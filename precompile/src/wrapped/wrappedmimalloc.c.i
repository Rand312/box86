# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
...
int wrappedmimalloc_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(mimallocName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(mimallocsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (mimallocsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, mimallocsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = mimallocsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, mimallocsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = mimallocsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(mimallocsymbolmap[i].name, '@')) AddDictionnary(box86->versym, mimallocsymbolmap[i].name); }
 cnt = sizeof(mimallocmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (mimallocmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, mimallocmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = mimallocmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, mimallocmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = mimallocmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(mimallocmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, mimallocmysymbolmap[i].name); }

    cnt = sizeof(mimallocstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, mimallocstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = mimallocstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(mimallocstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, mimallocstsymbolmap[i].name);
    }
    cnt = sizeof(mimallocsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, mimallocsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = mimallocsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = mimallocsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = mimallocsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(mimallocsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, mimallocsymbol2map[i].name);
    }
    cnt = sizeof(mimallocdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(mimallocdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, mimallocdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = mimallocdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, mimallocdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = mimallocdatamap[i].sz;
        }
    }
    cnt = sizeof(mimallocmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, mimallocmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = mimallocmydatamap[i].sz;
    }
...
void wrappedmimalloc_fini(library_t* lib)
{
...
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedmimalloc.c" 2
