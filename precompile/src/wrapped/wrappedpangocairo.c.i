# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2

const char* pangocairoName = "libpangocairo-1.0.so.0";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpangocairotypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpangocairotypes.h"
typedef void* (*pFpp_t)(void*, void*);
typedef void (*vFpppp_t)(void*, void*, void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
...
typedef struct pangocairo_my_s {


    pFpp_t pango_cairo_context_get_shape_renderer; vFpppp_t pango_cairo_context_set_shape_renderer;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static pangocairo_my_t my_pangocairo = {0};
static pangocairo_my_t * const my = &my_pangocairo;

static void getMy(library_t* lib)
{

    my->pango_cairo_context_get_shape_renderer = (pFpp_t)dlsym(lib->w.lib, "pango_cairo_context_get_shape_renderer"); my->pango_cairo_context_set_shape_renderer = (vFpppp_t)dlsym(lib->w.lib, "pango_cairo_context_set_shape_renderer");
...
# 35 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
# 52 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
static uintptr_t my_ShapeRenderer_fct_0 = 0; static void my_ShapeRenderer_0(void* a, void* b, int c, void* d) { RunFunctionFmt(my_ShapeRenderer_fct_0, "ppip", a, b, c, d); } static uintptr_t my_ShapeRenderer_fct_1 = 0; static void my_ShapeRenderer_1(void* a, void* b, int c, void* d) { RunFunctionFmt(my_ShapeRenderer_fct_1, "ppip", a, b, c, d); } static uintptr_t my_ShapeRenderer_fct_2 = 0; static void my_ShapeRenderer_2(void* a, void* b, int c, void* d) { RunFunctionFmt(my_ShapeRenderer_fct_2, "ppip", a, b, c, d); } static uintptr_t my_ShapeRenderer_fct_3 = 0; static void my_ShapeRenderer_3(void* a, void* b, int c, void* d) { RunFunctionFmt(my_ShapeRenderer_fct_3, "ppip", a, b, c, d); } static uintptr_t my_ShapeRenderer_fct_4 = 0; static void my_ShapeRenderer_4(void* a, void* b, int c, void* d) { RunFunctionFmt(my_ShapeRenderer_fct_4, "ppip", a, b, c, d); }
...
static void* find_ShapeRenderer_Fct(void* fct)
{
    ...
    if(my_ShapeRenderer_fct_0 == (uintptr_t)fct) return my_ShapeRenderer_0; if(my_ShapeRenderer_fct_1 == (uintptr_t)fct) return my_ShapeRenderer_1; if(my_ShapeRenderer_fct_2 == (uintptr_t)fct) return my_ShapeRenderer_2; if(my_ShapeRenderer_fct_3 == (uintptr_t)fct) return my_ShapeRenderer_3; if(my_ShapeRenderer_fct_4 == (uintptr_t)fct) return my_ShapeRenderer_4;


    if(my_ShapeRenderer_fct_0 == 0) {my_ShapeRenderer_fct_0 = (uintptr_t)fct; return my_ShapeRenderer_0; } if(my_ShapeRenderer_fct_1 == 0) {my_ShapeRenderer_fct_1 = (uintptr_t)fct; return my_ShapeRenderer_1; } if(my_ShapeRenderer_fct_2 == 0) {my_ShapeRenderer_fct_2 = (uintptr_t)fct; return my_ShapeRenderer_2; } if(my_ShapeRenderer_fct_3 == 0) {my_ShapeRenderer_fct_3 = (uintptr_t)fct; return my_ShapeRenderer_3; } if(my_ShapeRenderer_fct_4 == 0) {my_ShapeRenderer_fct_4 = (uintptr_t)fct; return my_ShapeRenderer_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for PangoCairo ShapeRenderer callback\n"); fflush(ftrace);}} while(0);
    return 
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 3 4
          ((void *)0)
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
              ;
}
static void* reverse_ShapeRenderer_Fct(void* fct)
{
    ...
    if(my_ShapeRenderer_0 == fct) return (void*)my_ShapeRenderer_fct_0; if(my_ShapeRenderer_1 == fct) return (void*)my_ShapeRenderer_fct_1; if(my_ShapeRenderer_2 == fct) return (void*)my_ShapeRenderer_fct_2; if(my_ShapeRenderer_3 == fct) return (void*)my_ShapeRenderer_fct_3; if(my_ShapeRenderer_4 == fct) return (void*)my_ShapeRenderer_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, vFppip, fct, 0, 
# 75 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 3 4
                                                             ((void *)0)
# 75 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
                                                                 );
}
...
static void* findGDestroyNotifyFct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for PangoCairo GDestroyNotify callback\n"); fflush(ftrace);}} while(0);
    return 
# 97 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 3 4
          ((void *)0)
# 97 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
              ;
}



__attribute__((visibility("default"))) void* my_pango_cairo_context_get_shape_renderer(x86emu_t* emu, void* ctx, void* p)
{
    (void)emu;
    return reverse_ShapeRenderer_Fct(my->pango_cairo_context_get_shape_renderer(ctx, p));
}

__attribute__((visibility("default"))) void my_pango_cairo_context_set_shape_renderer(x86emu_t* emu, void* ctx, void* f, void* p, void* d)
{
    (void)emu;
    my->pango_cairo_context_set_shape_renderer(ctx, find_ShapeRenderer_Fct(f), p, findGDestroyNotifyFct(d));
}
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpangocairodefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pangocairosymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1




{"pango_cairo_context_get_font_options", pFp, 0},
{"pango_cairo_context_get_resolution", dFp, 0},

{"pango_cairo_context_set_font_options", vFpp, 0},
{"pango_cairo_context_set_resolution", vFpd, 0},

{"pango_cairo_create_context", pFp, 0},
{"pango_cairo_create_layout", pFp, 0},
{"pango_cairo_error_underline_path", vFpdddd, 0},
{"pango_cairo_fc_font_get_type", iFv, 0},
{"pango_cairo_fc_font_map_get_type", iFv, 0},
{"pango_cairo_font_get_scaled_font", pFp, 0},
{"pango_cairo_font_get_type", iFv, 0},
{"pango_cairo_font_map_create_context", pFp, 0},
{"pango_cairo_font_map_get_default", pFv, 0},
{"pango_cairo_font_map_get_font_type", iFp, 0},
{"pango_cairo_font_map_get_resolution", dFp, 0},
{"pango_cairo_font_map_get_type", iFv, 0},
{"pango_cairo_font_map_new", pFv, 0},
{"pango_cairo_font_map_new_for_font_type", pFi, 0},
{"pango_cairo_font_map_set_default", vFp, 0},
{"pango_cairo_font_map_set_resolution", vFpd, 0},
{"pango_cairo_glyph_string_path", vFppp, 0},
{"pango_cairo_layout_line_path", vFpp, 0},
{"pango_cairo_layout_path", vFpp, 0},
{"pango_cairo_renderer_get_type", iFv, 0},
{"pango_cairo_show_error_underline", vFpdddd, 0},
{"pango_cairo_show_glyph_item", vFppp, 0},
{"pango_cairo_show_glyph_string", vFppp, 0},
{"pango_cairo_show_layout", vFpp, 0},
{"pango_cairo_show_layout_line", vFpp, 0},
{"pango_cairo_update_context", vFpp, 0},
{"pango_cairo_update_layout", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pangocairomysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1
...
{"pango_cairo_context_get_shape_renderer", pFEpp, 0},


{"pango_cairo_context_set_shape_renderer", vFEpppp, 0},
...
static const map_onesymbol_t pangocairostsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1
...
static const map_onesymbol2_t pangocairosymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1
...
static const map_onedata_t pangocairodatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1
...
static const map_onedata_t pangocairomydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpangocairoundefs.h" 1
...
int wrappedpangocairo_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(pangocairoName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(pangocairoName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(pangocairosymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pangocairosymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, pangocairosymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = pangocairosymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, pangocairosymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = pangocairosymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(pangocairosymbolmap[i].name, '@')) AddDictionnary(box86->versym, pangocairosymbolmap[i].name); }
 cnt = sizeof(pangocairomysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pangocairomysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, pangocairomysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = pangocairomysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, pangocairomysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = pangocairomysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(pangocairomysymbolmap[i].name, '@')) AddDictionnary(box86->versym, pangocairomysymbolmap[i].name); }

    cnt = sizeof(pangocairostsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, pangocairostsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = pangocairostsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(pangocairostsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, pangocairostsymbolmap[i].name);
    }
    cnt = sizeof(pangocairosymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, pangocairosymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = pangocairosymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = pangocairosymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = pangocairosymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(pangocairosymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, pangocairosymbol2map[i].name);
    }
    cnt = sizeof(pangocairodatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(pangocairodatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, pangocairodatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = pangocairodatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, pangocairodatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = pangocairodatamap[i].sz;
        }
    }
    cnt = sizeof(pangocairomydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, pangocairomydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = pangocairomydatamap[i].sz;
    }

    getMy(lib); setNeededLibs(lib, 1, "libpango-1.0.so.0");


    return 0;
}

void wrappedpangocairo_fini(library_t* lib)
{
...
# 126 "/home/ssd/pico/code/box86/src/wrapped/wrappedpangocairo.c" 2
