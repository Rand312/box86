# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedaluredefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t aluresymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1




{"alureGetVersion", vFpp, 0},
{"alureGetErrorString", pFv, 0},
{"alureGetDeviceNames", pFip, 0},
{"alureFreeDeviceNames", vFp, 0},
{"alureInitDevice", iFpp, 0},
{"alureShutdownDevice", iFv, 0},
{"alureGetSampleFormat", iFuuu, 0},
{"alureSleep", iFf, 0},
{"alureStreamSizeIsMicroSec", iFi, 0},
{"alureCreateBufferFromFile", uFp, 0},
{"alureCreateBufferFromMemory", uFpi, 0},
{"alureBufferDataFromFile", iFpu, 0},
{"alureBufferDataFromMemory", iFpiu, 0},
{"alureCreateStreamFromFile", pFpiip, 0},
{"alureCreateStreamFromMemory", pFpuiip, 0},
{"alureCreateStreamFromStaticMemory", pFpuiip, 0},

{"alureGetStreamLength", IFp, 0},
{"alureGetStreamFrequency", iFp, 0},
{"alureGetStreamOrder", uFp, 0},
{"alureBufferDataFromStream", iFpip, 0},
{"alureRewindStream", iFp, 0},
{"alureSetStreamOrder", iFpu, 0},
{"alureSetStreamPatchset", iFpp, 0},
{"alureDestroyStream", iFpip, 0},
{"alureUpdate", vFv, 0},
{"alureUpdateInterval", iFf, 0},


{"alureStopSource", iFui, 0},
{"alurePauseSource", iFu, 0},
{"alureResumeSource", iFu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t aluremysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1
...
static const map_onesymbol_t alurestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1
...
static const map_onesymbol2_t aluresymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1
...
static const map_onedata_t aluredatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1
...
static const map_onedata_t aluremydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedalureundefs.h" 1
...
int wrappedalure_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(alureName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(aluresymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (aluresymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, aluresymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = aluresymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, aluresymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = aluresymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(aluresymbolmap[i].name, '@')) AddDictionnary(box86->versym, aluresymbolmap[i].name); }
 cnt = sizeof(aluremysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (aluremysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, aluremysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = aluremysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, aluremysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = aluremysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(aluremysymbolmap[i].name, '@')) AddDictionnary(box86->versym, aluremysymbolmap[i].name); }

    cnt = sizeof(alurestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, alurestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = alurestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(alurestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, alurestsymbolmap[i].name);
    }
    cnt = sizeof(aluresymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, aluresymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = aluresymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = aluresymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = aluresymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(aluresymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, aluresymbol2map[i].name);
    }
    cnt = sizeof(aluredatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(aluredatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, aluredatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = aluredatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, aluredatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = aluredatamap[i].sz;
        }
    }
    cnt = sizeof(aluremydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, aluremydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = aluremydatamap[i].sz;
    }
...
void wrappedalure_fini(library_t* lib)
{
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedalure.c" 2
