# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedliboggdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t liboggsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
{"oggpackB_bytes", iFp, 0},
{"oggpackB_get_buffer", pFp, 0},



{"oggpackB_read", lFpi, 0},

{"oggpackB_readinit", vFppi, 0},
{"oggpackB_reset", vFp, 0},
{"oggpackB_write", vFpui, 0},


{"oggpackB_writeclear", vFp, 0},

{"oggpackB_writeinit", vFp, 0},

{"oggpack_bytes", lFp, 0},

{"oggpack_get_buffer", pFp, 0},
{"oggpack_look", lFpi, 0},

{"oggpack_read", lFpi, 0},

{"oggpack_readinit", vFppi, 0},
{"oggpack_reset", vFp, 0},
{"oggpack_write", vFpui, 0},


{"oggpack_writeclear", vFp, 0},

{"oggpack_writeinit", vFp, 0},
{"oggpack_writetrunc", vFpl, 0},
{"ogg_page_bos", iFp, 0},
{"ogg_page_checksum_set", iFp, 0},
{"ogg_page_continued", iFp, 0},
{"ogg_page_eos", iFp, 0},
{"ogg_page_granulepos", IFp, 0},


{"ogg_page_serialno", iFp, 0},


{"ogg_stream_clear", iFp, 0},


{"ogg_stream_flush", iFpp, 0},
{"ogg_stream_flush_fill", iFppi, 0},
{"ogg_stream_init", iFpi, 0},

{"ogg_stream_packetin", iFpp, 0},
{"ogg_stream_packetout", iFpp, 0},
{"ogg_stream_packetpeek", iFpp, 0},
{"ogg_stream_pagein", iFpp, 0},
{"ogg_stream_pageout", iFpp, 0},

{"ogg_stream_reset", iFp, 0},
{"ogg_stream_reset_serialno", iFpi, 0},
{"ogg_sync_buffer", pFpi, 0},

{"ogg_sync_clear", iFp, 0},

{"ogg_sync_init", iFp, 0},
{"ogg_sync_pageout", iFpp, 0},
{"ogg_sync_pageseek", iFpp, 0},
{"ogg_sync_reset", iFp, 0},
{"ogg_sync_wrote", iFpi, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t liboggmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
static const map_onesymbol_t liboggstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
static const map_onesymbol2_t liboggsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
static const map_onedata_t liboggdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
static const map_onedata_t liboggmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedliboggundefs.h" 1
...
int wrappedlibogg_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(liboggName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(liboggsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (liboggsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, liboggsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = liboggsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, liboggsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = liboggsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(liboggsymbolmap[i].name, '@')) AddDictionnary(box86->versym, liboggsymbolmap[i].name); }
 cnt = sizeof(liboggmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (liboggmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, liboggmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = liboggmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, liboggmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = liboggmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(liboggmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, liboggmysymbolmap[i].name); }

    cnt = sizeof(liboggstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, liboggstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = liboggstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(liboggstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, liboggstsymbolmap[i].name);
    }
    cnt = sizeof(liboggsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, liboggsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = liboggsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = liboggsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = liboggsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(liboggsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, liboggsymbol2map[i].name);
    }
    cnt = sizeof(liboggdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(liboggdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, liboggdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = liboggdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, liboggdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = liboggdatamap[i].sz;
        }
    }
    cnt = sizeof(liboggmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, liboggmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = liboggmydatamap[i].sz;
    }
...
void wrappedlibogg_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibogg.c" 2
