# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgcryptdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gcryptsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
{"gcry_check_version", pFp, 0},
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_mpi_new", pFu, 0},
# 130 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_mpi_print", uFipLpp, 0},

{"gcry_mpi_release", vFp, 0},
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_mpi_snew", pFu, 0},
# 153 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_pk_encrypt", uFppp, 0},
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"

{"gcry_sexp_build_array", uFpppp, 0},
# 191 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_sexp_find_token", pFppL, 0},




{"gcry_sexp_nth_data", pFpip, 0},
{"gcry_sexp_nth_mpi", pFpii, 0},


{"gcry_sexp_release", vFp, 0},




{"gcry_strerror", pFu, 0},
{"gcry_strsource", pFu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gcryptmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
static const map_onesymbol_t gcryptstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
static const map_onesymbol2_t gcryptsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h"
{"gcry_sexp_build", uFpppV, 0, "gcry_sexp_build_array"},
...
static const map_onedata_t gcryptdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
static const map_onedata_t gcryptmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgcryptundefs.h" 1
...
int wrappedgcrypt_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gcryptName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gcryptsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gcryptsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gcryptsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gcryptsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gcryptsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gcryptsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gcryptsymbolmap[i].name, '@')) AddDictionnary(box86->versym, gcryptsymbolmap[i].name); }
 cnt = sizeof(gcryptmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gcryptmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gcryptmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gcryptmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gcryptmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gcryptmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gcryptmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gcryptmysymbolmap[i].name); }

    cnt = sizeof(gcryptstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gcryptstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gcryptstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gcryptstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gcryptstsymbolmap[i].name);
    }
    cnt = sizeof(gcryptsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gcryptsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gcryptsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gcryptsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gcryptsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gcryptsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gcryptsymbol2map[i].name);
    }
    cnt = sizeof(gcryptdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gcryptdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gcryptdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gcryptdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gcryptdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gcryptdatamap[i].sz;
        }
    }
    cnt = sizeof(gcryptmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gcryptmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gcryptmydatamap[i].sz;
    }
...
void wrappedgcrypt_fini(library_t* lib)
{
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedgcrypt.c" 2
