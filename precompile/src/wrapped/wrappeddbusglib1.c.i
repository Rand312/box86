# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusglib1types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusglib1types.h"
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
...
typedef struct dbusglib1_my_s {
    ...
    vFppp_t dbus_g_type_collection_value_iterate; vFppp_t dbus_g_type_map_value_iterate; vFpppp_t dbus_g_proxy_disconnect_signal; vFppppp_t dbus_g_proxy_connect_signal; pFpppppiV_t dbus_g_proxy_begin_call; pFpppppiiV_t dbus_g_proxy_begin_call_with_timeout;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static dbusglib1_my_t my_dbusglib1 = {0};
static dbusglib1_my_t * const my = &my_dbusglib1;

static void getMy(library_t* lib)
{

    my->dbus_g_type_collection_value_iterate = (vFppp_t)dlsym(lib->w.lib, "dbus_g_type_collection_value_iterate"); my->dbus_g_type_map_value_iterate = (vFppp_t)dlsym(lib->w.lib, "dbus_g_type_map_value_iterate"); my->dbus_g_proxy_disconnect_signal = (vFpppp_t)dlsym(lib->w.lib, "dbus_g_proxy_disconnect_signal"); my->dbus_g_proxy_connect_signal = (vFppppp_t)dlsym(lib->w.lib, "dbus_g_proxy_connect_signal"); my->dbus_g_proxy_begin_call = (pFpppppiV_t)dlsym(lib->w.lib, "dbus_g_proxy_begin_call"); my->dbus_g_proxy_begin_call_with_timeout = (pFpppppiiV_t)dlsym(lib->w.lib, "dbus_g_proxy_begin_call_with_timeout");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
...
{
    if(!fct) return 
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 GDestroyNotify callback\n"); fflush(ftrace);}} while(0);
    return 
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
static uintptr_t my_GClosureNotify_fct_0 = 0; static void my_GClosureNotify_0(void* data, void* closure) { RunFunctionFmt(my_GClosureNotify_fct_0, "pp", data, closure); } static uintptr_t my_GClosureNotify_fct_1 = 0; static void my_GClosureNotify_1(void* data, void* closure) { RunFunctionFmt(my_GClosureNotify_fct_1, "pp", data, closure); } static uintptr_t my_GClosureNotify_fct_2 = 0; static void my_GClosureNotify_2(void* data, void* closure) { RunFunctionFmt(my_GClosureNotify_fct_2, "pp", data, closure); } static uintptr_t my_GClosureNotify_fct_3 = 0; static void my_GClosureNotify_3(void* data, void* closure) { RunFunctionFmt(my_GClosureNotify_fct_3, "pp", data, closure); }

static void* findGClosureNotifyFct(void* fct)
{
    if(!fct) return 
# 70 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 70 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_GClosureNotify_fct_0 == (uintptr_t)fct) return my_GClosureNotify_0; if(my_GClosureNotify_fct_1 == (uintptr_t)fct) return my_GClosureNotify_1; if(my_GClosureNotify_fct_2 == (uintptr_t)fct) return my_GClosureNotify_2; if(my_GClosureNotify_fct_3 == (uintptr_t)fct) return my_GClosureNotify_3;


    if(my_GClosureNotify_fct_0 == 0) {my_GClosureNotify_fct_0 = (uintptr_t)fct; return my_GClosureNotify_0; } if(my_GClosureNotify_fct_1 == 0) {my_GClosureNotify_fct_1 = (uintptr_t)fct; return my_GClosureNotify_1; } if(my_GClosureNotify_fct_2 == 0) {my_GClosureNotify_fct_2 = (uintptr_t)fct; return my_GClosureNotify_2; } if(my_GClosureNotify_fct_3 == 0) {my_GClosureNotify_fct_3 = (uintptr_t)fct; return my_GClosureNotify_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 GClosureNotify callback\n"); fflush(ftrace);}} while(0);
    return 
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
static uintptr_t my_DBusGProxyCallNotify_fct_0 = 0; static void my_DBusGProxyCallNotify_0(void* proxy, void* call_id, void* data) { RunFunctionFmt(my_DBusGProxyCallNotify_fct_0, "ppp", proxy, call_id, data); } static uintptr_t my_DBusGProxyCallNotify_fct_1 = 0; static void my_DBusGProxyCallNotify_1(void* proxy, void* call_id, void* data) { RunFunctionFmt(my_DBusGProxyCallNotify_fct_1, "ppp", proxy, call_id, data); } static uintptr_t my_DBusGProxyCallNotify_fct_2 = 0; static void my_DBusGProxyCallNotify_2(void* proxy, void* call_id, void* data) { RunFunctionFmt(my_DBusGProxyCallNotify_fct_2, "ppp", proxy, call_id, data); } static uintptr_t my_DBusGProxyCallNotify_fct_3 = 0; static void my_DBusGProxyCallNotify_3(void* proxy, void* call_id, void* data) { RunFunctionFmt(my_DBusGProxyCallNotify_fct_3, "ppp", proxy, call_id, data); }

static void* findDBusGProxyCallNotifyFct(void* fct)
{
    if(!fct) return 
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusGProxyCallNotify_fct_0 == (uintptr_t)fct) return my_DBusGProxyCallNotify_0; if(my_DBusGProxyCallNotify_fct_1 == (uintptr_t)fct) return my_DBusGProxyCallNotify_1; if(my_DBusGProxyCallNotify_fct_2 == (uintptr_t)fct) return my_DBusGProxyCallNotify_2; if(my_DBusGProxyCallNotify_fct_3 == (uintptr_t)fct) return my_DBusGProxyCallNotify_3;


    if(my_DBusGProxyCallNotify_fct_0 == 0) {my_DBusGProxyCallNotify_fct_0 = (uintptr_t)fct; return my_DBusGProxyCallNotify_0; } if(my_DBusGProxyCallNotify_fct_1 == 0) {my_DBusGProxyCallNotify_fct_1 = (uintptr_t)fct; return my_DBusGProxyCallNotify_1; } if(my_DBusGProxyCallNotify_fct_2 == 0) {my_DBusGProxyCallNotify_fct_2 = (uintptr_t)fct; return my_DBusGProxyCallNotify_2; } if(my_DBusGProxyCallNotify_fct_3 == 0) {my_DBusGProxyCallNotify_fct_3 = (uintptr_t)fct; return my_DBusGProxyCallNotify_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 DBusGProxyCallNotify callback\n"); fflush(ftrace);}} while(0);
    return 
# 102 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 102 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}
# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
...
{
    if(!fct) return 
# 116 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 116 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 GCallback callback\n"); fflush(ftrace);}} while(0);
    return 
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}
# 135 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
static uintptr_t my_DBusGTypeSpecializedCollectionIterator_fct_0 = 0; static void my_DBusGTypeSpecializedCollectionIterator_0(void* a, void* b) { RunFunctionFmt(my_DBusGTypeSpecializedCollectionIterator_fct_0, "pp", a, b); } static uintptr_t my_DBusGTypeSpecializedCollectionIterator_fct_1 = 0; static void my_DBusGTypeSpecializedCollectionIterator_1(void* a, void* b) { RunFunctionFmt(my_DBusGTypeSpecializedCollectionIterator_fct_1, "pp", a, b); } static uintptr_t my_DBusGTypeSpecializedCollectionIterator_fct_2 = 0; static void my_DBusGTypeSpecializedCollectionIterator_2(void* a, void* b) { RunFunctionFmt(my_DBusGTypeSpecializedCollectionIterator_fct_2, "pp", a, b); } static uintptr_t my_DBusGTypeSpecializedCollectionIterator_fct_3 = 0; static void my_DBusGTypeSpecializedCollectionIterator_3(void* a, void* b) { RunFunctionFmt(my_DBusGTypeSpecializedCollectionIterator_fct_3, "pp", a, b); }

static void* findDBusGTypeSpecializedCollectionIteratorFct(void* fct)
{
    if(!fct) return 
# 139 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 139 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusGTypeSpecializedCollectionIterator_fct_0 == (uintptr_t)fct) return my_DBusGTypeSpecializedCollectionIterator_0; if(my_DBusGTypeSpecializedCollectionIterator_fct_1 == (uintptr_t)fct) return my_DBusGTypeSpecializedCollectionIterator_1; if(my_DBusGTypeSpecializedCollectionIterator_fct_2 == (uintptr_t)fct) return my_DBusGTypeSpecializedCollectionIterator_2; if(my_DBusGTypeSpecializedCollectionIterator_fct_3 == (uintptr_t)fct) return my_DBusGTypeSpecializedCollectionIterator_3;


    if(my_DBusGTypeSpecializedCollectionIterator_fct_0 == 0) {my_DBusGTypeSpecializedCollectionIterator_fct_0 = (uintptr_t)fct; return my_DBusGTypeSpecializedCollectionIterator_0; } if(my_DBusGTypeSpecializedCollectionIterator_fct_1 == 0) {my_DBusGTypeSpecializedCollectionIterator_fct_1 = (uintptr_t)fct; return my_DBusGTypeSpecializedCollectionIterator_1; } if(my_DBusGTypeSpecializedCollectionIterator_fct_2 == 0) {my_DBusGTypeSpecializedCollectionIterator_fct_2 = (uintptr_t)fct; return my_DBusGTypeSpecializedCollectionIterator_2; } if(my_DBusGTypeSpecializedCollectionIterator_fct_3 == 0) {my_DBusGTypeSpecializedCollectionIterator_fct_3 = (uintptr_t)fct; return my_DBusGTypeSpecializedCollectionIterator_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 DBusGTypeSpecializedCollectionIterator callback\n"); fflush(ftrace);}} while(0);
    return 
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}
...
static uintptr_t my_DBusGTypeSpecializedMapIterator_fct_0 = 0; static void my_DBusGTypeSpecializedMapIterator_0(void* a, void* b, void* c) { RunFunctionFmt(my_DBusGTypeSpecializedMapIterator_fct_0, "ppp", a, b, c); } static uintptr_t my_DBusGTypeSpecializedMapIterator_fct_1 = 0; static void my_DBusGTypeSpecializedMapIterator_1(void* a, void* b, void* c) { RunFunctionFmt(my_DBusGTypeSpecializedMapIterator_fct_1, "ppp", a, b, c); } static uintptr_t my_DBusGTypeSpecializedMapIterator_fct_2 = 0; static void my_DBusGTypeSpecializedMapIterator_2(void* a, void* b, void* c) { RunFunctionFmt(my_DBusGTypeSpecializedMapIterator_fct_2, "ppp", a, b, c); } static uintptr_t my_DBusGTypeSpecializedMapIterator_fct_3 = 0; static void my_DBusGTypeSpecializedMapIterator_3(void* a, void* b, void* c) { RunFunctionFmt(my_DBusGTypeSpecializedMapIterator_fct_3, "ppp", a, b, c); }

static void* findDBusGTypeSpecializedMapIteratorFct(void* fct)
{
    if(!fct) return 
# 161 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
                   ((void *)0)
# 161 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusGTypeSpecializedMapIterator_fct_0 == (uintptr_t)fct) return my_DBusGTypeSpecializedMapIterator_0; if(my_DBusGTypeSpecializedMapIterator_fct_1 == (uintptr_t)fct) return my_DBusGTypeSpecializedMapIterator_1; if(my_DBusGTypeSpecializedMapIterator_fct_2 == (uintptr_t)fct) return my_DBusGTypeSpecializedMapIterator_2; if(my_DBusGTypeSpecializedMapIterator_fct_3 == (uintptr_t)fct) return my_DBusGTypeSpecializedMapIterator_3;


    if(my_DBusGTypeSpecializedMapIterator_fct_0 == 0) {my_DBusGTypeSpecializedMapIterator_fct_0 = (uintptr_t)fct; return my_DBusGTypeSpecializedMapIterator_0; } if(my_DBusGTypeSpecializedMapIterator_fct_1 == 0) {my_DBusGTypeSpecializedMapIterator_fct_1 = (uintptr_t)fct; return my_DBusGTypeSpecializedMapIterator_1; } if(my_DBusGTypeSpecializedMapIterator_fct_2 == 0) {my_DBusGTypeSpecializedMapIterator_fct_2 = (uintptr_t)fct; return my_DBusGTypeSpecializedMapIterator_2; } if(my_DBusGTypeSpecializedMapIterator_fct_3 == 0) {my_DBusGTypeSpecializedMapIterator_fct_3 = (uintptr_t)fct; return my_DBusGTypeSpecializedMapIterator_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus-glib1 DBusGTypeSpecializedCollectionIterator callback\n"); fflush(ftrace);}} while(0);
    return 
# 170 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 170 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}


__attribute__((visibility("default"))) void my_dbus_g_type_collection_value_iterate(x86emu_t* emu, void* value, void* cb, void* data)
{
    (void)emu;
    my->dbus_g_type_collection_value_iterate(value, findDBusGTypeSpecializedCollectionIteratorFct(cb), data);
}

__attribute__((visibility("default"))) void my_dbus_g_type_map_value_iterate(x86emu_t* emu, void* value, void* cb, void* data)
{
    (void)emu;
    my->dbus_g_type_map_value_iterate(value, findDBusGTypeSpecializedMapIteratorFct(cb), data);
}

__attribute__((visibility("default"))) void* my_dbus_g_proxy_begin_call(x86emu_t* emu, void* proxy, void* method, void* notify, void* data, void* destroy, int first, int* next)
{
    (void)emu;
    int narg = 0;
    if(first)
    ...
    switch (narg) {
        case 0: return my->dbus_g_proxy_begin_call(proxy, method, n, data, d, first, 0);
        ...
        default: do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no dbus-glib1 dbus_g_proxy_begin_call wrapper for %d args\n", narg); fflush(ftrace);}} while(0);
    }
    return 
# 200 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 200 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}

__attribute__((visibility("default"))) void* my_dbus_g_proxy_begin_call_with_timeout(x86emu_t* emu, void* proxy, void* method, void* notify, void* data, void* destroy, int timeout, int first, int* next)
{
    (void)emu;
    int narg = 0;
    if(first)
    ...
    void* d = findGDestroyNotifyFct(destroy);
    switch (narg) {
        case 0: return my->dbus_g_proxy_begin_call_with_timeout(proxy, method, n, data, d, timeout, first, 0);
        ...
        default: do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no dbus-glib1 dbus_g_proxy_begin_call_with_timeout wrapper for %d args\n", narg); fflush(ftrace);}} while(0);
    }
    return 
# 217 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 3 4
          ((void *)0)
# 217 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
              ;
}

__attribute__((visibility("default"))) void my_dbus_g_proxy_connect_signal(x86emu_t* emu, void* proxy, void* name, void* handler, void* data, void* free_fnc)
{
    (void)emu;
    my->dbus_g_proxy_connect_signal(proxy, name, findGCallbackFct(handler), data, findGClosureNotifyFct(free_fnc));
}

__attribute__((visibility("default"))) void my_dbus_g_proxy_disconnect_signal(x86emu_t* emu, void* proxy, void* name, void* handler, void* data)
{
    (void)emu;
    my->dbus_g_proxy_disconnect_signal(proxy, name, findGCallbackFct(handler), data);
}
# 243 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusglib1defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusglib1symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1




{"dbus_connection_get_g_connection", pFp, 0},
{"dbus_connection_get_g_type", iFv, 0},
{"dbus_connection_setup_with_g_main", vFpp, 0},
{"dbus_g_bus_get", pFip, 0},
{"dbus_g_bus_get_private", pFipp, 0},
{"dbus_g_connection_flush", vFp, 0},
{"dbus_g_connection_get_connection", pFp, 0},
{"dbus_g_connection_get_g_type", iFv, 0},
{"dbus_g_connection_lookup_g_object", pFpp, 0},
{"dbus_g_connection_open", pFpp, 0},
{"dbus_g_connection_ref", pFp, 0},
{"dbus_g_connection_register_g_object", vFppp, 0},
{"dbus_g_connection_unref", vFp, 0},
{"dbus_g_connection_unregister_g_object", vFpp, 0},
{"dbus_g_error_domain_register", vFppi, 0},
{"dbus_g_error_get_name", pFp, 0},
{"dbus_g_error_has_name", iFpp, 0},
{"dbus_g_error_quark", pFv, 0},

{"dbus_g_message_get_g_type", iFv, 0},



{"dbus_g_method_get_reply", pFp, 0},
{"dbus_g_method_get_sender", pFp, 0},
{"dbus_g_method_return", vFppppppppppp, 0},
{"dbus_g_method_return_error", vFpp, 0},
{"dbus_g_method_send_reply", vFpp, 0},
{"dbus_g_object_path_get_g_type", iFv, 0},
{"dbus_g_object_register_marshaller", vFpipppppppp, 0},
{"dbus_g_object_register_marshaller_array", vFpiup, 0},
{"dbus_g_object_type_install_info", vFip, 0},
{"dbus_g_object_type_register_shadow_property", vFipp, 0},
{"dbus_g_proxy_add_signal", vFppipppppppp, 0},


{"dbus_g_proxy_call", iFpppippppppppppppp, 0},
{"dbus_g_proxy_call_no_reply", vFppipppppppppppp, 0},
{"dbus_g_proxy_call_with_timeout", iFppipipppppppppppp, 0},
{"dbus_g_proxy_cancel_call", vFpp, 0},


{"dbus_g_proxy_end_call", iFpppippppppppppppppp, 0},
{"dbus_g_proxy_get_bus_name", pFp, 0},
{"dbus_g_proxy_get_interface", pFp, 0},
{"dbus_g_proxy_get_path", pFp, 0},
{"dbus_g_proxy_get_type", iFv, 0},
{"dbus_g_proxy_new_for_name", pFpppp, 0},
{"dbus_g_proxy_new_for_name_owner", pFppppp, 0},
{"dbus_g_proxy_new_for_peer", pFppp, 0},
{"dbus_g_proxy_new_from_proxy", pFppp, 0},
{"dbus_g_proxy_send", vFppp, 0},
{"dbus_g_proxy_set_default_timeout", vFpi, 0},
{"dbus_g_proxy_set_interface", vFpp, 0},
{"dbus_g_signature_get_g_type", iFv, 0},
{"dbus_g_thread_init", vFv, 0},
{"dbus_g_type_collection_get_fixed", iFppp, 0},


{"dbus_g_type_get_collection", iFpi, 0},
{"dbus_g_type_get_collection_specialization", iFi, 0},
{"dbus_g_type_get_map", iFpii, 0},
{"dbus_g_type_get_map_key_specialization", iFi, 0},
{"dbus_g_type_get_map_value_specialization", iFi, 0},
{"dbus_g_type_get_struct", iFpippppppppppp, 0},
{"dbus_g_type_get_struct_member_type", iFiu, 0},
{"dbus_g_type_get_struct_size", uFi, 0},
{"dbus_g_type_get_structv", iFpup, 0},
{"dbus_g_type_is_collection", iFi, 0},
{"dbus_g_type_is_map", iFi, 0},
{"dbus_g_type_is_struct", iFi, 0},





{"dbus_g_type_specialized_collection_append", vFpp, 0},
{"dbus_g_type_specialized_collection_end_append", vFp, 0},
{"dbus_g_type_specialized_construct", pFi, 0},
{"dbus_g_type_specialized_init", vFv, 0},
{"dbus_g_type_specialized_init_append", vFpp, 0},
{"dbus_g_type_specialized_map_append", vFppp, 0},
{"dbus_g_type_struct_get", iFpuppppppppppp, 0},
{"dbus_g_type_struct_get_member", iFpup, 0},

{"dbus_g_type_struct_set", iFpupppppppppppp, 0},
{"dbus_g_type_struct_set_member", iFpup, 0},
{"dbus_message_get_g_type", iFv, 0},
{"dbus_server_setup_with_g_main", vFpp, 0},
{"dbus_set_g_error", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusglib1mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1
...
{"dbus_g_proxy_begin_call", pFEpppppiV, 0},
{"dbus_g_proxy_begin_call_with_timeout", pFEpppppiiV, 0},




{"dbus_g_proxy_connect_signal", vFEppppp, 0},
{"dbus_g_proxy_disconnect_signal", vFEpppp, 0},
...
{"dbus_g_type_collection_value_iterate", vFEppp, 0},
...
{"dbus_g_type_map_value_iterate", vFEppp, 0},
...
static const map_onesymbol_t dbusglib1stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1
...
static const map_onesymbol2_t dbusglib1symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1
...
static const map_onedata_t dbusglib1datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1
...
static const map_onedata_t dbusglib1mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusglib1undefs.h" 1
...
int wrappeddbusglib1_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(dbusglib1Name, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(dbusglib1Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(dbusglib1symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusglib1symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, dbusglib1symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = dbusglib1symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, dbusglib1symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = dbusglib1symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(dbusglib1symbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusglib1symbolmap[i].name); }
 cnt = sizeof(dbusglib1mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusglib1mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, dbusglib1mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = dbusglib1mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, dbusglib1mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = dbusglib1mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(dbusglib1mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusglib1mysymbolmap[i].name); }

    cnt = sizeof(dbusglib1stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, dbusglib1stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = dbusglib1stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(dbusglib1stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, dbusglib1stsymbolmap[i].name);
    }
    cnt = sizeof(dbusglib1symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, dbusglib1symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = dbusglib1symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = dbusglib1symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = dbusglib1symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(dbusglib1symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, dbusglib1symbol2map[i].name);
    }
    cnt = sizeof(dbusglib1datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(dbusglib1datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, dbusglib1datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = dbusglib1datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, dbusglib1datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = dbusglib1datamap[i].sz;
        }
    }
    cnt = sizeof(dbusglib1mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, dbusglib1mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = dbusglib1mydatamap[i].sz;
    }
...
void wrappeddbusglib1_fini(library_t* lib)
{
...
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusglib1.c" 2
