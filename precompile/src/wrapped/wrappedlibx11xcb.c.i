# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibx11xcbdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libx11xcbsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1




{"XGetXCBConnection", pFp, 0},
{"XSetEventQueueOwner", vFpu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libx11xcbmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1
...
static const map_onesymbol_t libx11xcbstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1
...
static const map_onesymbol2_t libx11xcbsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1
...
static const map_onedata_t libx11xcbdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1
...
static const map_onedata_t libx11xcbmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibx11xcbundefs.h" 1
...
int wrappedlibx11xcb_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libx11xcbName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libx11xcbName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libx11xcbsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libx11xcbsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libx11xcbsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libx11xcbsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libx11xcbsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libx11xcbsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libx11xcbsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libx11xcbsymbolmap[i].name); }
 cnt = sizeof(libx11xcbmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libx11xcbmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libx11xcbmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libx11xcbmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libx11xcbmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libx11xcbmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libx11xcbmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libx11xcbmysymbolmap[i].name); }

    cnt = sizeof(libx11xcbstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libx11xcbstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libx11xcbstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libx11xcbstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libx11xcbstsymbolmap[i].name);
    }
    cnt = sizeof(libx11xcbsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libx11xcbsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libx11xcbsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libx11xcbsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libx11xcbsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libx11xcbsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libx11xcbsymbol2map[i].name);
    }
    cnt = sizeof(libx11xcbdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libx11xcbdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libx11xcbdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libx11xcbdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libx11xcbdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libx11xcbdatamap[i].sz;
        }
    }
    cnt = sizeof(libx11xcbmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libx11xcbmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libx11xcbmydatamap[i].sz;
    }
...
void wrappedlibx11xcb_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibx11xcb.c" 2
