# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2

const char* cairoName = "libcairo.so.2";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairotypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairotypes.h"
typedef int32_t (*iFpppp_t)(void*, void*, void*, void*);
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
...
typedef struct cairo_my_s {
    ...
    iFpppp_t cairo_font_face_set_user_data; iFpppp_t cairo_pattern_set_user_data; iFpppp_t cairo_scaled_font_set_user_data; iFpppp_t cairo_set_user_data; iFpppp_t cairo_surface_set_user_data;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static cairo_my_t my_cairo = {0};
static cairo_my_t * const my = &my_cairo;

static void getMy(library_t* lib)
{

    my->cairo_font_face_set_user_data = (iFpppp_t)dlsym(lib->w.lib, "cairo_font_face_set_user_data"); my->cairo_pattern_set_user_data = (iFpppp_t)dlsym(lib->w.lib, "cairo_pattern_set_user_data"); my->cairo_scaled_font_set_user_data = (iFpppp_t)dlsym(lib->w.lib, "cairo_scaled_font_set_user_data"); my->cairo_set_user_data = (iFpppp_t)dlsym(lib->w.lib, "cairo_set_user_data"); my->cairo_surface_set_user_data = (iFpppp_t)dlsym(lib->w.lib, "cairo_surface_set_user_data");
...
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
# 37 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
static uintptr_t my_cairo_destroy_fct_0 = 0; static void my_cairo_destroy_0(void* data) { RunFunctionFmt(my_cairo_destroy_fct_0, "p", data); } static uintptr_t my_cairo_destroy_fct_1 = 0; static void my_cairo_destroy_1(void* data) { RunFunctionFmt(my_cairo_destroy_fct_1, "p", data); } static uintptr_t my_cairo_destroy_fct_2 = 0; static void my_cairo_destroy_2(void* data) { RunFunctionFmt(my_cairo_destroy_fct_2, "p", data); } static uintptr_t my_cairo_destroy_fct_3 = 0; static void my_cairo_destroy_3(void* data) { RunFunctionFmt(my_cairo_destroy_fct_3, "p", data); } static uintptr_t my_cairo_destroy_fct_4 = 0; static void my_cairo_destroy_4(void* data) { RunFunctionFmt(my_cairo_destroy_fct_4, "p", data); }
...
static void* find_cairo_destroy_Fct(void* fct)
{
    ...
    if(my_cairo_destroy_fct_0 == (uintptr_t)fct) return my_cairo_destroy_0; if(my_cairo_destroy_fct_1 == (uintptr_t)fct) return my_cairo_destroy_1; if(my_cairo_destroy_fct_2 == (uintptr_t)fct) return my_cairo_destroy_2; if(my_cairo_destroy_fct_3 == (uintptr_t)fct) return my_cairo_destroy_3; if(my_cairo_destroy_fct_4 == (uintptr_t)fct) return my_cairo_destroy_4;


    if(my_cairo_destroy_fct_0 == 0) {my_cairo_destroy_fct_0 = (uintptr_t)fct; return my_cairo_destroy_0; } if(my_cairo_destroy_fct_1 == 0) {my_cairo_destroy_fct_1 = (uintptr_t)fct; return my_cairo_destroy_1; } if(my_cairo_destroy_fct_2 == 0) {my_cairo_destroy_fct_2 = (uintptr_t)fct; return my_cairo_destroy_2; } if(my_cairo_destroy_fct_3 == 0) {my_cairo_destroy_fct_3 = (uintptr_t)fct; return my_cairo_destroy_3; } if(my_cairo_destroy_fct_4 == 0) {my_cairo_destroy_fct_4 = (uintptr_t)fct; return my_cairo_destroy_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for cairo cairo_destroy callback\n"); fflush(ftrace);}} while(0);
    return 
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 3 4
          ((void *)0)
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
              ;
}
# 62 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
__attribute__((visibility("default"))) int my_cairo_set_user_data (x86emu_t* emu, void* cr, void* key, void* data, void* destroy) { (void)emu; return my->cairo_set_user_data(cr, key, data, find_cairo_destroy_Fct(destroy)); }
__attribute__((visibility("default"))) int my_cairo_pattern_set_user_data (x86emu_t* emu, void* cr, void* key, void* data, void* destroy) { (void)emu; return my->cairo_pattern_set_user_data(cr, key, data, find_cairo_destroy_Fct(destroy)); }
__attribute__((visibility("default"))) int my_cairo_scaled_font_set_user_data (x86emu_t* emu, void* cr, void* key, void* data, void* destroy) { (void)emu; return my->cairo_scaled_font_set_user_data(cr, key, data, find_cairo_destroy_Fct(destroy)); }
__attribute__((visibility("default"))) int my_cairo_surface_set_user_data (x86emu_t* emu, void* cr, void* key, void* data, void* destroy) { (void)emu; return my->cairo_surface_set_user_data(cr, key, data, find_cairo_destroy_Fct(destroy)); }
__attribute__((visibility("default"))) int my_cairo_font_face_set_user_data (x86emu_t* emu, void* cr, void* key, void* data, void* destroy) { (void)emu; return my->cairo_font_face_set_user_data(cr, key, data, find_cairo_destroy_Fct(destroy)); }
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairodefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t cairosymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1




{"cairo_append_path", vFpp, 0},
{"cairo_arc", vFpddddd, 0},
{"cairo_arc_negative", vFpddddd, 0},
{"cairo_clip", vFp, 0},
{"cairo_clip_extents", vFppppp, 0},
{"cairo_clip_preserve", vFp, 0},
{"cairo_close_path", vFp, 0},
{"cairo_copy_clip_rectangle_list", pFp, 0},
{"cairo_copy_page", vFp, 0},
{"cairo_copy_path", pFp, 0},
{"cairo_copy_path_flat", pFp, 0},
{"cairo_create", pFp, 0},
{"cairo_curve_to", vFpdddddd, 0},
{"cairo_debug_reset_static_data", vFv, 0},
{"cairo_destroy", vFp, 0},
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_device_to_user", vFppp, 0},
{"cairo_device_to_user_distance", vFppp, 0},
{"cairo_fill", vFp, 0},
{"cairo_fill_extents", vFppppp, 0},
{"cairo_fill_preserve", vFp, 0},
{"cairo_font_extents", vFpp, 0},
{"cairo_font_face_destroy", vFp, 0},
{"cairo_font_face_get_reference_count", uFp, 0},
{"cairo_font_face_get_type", iFp, 0},
{"cairo_font_face_get_user_data", pFpp, 0},
{"cairo_font_face_reference", pFp, 0},

{"cairo_font_face_status", iFp, 0},
{"cairo_font_options_copy", pFp, 0},
{"cairo_font_options_create", pFv, 0},
{"cairo_font_options_destroy", vFp, 0},
{"cairo_font_options_equal", iFpp, 0},
{"cairo_font_options_get_antialias", iFp, 0},
{"cairo_font_options_get_hint_metrics", iFp, 0},
{"cairo_font_options_get_hint_style", iFp, 0},
{"cairo_font_options_get_subpixel_order", iFp, 0},
{"cairo_font_options_hash", LFp, 0},
{"cairo_font_options_merge", vFpp, 0},
{"cairo_font_options_set_antialias", vFpi, 0},
{"cairo_font_options_set_hint_metrics", vFpi, 0},
{"cairo_font_options_set_hint_style", vFpi, 0},
{"cairo_font_options_set_subpixel_order", vFpi, 0},
{"cairo_font_options_status", iFp, 0},
{"cairo_format_stride_for_width", iFii, 0},
{"cairo_ft_font_face_create_for_ft_face", pFpi, 0},
{"cairo_ft_font_face_create_for_pattern", pFp, 0},
{"cairo_ft_font_face_get_synthesize", uFp, 0},
{"cairo_ft_font_face_set_synthesize", vFpu, 0},
{"cairo_ft_font_face_unset_synthesize", vFpu, 0},
{"cairo_ft_font_options_substitute", vFpp, 0},
{"cairo_ft_scaled_font_lock_face", pFp, 0},
{"cairo_ft_scaled_font_unlock_face", vFp, 0},
{"cairo_get_antialias", iFp, 0},
{"cairo_get_current_point", vFppp, 0},
{"cairo_get_dash", vFppp, 0},
{"cairo_get_dash_count", iFp, 0},
{"cairo_get_fill_rule", iFp, 0},
{"cairo_get_font_face", pFp, 0},
{"cairo_get_font_matrix", vFpp, 0},
{"cairo_get_font_options", vFpp, 0},
{"cairo_get_group_target", pFp, 0},
{"cairo_get_line_cap", iFp, 0},
{"cairo_get_line_join", iFp, 0},
{"cairo_get_line_width", dFp, 0},
{"cairo_get_matrix", vFpp, 0},
{"cairo_get_miter_limit", dFp, 0},
{"cairo_get_operator", iFp, 0},
{"cairo_get_reference_count", uFp, 0},
{"cairo_get_scaled_font", pFp, 0},
{"cairo_get_source", pFp, 0},
{"cairo_get_target", pFp, 0},
{"cairo_get_tolerance", dFp, 0},
{"cairo_get_user_data", pFpp, 0},
{"cairo_glyph_allocate", pFi, 0},
{"cairo_glyph_extents", vFppip, 0},
{"cairo_glyph_free", vFp, 0},
{"cairo_glyph_path", vFppi, 0},
{"cairo_has_current_point", iFp, 0},
{"cairo_identity_matrix", vFp, 0},
{"cairo_image_surface_create", pFiii, 0},
{"cairo_image_surface_create_for_data", pFpiiii, 0},


{"cairo_image_surface_get_data", pFp, 0},
{"cairo_image_surface_get_format", iFp, 0},
{"cairo_image_surface_get_height", iFp, 0},
{"cairo_image_surface_get_stride", iFp, 0},
{"cairo_image_surface_get_width", iFp, 0},
{"cairo_in_clip", iFpdd, 0},
{"cairo_in_fill", iFpdd, 0},
{"cairo_in_stroke", iFpdd, 0},
{"cairo_line_to", vFpdd, 0},
{"cairo_mask", vFpp, 0},
{"cairo_mask_surface", vFppdd, 0},
{"cairo_matrix_init", vFpdddddd, 0},
{"cairo_matrix_init_identity", vFp, 0},
{"cairo_matrix_init_rotate", vFpd, 0},
{"cairo_matrix_init_scale", vFpdd, 0},
{"cairo_matrix_init_translate", vFpdd, 0},
{"cairo_matrix_invert", iFp, 0},
{"cairo_matrix_multiply", vFppp, 0},
{"cairo_matrix_rotate", vFpd, 0},
{"cairo_matrix_scale", vFpdd, 0},
{"cairo_matrix_transform_distance", vFppp, 0},
{"cairo_matrix_transform_point", vFppp, 0},
{"cairo_matrix_translate", vFpdd, 0},
{"cairo_mesh_pattern_begin_patch", vFp, 0},
{"cairo_mesh_pattern_curve_to", vFpdddddd, 0},
{"cairo_mesh_pattern_end_patch", vFp, 0},
{"cairo_mesh_pattern_get_control_point", iFpuupp, 0},
{"cairo_mesh_pattern_get_corner_color_rgba", iFpuupppp, 0},
{"cairo_mesh_pattern_get_patch_count", iFpp, 0},
{"cairo_mesh_pattern_get_path", pFpu, 0},
{"cairo_mesh_pattern_line_to", vFpdd, 0},
{"cairo_mesh_pattern_move_to", vFpdd, 0},
{"cairo_mesh_pattern_set_control_point", vFpudd, 0},
{"cairo_mesh_pattern_set_corner_color_rgb", vFpuddd, 0},
{"cairo_mesh_pattern_set_corner_color_rgba", vFpudddd, 0},
{"cairo_move_to", vFpdd, 0},
{"cairo_new_path", vFp, 0},
{"cairo_new_sub_path", vFp, 0},
{"cairo_paint", vFp, 0},
{"cairo_paint_with_alpha", vFpd, 0},
{"cairo_path_destroy", vFp, 0},
{"cairo_path_extents", vFppppp, 0},
{"cairo_pattern_add_color_stop_rgb", vFpdddd, 0},
{"cairo_pattern_add_color_stop_rgba", vFpddddd, 0},
{"cairo_pattern_create_for_surface", pFp, 0},
{"cairo_pattern_create_linear", pFdddd, 0},
{"cairo_pattern_create_mesh", pFv, 0},
{"cairo_pattern_create_radial", pFdddddd, 0},

{"cairo_pattern_create_rgb", pFddd, 0},
{"cairo_pattern_create_rgba", pFdddd, 0},
{"cairo_pattern_destroy", vFp, 0},
{"cairo_pattern_get_color_stop_count", iFpp, 0},
{"cairo_pattern_get_color_stop_rgba", iFpippppp, 0},
{"cairo_pattern_get_extend", iFp, 0},
{"cairo_pattern_get_filter", iFp, 0},
{"cairo_pattern_get_linear_points", iFppppp, 0},
{"cairo_pattern_get_matrix", vFpp, 0},
{"cairo_pattern_get_radial_circles", iFppppppp, 0},
{"cairo_pattern_get_reference_count", uFp, 0},
{"cairo_pattern_get_rgba", iFppppp, 0},
{"cairo_pattern_get_surface", iFpp, 0},
{"cairo_pattern_get_type", iFp, 0},
{"cairo_pattern_get_user_data", pFpp, 0},
{"cairo_pattern_reference", pFp, 0},
{"cairo_pattern_set_extend", vFpi, 0},
{"cairo_pattern_set_filter", vFpi, 0},
{"cairo_pattern_set_matrix", vFpp, 0},

{"cairo_pattern_status", iFp, 0},
{"cairo_pdf_get_versions", vFpp, 0},
{"cairo_pdf_surface_create", pFpdd, 0},
{"cairo_pdf_surface_create_for_stream", pFppdd, 0},
{"cairo_pdf_surface_restrict_to_version", vFpi, 0},
{"cairo_pdf_surface_set_size", vFpdd, 0},
{"cairo_pdf_version_to_string", pFi, 0},
{"cairo_pop_group", pFp, 0},
{"cairo_pop_group_to_source", vFp, 0},
{"cairo_ps_get_levels", vFpp, 0},
{"cairo_ps_level_to_string", pFi, 0},
{"cairo_ps_surface_create", pFpdd, 0},
{"cairo_ps_surface_create_for_stream", pFppdd, 0},
{"cairo_ps_surface_dsc_begin_page_setup", vFp, 0},
{"cairo_ps_surface_dsc_begin_setup", vFp, 0},
{"cairo_ps_surface_dsc_comment", vFpp, 0},
{"cairo_ps_surface_get_eps", iFp, 0},
{"cairo_ps_surface_restrict_to_level", vFpi, 0},
{"cairo_ps_surface_set_eps", vFpi, 0},
{"cairo_ps_surface_set_size", vFpdd, 0},
{"cairo_push_group", vFp, 0},
{"cairo_push_group_with_content", vFpi, 0},
# 210 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_rectangle", vFpdddd, 0},
{"cairo_rectangle_list_destroy", vFp, 0},
{"cairo_reference", pFp, 0},
# 236 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_rel_curve_to", vFpdddddd, 0},
{"cairo_rel_line_to", vFpdd, 0},
{"cairo_rel_move_to", vFpdd, 0},
{"cairo_reset_clip", vFp, 0},
{"cairo_restore", vFp, 0},
{"cairo_rotate", vFpd, 0},
{"cairo_save", vFp, 0},
{"cairo_scale", vFpdd, 0},
{"cairo_scaled_font_create", pFpppp, 0},
{"cairo_scaled_font_destroy", vFp, 0},
{"cairo_scaled_font_extents", vFpp, 0},
{"cairo_scaled_font_get_ctm", vFpp, 0},
{"cairo_scaled_font_get_font_face", pFp, 0},
{"cairo_scaled_font_get_font_matrix", vFpp, 0},
{"cairo_scaled_font_get_font_options", vFpp, 0},
{"cairo_scaled_font_get_reference_count", uFp, 0},
{"cairo_scaled_font_get_scale_matrix", vFpp, 0},
{"cairo_scaled_font_get_type", iFp, 0},
{"cairo_scaled_font_get_user_data", pFpp, 0},
{"cairo_scaled_font_glyph_extents", vFppip, 0},
{"cairo_scaled_font_reference", pFp, 0},

{"cairo_scaled_font_status", iFp, 0},
{"cairo_scaled_font_text_extents", vFppp, 0},
{"cairo_scaled_font_text_to_glyphs", iFpddpippppp, 0},
# 269 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_select_font_face", vFppii, 0},
{"cairo_set_antialias", vFpi, 0},
{"cairo_set_dash", vFppid, 0},
{"cairo_set_fill_rule", vFpi, 0},
{"cairo_set_font_face", vFpp, 0},
{"cairo_set_font_matrix", vFpp, 0},
{"cairo_set_font_options", vFpp, 0},
{"cairo_set_font_size", vFpd, 0},
{"cairo_set_line_cap", vFpi, 0},
{"cairo_set_line_join", vFpi, 0},
{"cairo_set_line_width", vFpd, 0},
{"cairo_set_matrix", vFpp, 0},
{"cairo_set_miter_limit", vFpd, 0},
{"cairo_set_operator", vFpi, 0},
{"cairo_set_scaled_font", vFpp, 0},
{"cairo_set_source", vFpp, 0},
{"cairo_set_source_rgb", vFpddd, 0},
{"cairo_set_source_rgba", vFpdddd, 0},
{"cairo_set_source_surface", vFppdd, 0},
{"cairo_set_tolerance", vFpd, 0},

{"cairo_show_glyphs", vFppi, 0},
{"cairo_show_page", vFp, 0},
{"cairo_show_text", vFpp, 0},
{"cairo_show_text_glyphs", vFppipipii, 0},
{"cairo_status", iFp, 0},
{"cairo_status_to_string", pFi, 0},
{"cairo_stroke", vFp, 0},
{"cairo_stroke_extents", vFppppp, 0},
{"cairo_stroke_preserve", vFp, 0},
{"cairo_surface_copy_page", vFp, 0},
{"cairo_surface_create_for_rectangle", pFpdddd, 0},

{"cairo_surface_create_similar", pFppii, 0},
{"cairo_surface_create_similar_image", pFppii, 0},
{"cairo_surface_destroy", vFp, 0},
{"cairo_surface_finish", vFp, 0},
{"cairo_surface_flush", vFp, 0},
{"cairo_surface_get_content", pFp, 0},
{"cairo_surface_get_device", pFp, 0},
{"cairo_surface_get_device_offset", vFppp, 0},
{"cairo_surface_get_device_scale", vFpp, 0},
{"cairo_surface_get_fallback_resolution", vFppp, 0},
{"cairo_surface_get_font_options", vFpp, 0},
{"cairo_surface_get_mime_data", vFpppp, 0},
{"cairo_surface_get_reference_count", uFp, 0},
{"cairo_surface_get_type", iFp, 0},
{"cairo_surface_get_user_data", pFpp, 0},
{"cairo_surface_has_show_text_glyphs", iFp, 0},
{"cairo_surface_map_to_image", pFpp, 0},
{"cairo_surface_mark_dirty", vFp, 0},
{"cairo_surface_mark_dirty_rectangle", vFpiiii, 0},
# 330 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_surface_reference", pFp, 0},
{"cairo_surface_set_device_offset", vFpdd, 0},
{"cairo_surface_set_device_scale", vFpdd, 0},
{"cairo_surface_set_fallback_resolution", vFpdd, 0},


{"cairo_surface_show_page", vFp, 0},
{"cairo_surface_status", iFp, 0},
{"cairo_surface_supports_mime_type", iFpp, 0},
{"cairo_surface_unmap_image", vFpp, 0},
...
{"cairo_text_cluster_allocate", pFi, 0},
{"cairo_text_cluster_free", vFp, 0},
{"cairo_text_extents", vFppp, 0},
{"cairo_text_path", vFpp, 0},
{"cairo_toy_font_face_create", pFpii, 0},
{"cairo_toy_font_face_get_family", pFp, 0},
{"cairo_toy_font_face_get_slant", iFp, 0},
{"cairo_toy_font_face_get_weight", iFp, 0},
{"cairo_transform", vFpp, 0},
{"cairo_translate", vFpdd, 0},
# 366 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_user_to_device", vFppp, 0},
{"cairo_user_to_device_distance", vFppp, 0},
# 380 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h"
{"cairo_xlib_device_debug_cap_xrender_version", vFpii, 0},
{"cairo_xlib_device_debug_get_precision", iFp, 0},
{"cairo_xlib_device_debug_set_precision", vFpi, 0},
{"cairo_xlib_surface_create", pFpppii, 0},
{"cairo_xlib_surface_create_for_bitmap", pFpppii, 0},

{"cairo_xlib_surface_get_depth", iFp, 0},
{"cairo_xlib_surface_get_display", pFp, 0},
{"cairo_xlib_surface_get_drawable", pFp, 0},
{"cairo_xlib_surface_get_height", iFp, 0},
{"cairo_xlib_surface_get_screen", pFp, 0},
{"cairo_xlib_surface_get_visual", pFp, 0},
{"cairo_xlib_surface_get_width", iFp, 0},

{"cairo_xlib_surface_set_drawable", vFppii, 0},
{"cairo_xlib_surface_set_size", vFpii, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t cairomysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1
...
{"cairo_font_face_set_user_data", iFEpppp, 0},
...
{"cairo_pattern_set_user_data", iFEpppp, 0},
...
{"cairo_scaled_font_set_user_data", iFEpppp, 0},
...
{"cairo_surface_set_user_data", iFEpppp, 0},
...
static const map_onesymbol_t cairostsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1
...
static const map_onesymbol2_t cairosymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1
...
static const map_onedata_t cairodatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1
...
static const map_onedata_t cairomydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairoundefs.h" 1
...
int wrappedcairo_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(cairoName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(cairosymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (cairosymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, cairosymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = cairosymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, cairosymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = cairosymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(cairosymbolmap[i].name, '@')) AddDictionnary(box86->versym, cairosymbolmap[i].name); }
 cnt = sizeof(cairomysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (cairomysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, cairomysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = cairomysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, cairomysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = cairomysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(cairomysymbolmap[i].name, '@')) AddDictionnary(box86->versym, cairomysymbolmap[i].name); }

    cnt = sizeof(cairostsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, cairostsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = cairostsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(cairostsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, cairostsymbolmap[i].name);
    }
    cnt = sizeof(cairosymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, cairosymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = cairosymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = cairosymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = cairosymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(cairosymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, cairosymbol2map[i].name);
    }
    cnt = sizeof(cairodatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(cairodatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, cairodatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = cairodatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, cairodatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = cairodatamap[i].sz;
        }
    }
    cnt = sizeof(cairomydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, cairomydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = cairomydatamap[i].sz;
    }
...
void wrappedcairo_fini(library_t* lib)
{
...
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairo.c" 2
