# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibcryptdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libcryptsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
static const map_onesymbol_t libcryptmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
static const map_onesymbol_t libcryptstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
static const map_onesymbol2_t libcryptsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
static const map_onedata_t libcryptdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
static const map_onedata_t libcryptmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibcryptundefs.h" 1
...
int wrappedlibcrypt_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libcryptName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libcryptsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libcryptsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libcryptsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libcryptsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libcryptsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libcryptsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libcryptsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libcryptsymbolmap[i].name); }
 cnt = sizeof(libcryptmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libcryptmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libcryptmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libcryptmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libcryptmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libcryptmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libcryptmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libcryptmysymbolmap[i].name); }

    cnt = sizeof(libcryptstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libcryptstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libcryptstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libcryptstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libcryptstsymbolmap[i].name);
    }
    cnt = sizeof(libcryptsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libcryptsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libcryptsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libcryptsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libcryptsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libcryptsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libcryptsymbol2map[i].name);
    }
    cnt = sizeof(libcryptdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libcryptdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libcryptdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libcryptdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libcryptdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libcryptdatamap[i].sz;
        }
    }
    cnt = sizeof(libcryptmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libcryptmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libcryptmydatamap[i].sz;
    }
...
void wrappedlibcrypt_fini(library_t* lib)
{
...
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcrypt.c" 2
