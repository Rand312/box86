# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stdarg.h" 1 3 4
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
__attribute__((visibility("default"))) uintptr_t my_snd_lib_error = 0;
...
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibasoundtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibasoundtypes.h"
typedef int32_t (*iFp_t)(void*);
typedef void* (*pFppp_t)(void*, void*, void*);
typedef int32_t (*iFpipp_t)(void*, int32_t, void*, void*);
typedef int32_t (*iFpppp_t)(void*, void*, void*, void*);
typedef void* (*pFpipL_t)(void*, int32_t, void*, uintptr_t);
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
...
typedef struct libasound_my_s {


    iFp_t snd_dlclose; iFp_t snd_lib_error_set_handler; pFppp_t snd_dlsym; iFpipp_t snd_async_add_handler; iFpppp_t snd_async_add_pcm_handler; pFpipL_t snd_dlopen;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libasound_my_t my_libasound = {0};
static libasound_my_t * const my = &my_libasound;

static void getMy(library_t* lib)
{

    my->snd_dlclose = (iFp_t)dlsym(lib->w.lib, "snd_dlclose"); my->snd_lib_error_set_handler = (iFp_t)dlsym(lib->w.lib, "snd_lib_error_set_handler"); my->snd_dlsym = (pFppp_t)dlsym(lib->w.lib, "snd_dlsym"); my->snd_async_add_handler = (iFpipp_t)dlsym(lib->w.lib, "snd_async_add_handler"); my->snd_async_add_pcm_handler = (iFpppp_t)dlsym(lib->w.lib, "snd_async_add_pcm_handler"); my->snd_dlopen = (pFpipL_t)dlsym(lib->w.lib, "snd_dlopen");
...
# 45 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
static uintptr_t my_async_fct_0 = 0; static void* my_async_0(void* handler) { return (void*)RunFunctionFmt(my_async_fct_0, "p", handler); } static uintptr_t my_async_fct_1 = 0; static void* my_async_1(void* handler) { return (void*)RunFunctionFmt(my_async_fct_1, "p", handler); } static uintptr_t my_async_fct_2 = 0; static void* my_async_2(void* handler) { return (void*)RunFunctionFmt(my_async_fct_2, "p", handler); } static uintptr_t my_async_fct_3 = 0; static void* my_async_3(void* handler) { return (void*)RunFunctionFmt(my_async_fct_3, "p", handler); }
...
static void* findAsyncFct(void* fct)
{
    ...
    if(my_async_fct_0 == (uintptr_t)fct) return my_async_0; if(my_async_fct_1 == (uintptr_t)fct) return my_async_1; if(my_async_fct_2 == (uintptr_t)fct) return my_async_2; if(my_async_fct_3 == (uintptr_t)fct) return my_async_3;


    if(my_async_fct_0 == 0) {my_async_fct_0 = (uintptr_t)fct; return my_async_0; } if(my_async_fct_1 == 0) {my_async_fct_1 = (uintptr_t)fct; return my_async_1; } if(my_async_fct_2 == 0) {my_async_fct_2 = (uintptr_t)fct; return my_async_2; } if(my_async_fct_3 == 0) {my_async_fct_3 = (uintptr_t)fct; return my_async_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Asound Async callback\n"); fflush(ftrace);}} while(0);
    return 
# 72 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
          ((void *)0)
# 72 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
              ;
}


__attribute__((visibility("default"))) int my_snd_async_add_handler(x86emu_t *emu, void *handler, int fd, void* callback, void *private_data)
{
    (void)emu;
    return my->snd_async_add_handler(handler, fd, findAsyncFct(callback), private_data);
}

__attribute__((visibility("default"))) int my_snd_async_add_pcm_handler(x86emu_t *emu, void *handler, void* pcm, void* callback, void *private_data)
{
    (void)emu;
...
# 88 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
                                    ((void *)0)
# 88 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
                                        ;
...
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
   __builtin_va_start(
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
   ap
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
   ,
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
...
# 98 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
   __builtin_va_end(
# 98 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
   ap
# 98 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
   )
# 98 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
...
__attribute__((visibility("default"))) int my_snd_lib_error_set_handler(x86emu_t* emu, void* handler)
{
    (void)emu;
    ...
    if (code) {
        if (code && ((code[0] == 0xC3) || ((code[0] == 0xF3) && (code[1] == 0xC3)))) {
            ...
            do {if((0)<=box86_log) {fprintf(ftrace, "Warning: snd_lib_error_set_handler: using dummy error handler\n"); fflush(ftrace);}} while(0);
        }
    } else error_handler = 
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 3 4
                          ((void *)0)
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c"
                              ;
...
__attribute__((visibility("default"))) void * my_snd_dlopen(x86emu_t* emu, void* name, int mode, void* errbuf, size_t errbuflen)
{
    void* ret = my_dlopen(emu, name, mode);
    if(!ret && errbuf) {
        strncpy(errbuf, my_dlerror(emu), errbuflen);
    }
    return ret;
}
__attribute__((visibility("default"))) int my_snd_dlclose(x86emu_t* emu, void* handle)
{
    return my_dlclose(emu, handle);
}
__attribute__((visibility("default"))) void* my_snd_dlsym(x86emu_t* emu, void* handle, void* name, void* version)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibasounddefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libasoundsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
{"snd_async_handler_get_callback_private", pFp, 0},
{"snd_shm_area_create", pFip, 0},
{"snd_shm_area_share", pFp, 0},
{"snd_shm_area_destroy", iFp, 0},
{"snd_user_file", iFpp, 0},
{"snd_input_stdio_open", iFppp, 0},
{"snd_input_stdio_attach", iFppi, 0},
{"snd_input_buffer_open", iFppu, 0},
{"snd_input_close", iFp, 0},

{"snd_input_gets", pFppu, 0},
{"snd_input_getc", iFp, 0},
{"snd_input_ungetc", iFpi, 0},
{"snd_output_stdio_open", iFppp, 0},
{"snd_output_stdio_attach", iFppi, 0},
{"snd_output_buffer_open", iFp, 0},
{"snd_output_buffer_string", uFpp, 0},
{"snd_output_close", iFp, 0},


{"snd_output_puts", iFpp, 0},
{"snd_output_putc", iFpi, 0},
{"snd_output_flush", iFp, 0},
{"snd_strerror", pFi, 0},

{"snd_config_top", iFp, 0},
{"snd_config_load", iFpp, 0},
{"snd_config_load_override", iFpp, 0},
{"snd_config_save", iFpp, 0},
{"snd_config_update", iFv, 0},
{"snd_config_update_r", iFppp, 0},
{"snd_config_update_free", iFp, 0},
{"snd_config_update_free_global", iFv, 0},
{"snd_config_search", iFppp, 0},

{"snd_config_search_definition", iFpppp, 0},
{"snd_config_expand", iFppppp, 0},
{"snd_config_evaluate", iFpppp, 0},
{"snd_config_add", iFpp, 0},
{"snd_config_delete", iFp, 0},
{"snd_config_delete_compound_members", iFp, 0},
{"snd_config_copy", iFpp, 0},
{"snd_config_make", iFppi, 0},
{"snd_config_make_integer", iFpp, 0},
{"snd_config_make_integer64", iFpp, 0},
{"snd_config_make_real", iFpp, 0},
{"snd_config_make_string", iFpp, 0},
{"snd_config_make_pointer", iFpp, 0},
{"snd_config_make_compound", iFppi, 0},
{"snd_config_imake_integer", iFppi, 0},
{"snd_config_imake_integer64", iFppI, 0},
{"snd_config_imake_real", iFppd, 0},
{"snd_config_imake_string", iFppp, 0},
{"snd_config_imake_pointer", iFppp, 0},
{"snd_config_get_type", iFp, 0},
{"snd_config_set_id", iFpp, 0},
{"snd_config_set_integer", iFpi, 0},
{"snd_config_set_integer64", iFpI, 0},
{"snd_config_set_real", iFpd, 0},
{"snd_config_set_string", iFpp, 0},
{"snd_config_set_ascii", iFpp, 0},
{"snd_config_set_pointer", iFpp, 0},
{"snd_config_get_id", iFpp, 0},
{"snd_config_get_integer", iFpp, 0},
{"snd_config_get_integer64", iFpp, 0},
{"snd_config_get_real", iFpp, 0},
{"snd_config_get_ireal", iFpp, 0},
{"snd_config_get_string", iFpp, 0},
{"snd_config_get_ascii", iFpp, 0},
{"snd_config_get_pointer", iFpp, 0},
{"snd_config_test_id", iFpp, 0},
{"snd_config_iterator_first", pFp, 0},
{"snd_config_iterator_next", pFp, 0},
{"snd_config_iterator_end", pFp, 0},
{"snd_config_iterator_entry", pFp, 0},
{"snd_config_get_bool_ascii", iFp, 0},
{"snd_config_get_bool", iFp, 0},
{"snd_config_get_ctl_iface_ascii", iFp, 0},
{"snd_config_get_ctl_iface", iFp, 0},
{"snd_device_name_free_hint", iFp, 0},
{"snd_device_name_get_hint", pFpp, 0},
{"snd_device_name_hint", iFipp, 0},
{"snd_names_list", iFpp, 0},
{"snd_names_list_free", vFp, 0},
{"snd_pcm_format_mask_sizeof", uFv, 0},
{"snd_pcm_subformat_mask_sizeof", uFv, 0},
{"snd_pcm_status_sizeof", uFv, 0},

{"snd_async_handler_get_pcm", pFp, 0},
{"snd_pcm_access_mask_any", vFp, 0},
{"snd_pcm_access_mask_copy", vFpp, 0},
{"snd_pcm_access_mask_empty", iFp, 0},
{"snd_pcm_access_mask_free", vFp, 0},
{"snd_pcm_access_mask_malloc", iFp, 0},
{"snd_pcm_access_mask_none", vFp, 0},
{"snd_pcm_access_mask_reset", vFpi, 0},
{"snd_pcm_access_mask_set", vFpi, 0},
{"snd_pcm_access_mask_test", iFpi, 0},
{"snd_pcm_access_name", pFi, 0},
{"snd_pcm_area_copy", iFpupuui, 0},
{"snd_pcm_area_silence", iFpuui, 0},
{"snd_pcm_areas_copy", iFpupuuui, 0},
{"snd_pcm_areas_silence", iFpuuui, 0},
{"snd_pcm_avail", iFp, 0},
{"snd_pcm_avail_delay", iFppp, 0},
{"snd_pcm_avail_update", iFp, 0},
{"snd_pcm_build_linear_format", iFiiii, 0},
{"snd_pcm_bytes_to_frames", iFpu, 0},
{"snd_pcm_bytes_to_samples", iFpu, 0},
{"snd_pcm_chmap_type_name", pFi, 0},
{"snd_pcm_chmap_name", pFi, 0},
{"snd_pcm_chmap_long_name", pFi, 0},
{"snd_pcm_chmap_print", iFpup, 0},
{"snd_pcm_chmap_from_string", uFp, 0},
{"snd_pcm_chmap_parse_string", pFp, 0},
{"snd_pcm_close", iFp, 0},
{"snd_pcm_delay", iFpp, 0},
{"snd_pcm_drain", iFp, 0},
{"snd_pcm_drop", iFp, 0},
{"snd_pcm_dump", iFpp, 0},
{"snd_pcm_dump_hw_setup", iFpp, 0},
{"snd_pcm_dump_setup", iFpp, 0},
{"snd_pcm_dump_sw_setup", iFpp, 0},
{"snd_pcm_format_big_endian", iFi, 0},
{"snd_pcm_format_cpu_endian", iFi, 0},
{"snd_pcm_format_description", pFi, 0},
{"snd_pcm_format_float", iFi, 0},
{"snd_pcm_format_linear", iFi, 0},
{"snd_pcm_format_little_endian", iFi, 0},
{"snd_pcm_format_mask_any", vFp, 0},
{"snd_pcm_format_mask_copy", vFpp, 0},
{"snd_pcm_format_mask_empty", iFp, 0},
{"snd_pcm_format_mask_free", vFp, 0},
{"snd_pcm_format_mask_malloc", iFp, 0},
{"snd_pcm_format_mask_none", vFp, 0},
{"snd_pcm_format_mask_reset", vFpi, 0},
{"snd_pcm_format_mask_set", vFpi, 0},
{"snd_pcm_format_mask_test", iFpi, 0},
{"snd_pcm_format_name", pFi, 0},
{"snd_pcm_format_physical_width", iFi, 0},
{"snd_pcm_format_set_silence", iFipu, 0},
{"snd_pcm_format_signed", iFi, 0},
{"snd_pcm_format_silence", iFi, 0},
{"snd_pcm_format_silence_16", iFi, 0},
{"snd_pcm_format_silence_32", iFi, 0},
{"snd_pcm_format_silence_64", iFi, 0},
{"snd_pcm_format_size", uFiu, 0},
{"snd_pcm_format_unsigned", iFi, 0},
{"snd_pcm_format_value", iFp, 0},
{"snd_pcm_format_width", iFi, 0},
{"snd_pcm_forward", iFpu, 0},
{"snd_pcm_frames_to_bytes", uFpi, 0},
{"snd_pcm_get_params", iFppp, 0},
{"snd_pcm_get_chmap", pFp, 0},
{"snd_pcm_hook_add", iFppipp, 0},
{"snd_pcm_hook_get_pcm", pFp, 0},
{"snd_pcm_hook_get_private", pFp, 0},
{"snd_pcm_hook_remove", iFp, 0},
{"snd_pcm_hook_set_private", vFpp, 0},
{"snd_pcm_hw_free", iFp, 0},
{"snd_pcm_hw_params", iFpp, 0},
{"snd_pcm_hw_params_any", iFpp, 0},
{"snd_pcm_hw_params_can_mmap_sample_resolution", iFp, 0},
{"snd_pcm_hw_params_can_overrange", iFp, 0},
{"snd_pcm_hw_params_can_pause", iFp, 0},
{"snd_pcm_hw_params_can_resume", iFp, 0},
{"snd_pcm_hw_params_can_sync_start", iFp, 0},
{"snd_pcm_hw_params_copy", vFpp, 0},
{"snd_pcm_hw_params_current", iFpp, 0},
{"snd_pcm_hw_params_dump", iFpp, 0},
{"snd_pcm_hw_params_free", vFp, 0},
{"snd_pcm_hw_params_get_access", iFpp, 0},
{"snd_pcm_hw_params_get_access_mask", iFpp, 0},
{"snd_pcm_hw_params_get_buffer_size", iFpp, 0},
{"snd_pcm_hw_params_get_buffer_size_max", iFpp, 0},
{"snd_pcm_hw_params_get_buffer_size_min", iFpp, 0},
{"snd_pcm_hw_params_get_buffer_time", iFppp, 0},
{"snd_pcm_hw_params_get_buffer_time_max", iFppp, 0},
{"snd_pcm_hw_params_get_buffer_time_min", iFppp, 0},
{"snd_pcm_hw_params_get_channels", iFpp, 0},
{"snd_pcm_hw_params_get_channels_max", iFpp, 0},
{"snd_pcm_hw_params_get_channels_min", iFpp, 0},
{"snd_pcm_hw_params_get_export_buffer", iFppp, 0},
{"snd_pcm_hw_params_get_fifo_size", iFp, 0},
{"snd_pcm_hw_params_get_format", iFpp, 0},
{"snd_pcm_hw_params_get_format_mask", vFpp, 0},
{"snd_pcm_hw_params_get_min_align", iFpp, 0},
{"snd_pcm_hw_params_get_period_size", iFppp, 0},
{"snd_pcm_hw_params_get_period_size_max", iFppp, 0},
{"snd_pcm_hw_params_get_period_size_min", iFppp, 0},
{"snd_pcm_hw_params_get_period_time", iFppp, 0},
{"snd_pcm_hw_params_get_period_time_max", iFppp, 0},
{"snd_pcm_hw_params_get_period_time_min", iFppp, 0},
{"snd_pcm_hw_params_get_periods", iFppp, 0},
{"snd_pcm_hw_params_get_periods_max", iFppp, 0},
{"snd_pcm_hw_params_get_periods_min", iFppp, 0},
{"snd_pcm_hw_params_get_rate", iFppp, 0},
{"snd_pcm_hw_params_get_rate_max", iFppp, 0},
{"snd_pcm_hw_params_get_rate_min", iFppp, 0},
{"snd_pcm_hw_params_get_rate_numden", iFppp, 0},
{"snd_pcm_hw_params_get_rate_resample", iFppp, 0},
{"snd_pcm_hw_params_get_sbits", iFp, 0},
{"snd_pcm_hw_params_get_subformat", iFpp, 0},
{"snd_pcm_hw_params_get_subformat_mask", vFpp, 0},
{"snd_pcm_hw_params_get_tick_time", iFppp, 0},
{"snd_pcm_hw_params_get_tick_time_max", iFppp, 0},
{"snd_pcm_hw_params_get_tick_time_min", iFppp, 0},
{"snd_pcm_hw_params_is_batch", iFp, 0},
{"snd_pcm_hw_params_is_block_transfer", iFp, 0},
{"snd_pcm_hw_params_is_double", iFp, 0},
{"snd_pcm_hw_params_is_half_duplex", iFp, 0},
{"snd_pcm_hw_params_is_joint_duplex", iFp, 0},
{"snd_pcm_hw_params_malloc", iFp, 0},
{"snd_pcm_hw_params_set_access", iFppi, 0},
{"snd_pcm_hw_params_set_access_first", iFppp, 0},
{"snd_pcm_hw_params_set_access_last", iFppp, 0},
{"snd_pcm_hw_params_set_access_mask", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_size", iFppu, 0},
{"snd_pcm_hw_params_set_buffer_size_first", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_size_last", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_size_max", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_size_min", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_size_minmax", iFpppp, 0},
{"snd_pcm_hw_params_set_buffer_size_near", iFppp, 0},
{"snd_pcm_hw_params_set_buffer_time", iFppui, 0},
{"snd_pcm_hw_params_set_buffer_time_first", iFpppp, 0},
{"snd_pcm_hw_params_set_buffer_time_last", iFpppp, 0},
{"snd_pcm_hw_params_set_buffer_time_max", iFpppp, 0},
{"snd_pcm_hw_params_set_buffer_time_min", iFpppp, 0},
{"snd_pcm_hw_params_set_buffer_time_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_buffer_time_near", iFpppp, 0},
{"snd_pcm_hw_params_set_channels", iFppu, 0},
{"snd_pcm_hw_params_set_channels_first", iFppp, 0},
{"snd_pcm_hw_params_set_channels_last", iFppp, 0},
{"snd_pcm_hw_params_set_channels_max", iFppp, 0},
{"snd_pcm_hw_params_set_channels_min", iFppp, 0},
{"snd_pcm_hw_params_set_channels_minmax", iFpppp, 0},
{"snd_pcm_hw_params_set_channels_near", iFppp, 0},
{"snd_pcm_hw_params_set_export_buffer", iFppu, 0},
{"snd_pcm_hw_params_set_format", iFppi, 0},
{"snd_pcm_hw_params_set_format_first", iFppp, 0},
{"snd_pcm_hw_params_set_format_last", iFppp, 0},
{"snd_pcm_hw_params_set_format_mask", iFppp, 0},
{"snd_pcm_hw_params_set_period_size", iFppui, 0},
{"snd_pcm_hw_params_set_period_size_first", iFpppp, 0},
{"snd_pcm_hw_params_set_period_size_integer", iFpp, 0},
{"snd_pcm_hw_params_set_period_size_last", iFpppp, 0},
{"snd_pcm_hw_params_set_period_size_max", iFpppp, 0},
{"snd_pcm_hw_params_set_period_size_min", iFpppp, 0},
{"snd_pcm_hw_params_set_period_size_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_period_size_near", iFpppp, 0},
{"snd_pcm_hw_params_set_period_time", iFppui, 0},
{"snd_pcm_hw_params_set_period_time_first", iFpppp, 0},
{"snd_pcm_hw_params_set_period_time_last", iFpppp, 0},
{"snd_pcm_hw_params_set_period_time_max", iFpppp, 0},
{"snd_pcm_hw_params_set_period_time_min", iFpppp, 0},
{"snd_pcm_hw_params_set_period_time_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_period_time_near", iFpppp, 0},
{"snd_pcm_hw_params_set_periods", iFppui, 0},
{"snd_pcm_hw_params_set_periods_first", iFpppp, 0},
{"snd_pcm_hw_params_set_periods_integer", iFpp, 0},
{"snd_pcm_hw_params_set_periods_last", iFpppp, 0},
{"snd_pcm_hw_params_set_periods_max", iFpppp, 0},
{"snd_pcm_hw_params_set_periods_min", iFpppp, 0},
{"snd_pcm_hw_params_set_periods_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_periods_near", iFpppp, 0},
{"snd_pcm_hw_params_set_rate", iFppui, 0},
{"snd_pcm_hw_params_set_rate_first", iFpppp, 0},
{"snd_pcm_hw_params_set_rate_last", iFpppp, 0},
{"snd_pcm_hw_params_set_rate_max", iFpppp, 0},
{"snd_pcm_hw_params_set_rate_min", iFpppp, 0},
{"snd_pcm_hw_params_set_rate_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_rate_near", iFpppp, 0},
{"snd_pcm_hw_params_set_rate_resample", iFppu, 0},
{"snd_pcm_hw_params_set_subformat", iFppi, 0},
{"snd_pcm_hw_params_set_subformat_first", iFppp, 0},
{"snd_pcm_hw_params_set_subformat_last", iFppp, 0},
{"snd_pcm_hw_params_set_subformat_mask", iFppp, 0},
{"snd_pcm_hw_params_set_tick_time", iFppui, 0},
{"snd_pcm_hw_params_set_tick_time_first", iFpppp, 0},
{"snd_pcm_hw_params_set_tick_time_last", iFpppp, 0},
{"snd_pcm_hw_params_set_tick_time_max", iFpppp, 0},
{"snd_pcm_hw_params_set_tick_time_min", iFpppp, 0},
{"snd_pcm_hw_params_set_tick_time_minmax", iFpppppp, 0},
{"snd_pcm_hw_params_set_tick_time_near", iFpppp, 0},
{"snd_pcm_hw_params_test_access", iFppi, 0},
{"snd_pcm_hw_params_test_buffer_size", iFppu, 0},
{"snd_pcm_hw_params_test_buffer_time", iFppui, 0},
{"snd_pcm_hw_params_test_channels", iFppu, 0},
{"snd_pcm_hw_params_test_format", iFppi, 0},
{"snd_pcm_hw_params_test_period_size", iFppui, 0},
{"snd_pcm_hw_params_test_period_time", iFppui, 0},
{"snd_pcm_hw_params_test_periods", iFppui, 0},
{"snd_pcm_hw_params_test_rate", iFppui, 0},
{"snd_pcm_hw_params_test_subformat", iFppi, 0},
{"snd_pcm_hw_params_test_tick_time", iFppui, 0},
{"snd_pcm_hwsync", iFp, 0},
{"snd_pcm_info", iFpp, 0},
{"snd_pcm_info_copy", vFpp, 0},
{"snd_pcm_info_free", vFp, 0},
{"snd_pcm_info_get_card", iFp, 0},
{"snd_pcm_info_get_class", iFp, 0},
{"snd_pcm_info_get_device", uFp, 0},
{"snd_pcm_info_get_id", pFp, 0},
{"snd_pcm_info_get_name", pFp, 0},
{"snd_pcm_info_get_stream", iFp, 0},
{"snd_pcm_info_get_subclass", iFp, 0},
{"snd_pcm_info_get_subdevice", uFp, 0},
{"snd_pcm_info_get_subdevice_name", pFp, 0},
{"snd_pcm_info_get_subdevices_avail", uFp, 0},
{"snd_pcm_info_get_subdevices_count", uFp, 0},
{"snd_pcm_info_get_sync", pFp, 0},
{"snd_pcm_info_malloc", iFp, 0},
{"snd_pcm_info_sizeof", uFv, 0},
{"snd_pcm_access_mask_sizeof", uFv, 0},
{"snd_pcm_info_set_device", vFpu, 0},
{"snd_pcm_info_set_stream", vFpi, 0},
{"snd_pcm_info_set_subdevice", vFpu, 0},
{"snd_pcm_link", iFpp, 0},
{"snd_pcm_meter_add_scope", iFpp, 0},
{"snd_pcm_meter_get_boundary", uFp, 0},
{"snd_pcm_meter_get_bufsize", uFp, 0},
{"snd_pcm_meter_get_channels", uFp, 0},
{"snd_pcm_meter_get_now", uFp, 0},
{"snd_pcm_meter_get_rate", uFp, 0},
{"snd_pcm_meter_search_scope", pFpp, 0},
{"snd_pcm_mmap_begin", iFpppp, 0},
{"snd_pcm_mmap_commit", iFpuu, 0},
{"snd_pcm_mmap_readi", iFppu, 0},
{"snd_pcm_mmap_readn", iFppu, 0},
{"snd_pcm_mmap_writei", iFppu, 0},
{"snd_pcm_mmap_writen", iFppu, 0},
{"snd_pcm_name", pFp, 0},
{"snd_pcm_nonblock", iFpi, 0},
{"snd_pcm_open", iFppii, 0},
{"snd_pcm_open_lconf", iFppiip, 0},
{"snd_pcm_pause", iFpi, 0},
{"snd_pcm_poll_descriptors", iFppu, 0},
{"snd_pcm_poll_descriptors_count", iFp, 0},
{"snd_pcm_poll_descriptors_revents", iFppup, 0},
{"snd_pcm_prepare", iFp, 0},
{"snd_pcm_readi", iFppu, 0},
{"snd_pcm_readn", iFppu, 0},
{"snd_pcm_recover", iFpii, 0},
{"snd_pcm_reset", iFp, 0},
{"snd_pcm_resume", iFp, 0},
{"snd_pcm_rewind", iFpu, 0},
{"snd_pcm_samples_to_bytes", uFpi, 0},

{"snd_pcm_scope_get_name", pFp, 0},
{"snd_pcm_scope_malloc", iFp, 0},
{"snd_pcm_scope_s16_get_channel_buffer", pFpu, 0},
{"snd_pcm_scope_s16_open", iFppp, 0},

{"snd_pcm_hw_params_sizeof", uFv, 0},
{"snd_pcm_sw_params_sizeof", uFv, 0},
{"snd_pcm_hw_params_is_monotonic", iFp, 0},
{"snd_pcm_scope_set_name", vFpp, 0},

{"snd_pcm_set_chmap", iFpp, 0},
{"snd_pcm_set_params", iFpiiuuiu, 0},
{"snd_pcm_start", iFp, 0},
{"snd_pcm_start_mode_name", pFi, 0},
{"snd_pcm_state", iFp, 0},
{"snd_pcm_state_name", pFi, 0},
{"snd_pcm_status", iFpp, 0},
{"snd_pcm_status_copy", vFpp, 0},
{"snd_pcm_status_dump", iFpp, 0},
{"snd_pcm_status_free", vFp, 0},
{"snd_pcm_status_get_avail", uFp, 0},
{"snd_pcm_status_get_avail_max", uFp, 0},
{"snd_pcm_status_get_delay", iFp, 0},
{"snd_pcm_status_get_htstamp", vFpp, 0},
{"snd_pcm_status_get_overrange", uFp, 0},
{"snd_pcm_status_get_state", iFp, 0},
{"snd_pcm_status_get_trigger_htstamp", vFpp, 0},
{"snd_pcm_status_get_trigger_tstamp", vFpp, 0},
{"snd_pcm_status_get_tstamp", vFpp, 0},
{"snd_pcm_status_malloc", iFp, 0},
{"snd_pcm_stream", iFp, 0},
{"snd_pcm_stream_name", pFi, 0},
{"snd_pcm_subformat_description", pFi, 0},
{"snd_pcm_subformat_mask_any", vFp, 0},
{"snd_pcm_subformat_mask_copy", vFpp, 0},
{"snd_pcm_subformat_mask_empty", iFp, 0},
{"snd_pcm_subformat_mask_free", vFp, 0},
{"snd_pcm_subformat_mask_malloc", iFp, 0},
{"snd_pcm_subformat_mask_none", vFp, 0},
{"snd_pcm_subformat_mask_reset", vFpi, 0},
{"snd_pcm_subformat_mask_set", vFpi, 0},
{"snd_pcm_subformat_mask_test", iFpi, 0},
{"snd_pcm_subformat_name", pFi, 0},
{"snd_pcm_sw_params", iFpp, 0},
{"snd_pcm_sw_params_copy", vFpp, 0},
{"snd_pcm_sw_params_current", iFpp, 0},
{"snd_pcm_sw_params_dump", iFpp, 0},
{"snd_pcm_sw_params_free", vFp, 0},
{"snd_pcm_sw_params_get_avail_min", iFpp, 0},
{"snd_pcm_sw_params_get_boundary", iFpp, 0},
{"snd_pcm_sw_params_get_silence_size", iFpp, 0},
{"snd_pcm_sw_params_get_silence_threshold", iFpp, 0},
{"snd_pcm_sw_params_get_sleep_min", iFpp, 0},
{"snd_pcm_sw_params_get_start_mode", iFp, 0},
{"snd_pcm_sw_params_get_start_threshold", iFpp, 0},
{"snd_pcm_sw_params_get_stop_threshold", iFpp, 0},
{"snd_pcm_sw_params_get_tstamp_mode", iFpp, 0},
{"snd_pcm_sw_params_get_xfer_align", iFpp, 0},
{"snd_pcm_sw_params_get_xrun_mode", iFp, 0},
{"snd_pcm_sw_params_malloc", iFp, 0},
{"snd_pcm_sw_params_set_avail_min", iFppu, 0},
{"snd_pcm_sw_params_set_silence_size", iFppu, 0},
{"snd_pcm_sw_params_set_silence_threshold", iFppu, 0},
{"snd_pcm_sw_params_set_sleep_min", iFppu, 0},
{"snd_pcm_sw_params_set_start_mode", iFppi, 0},
{"snd_pcm_sw_params_set_start_threshold", iFppu, 0},
{"snd_pcm_sw_params_set_stop_threshold", iFppu, 0},
{"snd_pcm_sw_params_set_tstamp_mode", iFppi, 0},
{"snd_pcm_sw_params_set_xfer_align", iFppu, 0},
{"snd_pcm_sw_params_set_xrun_mode", iFppi, 0},
{"snd_pcm_tstamp_mode_name", pFi, 0},
{"snd_pcm_type", iFp, 0},
{"snd_pcm_type_name", pFi, 0},
{"snd_pcm_unlink", iFp, 0},
{"snd_pcm_wait", iFpi, 0},
{"snd_pcm_writei", iFppu, 0},
{"snd_pcm_writen", iFppu, 0},
{"snd_pcm_xrun_mode_name", pFi, 0},
{"snd_spcm_init", iFpuuiiiii, 0},
{"snd_spcm_init_duplex", iFppuuiiiiii, 0},
{"snd_spcm_init_get_params", iFpppp, 0},
{"snd_rawmidi_open", iFpppi, 0},
{"snd_rawmidi_open_lconf", iFpppip, 0},
{"snd_rawmidi_close", iFp, 0},
{"snd_rawmidi_poll_descriptors_count", iFp, 0},
{"snd_rawmidi_poll_descriptors", iFppu, 0},
{"snd_rawmidi_poll_descriptors_revents", iFppup, 0},
{"snd_rawmidi_nonblock", iFpi, 0},
{"snd_rawmidi_info_sizeof", uFv, 0},
{"snd_rawmidi_info_malloc", iFp, 0},
{"snd_rawmidi_info_free", vFp, 0},
{"snd_rawmidi_info_copy", vFpp, 0},
{"snd_rawmidi_info_get_device", uFp, 0},
{"snd_rawmidi_info_get_subdevice", uFp, 0},
{"snd_rawmidi_info_get_stream", iFp, 0},
{"snd_rawmidi_info_get_card", iFp, 0},
{"snd_rawmidi_info_get_flags", uFp, 0},
{"snd_rawmidi_info_get_id", pFp, 0},
{"snd_rawmidi_info_get_name", pFp, 0},
{"snd_rawmidi_info_get_subdevice_name", pFp, 0},
{"snd_rawmidi_info_get_subdevices_count", uFp, 0},
{"snd_rawmidi_info_get_subdevices_avail", uFp, 0},
{"snd_rawmidi_info_set_device", vFpu, 0},
{"snd_rawmidi_info_set_subdevice", vFpu, 0},
{"snd_rawmidi_info_set_stream", vFpi, 0},
{"snd_rawmidi_info", iFpp, 0},
{"snd_rawmidi_params_sizeof", uFv, 0},
{"snd_rawmidi_params_malloc", iFp, 0},
{"snd_rawmidi_params_free", vFp, 0},
{"snd_rawmidi_params_copy", vFpp, 0},
{"snd_rawmidi_params_set_buffer_size", iFppu, 0},
{"snd_rawmidi_params_get_buffer_size", uFp, 0},
{"snd_rawmidi_params_set_avail_min", iFppu, 0},
{"snd_rawmidi_params_get_avail_min", uFp, 0},
{"snd_rawmidi_params_set_no_active_sensing", iFppi, 0},
{"snd_rawmidi_params_get_no_active_sensing", iFp, 0},
{"snd_rawmidi_params", iFpp, 0},
{"snd_rawmidi_params_current", iFpp, 0},
{"snd_rawmidi_status_sizeof", uFv, 0},
{"snd_rawmidi_status_malloc", iFp, 0},
{"snd_rawmidi_status_free", vFp, 0},
{"snd_rawmidi_status_copy", vFpp, 0},
{"snd_rawmidi_status_get_tstamp", vFpp, 0},
{"snd_rawmidi_status_get_avail", uFp, 0},
{"snd_rawmidi_status_get_xruns", uFp, 0},
{"snd_rawmidi_status", iFpp, 0},
{"snd_rawmidi_drain", iFp, 0},
{"snd_rawmidi_drop", iFp, 0},
{"snd_rawmidi_write", uFppu, 0},
{"snd_rawmidi_read", uFppu, 0},
{"snd_rawmidi_name", pFp, 0},
{"snd_rawmidi_type", iFp, 0},
{"snd_rawmidi_stream", iFp, 0},
{"snd_timer_query_open", iFppi, 0},
{"snd_timer_query_open_lconf", iFppip, 0},
{"snd_timer_query_close", iFp, 0},
{"snd_timer_query_next_device", iFpp, 0},
{"snd_timer_query_info", iFpp, 0},
{"snd_timer_query_params", iFpp, 0},
{"snd_timer_query_status", iFpp, 0},
{"snd_timer_open", iFppi, 0},
{"snd_timer_open_lconf", iFppip, 0},
{"snd_timer_close", iFp, 0},


{"snd_timer_poll_descriptors_count", iFp, 0},
{"snd_timer_poll_descriptors", iFppu, 0},
{"snd_timer_poll_descriptors_revents", iFppup, 0},
{"snd_timer_info", iFpp, 0},
{"snd_timer_params", iFpp, 0},
{"snd_timer_status", iFpp, 0},
{"snd_timer_start", iFp, 0},
{"snd_timer_stop", iFp, 0},
{"snd_timer_continue", iFp, 0},
{"snd_timer_read", uFppu, 0},
{"snd_timer_id_sizeof", uFv, 0},
{"snd_timer_id_malloc", iFp, 0},
{"snd_timer_id_free", vFp, 0},
{"snd_timer_id_copy", vFpp, 0},
{"snd_timer_id_set_class", vFpi, 0},
{"snd_timer_id_get_class", iFp, 0},
{"snd_timer_id_set_sclass", vFpi, 0},
{"snd_timer_id_get_sclass", iFp, 0},
{"snd_timer_id_set_card", vFpi, 0},
{"snd_timer_id_get_card", iFp, 0},
{"snd_timer_id_set_device", vFpi, 0},
{"snd_timer_id_get_device", iFp, 0},
{"snd_timer_id_set_subdevice", vFpi, 0},
{"snd_timer_id_get_subdevice", iFp, 0},
{"snd_timer_ginfo_sizeof", uFv, 0},
{"snd_timer_ginfo_malloc", iFp, 0},
{"snd_timer_ginfo_free", vFp, 0},
{"snd_timer_ginfo_copy", vFpp, 0},
{"snd_timer_ginfo_set_tid", iFpp, 0},
{"snd_timer_ginfo_get_tid", pFp, 0},
{"snd_timer_ginfo_get_flags", uFp, 0},
{"snd_timer_ginfo_get_card", iFp, 0},
{"snd_timer_ginfo_get_id", pFp, 0},
{"snd_timer_ginfo_get_name", pFp, 0},
{"snd_timer_ginfo_get_resolution", iFp, 0},
{"snd_timer_ginfo_get_resolution_min", iFp, 0},
{"snd_timer_ginfo_get_resolution_max", iFp, 0},
{"snd_timer_ginfo_get_clients", uFp, 0},
{"snd_timer_info_sizeof", uFv, 0},
{"snd_timer_info_malloc", iFp, 0},
{"snd_timer_info_free", vFp, 0},
{"snd_timer_info_copy", vFpp, 0},
{"snd_timer_info_is_slave", iFp, 0},
{"snd_timer_info_get_card", iFp, 0},
{"snd_timer_info_get_id", pFp, 0},
{"snd_timer_info_get_name", pFp, 0},
{"snd_timer_info_get_resolution", iFp, 0},
{"snd_timer_params_sizeof", uFv, 0},
{"snd_timer_params_malloc", iFp, 0},
{"snd_timer_params_free", vFp, 0},
{"snd_timer_params_copy", vFpp, 0},
{"snd_timer_params_set_auto_start", iFpi, 0},
{"snd_timer_params_get_auto_start", iFp, 0},
{"snd_timer_params_set_exclusive", iFpi, 0},
{"snd_timer_params_get_exclusive", iFp, 0},
{"snd_timer_params_set_early_event", iFpi, 0},
{"snd_timer_params_get_early_event", iFp, 0},
{"snd_timer_params_set_ticks", vFpi, 0},
{"snd_timer_params_get_ticks", iFp, 0},
{"snd_timer_params_set_queue_size", vFpi, 0},
{"snd_timer_params_get_queue_size", iFp, 0},
{"snd_timer_params_set_filter", vFpu, 0},
{"snd_timer_params_get_filter", uFp, 0},
{"snd_timer_status_sizeof", uFv, 0},
{"snd_timer_status_malloc", iFp, 0},
{"snd_timer_status_free", vFp, 0},
{"snd_timer_status_copy", vFpp, 0},
{"snd_timer_status_get_timestamp", iFp, 0},
{"snd_timer_status_get_resolution", iFp, 0},
{"snd_timer_status_get_lost", iFp, 0},
{"snd_timer_status_get_overrun", iFp, 0},
{"snd_timer_status_get_queue", iFp, 0},
{"snd_timer_info_get_ticks", iFp, 0},
{"snd_hwdep_open", iFppi, 0},
{"snd_hwdep_close", iFp, 0},
{"snd_hwdep_poll_descriptors", iFppu, 0},
{"snd_hwdep_poll_descriptors_revents", iFppup, 0},
{"snd_hwdep_nonblock", iFpi, 0},
{"snd_hwdep_info", iFpp, 0},
{"snd_hwdep_dsp_status", iFpp, 0},
{"snd_hwdep_dsp_load", iFpp, 0},
{"snd_hwdep_ioctl", iFpup, 0},
{"snd_hwdep_write", uFppu, 0},
{"snd_hwdep_read", uFppu, 0},
{"snd_hwdep_info_sizeof", uFv, 0},
{"snd_hwdep_dsp_status_sizeof", uFv, 0},
{"snd_hwdep_dsp_status_malloc", iFp, 0},
{"snd_hwdep_dsp_status_free", vFp, 0},
{"snd_hwdep_dsp_status_copy", vFpp, 0},
{"snd_hwdep_dsp_status_get_version", uFp, 0},
{"snd_hwdep_dsp_status_get_id", pFp, 0},
{"snd_hwdep_dsp_status_get_num_dsps", uFp, 0},
{"snd_hwdep_dsp_status_get_dsp_loaded", uFp, 0},
{"snd_hwdep_dsp_status_get_chip_ready", uFp, 0},
{"snd_hwdep_dsp_image_sizeof", uFv, 0},
{"snd_hwdep_dsp_image_malloc", iFp, 0},
{"snd_hwdep_dsp_image_free", vFp, 0},
{"snd_hwdep_dsp_image_copy", vFpp, 0},
{"snd_hwdep_dsp_image_get_index", uFp, 0},
{"snd_hwdep_dsp_image_get_name", pFp, 0},
{"snd_hwdep_dsp_image_get_image", pFp, 0},
{"snd_hwdep_dsp_image_get_length", uFp, 0},
{"snd_hwdep_dsp_image_set_index", vFpu, 0},
{"snd_hwdep_dsp_image_set_name", vFpp, 0},
{"snd_hwdep_dsp_image_set_image", vFpp, 0},
{"snd_hwdep_dsp_image_set_length", vFpu, 0},
{"snd_card_load", iFi, 0},
{"snd_card_next", iFp, 0},
{"snd_card_get_index", iFp, 0},
{"snd_card_get_name", iFip, 0},
{"snd_card_get_longname", iFip, 0},
{"snd_ctl_open", iFppi, 0},
{"snd_ctl_open_lconf", iFppip, 0},
{"snd_ctl_close", iFp, 0},
{"snd_ctl_nonblock", iFpi, 0},


{"snd_ctl_poll_descriptors_count", iFp, 0},
{"snd_ctl_poll_descriptors", iFppu, 0},
{"snd_ctl_poll_descriptors_revents", iFppup, 0},
{"snd_ctl_subscribe_events", iFpi, 0},
{"snd_ctl_card_info", iFpp, 0},
{"snd_ctl_elem_list", iFpp, 0},
{"snd_ctl_elem_info", iFpp, 0},
{"snd_ctl_elem_read", iFpp, 0},
{"snd_ctl_elem_write", iFpp, 0},
{"snd_ctl_elem_lock", iFpp, 0},
{"snd_ctl_elem_unlock", iFpp, 0},
{"snd_ctl_elem_tlv_read", iFpppu, 0},
{"snd_ctl_elem_tlv_write", iFppp, 0},
{"snd_ctl_elem_tlv_command", iFppp, 0},
{"snd_ctl_hwdep_next_device", iFpp, 0},
{"snd_ctl_hwdep_info", iFpp, 0},
{"snd_ctl_pcm_next_device", iFpp, 0},
{"snd_ctl_pcm_info", iFpp, 0},
{"snd_ctl_pcm_prefer_subdevice", iFpi, 0},
{"snd_ctl_rawmidi_next_device", iFpp, 0},
{"snd_ctl_rawmidi_info", iFpp, 0},
{"snd_ctl_rawmidi_prefer_subdevice", iFpi, 0},
{"snd_ctl_set_power_state", iFpu, 0},
{"snd_ctl_get_power_state", iFpp, 0},
{"snd_ctl_read", iFpp, 0},
{"snd_ctl_wait", iFpi, 0},
{"snd_ctl_name", pFp, 0},
{"snd_ctl_type", iFp, 0},
{"snd_ctl_elem_type_name", pFi, 0},
{"snd_ctl_elem_iface_name", pFi, 0},
{"snd_ctl_event_type_name", pFi, 0},
{"snd_ctl_event_elem_get_mask", uFp, 0},
{"snd_ctl_event_elem_get_numid", uFp, 0},
{"snd_ctl_event_elem_get_id", vFpp, 0},
{"snd_ctl_event_elem_get_interface", iFp, 0},
{"snd_ctl_event_elem_get_device", uFp, 0},
{"snd_ctl_event_elem_get_subdevice", uFp, 0},
{"snd_ctl_event_elem_get_name", pFp, 0},
{"snd_ctl_event_elem_get_index", uFp, 0},
{"snd_ctl_elem_list_alloc_space", iFpu, 0},
{"snd_ctl_elem_list_free_space", vFp, 0},
{"snd_ctl_elem_id_sizeof", uFv, 0},
{"snd_ctl_elem_id_malloc", iFp, 0},
{"snd_ctl_elem_id_free", vFp, 0},
{"snd_ctl_elem_id_clear", vFp, 0},
{"snd_ctl_elem_id_copy", vFpp, 0},
{"snd_ctl_elem_id_get_numid", uFp, 0},
{"snd_ctl_elem_id_get_interface", iFp, 0},
{"snd_ctl_elem_id_get_device", uFp, 0},
{"snd_ctl_elem_id_get_subdevice", uFp, 0},
{"snd_ctl_elem_id_get_name", pFp, 0},
{"snd_ctl_elem_id_get_index", uFp, 0},
{"snd_ctl_elem_id_set_numid", vFpu, 0},
{"snd_ctl_elem_id_set_interface", vFpi, 0},
{"snd_ctl_elem_id_set_device", vFpu, 0},
{"snd_ctl_elem_id_set_subdevice", vFpu, 0},
{"snd_ctl_elem_id_set_name", vFpp, 0},
{"snd_ctl_elem_id_set_index", vFpu, 0},
{"snd_ctl_card_info_sizeof", uFv, 0},
{"snd_ctl_card_info_malloc", iFp, 0},
{"snd_ctl_card_info_free", vFp, 0},
{"snd_ctl_card_info_clear", vFp, 0},
{"snd_ctl_card_info_copy", vFpp, 0},
{"snd_ctl_card_info_get_card", iFp, 0},
{"snd_ctl_card_info_get_id", pFp, 0},
{"snd_ctl_card_info_get_driver", pFp, 0},
{"snd_ctl_card_info_get_name", pFp, 0},
{"snd_ctl_card_info_get_longname", pFp, 0},
{"snd_ctl_card_info_get_mixername", pFp, 0},
{"snd_ctl_card_info_get_components", pFp, 0},
{"snd_ctl_event_sizeof", uFv, 0},
{"snd_ctl_event_malloc", iFp, 0},
{"snd_ctl_event_free", vFp, 0},
{"snd_ctl_event_clear", vFp, 0},
{"snd_ctl_event_copy", vFpp, 0},
{"snd_ctl_event_get_type", iFp, 0},
{"snd_ctl_elem_list_sizeof", uFv, 0},
{"snd_ctl_elem_list_malloc", iFp, 0},
{"snd_ctl_elem_list_free", vFp, 0},
{"snd_ctl_elem_list_clear", vFp, 0},
{"snd_ctl_elem_list_copy", vFpp, 0},
{"snd_ctl_elem_list_set_offset", vFpu, 0},
{"snd_ctl_elem_list_get_used", uFp, 0},
{"snd_ctl_elem_list_get_count", uFp, 0},
{"snd_ctl_elem_list_get_id", vFpup, 0},
{"snd_ctl_elem_list_get_numid", uFpu, 0},
{"snd_ctl_elem_list_get_interface", iFpu, 0},
{"snd_ctl_elem_list_get_device", uFpu, 0},
{"snd_ctl_elem_list_get_subdevice", uFpu, 0},
{"snd_ctl_elem_list_get_name", pFpu, 0},
{"snd_ctl_elem_list_get_index", uFpu, 0},
{"snd_ctl_elem_info_sizeof", uFv, 0},
{"snd_ctl_elem_info_malloc", iFp, 0},
{"snd_ctl_elem_info_free", vFp, 0},
{"snd_ctl_elem_info_clear", vFp, 0},
{"snd_ctl_elem_info_copy", vFpp, 0},
{"snd_ctl_elem_info_get_type", iFp, 0},
{"snd_ctl_elem_info_is_readable", iFp, 0},
{"snd_ctl_elem_info_is_writable", iFp, 0},
{"snd_ctl_elem_info_is_volatile", iFp, 0},
{"snd_ctl_elem_info_is_inactive", iFp, 0},
{"snd_ctl_elem_info_is_locked", iFp, 0},
{"snd_ctl_elem_info_is_tlv_readable", iFp, 0},
{"snd_ctl_elem_info_is_tlv_writable", iFp, 0},
{"snd_ctl_elem_info_is_tlv_commandable", iFp, 0},
{"snd_ctl_elem_info_is_owner", iFp, 0},
{"snd_ctl_elem_info_is_user", iFp, 0},
{"snd_ctl_elem_info_get_owner", iFp, 0},
{"snd_ctl_elem_info_get_count", uFp, 0},
{"snd_ctl_elem_info_get_min", iFp, 0},
{"snd_ctl_elem_info_get_max", iFp, 0},
{"snd_ctl_elem_info_get_step", iFp, 0},
{"snd_ctl_elem_info_get_min64", IFp, 0},
{"snd_ctl_elem_info_get_max64", IFp, 0},
{"snd_ctl_elem_info_get_step64", IFp, 0},
{"snd_ctl_elem_info_get_items", uFp, 0},
{"snd_ctl_elem_info_set_item", vFpu, 0},
{"snd_ctl_elem_info_get_item_name", pFp, 0},
{"snd_ctl_elem_info_get_dimensions", iFp, 0},
{"snd_ctl_elem_info_get_dimension", iFpu, 0},
{"snd_ctl_elem_info_get_id", vFpp, 0},
{"snd_ctl_elem_info_get_numid", uFp, 0},
{"snd_ctl_elem_info_get_interface", iFp, 0},
{"snd_ctl_elem_info_get_device", uFp, 0},
{"snd_ctl_elem_info_get_subdevice", uFp, 0},
{"snd_ctl_elem_info_get_name", pFp, 0},
{"snd_ctl_elem_info_get_index", uFp, 0},
{"snd_ctl_elem_info_set_id", vFpp, 0},
{"snd_ctl_elem_info_set_numid", vFpu, 0},
{"snd_ctl_elem_info_set_interface", vFpi, 0},
{"snd_ctl_elem_info_set_device", vFpu, 0},
{"snd_ctl_elem_info_set_subdevice", vFpu, 0},
{"snd_ctl_elem_info_set_name", vFpp, 0},
{"snd_ctl_elem_info_set_index", vFpu, 0},
{"snd_ctl_elem_add_integer", iFppuiii, 0},
{"snd_ctl_elem_add_integer64", iFppuIII, 0},
{"snd_ctl_elem_add_boolean", iFppu, 0},
{"snd_ctl_elem_add_iec958", iFpp, 0},
{"snd_ctl_elem_remove", iFpp, 0},
{"snd_ctl_elem_value_sizeof", uFv, 0},
{"snd_ctl_elem_value_malloc", iFp, 0},
{"snd_ctl_elem_value_free", vFp, 0},
{"snd_ctl_elem_value_clear", vFp, 0},
{"snd_ctl_elem_value_copy", vFpp, 0},
{"snd_ctl_elem_value_get_id", vFpp, 0},
{"snd_ctl_elem_value_get_numid", uFp, 0},
{"snd_ctl_elem_value_get_interface", iFp, 0},
{"snd_ctl_elem_value_get_device", uFp, 0},
{"snd_ctl_elem_value_get_subdevice", uFp, 0},
{"snd_ctl_elem_value_get_name", pFp, 0},
{"snd_ctl_elem_value_get_index", uFp, 0},
{"snd_ctl_elem_value_set_id", vFpp, 0},
{"snd_ctl_elem_value_set_numid", vFpu, 0},
{"snd_ctl_elem_value_set_interface", vFpi, 0},
{"snd_ctl_elem_value_set_device", vFpu, 0},
{"snd_ctl_elem_value_set_subdevice", vFpu, 0},
{"snd_ctl_elem_value_set_name", vFpp, 0},
{"snd_ctl_elem_value_set_index", vFpu, 0},
{"snd_ctl_elem_value_get_boolean", iFpu, 0},
{"snd_ctl_elem_value_get_integer", iFpu, 0},
{"snd_ctl_elem_value_get_integer64", IFpu, 0},
{"snd_ctl_elem_value_get_enumerated", uFpu, 0},
{"snd_ctl_elem_value_get_byte", CFpu, 0},
{"snd_ctl_elem_value_set_boolean", vFpui, 0},
{"snd_ctl_elem_value_set_integer", vFpui, 0},
{"snd_ctl_elem_value_set_integer64", vFpuI, 0},
{"snd_ctl_elem_value_set_enumerated", vFpuu, 0},
{"snd_ctl_elem_value_set_byte", vFpuu, 0},
{"snd_ctl_elem_set_bytes", vFppu, 0},
{"snd_ctl_elem_value_get_bytes", pFp, 0},
{"snd_ctl_elem_value_get_iec958", vFpp, 0},
{"snd_ctl_elem_value_set_iec958", vFpp, 0},
{"snd_hctl_compare_fast", iFpp, 0},
{"snd_hctl_open", iFppi, 0},
{"snd_hctl_open_ctl", iFpp, 0},
{"snd_hctl_close", iFp, 0},
{"snd_hctl_nonblock", iFpi, 0},
{"snd_hctl_poll_descriptors_count", iFp, 0},
{"snd_hctl_poll_descriptors", iFppu, 0},
{"snd_hctl_poll_descriptors_revents", iFppup, 0},
{"snd_hctl_get_count", uFp, 0},
{"snd_hctl_set_compare", iFpp, 0},
{"snd_hctl_first_elem", pFp, 0},
{"snd_hctl_last_elem", pFp, 0},
{"snd_hctl_find_elem", pFpp, 0},
...
{"snd_hctl_name", pFp, 0},
{"snd_hctl_wait", iFpi, 0},
{"snd_hctl_ctl", pFp, 0},
{"snd_hctl_elem_next", pFp, 0},
{"snd_hctl_elem_prev", pFp, 0},
{"snd_hctl_elem_info", iFpp, 0},
{"snd_hctl_elem_read", iFpp, 0},
{"snd_hctl_elem_write", iFpp, 0},
{"snd_hctl_elem_tlv_read", iFppu, 0},
{"snd_hctl_elem_tlv_write", iFpp, 0},
{"snd_hctl_elem_tlv_command", iFpp, 0},
{"snd_hctl_elem_get_hctl", pFp, 0},
{"snd_hctl_elem_get_id", vFpp, 0},
{"snd_hctl_elem_get_numid", uFp, 0},
{"snd_hctl_elem_get_interface", iFp, 0},
{"snd_hctl_elem_get_device", uFp, 0},
{"snd_hctl_elem_get_subdevice", uFp, 0},
{"snd_hctl_elem_get_name", pFp, 0},
{"snd_hctl_elem_get_index", uFp, 0},



{"snd_sctl_build", iFppppi, 0},
{"snd_sctl_free", iFp, 0},
{"snd_sctl_install", iFp, 0},
{"snd_sctl_remove", iFp, 0},
{"snd_mixer_open", iFpi, 0},
{"snd_mixer_close", iFp, 0},
{"snd_mixer_first_elem", pFp, 0},
{"snd_mixer_last_elem", pFp, 0},
{"snd_mixer_handle_events", iFp, 0},
{"snd_mixer_attach", iFpp, 0},
{"snd_mixer_attach_hctl", iFpp, 0},
{"snd_mixer_detach", iFpp, 0},
{"snd_mixer_detach_hctl", iFpp, 0},
{"snd_mixer_get_hctl", iFppp, 0},
{"snd_mixer_poll_descriptors_count", iFp, 0},
{"snd_mixer_poll_descriptors", iFppu, 0},
{"snd_mixer_poll_descriptors_revents", iFppup, 0},
{"snd_mixer_load", iFp, 0},
{"snd_mixer_free", vFp, 0},
{"snd_mixer_wait", iFpi, 0},
{"snd_mixer_set_compare", iFpp, 0},



{"snd_mixer_get_count", uFp, 0},
{"snd_mixer_class_unregister", iFp, 0},
{"snd_mixer_elem_next", pFp, 0},
{"snd_mixer_elem_prev", pFp, 0},



{"snd_mixer_elem_get_type", iFp, 0},

{"snd_mixer_add_elem", iFpp, 0},
{"snd_mixer_remove_elem", iFpp, 0},
{"snd_mixer_elem_new", iFpiipp, 0},
{"snd_mixer_elem_add", iFpp, 0},
{"snd_mixer_elem_remove", iFp, 0},
{"snd_mixer_elem_free", vFp, 0},
{"snd_mixer_elem_info", iFp, 0},
{"snd_mixer_elem_value", iFp, 0},
{"snd_mixer_elem_attach", iFpp, 0},
{"snd_mixer_elem_detach", iFpp, 0},
{"snd_mixer_elem_empty", iFp, 0},
{"snd_mixer_elem_get_private", pFp, 0},
{"snd_mixer_class_sizeof", uFv, 0},
{"snd_mixer_class_malloc", iFp, 0},
{"snd_mixer_class_free", vFp, 0},
{"snd_mixer_class_copy", vFpp, 0},
{"snd_mixer_class_get_mixer", pFp, 0},
{"snd_mixer_class_get_event", pFp, 0},
{"snd_mixer_class_get_private", pFp, 0},
{"snd_mixer_class_get_compare", pFp, 0},
{"snd_mixer_class_set_event", iFpp, 0},
{"snd_mixer_class_set_private", iFpp, 0},
{"snd_mixer_class_set_private_free", iFpp, 0},
{"snd_mixer_class_set_compare", iFpp, 0},
{"snd_mixer_selem_channel_name", pFi, 0},
{"snd_mixer_selem_register", iFppp, 0},
{"snd_mixer_selem_get_id", vFpp, 0},
{"snd_mixer_selem_get_name", pFp, 0},
{"snd_mixer_selem_get_index", uFp, 0},
{"snd_mixer_find_selem", pFpp, 0},
{"snd_mixer_selem_is_active", iFp, 0},
{"snd_mixer_selem_is_playback_mono", iFp, 0},
{"snd_mixer_selem_has_playback_channel", iFpi, 0},
{"snd_mixer_selem_is_capture_mono", iFp, 0},
{"snd_mixer_selem_has_capture_channel", iFpi, 0},
{"snd_mixer_selem_get_capture_group", iFp, 0},
{"snd_mixer_selem_has_common_volume", iFp, 0},
{"snd_mixer_selem_has_playback_volume", iFp, 0},
{"snd_mixer_selem_has_playback_volume_joined", iFp, 0},
{"snd_mixer_selem_has_capture_volume", iFp, 0},
{"snd_mixer_selem_has_capture_volume_joined", iFp, 0},
{"snd_mixer_selem_has_common_switch", iFp, 0},
{"snd_mixer_selem_has_playback_switch", iFp, 0},
{"snd_mixer_selem_has_playback_switch_joined", iFp, 0},
{"snd_mixer_selem_has_capture_switch", iFp, 0},
{"snd_mixer_selem_has_capture_switch_joined", iFp, 0},
{"snd_mixer_selem_has_capture_switch_exclusive", iFp, 0},
{"snd_mixer_selem_get_playback_volume", iFpip, 0},
{"snd_mixer_selem_get_capture_volume", iFpip, 0},
{"snd_mixer_selem_get_playback_dB", iFpip, 0},
{"snd_mixer_selem_get_capture_dB", iFpip, 0},
{"snd_mixer_selem_get_playback_switch", iFpip, 0},
{"snd_mixer_selem_get_capture_switch", iFpip, 0},
{"snd_mixer_selem_set_playback_volume", iFpii, 0},
{"snd_mixer_selem_set_capture_volume", iFpii, 0},
{"snd_mixer_selem_set_playback_dB", iFpiii, 0},
{"snd_mixer_selem_set_capture_dB", iFpiii, 0},
{"snd_mixer_selem_set_playback_volume_all", iFpi, 0},
{"snd_mixer_selem_set_capture_volume_all", iFpi, 0},
{"snd_mixer_selem_set_playback_dB_all", iFpii, 0},
{"snd_mixer_selem_set_capture_dB_all", iFpii, 0},
{"snd_mixer_selem_set_playback_switch", iFpii, 0},
{"snd_mixer_selem_set_capture_switch", iFpii, 0},
{"snd_mixer_selem_set_playback_switch_all", iFpi, 0},
{"snd_mixer_selem_set_capture_switch_all", iFpi, 0},
{"snd_mixer_selem_get_playback_volume_range", iFppp, 0},
{"snd_mixer_selem_get_playback_dB_range", iFppp, 0},
{"snd_mixer_selem_set_playback_volume_range", iFpii, 0},
{"snd_mixer_selem_get_capture_volume_range", iFppp, 0},
{"snd_mixer_selem_get_capture_dB_range", iFppp, 0},
{"snd_mixer_selem_set_capture_volume_range", iFpii, 0},
{"snd_mixer_selem_is_enumerated", iFp, 0},
{"snd_mixer_selem_is_enum_playback", iFp, 0},
{"snd_mixer_selem_is_enum_capture", iFp, 0},
{"snd_mixer_selem_get_enum_items", iFp, 0},
{"snd_mixer_selem_get_enum_item_name", iFpuup, 0},
{"snd_mixer_selem_get_enum_item", iFpip, 0},
{"snd_mixer_selem_set_enum_item", iFpiu, 0},
{"snd_mixer_selem_id_sizeof", uFv, 0},
{"snd_mixer_selem_id_malloc", iFp, 0},
{"snd_mixer_selem_id_free", vFp, 0},
{"snd_mixer_selem_id_copy", vFpp, 0},
{"snd_mixer_selem_id_get_name", pFp, 0},
{"snd_mixer_selem_id_get_index", uFp, 0},
{"snd_mixer_selem_id_set_name", vFpp, 0},
{"snd_mixer_selem_id_set_index", vFpu, 0},
{"snd_seq_open", iFppii, 0},
{"snd_seq_open_lconf", iFppiip, 0},
{"snd_seq_name", pFp, 0},
{"snd_seq_type", iFp, 0},
{"snd_seq_close", iFp, 0},
{"snd_seq_poll_descriptors_count", iFpw, 0},
{"snd_seq_poll_descriptors", iFppuw, 0},
{"snd_seq_poll_descriptors_revents", iFppup, 0},
{"snd_seq_nonblock", iFpi, 0},
{"snd_seq_client_id", iFp, 0},
{"snd_seq_get_output_buffer_size", uFp, 0},
{"snd_seq_get_input_buffer_size", uFp, 0},
{"snd_seq_set_output_buffer_size", iFpu, 0},
{"snd_seq_set_input_buffer_size", iFpu, 0},
{"snd_seq_system_info_sizeof", uFv, 0},
{"snd_seq_system_info_malloc", iFp, 0},
{"snd_seq_system_info_free", vFp, 0},
{"snd_seq_system_info_copy", vFpp, 0},
{"snd_seq_system_info_get_queues", iFp, 0},
{"snd_seq_system_info_get_clients", iFp, 0},
{"snd_seq_system_info_get_ports", iFp, 0},
{"snd_seq_system_info_get_channels", iFp, 0},
{"snd_seq_system_info_get_cur_clients", iFp, 0},
{"snd_seq_system_info_get_cur_queues", iFp, 0},
{"snd_seq_system_info", iFpp, 0},
{"snd_seq_client_info_sizeof", uFv, 0},
{"snd_seq_client_info_malloc", iFp, 0},
{"snd_seq_client_info_free", vFp, 0},
{"snd_seq_client_info_copy", vFpp, 0},
{"snd_seq_client_info_get_client", iFp, 0},
{"snd_seq_client_info_get_type", iFp, 0},
{"snd_seq_client_info_get_name", pFp, 0},
{"snd_seq_client_info_get_broadcast_filter", iFp, 0},
{"snd_seq_client_info_get_error_bounce", iFp, 0},
{"snd_seq_client_info_get_event_filter", pFp, 0},
{"snd_seq_client_info_get_num_ports", iFp, 0},
{"snd_seq_client_info_get_event_lost", iFp, 0},
{"snd_seq_client_info_set_client", vFpi, 0},
{"snd_seq_client_info_set_name", vFpp, 0},
{"snd_seq_client_info_set_broadcast_filter", vFpi, 0},
{"snd_seq_client_info_set_error_bounce", vFpi, 0},
{"snd_seq_client_info_set_event_filter", vFpp, 0},
{"snd_seq_get_client_info", iFpp, 0},
{"snd_seq_get_any_client_info", iFpip, 0},
{"snd_seq_set_client_info", iFpp, 0},
{"snd_seq_query_next_client", iFpp, 0},
{"snd_seq_client_pool_sizeof", uFv, 0},
{"snd_seq_client_pool_malloc", iFp, 0},
{"snd_seq_client_pool_free", vFp, 0},
{"snd_seq_client_pool_copy", vFpp, 0},
{"snd_seq_client_pool_get_client", iFp, 0},
{"snd_seq_client_pool_get_output_pool", uFp, 0},
{"snd_seq_client_pool_get_input_pool", uFp, 0},
{"snd_seq_client_pool_get_output_room", uFp, 0},
{"snd_seq_client_pool_get_output_free", uFp, 0},
{"snd_seq_client_pool_get_input_free", uFp, 0},
{"snd_seq_client_pool_set_output_pool", vFpu, 0},
{"snd_seq_client_pool_set_input_pool", vFpu, 0},
{"snd_seq_client_pool_set_output_room", vFpu, 0},
{"snd_seq_get_client_pool", iFpp, 0},
{"snd_seq_set_client_pool", iFpp, 0},
{"snd_seq_port_info_sizeof", uFv, 0},
{"snd_seq_port_info_malloc", iFp, 0},
{"snd_seq_port_info_free", vFp, 0},
{"snd_seq_port_info_copy", vFpp, 0},
{"snd_seq_port_info_get_client", iFp, 0},
{"snd_seq_port_info_get_port", iFp, 0},
{"snd_seq_port_info_get_addr", pFp, 0},
{"snd_seq_port_info_get_name", pFp, 0},
{"snd_seq_port_info_get_capability", uFp, 0},
{"snd_seq_port_info_get_type", uFp, 0},
{"snd_seq_port_info_get_midi_channels", iFp, 0},
{"snd_seq_port_info_get_midi_voices", iFp, 0},
{"snd_seq_port_info_get_synth_voices", iFp, 0},
{"snd_seq_port_info_get_read_use", iFp, 0},
{"snd_seq_port_info_get_write_use", iFp, 0},
{"snd_seq_port_info_get_port_specified", iFp, 0},
{"snd_seq_port_info_get_timestamping", iFp, 0},
{"snd_seq_port_info_get_timestamp_real", iFp, 0},
{"snd_seq_port_info_get_timestamp_queue", iFp, 0},
{"snd_seq_port_info_set_client", vFpi, 0},
{"snd_seq_port_info_set_port", vFpi, 0},
{"snd_seq_port_info_set_addr", vFpp, 0},
{"snd_seq_port_info_set_name", vFpp, 0},
{"snd_seq_port_info_set_capability", vFpu, 0},
{"snd_seq_port_info_set_type", vFpu, 0},
{"snd_seq_port_info_set_midi_channels", vFpi, 0},
{"snd_seq_port_info_set_midi_voices", vFpi, 0},
{"snd_seq_port_info_set_synth_voices", vFpi, 0},
{"snd_seq_port_info_set_port_specified", vFpi, 0},
{"snd_seq_port_info_set_timestamping", vFpi, 0},
{"snd_seq_port_info_set_timestamp_real", vFpi, 0},
{"snd_seq_port_info_set_timestamp_queue", vFpi, 0},
{"snd_seq_create_port", iFpp, 0},
{"snd_seq_delete_port", iFpi, 0},
{"snd_seq_get_port_info", iFpip, 0},
{"snd_seq_get_any_port_info", iFpiip, 0},
{"snd_seq_set_port_info", iFpip, 0},
{"snd_seq_query_next_port", iFpp, 0},
{"snd_seq_port_subscribe_sizeof", uFv, 0},
{"snd_seq_port_subscribe_malloc", iFp, 0},
{"snd_seq_port_subscribe_free", vFp, 0},
{"snd_seq_port_subscribe_copy", vFpp, 0},
{"snd_seq_port_subscribe_get_sender", pFp, 0},
{"snd_seq_port_subscribe_get_dest", pFp, 0},
{"snd_seq_port_subscribe_get_queue", iFp, 0},
{"snd_seq_port_subscribe_get_exclusive", iFp, 0},
{"snd_seq_port_subscribe_get_time_update", iFp, 0},
{"snd_seq_port_subscribe_get_time_real", iFp, 0},
{"snd_seq_port_subscribe_set_sender", vFpp, 0},
{"snd_seq_port_subscribe_set_dest", vFpp, 0},
{"snd_seq_port_subscribe_set_queue", vFpi, 0},
{"snd_seq_port_subscribe_set_exclusive", vFpi, 0},
{"snd_seq_port_subscribe_set_time_update", vFpi, 0},
{"snd_seq_port_subscribe_set_time_real", vFpi, 0},
{"snd_seq_get_port_subscription", iFpp, 0},
{"snd_seq_subscribe_port", iFpp, 0},
{"snd_seq_unsubscribe_port", iFpp, 0},
{"snd_seq_query_subscribe_sizeof", uFv, 0},
{"snd_seq_query_subscribe_malloc", iFp, 0},
{"snd_seq_query_subscribe_free", vFp, 0},
{"snd_seq_query_subscribe_copy", vFpp, 0},
{"snd_seq_query_subscribe_get_client", iFp, 0},
{"snd_seq_query_subscribe_get_port", iFp, 0},
{"snd_seq_query_subscribe_get_root", pFp, 0},
{"snd_seq_query_subscribe_get_type", iFp, 0},
{"snd_seq_query_subscribe_get_index", iFp, 0},
{"snd_seq_query_subscribe_get_num_subs", iFp, 0},
{"snd_seq_query_subscribe_get_addr", pFp, 0},
{"snd_seq_query_subscribe_get_queue", iFp, 0},
{"snd_seq_query_subscribe_get_exclusive", iFp, 0},
{"snd_seq_query_subscribe_get_time_update", iFp, 0},
{"snd_seq_query_subscribe_get_time_real", iFp, 0},
{"snd_seq_query_subscribe_set_client", vFpi, 0},
{"snd_seq_query_subscribe_set_port", vFpi, 0},
{"snd_seq_query_subscribe_set_root", vFpp, 0},
{"snd_seq_query_subscribe_set_type", vFpi, 0},
{"snd_seq_query_subscribe_set_index", vFpi, 0},
{"snd_seq_query_port_subscribers", iFpp, 0},
{"snd_seq_queue_info_sizeof", uFv, 0},
{"snd_seq_queue_info_malloc", iFp, 0},
{"snd_seq_queue_info_free", vFp, 0},
{"snd_seq_queue_info_copy", vFpp, 0},
{"snd_seq_queue_info_get_queue", iFp, 0},
{"snd_seq_queue_info_get_name", pFp, 0},
{"snd_seq_queue_info_get_owner", iFp, 0},
{"snd_seq_queue_info_get_locked", iFp, 0},
{"snd_seq_queue_info_get_flags", uFp, 0},
{"snd_seq_queue_info_set_name", vFpp, 0},
{"snd_seq_queue_info_set_owner", vFpi, 0},
{"snd_seq_queue_info_set_locked", vFpi, 0},
{"snd_seq_queue_info_set_flags", vFpu, 0},
{"snd_seq_create_queue", iFpp, 0},
{"snd_seq_alloc_named_queue", iFpp, 0},
{"snd_seq_alloc_queue", iFp, 0},
{"snd_seq_free_queue", iFpi, 0},
{"snd_seq_get_queue_info", iFpip, 0},
{"snd_seq_set_queue_info", iFpip, 0},
{"snd_seq_query_named_queue", iFpp, 0},
{"snd_seq_get_queue_usage", iFpi, 0},
{"snd_seq_set_queue_usage", iFpii, 0},
{"snd_seq_queue_status_sizeof", uFv, 0},
{"snd_seq_queue_status_malloc", iFp, 0},
{"snd_seq_queue_status_free", vFp, 0},
{"snd_seq_queue_status_copy", vFpp, 0},
{"snd_seq_queue_status_get_queue", iFp, 0},
{"snd_seq_queue_status_get_events", iFp, 0},
{"snd_seq_queue_status_get_tick_time", uFp, 0},
{"snd_seq_queue_status_get_real_time", pFp, 0},
{"snd_seq_queue_status_get_status", uFp, 0},
{"snd_seq_get_queue_status", iFpip, 0},
{"snd_seq_queue_tempo_sizeof", uFv, 0},
{"snd_seq_queue_tempo_malloc", iFp, 0},
{"snd_seq_queue_tempo_free", vFp, 0},
{"snd_seq_queue_tempo_copy", vFpp, 0},
{"snd_seq_queue_tempo_get_queue", iFp, 0},
{"snd_seq_queue_tempo_get_tempo", uFp, 0},
{"snd_seq_queue_tempo_get_ppq", iFp, 0},
{"snd_seq_queue_tempo_get_skew", uFp, 0},
{"snd_seq_queue_tempo_get_skew_base", uFp, 0},
{"snd_seq_queue_tempo_set_tempo", vFpu, 0},
{"snd_seq_queue_tempo_set_ppq", vFpi, 0},
{"snd_seq_queue_tempo_set_skew", vFpu, 0},
{"snd_seq_queue_tempo_set_skew_base", vFpu, 0},
{"snd_seq_get_queue_tempo", iFpip, 0},
{"snd_seq_set_queue_tempo", iFpip, 0},
{"snd_seq_queue_timer_sizeof", uFv, 0},
{"snd_seq_queue_timer_malloc", iFp, 0},
{"snd_seq_queue_timer_free", vFp, 0},
{"snd_seq_queue_timer_copy", vFpp, 0},
{"snd_seq_queue_timer_get_queue", iFp, 0},
{"snd_seq_queue_timer_get_type", iFp, 0},
{"snd_seq_queue_timer_get_id", pFp, 0},
{"snd_seq_queue_timer_get_resolution", uFp, 0},
{"snd_seq_queue_timer_set_type", vFpi, 0},
{"snd_seq_queue_timer_set_id", vFpp, 0},
{"snd_seq_queue_timer_set_resolution", vFpu, 0},
{"snd_seq_get_queue_timer", iFpip, 0},
{"snd_seq_set_queue_timer", iFpip, 0},
{"snd_seq_free_event", iFp, 0},
{"snd_seq_event_length", uFp, 0},
{"snd_seq_event_output", iFpp, 0},
{"snd_seq_event_output_buffer", iFpp, 0},
{"snd_seq_event_output_direct", iFpp, 0},
{"snd_seq_event_input", iFpp, 0},
{"snd_seq_event_input_pending", iFpi, 0},
{"snd_seq_drain_output", iFp, 0},
{"snd_seq_event_output_pending", iFp, 0},
{"snd_seq_extract_output", iFpp, 0},
{"snd_seq_drop_output", iFp, 0},
{"snd_seq_drop_output_buffer", iFp, 0},
{"snd_seq_drop_input", iFp, 0},
{"snd_seq_drop_input_buffer", iFp, 0},
{"snd_seq_remove_events_sizeof", uFv, 0},
{"snd_seq_remove_events_malloc", iFp, 0},
{"snd_seq_remove_events_free", vFp, 0},
{"snd_seq_remove_events_copy", vFpp, 0},
{"snd_seq_remove_events_get_condition", uFp, 0},
{"snd_seq_remove_events_get_queue", iFp, 0},
{"snd_seq_remove_events_get_time", pFp, 0},
{"snd_seq_remove_events_get_dest", pFp, 0},
{"snd_seq_remove_events_get_channel", iFp, 0},
{"snd_seq_remove_events_get_event_type", iFp, 0},
{"snd_seq_remove_events_get_tag", iFp, 0},
{"snd_seq_remove_events_set_condition", vFpu, 0},
{"snd_seq_remove_events_set_queue", vFpi, 0},
{"snd_seq_remove_events_set_time", vFpp, 0},
{"snd_seq_remove_events_set_dest", vFpp, 0},
{"snd_seq_remove_events_set_channel", vFpi, 0},
{"snd_seq_remove_events_set_event_type", vFpi, 0},
{"snd_seq_remove_events_set_tag", vFpi, 0},
{"snd_seq_remove_events", iFpp, 0},
{"snd_seq_set_bit", vFip, 0},
{"snd_seq_change_bit", iFip, 0},
{"snd_seq_get_bit", iFip, 0},
{"snd_midi_event_new", iFup, 0},
{"snd_midi_event_resize_buffer", iFpu, 0},
{"snd_midi_event_free", vFp, 0},
{"snd_midi_event_init", vFp, 0},
{"snd_midi_event_reset_encode", vFp, 0},
{"snd_midi_event_reset_decode", vFp, 0},
{"snd_midi_event_no_status", vFpi, 0},
{"snd_midi_event_encode", iFppip, 0},
{"snd_midi_event_encode_byte", iFpip, 0},
{"snd_midi_event_decode", iFppip, 0},
{"snd_seq_control_queue", iFpiiip, 0},
{"snd_seq_create_simple_port", iFppuu, 0},
{"snd_seq_delete_simple_port", iFpi, 0},
{"snd_seq_connect_from", iFpiii, 0},
{"snd_seq_connect_to", iFpiii, 0},
{"snd_seq_disconnect_from", iFpiii, 0},
{"snd_seq_disconnect_to", iFpiii, 0},
{"snd_seq_set_client_name", iFpp, 0},
{"snd_seq_set_client_event_filter", iFpi, 0},
{"snd_seq_set_client_pool_output_room", iFpu, 0},
{"snd_seq_set_client_pool_input", iFpu, 0},
{"snd_seq_reset_pool_output", iFp, 0},
{"snd_seq_reset_pool_input", iFp, 0},
{"snd_seq_sync_output_queue", iFp, 0},
{"snd_seq_parse_address", iFppp, 0},

{"snd_hwdep_info_get_iface", iFp, 0},

{"superdummy_error_handler", vFpipipV, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libasoundmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
{"snd_dlopen", pFEpipL, 0},
{"snd_dlsym", pFEppp, 0},
{"snd_dlclose", iFEp, 0},
{"snd_async_add_handler", iFEpipp, 0},
...
{"snd_lib_error_set_handler", iFEp, 0},
...
{"snd_async_add_pcm_handler", iFEpppp, 0},
...
static const map_onesymbol_t libasoundstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
static const map_onesymbol2_t libasoundsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
static const map_onedata_t libasounddatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
{"alsa_lisp_t", 4, 0},
{"snd_config", 4, 0},
{"_snd_config_hook_load_dlsym_config_hook_001", 4, 0},
{"_snd_config_hook_load_for_all_cards_dlsym_config_hook_001", 4, 0},
{"__snd_ctl_hw_open_dlsym_control_001", 4, 0},
{"__snd_ctl_shm_open_dlsym_control_001", 4, 0},
{"_snd_func_card_driver_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_card_id_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_card_inum_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_card_name_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_concat_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_datadir_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_getenv_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_iadd_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_igetenv_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_imul_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_pcm_args_by_class_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_pcm_id_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_private_card_driver_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_private_pcm_subdevice_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_private_string_dlsym_config_evaluate_001", 4, 0},
{"_snd_func_refer_dlsym_config_evaluate_001", 4, 0},
{"__snd_hwdep_hw_open_dlsym_hwdep_001", 4, 0},
{"__snd_pcm_adpcm_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_alaw_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_asym_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_copy_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_dmix_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_dshare_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_dsnoop_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_empty_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_file_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_hook_ctl_elems_install_dlsym_pcm_001", 4, 0},
{"__snd_pcm_hooks_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_hw_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_iec958_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_ladspa_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_lfloat_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_linear_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_mmap_emul_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_mulaw_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_multi_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_null_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_plug_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_rate_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_route_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_share_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_shm_open_dlsym_pcm_001", 4, 0},
{"__snd_pcm_softvol_open_dlsym_pcm_001", 4, 0},
{"__snd_rawmidi_hw_open_dlsym_rawmidi_001", 4, 0},
{"__snd_rawmidi_virtual_open_dlsym_rawmidi_001", 4, 0},
{"__snd_seq_hw_open_dlsym_seq_001", 4, 0},
{"__snd_timer_hw_open_dlsym_timer_001", 4, 0},
{"__snd_timer_query_hw_open_dlsym_timer_query_001", 4, 0},
...
static const map_onedata_t libasoundmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibasoundundefs.h" 1
...
int wrappedlibasound_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libasoundName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libasoundName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libasoundsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libasoundsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libasoundsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libasoundsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libasoundsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libasoundsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libasoundsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libasoundsymbolmap[i].name); }
 cnt = sizeof(libasoundmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libasoundmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libasoundmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libasoundmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libasoundmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libasoundmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libasoundmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libasoundmysymbolmap[i].name); }

    cnt = sizeof(libasoundstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libasoundstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libasoundstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libasoundstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libasoundstsymbolmap[i].name);
    }
    cnt = sizeof(libasoundsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libasoundsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libasoundsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libasoundsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libasoundsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libasoundsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libasoundsymbol2map[i].name);
    }
    cnt = sizeof(libasounddatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libasounddatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libasounddatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libasounddatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libasounddatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libasounddatamap[i].sz;
        }
    }
    cnt = sizeof(libasoundmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libasoundmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libasoundmydatamap[i].sz;
    }
...
# 154 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibasound.c" 2
