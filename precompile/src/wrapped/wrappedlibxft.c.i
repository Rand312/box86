# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2




    const char* libxftName = "libXft.so.2";
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxftdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxftsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
{"XftDrawChange", vFpp, 0},



{"XftDrawCreate", pFpppp, 0},
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
{"XftDrawRect", vFppiiuu, 0},
{"XftDrawSetClip", iFpp, 0},




{"XftDrawString32", vFpppiipi, 0},
{"XftDrawString8", vFpppiipi, 0},
# 48 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
{"XftFontMatch", pFpipp, 0},
{"XftFontOpen", pFpippppppppppppppppp, 0},


{"XftFontOpenPattern", pFpp, 0},
{"XftFontOpenXlfd", pFpip, 0},
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
{"XftNameUnparse", iFppi, 0},

{"XftTextExtents32", vFpppip, 0},
{"XftTextExtents8", vFpppip, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxftmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
...
static const map_onesymbol_t libxftstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
...
static const map_onesymbol2_t libxftsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
...
static const map_onedata_t libxftdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
...
static const map_onedata_t libxftmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxftundefs.h" 1
...
int wrappedlibxft_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxftName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxftsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxftsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxftsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxftsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxftsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxftsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxftsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxftsymbolmap[i].name); }
 cnt = sizeof(libxftmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxftmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxftmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxftmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxftmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxftmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxftmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxftmysymbolmap[i].name); }

    cnt = sizeof(libxftstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxftstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxftstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxftstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxftstsymbolmap[i].name);
    }
    cnt = sizeof(libxftsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxftsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxftsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxftsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxftsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxftsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxftsymbol2map[i].name);
    }
    cnt = sizeof(libxftdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxftdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxftdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxftdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxftdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxftdatamap[i].sz;
        }
    }
    cnt = sizeof(libxftmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxftmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxftmydatamap[i].sz;
    }

    setNeededLibs(lib, 4, "libX11.so.6", "libfontconfig.so.1", "libXrender.so.1", "libfreetype.so.6");


    return 0;
}

void wrappedlibxft_fini(library_t* lib)
{
...
# 39 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxft.c" 2
