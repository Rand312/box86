# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2




    const char* libxpmName = "libXpm.so.4";
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxpmdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxpmsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1





{"XpmAttributesSize", iFv, 0},
{"XpmCreateBufferFromImage", iFppppp, 0},
{"XpmCreateBufferFromPixmap", iFppppp, 0},
{"XpmCreateBufferFromXpmImage", iFppp, 0},
{"XpmCreateDataFromImage", iFppppp, 0},
{"XpmCreateDataFromPixmap", iFppppp, 0},
{"XpmCreateDataFromXpmImage", iFppp, 0},
{"XpmCreateImageFromBuffer", iFppppp, 0},
{"XpmCreateImageFromData", iFppppp, 0},

{"XpmCreateImageFromXpmImage", iFppppp, 0},
{"XpmCreatePixmapFromBuffer", iFpppppp, 0},
{"XpmCreatePixmapFromData", iFpppppp, 0},

{"XpmCreatePixmapFromXpmImage", iFpppppp, 0},
{"XpmCreateXpmImageFromBuffer", iFppp, 0},
{"XpmCreateXpmImageFromData", iFppp, 0},
{"XpmCreateXpmImageFromImage", iFppppp, 0},
{"XpmCreateXpmImageFromPixmap", iFppppp, 0},
{"XpmFree", vFp, 0},
{"XpmFreeAttributes", vFp, 0},

{"XpmFreeExtensions", vFpi, 0},

{"XpmFreeXpmImage", vFp, 0},
{"XpmFreeXpmInfo", vFp, 0},

{"XpmGetErrorString", pFi, 0},
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h"
{"XpmLibraryVersion", iFv, 0},
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h"
{"XpmReadFileToBuffer", iFpp, 0},
{"XpmReadFileToData", iFpp, 0},

{"XpmReadFileToPixmap", iFpppppp, 0},
{"XpmReadFileToXpmImage", iFppp, 0},




{"XpmWriteFileFromBuffer", iFpp, 0},
{"XpmWriteFileFromData", iFpp, 0},

{"XpmWriteFileFromPixmap", iFppppp, 0},
{"XpmWriteFileFromXpmImage", iFppp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxpmmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1
...
static const map_onesymbol_t libxpmstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1
...
static const map_onesymbol2_t libxpmsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1
...
static const map_onedata_t libxpmdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1
...
static const map_onedata_t libxpmmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxpmundefs.h" 1
...
int wrappedlibxpm_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxpmName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxpmsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxpmsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxpmsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxpmsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxpmsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxpmsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxpmsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxpmsymbolmap[i].name); }
 cnt = sizeof(libxpmmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxpmmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxpmmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxpmmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxpmmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxpmmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxpmmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxpmmysymbolmap[i].name); }

    cnt = sizeof(libxpmstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxpmstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxpmstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxpmstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxpmstsymbolmap[i].name);
    }
    cnt = sizeof(libxpmsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxpmsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxpmsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxpmsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxpmsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxpmsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxpmsymbol2map[i].name);
    }
    cnt = sizeof(libxpmdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxpmdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxpmdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxpmdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxpmdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxpmdatamap[i].sz;
        }
    }
    cnt = sizeof(libxpmmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxpmmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxpmmydatamap[i].sz;
    }
...
void wrappedlibxpm_fini(library_t* lib)
{
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpm.c" 2
