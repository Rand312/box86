# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2




    const char* libxssName = "libXss.so.1";
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxssdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxsssymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1




{"XScreenSaverAllocInfo", pFv, 0},
{"XScreenSaverGetRegistered", uFpipp, 0},
{"XScreenSaverQueryExtension", iFppp, 0},
{"XScreenSaverQueryInfo", iFppp, 0},
{"XScreenSaverQueryVersion", iFppp, 0},
{"XScreenSaverRegister", vFpiup, 0},
{"XScreenSaverSelectInput", vFppu, 0},
{"XScreenSaverSetAttributes", vFppiiuuuiupup, 0},
{"XScreenSaverSuspend", vFpi, 0},
{"XScreenSaverUnregister", iFpi, 0},
{"XScreenSaverUnsetAttributes", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxssmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1
...
static const map_onesymbol_t libxssstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1
...
static const map_onesymbol2_t libxsssymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1
...
static const map_onedata_t libxssdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1
...
static const map_onedata_t libxssmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxssundefs.h" 1
...
int wrappedlibxss_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxssName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxsssymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxsssymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxsssymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxsssymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxsssymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxsssymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxsssymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxsssymbolmap[i].name); }
 cnt = sizeof(libxssmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxssmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxssmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxssmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxssmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxssmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxssmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxssmysymbolmap[i].name); }

    cnt = sizeof(libxssstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxssstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxssstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxssstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxssstsymbolmap[i].name);
    }
    cnt = sizeof(libxsssymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxsssymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxsssymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxsssymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxsssymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxsssymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxsssymbol2map[i].name);
    }
    cnt = sizeof(libxssdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxssdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxssdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxssdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxssdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxssdatamap[i].sz;
        }
    }
    cnt = sizeof(libxssmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxssmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxssmydatamap[i].sz;
    }
...
void wrappedlibxss_fini(library_t* lib)
{
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxss.c" 2
