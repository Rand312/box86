# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2




    const char* xineramaName = "libXinerama.so.1";
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxineramadefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t xineramasymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1




{"XineramaIsActive", iFp, 0},
{"XineramaQueryExtension", iFppp, 0},
{"XineramaQueryScreens", pFpp, 0},
{"XineramaQueryVersion", iFppp, 0},
{"XPanoramiXAllocInfo", pFv, 0},
{"XPanoramiXGetScreenCount", iFppp, 0},
{"XPanoramiXGetScreenSize", iFppip, 0},
{"XPanoramiXGetState", iFppp, 0},
{"XPanoramiXQueryExtension", iFppp, 0},
{"XPanoramiXQueryVersion", iFppp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t xineramamysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1
...
static const map_onesymbol_t xineramastsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1
...
static const map_onesymbol2_t xineramasymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1
...
static const map_onedata_t xineramadatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1
...
static const map_onedata_t xineramamydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxineramaundefs.h" 1
...
int wrappedxinerama_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(xineramaName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(xineramasymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (xineramasymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, xineramasymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = xineramasymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, xineramasymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = xineramasymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(xineramasymbolmap[i].name, '@')) AddDictionnary(box86->versym, xineramasymbolmap[i].name); }
 cnt = sizeof(xineramamysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (xineramamysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, xineramamysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = xineramamysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, xineramamysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = xineramamysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(xineramamysymbolmap[i].name, '@')) AddDictionnary(box86->versym, xineramamysymbolmap[i].name); }

    cnt = sizeof(xineramastsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, xineramastsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = xineramastsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(xineramastsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, xineramastsymbolmap[i].name);
    }
    cnt = sizeof(xineramasymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, xineramasymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = xineramasymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = xineramasymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = xineramasymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(xineramasymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, xineramasymbol2map[i].name);
    }
    cnt = sizeof(xineramadatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(xineramadatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, xineramadatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = xineramadatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, xineramadatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = xineramadatamap[i].sz;
        }
    }
    cnt = sizeof(xineramamydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, xineramamydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = xineramamydatamap[i].sz;
    }
...
void wrappedxinerama_fini(library_t* lib)
{
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedxinerama.c" 2
