# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
...
int wrappedsoftokn3_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(softokn3Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(softokn3symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (softokn3symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, softokn3symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = softokn3symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, softokn3symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = softokn3symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(softokn3symbolmap[i].name, '@')) AddDictionnary(box86->versym, softokn3symbolmap[i].name); }
 cnt = sizeof(softokn3mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (softokn3mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, softokn3mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = softokn3mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, softokn3mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = softokn3mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(softokn3mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, softokn3mysymbolmap[i].name); }

    cnt = sizeof(softokn3stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, softokn3stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = softokn3stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(softokn3stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, softokn3stsymbolmap[i].name);
    }
    cnt = sizeof(softokn3symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, softokn3symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = softokn3symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = softokn3symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = softokn3symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(softokn3symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, softokn3symbol2map[i].name);
    }
    cnt = sizeof(softokn3datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(softokn3datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, softokn3datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = softokn3datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, softokn3datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = softokn3datamap[i].sz;
        }
    }
    cnt = sizeof(softokn3mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, softokn3mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = softokn3mydatamap[i].sz;
    }
...
void wrappedsoftokn3_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedsoftokn3.c" 2
