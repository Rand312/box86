# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibuuiddefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libuuidsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
{"uuid_copy", vFpp, 0},
{"uuid_generate", vFp, 0},
{"uuid__generate_random", vFpp, 0},
{"uuid_generate_random", vFp, 0},
{"uuid__generate_time", vFpp, 0},
{"uuid_generate_time", vFp, 0},
{"uuid_generate_time_safe", iFp, 0},
{"uuid_is_null", iFp, 0},
{"uuid_parse", iFpp, 0},
{"uuid_time", uFpp, 0},
{"uuid_type", iFp, 0},
{"uuid_unparse", vFpp, 0},
{"uuid_unparse_lower", vFpp, 0},
{"uuid_unparse_upper", vFpp, 0},
{"uuid_variant", iFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libuuidmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
static const map_onesymbol_t libuuidstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
static const map_onesymbol2_t libuuidsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
static const map_onedata_t libuuiddatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
static const map_onedata_t libuuidmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibuuidundefs.h" 1
...
int wrappedlibuuid_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libuuidName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libuuidsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libuuidsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libuuidsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libuuidsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libuuidsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libuuidsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libuuidsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libuuidsymbolmap[i].name); }
 cnt = sizeof(libuuidmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libuuidmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libuuidmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libuuidmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libuuidmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libuuidmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libuuidmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libuuidmysymbolmap[i].name); }

    cnt = sizeof(libuuidstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libuuidstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libuuidstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libuuidstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libuuidstsymbolmap[i].name);
    }
    cnt = sizeof(libuuidsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libuuidsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libuuidsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libuuidsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libuuidsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libuuidsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libuuidsymbol2map[i].name);
    }
    cnt = sizeof(libuuiddatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libuuiddatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libuuiddatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libuuiddatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libuuiddatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libuuiddatamap[i].sz;
        }
    }
    cnt = sizeof(libuuidmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libuuidmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libuuidmydatamap[i].sz;
    }
...
void wrappedlibuuid_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibuuid.c" 2
