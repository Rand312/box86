# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2

const char* appindicator3Name = "libappindicator3.so.1";
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedappindicator3defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t appindicator3symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
static const map_onesymbol_t appindicator3mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
static const map_onesymbol_t appindicator3stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
static const map_onesymbol2_t appindicator3symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
static const map_onedata_t appindicator3datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
static const map_onedata_t appindicator3mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedappindicator3undefs.h" 1
...
int wrappedappindicator3_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(appindicator3Name, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(appindicator3Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(appindicator3symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (appindicator3symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, appindicator3symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = appindicator3symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, appindicator3symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = appindicator3symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(appindicator3symbolmap[i].name, '@')) AddDictionnary(box86->versym, appindicator3symbolmap[i].name); }
 cnt = sizeof(appindicator3mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (appindicator3mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, appindicator3mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = appindicator3mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, appindicator3mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = appindicator3mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(appindicator3mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, appindicator3mysymbolmap[i].name); }

    cnt = sizeof(appindicator3stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, appindicator3stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = appindicator3stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(appindicator3stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, appindicator3stsymbolmap[i].name);
    }
    cnt = sizeof(appindicator3symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, appindicator3symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = appindicator3symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = appindicator3symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = appindicator3symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(appindicator3symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, appindicator3symbol2map[i].name);
    }
    cnt = sizeof(appindicator3datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(appindicator3datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, appindicator3datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = appindicator3datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, appindicator3datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = appindicator3datamap[i].sz;
        }
    }
    cnt = sizeof(appindicator3mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, appindicator3mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = appindicator3mydatamap[i].sz;
    }

    lib->w.altmy = box_strdup("my3_"); setNeededLibs(lib, 5, "libgtk-3.so.0", "libgdk-3.so.0", "libgio-2.0.so.0", "libgobject-2.0.so.0", "libglib-2.0.so.0");


    return 0;
}

void wrappedappindicator3_fini(library_t* lib)
{
...
# 32 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator3.c" 2
