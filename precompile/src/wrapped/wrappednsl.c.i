# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
...
int wrappednsl_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(nslName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(nslsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (nslsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, nslsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = nslsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, nslsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = nslsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(nslsymbolmap[i].name, '@')) AddDictionnary(box86->versym, nslsymbolmap[i].name); }
 cnt = sizeof(nslmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (nslmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, nslmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = nslmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, nslmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = nslmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(nslmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, nslmysymbolmap[i].name); }

    cnt = sizeof(nslstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, nslstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = nslstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(nslstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, nslstsymbolmap[i].name);
    }
    cnt = sizeof(nslsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, nslsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = nslsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = nslsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = nslsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(nslsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, nslsymbol2map[i].name);
    }
    cnt = sizeof(nsldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(nsldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, nsldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = nsldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, nsldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = nsldatamap[i].sz;
        }
    }
    cnt = sizeof(nslmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, nslmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = nslmydatamap[i].sz;
    }
...
void wrappednsl_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappednsl.c" 2
