# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2




    const char* gstappName = "libgstapp-1.0.so.0";
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c"
...
int wrappedgstapp_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gstappName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gstappsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstappsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gstappsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gstappsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gstappsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gstappsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gstappsymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstappsymbolmap[i].name); }
 cnt = sizeof(gstappmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstappmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gstappmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gstappmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gstappmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gstappmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gstappmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstappmysymbolmap[i].name); }

    cnt = sizeof(gstappstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gstappstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gstappstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gstappstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gstappstsymbolmap[i].name);
    }
    cnt = sizeof(gstappsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gstappsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gstappsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gstappsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gstappsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gstappsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gstappsymbol2map[i].name);
    }
    cnt = sizeof(gstappdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gstappdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gstappdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gstappdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gstappdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gstappdatamap[i].sz;
        }
    }
    cnt = sizeof(gstappmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gstappmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gstappmydatamap[i].sz;
    }
...
void wrappedgstapp_fini(library_t* lib)
{
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstapp.c" 2
