# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibtifftypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibtifftypes.h"
typedef int32_t (*iFpuV_t)(void*, uint32_t, ...);
typedef void* (*pFpppppppppp_t)(void*, void*, void*, void*, void*, void*, void*, void*, void*, void*);
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
...
typedef struct libtiff_my_s {


    iFpuV_t TIFFGetField; iFpuV_t TIFFSetField; pFpppppppppp_t TIFFClientOpen;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libtiff_my_t my_libtiff = {0};
static libtiff_my_t * const my = &my_libtiff;

static void getMy(library_t* lib)
{

    my->TIFFGetField = (iFpuV_t)dlsym(lib->w.lib, "TIFFGetField"); my->TIFFSetField = (iFpuV_t)dlsym(lib->w.lib, "TIFFSetField"); my->TIFFClientOpen = (pFpppppppppp_t)dlsym(lib->w.lib, "TIFFClientOpen");
...
# 35 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
static uintptr_t my_TIFFReadWriteProc_fct_0 = 0; static int my_TIFFReadWriteProc_0(void* a, void* b, int c) { return (int)RunFunctionFmt(my_TIFFReadWriteProc_fct_0, "ppi", a, b, c); } static uintptr_t my_TIFFReadWriteProc_fct_1 = 0; static int my_TIFFReadWriteProc_1(void* a, void* b, int c) { return (int)RunFunctionFmt(my_TIFFReadWriteProc_fct_1, "ppi", a, b, c); } static uintptr_t my_TIFFReadWriteProc_fct_2 = 0; static int my_TIFFReadWriteProc_2(void* a, void* b, int c) { return (int)RunFunctionFmt(my_TIFFReadWriteProc_fct_2, "ppi", a, b, c); } static uintptr_t my_TIFFReadWriteProc_fct_3 = 0; static int my_TIFFReadWriteProc_3(void* a, void* b, int c) { return (int)RunFunctionFmt(my_TIFFReadWriteProc_fct_3, "ppi", a, b, c); }
...
static void* find_TIFFReadWriteProc_Fct(void* fct)
{
    ...
    if(my_TIFFReadWriteProc_fct_0 == (uintptr_t)fct) return my_TIFFReadWriteProc_0; if(my_TIFFReadWriteProc_fct_1 == (uintptr_t)fct) return my_TIFFReadWriteProc_1; if(my_TIFFReadWriteProc_fct_2 == (uintptr_t)fct) return my_TIFFReadWriteProc_2; if(my_TIFFReadWriteProc_fct_3 == (uintptr_t)fct) return my_TIFFReadWriteProc_3;


    if(my_TIFFReadWriteProc_fct_0 == 0) {my_TIFFReadWriteProc_fct_0 = (uintptr_t)fct; return my_TIFFReadWriteProc_0; } if(my_TIFFReadWriteProc_fct_1 == 0) {my_TIFFReadWriteProc_fct_1 = (uintptr_t)fct; return my_TIFFReadWriteProc_1; } if(my_TIFFReadWriteProc_fct_2 == 0) {my_TIFFReadWriteProc_fct_2 = (uintptr_t)fct; return my_TIFFReadWriteProc_2; } if(my_TIFFReadWriteProc_fct_3 == 0) {my_TIFFReadWriteProc_fct_3 = (uintptr_t)fct; return my_TIFFReadWriteProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFReadWriteProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 63 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 63 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}
...
static uintptr_t my_TIFFSeekProc_fct_0 = 0; static int64_t my_TIFFSeekProc_0(void* a, int64_t b, int c) { return (int64_t)RunFunctionFmt64(my_TIFFSeekProc_fct_0, "pIi", a, b, c); } static uintptr_t my_TIFFSeekProc_fct_1 = 0; static int64_t my_TIFFSeekProc_1(void* a, int64_t b, int c) { return (int64_t)RunFunctionFmt64(my_TIFFSeekProc_fct_1, "pIi", a, b, c); } static uintptr_t my_TIFFSeekProc_fct_2 = 0; static int64_t my_TIFFSeekProc_2(void* a, int64_t b, int c) { return (int64_t)RunFunctionFmt64(my_TIFFSeekProc_fct_2, "pIi", a, b, c); } static uintptr_t my_TIFFSeekProc_fct_3 = 0; static int64_t my_TIFFSeekProc_3(void* a, int64_t b, int c) { return (int64_t)RunFunctionFmt64(my_TIFFSeekProc_fct_3, "pIi", a, b, c); }
...
static void* find_TIFFSeekProc_Fct(void* fct)
{
    ...
    if(my_TIFFSeekProc_fct_0 == (uintptr_t)fct) return my_TIFFSeekProc_0; if(my_TIFFSeekProc_fct_1 == (uintptr_t)fct) return my_TIFFSeekProc_1; if(my_TIFFSeekProc_fct_2 == (uintptr_t)fct) return my_TIFFSeekProc_2; if(my_TIFFSeekProc_fct_3 == (uintptr_t)fct) return my_TIFFSeekProc_3;


    if(my_TIFFSeekProc_fct_0 == 0) {my_TIFFSeekProc_fct_0 = (uintptr_t)fct; return my_TIFFSeekProc_0; } if(my_TIFFSeekProc_fct_1 == 0) {my_TIFFSeekProc_fct_1 = (uintptr_t)fct; return my_TIFFSeekProc_1; } if(my_TIFFSeekProc_fct_2 == 0) {my_TIFFSeekProc_fct_2 = (uintptr_t)fct; return my_TIFFSeekProc_2; } if(my_TIFFSeekProc_fct_3 == 0) {my_TIFFSeekProc_fct_3 = (uintptr_t)fct; return my_TIFFSeekProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFSeekProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 85 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 85 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}
...
static uintptr_t my_TIFFCloseProc_fct_0 = 0; static int my_TIFFCloseProc_0(void* a) { return (int)RunFunctionFmt(my_TIFFCloseProc_fct_0, "p", a); } static uintptr_t my_TIFFCloseProc_fct_1 = 0; static int my_TIFFCloseProc_1(void* a) { return (int)RunFunctionFmt(my_TIFFCloseProc_fct_1, "p", a); } static uintptr_t my_TIFFCloseProc_fct_2 = 0; static int my_TIFFCloseProc_2(void* a) { return (int)RunFunctionFmt(my_TIFFCloseProc_fct_2, "p", a); } static uintptr_t my_TIFFCloseProc_fct_3 = 0; static int my_TIFFCloseProc_3(void* a) { return (int)RunFunctionFmt(my_TIFFCloseProc_fct_3, "p", a); }
...
static void* find_TIFFCloseProc_Fct(void* fct)
{
    ...
    if(my_TIFFCloseProc_fct_0 == (uintptr_t)fct) return my_TIFFCloseProc_0; if(my_TIFFCloseProc_fct_1 == (uintptr_t)fct) return my_TIFFCloseProc_1; if(my_TIFFCloseProc_fct_2 == (uintptr_t)fct) return my_TIFFCloseProc_2; if(my_TIFFCloseProc_fct_3 == (uintptr_t)fct) return my_TIFFCloseProc_3;


    if(my_TIFFCloseProc_fct_0 == 0) {my_TIFFCloseProc_fct_0 = (uintptr_t)fct; return my_TIFFCloseProc_0; } if(my_TIFFCloseProc_fct_1 == 0) {my_TIFFCloseProc_fct_1 = (uintptr_t)fct; return my_TIFFCloseProc_1; } if(my_TIFFCloseProc_fct_2 == 0) {my_TIFFCloseProc_fct_2 = (uintptr_t)fct; return my_TIFFCloseProc_2; } if(my_TIFFCloseProc_fct_3 == 0) {my_TIFFCloseProc_fct_3 = (uintptr_t)fct; return my_TIFFCloseProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFCloseProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}
...
static uintptr_t my_TIFFSizeProc_fct_0 = 0; static int64_t my_TIFFSizeProc_0(void* a) { return (int64_t)RunFunctionFmt64(my_TIFFSizeProc_fct_0, "p", a); } static uintptr_t my_TIFFSizeProc_fct_1 = 0; static int64_t my_TIFFSizeProc_1(void* a) { return (int64_t)RunFunctionFmt64(my_TIFFSizeProc_fct_1, "p", a); } static uintptr_t my_TIFFSizeProc_fct_2 = 0; static int64_t my_TIFFSizeProc_2(void* a) { return (int64_t)RunFunctionFmt64(my_TIFFSizeProc_fct_2, "p", a); } static uintptr_t my_TIFFSizeProc_fct_3 = 0; static int64_t my_TIFFSizeProc_3(void* a) { return (int64_t)RunFunctionFmt64(my_TIFFSizeProc_fct_3, "p", a); }
...
static void* find_TIFFSizeProc_Fct(void* fct)
{
    ...
    if(my_TIFFSizeProc_fct_0 == (uintptr_t)fct) return my_TIFFSizeProc_0; if(my_TIFFSizeProc_fct_1 == (uintptr_t)fct) return my_TIFFSizeProc_1; if(my_TIFFSizeProc_fct_2 == (uintptr_t)fct) return my_TIFFSizeProc_2; if(my_TIFFSizeProc_fct_3 == (uintptr_t)fct) return my_TIFFSizeProc_3;


    if(my_TIFFSizeProc_fct_0 == 0) {my_TIFFSizeProc_fct_0 = (uintptr_t)fct; return my_TIFFSizeProc_0; } if(my_TIFFSizeProc_fct_1 == 0) {my_TIFFSizeProc_fct_1 = (uintptr_t)fct; return my_TIFFSizeProc_1; } if(my_TIFFSizeProc_fct_2 == 0) {my_TIFFSizeProc_fct_2 = (uintptr_t)fct; return my_TIFFSizeProc_2; } if(my_TIFFSizeProc_fct_3 == 0) {my_TIFFSizeProc_fct_3 = (uintptr_t)fct; return my_TIFFSizeProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFSizeProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 129 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 129 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}
...
static uintptr_t my_TIFFMapFileProc_fct_0 = 0; static int my_TIFFMapFileProc_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_TIFFMapFileProc_fct_0, "ppp", a, b, c); } static uintptr_t my_TIFFMapFileProc_fct_1 = 0; static int my_TIFFMapFileProc_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_TIFFMapFileProc_fct_1, "ppp", a, b, c); } static uintptr_t my_TIFFMapFileProc_fct_2 = 0; static int my_TIFFMapFileProc_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_TIFFMapFileProc_fct_2, "ppp", a, b, c); } static uintptr_t my_TIFFMapFileProc_fct_3 = 0; static int my_TIFFMapFileProc_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_TIFFMapFileProc_fct_3, "ppp", a, b, c); }
...
static void* find_TIFFMapFileProc_Fct(void* fct)
{
    ...
    if(my_TIFFMapFileProc_fct_0 == (uintptr_t)fct) return my_TIFFMapFileProc_0; if(my_TIFFMapFileProc_fct_1 == (uintptr_t)fct) return my_TIFFMapFileProc_1; if(my_TIFFMapFileProc_fct_2 == (uintptr_t)fct) return my_TIFFMapFileProc_2; if(my_TIFFMapFileProc_fct_3 == (uintptr_t)fct) return my_TIFFMapFileProc_3;


    if(my_TIFFMapFileProc_fct_0 == 0) {my_TIFFMapFileProc_fct_0 = (uintptr_t)fct; return my_TIFFMapFileProc_0; } if(my_TIFFMapFileProc_fct_1 == 0) {my_TIFFMapFileProc_fct_1 = (uintptr_t)fct; return my_TIFFMapFileProc_1; } if(my_TIFFMapFileProc_fct_2 == 0) {my_TIFFMapFileProc_fct_2 = (uintptr_t)fct; return my_TIFFMapFileProc_2; } if(my_TIFFMapFileProc_fct_3 == 0) {my_TIFFMapFileProc_fct_3 = (uintptr_t)fct; return my_TIFFMapFileProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFMapFileProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}
...
static uintptr_t my_TIFFUnmapFileProc_fct_0 = 0; static void my_TIFFUnmapFileProc_0(void* a, void* b, int64_t c) { RunFunctionFmt(my_TIFFUnmapFileProc_fct_0, "ppI", a, b, c); } static uintptr_t my_TIFFUnmapFileProc_fct_1 = 0; static void my_TIFFUnmapFileProc_1(void* a, void* b, int64_t c) { RunFunctionFmt(my_TIFFUnmapFileProc_fct_1, "ppI", a, b, c); } static uintptr_t my_TIFFUnmapFileProc_fct_2 = 0; static void my_TIFFUnmapFileProc_2(void* a, void* b, int64_t c) { RunFunctionFmt(my_TIFFUnmapFileProc_fct_2, "ppI", a, b, c); } static uintptr_t my_TIFFUnmapFileProc_fct_3 = 0; static void my_TIFFUnmapFileProc_3(void* a, void* b, int64_t c) { RunFunctionFmt(my_TIFFUnmapFileProc_fct_3, "ppI", a, b, c); }
...
static void* find_TIFFUnmapFileProc_Fct(void* fct)
{
    ...
    if(my_TIFFUnmapFileProc_fct_0 == (uintptr_t)fct) return my_TIFFUnmapFileProc_0; if(my_TIFFUnmapFileProc_fct_1 == (uintptr_t)fct) return my_TIFFUnmapFileProc_1; if(my_TIFFUnmapFileProc_fct_2 == (uintptr_t)fct) return my_TIFFUnmapFileProc_2; if(my_TIFFUnmapFileProc_fct_3 == (uintptr_t)fct) return my_TIFFUnmapFileProc_3;


    if(my_TIFFUnmapFileProc_fct_0 == 0) {my_TIFFUnmapFileProc_fct_0 = (uintptr_t)fct; return my_TIFFUnmapFileProc_0; } if(my_TIFFUnmapFileProc_fct_1 == 0) {my_TIFFUnmapFileProc_fct_1 = (uintptr_t)fct; return my_TIFFUnmapFileProc_1; } if(my_TIFFUnmapFileProc_fct_2 == 0) {my_TIFFUnmapFileProc_fct_2 = (uintptr_t)fct; return my_TIFFUnmapFileProc_2; } if(my_TIFFUnmapFileProc_fct_3 == 0) {my_TIFFUnmapFileProc_fct_3 = (uintptr_t)fct; return my_TIFFUnmapFileProc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libtiff TIFFUnmapFileProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 173 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 3 4
          ((void *)0)
# 173 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c"
              ;
}


__attribute__((visibility("default"))) void* my_TIFFClientOpen(void* filename, void* mode, void* clientdata, void* readproc, void* writeproc, void* seekproc, void* closeproc, void* sizeproc, void* mapproc, void* unmapproc)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibtiffdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libtiffsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
{"TIFFCurrentDirOffset", UFp, 0},
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFFdOpen", pFipp, 0},
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"

# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFIsByteSwapped", iFp, 0},
# 130 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFNumberOfDirectories", WFp, 0},


{"TIFFOpen", pFpp, 0},
# 146 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFReadDirectory", iFp, 0},
{"TIFFReadEncodedStrip", iFpupi, 0},
{"TIFFReadEncodedTile", iFpupi, 0},
# 176 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFSetDirectory", iFpW, 0},




# 221 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFVGetField", iFpup, 0},

{"TIFFVSetField", iFpup, 0},
# 235 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFWriteDirectory", iFp, 0},




{"TIFFWriteScanline", iFppuW, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libtiffmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFClientOpen", pFpppppppppp, 0},
...
static const map_onesymbol_t libtiffstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
static const map_onesymbol2_t libtiffsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
{"TIFFGetField", iFpuV, 0, "TIFFVGetField"},
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
{"TIFFSetField", iFpuV, 0, "TIFFVSetField"},
# 221 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
static const map_onedata_t libtiffdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
static const map_onedata_t libtiffmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibtiffundefs.h" 1
...
int wrappedlibtiff_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libtiffName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libtiffsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libtiffsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libtiffsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libtiffsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libtiffsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libtiffsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libtiffsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libtiffsymbolmap[i].name); }
 cnt = sizeof(libtiffmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libtiffmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libtiffmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libtiffmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libtiffmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libtiffmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libtiffmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libtiffmysymbolmap[i].name); }

    cnt = sizeof(libtiffstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libtiffstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libtiffstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libtiffstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libtiffstsymbolmap[i].name);
    }
    cnt = sizeof(libtiffsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libtiffsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libtiffsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libtiffsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libtiffsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libtiffsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libtiffsymbol2map[i].name);
    }
    cnt = sizeof(libtiffdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libtiffdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libtiffdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libtiffdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libtiffdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libtiffdatamap[i].sz;
        }
    }
    cnt = sizeof(libtiffmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libtiffmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libtiffmydatamap[i].sz;
    }
...
void wrappedlibtiff_fini(library_t* lib)
{
...
# 192 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibtiff.c" 2
