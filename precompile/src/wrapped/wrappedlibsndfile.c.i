# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsndfiletypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsndfiletypes.h"
typedef int32_t (*iFp_t)(void*);
typedef void* (*pFpipp_t)(void*, int32_t, void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
...
typedef struct libsndfile_my_s {


    iFp_t sf_close; pFpipp_t sf_open_virtual;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libsndfile_my_t my_libsndfile = {0};
static libsndfile_my_t * const my = &my_libsndfile;

static void getMy(library_t* lib)
{

    my->sf_close = (iFp_t)dlsym(lib->w.lib, "sf_close"); my->sf_open_virtual = (pFpipp_t)dlsym(lib->w.lib, "sf_open_virtual");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
# 48 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
static uintptr_t my_sf_vio_get_filelen_fct_0 = 0; static int64_t my_sf_vio_get_filelen_0(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_get_filelen_fct_0, "p", a);} static uintptr_t my_sf_vio_get_filelen_fct_1 = 0; static int64_t my_sf_vio_get_filelen_1(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_get_filelen_fct_1, "p", a);} static uintptr_t my_sf_vio_get_filelen_fct_2 = 0; static int64_t my_sf_vio_get_filelen_2(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_get_filelen_fct_2, "p", a);} static uintptr_t my_sf_vio_get_filelen_fct_3 = 0; static int64_t my_sf_vio_get_filelen_3(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_get_filelen_fct_3, "p", a);} static uintptr_t my_sf_vio_get_filelen_fct_4 = 0; static int64_t my_sf_vio_get_filelen_4(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_get_filelen_fct_4, "p", a);}
...
static void* find_sf_vio_get_filelen_Fct(void* fct)
{
    ...
    if(my_sf_vio_get_filelen_fct_0 == (uintptr_t)fct) return my_sf_vio_get_filelen_0; if(my_sf_vio_get_filelen_fct_1 == (uintptr_t)fct) return my_sf_vio_get_filelen_1; if(my_sf_vio_get_filelen_fct_2 == (uintptr_t)fct) return my_sf_vio_get_filelen_2; if(my_sf_vio_get_filelen_fct_3 == (uintptr_t)fct) return my_sf_vio_get_filelen_3; if(my_sf_vio_get_filelen_fct_4 == (uintptr_t)fct) return my_sf_vio_get_filelen_4;


    if(my_sf_vio_get_filelen_fct_0 == 0) {my_sf_vio_get_filelen_fct_0 = (uintptr_t)fct; return my_sf_vio_get_filelen_0; } if(my_sf_vio_get_filelen_fct_1 == 0) {my_sf_vio_get_filelen_fct_1 = (uintptr_t)fct; return my_sf_vio_get_filelen_1; } if(my_sf_vio_get_filelen_fct_2 == 0) {my_sf_vio_get_filelen_fct_2 = (uintptr_t)fct; return my_sf_vio_get_filelen_2; } if(my_sf_vio_get_filelen_fct_3 == 0) {my_sf_vio_get_filelen_fct_3 = (uintptr_t)fct; return my_sf_vio_get_filelen_3; } if(my_sf_vio_get_filelen_fct_4 == 0) {my_sf_vio_get_filelen_fct_4 = (uintptr_t)fct; return my_sf_vio_get_filelen_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for sndfile sf_vio_get_filelen callback\n"); fflush(ftrace);}} while(0);
    return 
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 3 4
          ((void *)0)
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
              ;
}
...
static uintptr_t my_sf_vio_seek_fct_0 = 0; static int64_t my_sf_vio_seek_0(int64_t offset, int whence, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_seek_fct_0, "Iip", offset, whence, user_data); } static uintptr_t my_sf_vio_seek_fct_1 = 0; static int64_t my_sf_vio_seek_1(int64_t offset, int whence, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_seek_fct_1, "Iip", offset, whence, user_data); } static uintptr_t my_sf_vio_seek_fct_2 = 0; static int64_t my_sf_vio_seek_2(int64_t offset, int whence, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_seek_fct_2, "Iip", offset, whence, user_data); } static uintptr_t my_sf_vio_seek_fct_3 = 0; static int64_t my_sf_vio_seek_3(int64_t offset, int whence, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_seek_fct_3, "Iip", offset, whence, user_data); } static uintptr_t my_sf_vio_seek_fct_4 = 0; static int64_t my_sf_vio_seek_4(int64_t offset, int whence, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_seek_fct_4, "Iip", offset, whence, user_data); }
...
static void* find_sf_vio_seek_Fct(void* fct)
{
    ...
    if(my_sf_vio_seek_fct_0 == (uintptr_t)fct) return my_sf_vio_seek_0; if(my_sf_vio_seek_fct_1 == (uintptr_t)fct) return my_sf_vio_seek_1; if(my_sf_vio_seek_fct_2 == (uintptr_t)fct) return my_sf_vio_seek_2; if(my_sf_vio_seek_fct_3 == (uintptr_t)fct) return my_sf_vio_seek_3; if(my_sf_vio_seek_fct_4 == (uintptr_t)fct) return my_sf_vio_seek_4;


    if(my_sf_vio_seek_fct_0 == 0) {my_sf_vio_seek_fct_0 = (uintptr_t)fct; return my_sf_vio_seek_0; } if(my_sf_vio_seek_fct_1 == 0) {my_sf_vio_seek_fct_1 = (uintptr_t)fct; return my_sf_vio_seek_1; } if(my_sf_vio_seek_fct_2 == 0) {my_sf_vio_seek_fct_2 = (uintptr_t)fct; return my_sf_vio_seek_2; } if(my_sf_vio_seek_fct_3 == 0) {my_sf_vio_seek_fct_3 = (uintptr_t)fct; return my_sf_vio_seek_3; } if(my_sf_vio_seek_fct_4 == 0) {my_sf_vio_seek_fct_4 = (uintptr_t)fct; return my_sf_vio_seek_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for sndfile sf_vio_seek callback\n"); fflush(ftrace);}} while(0);
    return 
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 3 4
          ((void *)0)
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
              ;
}
...
static uintptr_t my_sf_vio_read_fct_0 = 0; static int64_t my_sf_vio_read_0(void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_read_fct_0, "pIp", ptr, count, user_data); } static uintptr_t my_sf_vio_read_fct_1 = 0; static int64_t my_sf_vio_read_1(void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_read_fct_1, "pIp", ptr, count, user_data); } static uintptr_t my_sf_vio_read_fct_2 = 0; static int64_t my_sf_vio_read_2(void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_read_fct_2, "pIp", ptr, count, user_data); } static uintptr_t my_sf_vio_read_fct_3 = 0; static int64_t my_sf_vio_read_3(void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_read_fct_3, "pIp", ptr, count, user_data); } static uintptr_t my_sf_vio_read_fct_4 = 0; static int64_t my_sf_vio_read_4(void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_read_fct_4, "pIp", ptr, count, user_data); }
...
static void* find_sf_vio_read_Fct(void* fct)
{
    ...
    if(my_sf_vio_read_fct_0 == (uintptr_t)fct) return my_sf_vio_read_0; if(my_sf_vio_read_fct_1 == (uintptr_t)fct) return my_sf_vio_read_1; if(my_sf_vio_read_fct_2 == (uintptr_t)fct) return my_sf_vio_read_2; if(my_sf_vio_read_fct_3 == (uintptr_t)fct) return my_sf_vio_read_3; if(my_sf_vio_read_fct_4 == (uintptr_t)fct) return my_sf_vio_read_4;


    if(my_sf_vio_read_fct_0 == 0) {my_sf_vio_read_fct_0 = (uintptr_t)fct; return my_sf_vio_read_0; } if(my_sf_vio_read_fct_1 == 0) {my_sf_vio_read_fct_1 = (uintptr_t)fct; return my_sf_vio_read_1; } if(my_sf_vio_read_fct_2 == 0) {my_sf_vio_read_fct_2 = (uintptr_t)fct; return my_sf_vio_read_2; } if(my_sf_vio_read_fct_3 == 0) {my_sf_vio_read_fct_3 = (uintptr_t)fct; return my_sf_vio_read_3; } if(my_sf_vio_read_fct_4 == 0) {my_sf_vio_read_fct_4 = (uintptr_t)fct; return my_sf_vio_read_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for sndfile sf_vio_read callback\n"); fflush(ftrace);}} while(0);
    return 
# 105 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 3 4
          ((void *)0)
# 105 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
              ;
}
...
static uintptr_t my_sf_vio_write_fct_0 = 0; static int64_t my_sf_vio_write_0(const void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_write_fct_0, "pIp", ptr, count, user_data);} static uintptr_t my_sf_vio_write_fct_1 = 0; static int64_t my_sf_vio_write_1(const void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_write_fct_1, "pIp", ptr, count, user_data);} static uintptr_t my_sf_vio_write_fct_2 = 0; static int64_t my_sf_vio_write_2(const void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_write_fct_2, "pIp", ptr, count, user_data);} static uintptr_t my_sf_vio_write_fct_3 = 0; static int64_t my_sf_vio_write_3(const void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_write_fct_3, "pIp", ptr, count, user_data);} static uintptr_t my_sf_vio_write_fct_4 = 0; static int64_t my_sf_vio_write_4(const void* ptr, int64_t count, void *user_data) { return (int64_t)RunFunctionFmt64(my_sf_vio_write_fct_4, "pIp", ptr, count, user_data);}
...
static void* find_sf_vio_write_Fct(void* fct)
{
    ...
    if(my_sf_vio_write_fct_0 == (uintptr_t)fct) return my_sf_vio_write_0; if(my_sf_vio_write_fct_1 == (uintptr_t)fct) return my_sf_vio_write_1; if(my_sf_vio_write_fct_2 == (uintptr_t)fct) return my_sf_vio_write_2; if(my_sf_vio_write_fct_3 == (uintptr_t)fct) return my_sf_vio_write_3; if(my_sf_vio_write_fct_4 == (uintptr_t)fct) return my_sf_vio_write_4;


    if(my_sf_vio_write_fct_0 == 0) {my_sf_vio_write_fct_0 = (uintptr_t)fct; return my_sf_vio_write_0; } if(my_sf_vio_write_fct_1 == 0) {my_sf_vio_write_fct_1 = (uintptr_t)fct; return my_sf_vio_write_1; } if(my_sf_vio_write_fct_2 == 0) {my_sf_vio_write_fct_2 = (uintptr_t)fct; return my_sf_vio_write_2; } if(my_sf_vio_write_fct_3 == 0) {my_sf_vio_write_fct_3 = (uintptr_t)fct; return my_sf_vio_write_3; } if(my_sf_vio_write_fct_4 == 0) {my_sf_vio_write_fct_4 = (uintptr_t)fct; return my_sf_vio_write_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for sndfile sf_vio_write callback\n"); fflush(ftrace);}} while(0);
    return 
# 127 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 3 4
          ((void *)0)
# 127 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
              ;
}
...
static uintptr_t my_sf_vio_tell_fct_0 = 0; static int64_t my_sf_vio_tell_0(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_tell_fct_0, "p", a); } static uintptr_t my_sf_vio_tell_fct_1 = 0; static int64_t my_sf_vio_tell_1(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_tell_fct_1, "p", a); } static uintptr_t my_sf_vio_tell_fct_2 = 0; static int64_t my_sf_vio_tell_2(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_tell_fct_2, "p", a); } static uintptr_t my_sf_vio_tell_fct_3 = 0; static int64_t my_sf_vio_tell_3(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_tell_fct_3, "p", a); } static uintptr_t my_sf_vio_tell_fct_4 = 0; static int64_t my_sf_vio_tell_4(void* a) { return (int64_t)RunFunctionFmt64(my_sf_vio_tell_fct_4, "p", a); }
...
static void* find_sf_vio_tell_Fct(void* fct)
{
    ...
    if(my_sf_vio_tell_fct_0 == (uintptr_t)fct) return my_sf_vio_tell_0; if(my_sf_vio_tell_fct_1 == (uintptr_t)fct) return my_sf_vio_tell_1; if(my_sf_vio_tell_fct_2 == (uintptr_t)fct) return my_sf_vio_tell_2; if(my_sf_vio_tell_fct_3 == (uintptr_t)fct) return my_sf_vio_tell_3; if(my_sf_vio_tell_fct_4 == (uintptr_t)fct) return my_sf_vio_tell_4;


    if(my_sf_vio_tell_fct_0 == 0) {my_sf_vio_tell_fct_0 = (uintptr_t)fct; return my_sf_vio_tell_0; } if(my_sf_vio_tell_fct_1 == 0) {my_sf_vio_tell_fct_1 = (uintptr_t)fct; return my_sf_vio_tell_1; } if(my_sf_vio_tell_fct_2 == 0) {my_sf_vio_tell_fct_2 = (uintptr_t)fct; return my_sf_vio_tell_2; } if(my_sf_vio_tell_fct_3 == 0) {my_sf_vio_tell_fct_3 = (uintptr_t)fct; return my_sf_vio_tell_3; } if(my_sf_vio_tell_fct_4 == 0) {my_sf_vio_tell_fct_4 = (uintptr_t)fct; return my_sf_vio_tell_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for sndfile sf_vio_tell callback\n"); fflush(ftrace);}} while(0);
    return 
# 149 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 3 4
          ((void *)0)
# 149 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c"
              ;
}
...
__attribute__((visibility("default"))) void* my_sf_open_virtual(x86emu_t* emu, my_sfvirtual_io_t* sfvirtual, int mode, void* sfinfo, void* data)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_sf_close(x86emu_t* emu, void* sf)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsndfiledefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsndfilesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
{"sf_command", iFpipi, 0},
{"sf_current_byterate", iFp, 0},
{"sf_error", iFp, 0},
{"sf_error_number", pFi, 0},
{"sf_error_str", pFpi, 0},
{"sf_format_check", iFp, 0},
{"sf_get_chunk_data", iFpp, 0},
{"sf_get_chunk_iterator", pFpp, 0},
{"sf_get_chunk_size", iFpp, 0},
{"sf_get_string", pFpi, 0},
{"sf_next_chunk_iterator", pFp, 0},
{"sf_open", pFpip, 0},
{"sf_open_fd", pFiipi, 0},

{"sf_perror", iFp, 0},
{"sf_read_double", IFppI, 0},
{"sf_readf_double", IFppI, 0},
{"sf_readf_float", IFppI, 0},
{"sf_readf_int", IFppI, 0},
{"sf_read_float", IFppI, 0},
{"sf_readf_short", IFppI, 0},
{"sf_read_int", IFppI, 0},
{"sf_read_raw", IFppI, 0},
{"sf_read_short", IFppI, 0},
{"sf_seek", IFpIi, 0},
{"sf_set_chunk", iFpp, 0},
{"sf_set_string", iFpip, 0},
{"sf_strerror", pFp, 0},
{"sf_version_string", pFv, 0},
{"sf_write_double", IFppI, 0},
{"sf_writef_double", IFppI, 0},
{"sf_writef_float", IFppI, 0},
{"sf_writef_int", IFppI, 0},
{"sf_write_float", IFppI, 0},
{"sf_writef_short", IFppI, 0},
{"sf_write_int", IFppI, 0},
{"sf_write_raw", IFppI, 0},
{"sf_write_short", IFppI, 0},
{"sf_write_sync", vFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsndfilemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
static const map_onesymbol_t libsndfilestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
static const map_onesymbol2_t libsndfilesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
static const map_onedata_t libsndfiledatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
static const map_onedata_t libsndfilemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsndfileundefs.h" 1
...
int wrappedlibsndfile_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libsndfileName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libsndfileName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libsndfilesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsndfilesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libsndfilesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libsndfilesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libsndfilesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libsndfilesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libsndfilesymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsndfilesymbolmap[i].name); }
 cnt = sizeof(libsndfilemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsndfilemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libsndfilemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libsndfilemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libsndfilemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libsndfilemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libsndfilemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsndfilemysymbolmap[i].name); }

    cnt = sizeof(libsndfilestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libsndfilestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libsndfilestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libsndfilestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libsndfilestsymbolmap[i].name);
    }
    cnt = sizeof(libsndfilesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libsndfilesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libsndfilesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libsndfilesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libsndfilesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libsndfilesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libsndfilesymbol2map[i].name);
    }
    cnt = sizeof(libsndfiledatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libsndfiledatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libsndfiledatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libsndfiledatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libsndfiledatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libsndfiledatamap[i].sz;
        }
    }
    cnt = sizeof(libsndfilemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libsndfilemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libsndfilemydatamap[i].sz;
    }
...
void wrappedlibsndfile_fini(library_t* lib)
{
...
# 192 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsndfile.c" 2
