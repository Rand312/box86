# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2

# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_vtable.h" 1
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_vtable.h"
...
typedef struct ID3DPresentGroupVtbl
{
 ...
 int (*CreateAdditionalPresent)(void *This, void *pPresentationParameters, void **ppPresent);
                 int (*GetVersion) (void *This, void *major, void *minor);
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 92 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_gen.h" 1
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_gen.h"
static void make_vtable_ID3DAdapter9Vtbl(x86emu_t* emu, ID3DAdapter9Vtbl* new, ID3DAdapter9Vtbl* real)
{
    new->QueryInterface = (void*)AddBridge(emu->context->system, iFppp, real->QueryInterface, 3*4, "QueryInterface");
    new->AddRef = (void*)AddBridge(emu->context->system, uFp, real->AddRef, 1*4, "AddRef");
    new->Release = (void*)AddBridge(emu->context->system, uFp, real->Release, 1*4, "Release");

    new->GetAdapterIdentifier = (void*)AddBridge(emu->context->system, iFpup, real->GetAdapterIdentifier, 3*4, "GetAdapterIdentifier");
    new->CheckDeviceType = (void*)AddBridge(emu->context->system, iFpiiii, real->CheckDeviceType, 5*4, "CheckDeviceType");
    new->CheckDeviceFormat = (void*)AddBridge(emu->context->system, iFpiiuii, real->CheckDeviceFormat, 6*4, "CheckDeviceFormat");
    new->CheckDeviceMultiSampleType = (void*)AddBridge(emu->context->system, iFpiiiip, real->CheckDeviceMultiSampleType, 6*4, "CheckDeviceMultiSampleType");
    new->CheckDepthStencilMatch = (void*)AddBridge(emu->context->system, iFpiiii, real->CheckDepthStencilMatch, 5*4, "CheckDepthStencilMatch");
    new->CheckDeviceFormatConversion = (void*)AddBridge(emu->context->system, iFpiii, real->CheckDeviceFormatConversion, 4*4, "CheckDeviceFormatConversion");
    new->GetDeviceCaps = (void*)AddBridge(emu->context->system, iFpip, real->GetDeviceCaps, 3*4, "GetDeviceCaps");
    new->CreateDevice = (void*)AddBridge(emu->context->system, iFEpuipupppp, real->CreateDevice, 9*4, "CreateDevice");
    new->CreateDeviceEx = (void*)AddBridge(emu->context->system, iFEpuipuppppp, real->CreateDeviceEx, 10*4, "CreateDeviceEx");
}
...
static void make_vtable_IDirect3D9Vtbl(x86emu_t* emu, IDirect3D9Vtbl* new, IDirect3D9Vtbl* real)
{
    ...
    new->RegisterSoftwareDevice = (void*)AddBridge(emu->context->system, iFpp, real->RegisterSoftwareDevice, 2*4, "RegisterSoftwareDevice");
    new->GetAdapterCount = (void*)AddBridge(emu->context->system, uFp, real->GetAdapterCount, 1*4, "GetAdapterCount");
    new->GetAdapterIdentifier = (void*)AddBridge(emu->context->system, iFpuup, real->GetAdapterIdentifier, 4*4, "GetAdapterIdentifier");
    new->GetAdapterModeCount = (void*)AddBridge(emu->context->system, uFpui, real->GetAdapterModeCount, 3*4, "GetAdapterModeCount");
    new->EnumAdapterModes = (void*)AddBridge(emu->context->system, iFpuiup, real->EnumAdapterModes, 5*4, "EnumAdapterModes");
    new->GetAdapterDisplayMode = (void*)AddBridge(emu->context->system, iFpup, real->GetAdapterDisplayMode, 3*4, "GetAdapterDisplayMode");
    new->CheckDeviceType = (void*)AddBridge(emu->context->system, iFpuiiii, real->CheckDeviceType, 6*4, "CheckDeviceType");
    new->CheckDeviceFormat = (void*)AddBridge(emu->context->system, iFpuiiuii, real->CheckDeviceFormat, 7*4, "CheckDeviceFormat");
    new->CheckDeviceMultiSampleType = (void*)AddBridge(emu->context->system, iFpuiiiip, real->CheckDeviceMultiSampleType, 7*4, "CheckDeviceMultiSampleType");
    new->CheckDepthStencilMatch = (void*)AddBridge(emu->context->system, iFpuiiii, real->CheckDepthStencilMatch, 6*4, "CheckDepthStencilMatch");
    new->CheckDeviceFormatConversion = (void*)AddBridge(emu->context->system, iFpuiii, real->CheckDeviceFormatConversion, 5*4, "CheckDeviceFormatConversion");
    new->GetDeviceCaps = (void*)AddBridge(emu->context->system, iFpuip, real->GetDeviceCaps, 4*4, "GetDeviceCaps");
    new->GetAdapterMonitor = (void*)AddBridge(emu->context->system, pFpu, real->GetAdapterMonitor, 2*4, "GetAdapterMonitor");
    new->CreateDevice = (void*)AddBridge(emu->context->system, iFpuipupp, real->CreateDevice, 7*4, "CreateDevice");
}
...
static void make_vtable_IDirect3D9ExVtbl(x86emu_t* emu, IDirect3D9ExVtbl* new, IDirect3D9ExVtbl* real)
{
    ...
    new->GetAdapterModeCountEx = (void*)AddBridge(emu->context->system, uFpup, real->GetAdapterModeCountEx, 3*4, "GetAdapterModeCountEx");
    new->EnumAdapterModesEx = (void*)AddBridge(emu->context->system, iFpupup, real->EnumAdapterModesEx, 5*4, "EnumAdapterModesEx");
    new->GetAdapterDisplayModeEx = (void*)AddBridge(emu->context->system, iFpupp, real->GetAdapterDisplayModeEx, 4*4, "GetAdapterDisplayModeEx");
    new->CreateDeviceEx = (void*)AddBridge(emu->context->system, iFpuipuppp, real->CreateDeviceEx, 8*4, "CreateDeviceEx");
    new->GetAdapterLUID = (void*)AddBridge(emu->context->system, iFpup, real->GetAdapterLUID, 3*4, "GetAdapterLUID");
}
...
static void make_vtable_IDirect3D9ExOverlayExtensionVtbl(x86emu_t* emu, IDirect3D9ExOverlayExtensionVtbl* new, IDirect3D9ExOverlayExtensionVtbl* real)
{
    ...
    new->CheckDeviceOverlayType = (void*)AddBridge(emu->context->system, iFpuiuuipip, real->CheckDeviceOverlayType, 9*4, "CheckDeviceOverlayType");
}
...
static void make_vtable_IDirect3DAuthenticatedChannel9Vtbl(x86emu_t* emu, IDirect3DAuthenticatedChannel9Vtbl* new, IDirect3DAuthenticatedChannel9Vtbl* real)
{
    ...
    new->GetCertificateSize = (void*)AddBridge(emu->context->system, iFpp, real->GetCertificateSize, 2*4, "GetCertificateSize");
    new->GetCertificate = (void*)AddBridge(emu->context->system, iFpup, real->GetCertificate, 3*4, "GetCertificate");
    new->NegotiateKeyExchange = (void*)AddBridge(emu->context->system, iFpup, real->NegotiateKeyExchange, 3*4, "NegotiateKeyExchange");
    new->Query = (void*)AddBridge(emu->context->system, iFpupup, real->Query, 5*4, "Query");
    new->Configure = (void*)AddBridge(emu->context->system, iFpupp, real->Configure, 4*4, "Configure");
}
...
static void make_vtable_IDirect3DBaseTexture9Vtbl(x86emu_t* emu, IDirect3DBaseTexture9Vtbl* new, IDirect3DBaseTexture9Vtbl* real)
{
    ...
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->SetPrivateData = (void*)AddBridge(emu->context->system, iFpppuu, real->SetPrivateData, 5*4, "SetPrivateData");
    new->GetPrivateData = (void*)AddBridge(emu->context->system, iFpppp, real->GetPrivateData, 4*4, "GetPrivateData");
    new->FreePrivateData = (void*)AddBridge(emu->context->system, iFpp, real->FreePrivateData, 2*4, "FreePrivateData");
    new->SetPriority = (void*)AddBridge(emu->context->system, uFpu, real->SetPriority, 2*4, "SetPriority");
    new->GetPriority = (void*)AddBridge(emu->context->system, uFp, real->GetPriority, 1*4, "GetPriority");
    new->PreLoad = (void*)AddBridge(emu->context->system, vFp, real->PreLoad, 1*4, "PreLoad");
    new->GetType = (void*)AddBridge(emu->context->system, iFp, real->GetType, 1*4, "GetType");

    new->SetLOD = (void*)AddBridge(emu->context->system, uFpu, real->SetLOD, 2*4, "SetLOD");
    new->GetLOD = (void*)AddBridge(emu->context->system, uFp, real->GetLOD, 1*4, "GetLOD");
    new->GetLevelCount = (void*)AddBridge(emu->context->system, uFp, real->GetLevelCount, 1*4, "GetLevelCount");
    new->SetAutoGenFilterType = (void*)AddBridge(emu->context->system, iFpi, real->SetAutoGenFilterType, 2*4, "SetAutoGenFilterType");
    new->GetAutoGenFilterType = (void*)AddBridge(emu->context->system, iFp, real->GetAutoGenFilterType, 1*4, "GetAutoGenFilterType");
    new->GenerateMipSubLevels = (void*)AddBridge(emu->context->system, vFp, real->GenerateMipSubLevels, 1*4, "GenerateMipSubLevels");
}
...
static void make_vtable_IDirect3DCryptoSession9Vtbl(x86emu_t* emu, IDirect3DCryptoSession9Vtbl* new, IDirect3DCryptoSession9Vtbl* real)
{
    ...
    new->GetCertificate = (void*)AddBridge(emu->context->system, iFpup, real->GetCertificate, 3*4, "GetCertificate");
    new->NegotiateKeyExchange = (void*)AddBridge(emu->context->system, iFpup, real->NegotiateKeyExchange, 3*4, "NegotiateKeyExchange");
    new->EncryptionBlt = (void*)AddBridge(emu->context->system, iFpppup, real->EncryptionBlt, 5*4, "EncryptionBlt");
    new->DecryptionBlt = (void*)AddBridge(emu->context->system, iFpppuppp, real->DecryptionBlt, 7*4, "DecryptionBlt");
    new->GetSurfacePitch = (void*)AddBridge(emu->context->system, iFppp, real->GetSurfacePitch, 3*4, "GetSurfacePitch");
    new->StartSessionKeyRefresh = (void*)AddBridge(emu->context->system, iFppu, real->StartSessionKeyRefresh, 3*4, "StartSessionKeyRefresh");
    new->FinishSessionKeyRefresh = (void*)AddBridge(emu->context->system, iFp, real->FinishSessionKeyRefresh, 1*4, "FinishSessionKeyRefresh");
    new->GetEncryptionBltKey = (void*)AddBridge(emu->context->system, iFppu, real->GetEncryptionBltKey, 3*4, "GetEncryptionBltKey");
}
...
static void make_vtable_IDirect3DCubeTexture9Vtbl(x86emu_t* emu, IDirect3DCubeTexture9Vtbl* new, IDirect3DCubeTexture9Vtbl* real)
{
    ...
    new->GetLevelDesc = (void*)AddBridge(emu->context->system, iFpup, real->GetLevelDesc, 3*4, "GetLevelDesc");
    my_GetCubeMapSurface_real = (void*)real->GetCubeMapSurface; new->GetCubeMapSurface = (void*)AddBridge(emu->context->system, iFEpiup, my_GetCubeMapSurface, 4*4, "my_" "GetCubeMapSurface");
    new->LockRect = (void*)AddBridge(emu->context->system, iFpiuppu, real->LockRect, 6*4, "LockRect");
    new->UnlockRect = (void*)AddBridge(emu->context->system, iFpiu, real->UnlockRect, 3*4, "UnlockRect");
    new->AddDirtyRect = (void*)AddBridge(emu->context->system, iFpip, real->AddDirtyRect, 3*4, "AddDirtyRect");
}
...
static void make_vtable_IDirect3DDevice9Vtbl(x86emu_t* emu, IDirect3DDevice9Vtbl* new, IDirect3DDevice9Vtbl* real)
{
    ...
    new->TestCooperativeLevel = (void*)AddBridge(emu->context->system, iFp, real->TestCooperativeLevel, 1*4, "TestCooperativeLevel");
    new->GetAvailableTextureMem = (void*)AddBridge(emu->context->system, uFp, real->GetAvailableTextureMem, 1*4, "GetAvailableTextureMem");
    new->EvictManagedResources = (void*)AddBridge(emu->context->system, iFp, real->EvictManagedResources, 1*4, "EvictManagedResources");
    my_GetDirect3D_real = (void*)real->GetDirect3D; new->GetDirect3D = (void*)AddBridge(emu->context->system, iFEpp, my_GetDirect3D, 2*4, "my_" "GetDirect3D");
    new->GetDeviceCaps = (void*)AddBridge(emu->context->system, iFpp, real->GetDeviceCaps, 2*4, "GetDeviceCaps");
    new->GetDisplayMode = (void*)AddBridge(emu->context->system, iFpup, real->GetDisplayMode, 3*4, "GetDisplayMode");
    new->GetCreationParameters = (void*)AddBridge(emu->context->system, iFpp, real->GetCreationParameters, 2*4, "GetCreationParameters");
    new->SetCursorProperties = (void*)AddBridge(emu->context->system, iFpuup, real->SetCursorProperties, 4*4, "SetCursorProperties");
    new->SetCursorPosition = (void*)AddBridge(emu->context->system, vFpiiu, real->SetCursorPosition, 4*4, "SetCursorPosition");
    new->ShowCursor = (void*)AddBridge(emu->context->system, iFpi, real->ShowCursor, 2*4, "ShowCursor");
    my_CreateAdditionalSwapChain_real = (void*)real->CreateAdditionalSwapChain; new->CreateAdditionalSwapChain = (void*)AddBridge(emu->context->system, iFEppp, my_CreateAdditionalSwapChain, 3*4, "my_" "CreateAdditionalSwapChain");
    my_GetSwapChain_real = (void*)real->GetSwapChain; new->GetSwapChain = (void*)AddBridge(emu->context->system, iFEpup, my_GetSwapChain, 3*4, "my_" "GetSwapChain");
    new->GetNumberOfSwapChains = (void*)AddBridge(emu->context->system, uFp, real->GetNumberOfSwapChains, 1*4, "GetNumberOfSwapChains");
    new->Reset = (void*)AddBridge(emu->context->system, iFpp, real->Reset, 2*4, "Reset");
    new->Present = (void*)AddBridge(emu->context->system, iFppppp, real->Present, 5*4, "Present");
    my_GetBackBuffer_real = (void*)real->GetBackBuffer; new->GetBackBuffer = (void*)AddBridge(emu->context->system, iFEpuuip, my_GetBackBuffer, 5*4, "my_" "GetBackBuffer");
    new->GetRasterStatus = (void*)AddBridge(emu->context->system, iFpup, real->GetRasterStatus, 3*4, "GetRasterStatus");
    new->SetDialogBoxMode = (void*)AddBridge(emu->context->system, iFpi, real->SetDialogBoxMode, 2*4, "SetDialogBoxMode");
    new->SetGammaRamp = (void*)AddBridge(emu->context->system, vFpuup, real->SetGammaRamp, 4*4, "SetGammaRamp");
    new->GetGammaRamp = (void*)AddBridge(emu->context->system, vFpup, real->GetGammaRamp, 3*4, "GetGammaRamp");
    my_CreateTexture_real = (void*)real->CreateTexture; new->CreateTexture = (void*)AddBridge(emu->context->system, iFEpuuuuiipp, my_CreateTexture, 9*4, "my_" "CreateTexture");
    my_CreateVolumeTexture_real = (void*)real->CreateVolumeTexture; new->CreateVolumeTexture = (void*)AddBridge(emu->context->system, iFEpuuuuuiipp, my_CreateVolumeTexture, 10*4, "my_" "CreateVolumeTexture");
    my_CreateCubeTexture_real = (void*)real->CreateCubeTexture; new->CreateCubeTexture = (void*)AddBridge(emu->context->system, iFEpuuuiipp, my_CreateCubeTexture, 8*4, "my_" "CreateCubeTexture");
    my_CreateVertexBuffer_real = (void*)real->CreateVertexBuffer; new->CreateVertexBuffer = (void*)AddBridge(emu->context->system, iFEpuuuipp, my_CreateVertexBuffer, 7*4, "my_" "CreateVertexBuffer");
    my_CreateIndexBuffer_real = (void*)real->CreateIndexBuffer; new->CreateIndexBuffer = (void*)AddBridge(emu->context->system, iFEpuuiipp, my_CreateIndexBuffer, 7*4, "my_" "CreateIndexBuffer");
    my_CreateRenderTarget_real = (void*)real->CreateRenderTarget; new->CreateRenderTarget = (void*)AddBridge(emu->context->system, iFEpuuiiuipp, my_CreateRenderTarget, 9*4, "my_" "CreateRenderTarget");
    my_CreateDepthStencilSurface_real = (void*)real->CreateDepthStencilSurface; new->CreateDepthStencilSurface = (void*)AddBridge(emu->context->system, iFEpuuiiuipp, my_CreateDepthStencilSurface, 9*4, "my_" "CreateDepthStencilSurface");
    new->UpdateSurface = (void*)AddBridge(emu->context->system, iFppppp, real->UpdateSurface, 5*4, "UpdateSurface");
    new->UpdateTexture = (void*)AddBridge(emu->context->system, iFppp, real->UpdateTexture, 3*4, "UpdateTexture");
    new->GetRenderTargetData = (void*)AddBridge(emu->context->system, iFppp, real->GetRenderTargetData, 3*4, "GetRenderTargetData");
    new->GetFrontBufferData = (void*)AddBridge(emu->context->system, iFpup, real->GetFrontBufferData, 3*4, "GetFrontBufferData");
    new->StretchRect = (void*)AddBridge(emu->context->system, iFpppppi, real->StretchRect, 6*4, "StretchRect");
    new->ColorFill = (void*)AddBridge(emu->context->system, iFpppu, real->ColorFill, 4*4, "ColorFill");
    my_CreateOffscreenPlainSurface_real = (void*)real->CreateOffscreenPlainSurface; new->CreateOffscreenPlainSurface = (void*)AddBridge(emu->context->system, iFEpuuiipp, my_CreateOffscreenPlainSurface, 7*4, "my_" "CreateOffscreenPlainSurface");
    new->SetRenderTarget = (void*)AddBridge(emu->context->system, iFpup, real->SetRenderTarget, 3*4, "SetRenderTarget");
    my_GetRenderTarget_real = (void*)real->GetRenderTarget; new->GetRenderTarget = (void*)AddBridge(emu->context->system, iFEpup, my_GetRenderTarget, 3*4, "my_" "GetRenderTarget");
    new->SetDepthStencilSurface = (void*)AddBridge(emu->context->system, iFpp, real->SetDepthStencilSurface, 2*4, "SetDepthStencilSurface");
    my_GetDepthStencilSurface_real = (void*)real->GetDepthStencilSurface; new->GetDepthStencilSurface = (void*)AddBridge(emu->context->system, iFEpp, my_GetDepthStencilSurface, 2*4, "my_" "GetDepthStencilSurface");
    new->BeginScene = (void*)AddBridge(emu->context->system, iFp, real->BeginScene, 1*4, "BeginScene");
    new->EndScene = (void*)AddBridge(emu->context->system, iFp, real->EndScene, 1*4, "EndScene");
    new->Clear = (void*)AddBridge(emu->context->system, iFpupuufu, real->Clear, 7*4, "Clear");
    new->SetTransform = (void*)AddBridge(emu->context->system, iFpip, real->SetTransform, 3*4, "SetTransform");
    new->GetTransform = (void*)AddBridge(emu->context->system, iFpip, real->GetTransform, 3*4, "GetTransform");
    new->MultiplyTransform = (void*)AddBridge(emu->context->system, iFpip, real->MultiplyTransform, 3*4, "MultiplyTransform");
    new->SetViewport = (void*)AddBridge(emu->context->system, iFpp, real->SetViewport, 2*4, "SetViewport");
    new->GetViewport = (void*)AddBridge(emu->context->system, iFpp, real->GetViewport, 2*4, "GetViewport");
    new->SetMaterial = (void*)AddBridge(emu->context->system, iFpp, real->SetMaterial, 2*4, "SetMaterial");
    new->GetMaterial = (void*)AddBridge(emu->context->system, iFpp, real->GetMaterial, 2*4, "GetMaterial");
    new->SetLight = (void*)AddBridge(emu->context->system, iFpup, real->SetLight, 3*4, "SetLight");
    new->GetLight = (void*)AddBridge(emu->context->system, iFpup, real->GetLight, 3*4, "GetLight");
    new->LightEnable = (void*)AddBridge(emu->context->system, iFpui, real->LightEnable, 3*4, "LightEnable");
    new->GetLightEnable = (void*)AddBridge(emu->context->system, iFpup, real->GetLightEnable, 3*4, "GetLightEnable");
    new->SetClipPlane = (void*)AddBridge(emu->context->system, iFpup, real->SetClipPlane, 3*4, "SetClipPlane");
    new->GetClipPlane = (void*)AddBridge(emu->context->system, iFpup, real->GetClipPlane, 3*4, "GetClipPlane");
    new->SetRenderState = (void*)AddBridge(emu->context->system, iFpiu, real->SetRenderState, 3*4, "SetRenderState");
    new->GetRenderState = (void*)AddBridge(emu->context->system, iFpip, real->GetRenderState, 3*4, "GetRenderState");
    my_CreateStateBlock_real = (void*)real->CreateStateBlock; new->CreateStateBlock = (void*)AddBridge(emu->context->system, iFEpip, my_CreateStateBlock, 3*4, "my_" "CreateStateBlock");
    new->BeginStateBlock = (void*)AddBridge(emu->context->system, iFp, real->BeginStateBlock, 1*4, "BeginStateBlock");
    my_EndStateBlock_real = (void*)real->EndStateBlock; new->EndStateBlock = (void*)AddBridge(emu->context->system, iFEpp, my_EndStateBlock, 2*4, "my_" "EndStateBlock");
    new->SetClipStatus = (void*)AddBridge(emu->context->system, iFpp, real->SetClipStatus, 2*4, "SetClipStatus");
    new->GetClipStatus = (void*)AddBridge(emu->context->system, iFpp, real->GetClipStatus, 2*4, "GetClipStatus");
    new->GetTexture = (void*)AddBridge(emu->context->system, iFpup, real->GetTexture, 3*4, "GetTexture");
    new->SetTexture = (void*)AddBridge(emu->context->system, iFpup, real->SetTexture, 3*4, "SetTexture");
    new->GetTextureStageState = (void*)AddBridge(emu->context->system, iFpuip, real->GetTextureStageState, 4*4, "GetTextureStageState");
    new->SetTextureStageState = (void*)AddBridge(emu->context->system, iFpuiu, real->SetTextureStageState, 4*4, "SetTextureStageState");
    new->GetSamplerState = (void*)AddBridge(emu->context->system, iFpuip, real->GetSamplerState, 4*4, "GetSamplerState");
    new->SetSamplerState = (void*)AddBridge(emu->context->system, iFpuiu, real->SetSamplerState, 4*4, "SetSamplerState");
    new->ValidateDevice = (void*)AddBridge(emu->context->system, iFpp, real->ValidateDevice, 2*4, "ValidateDevice");
    new->SetPaletteEntries = (void*)AddBridge(emu->context->system, iFpup, real->SetPaletteEntries, 3*4, "SetPaletteEntries");
    new->GetPaletteEntries = (void*)AddBridge(emu->context->system, iFpup, real->GetPaletteEntries, 3*4, "GetPaletteEntries");
    new->SetCurrentTexturePalette = (void*)AddBridge(emu->context->system, iFpu, real->SetCurrentTexturePalette, 2*4, "SetCurrentTexturePalette");
    new->GetCurrentTexturePalette = (void*)AddBridge(emu->context->system, iFpp, real->GetCurrentTexturePalette, 2*4, "GetCurrentTexturePalette");
    new->SetScissorRect = (void*)AddBridge(emu->context->system, iFpp, real->SetScissorRect, 2*4, "SetScissorRect");
    new->GetScissorRect = (void*)AddBridge(emu->context->system, iFpp, real->GetScissorRect, 2*4, "GetScissorRect");
    new->SetSoftwareVertexProcessing = (void*)AddBridge(emu->context->system, iFpi, real->SetSoftwareVertexProcessing, 2*4, "SetSoftwareVertexProcessing");
    new->GetSoftwareVertexProcessing = (void*)AddBridge(emu->context->system, iFp, real->GetSoftwareVertexProcessing, 1*4, "GetSoftwareVertexProcessing");
    new->SetNPatchMode = (void*)AddBridge(emu->context->system, iFpf, real->SetNPatchMode, 2*4, "SetNPatchMode");
    new->GetNPatchMode = (void*)AddBridge(emu->context->system, fFp, real->GetNPatchMode, 1*4, "GetNPatchMode");
    new->DrawPrimitive = (void*)AddBridge(emu->context->system, iFpiuu, real->DrawPrimitive, 4*4, "DrawPrimitive");
    new->DrawIndexedPrimitive = (void*)AddBridge(emu->context->system, iFpiiuuuu, real->DrawIndexedPrimitive, 7*4, "DrawIndexedPrimitive");
    new->DrawPrimitiveUP = (void*)AddBridge(emu->context->system, iFpiupu, real->DrawPrimitiveUP, 5*4, "DrawPrimitiveUP");
    new->DrawIndexedPrimitiveUP = (void*)AddBridge(emu->context->system, iFpiuuupipu, real->DrawIndexedPrimitiveUP, 9*4, "DrawIndexedPrimitiveUP");
    new->ProcessVertices = (void*)AddBridge(emu->context->system, iFpuuuppu, real->ProcessVertices, 7*4, "ProcessVertices");
    my_CreateVertexDeclaration_real = (void*)real->CreateVertexDeclaration; new->CreateVertexDeclaration = (void*)AddBridge(emu->context->system, iFEppp, my_CreateVertexDeclaration, 3*4, "my_" "CreateVertexDeclaration");
    new->SetVertexDeclaration = (void*)AddBridge(emu->context->system, iFpp, real->SetVertexDeclaration, 2*4, "SetVertexDeclaration");
    new->GetVertexDeclaration = (void*)AddBridge(emu->context->system, iFpp, real->GetVertexDeclaration, 2*4, "GetVertexDeclaration");
    new->SetFVF = (void*)AddBridge(emu->context->system, iFpu, real->SetFVF, 2*4, "SetFVF");
    new->GetFVF = (void*)AddBridge(emu->context->system, iFpp, real->GetFVF, 2*4, "GetFVF");
    my_CreateVertexShader_real = (void*)real->CreateVertexShader; new->CreateVertexShader = (void*)AddBridge(emu->context->system, iFEppp, my_CreateVertexShader, 3*4, "my_" "CreateVertexShader");
    new->SetVertexShader = (void*)AddBridge(emu->context->system, iFpp, real->SetVertexShader, 2*4, "SetVertexShader");
    new->GetVertexShader = (void*)AddBridge(emu->context->system, iFpp, real->GetVertexShader, 2*4, "GetVertexShader");
    new->SetVertexShaderConstantF = (void*)AddBridge(emu->context->system, iFpupu, real->SetVertexShaderConstantF, 4*4, "SetVertexShaderConstantF");
    new->GetVertexShaderConstantF = (void*)AddBridge(emu->context->system, iFpupu, real->GetVertexShaderConstantF, 4*4, "GetVertexShaderConstantF");
    new->SetVertexShaderConstantI = (void*)AddBridge(emu->context->system, iFpupu, real->SetVertexShaderConstantI, 4*4, "SetVertexShaderConstantI");
    new->GetVertexShaderConstantI = (void*)AddBridge(emu->context->system, iFpupu, real->GetVertexShaderConstantI, 4*4, "GetVertexShaderConstantI");
    new->SetVertexShaderConstantB = (void*)AddBridge(emu->context->system, iFpupu, real->SetVertexShaderConstantB, 4*4, "SetVertexShaderConstantB");
    new->GetVertexShaderConstantB = (void*)AddBridge(emu->context->system, iFpupu, real->GetVertexShaderConstantB, 4*4, "GetVertexShaderConstantB");
    new->SetStreamSource = (void*)AddBridge(emu->context->system, iFpupuu, real->SetStreamSource, 5*4, "SetStreamSource");
    new->GetStreamSource = (void*)AddBridge(emu->context->system, iFpuppp, real->GetStreamSource, 5*4, "GetStreamSource");
    new->SetStreamSourceFreq = (void*)AddBridge(emu->context->system, iFpuu, real->SetStreamSourceFreq, 3*4, "SetStreamSourceFreq");
    new->GetStreamSourceFreq = (void*)AddBridge(emu->context->system, iFpup, real->GetStreamSourceFreq, 3*4, "GetStreamSourceFreq");
    new->SetIndices = (void*)AddBridge(emu->context->system, iFpp, real->SetIndices, 2*4, "SetIndices");
    new->GetIndices = (void*)AddBridge(emu->context->system, iFpp, real->GetIndices, 2*4, "GetIndices");
    my_CreatePixelShader_real = (void*)real->CreatePixelShader; new->CreatePixelShader = (void*)AddBridge(emu->context->system, iFEppp, my_CreatePixelShader, 3*4, "my_" "CreatePixelShader");
    new->SetPixelShader = (void*)AddBridge(emu->context->system, iFpp, real->SetPixelShader, 2*4, "SetPixelShader");
    new->GetPixelShader = (void*)AddBridge(emu->context->system, iFpp, real->GetPixelShader, 2*4, "GetPixelShader");
    new->SetPixelShaderConstantF = (void*)AddBridge(emu->context->system, iFpupu, real->SetPixelShaderConstantF, 4*4, "SetPixelShaderConstantF");
    new->GetPixelShaderConstantF = (void*)AddBridge(emu->context->system, iFpupu, real->GetPixelShaderConstantF, 4*4, "GetPixelShaderConstantF");
    new->SetPixelShaderConstantI = (void*)AddBridge(emu->context->system, iFpupu, real->SetPixelShaderConstantI, 4*4, "SetPixelShaderConstantI");
    new->GetPixelShaderConstantI = (void*)AddBridge(emu->context->system, iFpupu, real->GetPixelShaderConstantI, 4*4, "GetPixelShaderConstantI");
    new->SetPixelShaderConstantB = (void*)AddBridge(emu->context->system, iFpupu, real->SetPixelShaderConstantB, 4*4, "SetPixelShaderConstantB");
    new->GetPixelShaderConstantB = (void*)AddBridge(emu->context->system, iFpupu, real->GetPixelShaderConstantB, 4*4, "GetPixelShaderConstantB");
    new->DrawRectPatch = (void*)AddBridge(emu->context->system, iFpupp, real->DrawRectPatch, 4*4, "DrawRectPatch");
    new->DrawTriPatch = (void*)AddBridge(emu->context->system, iFpupp, real->DrawTriPatch, 4*4, "DrawTriPatch");
    new->DeletePatch = (void*)AddBridge(emu->context->system, iFpu, real->DeletePatch, 2*4, "DeletePatch");
    my_CreateQuery_real = (void*)real->CreateQuery; new->CreateQuery = (void*)AddBridge(emu->context->system, iFEpip, my_CreateQuery, 3*4, "my_" "CreateQuery");
}
...
static void make_vtable_IDirect3DDevice9ExVtbl(x86emu_t* emu, IDirect3DDevice9ExVtbl* new, IDirect3DDevice9ExVtbl* real)
{
    ...
    new->GetAvailableTextureMem = (void*)AddBridge(emu->context->system, uFp, real->GetAvailableTextureMem, 1*4, "GetAvailableTextureMem");
    new->EvictManagedResources = (void*)AddBridge(emu->context->system, iFp, real->EvictManagedResources, 1*4, "EvictManagedResources");
    new->GetDirect3D = (void*)AddBridge(emu->context->system, iFpp, real->GetDirect3D, 2*4, "GetDirect3D");
    new->GetDeviceCaps = (void*)AddBridge(emu->context->system, iFpp, real->GetDeviceCaps, 2*4, "GetDeviceCaps");
    new->GetDisplayMode = (void*)AddBridge(emu->context->system, iFpup, real->GetDisplayMode, 3*4, "GetDisplayMode");
    new->GetCreationParameters = (void*)AddBridge(emu->context->system, iFpp, real->GetCreationParameters, 2*4, "GetCreationParameters");
    new->SetCursorProperties = (void*)AddBridge(emu->context->system, iFpuup, real->SetCursorProperties, 4*4, "SetCursorProperties");
    ...
    new->SetConvolutionMonoKernel = (void*)AddBridge(emu->context->system, iFpuupp, real->SetConvolutionMonoKernel, 5*4, "SetConvolutionMonoKernel");
    new->ComposeRects = (void*)AddBridge(emu->context->system, iFppppupiii, real->ComposeRects, 9*4, "ComposeRects");
    new->PresentEx = (void*)AddBridge(emu->context->system, iFpppppu, real->PresentEx, 6*4, "PresentEx");
    new->GetGPUThreadPriority = (void*)AddBridge(emu->context->system, iFpp, real->GetGPUThreadPriority, 2*4, "GetGPUThreadPriority");
    new->SetGPUThreadPriority = (void*)AddBridge(emu->context->system, iFpi, real->SetGPUThreadPriority, 2*4, "SetGPUThreadPriority");
    new->WaitForVBlank = (void*)AddBridge(emu->context->system, iFpu, real->WaitForVBlank, 2*4, "WaitForVBlank");
    my_CheckResourceResidency_real = (void*)real->CheckResourceResidency; new->CheckResourceResidency = (void*)AddBridge(emu->context->system, iFEppu, my_CheckResourceResidency, 3*4, "my_" "CheckResourceResidency");
    new->SetMaximumFrameLatency = (void*)AddBridge(emu->context->system, iFpu, real->SetMaximumFrameLatency, 2*4, "SetMaximumFrameLatency");
    new->GetMaximumFrameLatency = (void*)AddBridge(emu->context->system, iFpp, real->GetMaximumFrameLatency, 2*4, "GetMaximumFrameLatency");
    new->CheckDeviceState = (void*)AddBridge(emu->context->system, iFpp, real->CheckDeviceState, 2*4, "CheckDeviceState");
    my_CreateRenderTargetEx_real = (void*)real->CreateRenderTargetEx; new->CreateRenderTargetEx = (void*)AddBridge(emu->context->system, iFEpuuiiuippu, my_CreateRenderTargetEx, 10*4, "my_" "CreateRenderTargetEx");
    my_CreateOffscreenPlainSurfaceEx_real = (void*)real->CreateOffscreenPlainSurfaceEx; new->CreateOffscreenPlainSurfaceEx = (void*)AddBridge(emu->context->system, iFEpuuiippu, my_CreateOffscreenPlainSurfaceEx, 8*4, "my_" "CreateOffscreenPlainSurfaceEx");
    my_CreateDepthStencilSurfaceEx_real = (void*)real->CreateDepthStencilSurfaceEx; new->CreateDepthStencilSurfaceEx = (void*)AddBridge(emu->context->system, iFEpuuiiuippu, my_CreateDepthStencilSurfaceEx, 10*4, "my_" "CreateDepthStencilSurfaceEx");
    new->ResetEx = (void*)AddBridge(emu->context->system, iFppp, real->ResetEx, 3*4, "ResetEx");
    new->GetDisplayModeEx = (void*)AddBridge(emu->context->system, iFpupp, real->GetDisplayModeEx, 4*4, "GetDisplayModeEx");
}
...
static void make_vtable_IDirect3DDevice9VideoVtbl(x86emu_t* emu, IDirect3DDevice9VideoVtbl* new, IDirect3DDevice9VideoVtbl* real)
{
    ...
    new->GetContentProtectionCaps = (void*)AddBridge(emu->context->system, iFpppp, real->GetContentProtectionCaps, 4*4, "GetContentProtectionCaps");
    my_CreateAuthenticatedChannel_real = (void*)real->CreateAuthenticatedChannel; new->CreateAuthenticatedChannel = (void*)AddBridge(emu->context->system, iFEpipp, my_CreateAuthenticatedChannel, 4*4, "my_" "CreateAuthenticatedChannel");
    my_CreateCryptoSession_real = (void*)real->CreateCryptoSession; new->CreateCryptoSession = (void*)AddBridge(emu->context->system, iFEppppp, my_CreateCryptoSession, 5*4, "my_" "CreateCryptoSession");
}
...
static void make_vtable_IDirect3DIndexBuffer9Vtbl(x86emu_t* emu, IDirect3DIndexBuffer9Vtbl* new, IDirect3DIndexBuffer9Vtbl* real)
{
    ...
    new->Lock = (void*)AddBridge(emu->context->system, iFpuupu, real->Lock, 5*4, "Lock");
    new->Unlock = (void*)AddBridge(emu->context->system, iFp, real->Unlock, 1*4, "Unlock");
    new->GetDesc = (void*)AddBridge(emu->context->system, iFpp, real->GetDesc, 2*4, "GetDesc");
}
...
static void make_vtable_IDirect3DPixelShader9Vtbl(x86emu_t* emu, IDirect3DPixelShader9Vtbl* new, IDirect3DPixelShader9Vtbl* real)
{
    ...
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->GetFunction = (void*)AddBridge(emu->context->system, iFppp, real->GetFunction, 3*4, "GetFunction");
}
...
static void make_vtable_IDirect3DQuery9Vtbl(x86emu_t* emu, IDirect3DQuery9Vtbl* new, IDirect3DQuery9Vtbl* real)
{
    ...
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->GetType = (void*)AddBridge(emu->context->system, iFp, real->GetType, 1*4, "GetType");
    new->GetDataSize = (void*)AddBridge(emu->context->system, uFp, real->GetDataSize, 1*4, "GetDataSize");
    new->Issue = (void*)AddBridge(emu->context->system, iFpu, real->Issue, 2*4, "Issue");
    new->GetData = (void*)AddBridge(emu->context->system, iFppuu, real->GetData, 4*4, "GetData");
}
...
static void make_vtable_IDirect3DStateBlock9Vtbl(x86emu_t* emu, IDirect3DStateBlock9Vtbl* new, IDirect3DStateBlock9Vtbl* real)
{
    ...
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->Capture = (void*)AddBridge(emu->context->system, iFp, real->Capture, 1*4, "Capture");
    new->Apply = (void*)AddBridge(emu->context->system, iFp, real->Apply, 1*4, "Apply");
}
...
static void make_vtable_IDirect3DSurface9Vtbl(x86emu_t* emu, IDirect3DSurface9Vtbl* new, IDirect3DSurface9Vtbl* real)
{
    ...
    new->GetContainer = (void*)AddBridge(emu->context->system, iFppp, real->GetContainer, 3*4, "GetContainer");
    new->GetDesc = (void*)AddBridge(emu->context->system, iFpp, real->GetDesc, 2*4, "GetDesc");
    new->LockRect = (void*)AddBridge(emu->context->system, iFpppu, real->LockRect, 4*4, "LockRect");
    new->UnlockRect = (void*)AddBridge(emu->context->system, iFp, real->UnlockRect, 1*4, "UnlockRect");
    new->GetDC = (void*)AddBridge(emu->context->system, iFpp, real->GetDC, 2*4, "GetDC");
    new->ReleaseDC = (void*)AddBridge(emu->context->system, iFpp, real->ReleaseDC, 2*4, "ReleaseDC");
}
...
static void make_vtable_IDirect3DSwapChain9Vtbl(x86emu_t* emu, IDirect3DSwapChain9Vtbl* new, IDirect3DSwapChain9Vtbl* real)
{
    ...
    new->Present = (void*)AddBridge(emu->context->system, iFpppppu, real->Present, 6*4, "Present");
    new->GetFrontBufferData = (void*)AddBridge(emu->context->system, iFpp, real->GetFrontBufferData, 2*4, "GetFrontBufferData");
    new->GetBackBuffer = (void*)AddBridge(emu->context->system, iFpuip, real->GetBackBuffer, 4*4, "GetBackBuffer");
    new->GetRasterStatus = (void*)AddBridge(emu->context->system, iFpp, real->GetRasterStatus, 2*4, "GetRasterStatus");
    new->GetDisplayMode = (void*)AddBridge(emu->context->system, iFpp, real->GetDisplayMode, 2*4, "GetDisplayMode");
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->GetPresentParameters = (void*)AddBridge(emu->context->system, iFpp, real->GetPresentParameters, 2*4, "GetPresentParameters");
}
...
static void make_vtable_IDirect3DSwapChain9ExVtbl(x86emu_t* emu, IDirect3DSwapChain9ExVtbl* new, IDirect3DSwapChain9ExVtbl* real)
{
    ...
    new->GetLastPresentCount = (void*)AddBridge(emu->context->system, iFpp, real->GetLastPresentCount, 2*4, "GetLastPresentCount");
    new->GetPresentStats = (void*)AddBridge(emu->context->system, iFpp, real->GetPresentStats, 2*4, "GetPresentStats");
    new->GetDisplayModeEx = (void*)AddBridge(emu->context->system, iFppp, real->GetDisplayModeEx, 3*4, "GetDisplayModeEx");
}
...
static void make_vtable_IDirect3DTexture9Vtbl(x86emu_t* emu, IDirect3DTexture9Vtbl* new, IDirect3DTexture9Vtbl* real)
{
    ...
    new->GetLevelDesc = (void*)AddBridge(emu->context->system, iFpup, real->GetLevelDesc, 3*4, "GetLevelDesc");
    my_GetSurfaceLevel_real = (void*)real->GetSurfaceLevel; new->GetSurfaceLevel = (void*)AddBridge(emu->context->system, iFEpup, my_GetSurfaceLevel, 3*4, "my_" "GetSurfaceLevel");
    new->LockRect = (void*)AddBridge(emu->context->system, iFpuppu, real->LockRect, 5*4, "LockRect");
    new->UnlockRect = (void*)AddBridge(emu->context->system, iFpu, real->UnlockRect, 2*4, "UnlockRect");
    new->AddDirtyRect = (void*)AddBridge(emu->context->system, iFpp, real->AddDirtyRect, 2*4, "AddDirtyRect");
}
...
static void make_vtable_IDirect3DVertexDeclaration9Vtbl(x86emu_t* emu, IDirect3DVertexDeclaration9Vtbl* new, IDirect3DVertexDeclaration9Vtbl* real)
{
    ...
    new->GetDevice = (void*)AddBridge(emu->context->system, iFpp, real->GetDevice, 2*4, "GetDevice");
    new->GetDeclaration = (void*)AddBridge(emu->context->system, iFppp, real->GetDeclaration, 3*4, "GetDeclaration");
}
...
static void make_vtable_IDirect3DVolume9Vtbl(x86emu_t* emu, IDirect3DVolume9Vtbl* new, IDirect3DVolume9Vtbl* real)
{
    ...
    new->GetContainer = (void*)AddBridge(emu->context->system, iFppp, real->GetContainer, 3*4, "GetContainer");
    new->GetDesc = (void*)AddBridge(emu->context->system, iFpp, real->GetDesc, 2*4, "GetDesc");
    new->LockBox = (void*)AddBridge(emu->context->system, iFpppu, real->LockBox, 4*4, "LockBox");
    new->UnlockBox = (void*)AddBridge(emu->context->system, iFp, real->UnlockBox, 1*4, "UnlockBox");
}
...
static void make_vtable_IDirect3DVolumeTexture9Vtbl(x86emu_t* emu, IDirect3DVolumeTexture9Vtbl* new, IDirect3DVolumeTexture9Vtbl* real)
{
    ...
    new->GetLevelDesc = (void*)AddBridge(emu->context->system, iFpup, real->GetLevelDesc, 3*4, "GetLevelDesc");
    my_GetVolumeLevel_real = (void*)real->GetVolumeLevel; new->GetVolumeLevel = (void*)AddBridge(emu->context->system, iFEpup, my_GetVolumeLevel, 3*4, "my_" "GetVolumeLevel");
    new->LockBox = (void*)AddBridge(emu->context->system, iFpuppu, real->LockBox, 5*4, "LockBox");
    new->UnlockBox = (void*)AddBridge(emu->context->system, iFpu, real->UnlockBox, 2*4, "UnlockBox");
    new->AddDirtyBox = (void*)AddBridge(emu->context->system, iFpp, real->AddDirtyBox, 2*4, "AddDirtyBox");
}
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
...
# 183 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
static int my_CreateAuthenticatedChannel(x86emu_t* emu, void* This, int ChannelType, void*** ppAuthenticatedChannel, void* pChannelHandle) { int r = my_CreateAuthenticatedChannel_real(This, ChannelType, ppAuthenticatedChannel, pChannelHandle); if (r) return r; if (!my->vtables.my_IDirect3DAuthenticatedChannel9Vtbl_init) { make_vtable_IDirect3DAuthenticatedChannel9Vtbl(emu, &my->vtables.my_IDirect3DAuthenticatedChannel9Vtbl, **ppAuthenticatedChannel); my->vtables.my_IDirect3DAuthenticatedChannel9Vtbl_init = 1; } (*ppAuthenticatedChannel)[0] = &my->vtables.my_IDirect3DAuthenticatedChannel9Vtbl; (*ppAuthenticatedChannel)[1] = &my->vtables.my_IDirect3DAuthenticatedChannel9Vtbl; return 0; }
static int my_CreateCryptoSession(x86emu_t* emu, void* This, const void* pCryptoType, const void* pDecodeProfile, void*** ppCryptoSession, void* pCryptoHandle) { int r = my_CreateCryptoSession_real(This, pCryptoType, pDecodeProfile, ppCryptoSession, pCryptoHandle); if (r) return r; if (!my->vtables.my_IDirect3DCryptoSession9Vtbl_init) { make_vtable_IDirect3DCryptoSession9Vtbl(emu, &my->vtables.my_IDirect3DCryptoSession9Vtbl, **ppCryptoSession); my->vtables.my_IDirect3DCryptoSession9Vtbl_init = 1; } (*ppCryptoSession)[0] = &my->vtables.my_IDirect3DCryptoSession9Vtbl; (*ppCryptoSession)[1] = &my->vtables.my_IDirect3DCryptoSession9Vtbl; return 0; }
static int my_CreateCubeTexture(x86emu_t* emu, void* This, unsigned EdgeLength, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppCubeTexture, void* pSharedHandle) { int r = my_CreateCubeTexture_real(This, EdgeLength, Levels, Usage, Format, Pool, ppCubeTexture, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DCubeTexture9Vtbl_init) { make_vtable_IDirect3DCubeTexture9Vtbl(emu, &my->vtables.my_IDirect3DCubeTexture9Vtbl, **ppCubeTexture); my->vtables.my_IDirect3DCubeTexture9Vtbl_init = 1; } (*ppCubeTexture)[0] = &my->vtables.my_IDirect3DCubeTexture9Vtbl; (*ppCubeTexture)[1] = &my->vtables.my_IDirect3DCubeTexture9Vtbl; return 0; }
static int my_CreateIndexBuffer(x86emu_t* emu, void* This, unsigned Length, unsigned Usage, int Format, int Pool, void*** ppIndexBuffer, void* pSharedHandle) { int r = my_CreateIndexBuffer_real(This, Length, Usage, Format, Pool, ppIndexBuffer, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DIndexBuffer9Vtbl_init) { make_vtable_IDirect3DIndexBuffer9Vtbl(emu, &my->vtables.my_IDirect3DIndexBuffer9Vtbl, **ppIndexBuffer); my->vtables.my_IDirect3DIndexBuffer9Vtbl_init = 1; } (*ppIndexBuffer)[0] = &my->vtables.my_IDirect3DIndexBuffer9Vtbl; (*ppIndexBuffer)[1] = &my->vtables.my_IDirect3DIndexBuffer9Vtbl; return 0; }
static int my_CreatePixelShader(x86emu_t* emu, void* This, const void* pFunction, void*** ppShader) { int r = my_CreatePixelShader_real(This, pFunction, ppShader); if (r) return r; if (!my->vtables.my_IDirect3DPixelShader9Vtbl_init) { make_vtable_IDirect3DPixelShader9Vtbl(emu, &my->vtables.my_IDirect3DPixelShader9Vtbl, **ppShader); my->vtables.my_IDirect3DPixelShader9Vtbl_init = 1; } (*ppShader)[0] = &my->vtables.my_IDirect3DPixelShader9Vtbl; (*ppShader)[1] = &my->vtables.my_IDirect3DPixelShader9Vtbl; return 0; }
static int my_CheckResourceResidency(x86emu_t* emu, void* This, void*** pResourceArray, unsigned NumResources) { int r = my_CheckResourceResidency_real(This, pResourceArray, NumResources); if (r) return r; if (!my->vtables.my_IDirect3DResource9Vtbl_init) { make_vtable_IDirect3DResource9Vtbl(emu, &my->vtables.my_IDirect3DResource9Vtbl, **pResourceArray); my->vtables.my_IDirect3DResource9Vtbl_init = 1; } (*pResourceArray)[0] = &my->vtables.my_IDirect3DResource9Vtbl; (*pResourceArray)[1] = &my->vtables.my_IDirect3DResource9Vtbl; return 0; }
static int my_CreateStateBlock(x86emu_t* emu, void* This, int Type, void*** ppSB) { int r = my_CreateStateBlock_real(This, Type, ppSB); if (r) return r; if (!my->vtables.my_IDirect3DStateBlock9Vtbl_init) { make_vtable_IDirect3DStateBlock9Vtbl(emu, &my->vtables.my_IDirect3DStateBlock9Vtbl, **ppSB); my->vtables.my_IDirect3DStateBlock9Vtbl_init = 1; } (*ppSB)[0] = &my->vtables.my_IDirect3DStateBlock9Vtbl; (*ppSB)[1] = &my->vtables.my_IDirect3DStateBlock9Vtbl; return 0; }
static int my_EndStateBlock(x86emu_t* emu, void* This, void*** ppSB) { int r = my_EndStateBlock_real(This, ppSB); if (r) return r; if (!my->vtables.my_IDirect3DStateBlock9Vtbl_init) { make_vtable_IDirect3DStateBlock9Vtbl(emu, &my->vtables.my_IDirect3DStateBlock9Vtbl, **ppSB); my->vtables.my_IDirect3DStateBlock9Vtbl_init = 1; } (*ppSB)[0] = &my->vtables.my_IDirect3DStateBlock9Vtbl; (*ppSB)[1] = &my->vtables.my_IDirect3DStateBlock9Vtbl; return 0; }
static int my_CreateDepthStencilSurfaceEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle, unsigned Usage) { int r = my_CreateDepthStencilSurfaceEx_real(This, Width, Height, Format, MultiSample, MultisampleQuality, Discard, ppSurface, pSharedHandle, Usage); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateDepthStencilSurface(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Discard, void*** ppSurface, void* pSharedHandle) { int r = my_CreateDepthStencilSurface_real(This, Width, Height, Format, MultiSample, MultisampleQuality, Discard, ppSurface, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateOffscreenPlainSurfaceEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle, unsigned Usage) { int r = my_CreateOffscreenPlainSurfaceEx_real(This, Width, Height, Format, Pool, ppSurface, pSharedHandle, Usage); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateOffscreenPlainSurface(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int Pool, void*** ppSurface, void* pSharedHandle) { int r = my_CreateOffscreenPlainSurface_real(This, Width, Height, Format, Pool, ppSurface, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateRenderTargetEx(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle, unsigned Usage) { int r = my_CreateRenderTargetEx_real(This, Width, Height, Format, MultiSample, MultisampleQuality, Lockable, ppSurface, pSharedHandle, Usage); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateRenderTarget(x86emu_t* emu, void* This, unsigned Width, unsigned Height, int Format, int MultiSample, unsigned MultisampleQuality, int Lockable, void*** ppSurface, void* pSharedHandle) { int r = my_CreateRenderTarget_real(This, Width, Height, Format, MultiSample, MultisampleQuality, Lockable, ppSurface, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_GetCubeMapSurface(x86emu_t* emu, void* This, int FaceType, unsigned Level, void*** ppCubeMapSurface) { int r = my_GetCubeMapSurface_real(This, FaceType, Level, ppCubeMapSurface); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppCubeMapSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppCubeMapSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppCubeMapSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_GetDepthStencilSurface(x86emu_t* emu, void* This, void*** ppZStencilSurface) { int r = my_GetDepthStencilSurface_real(This, ppZStencilSurface); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppZStencilSurface); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppZStencilSurface)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppZStencilSurface)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_GetBackBuffer(x86emu_t* emu, void* This, unsigned iSwapChain, unsigned iBackBuffer, int Type, void*** ppBackBuffer) { int r = my_GetBackBuffer_real(This, iSwapChain, iBackBuffer, Type, ppBackBuffer); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppBackBuffer); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppBackBuffer)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppBackBuffer)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_GetRenderTarget(x86emu_t* emu, void* This, unsigned RenderTargetIndex, void*** ppRenderTarget) { int r = my_GetRenderTarget_real(This, RenderTargetIndex, ppRenderTarget); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppRenderTarget); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppRenderTarget)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppRenderTarget)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_GetSurfaceLevel(x86emu_t* emu, void* This, unsigned Level, void*** ppSurfaceLevel) { int r = my_GetSurfaceLevel_real(This, Level, ppSurfaceLevel); if (r) return r; if (!my->vtables.my_IDirect3DSurface9Vtbl_init) { make_vtable_IDirect3DSurface9Vtbl(emu, &my->vtables.my_IDirect3DSurface9Vtbl, **ppSurfaceLevel); my->vtables.my_IDirect3DSurface9Vtbl_init = 1; } (*ppSurfaceLevel)[0] = &my->vtables.my_IDirect3DSurface9Vtbl; (*ppSurfaceLevel)[1] = &my->vtables.my_IDirect3DSurface9Vtbl; return 0; }
static int my_CreateAdditionalSwapChain(x86emu_t* emu, void* This, void* pPresentationParameters, void*** pSwapChain) { int r = my_CreateAdditionalSwapChain_real(This, pPresentationParameters, pSwapChain); if (r) return r; if (!my->vtables.my_IDirect3DSwapChain9Vtbl_init) { make_vtable_IDirect3DSwapChain9Vtbl(emu, &my->vtables.my_IDirect3DSwapChain9Vtbl, **pSwapChain); my->vtables.my_IDirect3DSwapChain9Vtbl_init = 1; } (*pSwapChain)[0] = &my->vtables.my_IDirect3DSwapChain9Vtbl; (*pSwapChain)[1] = &my->vtables.my_IDirect3DSwapChain9Vtbl; return 0; }
static int my_GetSwapChain(x86emu_t* emu, void* This, unsigned iSwapChain, void*** pSwapChain) { int r = my_GetSwapChain_real(This, iSwapChain, pSwapChain); if (r) return r; if (!my->vtables.my_IDirect3DSwapChain9Vtbl_init) { make_vtable_IDirect3DSwapChain9Vtbl(emu, &my->vtables.my_IDirect3DSwapChain9Vtbl, **pSwapChain); my->vtables.my_IDirect3DSwapChain9Vtbl_init = 1; } (*pSwapChain)[0] = &my->vtables.my_IDirect3DSwapChain9Vtbl; (*pSwapChain)[1] = &my->vtables.my_IDirect3DSwapChain9Vtbl; return 0; }
static int my_CreateTexture(x86emu_t* emu, void* This, unsigned Width, unsigned Height, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppTexture, void* pSharedHandle) { int r = my_CreateTexture_real(This, Width, Height, Levels, Usage, Format, Pool, ppTexture, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DTexture9Vtbl_init) { make_vtable_IDirect3DTexture9Vtbl(emu, &my->vtables.my_IDirect3DTexture9Vtbl, **ppTexture); my->vtables.my_IDirect3DTexture9Vtbl_init = 1; } (*ppTexture)[0] = &my->vtables.my_IDirect3DTexture9Vtbl; (*ppTexture)[1] = &my->vtables.my_IDirect3DTexture9Vtbl; return 0; }
static int my_CreateVertexBuffer(x86emu_t* emu, void* This, unsigned Length, unsigned Usage, unsigned FVF, int Pool, void*** ppVertexBuffer, void* pSharedHandle) { int r = my_CreateVertexBuffer_real(This, Length, Usage, FVF, Pool, ppVertexBuffer, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DVertexBuffer9Vtbl_init) { make_vtable_IDirect3DVertexBuffer9Vtbl(emu, &my->vtables.my_IDirect3DVertexBuffer9Vtbl, **ppVertexBuffer); my->vtables.my_IDirect3DVertexBuffer9Vtbl_init = 1; } (*ppVertexBuffer)[0] = &my->vtables.my_IDirect3DVertexBuffer9Vtbl; (*ppVertexBuffer)[1] = &my->vtables.my_IDirect3DVertexBuffer9Vtbl; return 0; }
static int my_CreateVertexDeclaration(x86emu_t* emu, void* This, const void* pVertexElements, void*** ppDecl) { int r = my_CreateVertexDeclaration_real(This, pVertexElements, ppDecl); if (r) return r; if (!my->vtables.my_IDirect3DVertexDeclaration9Vtbl_init) { make_vtable_IDirect3DVertexDeclaration9Vtbl(emu, &my->vtables.my_IDirect3DVertexDeclaration9Vtbl, **ppDecl); my->vtables.my_IDirect3DVertexDeclaration9Vtbl_init = 1; } (*ppDecl)[0] = &my->vtables.my_IDirect3DVertexDeclaration9Vtbl; (*ppDecl)[1] = &my->vtables.my_IDirect3DVertexDeclaration9Vtbl; return 0; }
static int my_CreateVertexShader(x86emu_t* emu, void* This, const void* pFunction, void*** ppShader) { int r = my_CreateVertexShader_real(This, pFunction, ppShader); if (r) return r; if (!my->vtables.my_IDirect3DVertexShader9Vtbl_init) { make_vtable_IDirect3DVertexShader9Vtbl(emu, &my->vtables.my_IDirect3DVertexShader9Vtbl, **ppShader); my->vtables.my_IDirect3DVertexShader9Vtbl_init = 1; } (*ppShader)[0] = &my->vtables.my_IDirect3DVertexShader9Vtbl; (*ppShader)[1] = &my->vtables.my_IDirect3DVertexShader9Vtbl; return 0; }
static int my_GetVolumeLevel(x86emu_t* emu, void* This, unsigned Level, void*** ppVolumeLevel) { int r = my_GetVolumeLevel_real(This, Level, ppVolumeLevel); if (r) return r; if (!my->vtables.my_IDirect3DVolume9Vtbl_init) { make_vtable_IDirect3DVolume9Vtbl(emu, &my->vtables.my_IDirect3DVolume9Vtbl, **ppVolumeLevel); my->vtables.my_IDirect3DVolume9Vtbl_init = 1; } (*ppVolumeLevel)[0] = &my->vtables.my_IDirect3DVolume9Vtbl; (*ppVolumeLevel)[1] = &my->vtables.my_IDirect3DVolume9Vtbl; return 0; }
static int my_CreateVolumeTexture(x86emu_t* emu, void* This, unsigned Width, unsigned Height, unsigned Depth, unsigned Levels, unsigned Usage, int Format, int Pool, void*** ppVolumeTexture, void* pSharedHandle) { int r = my_CreateVolumeTexture_real(This, Width, Height, Depth, Levels, Usage, Format, Pool, ppVolumeTexture, pSharedHandle); if (r) return r; if (!my->vtables.my_IDirect3DVolumeTexture9Vtbl_init) { make_vtable_IDirect3DVolumeTexture9Vtbl(emu, &my->vtables.my_IDirect3DVolumeTexture9Vtbl, **ppVolumeTexture); my->vtables.my_IDirect3DVolumeTexture9Vtbl_init = 1; } (*ppVolumeTexture)[0] = &my->vtables.my_IDirect3DVolumeTexture9Vtbl; (*ppVolumeTexture)[1] = &my->vtables.my_IDirect3DVolumeTexture9Vtbl; return 0; }

static int my_CreateQuery(x86emu_t* emu, void* This, int Type, void*** ppQuery) { int r = my_CreateQuery_real(This, Type, ppQuery); if ((r || !ppQuery)) return r; if (!my->vtables.my_IDirect3DQuery9Vtbl_init) { make_vtable_IDirect3DQuery9Vtbl(emu, &my->vtables.my_IDirect3DQuery9Vtbl, **ppQuery); my->vtables.my_IDirect3DQuery9Vtbl_init = 1; } (*ppQuery)[0] = &my->vtables.my_IDirect3DQuery9Vtbl; (*ppQuery)[1] = &my->vtables.my_IDirect3DQuery9Vtbl; return 0; }
...
# 278 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
static uintptr_t my_Present_QueryInterface_fct = 0; static int my_Present_QueryInterface(void* a, void* b, void** c) { int r = (int)RunFunctionFmt(my_Present_QueryInterface_fct, "ppp", a, b, c); return r; } static uintptr_t my_Present_AddRef_fct = 0; static unsigned my_Present_AddRef(void* a) { unsigned r = (unsigned)RunFunctionFmt(my_Present_AddRef_fct, "p", a); return r; } static uintptr_t my_Present_Release_fct = 0; static unsigned my_Present_Release(void* a) { unsigned r = (unsigned)RunFunctionFmt(my_Present_Release_fct, "p", a); return r; } static uintptr_t my_Present_SetPresentParameters_fct = 0; static int my_Present_SetPresentParameters(void* a, void* b, void* c) { int r = (int)RunFunctionFmt(my_Present_SetPresentParameters_fct, "ppp", a, b, c); return r; } static uintptr_t my_Present_NewD3DWindowBufferFromDmaBuf_fct = 0; static int my_Present_NewD3DWindowBufferFromDmaBuf(void* a, int b, int c, int d, int e, int f, int g, void** h) { int r = (int)RunFunctionFmt(my_Present_NewD3DWindowBufferFromDmaBuf_fct, "piiiiiip", a, b, c, d, e, f, g, h); return r; } static uintptr_t my_Present_DestroyD3DWindowBuffer_fct = 0; static int my_Present_DestroyD3DWindowBuffer(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_DestroyD3DWindowBuffer_fct, "pp", a, b); return r; } static uintptr_t my_Present_WaitBufferReleased_fct = 0; static int my_Present_WaitBufferReleased(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_WaitBufferReleased_fct, "pp", a, b); return r; } static uintptr_t my_Present_FrontBufferCopy_fct = 0; static int my_Present_FrontBufferCopy(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_FrontBufferCopy_fct, "pp", a, b); return r; } static uintptr_t my_Present_PresentBuffer_fct = 0; static int my_Present_PresentBuffer(void* a, void* b, void* c, const void* d, const void* e, const void* f, unsigned g) { int r = (int)RunFunctionFmt(my_Present_PresentBuffer_fct, "ppppppu", a, b, c, d, e, f, g); return r; } static uintptr_t my_Present_GetRasterStatus_fct = 0; static int my_Present_GetRasterStatus(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_GetRasterStatus_fct, "pp", a, b); return r; } static uintptr_t my_Present_GetDisplayMode_fct = 0; static int my_Present_GetDisplayMode(void* a, void* b, void* c) { int r = (int)RunFunctionFmt(my_Present_GetDisplayMode_fct, "ppp", a, b, c); return r; } static uintptr_t my_Present_GetPresentStats_fct = 0; static int my_Present_GetPresentStats(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_GetPresentStats_fct, "pp", a, b); return r; } static uintptr_t my_Present_GetCursorPos_fct = 0; static int my_Present_GetCursorPos(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_GetCursorPos_fct, "pp", a, b); return r; } static uintptr_t my_Present_SetCursorPos_fct = 0; static int my_Present_SetCursorPos(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_SetCursorPos_fct, "pp", a, b); return r; } static uintptr_t my_Present_SetCursor_fct = 0; static int my_Present_SetCursor(void* a, void* b, void* c, int d) { int r = (int)RunFunctionFmt(my_Present_SetCursor_fct, "pppi", a, b, c, d); return r; } static uintptr_t my_Present_SetGammaRamp_fct = 0; static int my_Present_SetGammaRamp(void* a, const void* b, void* c) { int r = (int)RunFunctionFmt(my_Present_SetGammaRamp_fct, "ppp", a, b, c); return r; } static uintptr_t my_Present_GetWindowInfo_fct = 0; static int my_Present_GetWindowInfo(void* a, void* b, void* c, void* d, void* e) { int r = (int)RunFunctionFmt(my_Present_GetWindowInfo_fct, "pppp", a, b, c, d, e); return r; } static uintptr_t my_Present_GetWindowOccluded_fct = 0; static int my_Present_GetWindowOccluded(void* a) { int r = (int)RunFunctionFmt(my_Present_GetWindowOccluded_fct, "p", a); return r; } static uintptr_t my_Present_ResolutionMismatch_fct = 0; static int my_Present_ResolutionMismatch(void* a) { int r = (int)RunFunctionFmt(my_Present_ResolutionMismatch_fct, "p", a); return r; } static uintptr_t my_Present_CreateThread_fct = 0; static void* my_Present_CreateThread(void* a, void* b, void* c) { void* r = (void*)RunFunctionFmt(my_Present_CreateThread_fct, "ppp", a, b, c); return r; } static uintptr_t my_Present_WaitForThread_fct = 0; static int my_Present_WaitForThread(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_WaitForThread_fct, "pp", a, b); return r; } static uintptr_t my_Present_SetPresentParameters2_fct = 0; static int my_Present_SetPresentParameters2(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_SetPresentParameters2_fct, "pp", a, b); return r; } static uintptr_t my_Present_IsBufferReleased_fct = 0; static int my_Present_IsBufferReleased(void* a, void* b) { int r = (int)RunFunctionFmt(my_Present_IsBufferReleased_fct, "pp", a, b); return r; } static uintptr_t my_Present_WaitBufferReleaseEvent_fct = 0; static int my_Present_WaitBufferReleaseEvent(void* a) { int r = (int)RunFunctionFmt(my_Present_WaitBufferReleaseEvent_fct, "p", a); return r; }

static void fixup_PresentVtbl(ID3DPresentVtbl *vtbl)
{
    my_Present_QueryInterface_fct = (uintptr_t)vtbl->QueryInterface; vtbl->QueryInterface = my_Present_QueryInterface; my_Present_AddRef_fct = (uintptr_t)vtbl->AddRef; vtbl->AddRef = my_Present_AddRef; my_Present_Release_fct = (uintptr_t)vtbl->Release; vtbl->Release = my_Present_Release; my_Present_SetPresentParameters_fct = (uintptr_t)vtbl->SetPresentParameters; vtbl->SetPresentParameters = my_Present_SetPresentParameters; my_Present_NewD3DWindowBufferFromDmaBuf_fct = (uintptr_t)vtbl->NewD3DWindowBufferFromDmaBuf; vtbl->NewD3DWindowBufferFromDmaBuf = my_Present_NewD3DWindowBufferFromDmaBuf; my_Present_DestroyD3DWindowBuffer_fct = (uintptr_t)vtbl->DestroyD3DWindowBuffer; vtbl->DestroyD3DWindowBuffer = my_Present_DestroyD3DWindowBuffer; my_Present_WaitBufferReleased_fct = (uintptr_t)vtbl->WaitBufferReleased; vtbl->WaitBufferReleased = my_Present_WaitBufferReleased; my_Present_FrontBufferCopy_fct = (uintptr_t)vtbl->FrontBufferCopy; vtbl->FrontBufferCopy = my_Present_FrontBufferCopy; my_Present_PresentBuffer_fct = (uintptr_t)vtbl->PresentBuffer; vtbl->PresentBuffer = my_Present_PresentBuffer; my_Present_GetRasterStatus_fct = (uintptr_t)vtbl->GetRasterStatus; vtbl->GetRasterStatus = my_Present_GetRasterStatus; my_Present_GetDisplayMode_fct = (uintptr_t)vtbl->GetDisplayMode; vtbl->GetDisplayMode = my_Present_GetDisplayMode; my_Present_GetPresentStats_fct = (uintptr_t)vtbl->GetPresentStats; vtbl->GetPresentStats = my_Present_GetPresentStats; my_Present_GetCursorPos_fct = (uintptr_t)vtbl->GetCursorPos; vtbl->GetCursorPos = my_Present_GetCursorPos; my_Present_SetCursorPos_fct = (uintptr_t)vtbl->SetCursorPos; vtbl->SetCursorPos = my_Present_SetCursorPos; my_Present_SetCursor_fct = (uintptr_t)vtbl->SetCursor; vtbl->SetCursor = my_Present_SetCursor; my_Present_SetGammaRamp_fct = (uintptr_t)vtbl->SetGammaRamp; vtbl->SetGammaRamp = my_Present_SetGammaRamp; my_Present_GetWindowInfo_fct = (uintptr_t)vtbl->GetWindowInfo; vtbl->GetWindowInfo = my_Present_GetWindowInfo; my_Present_GetWindowOccluded_fct = (uintptr_t)vtbl->GetWindowOccluded; vtbl->GetWindowOccluded = my_Present_GetWindowOccluded; my_Present_ResolutionMismatch_fct = (uintptr_t)vtbl->ResolutionMismatch; vtbl->ResolutionMismatch = my_Present_ResolutionMismatch; my_Present_CreateThread_fct = (uintptr_t)vtbl->CreateThread; vtbl->CreateThread = my_Present_CreateThread; my_Present_WaitForThread_fct = (uintptr_t)vtbl->WaitForThread; vtbl->WaitForThread = my_Present_WaitForThread; my_Present_SetPresentParameters2_fct = (uintptr_t)vtbl->SetPresentParameters2; vtbl->SetPresentParameters2 = my_Present_SetPresentParameters2; my_Present_IsBufferReleased_fct = (uintptr_t)vtbl->IsBufferReleased; vtbl->IsBufferReleased = my_Present_IsBufferReleased; my_Present_WaitBufferReleaseEvent_fct = (uintptr_t)vtbl->WaitBufferReleaseEvent; vtbl->WaitBufferReleaseEvent = my_Present_WaitBufferReleaseEvent;
}


static int pres_init = 0;
# 305 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c"
static uintptr_t my_PresentGroup_QueryInterface_fct = 0; static int my_PresentGroup_QueryInterface(void* a, void* b, void** c) { int r = (int)RunFunctionFmt(my_PresentGroup_QueryInterface_fct, "ppp", a, b, c); return r; } static uintptr_t my_PresentGroup_AddRef_fct = 0; static unsigned my_PresentGroup_AddRef(void* a) { unsigned r = (unsigned)RunFunctionFmt(my_PresentGroup_AddRef_fct, "p", a); return r; } static uintptr_t my_PresentGroup_Release_fct = 0; static unsigned my_PresentGroup_Release(void* a) { unsigned r = (unsigned)RunFunctionFmt(my_PresentGroup_Release_fct, "p", a); return r; } static uintptr_t my_PresentGroup_GetMultiheadCount_fct = 0; static unsigned my_PresentGroup_GetMultiheadCount(void* a) { unsigned r = (unsigned)RunFunctionFmt(my_PresentGroup_GetMultiheadCount_fct, "p", a); return r; } static uintptr_t my_PresentGroup_GetPresent_fct = 0; static int my_PresentGroup_GetPresent(void* a, unsigned b, void** c) { int r = (int)RunFunctionFmt(my_PresentGroup_GetPresent_fct, "pup", a, b, c); ID3DPresentVtbl*** vtbl = (void*)c; if (!pres_init) fixup_PresentVtbl(**vtbl); pres_init = 1; return r; } static uintptr_t my_PresentGroup_CreateAdditionalPresent_fct = 0; static int my_PresentGroup_CreateAdditionalPresent(void* a, void* b, void** c) { int r = (int)RunFunctionFmt(my_PresentGroup_CreateAdditionalPresent_fct, "ppp", a, b, c); return r; } static uintptr_t my_PresentGroup_GetVersion_fct = 0; static int my_PresentGroup_GetVersion(void* a, void* b, void* c) { int r = (int)RunFunctionFmt(my_PresentGroup_GetVersion_fct, "ppp", a, b, c); return r; }

static void fixup_PresentGroupVtbl(ID3DPresentGroupVtbl *vtbl)
{
    my_PresentGroup_QueryInterface_fct = (uintptr_t)vtbl->QueryInterface; vtbl->QueryInterface = my_PresentGroup_QueryInterface; my_PresentGroup_AddRef_fct = (uintptr_t)vtbl->AddRef; vtbl->AddRef = my_PresentGroup_AddRef; my_PresentGroup_Release_fct = (uintptr_t)vtbl->Release; vtbl->Release = my_PresentGroup_Release; my_PresentGroup_GetMultiheadCount_fct = (uintptr_t)vtbl->GetMultiheadCount; vtbl->GetMultiheadCount = my_PresentGroup_GetMultiheadCount; my_PresentGroup_GetPresent_fct = (uintptr_t)vtbl->GetPresent; vtbl->GetPresent = my_PresentGroup_GetPresent; my_PresentGroup_CreateAdditionalPresent_fct = (uintptr_t)vtbl->CreateAdditionalPresent; vtbl->CreateAdditionalPresent = my_PresentGroup_CreateAdditionalPresent; my_PresentGroup_GetVersion_fct = (uintptr_t)vtbl->GetVersion; vtbl->GetVersion = my_PresentGroup_GetVersion;
}
...
__attribute__((visibility("default"))) void* my_D3DAdapter9GetProc(x86emu_t* emu, void *ptr)
{
    (void)ptr;

    *(uint32_t *)(emu->regs[_SP].dword[0] + 4) = *(uint32_t *)(emu->regs[_SP].dword[0]);
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedd3dadapter9defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t d3dadapter9symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1
...
static const map_onesymbol_t d3dadapter9mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1




{"D3DAdapter9GetProc", pFEp, 0},
# 68 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t d3dadapter9stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1
...
static const map_onesymbol2_t d3dadapter9symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1
...
static const map_onedata_t d3dadapter9datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1
...
static const map_onedata_t d3dadapter9mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedd3dadapter9undefs.h" 1
...
int wrappedd3dadapter9_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(d3dadapter9Name, 
...
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        lib->w.lib = dlopen("/usr/lib/arm-linux-gnueabihf/d3d/d3dadapter9.so.1", 
...
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(d3dadapter9Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(d3dadapter9symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (d3dadapter9symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, d3dadapter9symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = d3dadapter9symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, d3dadapter9symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = d3dadapter9symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(d3dadapter9symbolmap[i].name, '@')) AddDictionnary(box86->versym, d3dadapter9symbolmap[i].name); }
 cnt = sizeof(d3dadapter9mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (d3dadapter9mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, d3dadapter9mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = d3dadapter9mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, d3dadapter9mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = d3dadapter9mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(d3dadapter9mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, d3dadapter9mysymbolmap[i].name); }

    cnt = sizeof(d3dadapter9stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, d3dadapter9stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = d3dadapter9stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(d3dadapter9stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, d3dadapter9stsymbolmap[i].name);
    }
    cnt = sizeof(d3dadapter9symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, d3dadapter9symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = d3dadapter9symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = d3dadapter9symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = d3dadapter9symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(d3dadapter9symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, d3dadapter9symbol2map[i].name);
    }
    cnt = sizeof(d3dadapter9datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(d3dadapter9datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, d3dadapter9datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = d3dadapter9datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, d3dadapter9datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = d3dadapter9datamap[i].sz;
        }
    }
    cnt = sizeof(d3dadapter9mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, d3dadapter9mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = d3dadapter9mydatamap[i].sz;
    }
...
void wrappedd3dadapter9_fini(library_t* lib)
{
...
# 474 "/home/ssd/pico/code/box86/src/wrapped/wrappedd3dadapter9.c" 2
