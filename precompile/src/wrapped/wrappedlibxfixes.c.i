# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2




    const char* libxfixesName = "libXfixes.so.3";
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxfixesdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxfixessymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1




{"XFixesChangeCursor", vFppp, 0},
{"XFixesChangeCursorByName", vFppp, 0},
{"XFixesChangeSaveSet", vFppiii, 0},
{"XFixesCopyRegion", vFppp, 0},
{"XFixesCreatePointerBarrier", pFppiiiiiip, 0},
{"XFixesCreateRegion", pFppi, 0},
{"XFixesCreateRegionFromBitmap", pFpp, 0},
{"XFixesCreateRegionFromGC", pFpp, 0},
{"XFixesCreateRegionFromPicture", pFpp, 0},
{"XFixesCreateRegionFromWindow", pFppi, 0},
{"XFixesDestroyPointerBarrier", vFpp, 0},
{"XFixesDestroyRegion", vFpp, 0},
{"XFixesExpandRegion", vFpppuuuu, 0},


{"XFixesFetchRegion", pFppp, 0},
{"XFixesFetchRegionAndBounds", pFpppp, 0},
{"XFixesFindDisplay", pFp, 0},
{"XFixesGetCursorImage", pFp, 0},
{"XFixesGetCursorName", pFppp, 0},
{"XFixesHideCursor", vFpp, 0},
{"XFixesIntersectRegion", vFpppp, 0},
{"XFixesInvertRegion", vFpppp, 0},
{"XFixesQueryExtension", iFppp, 0},
{"XFixesQueryVersion", iFppp, 0},
{"XFixesRegionExtents", vFppp, 0},
{"XFixesSelectCursorInput", vFppu, 0},
{"XFixesSelectSelectionInput", vFpppu, 0},
{"XFixesSetCursorName", vFppp, 0},
{"XFixesSetGCClipRegion", vFppiip, 0},
{"XFixesSetPictureClipRegion", vFppiip, 0},
{"XFixesSetRegion", vFpppi, 0},
{"XFixesSetWindowShapeRegion", vFppiiip, 0},
{"XFixesShowCursor", vFpp, 0},
{"XFixesSubtractRegion", vFpppp, 0},
{"XFixesTranslateRegion", vFppii, 0},
{"XFixesUnionRegion", vFpppp, 0},
{"XFixesVersion", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxfixesmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1
...
static const map_onesymbol_t libxfixesstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1
...
static const map_onesymbol2_t libxfixessymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1
...
static const map_onedata_t libxfixesdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1
...
{"XFixesExtensionInfo", 4, 0},
{"XFixesExtensionName", 4, 0},
...
static const map_onedata_t libxfixesmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxfixesundefs.h" 1
...
int wrappedlibxfixes_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxfixesName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxfixesName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxfixessymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxfixessymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxfixessymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxfixessymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxfixessymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxfixessymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxfixessymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxfixessymbolmap[i].name); }
 cnt = sizeof(libxfixesmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxfixesmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxfixesmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxfixesmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxfixesmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxfixesmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxfixesmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxfixesmysymbolmap[i].name); }

    cnt = sizeof(libxfixesstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxfixesstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxfixesstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxfixesstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxfixesstsymbolmap[i].name);
    }
    cnt = sizeof(libxfixessymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxfixessymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxfixessymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxfixessymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxfixessymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxfixessymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxfixessymbol2map[i].name);
    }
    cnt = sizeof(libxfixesdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxfixesdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxfixesdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxfixesdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxfixesdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxfixesdatamap[i].sz;
        }
    }
    cnt = sizeof(libxfixesmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxfixesmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxfixesmydatamap[i].sz;
    }
...
void wrappedlibxfixes_fini(library_t* lib)
{
...
# 39 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxfixes.c" 2
