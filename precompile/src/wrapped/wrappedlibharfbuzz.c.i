# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
...
int wrappedlibharfbuzz_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libharfbuzzName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libharfbuzzName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libharfbuzzsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libharfbuzzsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libharfbuzzsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libharfbuzzsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libharfbuzzsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libharfbuzzsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libharfbuzzsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libharfbuzzsymbolmap[i].name); }
 cnt = sizeof(libharfbuzzmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libharfbuzzmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libharfbuzzmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libharfbuzzmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libharfbuzzmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libharfbuzzmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libharfbuzzmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libharfbuzzmysymbolmap[i].name); }

    cnt = sizeof(libharfbuzzstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libharfbuzzstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libharfbuzzstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libharfbuzzstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libharfbuzzstsymbolmap[i].name);
    }
    cnt = sizeof(libharfbuzzsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libharfbuzzsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libharfbuzzsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libharfbuzzsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libharfbuzzsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libharfbuzzsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libharfbuzzsymbol2map[i].name);
    }
    cnt = sizeof(libharfbuzzdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libharfbuzzdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libharfbuzzdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libharfbuzzdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libharfbuzzdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libharfbuzzdatamap[i].sz;
        }
    }
    cnt = sizeof(libharfbuzzmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libharfbuzzmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libharfbuzzmydatamap[i].sz;
    }
...
void wrappedlibharfbuzz_fini(library_t* lib)
{
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibharfbuzz.c" 2
