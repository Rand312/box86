# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2


const char* utilName = "libutil.so.1";


__attribute__((visibility("default"))) pid_t my_forkpty(x86emu_t* emu, void* amaster, void* name, void* termp, void* winp)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedutildefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t utilsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
static const map_onesymbol_t utilmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
static const map_onesymbol_t utilstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
static const map_onesymbol2_t utilsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
static const map_onedata_t utildatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
static const map_onedata_t utilmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedutilundefs.h" 1
...
int wrappedutil_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(utilName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(utilsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (utilsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, utilsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = utilsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, utilsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = utilsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(utilsymbolmap[i].name, '@')) AddDictionnary(box86->versym, utilsymbolmap[i].name); }
 cnt = sizeof(utilmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (utilmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, utilmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = utilmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, utilmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = utilmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(utilmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, utilmysymbolmap[i].name); }

    cnt = sizeof(utilstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, utilstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = utilstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(utilstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, utilstsymbolmap[i].name);
    }
    cnt = sizeof(utilsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, utilsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = utilsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = utilsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = utilsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(utilsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, utilsymbol2map[i].name);
    }
    cnt = sizeof(utildatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(utildatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, utildatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = utildatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, utildatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = utildatamap[i].sz;
        }
    }
    cnt = sizeof(utilmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, utilmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = utilmydatamap[i].sz;
    }
...
void wrappedutil_fini(library_t* lib)
{
...
# 41 "/home/ssd/pico/code/box86/src/wrapped/wrappedutil.c" 2
