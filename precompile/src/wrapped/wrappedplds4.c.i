# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
...
int wrappedplds4_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(plds4Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(plds4symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (plds4symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, plds4symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = plds4symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, plds4symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = plds4symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(plds4symbolmap[i].name, '@')) AddDictionnary(box86->versym, plds4symbolmap[i].name); }
 cnt = sizeof(plds4mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (plds4mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, plds4mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = plds4mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, plds4mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = plds4mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(plds4mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, plds4mysymbolmap[i].name); }

    cnt = sizeof(plds4stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, plds4stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = plds4stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(plds4stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, plds4stsymbolmap[i].name);
    }
    cnt = sizeof(plds4symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, plds4symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = plds4symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = plds4symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = plds4symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(plds4symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, plds4symbol2map[i].name);
    }
    cnt = sizeof(plds4datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(plds4datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, plds4datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = plds4datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, plds4datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = plds4datamap[i].sz;
        }
    }
    cnt = sizeof(plds4mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, plds4mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = plds4mydatamap[i].sz;
    }
...
void wrappedplds4_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedplds4.c" 2
