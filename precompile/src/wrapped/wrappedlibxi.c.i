# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2




    const char* libxiName = "libXi.so.6";
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxidefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxisymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
{"XChangeDeviceProperty", vFppppiipi, 0},



{"XCloseDevice", iFpp, 0},
{"XDeleteDeviceProperty", vFppp, 0},


{"XFreeDeviceList", iFp, 0},
{"XFreeDeviceMotionEvents", iFv, 0},
{"XFreeDeviceState", vFp, 0},

{"XGetDeviceButtonMapping", iFpppi, 0},





{"XGetDeviceMotionEvents", pFppuuppp, 0},
{"XGetDeviceProperty", iFpppllipppppp, 0},
{"XGetExtensionVersion", pFpp, 0},


{"XGrabDevice", iFpppiipiiu, 0},




{"XIBarrierReleasePointer", vFpipp, 0},
{"XIBarrierReleasePointers", vFppi, 0},

{"XIChangeProperty", vFpippiipi, 0},

{"XIDeleteProperty", vFpip, 0},
{"XIFreeDeviceInfo", vFp, 0},
{"XIGetClientPointer", iFppp, 0},

{"XIGetProperty", iFpipllipppppp, 0},
{"XIGetSelectedEvents", iFpppi, 0},
{"XIGrabButton", iFpiippiiipip, 0},
{"XIGrabDevice", iFpipLpiiip, 0},


{"XIGrabKeycode", iFpiipiiipip, 0},
{"XIGrabTouchBegin", iFpipipip, 0},

{"XIQueryDevice", pFpip, 0},
{"XIQueryPointer", iFpipppppppppp, 0},
{"XIQueryVersion", iFppp, 0},
{"XISelectEvents", iFpppi, 0},
{"XISetClientPointer", iFppi, 0},


{"XIUngrabButton", iFpiipip, 0},
{"XIUngrabDevice", iFpiL, 0},


{"XIUngrabKeycode", iFpiipip, 0},
{"XIUngrabTouchBegin", iFpipip, 0},
{"XIWarpPointer", iFpippddiidd, 0},

{"XListInputDevices", pFpp, 0},
{"XOpenDevice", pFpp, 0},
{"XQueryDeviceState", pFpp, 0},
{"XSelectExtensionEvent", iFpppi, 0},

{"XSetDeviceButtonMapping", iFpppi, 0},




{"XUngrabDevice", iFppu, 0},


{"_XiGetDevicePresenceNotifyEvent", iFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libximysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
...
static const map_onesymbol_t libxistsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
...
static const map_onesymbol2_t libxisymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
...
static const map_onedata_t libxidatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
...
static const map_onedata_t libximydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxiundefs.h" 1
...
int wrappedlibxi_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxiName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxisymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxisymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxisymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxisymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxisymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxisymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxisymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxisymbolmap[i].name); }
 cnt = sizeof(libximysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libximysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libximysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libximysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libximysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libximysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libximysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libximysymbolmap[i].name); }

    cnt = sizeof(libxistsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxistsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxistsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxistsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxistsymbolmap[i].name);
    }
    cnt = sizeof(libxisymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxisymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxisymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxisymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxisymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxisymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxisymbol2map[i].name);
    }
    cnt = sizeof(libxidatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxidatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxidatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxidatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxidatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxidatamap[i].sz;
        }
    }
    cnt = sizeof(libximydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libximydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libximydatamap[i].sz;
    }
...
void wrappedlibxi_fini(library_t* lib)
{
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxi.c" 2
