# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcursordefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcursorsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1




{"XcursorAnimateCreate", pFp, 0},
{"XcursorAnimateDestroy", vFp, 0},
{"XcursorAnimateNext", pFp, 0},
{"XcursorCommentCreate", pFui, 0},
{"XcursorCommentDestroy", vFp, 0},
{"XcursorCommentsCreate", pFi, 0},
{"XcursorCommentsDestroy", vFp, 0},


{"XcursorCursorsCreate", pFpi, 0},
{"XcursorCursorsDestroy", vFp, 0},
{"XcursorFileLoad", pFppp, 0},
{"XcursorFileLoadAllImages", pFp, 0},
{"XcursorFileLoadImage", pFpi, 0},
{"XcursorFileLoadImages", pFpi, 0},
{"XcursorFilenameLoad", iFppp, 0},
{"XcursorFilenameLoadAllImages", pFp, 0},
{"XcursorFilenameLoadCursor", pFpp, 0},
{"XcursorFilenameLoadCursors", pFpp, 0},
{"XcursorFilenameLoadImage", pFpi, 0},
{"XcursorFilenameLoadImages", pFpi, 0},
{"XcursorFilenameSave", iFppp, 0},
{"XcursorFilenameSaveImages", iFpp, 0},
{"XcursorFileSave", iFppp, 0},
{"XcursorFileSaveImages", iFpp, 0},
{"XcursorGetDefaultSize", iFp, 0},

{"XcursorGetTheme", pFp, 0},
{"XcursorGetThemeCore", iFp, 0},
{"XcursorImageCreate", pFii, 0},
{"XcursorImageDestroy", vFp, 0},

{"XcursorImageLoadCursor", pFpp, 0},
{"XcursorImagesCreate", pFi, 0},
{"XcursorImagesDestroy", vFp, 0},
{"XcursorImagesLoadCursor", pFpp, 0},
{"XcursorImagesLoadCursors", pFpp, 0},
{"XcursorImagesSetName", vFpp, 0},
{"XcursorLibraryLoadCursor", pFpp, 0},
{"XcursorLibraryLoadCursors", pFpp, 0},
{"XcursorLibraryLoadImage", pFppi, 0},
{"XcursorLibraryLoadImages", pFppi, 0},
{"XcursorLibraryPath", pFv, 0},
{"XcursorLibraryShape", iFp, 0},
{"XcursorNoticeCreateBitmap", vFppuu, 0},

{"XcursorSetDefaultSize", iFpi, 0},
{"XcursorSetTheme", iFpp, 0},
{"XcursorSetThemeCore", iFpi, 0},
{"XcursorShapeLoadCursor", pFpu, 0},
{"XcursorShapeLoadCursors", pFpu, 0},
{"XcursorShapeLoadImage", pFupi, 0},
{"XcursorShapeLoadImages", pFupi, 0},
{"XcursorSupportsAnim", iFp, 0},
{"XcursorSupportsARGB", iFp, 0},
{"XcursorTryShapeBitmapCursor", pFpppppuu, 0},
{"XcursorTryShapeCursor", pFpppuupp, 0},
{"XcursorXcFileLoad", iFppp, 0},
{"XcursorXcFileLoadAllImages", pFp, 0},
{"XcursorXcFileLoadImage", pFpi, 0},
{"XcursorXcFileLoadImages", pFpi, 0},
{"XcursorXcFileSave", iFppp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcursormysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1
...
static const map_onesymbol_t libxcursorstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1
...
static const map_onesymbol2_t libxcursorsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1
...
static const map_onedata_t libxcursordatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1
...
static const map_onedata_t libxcursormydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcursorundefs.h" 1
...
int wrappedlibxcursor_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxcursorName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxcursorName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxcursorsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcursorsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxcursorsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxcursorsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxcursorsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxcursorsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxcursorsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcursorsymbolmap[i].name); }
 cnt = sizeof(libxcursormysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcursormysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxcursormysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxcursormysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxcursormysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxcursormysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxcursormysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcursormysymbolmap[i].name); }

    cnt = sizeof(libxcursorstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxcursorstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxcursorstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxcursorstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxcursorstsymbolmap[i].name);
    }
    cnt = sizeof(libxcursorsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxcursorsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxcursorsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxcursorsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxcursorsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxcursorsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxcursorsymbol2map[i].name);
    }
    cnt = sizeof(libxcursordatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxcursordatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxcursordatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxcursordatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxcursordatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxcursordatamap[i].sz;
        }
    }
    cnt = sizeof(libxcursormydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxcursormydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxcursormydatamap[i].sz;
    }
...
void wrappedlibxcursor_fini(library_t* lib)
{
...
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcursor.c" 2
