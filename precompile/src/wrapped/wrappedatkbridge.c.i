# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2

const char* atkbridgeName = "libatk-bridge-2.0.so.0";
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedatkbridgedefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t atkbridgesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1




{"atk_bridge_adaptor_cleanup", iFpp, 0},
{"atk_bridge_adaptor_init", vFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t atkbridgemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1
...
static const map_onesymbol_t atkbridgestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1
...
static const map_onesymbol2_t atkbridgesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1
...
static const map_onedata_t atkbridgedatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1
...
static const map_onedata_t atkbridgemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedatkbridgeundefs.h" 1
...
int wrappedatkbridge_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(atkbridgeName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(atkbridgeName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(atkbridgesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (atkbridgesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, atkbridgesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = atkbridgesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, atkbridgesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = atkbridgesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(atkbridgesymbolmap[i].name, '@')) AddDictionnary(box86->versym, atkbridgesymbolmap[i].name); }
 cnt = sizeof(atkbridgemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (atkbridgemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, atkbridgemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = atkbridgemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, atkbridgemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = atkbridgemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(atkbridgemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, atkbridgemysymbolmap[i].name); }

    cnt = sizeof(atkbridgestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, atkbridgestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = atkbridgestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(atkbridgestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, atkbridgestsymbolmap[i].name);
    }
    cnt = sizeof(atkbridgesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, atkbridgesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = atkbridgesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = atkbridgesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = atkbridgesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(atkbridgesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, atkbridgesymbol2map[i].name);
    }
    cnt = sizeof(atkbridgedatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(atkbridgedatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, atkbridgedatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = atkbridgedatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, atkbridgedatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = atkbridgedatamap[i].sz;
        }
    }
    cnt = sizeof(atkbridgemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, atkbridgemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = atkbridgemydatamap[i].sz;
    }

    setNeededLibs(lib, 5, "libatk-1.0.so.0", "libSM.so.6", "libICE.so.6", "libXau.so.6", "libxcb.so.1");


    return 0;
}

void wrappedatkbridge_fini(library_t* lib)
{
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedatkbridge.c" 2
