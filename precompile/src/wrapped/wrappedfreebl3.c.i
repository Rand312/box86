# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
...
int wrappedfreebl3_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(freebl3Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(freebl3symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (freebl3symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, freebl3symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = freebl3symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, freebl3symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = freebl3symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(freebl3symbolmap[i].name, '@')) AddDictionnary(box86->versym, freebl3symbolmap[i].name); }
 cnt = sizeof(freebl3mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (freebl3mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, freebl3mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = freebl3mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, freebl3mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = freebl3mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(freebl3mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, freebl3mysymbolmap[i].name); }

    cnt = sizeof(freebl3stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, freebl3stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = freebl3stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(freebl3stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, freebl3stsymbolmap[i].name);
    }
    cnt = sizeof(freebl3symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, freebl3symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = freebl3symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = freebl3symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = freebl3symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(freebl3symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, freebl3symbol2map[i].name);
    }
    cnt = sizeof(freebl3datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(freebl3datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, freebl3datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = freebl3datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, freebl3datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = freebl3datamap[i].sz;
        }
    }
    cnt = sizeof(freebl3mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, freebl3mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = freebl3mydatamap[i].sz;
    }
...
void wrappedfreebl3_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreebl3.c" 2
