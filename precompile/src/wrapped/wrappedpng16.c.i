# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpng16types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpng16types.h"
...
# 36 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
...
typedef struct png16_my_s {
    ...
    vFp_t png_free; vFpp_t png_destroy_write_struct; vFpp_t png_set_read_user_transform_fn; vFppp_t png_destroy_read_struct; vFppp_t png_set_read_fn; vFpppp_t png_set_error_fn; vFpppp_t png_set_write_fn; pFpppp_t png_create_read_struct; pFpppp_t png_create_write_struct; vFppppp_t png_set_progressive_read_fn; pFppppppp_t png_create_read_struct_2; pFppppppp_t png_create_write_struct_2;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static png16_my_t my_png16 = {0};
static png16_my_t * const my = &my_png16;

static void getMy(library_t* lib)
{

    my->png_free = (vFp_t)dlsym(lib->w.lib, "png_free"); my->png_destroy_write_struct = (vFpp_t)dlsym(lib->w.lib, "png_destroy_write_struct"); my->png_set_read_user_transform_fn = (vFpp_t)dlsym(lib->w.lib, "png_set_read_user_transform_fn"); my->png_destroy_read_struct = (vFppp_t)dlsym(lib->w.lib, "png_destroy_read_struct"); my->png_set_read_fn = (vFppp_t)dlsym(lib->w.lib, "png_set_read_fn"); my->png_set_error_fn = (vFpppp_t)dlsym(lib->w.lib, "png_set_error_fn"); my->png_set_write_fn = (vFpppp_t)dlsym(lib->w.lib, "png_set_write_fn"); my->png_create_read_struct = (pFpppp_t)dlsym(lib->w.lib, "png_create_read_struct"); my->png_create_write_struct = (pFpppp_t)dlsym(lib->w.lib, "png_create_write_struct"); my->png_set_progressive_read_fn = (vFppppp_t)dlsym(lib->w.lib, "png_set_progressive_read_fn"); my->png_create_read_struct_2 = (pFppppppp_t)dlsym(lib->w.lib, "png_create_read_struct_2"); my->png_create_write_struct_2 = (pFppppppp_t)dlsym(lib->w.lib, "png_create_write_struct_2");
...
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
# 52 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
static uintptr_t my_user_write_fct_0 = 0; static void my_user_write_0(void* png_ptr, void* data, int32_t length) { RunFunctionFmt(my_user_write_fct_0, "ppi", png_ptr, data, length);} static uintptr_t my_user_write_fct_1 = 0; static void my_user_write_1(void* png_ptr, void* data, int32_t length) { RunFunctionFmt(my_user_write_fct_1, "ppi", png_ptr, data, length);} static uintptr_t my_user_write_fct_2 = 0; static void my_user_write_2(void* png_ptr, void* data, int32_t length) { RunFunctionFmt(my_user_write_fct_2, "ppi", png_ptr, data, length);} static uintptr_t my_user_write_fct_3 = 0; static void my_user_write_3(void* png_ptr, void* data, int32_t length) { RunFunctionFmt(my_user_write_fct_3, "ppi", png_ptr, data, length);}
...
static void* finduser_writeFct(void* fct)
{
    ...
    if(my_user_write_fct_0 == (uintptr_t)fct) return my_user_write_0; if(my_user_write_fct_1 == (uintptr_t)fct) return my_user_write_1; if(my_user_write_fct_2 == (uintptr_t)fct) return my_user_write_2; if(my_user_write_fct_3 == (uintptr_t)fct) return my_user_write_3;


    if(my_user_write_fct_0 == 0) {my_user_write_fct_0 = (uintptr_t)fct; return my_user_write_0; } if(my_user_write_fct_1 == 0) {my_user_write_fct_1 = (uintptr_t)fct; return my_user_write_1; } if(my_user_write_fct_2 == 0) {my_user_write_fct_2 = (uintptr_t)fct; return my_user_write_2; } if(my_user_write_fct_3 == 0) {my_user_write_fct_3 = (uintptr_t)fct; return my_user_write_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 user_write callback\n"); fflush(ftrace);}} while(0);
    return 
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static uintptr_t my_user_flush_fct_0 = 0; static void my_user_flush_0(void* png_ptr) { RunFunctionFmt(my_user_flush_fct_0, "p", png_ptr);} static uintptr_t my_user_flush_fct_1 = 0; static void my_user_flush_1(void* png_ptr) { RunFunctionFmt(my_user_flush_fct_1, "p", png_ptr);} static uintptr_t my_user_flush_fct_2 = 0; static void my_user_flush_2(void* png_ptr) { RunFunctionFmt(my_user_flush_fct_2, "p", png_ptr);} static uintptr_t my_user_flush_fct_3 = 0; static void my_user_flush_3(void* png_ptr) { RunFunctionFmt(my_user_flush_fct_3, "p", png_ptr);}
...
static void* finduser_flushFct(void* fct)
{
    ...
    if(my_user_flush_fct_0 == (uintptr_t)fct) return my_user_flush_0; if(my_user_flush_fct_1 == (uintptr_t)fct) return my_user_flush_1; if(my_user_flush_fct_2 == (uintptr_t)fct) return my_user_flush_2; if(my_user_flush_fct_3 == (uintptr_t)fct) return my_user_flush_3;


    if(my_user_flush_fct_0 == 0) {my_user_flush_fct_0 = (uintptr_t)fct; return my_user_flush_0; } if(my_user_flush_fct_1 == 0) {my_user_flush_fct_1 = (uintptr_t)fct; return my_user_flush_1; } if(my_user_flush_fct_2 == 0) {my_user_flush_fct_2 = (uintptr_t)fct; return my_user_flush_2; } if(my_user_flush_fct_3 == 0) {my_user_flush_fct_3 = (uintptr_t)fct; return my_user_flush_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 user_flush callback\n"); fflush(ftrace);}} while(0);
    return 
# 87 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 87 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static uintptr_t my_user_read_fct_0 = 0; static void my_user_read_0(void* png_ptr, void* data, size_t length) { RunFunctionFmt(my_user_read_fct_0, "ppL", png_ptr, data, length); } static uintptr_t my_user_read_fct_1 = 0; static void my_user_read_1(void* png_ptr, void* data, size_t length) { RunFunctionFmt(my_user_read_fct_1, "ppL", png_ptr, data, length); } static uintptr_t my_user_read_fct_2 = 0; static void my_user_read_2(void* png_ptr, void* data, size_t length) { RunFunctionFmt(my_user_read_fct_2, "ppL", png_ptr, data, length); } static uintptr_t my_user_read_fct_3 = 0; static void my_user_read_3(void* png_ptr, void* data, size_t length) { RunFunctionFmt(my_user_read_fct_3, "ppL", png_ptr, data, length); }
...
static void* finduser_readFct(void* fct)
{
    ...
    if(my_user_read_fct_0 == (uintptr_t)fct) return my_user_read_0; if(my_user_read_fct_1 == (uintptr_t)fct) return my_user_read_1; if(my_user_read_fct_2 == (uintptr_t)fct) return my_user_read_2; if(my_user_read_fct_3 == (uintptr_t)fct) return my_user_read_3;


    if(my_user_read_fct_0 == 0) {my_user_read_fct_0 = (uintptr_t)fct; return my_user_read_0; } if(my_user_read_fct_1 == 0) {my_user_read_fct_1 = (uintptr_t)fct; return my_user_read_1; } if(my_user_read_fct_2 == 0) {my_user_read_fct_2 = (uintptr_t)fct; return my_user_read_2; } if(my_user_read_fct_3 == 0) {my_user_read_fct_3 = (uintptr_t)fct; return my_user_read_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 user_read callback\n"); fflush(ftrace);}} while(0);
    return 
# 109 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 109 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static uintptr_t my_error_fct_0 = 0; static void my_error_0(void* a, void* b) { RunFunctionFmt(my_error_fct_0, "pp", a, b); } static uintptr_t my_error_fct_1 = 0; static void my_error_1(void* a, void* b) { RunFunctionFmt(my_error_fct_1, "pp", a, b); } static uintptr_t my_error_fct_2 = 0; static void my_error_2(void* a, void* b) { RunFunctionFmt(my_error_fct_2, "pp", a, b); } static uintptr_t my_error_fct_3 = 0; static void my_error_3(void* a, void* b) { RunFunctionFmt(my_error_fct_3, "pp", a, b); }
...
static void* finderrorFct(void* fct)
{
    ...
    if(my_error_fct_0 == (uintptr_t)fct) return my_error_0; if(my_error_fct_1 == (uintptr_t)fct) return my_error_1; if(my_error_fct_2 == (uintptr_t)fct) return my_error_2; if(my_error_fct_3 == (uintptr_t)fct) return my_error_3;


    if(my_error_fct_0 == 0) {my_error_fct_0 = (uintptr_t)fct; return my_error_0; } if(my_error_fct_1 == 0) {my_error_fct_1 = (uintptr_t)fct; return my_error_1; } if(my_error_fct_2 == 0) {my_error_fct_2 = (uintptr_t)fct; return my_error_2; } if(my_error_fct_3 == 0) {my_error_fct_3 = (uintptr_t)fct; return my_error_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 error callback\n"); fflush(ftrace);}} while(0);
    return 
# 131 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 131 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static uintptr_t my_warning_fct_0 = 0; static void my_warning_0(void* a, void* b) { RunFunctionFmt(my_warning_fct_0, "pp", a, b); } static uintptr_t my_warning_fct_1 = 0; static void my_warning_1(void* a, void* b) { RunFunctionFmt(my_warning_fct_1, "pp", a, b); } static uintptr_t my_warning_fct_2 = 0; static void my_warning_2(void* a, void* b) { RunFunctionFmt(my_warning_fct_2, "pp", a, b); } static uintptr_t my_warning_fct_3 = 0; static void my_warning_3(void* a, void* b) { RunFunctionFmt(my_warning_fct_3, "pp", a, b); }
...
static void* findwarningFct(void* fct)
{
    ...
    if(my_warning_fct_0 == (uintptr_t)fct) return my_warning_0; if(my_warning_fct_1 == (uintptr_t)fct) return my_warning_1; if(my_warning_fct_2 == (uintptr_t)fct) return my_warning_2; if(my_warning_fct_3 == (uintptr_t)fct) return my_warning_3;


    if(my_warning_fct_0 == 0) {my_warning_fct_0 = (uintptr_t)fct; return my_warning_0; } if(my_warning_fct_1 == 0) {my_warning_fct_1 = (uintptr_t)fct; return my_warning_1; } if(my_warning_fct_2 == 0) {my_warning_fct_2 = (uintptr_t)fct; return my_warning_2; } if(my_warning_fct_3 == 0) {my_warning_fct_3 = (uintptr_t)fct; return my_warning_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 warning callback\n"); fflush(ftrace);}} while(0);
    return 
# 153 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 153 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static uintptr_t my_malloc_fct_0 = 0; static void my_malloc_0(void* a, unsigned long b) { RunFunctionFmt(my_malloc_fct_0, "pL", a, b); } static uintptr_t my_malloc_fct_1 = 0; static void my_malloc_1(void* a, unsigned long b) { RunFunctionFmt(my_malloc_fct_1, "pL", a, b); } static uintptr_t my_malloc_fct_2 = 0; static void my_malloc_2(void* a, unsigned long b) { RunFunctionFmt(my_malloc_fct_2, "pL", a, b); } static uintptr_t my_malloc_fct_3 = 0; static void my_malloc_3(void* a, unsigned long b) { RunFunctionFmt(my_malloc_fct_3, "pL", a, b); }
...
static void* findmallocFct(void* fct)
{
    ...
    if(my_malloc_fct_0 == (uintptr_t)fct) return my_malloc_0; if(my_malloc_fct_1 == (uintptr_t)fct) return my_malloc_1; if(my_malloc_fct_2 == (uintptr_t)fct) return my_malloc_2; if(my_malloc_fct_3 == (uintptr_t)fct) return my_malloc_3;


    if(my_malloc_fct_0 == 0) {my_malloc_fct_0 = (uintptr_t)fct; return my_malloc_0; } if(my_malloc_fct_1 == 0) {my_malloc_fct_1 = (uintptr_t)fct; return my_malloc_1; } if(my_malloc_fct_2 == 0) {my_malloc_fct_2 = (uintptr_t)fct; return my_malloc_2; } if(my_malloc_fct_3 == 0) {my_malloc_fct_3 = (uintptr_t)fct; return my_malloc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 malloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 175 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 175 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static void* findfreeFct(void* fct)
{
    ...
    if(my_free_fct_0 == (uintptr_t)fct) return my_free_0; if(my_free_fct_1 == (uintptr_t)fct) return my_free_1; if(my_free_fct_2 == (uintptr_t)fct) return my_free_2; if(my_free_fct_3 == (uintptr_t)fct) return my_free_3;


    if(my_free_fct_0 == 0) {my_free_fct_0 = (uintptr_t)fct; return my_free_0; } if(my_free_fct_1 == 0) {my_free_fct_1 = (uintptr_t)fct; return my_free_1; } if(my_free_fct_2 == 0) {my_free_fct_2 = (uintptr_t)fct; return my_free_2; } if(my_free_fct_3 == 0) {my_free_fct_3 = (uintptr_t)fct; return my_free_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 free callback\n"); fflush(ftrace);}} while(0);
    return 
# 197 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 197 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
# 207 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
static uintptr_t my_progressive_info_fct_0 = 0; static void my_progressive_info_0(void* a, void* b) { RunFunctionFmt(my_progressive_info_fct_0, "pp", a, b);} static uintptr_t my_progressive_info_fct_1 = 0; static void my_progressive_info_1(void* a, void* b) { RunFunctionFmt(my_progressive_info_fct_1, "pp", a, b);} static uintptr_t my_progressive_info_fct_2 = 0; static void my_progressive_info_2(void* a, void* b) { RunFunctionFmt(my_progressive_info_fct_2, "pp", a, b);} static uintptr_t my_progressive_info_fct_3 = 0; static void my_progressive_info_3(void* a, void* b) { RunFunctionFmt(my_progressive_info_fct_3, "pp", a, b);}
...
static void* findprogressive_infoFct(void* fct)
{
    ...
    if(my_progressive_info_fct_0 == (uintptr_t)fct) return my_progressive_info_0; if(my_progressive_info_fct_1 == (uintptr_t)fct) return my_progressive_info_1; if(my_progressive_info_fct_2 == (uintptr_t)fct) return my_progressive_info_2; if(my_progressive_info_fct_3 == (uintptr_t)fct) return my_progressive_info_3;


    if(my_progressive_info_fct_0 == 0) {my_progressive_info_fct_0 = (uintptr_t)fct; return my_progressive_info_0; } if(my_progressive_info_fct_1 == 0) {my_progressive_info_fct_1 = (uintptr_t)fct; return my_progressive_info_1; } if(my_progressive_info_fct_2 == 0) {my_progressive_info_fct_2 = (uintptr_t)fct; return my_progressive_info_2; } if(my_progressive_info_fct_3 == 0) {my_progressive_info_fct_3 = (uintptr_t)fct; return my_progressive_info_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 progressive_info callback\n"); fflush(ftrace);}} while(0);
    return 
# 220 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 220 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
# 230 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
static uintptr_t my_progressive_end_fct_0 = 0; static void my_progressive_end_0(void* a, void* b) { RunFunctionFmt(my_progressive_end_fct_0, "pp", a, b); } static uintptr_t my_progressive_end_fct_1 = 0; static void my_progressive_end_1(void* a, void* b) { RunFunctionFmt(my_progressive_end_fct_1, "pp", a, b); } static uintptr_t my_progressive_end_fct_2 = 0; static void my_progressive_end_2(void* a, void* b) { RunFunctionFmt(my_progressive_end_fct_2, "pp", a, b); } static uintptr_t my_progressive_end_fct_3 = 0; static void my_progressive_end_3(void* a, void* b) { RunFunctionFmt(my_progressive_end_fct_3, "pp", a, b); }
...
static void* findprogressive_endFct(void* fct)
{
    ...
    if(my_progressive_end_fct_0 == (uintptr_t)fct) return my_progressive_end_0; if(my_progressive_end_fct_1 == (uintptr_t)fct) return my_progressive_end_1; if(my_progressive_end_fct_2 == (uintptr_t)fct) return my_progressive_end_2; if(my_progressive_end_fct_3 == (uintptr_t)fct) return my_progressive_end_3;


    if(my_progressive_end_fct_0 == 0) {my_progressive_end_fct_0 = (uintptr_t)fct; return my_progressive_end_0; } if(my_progressive_end_fct_1 == 0) {my_progressive_end_fct_1 = (uintptr_t)fct; return my_progressive_end_1; } if(my_progressive_end_fct_2 == 0) {my_progressive_end_fct_2 = (uintptr_t)fct; return my_progressive_end_2; } if(my_progressive_end_fct_3 == 0) {my_progressive_end_fct_3 = (uintptr_t)fct; return my_progressive_end_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 progressive_end callback\n"); fflush(ftrace);}} while(0);
    return 
# 243 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 243 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
# 253 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
static uintptr_t my_progressive_row_fct_0 = 0; static void my_progressive_row_0(void* a, void* b, uint32_t c, int d) { RunFunctionFmt(my_progressive_row_fct_0, "ppui", a, b, c, d); } static uintptr_t my_progressive_row_fct_1 = 0; static void my_progressive_row_1(void* a, void* b, uint32_t c, int d) { RunFunctionFmt(my_progressive_row_fct_1, "ppui", a, b, c, d); } static uintptr_t my_progressive_row_fct_2 = 0; static void my_progressive_row_2(void* a, void* b, uint32_t c, int d) { RunFunctionFmt(my_progressive_row_fct_2, "ppui", a, b, c, d); } static uintptr_t my_progressive_row_fct_3 = 0; static void my_progressive_row_3(void* a, void* b, uint32_t c, int d) { RunFunctionFmt(my_progressive_row_fct_3, "ppui", a, b, c, d); }
...
static void* findprogressive_rowFct(void* fct)
{
    ...
    if(my_progressive_row_fct_0 == (uintptr_t)fct) return my_progressive_row_0; if(my_progressive_row_fct_1 == (uintptr_t)fct) return my_progressive_row_1; if(my_progressive_row_fct_2 == (uintptr_t)fct) return my_progressive_row_2; if(my_progressive_row_fct_3 == (uintptr_t)fct) return my_progressive_row_3;


    if(my_progressive_row_fct_0 == 0) {my_progressive_row_fct_0 = (uintptr_t)fct; return my_progressive_row_0; } if(my_progressive_row_fct_1 == 0) {my_progressive_row_fct_1 = (uintptr_t)fct; return my_progressive_row_1; } if(my_progressive_row_fct_2 == 0) {my_progressive_row_fct_2 = (uintptr_t)fct; return my_progressive_row_2; } if(my_progressive_row_fct_3 == 0) {my_progressive_row_fct_3 = (uintptr_t)fct; return my_progressive_row_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 progressive_row callback\n"); fflush(ftrace);}} while(0);
    return 
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
# 277 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
static uintptr_t my_user_transform_fct_0 = 0; static void my_user_transform_0(void* ptr, void* row, void* data) { RunFunctionFmt(my_user_transform_fct_0, "ppp", ptr, row, data); } static uintptr_t my_user_transform_fct_1 = 0; static void my_user_transform_1(void* ptr, void* row, void* data) { RunFunctionFmt(my_user_transform_fct_1, "ppp", ptr, row, data); } static uintptr_t my_user_transform_fct_2 = 0; static void my_user_transform_2(void* ptr, void* row, void* data) { RunFunctionFmt(my_user_transform_fct_2, "ppp", ptr, row, data); } static uintptr_t my_user_transform_fct_3 = 0; static void my_user_transform_3(void* ptr, void* row, void* data) { RunFunctionFmt(my_user_transform_fct_3, "ppp", ptr, row, data); }
...
static void* finduser_transformFct(void* fct)
{
    ...
    if(my_user_transform_fct_0 == (uintptr_t)fct) return my_user_transform_0; if(my_user_transform_fct_1 == (uintptr_t)fct) return my_user_transform_1; if(my_user_transform_fct_2 == (uintptr_t)fct) return my_user_transform_2; if(my_user_transform_fct_3 == (uintptr_t)fct) return my_user_transform_3;


    if(my_user_transform_fct_0 == 0) {my_user_transform_fct_0 = (uintptr_t)fct; return my_user_transform_0; } if(my_user_transform_fct_1 == 0) {my_user_transform_fct_1 = (uintptr_t)fct; return my_user_transform_1; } if(my_user_transform_fct_2 == 0) {my_user_transform_fct_2 = (uintptr_t)fct; return my_user_transform_2; } if(my_user_transform_fct_3 == 0) {my_user_transform_fct_3 = (uintptr_t)fct; return my_user_transform_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng16 user_transform callback\n"); fflush(ftrace);}} while(0);
    return 
# 290 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
          ((void *)0)
# 290 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
              ;
}
...
static void* current_png_struct = 
# 302 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
                                 ((void *)0)
# 302 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
                                     ;
static int current_jmpbuf[12] = {0};
int32_t my_setjmp(x86emu_t* emu, void *p);
void my_longjmp(x86emu_t* emu, void *p, int32_t __val);
int png16_setjmp(x86emu_t* emu, void *p)
{
    ...
    if(p!=*png->jmp_buf_ptr)
        return 0;
    do {if((2)<=box86_log) {fprintf(ftrace, " (Hack for setjmp inside png16 struct) "); fflush(ftrace);}} while(0);
    if(png->jmp_buf_size) {
    ...
    if(
# 322 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
      _setjmp (
# 322 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
      png->jmp_buf_local
# 322 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
      )
# 322 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
...
__attribute__((visibility("default"))) void my16_png_set_read_fn(x86emu_t *emu, void* png_ptr, void* io_ptr, void* read_data_fn)
{
    (void)emu;
    my->png_set_read_fn(png_ptr, io_ptr, finduser_readFct(read_data_fn));
}

__attribute__((visibility("default"))) void my16_png_set_read_user_transform_fn(x86emu_t *emu, void* png_ptr, void* read_transform_fn)
{
    (void)emu;
    my->png_set_read_user_transform_fn(png_ptr, finduser_transformFct(read_transform_fn));
}

__attribute__((visibility("default"))) void my16_png_set_error_fn(x86emu_t* emu, void* pngptr, void* errorptr, void* error_fn, void* warning_fn)
{
    (void)emu;
    my->png_set_error_fn(pngptr, errorptr, finderrorFct(error_fn), findwarningFct(warning_fn));
}

__attribute__((visibility("default"))) void my16_png_set_write_fn(x86emu_t* emu, void* png_ptr, void* io_ptr, void* write_fn, void* flush_fn)
{
    (void)emu;
    my->png_set_write_fn(png_ptr, io_ptr, finduser_writeFct(write_fn), finduser_flushFct(flush_fn));
}

__attribute__((visibility("default"))) void* my16_png_create_read_struct_2(x86emu_t* emu, void* user_png_ver, void* error_ptr, void* error_fn, void* warn_fn, void* mem_ptr, void* malloc_fn, void* free_fn)
{
    (void)emu;
...
__attribute__((visibility("default"))) void* my16_png_create_write_struct_2(x86emu_t* emu, void* user_png_ver, void* error_ptr, void* error_fn, void* warn_fn, void* mem_ptr, void* malloc_fn, void* free_fn)
{
    (void)emu;
...
__attribute__((visibility("default"))) void my16_png_set_progressive_read_fn(x86emu_t* emu, void* png_ptr, void* user_ptr, void* info, void* row, void* end)
{
    (void)emu;
...
__attribute__((visibility("default"))) void* my16_png_create_read_struct(x86emu_t* emu, void* png_ptr, void* user_ptr, void* errorfn, void* warnfn)
{
    (void)emu;
...
__attribute__((visibility("default"))) void* my16_png_create_write_struct(x86emu_t* emu, void* png_ptr, void* user_ptr, void* errorfn, void* warnfn)
{
    (void)emu;
...
__attribute__((visibility("default"))) void my16_png_destroy_read_struct(x86emu_t* emu, void** png_ptr, void** info_ptr, void** end_info_ptr)
{
    (void)emu;
    if(png_ptr && *png_ptr==current_png_struct)
        current_png_struct = 
# 390 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
                            ((void *)0)
# 390 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
                                ;
    my->png_destroy_read_struct(png_ptr, info_ptr, end_info_ptr);
}
__attribute__((visibility("default"))) void my16_png_destroy_write_struct(x86emu_t* emu, void** png_ptr, void** info_ptr)
{
    (void)emu;
    if(png_ptr && *png_ptr==current_png_struct)
        current_png_struct = 
# 397 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 3 4
                            ((void *)0)
# 397 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
                                ;
    my->png_destroy_write_struct(png_ptr, info_ptr);
}
# 409 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpng16defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t png16symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1




{"png_convert_from_time_t", vFpu, 0},

{"png_create_info_struct", pFp, 0},



{"png_error", vFpp, 0},
{"png_free", vFpp, 0},
{"png_get_bit_depth", CFpp, 0},
{"png_get_color_type", CFpp, 0},
{"png_get_error_ptr", pFp, 0},
{"png_get_iCCP", uFpppppp, 0},
{"png_get_IHDR", uFppppppppp, 0},
{"png_get_image_height", uFpp, 0},
{"png_get_image_width", uFpp, 0},
{"png_get_io_ptr", pFp, 0},
{"png_get_PLTE", uFpppp, 0},
{"png_get_pHYs", uFppppp, 0},
{"png_get_rows", pFpp, 0},
{"png_get_tRNS", uFppppp, 0},
{"png_get_valid", uFppu, 0},
{"png_init_io", vFpp, 0},
{"png_malloc", pFpu, 0},
{"png_read_end", vFpp, 0},
{"png_read_image", vFpp, 0},
{"png_read_info", vFpp, 0},
{"png_read_png", vFppip, 0},
{"png_read_update_info", vFpp, 0},
{"png_set_bgr", vFp, 0},
{"png_set_compression_level", vFpi, 0},
{"png_set_crc_action", vFpii, 0},

{"png_set_expand", vFp, 0},
{"png_set_expand_gray_1_2_4_to_8", vFp, 0},
{"png_set_filler", vFpui, 0},
{"png_set_filter", vFpii, 0},
{"png_set_gray_to_rgb", vFp, 0},
{"png_set_IHDR", vFppuuiiiii, 0},
{"png_set_interlace_handling", iFp, 0},
{"png_set_longjmp_fn", pFppu, 0},
{"png_set_packing", vFp, 0},
{"png_set_packswap", vFp, 0},
{"png_set_palette_to_rgb", vFp, 0},
{"png_set_PLTE", vFpppi, 0},
{"png_set_pHYs", vFppuui, 0},


{"png_set_rows", vFppp, 0},
{"png_set_sig_bytes", vFpi, 0},
{"png_set_strip_16", vFp, 0},
{"png_set_tIME", vFppp, 0},
{"png_set_tRNS", vFpppip, 0},
{"png_set_tRNS_to_alpha", vFp, 0},

{"png_set_swap", vFp, 0},
{"png_sig_cmp", iFpuu, 0},
{"png_warning", vFpp, 0},
{"png_write_end", vFpp, 0},
{"png_write_chunk", vFpppu, 0},
{"png_write_info", vFpp, 0},
{"png_write_png", vFppip, 0},
{"png_write_row", vFpp, 0},
{"png_write_rows", vFppu, 0},
{"png_get_rowbytes", uFpp, 0},
{"png_set_add_alpha", vFpui, 0},
{"png_get_sRGB", uFppp, 0},
{"png_set_gamma", vFpdd, 0},
{"png_get_gAMA", uFppp, 0},
{"png_read_row", vFppp, 0},
{"png_get_channels", CFpp, 0},
{"png_set_iCCP", vFpppipu, 0},
{"png_set_sRGB", vFppi, 0},
{"png_set_compression_mem_level", vFpi, 0},
{"png_set_text", vFpppi, 0},
{"png_get_cHRM", uFpppppppppp, 0},
{"png_set_compression_strategy", vFpi, 0},
{"png_set_gAMA", vFppd, 0},

{"png_get_header_ver", pFp, 0},
{"png_set_compression_buffer_size", vFpu, 0},

{"png_set_cHRM", vFppdddddddd, 0},
{"png_permit_mng_features", uFpu, 0},
{"png_set_keep_unknown_chunks", vFpipi, 0},
{"png_set_oFFs", vFppiii, 0},
{"png_get_libpng_ver", pFp, 0},
{"png_get_text", uFpppp, 0},
{"png_set_sBIT", vFppp, 0},
{"png_set_bKGD", vFppp, 0},
{"png_get_x_offset_pixels", iFpp, 0},
{"png_get_y_offset_pixels", iFpp, 0},
{"png_write_image", vFpp, 0},
{"png_process_data", vFpppL, 0},
{"png_progressive_combine_row", vFppp, 0},
{"png_get_progressive_ptr", pFp, 0},
{"png_get_interlace_type", CFpp, 0},

{"png_set_shift", vFpp, 0},
{"png_image_begin_read_from_memory", iFppL, 0},
{"png_image_finish_read", iFpppip, 0},
{"png_image_free", vFp, 0},
{"png_set_flush", vFpi, 0},
{"png_set_invert_alpha", vFp, 0},
{"png_set_invert_mono", vFp, 0},
{"png_get_mem_ptr", pFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t png16mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1
...
{"png_create_read_struct", pFEpppp, 0},

{"png_create_write_struct", pFEpppp, 0},
{"png_destroy_read_struct", vFEppp, 0},
{"png_destroy_write_struct", vFEpp, 0},
...
{"png_set_read_fn", vFEppp, 0},
{"png_set_read_user_transform_fn", vFEpp, 0},
...
{"png_create_read_struct_2", pFEppppppp, 0},


{"png_create_write_struct_2", pFEppppppp, 0},
...
{"png_set_progressive_read_fn", vFEppppp, 0},
...
static const map_onesymbol_t png16stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1
...
static const map_onesymbol2_t png16symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1
...
static const map_onedata_t png16datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1
...
static const map_onedata_t png16mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpng16undefs.h" 1
...
int wrappedpng16_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(png16Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(png16symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (png16symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, png16symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = png16symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, png16symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = png16symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(png16symbolmap[i].name, '@')) AddDictionnary(box86->versym, png16symbolmap[i].name); }
 cnt = sizeof(png16mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (png16mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, png16mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = png16mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, png16mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = png16mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(png16mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, png16mysymbolmap[i].name); }

    cnt = sizeof(png16stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, png16stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = png16stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(png16stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, png16stsymbolmap[i].name);
    }
    cnt = sizeof(png16symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, png16symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = png16symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = png16symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = png16symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(png16symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, png16symbol2map[i].name);
    }
    cnt = sizeof(png16datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(png16datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, png16datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = png16datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, png16datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = png16datamap[i].sz;
        }
    }
    cnt = sizeof(png16mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, png16mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = png16mydatamap[i].sz;
    }

    lib->w.altprefix = box_strdup("yes"); getMy(lib); lib->w.altmy = box_strdup("my16_");


    return 0;
}

void wrappedpng16_fini(library_t* lib)
{
...
# 410 "/home/ssd/pico/code/box86/src/wrapped/wrappedpng16.c" 2
