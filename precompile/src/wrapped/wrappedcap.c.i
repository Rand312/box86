# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
...
int wrappedcap_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(capName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(capsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (capsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, capsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = capsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, capsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = capsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(capsymbolmap[i].name, '@')) AddDictionnary(box86->versym, capsymbolmap[i].name); }
 cnt = sizeof(capmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (capmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, capmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = capmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, capmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = capmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(capmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, capmysymbolmap[i].name); }

    cnt = sizeof(capstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, capstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = capstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(capstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, capstsymbolmap[i].name);
    }
    cnt = sizeof(capsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, capsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = capsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = capsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = capsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(capsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, capsymbol2map[i].name);
    }
    cnt = sizeof(capdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(capdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, capdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = capdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, capdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = capdatamap[i].sz;
        }
    }
    cnt = sizeof(capmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, capmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = capmydatamap[i].sz;
    }
...
void wrappedcap_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedcap.c" 2
