# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfreetypetypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfreetypetypes.h"
...
# 167 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
...
typedef struct freetype_my_s {
    ...
    iFpp_t FT_New_Library; iFppp_t FT_Outline_Decompose; iFpplp_t FT_Open_Face; iFpuuLppp_t FTC_Manager_New;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static freetype_my_t my_freetype = {0};
static freetype_my_t * const my = &my_freetype;

static void getMy(library_t* lib)
{

    my->FT_New_Library = (iFpp_t)dlsym(lib->w.lib, "FT_New_Library"); my->FT_Outline_Decompose = (iFppp_t)dlsym(lib->w.lib, "FT_Outline_Decompose"); my->FT_Open_Face = (iFpplp_t)dlsym(lib->w.lib, "FT_Open_Face"); my->FTC_Manager_New = (iFpuuLppp_t)dlsym(lib->w.lib, "FTC_Manager_New");
...
# 169 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
# 185 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Generic_Finalizer_fct_0 = 0; static void my_FT_Generic_Finalizer_0(void* object) { RunFunctionFmt(my_FT_Generic_Finalizer_fct_0, "p", object); } static uintptr_t my_FT_Generic_Finalizer_fct_1 = 0; static void my_FT_Generic_Finalizer_1(void* object) { RunFunctionFmt(my_FT_Generic_Finalizer_fct_1, "p", object); } static uintptr_t my_FT_Generic_Finalizer_fct_2 = 0; static void my_FT_Generic_Finalizer_2(void* object) { RunFunctionFmt(my_FT_Generic_Finalizer_fct_2, "p", object); } static uintptr_t my_FT_Generic_Finalizer_fct_3 = 0; static void my_FT_Generic_Finalizer_3(void* object) { RunFunctionFmt(my_FT_Generic_Finalizer_fct_3, "p", object); } static uintptr_t my_FT_Generic_Finalizer_fct_4 = 0; static void my_FT_Generic_Finalizer_4(void* object) { RunFunctionFmt(my_FT_Generic_Finalizer_fct_4, "p", object); }

static void* find_FT_Generic_Finalizer_Fct(void* fct)
{
    if(!fct) return 
# 189 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 189 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Generic_Finalizer_fct_0 == (uintptr_t)fct) return my_FT_Generic_Finalizer_0; if(my_FT_Generic_Finalizer_fct_1 == (uintptr_t)fct) return my_FT_Generic_Finalizer_1; if(my_FT_Generic_Finalizer_fct_2 == (uintptr_t)fct) return my_FT_Generic_Finalizer_2; if(my_FT_Generic_Finalizer_fct_3 == (uintptr_t)fct) return my_FT_Generic_Finalizer_3; if(my_FT_Generic_Finalizer_fct_4 == (uintptr_t)fct) return my_FT_Generic_Finalizer_4;


    if(my_FT_Generic_Finalizer_fct_0 == 0) {my_FT_Generic_Finalizer_fct_0 = (uintptr_t)fct; return my_FT_Generic_Finalizer_0; } if(my_FT_Generic_Finalizer_fct_1 == 0) {my_FT_Generic_Finalizer_fct_1 = (uintptr_t)fct; return my_FT_Generic_Finalizer_1; } if(my_FT_Generic_Finalizer_fct_2 == 0) {my_FT_Generic_Finalizer_fct_2 = (uintptr_t)fct; return my_FT_Generic_Finalizer_2; } if(my_FT_Generic_Finalizer_fct_3 == 0) {my_FT_Generic_Finalizer_fct_3 = (uintptr_t)fct; return my_FT_Generic_Finalizer_3; } if(my_FT_Generic_Finalizer_fct_4 == 0) {my_FT_Generic_Finalizer_fct_4 = (uintptr_t)fct; return my_FT_Generic_Finalizer_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Generic_Finalizer callback\n"); fflush(ftrace);}} while(0);
    return 
# 199 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 199 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 213 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FTC_Face_Requester_fct_0 = 0; static int my_FTC_Face_Requester_0(void* face_id, void* lib, void* req, void* aface) { int ret = (int)RunFunctionFmt(my_FTC_Face_Requester_fct_0, "pppp", face_id, lib, req, aface); if(aface && *(void**)aface) { FT_FaceRec_t *f = *(FT_FaceRec_t**)aface; f->generic.finalizer = find_FT_Generic_Finalizer_Fct(f->generic.finalizer); } return ret; } static uintptr_t my_FTC_Face_Requester_fct_1 = 0; static int my_FTC_Face_Requester_1(void* face_id, void* lib, void* req, void* aface) { int ret = (int)RunFunctionFmt(my_FTC_Face_Requester_fct_1, "pppp", face_id, lib, req, aface); if(aface && *(void**)aface) { FT_FaceRec_t *f = *(FT_FaceRec_t**)aface; f->generic.finalizer = find_FT_Generic_Finalizer_Fct(f->generic.finalizer); } return ret; } static uintptr_t my_FTC_Face_Requester_fct_2 = 0; static int my_FTC_Face_Requester_2(void* face_id, void* lib, void* req, void* aface) { int ret = (int)RunFunctionFmt(my_FTC_Face_Requester_fct_2, "pppp", face_id, lib, req, aface); if(aface && *(void**)aface) { FT_FaceRec_t *f = *(FT_FaceRec_t**)aface; f->generic.finalizer = find_FT_Generic_Finalizer_Fct(f->generic.finalizer); } return ret; } static uintptr_t my_FTC_Face_Requester_fct_3 = 0; static int my_FTC_Face_Requester_3(void* face_id, void* lib, void* req, void* aface) { int ret = (int)RunFunctionFmt(my_FTC_Face_Requester_fct_3, "pppp", face_id, lib, req, aface); if(aface && *(void**)aface) { FT_FaceRec_t *f = *(FT_FaceRec_t**)aface; f->generic.finalizer = find_FT_Generic_Finalizer_Fct(f->generic.finalizer); } return ret; } static uintptr_t my_FTC_Face_Requester_fct_4 = 0; static int my_FTC_Face_Requester_4(void* face_id, void* lib, void* req, void* aface) { int ret = (int)RunFunctionFmt(my_FTC_Face_Requester_fct_4, "pppp", face_id, lib, req, aface); if(aface && *(void**)aface) { FT_FaceRec_t *f = *(FT_FaceRec_t**)aface; f->generic.finalizer = find_FT_Generic_Finalizer_Fct(f->generic.finalizer); } return ret; }

static void* find_FTC_Face_Requester_Fct(void* fct)
{
    if(!fct) return 
# 217 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 217 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FTC_Face_Requester_fct_0 == (uintptr_t)fct) return my_FTC_Face_Requester_0; if(my_FTC_Face_Requester_fct_1 == (uintptr_t)fct) return my_FTC_Face_Requester_1; if(my_FTC_Face_Requester_fct_2 == (uintptr_t)fct) return my_FTC_Face_Requester_2; if(my_FTC_Face_Requester_fct_3 == (uintptr_t)fct) return my_FTC_Face_Requester_3; if(my_FTC_Face_Requester_fct_4 == (uintptr_t)fct) return my_FTC_Face_Requester_4;


    if(my_FTC_Face_Requester_fct_0 == 0) {my_FTC_Face_Requester_fct_0 = (uintptr_t)fct; return my_FTC_Face_Requester_0; } if(my_FTC_Face_Requester_fct_1 == 0) {my_FTC_Face_Requester_fct_1 = (uintptr_t)fct; return my_FTC_Face_Requester_1; } if(my_FTC_Face_Requester_fct_2 == 0) {my_FTC_Face_Requester_fct_2 = (uintptr_t)fct; return my_FTC_Face_Requester_2; } if(my_FTC_Face_Requester_fct_3 == 0) {my_FTC_Face_Requester_fct_3 = (uintptr_t)fct; return my_FTC_Face_Requester_3; } if(my_FTC_Face_Requester_fct_4 == 0) {my_FTC_Face_Requester_fct_4 = (uintptr_t)fct; return my_FTC_Face_Requester_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FTC_Face_Requester callback\n"); fflush(ftrace);}} while(0);
    return 
# 227 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 227 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 237 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Stream_IoFunc_fct_0 = 0; static unsigned long my_FT_Stream_IoFunc_0(void* a, unsigned long b, void* c, unsigned long d) { return (unsigned long)RunFunctionFmt(my_FT_Stream_IoFunc_fct_0, "pLpL", a, b, c, d); } static uintptr_t my_FT_Stream_IoFunc_fct_1 = 0; static unsigned long my_FT_Stream_IoFunc_1(void* a, unsigned long b, void* c, unsigned long d) { return (unsigned long)RunFunctionFmt(my_FT_Stream_IoFunc_fct_1, "pLpL", a, b, c, d); } static uintptr_t my_FT_Stream_IoFunc_fct_2 = 0; static unsigned long my_FT_Stream_IoFunc_2(void* a, unsigned long b, void* c, unsigned long d) { return (unsigned long)RunFunctionFmt(my_FT_Stream_IoFunc_fct_2, "pLpL", a, b, c, d); } static uintptr_t my_FT_Stream_IoFunc_fct_3 = 0; static unsigned long my_FT_Stream_IoFunc_3(void* a, unsigned long b, void* c, unsigned long d) { return (unsigned long)RunFunctionFmt(my_FT_Stream_IoFunc_fct_3, "pLpL", a, b, c, d); } static uintptr_t my_FT_Stream_IoFunc_fct_4 = 0; static unsigned long my_FT_Stream_IoFunc_4(void* a, unsigned long b, void* c, unsigned long d) { return (unsigned long)RunFunctionFmt(my_FT_Stream_IoFunc_fct_4, "pLpL", a, b, c, d); }

static void* find_FT_Stream_IoFunc_Fct(void* fct)
{
    if(!fct) return 
# 241 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 241 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Stream_IoFunc_fct_0 == (uintptr_t)fct) return my_FT_Stream_IoFunc_0; if(my_FT_Stream_IoFunc_fct_1 == (uintptr_t)fct) return my_FT_Stream_IoFunc_1; if(my_FT_Stream_IoFunc_fct_2 == (uintptr_t)fct) return my_FT_Stream_IoFunc_2; if(my_FT_Stream_IoFunc_fct_3 == (uintptr_t)fct) return my_FT_Stream_IoFunc_3; if(my_FT_Stream_IoFunc_fct_4 == (uintptr_t)fct) return my_FT_Stream_IoFunc_4;


    if(my_FT_Stream_IoFunc_fct_0 == 0) {my_FT_Stream_IoFunc_fct_0 = (uintptr_t)fct; return my_FT_Stream_IoFunc_0; } if(my_FT_Stream_IoFunc_fct_1 == 0) {my_FT_Stream_IoFunc_fct_1 = (uintptr_t)fct; return my_FT_Stream_IoFunc_1; } if(my_FT_Stream_IoFunc_fct_2 == 0) {my_FT_Stream_IoFunc_fct_2 = (uintptr_t)fct; return my_FT_Stream_IoFunc_2; } if(my_FT_Stream_IoFunc_fct_3 == 0) {my_FT_Stream_IoFunc_fct_3 = (uintptr_t)fct; return my_FT_Stream_IoFunc_3; } if(my_FT_Stream_IoFunc_fct_4 == 0) {my_FT_Stream_IoFunc_fct_4 = (uintptr_t)fct; return my_FT_Stream_IoFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Stream_IoFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 251 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 251 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Stream_CloseFunc_fct_0 = 0; static int my_FT_Stream_CloseFunc_0(void* a) { return (int)RunFunctionFmt(my_FT_Stream_CloseFunc_fct_0, "p", a); } static uintptr_t my_FT_Stream_CloseFunc_fct_1 = 0; static int my_FT_Stream_CloseFunc_1(void* a) { return (int)RunFunctionFmt(my_FT_Stream_CloseFunc_fct_1, "p", a); } static uintptr_t my_FT_Stream_CloseFunc_fct_2 = 0; static int my_FT_Stream_CloseFunc_2(void* a) { return (int)RunFunctionFmt(my_FT_Stream_CloseFunc_fct_2, "p", a); } static uintptr_t my_FT_Stream_CloseFunc_fct_3 = 0; static int my_FT_Stream_CloseFunc_3(void* a) { return (int)RunFunctionFmt(my_FT_Stream_CloseFunc_fct_3, "p", a); } static uintptr_t my_FT_Stream_CloseFunc_fct_4 = 0; static int my_FT_Stream_CloseFunc_4(void* a) { return (int)RunFunctionFmt(my_FT_Stream_CloseFunc_fct_4, "p", a); }

static void* find_FT_Stream_CloseFunc_Fct(void* fct)
{
    if(!fct) return 
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Stream_CloseFunc_fct_0 == (uintptr_t)fct) return my_FT_Stream_CloseFunc_0; if(my_FT_Stream_CloseFunc_fct_1 == (uintptr_t)fct) return my_FT_Stream_CloseFunc_1; if(my_FT_Stream_CloseFunc_fct_2 == (uintptr_t)fct) return my_FT_Stream_CloseFunc_2; if(my_FT_Stream_CloseFunc_fct_3 == (uintptr_t)fct) return my_FT_Stream_CloseFunc_3; if(my_FT_Stream_CloseFunc_fct_4 == (uintptr_t)fct) return my_FT_Stream_CloseFunc_4;


    if(my_FT_Stream_CloseFunc_fct_0 == 0) {my_FT_Stream_CloseFunc_fct_0 = (uintptr_t)fct; return my_FT_Stream_CloseFunc_0; } if(my_FT_Stream_CloseFunc_fct_1 == 0) {my_FT_Stream_CloseFunc_fct_1 = (uintptr_t)fct; return my_FT_Stream_CloseFunc_1; } if(my_FT_Stream_CloseFunc_fct_2 == 0) {my_FT_Stream_CloseFunc_fct_2 = (uintptr_t)fct; return my_FT_Stream_CloseFunc_2; } if(my_FT_Stream_CloseFunc_fct_3 == 0) {my_FT_Stream_CloseFunc_fct_3 = (uintptr_t)fct; return my_FT_Stream_CloseFunc_3; } if(my_FT_Stream_CloseFunc_fct_4 == 0) {my_FT_Stream_CloseFunc_fct_4 = (uintptr_t)fct; return my_FT_Stream_CloseFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Stream_CloseFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 275 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 275 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 285 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Outline_MoveToFunc_fct_0 = 0; static int my_FT_Outline_MoveToFunc_0(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_MoveToFunc_fct_0, "pp", a, b); } static uintptr_t my_FT_Outline_MoveToFunc_fct_1 = 0; static int my_FT_Outline_MoveToFunc_1(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_MoveToFunc_fct_1, "pp", a, b); } static uintptr_t my_FT_Outline_MoveToFunc_fct_2 = 0; static int my_FT_Outline_MoveToFunc_2(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_MoveToFunc_fct_2, "pp", a, b); } static uintptr_t my_FT_Outline_MoveToFunc_fct_3 = 0; static int my_FT_Outline_MoveToFunc_3(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_MoveToFunc_fct_3, "pp", a, b); } static uintptr_t my_FT_Outline_MoveToFunc_fct_4 = 0; static int my_FT_Outline_MoveToFunc_4(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_MoveToFunc_fct_4, "pp", a, b); }

static void* find_FT_Outline_MoveToFunc_Fct(void* fct)
{
    if(!fct) return 
# 289 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 289 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Outline_MoveToFunc_fct_0 == (uintptr_t)fct) return my_FT_Outline_MoveToFunc_0; if(my_FT_Outline_MoveToFunc_fct_1 == (uintptr_t)fct) return my_FT_Outline_MoveToFunc_1; if(my_FT_Outline_MoveToFunc_fct_2 == (uintptr_t)fct) return my_FT_Outline_MoveToFunc_2; if(my_FT_Outline_MoveToFunc_fct_3 == (uintptr_t)fct) return my_FT_Outline_MoveToFunc_3; if(my_FT_Outline_MoveToFunc_fct_4 == (uintptr_t)fct) return my_FT_Outline_MoveToFunc_4;


    if(my_FT_Outline_MoveToFunc_fct_0 == 0) {my_FT_Outline_MoveToFunc_fct_0 = (uintptr_t)fct; return my_FT_Outline_MoveToFunc_0; } if(my_FT_Outline_MoveToFunc_fct_1 == 0) {my_FT_Outline_MoveToFunc_fct_1 = (uintptr_t)fct; return my_FT_Outline_MoveToFunc_1; } if(my_FT_Outline_MoveToFunc_fct_2 == 0) {my_FT_Outline_MoveToFunc_fct_2 = (uintptr_t)fct; return my_FT_Outline_MoveToFunc_2; } if(my_FT_Outline_MoveToFunc_fct_3 == 0) {my_FT_Outline_MoveToFunc_fct_3 = (uintptr_t)fct; return my_FT_Outline_MoveToFunc_3; } if(my_FT_Outline_MoveToFunc_fct_4 == 0) {my_FT_Outline_MoveToFunc_fct_4 = (uintptr_t)fct; return my_FT_Outline_MoveToFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Outline_MoveToFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 299 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 299 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 309 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Outline_LineToFunc_fct_0 = 0; static int my_FT_Outline_LineToFunc_0(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_LineToFunc_fct_0, "pp", a, b); } static uintptr_t my_FT_Outline_LineToFunc_fct_1 = 0; static int my_FT_Outline_LineToFunc_1(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_LineToFunc_fct_1, "pp", a, b); } static uintptr_t my_FT_Outline_LineToFunc_fct_2 = 0; static int my_FT_Outline_LineToFunc_2(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_LineToFunc_fct_2, "pp", a, b); } static uintptr_t my_FT_Outline_LineToFunc_fct_3 = 0; static int my_FT_Outline_LineToFunc_3(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_LineToFunc_fct_3, "pp", a, b); } static uintptr_t my_FT_Outline_LineToFunc_fct_4 = 0; static int my_FT_Outline_LineToFunc_4(void* a, void* b) { return (int)RunFunctionFmt(my_FT_Outline_LineToFunc_fct_4, "pp", a, b); }

static void* find_FT_Outline_LineToFunc_Fct(void* fct)
{
    if(!fct) return 
# 313 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 313 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Outline_LineToFunc_fct_0 == (uintptr_t)fct) return my_FT_Outline_LineToFunc_0; if(my_FT_Outline_LineToFunc_fct_1 == (uintptr_t)fct) return my_FT_Outline_LineToFunc_1; if(my_FT_Outline_LineToFunc_fct_2 == (uintptr_t)fct) return my_FT_Outline_LineToFunc_2; if(my_FT_Outline_LineToFunc_fct_3 == (uintptr_t)fct) return my_FT_Outline_LineToFunc_3; if(my_FT_Outline_LineToFunc_fct_4 == (uintptr_t)fct) return my_FT_Outline_LineToFunc_4;


    if(my_FT_Outline_LineToFunc_fct_0 == 0) {my_FT_Outline_LineToFunc_fct_0 = (uintptr_t)fct; return my_FT_Outline_LineToFunc_0; } if(my_FT_Outline_LineToFunc_fct_1 == 0) {my_FT_Outline_LineToFunc_fct_1 = (uintptr_t)fct; return my_FT_Outline_LineToFunc_1; } if(my_FT_Outline_LineToFunc_fct_2 == 0) {my_FT_Outline_LineToFunc_fct_2 = (uintptr_t)fct; return my_FT_Outline_LineToFunc_2; } if(my_FT_Outline_LineToFunc_fct_3 == 0) {my_FT_Outline_LineToFunc_fct_3 = (uintptr_t)fct; return my_FT_Outline_LineToFunc_3; } if(my_FT_Outline_LineToFunc_fct_4 == 0) {my_FT_Outline_LineToFunc_fct_4 = (uintptr_t)fct; return my_FT_Outline_LineToFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Outline_LineToFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 323 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 323 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 333 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Outline_ConicToFunc_fct_0 = 0; static int my_FT_Outline_ConicToFunc_0(void* a, void* b, void * c) { return (int)RunFunctionFmt(my_FT_Outline_ConicToFunc_fct_0, "ppp", a, b, c); } static uintptr_t my_FT_Outline_ConicToFunc_fct_1 = 0; static int my_FT_Outline_ConicToFunc_1(void* a, void* b, void * c) { return (int)RunFunctionFmt(my_FT_Outline_ConicToFunc_fct_1, "ppp", a, b, c); } static uintptr_t my_FT_Outline_ConicToFunc_fct_2 = 0; static int my_FT_Outline_ConicToFunc_2(void* a, void* b, void * c) { return (int)RunFunctionFmt(my_FT_Outline_ConicToFunc_fct_2, "ppp", a, b, c); } static uintptr_t my_FT_Outline_ConicToFunc_fct_3 = 0; static int my_FT_Outline_ConicToFunc_3(void* a, void* b, void * c) { return (int)RunFunctionFmt(my_FT_Outline_ConicToFunc_fct_3, "ppp", a, b, c); } static uintptr_t my_FT_Outline_ConicToFunc_fct_4 = 0; static int my_FT_Outline_ConicToFunc_4(void* a, void* b, void * c) { return (int)RunFunctionFmt(my_FT_Outline_ConicToFunc_fct_4, "ppp", a, b, c); }

static void* find_FT_Outline_ConicToFunc_Fct(void* fct)
{
    if(!fct) return 
# 337 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 337 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Outline_ConicToFunc_fct_0 == (uintptr_t)fct) return my_FT_Outline_ConicToFunc_0; if(my_FT_Outline_ConicToFunc_fct_1 == (uintptr_t)fct) return my_FT_Outline_ConicToFunc_1; if(my_FT_Outline_ConicToFunc_fct_2 == (uintptr_t)fct) return my_FT_Outline_ConicToFunc_2; if(my_FT_Outline_ConicToFunc_fct_3 == (uintptr_t)fct) return my_FT_Outline_ConicToFunc_3; if(my_FT_Outline_ConicToFunc_fct_4 == (uintptr_t)fct) return my_FT_Outline_ConicToFunc_4;


    if(my_FT_Outline_ConicToFunc_fct_0 == 0) {my_FT_Outline_ConicToFunc_fct_0 = (uintptr_t)fct; return my_FT_Outline_ConicToFunc_0; } if(my_FT_Outline_ConicToFunc_fct_1 == 0) {my_FT_Outline_ConicToFunc_fct_1 = (uintptr_t)fct; return my_FT_Outline_ConicToFunc_1; } if(my_FT_Outline_ConicToFunc_fct_2 == 0) {my_FT_Outline_ConicToFunc_fct_2 = (uintptr_t)fct; return my_FT_Outline_ConicToFunc_2; } if(my_FT_Outline_ConicToFunc_fct_3 == 0) {my_FT_Outline_ConicToFunc_fct_3 = (uintptr_t)fct; return my_FT_Outline_ConicToFunc_3; } if(my_FT_Outline_ConicToFunc_fct_4 == 0) {my_FT_Outline_ConicToFunc_fct_4 = (uintptr_t)fct; return my_FT_Outline_ConicToFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Outline_ConicToFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 347 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 347 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 357 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Outline_CubicToFunc_fct_0 = 0; static int my_FT_Outline_CubicToFunc_0(void* a, void* b, void * c, void* d) { return (int)RunFunctionFmt(my_FT_Outline_CubicToFunc_fct_0, "pppp", a, b, c, d); } static uintptr_t my_FT_Outline_CubicToFunc_fct_1 = 0; static int my_FT_Outline_CubicToFunc_1(void* a, void* b, void * c, void* d) { return (int)RunFunctionFmt(my_FT_Outline_CubicToFunc_fct_1, "pppp", a, b, c, d); } static uintptr_t my_FT_Outline_CubicToFunc_fct_2 = 0; static int my_FT_Outline_CubicToFunc_2(void* a, void* b, void * c, void* d) { return (int)RunFunctionFmt(my_FT_Outline_CubicToFunc_fct_2, "pppp", a, b, c, d); } static uintptr_t my_FT_Outline_CubicToFunc_fct_3 = 0; static int my_FT_Outline_CubicToFunc_3(void* a, void* b, void * c, void* d) { return (int)RunFunctionFmt(my_FT_Outline_CubicToFunc_fct_3, "pppp", a, b, c, d); } static uintptr_t my_FT_Outline_CubicToFunc_fct_4 = 0; static int my_FT_Outline_CubicToFunc_4(void* a, void* b, void * c, void* d) { return (int)RunFunctionFmt(my_FT_Outline_CubicToFunc_fct_4, "pppp", a, b, c, d); }

static void* find_FT_Outline_CubicToFunc_Fct(void* fct)
{
    if(!fct) return 
# 361 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 361 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Outline_CubicToFunc_fct_0 == (uintptr_t)fct) return my_FT_Outline_CubicToFunc_0; if(my_FT_Outline_CubicToFunc_fct_1 == (uintptr_t)fct) return my_FT_Outline_CubicToFunc_1; if(my_FT_Outline_CubicToFunc_fct_2 == (uintptr_t)fct) return my_FT_Outline_CubicToFunc_2; if(my_FT_Outline_CubicToFunc_fct_3 == (uintptr_t)fct) return my_FT_Outline_CubicToFunc_3; if(my_FT_Outline_CubicToFunc_fct_4 == (uintptr_t)fct) return my_FT_Outline_CubicToFunc_4;


    if(my_FT_Outline_CubicToFunc_fct_0 == 0) {my_FT_Outline_CubicToFunc_fct_0 = (uintptr_t)fct; return my_FT_Outline_CubicToFunc_0; } if(my_FT_Outline_CubicToFunc_fct_1 == 0) {my_FT_Outline_CubicToFunc_fct_1 = (uintptr_t)fct; return my_FT_Outline_CubicToFunc_1; } if(my_FT_Outline_CubicToFunc_fct_2 == 0) {my_FT_Outline_CubicToFunc_fct_2 = (uintptr_t)fct; return my_FT_Outline_CubicToFunc_2; } if(my_FT_Outline_CubicToFunc_fct_3 == 0) {my_FT_Outline_CubicToFunc_fct_3 = (uintptr_t)fct; return my_FT_Outline_CubicToFunc_3; } if(my_FT_Outline_CubicToFunc_fct_4 == 0) {my_FT_Outline_CubicToFunc_fct_4 = (uintptr_t)fct; return my_FT_Outline_CubicToFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Outline_CubicToFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 371 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 371 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
# 381 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
static uintptr_t my_FT_Alloc_fct_0 = 0; static void* my_FT_Alloc_0(void* memory, long size) { return (void*)RunFunctionFmt(my_FT_Alloc_fct_0, "pl", memory, size); } static uintptr_t my_FT_Alloc_fct_1 = 0; static void* my_FT_Alloc_1(void* memory, long size) { return (void*)RunFunctionFmt(my_FT_Alloc_fct_1, "pl", memory, size); } static uintptr_t my_FT_Alloc_fct_2 = 0; static void* my_FT_Alloc_2(void* memory, long size) { return (void*)RunFunctionFmt(my_FT_Alloc_fct_2, "pl", memory, size); } static uintptr_t my_FT_Alloc_fct_3 = 0; static void* my_FT_Alloc_3(void* memory, long size) { return (void*)RunFunctionFmt(my_FT_Alloc_fct_3, "pl", memory, size); } static uintptr_t my_FT_Alloc_fct_4 = 0; static void* my_FT_Alloc_4(void* memory, long size) { return (void*)RunFunctionFmt(my_FT_Alloc_fct_4, "pl", memory, size); }

static void* find_FT_Alloc_Fct(void* fct)
{
    if(!fct) return 
# 385 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 385 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Alloc_fct_0 == (uintptr_t)fct) return my_FT_Alloc_0; if(my_FT_Alloc_fct_1 == (uintptr_t)fct) return my_FT_Alloc_1; if(my_FT_Alloc_fct_2 == (uintptr_t)fct) return my_FT_Alloc_2; if(my_FT_Alloc_fct_3 == (uintptr_t)fct) return my_FT_Alloc_3; if(my_FT_Alloc_fct_4 == (uintptr_t)fct) return my_FT_Alloc_4;


    if(my_FT_Alloc_fct_0 == 0) {my_FT_Alloc_fct_0 = (uintptr_t)fct; return my_FT_Alloc_0; } if(my_FT_Alloc_fct_1 == 0) {my_FT_Alloc_fct_1 = (uintptr_t)fct; return my_FT_Alloc_1; } if(my_FT_Alloc_fct_2 == 0) {my_FT_Alloc_fct_2 = (uintptr_t)fct; return my_FT_Alloc_2; } if(my_FT_Alloc_fct_3 == 0) {my_FT_Alloc_fct_3 = (uintptr_t)fct; return my_FT_Alloc_3; } if(my_FT_Alloc_fct_4 == 0) {my_FT_Alloc_fct_4 = (uintptr_t)fct; return my_FT_Alloc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Alloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 395 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 395 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
...
static uintptr_t my_FT_Free_fct_0 = 0; static void my_FT_Free_0(void* memory, void* p) { RunFunctionFmt(my_FT_Free_fct_0, "pp", memory, p); } static uintptr_t my_FT_Free_fct_1 = 0; static void my_FT_Free_1(void* memory, void* p) { RunFunctionFmt(my_FT_Free_fct_1, "pp", memory, p); } static uintptr_t my_FT_Free_fct_2 = 0; static void my_FT_Free_2(void* memory, void* p) { RunFunctionFmt(my_FT_Free_fct_2, "pp", memory, p); } static uintptr_t my_FT_Free_fct_3 = 0; static void my_FT_Free_3(void* memory, void* p) { RunFunctionFmt(my_FT_Free_fct_3, "pp", memory, p); } static uintptr_t my_FT_Free_fct_4 = 0; static void my_FT_Free_4(void* memory, void* p) { RunFunctionFmt(my_FT_Free_fct_4, "pp", memory, p); }

static void* find_FT_Free_Fct(void* fct)
{
    if(!fct) return 
# 408 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 408 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Free_fct_0 == (uintptr_t)fct) return my_FT_Free_0; if(my_FT_Free_fct_1 == (uintptr_t)fct) return my_FT_Free_1; if(my_FT_Free_fct_2 == (uintptr_t)fct) return my_FT_Free_2; if(my_FT_Free_fct_3 == (uintptr_t)fct) return my_FT_Free_3; if(my_FT_Free_fct_4 == (uintptr_t)fct) return my_FT_Free_4;


    if(my_FT_Free_fct_0 == 0) {my_FT_Free_fct_0 = (uintptr_t)fct; return my_FT_Free_0; } if(my_FT_Free_fct_1 == 0) {my_FT_Free_fct_1 = (uintptr_t)fct; return my_FT_Free_1; } if(my_FT_Free_fct_2 == 0) {my_FT_Free_fct_2 = (uintptr_t)fct; return my_FT_Free_2; } if(my_FT_Free_fct_3 == 0) {my_FT_Free_fct_3 = (uintptr_t)fct; return my_FT_Free_3; } if(my_FT_Free_fct_4 == 0) {my_FT_Free_fct_4 = (uintptr_t)fct; return my_FT_Free_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Free callback\n"); fflush(ftrace);}} while(0);
    return 
# 418 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 418 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
...
static uintptr_t my_FT_Realloc_fct_0 = 0; static void* my_FT_Realloc_0(void* memory, long cur, long size, void* p) { return (void*)RunFunctionFmt(my_FT_Realloc_fct_0, "pllp", memory, cur, size, p); } static uintptr_t my_FT_Realloc_fct_1 = 0; static void* my_FT_Realloc_1(void* memory, long cur, long size, void* p) { return (void*)RunFunctionFmt(my_FT_Realloc_fct_1, "pllp", memory, cur, size, p); } static uintptr_t my_FT_Realloc_fct_2 = 0; static void* my_FT_Realloc_2(void* memory, long cur, long size, void* p) { return (void*)RunFunctionFmt(my_FT_Realloc_fct_2, "pllp", memory, cur, size, p); } static uintptr_t my_FT_Realloc_fct_3 = 0; static void* my_FT_Realloc_3(void* memory, long cur, long size, void* p) { return (void*)RunFunctionFmt(my_FT_Realloc_fct_3, "pllp", memory, cur, size, p); } static uintptr_t my_FT_Realloc_fct_4 = 0; static void* my_FT_Realloc_4(void* memory, long cur, long size, void* p) { return (void*)RunFunctionFmt(my_FT_Realloc_fct_4, "pllp", memory, cur, size, p); }

static void* find_FT_Realloc_Fct(void* fct)
{
    if(!fct) return 
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                   ((void *)0)
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_FT_Realloc_fct_0 == (uintptr_t)fct) return my_FT_Realloc_0; if(my_FT_Realloc_fct_1 == (uintptr_t)fct) return my_FT_Realloc_1; if(my_FT_Realloc_fct_2 == (uintptr_t)fct) return my_FT_Realloc_2; if(my_FT_Realloc_fct_3 == (uintptr_t)fct) return my_FT_Realloc_3; if(my_FT_Realloc_fct_4 == (uintptr_t)fct) return my_FT_Realloc_4;


    if(my_FT_Realloc_fct_0 == 0) {my_FT_Realloc_fct_0 = (uintptr_t)fct; return my_FT_Realloc_0; } if(my_FT_Realloc_fct_1 == 0) {my_FT_Realloc_fct_1 = (uintptr_t)fct; return my_FT_Realloc_1; } if(my_FT_Realloc_fct_2 == 0) {my_FT_Realloc_fct_2 = (uintptr_t)fct; return my_FT_Realloc_2; } if(my_FT_Realloc_fct_3 == 0) {my_FT_Realloc_fct_3 = (uintptr_t)fct; return my_FT_Realloc_3; } if(my_FT_Realloc_fct_4 == 0) {my_FT_Realloc_fct_4 = (uintptr_t)fct; return my_FT_Realloc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype FT_Realloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 441 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
          ((void *)0)
# 441 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
              ;
}
...
static FT_MemoryRec_t my_FT_MemoryRec_struct_0 = {0}; static FT_MemoryRec_t* my_FT_MemoryRec_ref_0 = 
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
((void *)0)
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
; static FT_MemoryRec_t my_FT_MemoryRec_struct_1 = {0}; static FT_MemoryRec_t* my_FT_MemoryRec_ref_1 = 
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
((void *)0)
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
; static FT_MemoryRec_t my_FT_MemoryRec_struct_2 = {0}; static FT_MemoryRec_t* my_FT_MemoryRec_ref_2 = 
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
((void *)0)
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
; static FT_MemoryRec_t my_FT_MemoryRec_struct_3 = {0}; static FT_MemoryRec_t* my_FT_MemoryRec_ref_3 = 
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
((void *)0)
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
; static FT_MemoryRec_t my_FT_MemoryRec_struct_4 = {0}; static FT_MemoryRec_t* my_FT_MemoryRec_ref_4 = 
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
((void *)0)
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
;
...
{
    if(!s) return 
# 458 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 3 4
                  ((void *)0)
# 458 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c"
                      ;

    if(my_FT_MemoryRec_ref_0 == s) return &my_FT_MemoryRec_struct_0; if(my_FT_MemoryRec_ref_1 == s) return &my_FT_MemoryRec_struct_1; if(my_FT_MemoryRec_ref_2 == s) return &my_FT_MemoryRec_struct_2; if(my_FT_MemoryRec_ref_3 == s) return &my_FT_MemoryRec_struct_3; if(my_FT_MemoryRec_ref_4 == s) return &my_FT_MemoryRec_struct_4;


    if(!my_FT_MemoryRec_ref_0) {wrap_FT_MemoryRec(&my_FT_MemoryRec_struct_0, s); my_FT_MemoryRec_ref_0 = s; return &my_FT_MemoryRec_struct_0;} if(!my_FT_MemoryRec_ref_1) {wrap_FT_MemoryRec(&my_FT_MemoryRec_struct_1, s); my_FT_MemoryRec_ref_1 = s; return &my_FT_MemoryRec_struct_1;} if(!my_FT_MemoryRec_ref_2) {wrap_FT_MemoryRec(&my_FT_MemoryRec_struct_2, s); my_FT_MemoryRec_ref_2 = s; return &my_FT_MemoryRec_struct_2;} if(!my_FT_MemoryRec_ref_3) {wrap_FT_MemoryRec(&my_FT_MemoryRec_struct_3, s); my_FT_MemoryRec_ref_3 = s; return &my_FT_MemoryRec_struct_3;} if(!my_FT_MemoryRec_ref_4) {wrap_FT_MemoryRec(&my_FT_MemoryRec_struct_4, s); my_FT_MemoryRec_ref_4 = s; return &my_FT_MemoryRec_struct_4;}

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libfreetype Struct FT_MemoryRec wrapping\n"); fflush(ftrace);}} while(0);
    return s;
}



__attribute__((visibility("default"))) int my_FT_Open_Face(x86emu_t* emu, void* library, FT_Open_Args_t* args, long face_index, void* aface)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_FT_Outline_Decompose(x86emu_t* emu, void * arg0 , const FT_Outline_Funcs_t * arg1 , void * arg2)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_FTC_Manager_New(x86emu_t* emu, void* l, uint32_t max_faces, uint32_t max_sizes, uintptr_t max_bytes, void* req, void* data, void* aman)
{
    (void)emu;
    return my->FTC_Manager_New(l, max_faces, max_sizes, max_bytes, find_FTC_Face_Requester_Fct(req), data, aman);
}

__attribute__((visibility("default"))) int my_FT_New_Library(x86emu_t* emu, FT_MemoryRec_t* memory, void* p)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfreetypedefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t freetypesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1




{"FT_Activate_Size", iFp, 0},
{"FT_Add_Default_Modules", vFp, 0},

{"FT_Angle_Diff", lFll, 0},
{"FT_Atan2", lFll, 0},
{"FT_Attach_File", iFpp, 0},
{"FT_Attach_Stream", iFpp, 0},
{"FT_Bitmap_Convert", iFpppi, 0},
{"FT_Bitmap_Copy", iFppp, 0},
{"FT_Bitmap_Done", iFpp, 0},
{"FT_Bitmap_Embolden", iFppll, 0},
{"FT_Bitmap_Init", vFp, 0},
{"FT_Bitmap_New", vFp, 0},
...
{"FT_Done_Face", iFp, 0},
{"FT_Done_FreeType", iFp, 0},
{"FT_Done_Glyph", vFp, 0},
{"FT_Done_Library", iFp, 0},
{"FT_Done_Size", iFp, 0},
...
{"FT_Face_Properties", iFpup, 0},


{"FT_Get_Advance", iFpiup, 0},
{"FT_Get_Advances", iFpuuip, 0},


{"FT_Get_Char_Index", uFpL, 0},
{"FT_Get_Charmap_Index", iFp, 0},



{"FT_Get_CMap_Format", LFp, 0},

{"FT_Get_First_Char", LFpp, 0},

{"FT_Get_FSType_Flags", WFp, 0},

{"FT_Get_Glyph", iFpp, 0},
{"FT_Get_Glyph_Name", iFpupu, 0},
{"FT_Get_Kerning", iFpuuup, 0},




{"FT_Get_Name_Index", uFpp, 0},
{"FT_Get_Next_Char", LFpLp, 0},



{"FT_Get_Postscript_Name", pFp, 0},
{"FT_Get_PS_Font_Info", iFpp, 0},




{"FT_Get_Sfnt_Name", iFpip, 0},
{"FT_Get_Sfnt_Name_Count", uFp, 0},
{"FT_Get_Sfnt_Table", pFpi, 0},
{"FT_Get_SubGlyph_Info", iFpuppppp, 0},
{"FT_Get_Track_Kerning", iFplip, 0},
{"FT_Get_TrueType_Engine_Type", iFp, 0},


{"FT_Get_WinFNT_Header", iFpp, 0},
{"FT_Get_X11_Font_Format", pFp, 0},
{"FT_Glyph_Copy", iFpp, 0},
{"FT_Glyph_Get_CBox", vFpup, 0},
{"FT_GlyphSlot_Embolden", vFp, 0},
{"FT_GlyphSlot_Oblique", vFp, 0},
{"FT_GlyphSlot_Own_Bitmap", iFp, 0},
{"FT_Glyph_Stroke", iFppi, 0},
{"FT_Glyph_StrokeBorder", iFppCC, 0},
{"FT_Glyph_To_Bitmap", iFpipC, 0},
{"FT_Glyph_Transform", iFppp, 0},


{"FT_Init_FreeType", iFp, 0},
{"FT_Library_SetLcdFilter", iFpi, 0},
{"FT_Library_SetLcdFilterWeights", iFpp, 0},
{"FT_Library_Version", vFpppp, 0},
...
{"FT_Load_Char", iFpLi, 0},
{"FT_Load_Glyph", iFpui, 0},
{"FT_Load_Sfnt_Table", iFpLlpp, 0},
{"FT_Matrix_Invert", iFp, 0},
{"FT_Matrix_Multiply", vFpp, 0},
{"FT_MulDiv", lFlll, 0},
{"FT_MulFix", lFll, 0},
{"FT_New_Face", iFpplp, 0},

{"FT_New_Memory_Face", iFppllp, 0},
{"FT_New_Size", iFpp, 0},

{"FT_OpenType_Free", vFpp, 0},
{"FT_OpenType_Validate", iFpuppppp, 0},
{"FT_Outline_Check", iFp, 0},
{"FT_Outline_Copy", iFpp, 0},

{"FT_Outline_Done", iFpp, 0},

{"FT_Outline_Embolden", iFpl, 0},
{"FT_Outline_EmboldenXY", iFpll, 0},
{"FT_Outline_Get_BBox", iFpp, 0},
{"FT_Outline_Get_Bitmap", iFppp, 0},
{"FT_Outline_Get_CBox", vFpp, 0},



{"FT_Outline_New", iFpuip, 0},

{"FT_Outline_Render", iFppp, 0},
{"FT_Outline_Reverse", vFp, 0},
{"FT_Outline_Transform", vFpp, 0},
{"FT_Outline_Translate", vFpll, 0},

{"FT_Property_Set", iFpppp, 0},
{"FT_Reference_Face", iFp, 0},


{"FT_Render_Glyph", iFpi, 0},
{"FT_Request_Size", iFpp, 0},

{"FT_Select_Charmap", iFpi, 0},
{"FT_Select_Size", iFpi, 0},
{"FT_Set_Charmap", iFpp, 0},
{"FT_Set_Char_Size", iFplluu, 0},




{"FT_Set_Pixel_Sizes", iFpuu, 0},

{"FT_Set_Transform", vFppp, 0},
...
{"FT_Stroker_BeginSubPath", iFppC, 0},
{"FT_Stroker_ConicTo", iFppp, 0},
{"FT_Stroker_CubicTo", iFpppp, 0},
{"FT_Stroker_Done", vFp, 0},
{"FT_Stroker_EndSubPath", iFp, 0},
{"FT_Stroker_Export", vFpp, 0},
{"FT_Stroker_ExportBorder", vFpip, 0},
{"FT_Stroker_GetBorderCounts", iFpipp, 0},
{"FT_Stroker_GetCounts", iFppp, 0},
{"FT_Stroker_LineTo", iFpp, 0},
{"FT_Stroker_New", iFpp, 0},
{"FT_Stroker_ParseOutline", iFppC, 0},
{"FT_Stroker_Rewind", vFp, 0},
{"FT_Stroker_Set", vFpliil, 0},
{"FT_Tan", lFl, 0},


{"FT_Vector_From_Polar", vFpll, 0},
{"FT_Vector_Length", lFp, 0},
{"FT_Vector_Polarize", vFppp, 0},
{"FT_Vector_Rotate", vFpl, 0},
{"FT_Vector_Transform", vFpp, 0},
{"FT_Vector_Unit", vFpl, 0},

{"FTC_CMapCache_Lookup", uFppiu, 0},
{"FTC_CMapCache_New", iFpp, 0},
{"FTC_ImageCache_Lookup", iFppupp, 0},
{"FTC_ImageCache_LookupScaler", iFppLupp, 0},
{"FTC_ImageCache_New", iFpp, 0},
{"FTC_Manager_Done", vFp, 0},
{"FTC_Manager_LookupFace", iFppp, 0},
{"FTC_Manager_LookupSize", iFppp, 0},

{"FTC_Manager_RemoveFaceID", vFpp, 0},
{"FTC_Manager_Reset", vFp, 0},
{"FTC_Node_Unref", vFpp, 0},
{"FTC_SBitCache_Lookup", iFppupp, 0},
{"FTC_SBitCache_LookupScaler", iFppLupp, 0},
{"FTC_SBitCache_New", iFpp, 0},




{"FT_Set_MM_WeightVector", iFpUp, 0},
{"FT_Get_MM_WeightVector", iFppp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t freetypemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1
...
{"FT_New_Library", iFEpp, 0},


{"FT_Open_Face", iFEpplp, 0},




{"FT_Outline_Decompose", iFEppp, 0},
...
static const map_onesymbol_t freetypestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1
...
static const map_onesymbol2_t freetypesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1
...
static const map_onedata_t freetypedatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1
...
static const map_onedata_t freetypemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfreetypeundefs.h" 1
...
int wrappedfreetype_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(freetypeName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(freetypesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (freetypesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, freetypesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = freetypesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, freetypesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = freetypesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(freetypesymbolmap[i].name, '@')) AddDictionnary(box86->versym, freetypesymbolmap[i].name); }
 cnt = sizeof(freetypemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (freetypemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, freetypemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = freetypemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, freetypemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = freetypemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(freetypemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, freetypemysymbolmap[i].name); }

    cnt = sizeof(freetypestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, freetypestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = freetypestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(freetypestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, freetypestsymbolmap[i].name);
    }
    cnt = sizeof(freetypesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, freetypesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = freetypesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = freetypesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = freetypesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(freetypesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, freetypesymbol2map[i].name);
    }
    cnt = sizeof(freetypedatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(freetypedatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, freetypedatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = freetypedatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, freetypedatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = freetypedatamap[i].sz;
        }
    }
    cnt = sizeof(freetypemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, freetypemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = freetypemydatamap[i].sz;
    }
...
void wrappedfreetype_fini(library_t* lib)
{
...
# 517 "/home/ssd/pico/code/box86/src/wrapped/wrappedfreetype.c" 2
