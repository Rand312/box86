# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
...
int wrappedgomp_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gompName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gompsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gompsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gompsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gompsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gompsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gompsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gompsymbolmap[i].name, '@')) AddDictionnary(box86->versym, gompsymbolmap[i].name); }
 cnt = sizeof(gompmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gompmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gompmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gompmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gompmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gompmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gompmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gompmysymbolmap[i].name); }

    cnt = sizeof(gompstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gompstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gompstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gompstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gompstsymbolmap[i].name);
    }
    cnt = sizeof(gompsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gompsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gompsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gompsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gompsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gompsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gompsymbol2map[i].name);
    }
    cnt = sizeof(gompdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gompdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gompdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gompdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gompdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gompdatamap[i].sz;
        }
    }
    cnt = sizeof(gompmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gompmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gompmydatamap[i].sz;
    }
...
void wrappedgomp_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedgomp.c" 2
