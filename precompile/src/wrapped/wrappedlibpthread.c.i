# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
...
__attribute__((visibility("default"))) int my_pthread_setname_np(x86emu_t* emu, void* t, void* n)
{
    (void)emu;
    static void* f = 
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 3 4
                    ((void *)0)
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
                        ;
...
__attribute__((visibility("default"))) int my_pthread_getname_np(x86emu_t* emu, void* t, void* n, uint32_t s)
{
    (void)emu;
    static void* f = 
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 3 4
                    ((void *)0)
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
                        ;
    static int need_load = 1;
    if(need_load) {
        library_t* lib = GetLibInternal(libpthreadName);
...
__attribute__((visibility("default"))) int my_pthread_attr_setschedparam(x86emu_t* emu, void* attr, void* param)
{
    (void)emu;
    int policy;
    ...
    do {if((1)<=box86_log) {fprintf(ftrace, "Warning, call to pthread_attr_setschedparam(%p, %p[%d]) ignored\n", attr, param, param?(*(int*)param):-1); fflush(ftrace);}} while(0);
    return 0;
}

__attribute__((visibility("default"))) int my_pthread_rwlock_wrlock(pthread_rwlock_t *rwlock)
{
    return pthread_rwlock_wrlock(rwlock);
}
__attribute__((visibility("default"))) int my_pthread_rwlock_rdlock(pthread_rwlock_t* rwlock)
{
    return pthread_rwlock_rdlock(rwlock);
}
__attribute__((visibility("default"))) int my_pthread_rwlock_unlock(pthread_rwlock_t *rwlock)
{
    return pthread_rwlock_unlock(rwlock);
}

__attribute__((visibility("default"))) int32_t my_pthread_atfork(x86emu_t *emu, void* prepare, void* parent, void* child)
{
    (void)emu;
    ...
    my_context->atforks[i].handle = 
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 3 4
                                   ((void *)0)
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
                                       ;

    return 0;
}
__attribute__((visibility("default"))) int32_t my___pthread_atfork(x86emu_t *emu, void* prepare, void* parent, void* child) __attribute__((alias("my_pthread_atfork")));

__attribute__((visibility("default"))) void my___pthread_initialize()
{

}

void Timespec2Timespec64(void* dest, const void* source);
__attribute__((visibility("default"))) int my_sem_timedwait(sem_t* sem, struct timespec * t)
{
# 149 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpthreaddefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libpthreadsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h" 1
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"




{"pthread_attr_getdetachstate", iFpp, 0},
{"pthread_attr_getguardsize", iFpp, 0},
{"pthread_attr_getinheritsched", iFpp, 0},
{"pthread_attr_getschedparam", iFpp, 0},
{"pthread_attr_getschedpolicy", iFpp, 0},
{"pthread_attr_getscope", iFpp, 0},

{"pthread_attr_getstackaddr", iFpp, 0},
{"pthread_attr_getstacksize", iFpp, 0},
{"pthread_attr_init", iFp, 0},

{"pthread_attr_setdetachstate", iFpi, 0},
{"pthread_attr_setguardsize", iFpL, 0},
{"pthread_attr_setinheritsched", iFpi, 0},

{"pthread_attr_setschedparam", iFpp, 0},



{"pthread_attr_setschedpolicy", iFpi, 0},

{"pthread_attr_setscope", iFpi, 0},




{"pthread_attr_setstackaddr", iFpp, 0},
{"pthread_attr_setstacksize", iFpL, 0},
{"pthread_barrierattr_destroy", iFp, 0},
{"pthread_barrierattr_getpshared", iFpp, 0},
{"pthread_barrierattr_init", iFp, 0},
{"pthread_barrierattr_setpshared", iFpi, 0},
{"pthread_barrier_destroy", iFp, 0},
{"pthread_barrier_init", iFppu, 0},
{"pthread_barrier_wait", iFp, 0},
{"pthread_cancel", iFi, 0},





{"pthread_condattr_destroy", iFp, 0},
{"pthread_condattr_getclock", iFpp, 0},
{"pthread_condattr_getpshared", iFpp, 0},
{"pthread_condattr_init", iFp, 0},
{"pthread_condattr_setclock", iFpp, 0},
{"pthread_condattr_setpshared", iFpi, 0},
...
{"pthread_cond_broadcast", iFp, 0},
{"pthread_cond_destroy", iFp, 0},
{"pthread_cond_init", iFpp, 0},
{"pthread_cond_signal", iFp, 0},



{"pthread_detach", iFu, 0},
{"pthread_equal", iFuu, 0},
{"pthread_exit", vFp, 0},

{"pthread_getattr_np", iFup, 0},
{"pthread_getconcurrency", iFv, 0},
{"pthread_getcpuclockid", iFup, 0},
{"pthread_getschedparam", iFupp, 0},
{"__pthread_getspecific", pFu, 0},
{"pthread_getspecific", pFu, 0},
...
{"__pthread_mutexattr_destroy", iFp, 0},
{"pthread_mutexattr_destroy", iFp, 0},
{"pthread_mutexattr_getprioceiling", iFpp, 0},
{"pthread_mutexattr_getprotocol", iFpp, 0},


{"pthread_mutexattr_gettype", iFpp, 0},
{"__pthread_mutexattr_init", iFp, 0},
{"pthread_mutexattr_init", iFp, 0},
{"pthread_mutexattr_setprioceiling", iFpi, 0},
{"pthread_mutexattr_setprotocol", iFpp, 0},
{"pthread_mutexattr_setpshared", iFpi, 0},

{"__pthread_mutexattr_settype", iFpi, 0},
{"pthread_mutexattr_settype", iFpi, 0},


{"__pthread_mutex_destroy", iFp, 0},
{"pthread_mutex_destroy", iFp, 0},

{"__pthread_mutex_init", iFpp, 0},
{"pthread_mutex_init", iFpp, 0},
{"__pthread_mutex_lock", iFp, 0},
{"pthread_mutex_lock", iFp, 0},

{"pthread_mutex_timedlock", iFpp, 0},
{"__pthread_mutex_trylock", iFp, 0},
{"pthread_mutex_trylock", iFp, 0},
{"__pthread_mutex_unlock", iFp, 0},
{"pthread_mutex_unlock", iFp, 0},
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"




{"pthread_rwlockattr_destroy", vFp, 0},
{"pthread_rwlockattr_getkind_np", iFpp, 0},

{"pthread_rwlockattr_init", iFp, 0},
{"pthread_rwlockattr_setkind_np", iFpi, 0},


{"pthread_rwlock_destroy", iFp, 0},
{"__pthread_rwlock_init", iFpp, 0},
{"pthread_rwlock_init", iFpp, 0},
{"__pthread_rwlock_rdlock", iFp, 0},




{"pthread_rwlock_tryrdlock", iFp, 0},

{"pthread_rwlock_trywrlock", iFp, 0},
{"__pthread_rwlock_unlock", iFp, 0},

{"__pthread_rwlock_wrlock", iFp, 0},

{"pthread_self", uFv, 0},

{"pthread_setcancelstate", iFip, 0},
{"pthread_setcanceltype", iFip, 0},
{"pthread_setconcurrency", iFi, 0},

{"pthread_setschedparam", iFuip, 0},
{"pthread_setschedprio", iFpi, 0},
{"__pthread_setspecific", iFup, 0},
{"pthread_setspecific", iFup, 0},
{"pthread_sigmask", iFipp, 0},
{"pthread_spin_destroy", iFp, 0},
{"pthread_spin_init", iFpi, 0},
{"pthread_spin_lock", iFp, 0},
{"pthread_spin_trylock", iFp, 0},
{"pthread_spin_unlock", iFp, 0},
{"pthread_testcancel", vFv, 0},
{"pthread_timedjoin_np", iFppp, 0},
{"pthread_tryjoin_np", iFpp, 0},
...
static const map_onesymbol_t libpthreadmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h" 1
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"
{"pthread_atfork", iFEppp, 0},
{"__pthread_atfork", iFEppp, 0},
{"pthread_attr_destroy", iFEp, 0},
...
{"pthread_attr_getstack", iFEppp, 0},



{"pthread_attr_setaffinity_np", iFEpup, 0},
...
{"pthread_attr_setstack", iFEppL, 0},
...
{"_pthread_cleanup_pop", vFEpi, 0},
{"_pthread_cleanup_pop_restore", vFEpi, 0},
{"_pthread_cleanup_push", vFEppp, 0},
{"_pthread_cleanup_push_defer", vFEppp, 0},
...
{"pthread_cond_timedwait", iFEppp, 0},
{"pthread_cond_wait", iFEpp, 0},
{"pthread_create", iFEpppp, 0},



{"pthread_getaffinity_np", iFEpup, 0},
...
{"pthread_getname_np", iFEppu, 0},
{"__pthread_initialize", vFv, 0},

{"pthread_join", iFEup, 0},
{"__pthread_key_create", iFEpp, 0},
{"pthread_key_create", iFEpp, 0},
{"pthread_key_delete", iFEu, 0},

{"pthread_kill", iFEpi, 0},
...
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"
{"pthread_once", iFEpp, 0},
{"__pthread_once", iFEpp, 0},
{"__pthread_register_cancel", vFEp, 0},
...
{"pthread_rwlock_unlock", iFp, 0},

{"pthread_rwlock_wrlock", iFp, 0},

{"pthread_setaffinity_np", iFELup, 0},



{"pthread_setname_np", iFEpp, 0},
...
{"__pthread_unregister_cancel", vFEp, 0},


{"__pthread_unwind_next", vFEp, 0},
...
static const map_onesymbol2_t libpthreadsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h" 1
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"
...
{"pthread_cond_broadcast@GLIBC_2.0", iFEp, 0, "my_pthread_cond_broadcast_old"},
{"pthread_cond_destroy@GLIBC_2.0", iFEp, 0, "my_pthread_cond_destroy_old"},
{"pthread_cond_init@GLIBC_2.0", iFEpp, 0, "my_pthread_cond_init_old"},
{"pthread_cond_signal@GLIBC_2.0", iFEp, 0, "my_pthread_cond_signal_old"},
{"pthread_cond_timedwait@GLIBC_2.0", iFEppp, 0, "my_pthread_cond_timedwait_old"},
{"pthread_cond_wait@GLIBC_2.0", iFEpp, 0, "my_pthread_cond_wait_old"},
...
{"pthread_kill@GLIBC_2.0", iFEpi, 0, "my_pthread_kill_old"},
...
static const map_onedata_t libpthreaddatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h" 1
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"
...
static const map_onedata_t libpthreadmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h" 1
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpthreadundefs.h" 1
...
int wrappedlibpthread_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libpthreadName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libpthreadName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libpthreadsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpthreadsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libpthreadsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libpthreadsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libpthreadsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libpthreadsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libpthreadsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpthreadsymbolmap[i].name); }
 cnt = sizeof(libpthreadmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpthreadmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libpthreadmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libpthreadmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libpthreadmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libpthreadmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libpthreadmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpthreadmysymbolmap[i].name); }

    cnt = sizeof(libpthreadstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libpthreadstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libpthreadstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libpthreadstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libpthreadstsymbolmap[i].name);
    }
    cnt = sizeof(libpthreadsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libpthreadsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libpthreadsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libpthreadsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libpthreadsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libpthreadsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libpthreadsymbol2map[i].name);
    }
    cnt = sizeof(libpthreaddatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libpthreaddatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libpthreaddatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libpthreaddatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libpthreaddatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libpthreaddatamap[i].sz;
        }
    }
    cnt = sizeof(libpthreadmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libpthreadmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libpthreadmydatamap[i].sz;
    }
...
# 169 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpthread.c" 2
