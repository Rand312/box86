# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedalutdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t alutsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1




{"alutInit", cFpp, 0},
{"alutInitWithoutContext", cFpp, 0},
{"alutExit", cFv, 0},
{"alutGetError", iFv, 0},
{"alutGetErrorString", pFi, 0},
{"alutCreateBufferFromFile", uFp, 0},
{"alutCreateBufferFromFileImage", uFpi, 0},
{"alutCreateBufferHelloWorld", uFv, 0},
{"alutCreateBufferWaveform", uFifff, 0},
{"alutLoadMemoryFromFile", pFpppp, 0},
{"alutLoadMemoryFromFileImage", pFpippp, 0},
{"alutLoadMemoryHelloWorld", pFppp, 0},
{"alutLoadMemoryWaveform", pFifffppp, 0},
{"alutGetMIMETypes", pFi, 0},
{"alutGetMajorVersion", iFv, 0},
{"alutGetMinorVersion", iFv, 0},
{"alutSleep", cFf, 0},
{"alutLoadWAVFile", vFpppppp, 0},
{"alutLoadWAVMemory", vFpppppp, 0},
{"alutUnloadWAV", vFipii, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t alutmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1
...
static const map_onesymbol_t alutstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1
...
static const map_onesymbol2_t alutsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1
...
static const map_onedata_t alutdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1
...
static const map_onedata_t alutmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedalutundefs.h" 1
...
int wrappedalut_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(alutName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(alutsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (alutsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, alutsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = alutsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, alutsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = alutsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(alutsymbolmap[i].name, '@')) AddDictionnary(box86->versym, alutsymbolmap[i].name); }
 cnt = sizeof(alutmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (alutmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, alutmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = alutmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, alutmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = alutmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(alutmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, alutmysymbolmap[i].name); }

    cnt = sizeof(alutstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, alutstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = alutstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(alutstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, alutstsymbolmap[i].name);
    }
    cnt = sizeof(alutsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, alutsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = alutsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = alutsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = alutsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(alutsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, alutsymbol2map[i].name);
    }
    cnt = sizeof(alutdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(alutdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, alutdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = alutdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, alutdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = alutdatamap[i].sz;
        }
    }
    cnt = sizeof(alutmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, alutmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = alutmydatamap[i].sz;
    }
...
void wrappedalut_fini(library_t* lib)
{
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedalut.c" 2
