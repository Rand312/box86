# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibnmtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibnmtypes.h"
...
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
...
typedef struct libnm_my_s {


    vFpppp_t nm_device_disconnect_async; vFpppp_t nm_device_wifi_request_scan_async; vFpppp_t nm_remote_connection_delete_async; vFpippp_t nm_remote_connection_commit_changes_async; vFppppp_t nm_remote_connection_get_secrets_async; vFppippp_t nm_client_add_connection_async; vFppppppp_t nm_client_activate_connection_async; vFppppppp_t nm_client_add_and_activate_connection_async;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libnm_my_t my_libnm = {0};
static libnm_my_t * const my = &my_libnm;

static void getMy(library_t* lib)
{

    my->nm_device_disconnect_async = (vFpppp_t)dlsym(lib->w.lib, "nm_device_disconnect_async"); my->nm_device_wifi_request_scan_async = (vFpppp_t)dlsym(lib->w.lib, "nm_device_wifi_request_scan_async"); my->nm_remote_connection_delete_async = (vFpppp_t)dlsym(lib->w.lib, "nm_remote_connection_delete_async"); my->nm_remote_connection_commit_changes_async = (vFpippp_t)dlsym(lib->w.lib, "nm_remote_connection_commit_changes_async"); my->nm_remote_connection_get_secrets_async = (vFppppp_t)dlsym(lib->w.lib, "nm_remote_connection_get_secrets_async"); my->nm_client_add_connection_async = (vFppippp_t)dlsym(lib->w.lib, "nm_client_add_connection_async"); my->nm_client_activate_connection_async = (vFppppppp_t)dlsym(lib->w.lib, "nm_client_activate_connection_async"); my->nm_client_add_and_activate_connection_async = (vFppppppp_t)dlsym(lib->w.lib, "nm_client_add_and_activate_connection_async");
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
# 40 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
static uintptr_t my_GAsyncReadyCallback_fct_0 = 0; static void my_GAsyncReadyCallback_0(void* a, void* b, void* c) { RunFunctionFmt(my_GAsyncReadyCallback_fct_0, "ppp", a, b, c); } static uintptr_t my_GAsyncReadyCallback_fct_1 = 0; static void my_GAsyncReadyCallback_1(void* a, void* b, void* c) { RunFunctionFmt(my_GAsyncReadyCallback_fct_1, "ppp", a, b, c); } static uintptr_t my_GAsyncReadyCallback_fct_2 = 0; static void my_GAsyncReadyCallback_2(void* a, void* b, void* c) { RunFunctionFmt(my_GAsyncReadyCallback_fct_2, "ppp", a, b, c); } static uintptr_t my_GAsyncReadyCallback_fct_3 = 0; static void my_GAsyncReadyCallback_3(void* a, void* b, void* c) { RunFunctionFmt(my_GAsyncReadyCallback_fct_3, "ppp", a, b, c); } static uintptr_t my_GAsyncReadyCallback_fct_4 = 0; static void my_GAsyncReadyCallback_4(void* a, void* b, void* c) { RunFunctionFmt(my_GAsyncReadyCallback_fct_4, "ppp", a, b, c); }

static void* findGAsyncReadyCallbackFct(void* fct)
{
    if(!fct) return 
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 3 4
                   ((void *)0)
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_GAsyncReadyCallback_fct_0 == (uintptr_t)fct) return my_GAsyncReadyCallback_0; if(my_GAsyncReadyCallback_fct_1 == (uintptr_t)fct) return my_GAsyncReadyCallback_1; if(my_GAsyncReadyCallback_fct_2 == (uintptr_t)fct) return my_GAsyncReadyCallback_2; if(my_GAsyncReadyCallback_fct_3 == (uintptr_t)fct) return my_GAsyncReadyCallback_3; if(my_GAsyncReadyCallback_fct_4 == (uintptr_t)fct) return my_GAsyncReadyCallback_4;


    if(my_GAsyncReadyCallback_fct_0 == 0) {my_GAsyncReadyCallback_fct_0 = (uintptr_t)fct; return my_GAsyncReadyCallback_0; } if(my_GAsyncReadyCallback_fct_1 == 0) {my_GAsyncReadyCallback_fct_1 = (uintptr_t)fct; return my_GAsyncReadyCallback_1; } if(my_GAsyncReadyCallback_fct_2 == 0) {my_GAsyncReadyCallback_fct_2 = (uintptr_t)fct; return my_GAsyncReadyCallback_2; } if(my_GAsyncReadyCallback_fct_3 == 0) {my_GAsyncReadyCallback_fct_3 = (uintptr_t)fct; return my_GAsyncReadyCallback_3; } if(my_GAsyncReadyCallback_fct_4 == 0) {my_GAsyncReadyCallback_fct_4 = (uintptr_t)fct; return my_GAsyncReadyCallback_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libnm GAsyncReadyCallback callback\n"); fflush(ftrace);}} while(0);
    return 
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 3 4
          ((void *)0)
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
              ;
}



__attribute__((visibility("default"))) void my_nm_remote_connection_commit_changes_async(x86emu_t* emu, void* connection, int save, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_remote_connection_commit_changes_async(connection, save, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_remote_connection_get_secrets_async(x86emu_t* emu, void* connection, void* name, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_remote_connection_get_secrets_async(connection, name, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_remote_connection_delete_async(x86emu_t* emu, void* connection, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_remote_connection_delete_async(connection, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_client_add_and_activate_connection_async(x86emu_t* emu, void* client, void* partial, void* device, void* spec, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_client_add_and_activate_connection_async(client, partial, device, spec, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_device_disconnect_async(x86emu_t* emu, void* device, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_device_disconnect_async(device, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_device_wifi_request_scan_async(x86emu_t* emu, void* device, void* cancellable, void* cb, void* data)
{
    (void)emu;
    my->nm_device_wifi_request_scan_async(device, cancellable, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_client_add_connection_async(x86emu_t* emu, void* client, void* connection, int save, void* cancel, void* cb, void* data)
{
    (void)emu;
    my->nm_client_add_connection_async(client, connection, save, cancel, findGAsyncReadyCallbackFct(cb), data);
}

__attribute__((visibility("default"))) void my_nm_client_activate_connection_async(x86emu_t* emu, void* client, void* connection, void* device, void* obj, void* cancel, void* cb, void* data)
{
    (void)emu;
    my->nm_client_activate_connection_async(client, connection, device, obj, cancel, findGAsyncReadyCallbackFct(cb), data);
}
# 117 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibnmdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libnmsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h" 1




{"nm_802_11_ap_flags_get_type", iFv, 0},
{"nm_802_11_ap_security_flags_get_type", iFv, 0},
{"nm_802_11_mode_get_type", iFv, 0},
{"nm_access_point_connection_valid", iFp, 0},
{"nm_access_point_filter_connections", pFpp, 0},
{"nm_access_point_get_bssid", pFp, 0},
{"nm_access_point_get_flags", iFp, 0},
{"nm_access_point_get_frequency", uFp, 0},
{"nm_access_point_get_last_seen", iFp, 0},
{"nm_access_point_get_max_bitrate", uFp, 0},
{"nm_access_point_get_mode", iFp, 0},
{"nm_access_point_get_rsn_flags", iFp, 0},
{"nm_access_point_get_ssid", pFp, 0},
{"nm_access_point_get_strength", CFp, 0},
{"nm_access_point_get_type", iFv, 0},
{"nm_access_point_get_wpa_flags", iFp, 0},
{"nm_activation_state_flags_get_type", iFv, 0},


{"nm_active_connection_get_default", iFp, 0},
{"nm_active_connection_get_default6", iFp, 0},
# 34 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_active_connection_get_state", iFp, 0},
{"nm_active_connection_get_state_flags", iFp, 0},
{"nm_active_connection_get_state_reason", iFp, 0},
{"nm_active_connection_get_type", pFv, 0},
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_checkpoint_get_type", iFv, 0},

{"nm_client_activate_connection_finish", pFppp, 0},

{"nm_client_add_and_activate_connection_finish", pFppp, 0},

{"nm_client_add_connection_finish", iFppp, 0},
{"nm_client_check_connectivity", iFppp, 0},



{"nm_client_checkpoint_adjust_rollback_timeout_finish", iFppp, 0},

{"nm_client_checkpoint_create_finish", pFppp, 0},

{"nm_client_checkpoint_destroy_finish", iFppp, 0},

{"nm_client_checkpoint_rollback_finish", pFppp, 0},
{"nm_client_connectivity_check_get_available", iFp, 0},
{"nm_client_connectivity_check_get_enabled", iFp, 0},
{"nm_client_connectivity_check_set_enabled", vFpi, 0},
{"nm_client_deactivate_connection", iFpppp, 0},

{"nm_client_deactivate_connection_finish", iFppp, 0},
{"nm_client_error_get_type", iFv, 0},
{"nm_client_error_quark", uFv, 0},
{"nm_client_get_activating_connection", pFp, 0},
{"nm_client_get_active_connections", pFp, 0},
{"nm_client_get_all_devices", pFp, 0},
{"nm_client_get_checkpoints", pFp, 0},
{"nm_client_get_connection_by_id", pFpp, 0},
{"nm_client_get_connection_by_path", pFpp, 0},
{"nm_client_get_connection_by_uuid", pFpp, 0},
{"nm_client_get_connections", pFp, 0},
{"nm_client_get_connectivity", iFp, 0},
{"nm_client_get_device_by_iface", pFpp, 0},
{"nm_client_get_device_by_path", pFpp, 0},
{"nm_client_get_devices", pFp, 0},
{"nm_client_get_dns_configuration", pFp, 0},
{"nm_client_get_dns_mode", pFp, 0},
{"nm_client_get_dns_rc_manager", pFp, 0},
{"nm_client_get_logging", iFpppp, 0},
{"nm_client_get_nm_running", iFp, 0},
{"nm_client_get_permission_result", iFpi, 0},
{"nm_client_get_primary_connection", pFp, 0},
{"nm_client_get_startup", iFp, 0},
{"nm_client_get_state", iFp, 0},
{"nm_client_get_type", iFv, 0},
{"nm_client_get_version", pFp, 0},
{"nm_client_load_connections", iFppppp, 0},

{"nm_client_load_connections_finish", iFpppp, 0},
{"nm_client_networking_get_enabled", iFp, 0},
{"nm_client_networking_set_enabled", iFpip, 0},
{"nm_client_new", pFpp, 0},

{"nm_client_new_finish", pFpp, 0},
{"nm_client_permission_get_type", iFv, 0},
{"nm_client_permission_result_get_type", iFv, 0},
{"nm_client_reload_connections", iFppp, 0},

{"nm_client_reload_connections_finish", iFppp, 0},
{"nm_client_save_hostname", iFpppp, 0},

{"nm_client_save_hostname_finish", iFppp, 0},
{"nm_client_set_logging", iFpppp, 0},
{"nm_client_wimax_get_enabled", iFp, 0},
{"nm_client_wimax_hardware_get_enabled", iFp, 0},
{"nm_client_wimax_set_enabled", vFpi, 0},
{"nm_client_wireless_get_enabled", iFp, 0},
{"nm_client_wireless_hardware_get_enabled", iFp, 0},
{"nm_client_wireless_set_enabled", vFpi, 0},
{"nm_client_wwan_get_enabled", iFp, 0},
{"nm_client_wwan_hardware_get_enabled", iFp, 0},
{"nm_client_wwan_set_enabled", vFpi, 0},
{"nm_connection_add_setting", vFpp, 0},
{"nm_connection_clear_secrets", vFp, 0},

{"nm_connection_clear_settings", vFp, 0},
{"nm_connection_compare", iFppi, 0},
{"nm_connection_diff", iFppip, 0},
{"nm_connection_dump", vFp, 0},



{"nm_connection_get_connection_type", pFp, 0},
{"nm_connection_get_id", pFp, 0},
{"nm_connection_get_interface_name", pFp, 0},
{"nm_connection_get_path", pFp, 0},
{"nm_connection_get_setting", pFpi, 0},
{"nm_connection_get_setting_802_1x", pFp, 0},
{"nm_connection_get_setting_adsl", pFp, 0},
{"nm_connection_get_setting_bluetooth", pFp, 0},
{"nm_connection_get_setting_bond", pFp, 0},
{"nm_connection_get_setting_bridge", pFp, 0},
{"nm_connection_get_setting_bridge_port", pFp, 0},
{"nm_connection_get_setting_by_name", pFpp, 0},
{"nm_connection_get_setting_cdma", pFp, 0},
{"nm_connection_get_setting_connection", pFp, 0},
{"nm_connection_get_setting_dcb", pFp, 0},
{"nm_connection_get_setting_dummy", pFp, 0},
{"nm_connection_get_setting_generic", pFp, 0},
{"nm_connection_get_setting_gsm", pFp, 0},
{"nm_connection_get_setting_infiniband", pFp, 0},
{"nm_connection_get_setting_ip4_config", pFp, 0},
{"nm_connection_get_setting_ip6_config", pFp, 0},
{"nm_connection_get_setting_ip_tunnel", pFp, 0},
{"nm_connection_get_setting_macsec", pFp, 0},
{"nm_connection_get_setting_macvlan", pFp, 0},
{"nm_connection_get_setting_olpc_mesh", pFp, 0},
{"nm_connection_get_setting_ovs_bridge", pFp, 0},
{"nm_connection_get_setting_ovs_interface", pFp, 0},
{"nm_connection_get_setting_ovs_patch", pFp, 0},
{"nm_connection_get_setting_ovs_port", pFp, 0},
{"nm_connection_get_setting_ppp", pFp, 0},
{"nm_connection_get_setting_pppoe", pFp, 0},
{"nm_connection_get_setting_proxy", pFp, 0},
{"nm_connection_get_settings", pFpp, 0},
{"nm_connection_get_setting_serial", pFp, 0},
{"nm_connection_get_setting_tc_config", pFp, 0},
{"nm_connection_get_setting_team", pFp, 0},
{"nm_connection_get_setting_team_port", pFp, 0},
{"nm_connection_get_setting_tun", pFp, 0},
{"nm_connection_get_setting_vlan", pFp, 0},
{"nm_connection_get_setting_vpn", pFp, 0},
{"nm_connection_get_setting_vxlan", pFp, 0},
{"nm_connection_get_setting_wimax", pFp, 0},
{"nm_connection_get_setting_wired", pFp, 0},
{"nm_connection_get_setting_wireless", pFp, 0},
{"nm_connection_get_setting_wireless_security", pFp, 0},
{"nm_connection_get_type", iFv, 0},
{"nm_connection_get_uuid", pFp, 0},
{"nm_connection_get_virtual_device_description", pFp, 0},
{"nm_connection_is_type", iFpp, 0},
{"nm_connection_is_virtual", iFp, 0},
{"nm_connection_multi_connect_get_type", iFv, 0},
{"nm_connection_need_secrets", pFpp, 0},
{"nm_connection_normalize", iFpppp, 0},
{"nm_connection_remove_setting", vFpi, 0},
{"nm_connection_replace_settings", iFppp, 0},
{"nm_connection_replace_settings_from_connection", vFpp, 0},
{"nm_connection_serialization_flags_get_type", iFv, 0},
{"nm_connection_set_path", vFpp, 0},
{"nm_connection_to_dbus", pFpi, 0},
{"nm_connection_update_secrets", iFpppp, 0},
{"nm_connection_verify", iFpp, 0},
{"nm_connection_verify_secrets", iFpp, 0},
{"nm_connectivity_state_get_type", iFv, 0},
{"nm_crypto_error_get_type", iFv, 0},

{"nm_device_6lowpan_get_type", iFv, 0},

{"nm_device_adsl_get_type", iFv, 0},



{"nm_device_bond_get_type", iFv, 0},



{"nm_device_bridge_get_type", iFv, 0},



{"nm_device_bt_get_type", iFv, 0},
{"nm_device_capabilities_get_type", iFv, 0},
{"nm_device_connection_compatible", iFppp, 0},
{"nm_device_connection_valid", iFpp, 0},
{"nm_device_delete", iFppp, 0},

{"nm_device_delete_finish", iFppp, 0},
{"nm_device_disambiguate_names", pFpi, 0},
{"nm_device_disconnect", iFppp, 0},

{"nm_device_disconnect_finish", iFppp, 0},




{"nm_device_ethernet_get_carrier", iFp, 0},

{"nm_device_ethernet_get_permanent_hw_address", pFp, 0},

{"nm_device_ethernet_get_speed", uFp, 0},
{"nm_device_ethernet_get_type", pFv, 0},
{"nm_device_filter_connections", pFpp, 0},

{"nm_device_generic_get_type", iFv, 0},
{"nm_device_get_active_connection", pFp, 0},
{"nm_device_get_applied_connection", pFpuppp, 0},

{"nm_device_get_applied_connection_finish", pFpppp, 0},
{"nm_device_get_autoconnect", iFp, 0},
{"nm_device_get_available_connections", pFp, 0},
{"nm_device_get_capabilities", iFp, 0},
{"nm_device_get_description", pFp, 0},
{"nm_device_get_device_type", iFp, 0},
{"nm_device_get_dhcp4_config", pFp, 0},
{"nm_device_get_dhcp6_config", pFp, 0},
{"nm_device_get_driver", pFp, 0},
{"nm_device_get_driver_version", pFp, 0},
{"nm_device_get_firmware_missing", iFp, 0},
{"nm_device_get_firmware_version", pFp, 0},
{"nm_device_get_hw_address", pFp, 0},
{"nm_device_get_iface", pFp, 0},
{"nm_device_get_ip4_config", pFp, 0},
{"nm_device_get_ip6_config", pFp, 0},
{"nm_device_get_ip_iface", pFp, 0},
{"nm_device_get_lldp_neighbors", pFp, 0},
{"nm_device_get_managed", iFp, 0},
{"nm_device_get_metered", iFp, 0},
{"nm_device_get_mtu", uFp, 0},
{"nm_device_get_nm_plugin_missing", iFp, 0},
{"nm_device_get_physical_port_id", pFp, 0},
{"nm_device_get_product", pFp, 0},
{"nm_device_get_setting_type", iFp, 0},
{"nm_device_get_state", iFp, 0},
{"nm_device_get_state_reason", iFp, 0},
{"nm_device_get_type", iFv, 0},
{"nm_device_get_type_description", pFp, 0},
{"nm_device_get_udi", pFp, 0},
{"nm_device_get_vendor", pFp, 0},
# 288 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_device_is_real", iFp, 0},
{"nm_device_is_software", iFp, 0},
# 323 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_device_ppp_get_type", iFv, 0},
{"nm_device_reapply", iFppUupp, 0},

{"nm_device_reapply_finish", iFppp, 0},
{"nm_device_set_autoconnect", vFpi, 0},
{"nm_device_set_managed", vFpi, 0},
{"nm_device_state_get_type", iFv, 0},
{"nm_device_state_reason_get_type", iFv, 0},
# 368 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_device_wifi_get_access_point_by_path", pFpp, 0},
{"nm_device_wifi_get_access_points", pFp, 0},
{"nm_device_wifi_get_active_access_point", pFp, 0},
{"nm_device_wifi_get_bitrate", uFp, 0},
{"nm_device_wifi_get_capabilities", iFp, 0},
{"nm_device_wifi_get_hw_address", pFp, 0},
{"nm_device_wifi_get_last_scan", IFp, 0},
{"nm_device_wifi_get_mode", iFp, 0},
{"nm_device_wifi_get_permanent_hw_address", pFp, 0},
{"nm_device_wifi_get_type", iFv, 0},
{"nm_device_wifi_request_scan", iFppp, 0},

{"nm_device_wifi_request_scan_finish", iFppp, 0},
{"nm_device_wifi_request_scan_options", iFpppp, 0},
# 401 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_dhcp_config_get_type", iFv, 0},
{"nm_dns_entry_get_domains", pFp, 0},
{"nm_dns_entry_get_interface", pFp, 0},
{"nm_dns_entry_get_nameservers", pFp, 0},
{"nm_dns_entry_get_priority", iFp, 0},
{"nm_dns_entry_get_type", iFv, 0},
{"nm_dns_entry_get_vpn", iFp, 0},
{"nm_dns_entry_unref", vFp, 0},

{"nm_ip_address_get_address", pFp, 0},
{"nm_ip_address_get_address_binary", vFpp, 0},



{"nm_ip_address_get_prefix", uFp, 0},

{"nm_ip_address_new", pFipup, 0},

{"nm_ip_address_ref", vFp, 0},




{"nm_ip_address_unref", vFp, 0},
{"nm_ip_config_get_addresses", pFp, 0},


{"nm_ip_config_get_gateway", pFp, 0},
{"nm_ip_config_get_nameservers", pFp, 0},
# 461 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_lldp_neighbor_get_attr_names", pFp, 0},
{"nm_lldp_neighbor_get_attr_string_value", iFppp, 0},
{"nm_lldp_neighbor_get_attr_type", pFpp, 0},
{"nm_lldp_neighbor_get_attr_uint_value", iFppp, 0},
{"nm_lldp_neighbor_get_type", iFv, 0},
{"nm_lldp_neighbor_new", pFv, 0},
{"nm_lldp_neighbor_ref", pFp, 0},
{"nm_lldp_neighbor_unref", vFp, 0},
{"nm_manager_error_get_type", iFv, 0},
{"nm_manager_error_quark", uFv, 0},
{"nm_metered_get_type", iFv, 0},

{"nm_object_get_type", iFv, 0},
{"nm_remote_connection_commit_changes", iFpipp, 0},

{"nm_remote_connection_commit_changes_finish", iFppp, 0},


{"nm_remote_connection_delete_finish", iFppp, 0},




{"nm_remote_connection_get_secrets_finish", pFppp, 0},
{"nm_remote_connection_get_type", pFv, 0},
# 510 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_802_1x_add_eap_method", iFpp, 0},
# 587 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_802_1x_new", pFv, 0},
# 652 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_connection_get_autoconnect", iFp, 0},





{"nm_setting_connection_get_id", pFp, 0},
# 681 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_connection_new", pFv, 0},
# 727 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_get_type", pFv, 0},
# 754 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_ip4_config_new", pFv, 0},
...
{"nm_setting_ip6_config_new", pFv, 0},

{"nm_setting_ip_config_add_address", iFpp, 0},
{"nm_setting_ip_config_add_dns", iFpp, 0},
# 796 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_ip_config_get_type", pFv, 0},
# 1083 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_wired_new", pFv, 0},
# 1113 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_setting_wireless_new", pFv, 0},



{"nm_setting_wireless_security_add_group", iFpp, 0},
{"nm_setting_wireless_security_add_pairwise", iFpp, 0},
{"nm_setting_wireless_security_add_proto", iFpp, 0},
{"nm_setting_wireless_security_clear_groups", vFp, 0},
{"nm_setting_wireless_security_clear_pairwise", vFp, 0},
{"nm_setting_wireless_security_clear_protos", vFp, 0},
{"nm_setting_wireless_security_fils_get_type", iFv, 0},
{"nm_setting_wireless_security_get_auth_alg", pFp, 0},
{"nm_setting_wireless_security_get_fils", iFp, 0},
{"nm_setting_wireless_security_get_group", pFpu, 0},
{"nm_setting_wireless_security_get_key_mgmt", pFp, 0},
{"nm_setting_wireless_security_get_leap_password", pFp, 0},
{"nm_setting_wireless_security_get_leap_password_flags", iFp, 0},
{"nm_setting_wireless_security_get_leap_username", pFp, 0},
{"nm_setting_wireless_security_get_num_groups", uFp, 0},
{"nm_setting_wireless_security_get_num_pairwise", uFp, 0},
{"nm_setting_wireless_security_get_num_protos", uFp, 0},
{"nm_setting_wireless_security_get_pairwise", pFpu, 0},
{"nm_setting_wireless_security_get_pmf", iFp, 0},
{"nm_setting_wireless_security_get_proto", pFpu, 0},
{"nm_setting_wireless_security_get_psk", pFp, 0},
{"nm_setting_wireless_security_get_psk_flags", iFp, 0},
{"nm_setting_wireless_security_get_type", iFv, 0},
{"nm_setting_wireless_security_get_wep_key", pFpu, 0},
{"nm_setting_wireless_security_get_wep_key_flags", iFp, 0},
{"nm_setting_wireless_security_get_wep_key_type", iFp, 0},
{"nm_setting_wireless_security_get_wep_tx_keyidx", uFp, 0},
{"nm_setting_wireless_security_get_wps_method", iFp, 0},
{"nm_setting_wireless_security_new", pFv, 0},
{"nm_setting_wireless_security_pmf_get_type", iFv, 0},
{"nm_setting_wireless_security_remove_group", vFpu, 0},
{"nm_setting_wireless_security_remove_group_by_value", iFpp, 0},
{"nm_setting_wireless_security_remove_pairwise", vFpu, 0},
{"nm_setting_wireless_security_remove_pairwise_by_value", iFpp, 0},
{"nm_setting_wireless_security_remove_proto", vFpu, 0},
{"nm_setting_wireless_security_remove_proto_by_value", iFpp, 0},
{"nm_setting_wireless_security_set_wep_key", vFpup, 0},




{"nm_simple_connection_new", pFv, 0},
# 1278 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h"
{"nm_utils_security_valid", iFiiiiiii, 0},


{"nm_utils_ssid_to_utf8", pFpL, 0},
...
{"nm_client_activate_connection_async", vFEppppppp, 0},

{"nm_client_add_and_activate_connection_async", vFEppppppp, 0},

{"nm_client_add_connection_async", vFEppippp, 0},
...
{"nm_device_disconnect_async", vFEpppp, 0},
...
{"nm_device_wifi_request_scan_async", vFEpppp, 0},
...
{"nm_remote_connection_commit_changes_async", vFEpippp, 0},


{"nm_remote_connection_delete_async", vFEpppp, 0},




{"nm_remote_connection_get_secrets_async", vFEppppp, 0},
...
static const map_onesymbol_t libnmstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h" 1
...
static const map_onesymbol2_t libnmsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h" 1
...
static const map_onedata_t libnmdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h" 1
...
static const map_onedata_t libnmmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibnmundefs.h" 1
...
int wrappedlibnm_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libnmName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libnmsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libnmsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libnmsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libnmsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libnmsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libnmsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libnmsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libnmsymbolmap[i].name); }
 cnt = sizeof(libnmmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libnmmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libnmmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libnmmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libnmmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libnmmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libnmmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libnmmysymbolmap[i].name); }

    cnt = sizeof(libnmstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libnmstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libnmstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libnmstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libnmstsymbolmap[i].name);
    }
    cnt = sizeof(libnmsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libnmsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libnmsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libnmsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libnmsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libnmsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libnmsymbol2map[i].name);
    }
    cnt = sizeof(libnmdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libnmdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libnmdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libnmdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libnmdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libnmdatamap[i].sz;
        }
    }
    cnt = sizeof(libnmmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libnmmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libnmmydatamap[i].sz;
    }
...
void wrappedlibnm_fini(library_t* lib)
{
...
# 118 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibnm.c" 2
