# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2




    const char* pulsesimpleName = "libpulse-simple.so.0";
# 40 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpulsesimpledefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pulsesimplesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1




{"pa_simple_drain", iFpp, 0},
{"pa_simple_flush", iFpp, 0},
{"pa_simple_free", vFp, 0},
{"pa_simple_get_latency", UFpp, 0},
{"pa_simple_new", pFppipppppp, 0},
{"pa_simple_read", iFppLp, 0},
{"pa_simple_write", iFppLp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pulsesimplemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1
...
static const map_onesymbol_t pulsesimplestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1
...
static const map_onesymbol2_t pulsesimplesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1
...
static const map_onedata_t pulsesimpledatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1
...
static const map_onedata_t pulsesimplemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpulsesimpleundefs.h" 1
...
int wrappedpulsesimple_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(pulsesimpleName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(pulsesimpleName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(pulsesimplesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pulsesimplesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, pulsesimplesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = pulsesimplesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, pulsesimplesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = pulsesimplesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(pulsesimplesymbolmap[i].name, '@')) AddDictionnary(box86->versym, pulsesimplesymbolmap[i].name); }
 cnt = sizeof(pulsesimplemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pulsesimplemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, pulsesimplemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = pulsesimplemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, pulsesimplemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = pulsesimplemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(pulsesimplemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, pulsesimplemysymbolmap[i].name); }

    cnt = sizeof(pulsesimplestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, pulsesimplestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = pulsesimplestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(pulsesimplestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, pulsesimplestsymbolmap[i].name);
    }
    cnt = sizeof(pulsesimplesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, pulsesimplesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = pulsesimplesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = pulsesimplesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = pulsesimplesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(pulsesimplesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, pulsesimplesymbol2map[i].name);
    }
    cnt = sizeof(pulsesimpledatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(pulsesimpledatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, pulsesimpledatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = pulsesimpledatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, pulsesimpledatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = pulsesimpledatamap[i].sz;
        }
    }
    cnt = sizeof(pulsesimplemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, pulsesimplemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = pulsesimplemydatamap[i].sz;
    }
...
void wrappedpulsesimple_fini(library_t* lib)
{
...
# 41 "/home/ssd/pico/code/box86/src/wrapped/wrappedpulsesimple.c" 2
