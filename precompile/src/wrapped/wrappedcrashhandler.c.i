# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2



const char* crashhandlerName = "crashhandler.so";
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c"
...
int wrappedcrashhandler_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    if(!box86_steam) return -1; if(1) lib->w.lib = dlopen(
...
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(crashhandlerName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(crashhandlerName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(crashhandlersymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (crashhandlersymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, crashhandlersymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = crashhandlersymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, crashhandlersymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = crashhandlersymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(crashhandlersymbolmap[i].name, '@')) AddDictionnary(box86->versym, crashhandlersymbolmap[i].name); }
 cnt = sizeof(crashhandlermysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (crashhandlermysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, crashhandlermysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = crashhandlermysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, crashhandlermysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = crashhandlermysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(crashhandlermysymbolmap[i].name, '@')) AddDictionnary(box86->versym, crashhandlermysymbolmap[i].name); }

    cnt = sizeof(crashhandlerstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, crashhandlerstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = crashhandlerstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(crashhandlerstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, crashhandlerstsymbolmap[i].name);
    }
    cnt = sizeof(crashhandlersymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, crashhandlersymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = crashhandlersymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = crashhandlersymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = crashhandlersymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(crashhandlersymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, crashhandlersymbol2map[i].name);
    }
    cnt = sizeof(crashhandlerdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(crashhandlerdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, crashhandlerdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = crashhandlerdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, crashhandlerdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = crashhandlerdatamap[i].sz;
        }
    }
    cnt = sizeof(crashhandlermydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, crashhandlermydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = crashhandlermydatamap[i].sz;
    }
...
void wrappedcrashhandler_fini(library_t* lib)
{
...
# 32 "/home/ssd/pico/code/box86/src/wrapped/wrappedcrashhandler.c" 2
