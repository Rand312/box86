# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibztypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibztypes.h"
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
...
typedef struct libz_my_s {
    ...
    iFp_t deflateEnd; iFp_t inflateEnd; iFpi_t inflate; iFppi_t inflateInit_; iFpipi_t deflateInit_; iFpipi_t inflateInit2_; iFpippi_t inflateBackInit_; iFpiiiiipi_t deflateInit2_;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libz_my_t my_libz = {0};
static libz_my_t * const my = &my_libz;

static void getMy(library_t* lib)
{

    my->deflateEnd = (iFp_t)dlsym(lib->w.lib, "deflateEnd"); my->inflateEnd = (iFp_t)dlsym(lib->w.lib, "inflateEnd"); my->inflate = (iFpi_t)dlsym(lib->w.lib, "inflate"); my->inflateInit_ = (iFppi_t)dlsym(lib->w.lib, "inflateInit_"); my->deflateInit_ = (iFpipi_t)dlsym(lib->w.lib, "deflateInit_"); my->inflateInit2_ = (iFpipi_t)dlsym(lib->w.lib, "inflateInit2_"); my->inflateBackInit_ = (iFpippi_t)dlsym(lib->w.lib, "inflateBackInit_"); my->deflateInit2_ = (iFpiiiiipi_t)dlsym(lib->w.lib, "deflateInit2_");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
static uintptr_t my_alloc_fct_0 = 0; static void* my_alloc_0(void* opaque, uint32_t items, uint32_t size) { return (void*)RunFunctionFmt(my_alloc_fct_0, "puu", opaque, items, size); } static uintptr_t my_alloc_fct_1 = 0; static void* my_alloc_1(void* opaque, uint32_t items, uint32_t size) { return (void*)RunFunctionFmt(my_alloc_fct_1, "puu", opaque, items, size); } static uintptr_t my_alloc_fct_2 = 0; static void* my_alloc_2(void* opaque, uint32_t items, uint32_t size) { return (void*)RunFunctionFmt(my_alloc_fct_2, "puu", opaque, items, size); } static uintptr_t my_alloc_fct_3 = 0; static void* my_alloc_3(void* opaque, uint32_t items, uint32_t size) { return (void*)RunFunctionFmt(my_alloc_fct_3, "puu", opaque, items, size); } static uintptr_t my_alloc_fct_4 = 0; static void* my_alloc_4(void* opaque, uint32_t items, uint32_t size) { return (void*)RunFunctionFmt(my_alloc_fct_4, "puu", opaque, items, size); }
...
static void* find_alloc_Fct(void* fct)
{
    ...
    if(my_alloc_fct_0 == (uintptr_t)fct) return my_alloc_0; if(my_alloc_fct_1 == (uintptr_t)fct) return my_alloc_1; if(my_alloc_fct_2 == (uintptr_t)fct) return my_alloc_2; if(my_alloc_fct_3 == (uintptr_t)fct) return my_alloc_3; if(my_alloc_fct_4 == (uintptr_t)fct) return my_alloc_4;


    if(my_alloc_fct_0 == 0) {my_alloc_fct_0 = (uintptr_t)fct; return my_alloc_0; } if(my_alloc_fct_1 == 0) {my_alloc_fct_1 = (uintptr_t)fct; return my_alloc_1; } if(my_alloc_fct_2 == 0) {my_alloc_fct_2 = (uintptr_t)fct; return my_alloc_2; } if(my_alloc_fct_3 == 0) {my_alloc_fct_3 = (uintptr_t)fct; return my_alloc_3; } if(my_alloc_fct_4 == 0) {my_alloc_fct_4 = (uintptr_t)fct; return my_alloc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for zlib alloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 3 4
          ((void *)0)
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
              ;
}
static void* reverse_alloc_Fct(void* fct)
{
    ...
    if(my_alloc_0 == fct) return (void*)my_alloc_fct_0; if(my_alloc_1 == fct) return (void*)my_alloc_fct_1; if(my_alloc_2 == fct) return (void*)my_alloc_fct_2; if(my_alloc_3 == fct) return (void*)my_alloc_fct_3; if(my_alloc_4 == fct) return (void*)my_alloc_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, pFpuu, fct, 0, 
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 3 4
                                                            ((void *)0)
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
                                                                );
}
...
static uintptr_t my_free_fct_0 = 0; static void my_free_0(void* opaque, void* address) { RunFunctionFmt(my_free_fct_0, "pp", opaque, address); } static uintptr_t my_free_fct_1 = 0; static void my_free_1(void* opaque, void* address) { RunFunctionFmt(my_free_fct_1, "pp", opaque, address); } static uintptr_t my_free_fct_2 = 0; static void my_free_2(void* opaque, void* address) { RunFunctionFmt(my_free_fct_2, "pp", opaque, address); } static uintptr_t my_free_fct_3 = 0; static void my_free_3(void* opaque, void* address) { RunFunctionFmt(my_free_fct_3, "pp", opaque, address); } static uintptr_t my_free_fct_4 = 0; static void my_free_4(void* opaque, void* address) { RunFunctionFmt(my_free_fct_4, "pp", opaque, address); }
...
static void* find_free_Fct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for zlib free callback\n"); fflush(ftrace);}} while(0);
    return 
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 3 4
          ((void *)0)
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
              ;
}
static void* reverse_free_Fct(void* fct)
{
    ...
    if(my_free_0 == fct) return (void*)my_free_fct_0; if(my_free_1 == fct) return (void*)my_free_fct_1; if(my_free_2 == fct) return (void*)my_free_fct_2; if(my_free_3 == fct) return (void*)my_free_fct_3; if(my_free_4 == fct) return (void*)my_free_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, vFpp, fct, 0, 
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 3 4
                                                           ((void *)0)
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
                                                               );
}
...
__attribute__((visibility("default"))) int my_inflateInit_(x86emu_t* emu, void* str, void* version, int size)
{
...
__attribute__((visibility("default"))) int my_inflateInit2_(x86emu_t* emu, void* str, int windowBits, void* version, int stream_size)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_inflateBackInit_(x86emu_t* emu, void* str, int windowBits, void *window, void* version, int size)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_inflateEnd(x86emu_t* emu, void* str)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_deflateInit_(x86emu_t* emu, void* str, int level, void* version, int stream_size)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_deflateInit2_(x86emu_t* emu, void* str, int level, int method, int windowBits, int memLevel, int strategy, void* version, int stream_size)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_deflateEnd(x86emu_t* emu, void* str)
{
    wrapper_stream_z(emu, str);
...
__attribute__((visibility("default"))) int my_inflate(x86emu_t* emu, void* str, int flush)
{
    wrapper_stream_z(emu, str);
...
# 206 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibzdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libzsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1




{"adler32", LFLpu, 0},
{"adler32_combine", LFLLl, 0},
{"adler32_combine64", LFLLl, 0},
{"adler32_z", LFLpL, 0},
{"compress", iFpppL, 0},
{"compress2", iFpppLi, 0},
{"compressBound", LFL, 0},
{"crc32", LFLpu, 0},
{"crc32_combine", LFLLl, 0},
{"crc32_combine64", LFLLl, 0},
{"crc32_z", LFLpL, 0},
{"deflate", iFpi, 0},
{"deflateBound", LFpL, 0},
{"deflateCopy", iFpp, 0},

{"deflateGetDictionary", iFppp, 0},


{"deflateParams", iFpii, 0},
{"deflatePending", iFppp, 0},
{"deflatePrime", iFpii, 0},
{"deflateReset", iFp, 0},
{"deflateResetKeep", iFp, 0},
{"deflateSetDictionary", iFppu, 0},
{"deflateSetHeader", iFpp, 0},
{"deflateTune", iFpiiii, 0},
{"get_crc_table", pFv, 0},
{"gzbuffer", iFpu, 0},
{"gzclearerr", vFp, 0},
{"gzclose", iFp, 0},
...
{"inflateBackEnd", iFp, 0},

{"inflateCodesUsed", LFp, 0},
{"inflateCopy", iFpp, 0},

{"inflateGetDictionary", iFppp, 0},
{"inflateGetHeader", iFpp, 0},


{"inflateMark", lFp, 0},
{"inflatePrime", iFpii, 0},
{"inflateReset", iFp, 0},
{"inflateReset2", iFpi, 0},
{"inflateResetKeep", iFp, 0},
{"inflateSetDictionary", iFppu, 0},
{"inflateSync", iFp, 0},
{"inflateSyncPoint", iFp, 0},
{"inflateUndermine", iFpi, 0},
{"inflateValidate", iFpi, 0},
{"uncompress", iFpppL, 0},
{"uncompress2", iFpppp, 0},
{"zError", pFi, 0},
{"zlibCompileFlags", LFv, 0},
{"zlibVersion", pFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libzmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1
...
{"deflateInit_", iFEpipi, 0},
{"deflateInit2_", iFEpiiiiipi, 0},
...
{"inflateBackInit_", iFEpippi, 0},


{"inflateEnd", iFEp, 0},


{"inflateInit_", iFEppi, 0},
{"inflateInit2_", iFEpipi, 0},
...
static const map_onesymbol_t libzstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1
...
static const map_onesymbol2_t libzsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1
...
static const map_onedata_t libzdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1
...
static const map_onedata_t libzmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibzundefs.h" 1
...
int wrappedlibz_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libzName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libzsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libzsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libzsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libzsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libzsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libzsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libzsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libzsymbolmap[i].name); }
 cnt = sizeof(libzmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libzmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libzmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libzmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libzmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libzmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libzmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libzmysymbolmap[i].name); }

    cnt = sizeof(libzstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libzstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libzstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libzstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libzstsymbolmap[i].name);
    }
    cnt = sizeof(libzsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libzsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libzsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libzsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libzsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libzsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libzsymbol2map[i].name);
    }
    cnt = sizeof(libzdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libzdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libzdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libzdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libzdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libzdatamap[i].sz;
        }
    }
    cnt = sizeof(libzmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libzmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libzmydatamap[i].sz;
    }
...
void wrappedlibz_fini(library_t* lib)
{
...
# 207 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibz.c" 2
