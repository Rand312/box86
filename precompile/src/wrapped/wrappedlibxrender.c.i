# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2




    const char* libxrenderName = "libXrender.so.1";
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c"
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxrenderdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxrendersymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1




{"XRenderAddGlyphs", vFppppipi, 0},
{"XRenderAddTraps", vFppiipi, 0},
{"XRenderChangePicture", vFppLp, 0},
{"XRenderComposite", vFpipppiiiiiiuu, 0},
{"XRenderCompositeDoublePoly", vFpipppiiiipii, 0},
{"XRenderCompositeString16", vFpippppiiiipi, 0},
{"XRenderCompositeString32", vFpippppiiiipi, 0},
{"XRenderCompositeString8", vFpippppiiiipi, 0},
{"XRenderCompositeText16", vFpipppiiiipi, 0},
{"XRenderCompositeText32", vFpipppiiiipi, 0},
{"XRenderCompositeText8", vFpipppiiiipi, 0},
{"XRenderCompositeTrapezoids", vFpipppiipi, 0},
{"XRenderCompositeTriangles", vFpipppiipi, 0},
{"XRenderCompositeTriFan", vFpipppiipi, 0},
{"XRenderCompositeTriStrip", vFpipppiipi, 0},
{"XRenderCreateAnimCursor", pFpip, 0},
{"XRenderCreateConicalGradient", pFppppi, 0},
{"XRenderCreateCursor", pFppii, 0},
{"XRenderCreateGlyphSet", pFpp, 0},
{"XRenderCreateLinearGradient", pFppppi, 0},
{"XRenderCreatePicture", pFpppup, 0},
{"XRenderCreateRadialGradient", pFppppi, 0},
{"XRenderCreateSolidFill", pFpp, 0},


{"XRenderFillRectangle", vFpippiiuu, 0},
{"XRenderFillRectangles", vFpipppi, 0},
{"XRenderFindDisplay", pFp, 0},
{"XRenderFindFormat", pFpupi, 0},
{"XRenderFindStandardFormat", pFpi, 0},
{"XRenderFindVisualFormat", pFpp, 0},
{"XRenderFreeGlyphs", vFpppi, 0},
{"XRenderFreeGlyphSet", vFpp, 0},
{"XRenderFreePicture", vFpp, 0},
{"XRenderParseColor", iFppp, 0},
{"XRenderQueryExtension", iFppp, 0},
{"XRenderQueryFilters", pFpp, 0},
{"XRenderQueryFormats", iFp, 0},
{"XRenderQueryPictIndexValues", pFppp, 0},
{"XRenderQuerySubpixelOrder", iFpi, 0},
{"XRenderQueryVersion", iFppp, 0},
{"XRenderReferenceGlyphSet", pFpp, 0},
{"XRenderSetPictureClipRectangles", vFppiipi, 0},
{"XRenderSetPictureClipRegion", vFppp, 0},
{"XRenderSetPictureFilter", vFppppi, 0},
{"XRenderSetPictureTransform", vFppp, 0},
{"XRenderSetSubpixelOrder", iFpii, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxrendermysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1
...
static const map_onesymbol_t libxrenderstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1
...
static const map_onesymbol2_t libxrendersymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1
...
static const map_onedata_t libxrenderdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1
...
{"XRenderExtensionInfo", 4, 0},
{"XRenderExtensionName", 4, 0},
...
static const map_onedata_t libxrendermydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxrenderundefs.h" 1
...
int wrappedlibxrender_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxrenderName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxrenderName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxrendersymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxrendersymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxrendersymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxrendersymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxrendersymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxrendersymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxrendersymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxrendersymbolmap[i].name); }
 cnt = sizeof(libxrendermysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxrendermysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxrendermysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxrendermysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxrendermysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxrendermysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxrendermysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxrendermysymbolmap[i].name); }

    cnt = sizeof(libxrenderstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxrenderstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxrenderstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxrenderstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxrenderstsymbolmap[i].name);
    }
    cnt = sizeof(libxrendersymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxrendersymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxrendersymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxrendersymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxrendersymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxrendersymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxrendersymbol2map[i].name);
    }
    cnt = sizeof(libxrenderdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxrenderdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxrenderdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxrenderdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxrenderdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxrenderdatamap[i].sz;
        }
    }
    cnt = sizeof(libxrendermydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxrendermydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxrendermydatamap[i].sz;
    }

    setNeededLibs(lib, 4, "libX11.so.6", "libxcb.so.1", "libXau.so.6", "libXdmcp.so.6");


    return 0;
}

void wrappedlibxrender_fini(library_t* lib)
{
...
# 39 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxrender.c" 2
