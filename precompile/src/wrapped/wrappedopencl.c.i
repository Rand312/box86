# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2

const char* openclName = "libOpenCL.so.1";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopencltypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopencltypes.h"
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
...
typedef struct opencl_my_s {


    pFpuppp_t clCreateContextFromType; iFpupppp_t clBuildProgram; pFpupppp_t clCreateContext;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static opencl_my_t my_opencl = {0};
static opencl_my_t * const my = &my_opencl;

static void getMy(library_t* lib)
{

    my->clCreateContextFromType = (pFpuppp_t)dlsym(lib->w.lib, "clCreateContextFromType"); my->clBuildProgram = (iFpupppp_t)dlsym(lib->w.lib, "clBuildProgram"); my->clCreateContext = (pFpupppp_t)dlsym(lib->w.lib, "clCreateContext");
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
# 41 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c"
static uintptr_t my_notify_program_fct_0 = 0; static void my_notify_program_0(void* a, void* b) { RunFunctionFmt(my_notify_program_fct_0, "pp", a, b); } static uintptr_t my_notify_program_fct_1 = 0; static void my_notify_program_1(void* a, void* b) { RunFunctionFmt(my_notify_program_fct_1, "pp", a, b); } static uintptr_t my_notify_program_fct_2 = 0; static void my_notify_program_2(void* a, void* b) { RunFunctionFmt(my_notify_program_fct_2, "pp", a, b); } static uintptr_t my_notify_program_fct_3 = 0; static void my_notify_program_3(void* a, void* b) { RunFunctionFmt(my_notify_program_fct_3, "pp", a, b); } static uintptr_t my_notify_program_fct_4 = 0; static void my_notify_program_4(void* a, void* b) { RunFunctionFmt(my_notify_program_fct_4, "pp", a, b); }
...
static void* find_notify_program_Fct(void* fct)
{
    ...
    if(my_notify_program_fct_0 == (uintptr_t)fct) return my_notify_program_0; if(my_notify_program_fct_1 == (uintptr_t)fct) return my_notify_program_1; if(my_notify_program_fct_2 == (uintptr_t)fct) return my_notify_program_2; if(my_notify_program_fct_3 == (uintptr_t)fct) return my_notify_program_3; if(my_notify_program_fct_4 == (uintptr_t)fct) return my_notify_program_4;


    if(my_notify_program_fct_0 == 0) {my_notify_program_fct_0 = (uintptr_t)fct; return my_notify_program_0; } if(my_notify_program_fct_1 == 0) {my_notify_program_fct_1 = (uintptr_t)fct; return my_notify_program_1; } if(my_notify_program_fct_2 == 0) {my_notify_program_fct_2 = (uintptr_t)fct; return my_notify_program_2; } if(my_notify_program_fct_3 == 0) {my_notify_program_fct_3 = (uintptr_t)fct; return my_notify_program_3; } if(my_notify_program_fct_4 == 0) {my_notify_program_fct_4 = (uintptr_t)fct; return my_notify_program_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for opencl notify_program callback\n"); fflush(ftrace);}} while(0);
    return 
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 3 4
          ((void *)0)
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c"
              ;
}
...
static uintptr_t my_notity_context_fct_0 = 0; static void my_notity_context_0(void* a, void* b, size_t c, void* d) { RunFunctionFmt(my_notity_context_fct_0, "ppLp", a, b, c, d); } static uintptr_t my_notity_context_fct_1 = 0; static void my_notity_context_1(void* a, void* b, size_t c, void* d) { RunFunctionFmt(my_notity_context_fct_1, "ppLp", a, b, c, d); } static uintptr_t my_notity_context_fct_2 = 0; static void my_notity_context_2(void* a, void* b, size_t c, void* d) { RunFunctionFmt(my_notity_context_fct_2, "ppLp", a, b, c, d); } static uintptr_t my_notity_context_fct_3 = 0; static void my_notity_context_3(void* a, void* b, size_t c, void* d) { RunFunctionFmt(my_notity_context_fct_3, "ppLp", a, b, c, d); } static uintptr_t my_notity_context_fct_4 = 0; static void my_notity_context_4(void* a, void* b, size_t c, void* d) { RunFunctionFmt(my_notity_context_fct_4, "ppLp", a, b, c, d); }
...
static void* find_notity_context_Fct(void* fct)
{
    ...
    if(my_notity_context_fct_0 == (uintptr_t)fct) return my_notity_context_0; if(my_notity_context_fct_1 == (uintptr_t)fct) return my_notity_context_1; if(my_notity_context_fct_2 == (uintptr_t)fct) return my_notity_context_2; if(my_notity_context_fct_3 == (uintptr_t)fct) return my_notity_context_3; if(my_notity_context_fct_4 == (uintptr_t)fct) return my_notity_context_4;


    if(my_notity_context_fct_0 == 0) {my_notity_context_fct_0 = (uintptr_t)fct; return my_notity_context_0; } if(my_notity_context_fct_1 == 0) {my_notity_context_fct_1 = (uintptr_t)fct; return my_notity_context_1; } if(my_notity_context_fct_2 == 0) {my_notity_context_fct_2 = (uintptr_t)fct; return my_notity_context_2; } if(my_notity_context_fct_3 == 0) {my_notity_context_fct_3 = (uintptr_t)fct; return my_notity_context_3; } if(my_notity_context_fct_4 == 0) {my_notity_context_fct_4 = (uintptr_t)fct; return my_notity_context_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for opencl notity_context callback\n"); fflush(ftrace);}} while(0);
    return 
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 3 4
          ((void *)0)
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c"
              ;
}



__attribute__((visibility("default"))) int my_clBuildProgram(x86emu_t* emu, void* program, uint32_t num, void* devices, void* options, void* f, void* data)
{
    return my->clBuildProgram(program, num, devices, options, find_notify_program_Fct(f), data);
}

__attribute__((visibility("default"))) void* my_clCreateContext(x86emu_t* emu, void* prop, uint32_t num, void* devices, void* f, void* data, void* ret)
{
    return my->clCreateContext(prop, num, devices, find_notity_context_Fct(f), data, ret);
}

__attribute__((visibility("default"))) void* my_clCreateContextFromType(x86emu_t* emu, void* prop, uint32_t type, void* f, void* data, void* ret)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopencldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t openclsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1
...
{"clCreateBuffer", pFpuLpp, 0},

{"clCreateCommandQueue", pFppup, 0},
...
{"clCreateImage", pFpupppp, 0},
{"clCreateImage2D", pFpupLLLpp, 0},
{"clCreateImage3D", pFpupLLLLLpp, 0},

{"clCreateKernel", pFppp, 0},
{"clCreateKernelsInProgram", iFpupp, 0},

{"clCreateProgramWithBinary", pFpuppppp, 0},
{"clCreateProgramWithBuiltInKernels", pFpuppp, 0},

{"clCreateProgramWithSource", pFpuppp, 0},
{"clCreateSampler", pFpuuup, 0},

{"clCreateSubBuffer", pFpuupp, 0},
{"clCreateSubDevices", iFppupp, 0},
{"clCreateUserEvent", pFpp, 0},

{"clEnqueueBarrier", iFp, 0},
{"clEnqueueBarrierWithWaitList", iFpupp, 0},
{"clEnqueueCopyBuffer", iFpppLLLupp, 0},
{"clEnqueueCopyBufferRect", iFppppppLLLLupp, 0},
{"clEnqueueCopyBufferToImage", iFpppLppupp, 0},
{"clEnqueueCopyImage", iFppppppupp, 0},
{"clEnqueueCopyImageToBuffer", iFpppppLupp, 0},
{"clEnqueueFillBuffer", iFpppLLLupp, 0},
{"clEnqueueFillImage", iFpppppupp, 0},
{"clEnqueueMapBuffer", pFppuuLLuppp, 0},
{"clEnqueueMapImage", pFppuuppppuppp, 0},
{"clEnqueueMarker", iFpp, 0},
{"clEnqueueMarkerWithWaitList", iFpupp, 0},
{"clEnqueueMigrateMemObjects", iFpupuupp, 0},

{"clEnqueueNDRangeKernel", iFppupppupp, 0},
{"clEnqueueReadBuffer", iFppuLLpupp, 0},
{"clEnqueueReadBufferRect", iFppupppLLLLpupp, 0},
{"clEnqueueReadImage", iFppuppLLpupp, 0},
...
{"clEnqueueTask", iFppupp, 0},
{"clEnqueueUnmapMemObject", iFpppupp, 0},
{"clEnqueueWaitForEvents", iFpup, 0},
{"clEnqueueWriteBuffer", iFppuLLpupp, 0},
{"clEnqueueWriteBufferRect", iFppupppLLLLpupp, 0},
{"clEnqueueWriteImage", iFppuppLLpupp, 0},
{"clFinish", iFp, 0},
{"clFlush", iFp, 0},
{"clGetCommandQueueInfo", iFpuLpp, 0},
{"clGetContextInfo", iFpuLpp, 0},

{"clGetDeviceIDs", iFpuupp, 0},
{"clGetDeviceInfo", iFpuLpL, 0},
{"clGetEventInfo", iFpuLpp, 0},
{"clGetEventProfilingInfo", iFpuLpp, 0},





{"clGetImageInfo", pFpuLpp, 0},
{"clGetKernelArgInfo", iFpuuLpp, 0},
{"clGetKernelInfo", iFpuLpp, 0},

{"clGetKernelWorkGroupInfo", iFppuLpp, 0},
{"clGetMemObjectInfo", iFpuLpp, 0},

{"clGetPlatformIDs", iFupp, 0},
{"clGetPlatformInfo", iFpuLpp, 0},
{"clGetProgramBuildInfo", iFppuLpp, 0},
{"clGetProgramInfo", iFpuLpL, 0},
{"clGetSamplerInfo", iFpuLpp, 0},
{"clGetSupportedImageFormats", iFpuuupp, 0},

{"clReleaseCommandQueue", iFp, 0},
{"clReleaseContext", iFp, 0},
{"clReleaseDevice", iFp, 0},
{"clReleaseEvent", iFp, 0},
{"clReleaseKernel", iFp, 0},
{"clReleaseMemObject", iFp, 0},
{"clReleaseProgram", iFp, 0},
{"clReleaseSampler", iFp, 0},
{"clRetainCommandQueue", iFp, 0},
{"clRetainContext", iFp, 0},
{"clRetainDevice", iFp, 0},
{"clRetainEvent", iFp, 0},
{"clRetainKernel", iFp, 0},
{"clRetainMemObject", iFp, 0},
{"clRetainProgram", iFp, 0},
{"clRetainSampler", iFp, 0},




{"clSetKernelArg", iFpuLp, 0},





{"clSetUserEventStatus", iFpi, 0},


{"clUnloadCompiler", iFv, 0},
{"clUnloadPlatformCompiler", iFp, 0},
{"clWaitForEvents", iFup, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t openclmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1




{"clBuildProgram", iFEpupppp, 0},
...
{"clCreateContext", pFEpupppp, 0},
{"clCreateContextFromType", pFEpuppp, 0},
...
static const map_onesymbol_t openclstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1
...
static const map_onesymbol2_t openclsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1
...
static const map_onedata_t opencldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1
...
static const map_onedata_t openclmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopenclundefs.h" 1
...
int wrappedopencl_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(openclName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(openclsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (openclsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, openclsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = openclsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, openclsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = openclsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(openclsymbolmap[i].name, '@')) AddDictionnary(box86->versym, openclsymbolmap[i].name); }
 cnt = sizeof(openclmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (openclmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, openclmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = openclmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, openclmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = openclmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(openclmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, openclmysymbolmap[i].name); }

    cnt = sizeof(openclstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, openclstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = openclstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(openclstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, openclstsymbolmap[i].name);
    }
    cnt = sizeof(openclsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, openclsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = openclsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = openclsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = openclsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(openclsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, openclsymbol2map[i].name);
    }
    cnt = sizeof(opencldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(opencldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, opencldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = opencldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, opencldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = opencldatamap[i].sz;
        }
    }
    cnt = sizeof(openclmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, openclmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = openclmydatamap[i].sz;
    }
...
void wrappedopencl_fini(library_t* lib)
{
...
# 103 "/home/ssd/pico/code/box86/src/wrapped/wrappedopencl.c" 2
