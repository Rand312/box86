# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappednspr4types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappednspr4types.h"
typedef int32_t (*iFpp_t)(void*, void*);
typedef void* (*pFip_t)(int32_t, void*);
typedef void* (*pFpp_t)(void*, void*);
typedef int32_t (*iFppp_t)(void*, void*, void*);
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
...
typedef struct nspr4_my_s {
    ...
    iFpp_t PR_CallOnce; pFip_t PR_CreateIOLayerStub; pFpp_t PR_FindFunctionSymbol; iFppp_t PR_CallOnceWithArg;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static nspr4_my_t my_nspr4 = {0};
static nspr4_my_t * const my = &my_nspr4;

static void getMy(library_t* lib)
{

    my->PR_CallOnce = (iFpp_t)dlsym(lib->w.lib, "PR_CallOnce"); my->PR_CreateIOLayerStub = (pFip_t)dlsym(lib->w.lib, "PR_CreateIOLayerStub"); my->PR_FindFunctionSymbol = (pFpp_t)dlsym(lib->w.lib, "PR_FindFunctionSymbol"); my->PR_CallOnceWithArg = (iFppp_t)dlsym(lib->w.lib, "PR_CallOnceWithArg");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
# 46 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
static uintptr_t my_PRCallOnceWithArg_fct_0 = 0; static int my_PRCallOnceWithArg_0(void* a) { return (int)RunFunctionFmt(my_PRCallOnceWithArg_fct_0, "p", a); } static uintptr_t my_PRCallOnceWithArg_fct_1 = 0; static int my_PRCallOnceWithArg_1(void* a) { return (int)RunFunctionFmt(my_PRCallOnceWithArg_fct_1, "p", a); } static uintptr_t my_PRCallOnceWithArg_fct_2 = 0; static int my_PRCallOnceWithArg_2(void* a) { return (int)RunFunctionFmt(my_PRCallOnceWithArg_fct_2, "p", a); } static uintptr_t my_PRCallOnceWithArg_fct_3 = 0; static int my_PRCallOnceWithArg_3(void* a) { return (int)RunFunctionFmt(my_PRCallOnceWithArg_fct_3, "p", a); } static uintptr_t my_PRCallOnceWithArg_fct_4 = 0; static int my_PRCallOnceWithArg_4(void* a) { return (int)RunFunctionFmt(my_PRCallOnceWithArg_fct_4, "p", a); }
...
static void* find_PRCallOnceWithArg_Fct(void* fct)
{
    ...
    if(my_PRCallOnceWithArg_fct_0 == (uintptr_t)fct) return my_PRCallOnceWithArg_0; if(my_PRCallOnceWithArg_fct_1 == (uintptr_t)fct) return my_PRCallOnceWithArg_1; if(my_PRCallOnceWithArg_fct_2 == (uintptr_t)fct) return my_PRCallOnceWithArg_2; if(my_PRCallOnceWithArg_fct_3 == (uintptr_t)fct) return my_PRCallOnceWithArg_3; if(my_PRCallOnceWithArg_fct_4 == (uintptr_t)fct) return my_PRCallOnceWithArg_4;


    if(my_PRCallOnceWithArg_fct_0 == 0) {my_PRCallOnceWithArg_fct_0 = (uintptr_t)fct; return my_PRCallOnceWithArg_0; } if(my_PRCallOnceWithArg_fct_1 == 0) {my_PRCallOnceWithArg_fct_1 = (uintptr_t)fct; return my_PRCallOnceWithArg_1; } if(my_PRCallOnceWithArg_fct_2 == 0) {my_PRCallOnceWithArg_fct_2 = (uintptr_t)fct; return my_PRCallOnceWithArg_2; } if(my_PRCallOnceWithArg_fct_3 == 0) {my_PRCallOnceWithArg_fct_3 = (uintptr_t)fct; return my_PRCallOnceWithArg_3; } if(my_PRCallOnceWithArg_fct_4 == 0) {my_PRCallOnceWithArg_fct_4 = (uintptr_t)fct; return my_PRCallOnceWithArg_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for nspr4 PRCallOnceWithArg callback\n"); fflush(ftrace);}} while(0);
    return 
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 3 4
          ((void *)0)
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
              ;
}
...
static uintptr_t my_PRCallOnce_fct_0 = 0; static int my_PRCallOnce_0() { return (int)RunFunctionFmt(my_PRCallOnce_fct_0, ""); } static uintptr_t my_PRCallOnce_fct_1 = 0; static int my_PRCallOnce_1() { return (int)RunFunctionFmt(my_PRCallOnce_fct_1, ""); } static uintptr_t my_PRCallOnce_fct_2 = 0; static int my_PRCallOnce_2() { return (int)RunFunctionFmt(my_PRCallOnce_fct_2, ""); } static uintptr_t my_PRCallOnce_fct_3 = 0; static int my_PRCallOnce_3() { return (int)RunFunctionFmt(my_PRCallOnce_fct_3, ""); } static uintptr_t my_PRCallOnce_fct_4 = 0; static int my_PRCallOnce_4() { return (int)RunFunctionFmt(my_PRCallOnce_fct_4, ""); }
...
static void* find_PRCallOnce_Fct(void* fct)
{
    ...
    if(my_PRCallOnce_fct_0 == (uintptr_t)fct) return my_PRCallOnce_0; if(my_PRCallOnce_fct_1 == (uintptr_t)fct) return my_PRCallOnce_1; if(my_PRCallOnce_fct_2 == (uintptr_t)fct) return my_PRCallOnce_2; if(my_PRCallOnce_fct_3 == (uintptr_t)fct) return my_PRCallOnce_3; if(my_PRCallOnce_fct_4 == (uintptr_t)fct) return my_PRCallOnce_4;


    if(my_PRCallOnce_fct_0 == 0) {my_PRCallOnce_fct_0 = (uintptr_t)fct; return my_PRCallOnce_0; } if(my_PRCallOnce_fct_1 == 0) {my_PRCallOnce_fct_1 = (uintptr_t)fct; return my_PRCallOnce_1; } if(my_PRCallOnce_fct_2 == 0) {my_PRCallOnce_fct_2 = (uintptr_t)fct; return my_PRCallOnce_2; } if(my_PRCallOnce_fct_3 == 0) {my_PRCallOnce_fct_3 = (uintptr_t)fct; return my_PRCallOnce_3; } if(my_PRCallOnce_fct_4 == 0) {my_PRCallOnce_fct_4 = (uintptr_t)fct; return my_PRCallOnce_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for nspr4 PRCallOnce callback\n"); fflush(ftrace);}} while(0);
    return 
# 81 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 3 4
          ((void *)0)
# 81 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
              ;
}
...
__attribute__((visibility("default"))) int my_PR_CallOnceWithArg(x86emu_t* emu, void* once, void* f, void* arg)
{
    (void)emu;
    return my->PR_CallOnceWithArg(once, find_PRCallOnceWithArg_Fct(f), arg);
}

__attribute__((visibility("default"))) int my_PR_CallOnce(x86emu_t* emu, void* once, void* f)
{
    (void)emu;
    return my->PR_CallOnce(once, find_PRCallOnce_Fct(f));
}

__attribute__((visibility("default"))) void* my_PR_FindFunctionSymbol(x86emu_t* emu, void* symbol, void* name)
{
    (void)emu;

    do {if((0)<=box86_log) {fprintf(ftrace, "Error: using unimplemented PR_FindFunctionSymbol(%p, \"%s\")\n", symbol, (char*)name); fflush(ftrace);}} while(0);
    return 
# 111 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 3 4
          ((void *)0)
# 111 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
              ;
}

__attribute__((visibility("default"))) void* my_PR_CreateIOLayerStub(x86emu_t* emu, int ident, void* methods)
{
    (void)emu;

    do {if((0)<=box86_log) {fprintf(ftrace, "Error: using unimplemented PR_CreateIOLayerStub(%d, %p)\n", ident, methods); fflush(ftrace);}} while(0);
    return 
# 119 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 3 4
          ((void *)0)
# 119 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c"
              ;
}
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappednspr4defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t nspr4symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1




{"GetExecutionEnvironment", pFp, 0},
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_AssertCurrentThreadInMonitor", vFp, 0},
{"PR_AssertCurrentThreadOwnsLock", vFp, 0},





{"PR_AttachThread", pFiip, 0},




{"PR_BlockInterrupt", vFv, 0},



# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_ClearInterrupt", vFv, 0},
{"PR_ClearThreadGCAble", vFv, 0},
{"PR_Close", iFp, 0},


{"PR_CloseSemaphore", iFp, 0},
...
{"PR_ConvertIPv4AddrToIPv6", vFup, 0},





# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_DeleteSemaphore", iFp, 0},


{"PR_DestroyCondVar", vFp, 0},

{"PR_DestroyLock", vFp, 0},
{"PR_DestroyMonitor", vFp, 0},
...
{"PR_DetachThread", vFv, 0},



{"PR_EmulateAcceptRead", iFppppiu, 0},
{"PR_EmulateSendFile", iFppiu, 0},

{"PR_EnterMonitor", vFp, 0},
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_ExitMonitor", iFp, 0},
# 124 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"

# 137 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_Free", vFp, 0},

{"PR_FreeLibraryName", vFp, 0},
...
{"PR_GetCurrentThread", pFv, 0},
{"PR_GetDefaultIOMethods", pFv, 0},

{"PR_GetDirectorySeparator", CFv, 0},

{"PR_GetEnv", pFp, 0},

{"PR_GetError", iFv, 0},
{"PR_GetErrorText", iFp, 0},
{"PR_GetErrorTextLength", iFv, 0},
...
{"PR_GetIdentitiesLayer", pFpi, 0},




{"PR_GetLibraryFilePathname", pFpp, 0},
{"PR_GetLibraryName", pFpp, 0},
{"PR_GetLibraryPath", pFv, 0},

{"PR_GetMonitorEntryCount", iFp, 0},




{"PR_GetOSError", iFv, 0},
# 186 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_GetSocketOption", iFpp, 0},
...
{"PR_GetThreadAffinityMask", iFpp, 0},
{"PR_GetThreadID", uFp, 0},
{"PR_GetThreadName", pFp, 0},
{"PR_GetThreadPriority", iFp, 0},

{"PR_GetThreadScope", iFp, 0},
{"PR_GetThreadState", iFp, 0},
{"PR_GetThreadType", iFp, 0},





{"PR_GetUniqueIdentity", iFp, 0},
...
{"PR_ImportTCPSocket", pFi, 0},


{"PR_Init", vFiii, 0},

{"PR_Initialized", iFv, 0},

{"PR_Interrupt", iFp, 0},
{"PR_IntervalNow", iFv, 0},
{"PR_IntervalToMicroseconds", uFi, 0},
{"PR_IntervalToMilliseconds", uFi, 0},
{"PR_IntervalToSeconds", uFi, 0},
...
{"PR_LoadLibraryWithFlags", pFipppi, 0},
...
{"PR_MicrosecondsToInterval", iFu, 0},
{"PR_MillisecondsToInterval", iFu, 0},
...
{"PR_OpenSemaphore", pFpiiu, 0},
# 290 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_PopIOLayer", pFpi, 0},
{"PR_PostSem", vFp, 0},
{"PR_PostSemaphore", iFp, 0},




{"PR_ProcessExit", vFi, 0},

{"PR_PushIOLayer", iFpip, 0},
...
{"PR_Read", iFppi, 0},
# 316 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_ResumeAll", vFv, 0},
...
{"PR_SecondsToInterval", iFu, 0},
# 332 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_SetCurrentThreadName", iFp, 0},

{"PR_SetError", vFii, 0},
{"PR_SetErrorText", vFp, 0},


{"PR_SetLibraryPath", iFp, 0},




{"PR_SetSocketOption", iFpp, 0},




{"PR_SetThreadGCAble", vFv, 0},
{"PR_SetThreadPriority", vFpi, 0},
...
{"PR_Sleep", iFu, 0},
# 365 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_StringToNetAddr", iFpp, 0},
...
{"PR_TicksPerSecond", uFv, 0},




{"PR_UnblockInterrupt", vFv, 0},
{"PR_UnloadLibrary", iFp, 0},
{"PR_Unlock", iFp, 0},
# 391 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h"
{"PR_Wait", iFpi, 0},
{"PR_WaitCondVar", iFpi, 0},



{"PR_WaitSem", iFp, 0},
{"PR_WaitSemaphore", iFp, 0},
{"PR_Write", iFppi, 0},

{"PR_Yield", iFv, 0},

{"SetExecutionEnvironment", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t nspr4mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1
...
static const map_onesymbol_t nspr4stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1
...
static const map_onesymbol2_t nspr4symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1
...
static const map_onedata_t nspr4datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1
...
static const map_onedata_t nspr4mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappednspr4undefs.h" 1
...
int wrappednspr4_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(nspr4Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(nspr4symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (nspr4symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, nspr4symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = nspr4symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, nspr4symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = nspr4symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(nspr4symbolmap[i].name, '@')) AddDictionnary(box86->versym, nspr4symbolmap[i].name); }
 cnt = sizeof(nspr4mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (nspr4mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, nspr4mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = nspr4mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, nspr4mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = nspr4mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(nspr4mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, nspr4mysymbolmap[i].name); }

    cnt = sizeof(nspr4stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, nspr4stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = nspr4stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(nspr4stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, nspr4stsymbolmap[i].name);
    }
    cnt = sizeof(nspr4symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, nspr4symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = nspr4symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = nspr4symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = nspr4symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(nspr4symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, nspr4symbol2map[i].name);
    }
    cnt = sizeof(nspr4datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(nspr4datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, nspr4datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = nspr4datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, nspr4datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = nspr4datamap[i].sz;
        }
    }
    cnt = sizeof(nspr4mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, nspr4mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = nspr4mydatamap[i].sz;
    }
...
void wrappednspr4_fini(library_t* lib)
{
...
# 129 "/home/ssd/pico/code/box86/src/wrapped/wrappednspr4.c" 2
