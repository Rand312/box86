# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2

const char* libpcreName = "libpcre.so.3";


typedef void (*pcre_free_t)(void *);
__attribute__((visibility("default"))) uintptr_t my_pcre_free;
...
__attribute__((visibility("default"))) pcre_free_t pcre_free = wrapped_pcre_free;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpcredefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libpcresymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1




{"pcre_assign_jit_stack", vFpp, 0},

{"pcre_compile", pFpippp, 0},
{"pcre_compile2", pFpipppp, 0},
{"pcre_config", iFip, 0},
{"pcre_copy_named_substring", iFpppippi, 0},
{"pcre_copy_substring", iFppiipi, 0},
{"pcre_dfa_exec", iFpppiiipipi, 0},
{"pcre_exec", iFpppiiipi, 0},

{"pcre_free_study", vFp, 0},
{"pcre_free_substring", vFp, 0},
{"pcre_free_substring_list", vFp, 0},
{"pcre_fullinfo", iFppip, 0},
{"pcre_get_named_substring", iFpppipp, 0},
{"pcre_get_stringnumber", iFpp, 0},
{"pcre_get_stringtable_entries", iFpppp, 0},
{"pcre_get_substring", iFppiip, 0},
{"pcre_get_substring_list", iFppip, 0},
{"pcre_info", iFppp, 0},
{"pcre_jit_exec", iFpppiiipip, 0},
{"pcre_jit_free_unused_memory", vFv, 0},
{"pcre_jit_stack_alloc", pFii, 0},
{"pcre_jit_stack_free", vFp, 0},
{"pcre_maketables", pFv, 0},

{"pcre_pattern_to_host_byte_order", iFppp, 0},
{"pcre_refcount", iFpi, 0},
...
static const map_onesymbol_t libpcremysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1
...
static const map_onesymbol_t libpcrestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1
...
static const map_onesymbol2_t libpcresymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1
...
static const map_onedata_t libpcredatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1
...
static const map_onedata_t libpcremydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpcreundefs.h" 1
...
int wrappedlibpcre_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libpcreName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libpcresymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpcresymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libpcresymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libpcresymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libpcresymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libpcresymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libpcresymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpcresymbolmap[i].name); }
 cnt = sizeof(libpcremysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpcremysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libpcremysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libpcremysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libpcremysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libpcremysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libpcremysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpcremysymbolmap[i].name); }

    cnt = sizeof(libpcrestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libpcrestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libpcrestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libpcrestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libpcrestsymbolmap[i].name);
    }
    cnt = sizeof(libpcresymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libpcresymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libpcresymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libpcresymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libpcresymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libpcresymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libpcresymbol2map[i].name);
    }
    cnt = sizeof(libpcredatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libpcredatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libpcredatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libpcredatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libpcredatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libpcredatamap[i].sz;
        }
    }
    cnt = sizeof(libpcremydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libpcremydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libpcremydatamap[i].sz;
    }
...
void wrappedlibpcre_fini(library_t* lib)
{
...
# 34 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpcre.c" 2
