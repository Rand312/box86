# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                            ((void *)0)
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                ;



# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpegtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpegtypes.h"
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
typedef struct libjpeg_my_s {


    iFv_t jpeg_simd_cpu_support; iFp_t jpeg_finish_decompress; iFp_t jpeg_start_decompress; pFp_t jpeg_std_error; vFpp_t jpeg_stdio_dest; vFpp_t jpeg_stdio_src; iFpi_t jpeg_read_header; vFpiL_t jpeg_CreateDecompress; vFpip_t jpeg_set_marker_processor; uFppu_t jpeg_read_scanlines;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libjpeg_my_t my_libjpeg = {0};
static libjpeg_my_t * const my = &my_libjpeg;

static void getMy(library_t* lib)
{

    my->jpeg_simd_cpu_support = (iFv_t)dlsym(lib->w.lib, "jpeg_simd_cpu_support"); my->jpeg_finish_decompress = (iFp_t)dlsym(lib->w.lib, "jpeg_finish_decompress"); my->jpeg_start_decompress = (iFp_t)dlsym(lib->w.lib, "jpeg_start_decompress"); my->jpeg_std_error = (pFp_t)dlsym(lib->w.lib, "jpeg_std_error"); my->jpeg_stdio_dest = (vFpp_t)dlsym(lib->w.lib, "jpeg_stdio_dest"); my->jpeg_stdio_src = (vFpp_t)dlsym(lib->w.lib, "jpeg_stdio_src"); my->jpeg_read_header = (iFpi_t)dlsym(lib->w.lib, "jpeg_read_header"); my->jpeg_CreateDecompress = (vFpiL_t)dlsym(lib->w.lib, "jpeg_CreateDecompress"); my->jpeg_set_marker_processor = (vFpip_t)dlsym(lib->w.lib, "jpeg_set_marker_processor"); my->jpeg_read_scanlines = (uFppu_t)dlsym(lib->w.lib, "jpeg_read_scanlines");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
...
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_error_exit_fct_0 = 0; static void my_error_exit_0(jpeg_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapErrorMgr(my_bridge, cinfo->err); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_0, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapErrorMgr(my_bridge, cinfo->err); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_1 = 0; static void my_error_exit_1(jpeg_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapErrorMgr(my_bridge, cinfo->err); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_1, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapErrorMgr(my_bridge, cinfo->err); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_2 = 0; static void my_error_exit_2(jpeg_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapErrorMgr(my_bridge, cinfo->err); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_2, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapErrorMgr(my_bridge, cinfo->err); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_3 = 0; static void my_error_exit_3(jpeg_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapErrorMgr(my_bridge, cinfo->err); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_3, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapErrorMgr(my_bridge, cinfo->err); else longjmp(cinfo->client_data, 1); }
...
static void* finderror_exitFct(void* fct)
{
    ...
    return 
# 164 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 164 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
static void* is_error_exitFct(void* fct)
{
    if(!fct) return 
# 168 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                   ((void *)0)
# 168 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                       ;
    ...
    return 
# 172 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 172 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 182 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_emit_message_fct_0 = 0; static void my_emit_message_0(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_0, 2, cinfo, msg_level); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_1 = 0; static void my_emit_message_1(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_1, 2, cinfo, msg_level); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_2 = 0; static void my_emit_message_2(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_2, 2, cinfo, msg_level); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_3 = 0; static void my_emit_message_3(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_3, 2, cinfo, msg_level); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findemit_messageFct(void* fct)
{
    ...
    return 
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
static void* is_emit_messageFct(void* fct)
{
    if(!fct) return 
# 199 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                   ((void *)0)
# 199 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                       ;
    ...
    return 
# 203 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 203 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 213 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_output_message_fct_0 = 0; static void my_output_message_0(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_0, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_1 = 0; static void my_output_message_1(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_1, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_2 = 0; static void my_output_message_2(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_2, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_3 = 0; static void my_output_message_3(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_3, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findoutput_messageFct(void* fct)
{
    ...
    return 
# 226 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 226 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
static void* is_output_messageFct(void* fct)
{
    if(!fct) return 
# 230 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                   ((void *)0)
# 230 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                       ;
    ...
    return 
# 234 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 234 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_format_message_fct_0 = 0; static void my_format_message_0(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_0, 2, cinfo, buffer); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_1 = 0; static void my_format_message_1(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_1, 2, cinfo, buffer); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_2 = 0; static void my_format_message_2(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_2, 2, cinfo, buffer); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_3 = 0; static void my_format_message_3(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_3, 2, cinfo, buffer); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findformat_messageFct(void* fct)
{
    ...
    return 
# 257 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 257 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
static void* is_format_messageFct(void* fct)
{
    if(!fct) return 
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                   ((void *)0)
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                       ;
    ...
    return 
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 275 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_reset_error_mgr_fct_0 = 0; static void my_reset_error_mgr_0(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_0, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_1 = 0; static void my_reset_error_mgr_1(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_1, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_2 = 0; static void my_reset_error_mgr_2(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_2, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_3 = 0; static void my_reset_error_mgr_3(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_3, 1, cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findreset_error_mgrFct(void* fct)
{
    ...
    return 
# 288 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 288 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
static void* is_reset_error_mgrFct(void* fct)
{
    if(!fct) return 
# 292 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                   ((void *)0)
# 292 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                       ;
    ...
    return 
# 296 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 296 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 307 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static uintptr_t my_jpeg_marker_parser_method_fct_0 = 0; static int my_jpeg_marker_parser_method_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_0, "p", cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_1 = 0; static int my_jpeg_marker_parser_method_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_1, "p", cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_2 = 0; static int my_jpeg_marker_parser_method_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_2, "p", cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_3 = 0; static int my_jpeg_marker_parser_method_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg_common_struct_t*)cinfo)->client_data; ((jpeg_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_3, "p", cinfo); ((jpeg_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; }
...
static void* findjpeg_marker_parser_methodFct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libpng12 jpeg_marker_parser_method callback\n"); fflush(ftrace);}} while(0);
    return 
# 320 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
          ((void *)0)
# 320 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
              ;
}
# 332 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
static void wrapErrorMgr(bridge_t* bridge, jpeg_error_mgr_t* mgr)
{
    if(!mgr)
        return;
    ...
    p = is_error_exitFct(mgr->error_exit); if(!p) p = (void*)AddCheckBridge(bridge, vFp, mgr->error_exit, 0, 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ); mgr->error_exit = p; p = is_emit_messageFct(mgr->emit_message); if(!p) p = (void*)AddCheckBridge(bridge, vFpi, mgr->emit_message, 0, 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ); mgr->emit_message = p; p = is_output_messageFct(mgr->output_message); if(!p) p = (void*)AddCheckBridge(bridge, vFp, mgr->output_message, 0, 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ); mgr->output_message = p; p = is_format_messageFct(mgr->format_message); if(!p) p = (void*)AddCheckBridge(bridge, vFpp, mgr->format_message, 0, 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ); mgr->format_message = p; p = is_reset_error_mgrFct(mgr->reset_error_mgr); if(!p) p = (void*)AddCheckBridge(bridge, vFp, mgr->reset_error_mgr, 0, 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ); mgr->reset_error_mgr = p;
...
static void unwrapErrorMgr(bridge_t* bridge, jpeg_error_mgr_t* mgr)
{
    ...
    p = GetNativeFnc((uintptr_t)mgr->error_exit); if(!p) p = finderror_exitFct(mgr->error_exit); mgr->error_exit = p; p = GetNativeFnc((uintptr_t)mgr->emit_message); if(!p) p = findemit_messageFct(mgr->emit_message); mgr->emit_message = p; p = GetNativeFnc((uintptr_t)mgr->output_message); if(!p) p = findoutput_messageFct(mgr->output_message); mgr->output_message = p; p = GetNativeFnc((uintptr_t)mgr->format_message); if(!p) p = findformat_messageFct(mgr->format_message); mgr->format_message = p; p = GetNativeFnc((uintptr_t)mgr->reset_error_mgr); if(!p) p = findreset_error_mgrFct(mgr->reset_error_mgr); mgr->reset_error_mgr = p;

}


__attribute__((visibility("default"))) int my_jpeg_simd_cpu_support()
{
    return 0x01|0x04|0x08;
}

__attribute__((visibility("default"))) void* my_jpeg_std_error(x86emu_t* emu, void* errmgr)
{
    (void)emu;
...
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                                                                                        ((void *)0)
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                                                                            );
    ret->emit_message = (void*)AddCheckBridge(my_lib->w.bridge, vFpi, native_emit_message, 0, 
# 377 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                                                                                             ((void *)0)
# 377 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                                                                                 );
    ret->output_message = (void*)AddCheckBridge(my_lib->w.bridge, vFp, native_output_message, 0, 
# 378 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                                                                                                ((void *)0)
# 378 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                                                                                    );
    ret->format_message = (void*)AddCheckBridge(my_lib->w.bridge, vFpp, native_format_message, 0, 
# 379 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                                                                                                 ((void *)0)
# 379 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                                                                                     );
    ret->reset_error_mgr = (void*)AddCheckBridge(my_lib->w.bridge, vFp, native_reset_error_mgr, 0, 
# 380 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
                                                                                                  ((void *)0)
# 380 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
                                                                                                      );

    return ret;
}
# 400 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
__attribute__((visibility("default"))) void my_jpeg_CreateDecompress(x86emu_t* emu, jpeg_common_struct_t* cinfo, int version, unsigned long structsize)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 402 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 402 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 402 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 402 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_CreateDecompress(cinfo, version, structsize); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
}

__attribute__((visibility("default"))) int my_jpeg_read_header(x86emu_t* emu, jpeg_common_struct_t* cinfo, int image)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 407 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 407 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 407 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 407 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_read_header(cinfo, image); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
    return ret;
}

__attribute__((visibility("default"))) int my_jpeg_start_decompress(x86emu_t* emu, jpeg_common_struct_t* cinfo)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 413 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 413 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 413 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 413 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_start_decompress(cinfo); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
    return ret;
}

__attribute__((visibility("default"))) uint32_t my_jpeg_read_scanlines(x86emu_t* emu, jpeg_common_struct_t* cinfo, void* scanlines, uint32_t maxlines)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 419 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 419 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 419 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 419 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (uint32_t)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; uint32_t ret = my->jpeg_read_scanlines(cinfo, scanlines, maxlines); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
    return ret;
}

__attribute__((visibility("default"))) int my_jpeg_finish_decompress(x86emu_t* emu, jpeg_common_struct_t* cinfo)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 425 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 425 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 425 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 425 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_finish_decompress(cinfo); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
    return ret;
}

__attribute__((visibility("default"))) void my_jpeg_set_marker_processor(x86emu_t* emu, jpeg_common_struct_t* cinfo, int marker, void* routine)
{
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 431 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_set_marker_processor(cinfo, marker, findjpeg_marker_parser_methodFct(routine)); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
}

__attribute__((visibility("default"))) void my_jpeg_stdio_src(x86emu_t* emu, jpeg_common_struct_t* cinfo, void* infile) {
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_stdio_src(cinfo, infile); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
}

__attribute__((visibility("default"))) void my_jpeg_stdio_dest(x86emu_t* emu, jpeg_common_struct_t* cinfo, void* outfile) {
    jmpbuf_helper helper; unwrapErrorMgr(my_lib->w.bridge, cinfo->err); if(
# 439 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   _setjmp (
# 439 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   &helper.jmpbuf
# 439 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 3 4
   )
# 439 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
   ) { cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_stdio_src(cinfo, outfile); cinfo->client_data = helper.client_data; wrapErrorMgr(my_lib->w.bridge, cinfo->err);
}
# 451 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpegdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libjpegsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
{"jpeg_CreateCompress", vFpiu, 0},

{"jpeg_crop_scanline", vFppp, 0},
{"jpeg_default_colorspace", vFp, 0},
{"jpeg_default_qtables", vFpi, 0},
{"jpeg_destroy", vFp, 0},
{"jpeg_destroy_compress", vFp, 0},
{"jpeg_destroy_decompress", vFp, 0},




{"jpeg_finish_compress", vFp, 0},
...
# 88 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h"
{"jpeg_input_complete", iFp, 0},



{"jpeg_mem_dest", vFppp, 0},
...
static const map_onesymbol_t libjpegmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
static const map_onesymbol_t libjpegstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
static const map_onesymbol2_t libjpegsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
static const map_onedata_t libjpegdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
static const map_onedata_t libjpegmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpegundefs.h" 1
...
int wrappedlibjpeg_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        lib->w.lib = dlopen("libjpeg.so.62", 
...
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libjpegName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libjpegsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libjpegsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libjpegsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libjpegsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libjpegsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libjpegsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libjpegsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libjpegsymbolmap[i].name); }
 cnt = sizeof(libjpegmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libjpegmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libjpegmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libjpegmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libjpegmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libjpegmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libjpegmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libjpegmysymbolmap[i].name); }

    cnt = sizeof(libjpegstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libjpegstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libjpegstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libjpegstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libjpegstsymbolmap[i].name);
    }
    cnt = sizeof(libjpegsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libjpegsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libjpegsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libjpegsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libjpegsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libjpegsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libjpegsymbol2map[i].name);
    }
    cnt = sizeof(libjpegdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libjpegdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libjpegdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libjpegdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libjpegdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libjpegdatamap[i].sz;
        }
    }
    cnt = sizeof(libjpegmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libjpegmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libjpegmydatamap[i].sz;
    }

    my_bridge = lib->w.bridge; getMy(lib);


    return 0;
}

void wrappedlibjpeg_fini(library_t* lib)
{
...
# 452 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg.c" 2
