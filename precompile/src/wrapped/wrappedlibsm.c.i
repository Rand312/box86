# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsmtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsmtypes.h"
typedef int32_t (*iFppp_t)(void*, void*, void*);
typedef int32_t (*iFpipp_t)(void*, int32_t, void*, void*);
typedef void* (*pFppiiLpppip_t)(void*, void*, int32_t, int32_t, uintptr_t, void*, void*, void*, int32_t, void*);
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
typedef struct libsm_my_s {
    ...
    iFppp_t SmcRequestSaveYourselfPhase2; iFpipp_t SmcInteractRequest; pFppiiLpppip_t SmcOpenConnection;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libsm_my_t my_libsm = {0};
static libsm_my_t * const my = &my_libsm;

static void getMy(library_t* lib)
{

    my->SmcRequestSaveYourselfPhase2 = (iFppp_t)dlsym(lib->w.lib, "SmcRequestSaveYourselfPhase2"); my->SmcInteractRequest = (iFpipp_t)dlsym(lib->w.lib, "SmcInteractRequest"); my->SmcOpenConnection = (pFppiiLpppip_t)dlsym(lib->w.lib, "SmcOpenConnection");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
...
__attribute__((visibility("default"))) void* my_SmcOpenConnection(x86emu_t* emu, void* networkIdsList, void* context, int major, int minor, unsigned long mask, my_SmcCallbacks_t* cb, void* previousId, void* clientIdRet, int errorLength, void* errorRet)
{
    (void)emu;
    my_SmcCallbacks_t nat = {0};

    if(mask&(1L << 0)) {my_save_yourself_fct = (uintptr_t)cb->save_yourself.callback; nat.save_yourself.callback = my_save_yourself; nat.save_yourself.client_data=cb->save_yourself.client_data;}
    if(mask&(1L << 1)) {my_die_fct = (uintptr_t)cb->die.callback; nat.die.callback = my_die; nat.die.client_data=cb->die.client_data;}
    if(mask&(1L << 2)) {my_save_complete_fct = (uintptr_t)cb->save_complete.callback; nat.save_complete.callback = my_save_complete; nat.save_complete.client_data=cb->save_complete.client_data;}
    if(mask&(1L << 3)) {my_shutdown_cancelled_fct = (uintptr_t)cb->shutdown_cancelled.callback; nat.shutdown_cancelled.callback = my_shutdown_cancelled; nat.shutdown_cancelled.client_data=cb->shutdown_cancelled.client_data;}

    return my->SmcOpenConnection(networkIdsList, context, major, minor, mask, &nat, previousId, clientIdRet, errorLength, errorRet);
}
# 109 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c"
static uintptr_t my_Request_fct_0 = 0; static void my_Request_0(void* a, void* b) { RunFunctionFmt(my_Request_fct_0, "pp", a, b); } static uintptr_t my_Request_fct_1 = 0; static void my_Request_1(void* a, void* b) { RunFunctionFmt(my_Request_fct_1, "pp", a, b); } static uintptr_t my_Request_fct_2 = 0; static void my_Request_2(void* a, void* b) { RunFunctionFmt(my_Request_fct_2, "pp", a, b); } static uintptr_t my_Request_fct_3 = 0; static void my_Request_3(void* a, void* b) { RunFunctionFmt(my_Request_fct_3, "pp", a, b); } static uintptr_t my_Request_fct_4 = 0; static void my_Request_4(void* a, void* b) { RunFunctionFmt(my_Request_fct_4, "pp", a, b); }

static void* findRequestFct(void* fct)
{
    if(!fct) return 
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 3 4
                   ((void *)0)
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c"
                       ;
    void* p;
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSM Request callback\n"); fflush(ftrace);}} while(0);
    return 
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 3 4
          ((void *)0)
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c"
              ;
}



__attribute__((visibility("default"))) int my_SmcInteractRequest(x86emu_t* emu, void* smcConn, int f, void* cb, void* data)
{
    (void)emu;
    return my->SmcInteractRequest(smcConn, f, findRequestFct(cb), data);
}

__attribute__((visibility("default"))) int my_SmcRequestSaveYourselfPhase2(x86emu_t* emu, void* smcConn, void* cb, void* data)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsmdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsmsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1




{"SmcClientID", pFp, 0},
{"SmcCloseConnection", iFpip, 0},
{"_SmcDefaultErrorHandler", vFpiiliip, 0},
{"SmcDeleteProperties", vFpip, 0},
{"SmcGetIceConnection", pFp, 0},

{"SmcInteractDone", iFpi, 0},




{"SmcProtocolRevision", iFp, 0},
{"SmcProtocolVersion", iFp, 0},
{"SmcRelease", pFp, 0},
{"SmcRequestSaveYourself", vFpiiiii, 0},

{"SmcSaveYourselfDone", vFpi, 0},

{"SmcSetProperties", vFpip, 0},
{"SmcVendor", pFp, 0},
{"SmFreeProperty", vFp, 0},
{"SmFreeReasons", vFpp, 0},
{"SmsCleanUp", vFp, 0},
{"SmsClientHostName", pFp, 0},
{"SmsClientID", pFp, 0},
{"_SmsDefaultErrorHandler", vFpiiliip, 0},
{"SmsDie", vFp, 0},
{"SmsGenerateClientID", pFp, 0},
{"SmsGetIceConnection", pFp, 0},

{"SmsInteract", vFp, 0},

{"SmsProtocolRevision", iFp, 0},
{"SmsProtocolVersion", iFp, 0},
{"SmsRegisterClientReply", iFpp, 0},
{"SmsReturnProperties", vFpip, 0},
{"SmsSaveComplete", vFp, 0},
{"SmsSaveYourself", vFpiiii, 0},
{"SmsSaveYourselfPhase2", vFp, 0},

{"SmsShutdownCancelled", vFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsmmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1
...
{"SmcInteractRequest", iFEpipp, 0},

{"SmcOpenConnection", pFEppiiLpppip, 0},





{"SmcRequestSaveYourselfPhase2", iFEppp, 0},
...
static const map_onesymbol_t libsmstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1
...
static const map_onesymbol2_t libsmsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1
...
static const map_onedata_t libsmdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1
...
static const map_onedata_t libsmmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsmundefs.h" 1
...
int wrappedlibsm_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libsmName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libsmsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsmsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libsmsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libsmsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libsmsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libsmsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libsmsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsmsymbolmap[i].name); }
 cnt = sizeof(libsmmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsmmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libsmmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libsmmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libsmmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libsmmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libsmmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsmmysymbolmap[i].name); }

    cnt = sizeof(libsmstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libsmstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libsmstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libsmstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libsmstsymbolmap[i].name);
    }
    cnt = sizeof(libsmsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libsmsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libsmsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libsmsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libsmsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libsmsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libsmsymbol2map[i].name);
    }
    cnt = sizeof(libsmdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libsmdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libsmdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libsmdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libsmdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libsmdatamap[i].sz;
        }
    }
    cnt = sizeof(libsmmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libsmmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libsmmydatamap[i].sz;
    }
...
void wrappedlibsm_fini(library_t* lib)
{
...
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibsm.c" 2
