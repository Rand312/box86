# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedtcmallocminimaldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t tcmallocminimalsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1




{"aligned_alloc", pFuu, 0},
{"calloc", pFLL, 0},
{"cfree", vFp, 0},
...
{"malloc", pFL, 0},
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h"
{"malloc_size", LFp, 0},
{"malloc_stats", vFv, 0},
{"malloc_usable_size", LFp, 0},
{"mallopt", iFii, 0},
{"memalign", pFuu, 0},
...
{"nallocx", LFLi, 0},
{"__posix_memalign", iFpuu, 0},
{"posix_memalign", iFpuu, 0},

{"sbrk", pFl, 0},
# 122 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h"
{"valloc", pFu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t tcmallocminimalmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1
...
static const map_onesymbol_t tcmallocminimalstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1
...
static const map_onesymbol2_t tcmallocminimalsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1
...
static const map_onedata_t tcmallocminimaldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1
...
static const map_onedata_t tcmallocminimalmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedtcmallocminimalundefs.h" 1
...
int wrappedtcmallocminimal_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(tcmallocminimalName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(tcmallocminimalName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(tcmallocminimalsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (tcmallocminimalsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, tcmallocminimalsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = tcmallocminimalsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, tcmallocminimalsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = tcmallocminimalsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(tcmallocminimalsymbolmap[i].name, '@')) AddDictionnary(box86->versym, tcmallocminimalsymbolmap[i].name); }
 cnt = sizeof(tcmallocminimalmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (tcmallocminimalmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, tcmallocminimalmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = tcmallocminimalmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, tcmallocminimalmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = tcmallocminimalmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(tcmallocminimalmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, tcmallocminimalmysymbolmap[i].name); }

    cnt = sizeof(tcmallocminimalstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, tcmallocminimalstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = tcmallocminimalstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(tcmallocminimalstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, tcmallocminimalstsymbolmap[i].name);
    }
    cnt = sizeof(tcmallocminimalsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, tcmallocminimalsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = tcmallocminimalsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = tcmallocminimalsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = tcmallocminimalsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(tcmallocminimalsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, tcmallocminimalsymbol2map[i].name);
    }
    cnt = sizeof(tcmallocminimaldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(tcmallocminimaldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, tcmallocminimaldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = tcmallocminimaldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, tcmallocminimaldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = tcmallocminimaldatamap[i].sz;
        }
    }
    cnt = sizeof(tcmallocminimalmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, tcmallocminimalmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = tcmallocminimalmydatamap[i].sz;
    }
...
void wrappedtcmallocminimal_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedtcmallocminimal.c" 2
