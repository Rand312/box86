# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxtsttypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxtsttypes.h"
typedef int32_t (*iFpppp_t)(void*, void*, void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
...
typedef struct libxtst_my_s {
    ...
    iFpppp_t XRecordEnableContext; iFpppp_t XRecordEnableContextAsync;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libxtst_my_t my_libxtst = {0};
static libxtst_my_t * const my = &my_libxtst;

static void getMy(library_t* lib)
{

    my->XRecordEnableContext = (iFpppp_t)dlsym(lib->w.lib, "XRecordEnableContext"); my->XRecordEnableContextAsync = (iFpppp_t)dlsym(lib->w.lib, "XRecordEnableContextAsync");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
# 48 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c"
static uintptr_t my_XRecordInterceptProc_fct_0 = 0; static void my_XRecordInterceptProc_0(void* a, void* b) { RunFunctionFmt(my_XRecordInterceptProc_fct_0, "pp", a, b);} static uintptr_t my_XRecordInterceptProc_fct_1 = 0; static void my_XRecordInterceptProc_1(void* a, void* b) { RunFunctionFmt(my_XRecordInterceptProc_fct_1, "pp", a, b);} static uintptr_t my_XRecordInterceptProc_fct_2 = 0; static void my_XRecordInterceptProc_2(void* a, void* b) { RunFunctionFmt(my_XRecordInterceptProc_fct_2, "pp", a, b);} static uintptr_t my_XRecordInterceptProc_fct_3 = 0; static void my_XRecordInterceptProc_3(void* a, void* b) { RunFunctionFmt(my_XRecordInterceptProc_fct_3, "pp", a, b);} static uintptr_t my_XRecordInterceptProc_fct_4 = 0; static void my_XRecordInterceptProc_4(void* a, void* b) { RunFunctionFmt(my_XRecordInterceptProc_fct_4, "pp", a, b);}
...
static void* find_XRecordInterceptProc_Fct(void* fct)
{
    ...
    if(my_XRecordInterceptProc_fct_0 == (uintptr_t)fct) return my_XRecordInterceptProc_0; if(my_XRecordInterceptProc_fct_1 == (uintptr_t)fct) return my_XRecordInterceptProc_1; if(my_XRecordInterceptProc_fct_2 == (uintptr_t)fct) return my_XRecordInterceptProc_2; if(my_XRecordInterceptProc_fct_3 == (uintptr_t)fct) return my_XRecordInterceptProc_3; if(my_XRecordInterceptProc_fct_4 == (uintptr_t)fct) return my_XRecordInterceptProc_4;


    if(my_XRecordInterceptProc_fct_0 == 0) {my_XRecordInterceptProc_fct_0 = (uintptr_t)fct; return my_XRecordInterceptProc_0; } if(my_XRecordInterceptProc_fct_1 == 0) {my_XRecordInterceptProc_fct_1 = (uintptr_t)fct; return my_XRecordInterceptProc_1; } if(my_XRecordInterceptProc_fct_2 == 0) {my_XRecordInterceptProc_fct_2 = (uintptr_t)fct; return my_XRecordInterceptProc_2; } if(my_XRecordInterceptProc_fct_3 == 0) {my_XRecordInterceptProc_fct_3 = (uintptr_t)fct; return my_XRecordInterceptProc_3; } if(my_XRecordInterceptProc_fct_4 == 0) {my_XRecordInterceptProc_fct_4 = (uintptr_t)fct; return my_XRecordInterceptProc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libxtst XRecordInterceptProc callback\n"); fflush(ftrace);}} while(0);
    return 
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 3 4
          ((void *)0)
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c"
              ;
}

__attribute__((visibility("default"))) int my_XRecordEnableContextAsync(x86emu_t* emu, void* display, void* context, void* cb, void* closure)
{
    (void)emu;
    return my->XRecordEnableContextAsync(display, context, find_XRecordInterceptProc_Fct(cb), closure);
}

__attribute__((visibility("default"))) int my_XRecordEnableContext(x86emu_t* emu, void* display, void* context, void* cb, void* closure)
{
    (void)emu;
    return my->XRecordEnableContext(display, context, find_XRecordInterceptProc_Fct(cb), closure);
}
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxtstdefs.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1




{"XRecordAllocRange", pFv, 0},
{"XRecordCreateContext", LFpipipi, 0},
{"XRecordDisableContext", iFpL, 0},


{"XRecordFreeContext", iFpL, 0},
{"XRecordFreeData", vFp, 0},
{"XRecordFreeState", vFp, 0},
{"XRecordGetContext", iFpLp, 0},
{"XRecordIdBaseMask", uFp, 0},
{"XRecordProcessReplies", vFp, 0},
{"XRecordQueryVersion", iFpii, 0},
{"XRecordRegisterClients", iFpLipipi, 0},
{"XRecordUnregisterClients", iFpLpi, 0},
{"XTestCompareCurrentCursorWithWindow", iFpp, 0},
{"XTestCompareCursorWithWindow", iFppp, 0},
{"XTestDiscard", iFp, 0},
{"XTestFakeButtonEvent", iFpuiL, 0},
{"XTestFakeDeviceButtonEvent", iFppuipiL, 0},
{"XTestFakeDeviceKeyEvent", iFppuipiL, 0},
{"XTestFakeDeviceMotionEvent", iFppiipiL, 0},
{"XTestFakeKeyEvent", iFpuiL, 0},
{"XTestFakeMotionEvent", iFpiiiL, 0},
{"XTestFakeProximityEvent", iFppipiL, 0},
{"XTestFakeRelativeMotionEvent", iFpiiiL, 0},
{"XTestGrabControl", iFpi, 0},
{"XTestQueryExtension", iFppppp, 0},
{"XTestSetGContextOfGC", vFpp, 0},
{"XTestSetVisualIDOfVisual", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxtstmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1
...
{"XRecordEnableContext", iFEpppp, 0},
{"XRecordEnableContextAsync", iFEpppp, 0},
...
static const map_onesymbol_t libxtststsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1
...
static const map_onesymbol2_t libxtstsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1
...
static const map_onedata_t libxtstdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1
...
static const map_onedata_t libxtstmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxtstundefs.h" 1
...
int wrappedlibxtst_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxtstName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxtstsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxtstsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxtstsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxtstsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxtstsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxtstsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxtstsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxtstsymbolmap[i].name); }
 cnt = sizeof(libxtstmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxtstmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxtstmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxtstmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxtstmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxtstmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxtstmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxtstmysymbolmap[i].name); }

    cnt = sizeof(libxtststsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxtststsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxtststsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxtststsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxtststsymbolmap[i].name);
    }
    cnt = sizeof(libxtstsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxtstsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxtstsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxtstsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxtstsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxtstsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxtstsymbol2map[i].name);
    }
    cnt = sizeof(libxtstdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxtstdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxtstdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxtstdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxtstdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxtstdatamap[i].sz;
        }
    }
    cnt = sizeof(libxtstmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxtstmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxtstmydatamap[i].sz;
    }
...
void wrappedlibxtst_fini(library_t* lib)
{
...
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxtst.c" 2
