# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibssltypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibssltypes.h"
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
...
typedef struct libssl_my_s {
    ...
    vFpp_t SSL_CTX_sess_set_new_cb; vFpp_t SSL_CTX_set_default_passwd_cb; vFpp_t SSL_set_psk_client_callback; vFpip_t SSL_CTX_set_verify; vFpip_t SSL_set_verify; vFppp_t SSL_CTX_set_next_proto_select_cb; lFpip_t SSL_CTX_callback_ctrl; lFpip_t SSL_callback_ctrl; iFlpppp_t SSL_get_ex_new_index;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libssl_my_t my_libssl = {0};
static libssl_my_t * const my = &my_libssl;

static void getMy(library_t* lib)
{

    my->SSL_CTX_sess_set_new_cb = (vFpp_t)dlsym(lib->w.lib, "SSL_CTX_sess_set_new_cb"); my->SSL_CTX_set_default_passwd_cb = (vFpp_t)dlsym(lib->w.lib, "SSL_CTX_set_default_passwd_cb"); my->SSL_set_psk_client_callback = (vFpp_t)dlsym(lib->w.lib, "SSL_set_psk_client_callback"); my->SSL_CTX_set_verify = (vFpip_t)dlsym(lib->w.lib, "SSL_CTX_set_verify"); my->SSL_set_verify = (vFpip_t)dlsym(lib->w.lib, "SSL_set_verify"); my->SSL_CTX_set_next_proto_select_cb = (vFppp_t)dlsym(lib->w.lib, "SSL_CTX_set_next_proto_select_cb"); my->SSL_CTX_callback_ctrl = (lFpip_t)dlsym(lib->w.lib, "SSL_CTX_callback_ctrl"); my->SSL_callback_ctrl = (lFpip_t)dlsym(lib->w.lib, "SSL_callback_ctrl"); my->SSL_get_ex_new_index = (iFlpppp_t)dlsym(lib->w.lib, "SSL_get_ex_new_index");
...
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
# 46 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_pem_passwd_cb_fct_0 = 0; static int my_pem_passwd_cb_0(void* buf, int size, int rwflag, void* password) { return (int)RunFunctionFmt(my_pem_passwd_cb_fct_0, "piip", buf, size, rwflag, password); } static uintptr_t my_pem_passwd_cb_fct_1 = 0; static int my_pem_passwd_cb_1(void* buf, int size, int rwflag, void* password) { return (int)RunFunctionFmt(my_pem_passwd_cb_fct_1, "piip", buf, size, rwflag, password); } static uintptr_t my_pem_passwd_cb_fct_2 = 0; static int my_pem_passwd_cb_2(void* buf, int size, int rwflag, void* password) { return (int)RunFunctionFmt(my_pem_passwd_cb_fct_2, "piip", buf, size, rwflag, password); } static uintptr_t my_pem_passwd_cb_fct_3 = 0; static int my_pem_passwd_cb_3(void* buf, int size, int rwflag, void* password) { return (int)RunFunctionFmt(my_pem_passwd_cb_fct_3, "piip", buf, size, rwflag, password); } static uintptr_t my_pem_passwd_cb_fct_4 = 0; static int my_pem_passwd_cb_4(void* buf, int size, int rwflag, void* password) { return (int)RunFunctionFmt(my_pem_passwd_cb_fct_4, "piip", buf, size, rwflag, password); }

static void* find_pem_passwd_cb_Fct(void* fct)
{
    if(!fct) return 
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_pem_passwd_cb_fct_0 == (uintptr_t)fct) return my_pem_passwd_cb_0; if(my_pem_passwd_cb_fct_1 == (uintptr_t)fct) return my_pem_passwd_cb_1; if(my_pem_passwd_cb_fct_2 == (uintptr_t)fct) return my_pem_passwd_cb_2; if(my_pem_passwd_cb_fct_3 == (uintptr_t)fct) return my_pem_passwd_cb_3; if(my_pem_passwd_cb_fct_4 == (uintptr_t)fct) return my_pem_passwd_cb_4;


    if(my_pem_passwd_cb_fct_0 == 0) {my_pem_passwd_cb_fct_0 = (uintptr_t)fct; return my_pem_passwd_cb_0; } if(my_pem_passwd_cb_fct_1 == 0) {my_pem_passwd_cb_fct_1 = (uintptr_t)fct; return my_pem_passwd_cb_1; } if(my_pem_passwd_cb_fct_2 == 0) {my_pem_passwd_cb_fct_2 = (uintptr_t)fct; return my_pem_passwd_cb_2; } if(my_pem_passwd_cb_fct_3 == 0) {my_pem_passwd_cb_fct_3 = (uintptr_t)fct; return my_pem_passwd_cb_3; } if(my_pem_passwd_cb_fct_4 == 0) {my_pem_passwd_cb_fct_4 = (uintptr_t)fct; return my_pem_passwd_cb_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL pem_passwd_cb callback\n"); fflush(ftrace);}} while(0);
    return 
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 70 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_anonymous_fct_0 = 0; static void* my_anonymous_0(void* a, void* b, void* c, void *d) { return (void*)RunFunctionFmt(my_anonymous_fct_0, "pppp", a, b, c, d); } static uintptr_t my_anonymous_fct_1 = 0; static void* my_anonymous_1(void* a, void* b, void* c, void *d) { return (void*)RunFunctionFmt(my_anonymous_fct_1, "pppp", a, b, c, d); } static uintptr_t my_anonymous_fct_2 = 0; static void* my_anonymous_2(void* a, void* b, void* c, void *d) { return (void*)RunFunctionFmt(my_anonymous_fct_2, "pppp", a, b, c, d); } static uintptr_t my_anonymous_fct_3 = 0; static void* my_anonymous_3(void* a, void* b, void* c, void *d) { return (void*)RunFunctionFmt(my_anonymous_fct_3, "pppp", a, b, c, d); } static uintptr_t my_anonymous_fct_4 = 0; static void* my_anonymous_4(void* a, void* b, void* c, void *d) { return (void*)RunFunctionFmt(my_anonymous_fct_4, "pppp", a, b, c, d); }

static void* find_anonymous_Fct(void* fct)
{
    if(!fct) return 
# 74 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 74 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_anonymous_fct_0 == (uintptr_t)fct) return my_anonymous_0; if(my_anonymous_fct_1 == (uintptr_t)fct) return my_anonymous_1; if(my_anonymous_fct_2 == (uintptr_t)fct) return my_anonymous_2; if(my_anonymous_fct_3 == (uintptr_t)fct) return my_anonymous_3; if(my_anonymous_fct_4 == (uintptr_t)fct) return my_anonymous_4;


    if(my_anonymous_fct_0 == 0) {my_anonymous_fct_0 = (uintptr_t)fct; return my_anonymous_0; } if(my_anonymous_fct_1 == 0) {my_anonymous_fct_1 = (uintptr_t)fct; return my_anonymous_1; } if(my_anonymous_fct_2 == 0) {my_anonymous_fct_2 = (uintptr_t)fct; return my_anonymous_2; } if(my_anonymous_fct_3 == 0) {my_anonymous_fct_3 = (uintptr_t)fct; return my_anonymous_3; } if(my_anonymous_fct_4 == 0) {my_anonymous_fct_4 = (uintptr_t)fct; return my_anonymous_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL anonymous callback\n"); fflush(ftrace);}} while(0);
    return 
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 95 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_verify_fct_0 = 0; static int my_verify_0(int a, void* b) { return (int)RunFunctionFmt(my_verify_fct_0, "pp", a, b); } static uintptr_t my_verify_fct_1 = 0; static int my_verify_1(int a, void* b) { return (int)RunFunctionFmt(my_verify_fct_1, "pp", a, b); } static uintptr_t my_verify_fct_2 = 0; static int my_verify_2(int a, void* b) { return (int)RunFunctionFmt(my_verify_fct_2, "pp", a, b); } static uintptr_t my_verify_fct_3 = 0; static int my_verify_3(int a, void* b) { return (int)RunFunctionFmt(my_verify_fct_3, "pp", a, b); } static uintptr_t my_verify_fct_4 = 0; static int my_verify_4(int a, void* b) { return (int)RunFunctionFmt(my_verify_fct_4, "pp", a, b); }

static void* find_verify_Fct(void* fct)
{
    if(!fct) return 
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_verify_fct_0 == (uintptr_t)fct) return my_verify_0; if(my_verify_fct_1 == (uintptr_t)fct) return my_verify_1; if(my_verify_fct_2 == (uintptr_t)fct) return my_verify_2; if(my_verify_fct_3 == (uintptr_t)fct) return my_verify_3; if(my_verify_fct_4 == (uintptr_t)fct) return my_verify_4;


    if(my_verify_fct_0 == 0) {my_verify_fct_0 = (uintptr_t)fct; return my_verify_0; } if(my_verify_fct_1 == 0) {my_verify_fct_1 = (uintptr_t)fct; return my_verify_1; } if(my_verify_fct_2 == 0) {my_verify_fct_2 = (uintptr_t)fct; return my_verify_2; } if(my_verify_fct_3 == 0) {my_verify_fct_3 = (uintptr_t)fct; return my_verify_3; } if(my_verify_fct_4 == 0) {my_verify_fct_4 = (uintptr_t)fct; return my_verify_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL verify callback\n"); fflush(ftrace);}} while(0);
    return 
# 109 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 109 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 119 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_ex_new_fct_0 = 0; static void my_ex_new_0(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_new_fct_0, "pppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_new_fct_1 = 0; static void my_ex_new_1(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_new_fct_1, "pppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_new_fct_2 = 0; static void my_ex_new_2(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_new_fct_2, "pppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_new_fct_3 = 0; static void my_ex_new_3(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_new_fct_3, "pppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_new_fct_4 = 0; static void my_ex_new_4(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_new_fct_4, "pppilp", parent, ptr, ad, idx, argl, argp); }

static void* find_ex_new_Fct(void* fct)
{
    if(!fct) return 
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_ex_new_fct_0 == (uintptr_t)fct) return my_ex_new_0; if(my_ex_new_fct_1 == (uintptr_t)fct) return my_ex_new_1; if(my_ex_new_fct_2 == (uintptr_t)fct) return my_ex_new_2; if(my_ex_new_fct_3 == (uintptr_t)fct) return my_ex_new_3; if(my_ex_new_fct_4 == (uintptr_t)fct) return my_ex_new_4;


    if(my_ex_new_fct_0 == 0) {my_ex_new_fct_0 = (uintptr_t)fct; return my_ex_new_0; } if(my_ex_new_fct_1 == 0) {my_ex_new_fct_1 = (uintptr_t)fct; return my_ex_new_1; } if(my_ex_new_fct_2 == 0) {my_ex_new_fct_2 = (uintptr_t)fct; return my_ex_new_2; } if(my_ex_new_fct_3 == 0) {my_ex_new_fct_3 = (uintptr_t)fct; return my_ex_new_3; } if(my_ex_new_fct_4 == 0) {my_ex_new_fct_4 = (uintptr_t)fct; return my_ex_new_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL ex_new callback\n"); fflush(ftrace);}} while(0);
    return 
# 133 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 133 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_ex_free_fct_0 = 0; static void my_ex_free_0(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_free_fct_0, "ppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_free_fct_1 = 0; static void my_ex_free_1(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_free_fct_1, "ppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_free_fct_2 = 0; static void my_ex_free_2(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_free_fct_2, "ppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_free_fct_3 = 0; static void my_ex_free_3(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_free_fct_3, "ppilp", parent, ptr, ad, idx, argl, argp); } static uintptr_t my_ex_free_fct_4 = 0; static void my_ex_free_4(void* parent, void* ptr, void* ad, int idx, long argl, void* argp) { RunFunctionFmt(my_ex_free_fct_4, "ppilp", parent, ptr, ad, idx, argl, argp); }

static void* find_ex_free_Fct(void* fct)
{
    if(!fct) return 
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_ex_free_fct_0 == (uintptr_t)fct) return my_ex_free_0; if(my_ex_free_fct_1 == (uintptr_t)fct) return my_ex_free_1; if(my_ex_free_fct_2 == (uintptr_t)fct) return my_ex_free_2; if(my_ex_free_fct_3 == (uintptr_t)fct) return my_ex_free_3; if(my_ex_free_fct_4 == (uintptr_t)fct) return my_ex_free_4;


    if(my_ex_free_fct_0 == 0) {my_ex_free_fct_0 = (uintptr_t)fct; return my_ex_free_0; } if(my_ex_free_fct_1 == 0) {my_ex_free_fct_1 = (uintptr_t)fct; return my_ex_free_1; } if(my_ex_free_fct_2 == 0) {my_ex_free_fct_2 = (uintptr_t)fct; return my_ex_free_2; } if(my_ex_free_fct_3 == 0) {my_ex_free_fct_3 = (uintptr_t)fct; return my_ex_free_3; } if(my_ex_free_fct_4 == 0) {my_ex_free_fct_4 = (uintptr_t)fct; return my_ex_free_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL ex_free callback\n"); fflush(ftrace);}} while(0);
    return 
# 157 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 157 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 167 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_ex_dup_fct_0 = 0; static int my_ex_dup_0(void* to, void* from, void* from_d, int idx, long argl, void* argp) { return (int) RunFunctionFmt(my_ex_dup_fct_0, "pppilp", to, from, from_d, idx, argl, argp);} static uintptr_t my_ex_dup_fct_1 = 0; static int my_ex_dup_1(void* to, void* from, void* from_d, int idx, long argl, void* argp) { return (int) RunFunctionFmt(my_ex_dup_fct_1, "pppilp", to, from, from_d, idx, argl, argp);} static uintptr_t my_ex_dup_fct_2 = 0; static int my_ex_dup_2(void* to, void* from, void* from_d, int idx, long argl, void* argp) { return (int) RunFunctionFmt(my_ex_dup_fct_2, "pppilp", to, from, from_d, idx, argl, argp);} static uintptr_t my_ex_dup_fct_3 = 0; static int my_ex_dup_3(void* to, void* from, void* from_d, int idx, long argl, void* argp) { return (int) RunFunctionFmt(my_ex_dup_fct_3, "pppilp", to, from, from_d, idx, argl, argp);} static uintptr_t my_ex_dup_fct_4 = 0; static int my_ex_dup_4(void* to, void* from, void* from_d, int idx, long argl, void* argp) { return (int) RunFunctionFmt(my_ex_dup_fct_4, "pppilp", to, from, from_d, idx, argl, argp);}

static void* find_ex_dup_Fct(void* fct)
{
    if(!fct) return 
# 171 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 171 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_ex_dup_fct_0 == (uintptr_t)fct) return my_ex_dup_0; if(my_ex_dup_fct_1 == (uintptr_t)fct) return my_ex_dup_1; if(my_ex_dup_fct_2 == (uintptr_t)fct) return my_ex_dup_2; if(my_ex_dup_fct_3 == (uintptr_t)fct) return my_ex_dup_3; if(my_ex_dup_fct_4 == (uintptr_t)fct) return my_ex_dup_4;


    if(my_ex_dup_fct_0 == 0) {my_ex_dup_fct_0 = (uintptr_t)fct; return my_ex_dup_0; } if(my_ex_dup_fct_1 == 0) {my_ex_dup_fct_1 = (uintptr_t)fct; return my_ex_dup_1; } if(my_ex_dup_fct_2 == 0) {my_ex_dup_fct_2 = (uintptr_t)fct; return my_ex_dup_2; } if(my_ex_dup_fct_3 == 0) {my_ex_dup_fct_3 = (uintptr_t)fct; return my_ex_dup_3; } if(my_ex_dup_fct_4 == 0) {my_ex_dup_fct_4 = (uintptr_t)fct; return my_ex_dup_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL ex_dup callback\n"); fflush(ftrace);}} while(0);
    return 
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 191 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_client_cb_fct_0 = 0; static uint32_t my_client_cb_0(void* ssl, void* hint, void* identity, uint32_t id_len, void* psk, uint32_t psk_len) { return RunFunctionFmt(my_client_cb_fct_0, "pppupu", ssl, hint, identity, id_len, psk, psk_len); } static uintptr_t my_client_cb_fct_1 = 0; static uint32_t my_client_cb_1(void* ssl, void* hint, void* identity, uint32_t id_len, void* psk, uint32_t psk_len) { return RunFunctionFmt(my_client_cb_fct_1, "pppupu", ssl, hint, identity, id_len, psk, psk_len); } static uintptr_t my_client_cb_fct_2 = 0; static uint32_t my_client_cb_2(void* ssl, void* hint, void* identity, uint32_t id_len, void* psk, uint32_t psk_len) { return RunFunctionFmt(my_client_cb_fct_2, "pppupu", ssl, hint, identity, id_len, psk, psk_len); } static uintptr_t my_client_cb_fct_3 = 0; static uint32_t my_client_cb_3(void* ssl, void* hint, void* identity, uint32_t id_len, void* psk, uint32_t psk_len) { return RunFunctionFmt(my_client_cb_fct_3, "pppupu", ssl, hint, identity, id_len, psk, psk_len); } static uintptr_t my_client_cb_fct_4 = 0; static uint32_t my_client_cb_4(void* ssl, void* hint, void* identity, uint32_t id_len, void* psk, uint32_t psk_len) { return RunFunctionFmt(my_client_cb_fct_4, "pppupu", ssl, hint, identity, id_len, psk, psk_len); }

static void* find_client_cb_Fct(void* fct)
{
    if(!fct) return 
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_client_cb_fct_0 == (uintptr_t)fct) return my_client_cb_0; if(my_client_cb_fct_1 == (uintptr_t)fct) return my_client_cb_1; if(my_client_cb_fct_2 == (uintptr_t)fct) return my_client_cb_2; if(my_client_cb_fct_3 == (uintptr_t)fct) return my_client_cb_3; if(my_client_cb_fct_4 == (uintptr_t)fct) return my_client_cb_4;


    if(my_client_cb_fct_0 == 0) {my_client_cb_fct_0 = (uintptr_t)fct; return my_client_cb_0; } if(my_client_cb_fct_1 == 0) {my_client_cb_fct_1 = (uintptr_t)fct; return my_client_cb_1; } if(my_client_cb_fct_2 == 0) {my_client_cb_fct_2 = (uintptr_t)fct; return my_client_cb_2; } if(my_client_cb_fct_3 == 0) {my_client_cb_fct_3 = (uintptr_t)fct; return my_client_cb_3; } if(my_client_cb_fct_4 == 0) {my_client_cb_fct_4 = (uintptr_t)fct; return my_client_cb_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL client_cb callback\n"); fflush(ftrace);}} while(0);
    return 
# 205 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 205 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
# 215 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
static uintptr_t my_proto_select_fct_0 = 0; static int my_proto_select_0(void* s, void* out, void* outlen, void* in, uint32_t inlen, void* arg) { return (int)RunFunctionFmt(my_proto_select_fct_0, "ppppup", s, out, outlen, in, inlen, arg); } static uintptr_t my_proto_select_fct_1 = 0; static int my_proto_select_1(void* s, void* out, void* outlen, void* in, uint32_t inlen, void* arg) { return (int)RunFunctionFmt(my_proto_select_fct_1, "ppppup", s, out, outlen, in, inlen, arg); } static uintptr_t my_proto_select_fct_2 = 0; static int my_proto_select_2(void* s, void* out, void* outlen, void* in, uint32_t inlen, void* arg) { return (int)RunFunctionFmt(my_proto_select_fct_2, "ppppup", s, out, outlen, in, inlen, arg); } static uintptr_t my_proto_select_fct_3 = 0; static int my_proto_select_3(void* s, void* out, void* outlen, void* in, uint32_t inlen, void* arg) { return (int)RunFunctionFmt(my_proto_select_fct_3, "ppppup", s, out, outlen, in, inlen, arg); } static uintptr_t my_proto_select_fct_4 = 0; static int my_proto_select_4(void* s, void* out, void* outlen, void* in, uint32_t inlen, void* arg) { return (int)RunFunctionFmt(my_proto_select_fct_4, "ppppup", s, out, outlen, in, inlen, arg); }

static void* find_proto_select_Fct(void* fct)
{
    if(!fct) return 
# 219 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 219 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_proto_select_fct_0 == (uintptr_t)fct) return my_proto_select_0; if(my_proto_select_fct_1 == (uintptr_t)fct) return my_proto_select_1; if(my_proto_select_fct_2 == (uintptr_t)fct) return my_proto_select_2; if(my_proto_select_fct_3 == (uintptr_t)fct) return my_proto_select_3; if(my_proto_select_fct_4 == (uintptr_t)fct) return my_proto_select_4;


    if(my_proto_select_fct_0 == 0) {my_proto_select_fct_0 = (uintptr_t)fct; return my_proto_select_0; } if(my_proto_select_fct_1 == 0) {my_proto_select_fct_1 = (uintptr_t)fct; return my_proto_select_1; } if(my_proto_select_fct_2 == 0) {my_proto_select_fct_2 = (uintptr_t)fct; return my_proto_select_2; } if(my_proto_select_fct_3 == 0) {my_proto_select_fct_3 = (uintptr_t)fct; return my_proto_select_3; } if(my_proto_select_fct_4 == 0) {my_proto_select_fct_4 = (uintptr_t)fct; return my_proto_select_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL proto_select callback\n"); fflush(ftrace);}} while(0);
    return 
# 229 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 229 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}
...
static uintptr_t my_new_session_cb_fct_0 = 0; static int my_new_session_cb_0(void* a, void* b) { return (int)RunFunctionFmt(my_new_session_cb_fct_0, "pp", a, b); } static uintptr_t my_new_session_cb_fct_1 = 0; static int my_new_session_cb_1(void* a, void* b) { return (int)RunFunctionFmt(my_new_session_cb_fct_1, "pp", a, b); } static uintptr_t my_new_session_cb_fct_2 = 0; static int my_new_session_cb_2(void* a, void* b) { return (int)RunFunctionFmt(my_new_session_cb_fct_2, "pp", a, b); } static uintptr_t my_new_session_cb_fct_3 = 0; static int my_new_session_cb_3(void* a, void* b) { return (int)RunFunctionFmt(my_new_session_cb_fct_3, "pp", a, b); } static uintptr_t my_new_session_cb_fct_4 = 0; static int my_new_session_cb_4(void* a, void* b) { return (int)RunFunctionFmt(my_new_session_cb_fct_4, "pp", a, b); }

static void* find_new_session_cb_Fct(void* fct)
{
    if(!fct) return 
# 242 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
                   ((void *)0)
# 242 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_new_session_cb_fct_0 == (uintptr_t)fct) return my_new_session_cb_0; if(my_new_session_cb_fct_1 == (uintptr_t)fct) return my_new_session_cb_1; if(my_new_session_cb_fct_2 == (uintptr_t)fct) return my_new_session_cb_2; if(my_new_session_cb_fct_3 == (uintptr_t)fct) return my_new_session_cb_3; if(my_new_session_cb_fct_4 == (uintptr_t)fct) return my_new_session_cb_4;


    if(my_new_session_cb_fct_0 == 0) {my_new_session_cb_fct_0 = (uintptr_t)fct; return my_new_session_cb_0; } if(my_new_session_cb_fct_1 == 0) {my_new_session_cb_fct_1 = (uintptr_t)fct; return my_new_session_cb_1; } if(my_new_session_cb_fct_2 == 0) {my_new_session_cb_fct_2 = (uintptr_t)fct; return my_new_session_cb_2; } if(my_new_session_cb_fct_3 == 0) {my_new_session_cb_fct_3 = (uintptr_t)fct; return my_new_session_cb_3; } if(my_new_session_cb_fct_4 == 0) {my_new_session_cb_fct_4 = (uintptr_t)fct; return my_new_session_cb_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libSSL new_session_cb callback\n"); fflush(ftrace);}} while(0);
    return 
# 252 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 3 4
          ((void *)0)
# 252 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
              ;
}



__attribute__((visibility("default"))) void my_SSL_CTX_set_default_passwd_cb(x86emu_t* emu, void* ctx, void* cb)
{
    (void)emu;
    my->SSL_CTX_set_default_passwd_cb(ctx, find_pem_passwd_cb_Fct(cb));
}

__attribute__((visibility("default"))) long my_SSL_CTX_callback_ctrl(x86emu_t* emu, void* ctx, int cmd, void* f)
{
    (void)emu;
    return my->SSL_CTX_callback_ctrl(ctx, cmd, find_anonymous_Fct(f));
}

__attribute__((visibility("default"))) long my_SSL_callback_ctrl(x86emu_t* emu, void* ctx, int cmd, void* f)
{
    (void)emu;
    return my->SSL_callback_ctrl(ctx, cmd, find_anonymous_Fct(f));
}

__attribute__((visibility("default"))) void my_SSL_CTX_set_verify(x86emu_t* emu, void* ctx, int mode, void* f)
{
    (void)emu;
    my->SSL_CTX_set_verify(ctx, mode, find_verify_Fct(f));
}

__attribute__((visibility("default"))) void my_SSL_set_verify(x86emu_t* emu, void* ctx, int mode, void* f)
{
    (void)emu;
    my->SSL_set_verify(ctx, mode, find_verify_Fct(f));
}

__attribute__((visibility("default"))) void my_SSL_get_ex_new_index(x86emu_t* emu, long argl, void* argp, void* new_func, void* dup_func, void* free_func)
{
    (void)emu;
    my->SSL_get_ex_new_index(argl, argp, find_ex_new_Fct(new_func), find_ex_dup_Fct(dup_func), find_ex_free_Fct(free_func));
}

__attribute__((visibility("default"))) void my_SSL_set_psk_client_callback(x86emu_t* emu, void* ctx, void* cb)
{
    (void)emu;
    my->SSL_set_psk_client_callback(ctx, find_client_cb_Fct(cb));
}

__attribute__((visibility("default"))) void my_SSL_CTX_set_next_proto_select_cb(x86emu_t* emu, void* ctx, void* cb, void* arg)
{
    (void)emu;
    my->SSL_CTX_set_next_proto_select_cb(ctx, find_proto_select_Fct(cb), arg);
}

__attribute__((visibility("default"))) void my_SSL_CTX_sess_set_new_cb(x86emu_t* emu, void* ctx, void* cb)
{
    (void)emu;
    my->SSL_CTX_sess_set_new_cb(ctx, find_new_session_cb_Fct(cb));
}
# 318 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibssldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsslsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"d2i_SSL_SESSION", pFppl, 0},
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"DTLS_method", pFv, 0},
{"DTLS_server_method", pFv, 0},
{"DTLSv1_2_client_method", pFv, 0},
{"DTLSv1_2_method", pFv, 0},
{"DTLSv1_2_server_method", pFv, 0},
{"DTLSv1_client_method", pFv, 0},
{"DTLSv1_method", pFv, 0},
{"DTLSv1_server_method", pFv, 0},


{"i2d_SSL_SESSION", iFpp, 0},
# 184 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_accept", iFp, 0},

{"SSL_add_client_CA", iFpp, 0},
# 203 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"

# 222 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_check_private_key", iFp, 0},


{"SSL_CIPHER_description", pFppi, 0},

{"SSL_CIPHER_get_bits", iFpp, 0},



{"SSL_CIPHER_get_name", pFp, 0},
{"SSL_CIPHER_get_version", pFp, 0},



{"SSL_clear", iFp, 0},
# 256 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_connect", iFp, 0},


{"SSL_ctrl", lFpilp, 0},
{"SSL_CTX_add_client_CA", iFpp, 0},




{"SSL_CTX_check_private_key", iFp, 0},
{"SSL_CTX_ctrl", lFpilp, 0},

{"SSL_CTX_free", vFp, 0},



{"SSL_CTX_get_cert_store", pFp, 0},
# 284 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_CTX_load_verify_locations", iFppp, 0},
{"SSL_CTX_new", pFp, 0},
...
{"SSL_CTX_set_cert_store", vFpp, 0},

{"SSL_CTX_set_cipher_list", iFpp, 0},
{"SSL_CTX_set_client_CA_list", vFpp, 0},





{"SSL_CTX_set_default_passwd_cb_userdata", vFpp, 0},
{"SSL_CTX_set_default_verify_paths", iFp, 0},
...
# 334 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"

{"SSL_CTX_set_verify_depth", vFpi, 0},


{"SSL_CTX_use_certificate", iFpp, 0},
{"SSL_CTX_use_certificate_ASN1", iFpip, 0},
{"SSL_CTX_use_certificate_chain_file", iFpp, 0},
{"SSL_CTX_use_certificate_file", iFppi, 0},
{"SSL_CTX_use_PrivateKey", iFpp, 0},
{"SSL_CTX_use_PrivateKey_ASN1", iFuppi, 0},
{"SSL_CTX_use_PrivateKey_file", iFppi, 0},

{"SSL_CTX_use_RSAPrivateKey", iFpp, 0},
{"SSL_CTX_use_RSAPrivateKey_ASN1", iFppl, 0},
{"SSL_CTX_use_RSAPrivateKey_file", iFppi, 0},
# 358 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_free", vFp, 0},


{"SSL_get0_next_proto_negotiated", vFppp, 0},

{"SSL_get0_session", pFp, 0},
{"SSL_get1_session", pFp, 0},

{"SSL_get_certificate", pFp, 0},


{"SSL_get_ciphers", pFp, 0},


{"SSL_get_current_cipher", pFp, 0},



{"SSL_get_error", iFpi, 0},
{"SSL_get_ex_data", pFpi, 0},
...
{"SSL_get_peer_cert_chain", pFp, 0},
{"SSL_get_peer_certificate", pFp, 0},


{"SSL_get_privatekey", pFp, 0},
# 401 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_get_session", pFp, 0},


{"SSL_get_shutdown", iFp, 0},
# 417 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_get_verify_result", iFp, 0},
...
{"SSL_is_server", iFp, 0},
{"SSL_library_init", iFv, 0},


{"SSL_load_error_strings", vFv, 0},
{"SSL_new", pFp, 0},
...
{"SSL_select_next_proto", iFpppupu, 0},


{"ssl_session_dup", pFp, 0},
{"SSL_SESSION_dup", pFp, 0},
{"SSL_SESSION_free", vFp, 0},
...
{"SSL_SESSION_up_ref", iFp, 0},

{"SSL_set_accept_state", vFp, 0},

{"SSL_set_bio", vFppp, 0},


{"SSL_set_cipher_list", iFpp, 0},
{"SSL_set_client_CA_list", vFpp, 0},

{"SSL_set_connect_state", vFp, 0},

{"SSL_set_ex_data", iFpip, 0},
{"SSL_set_fd", iFpi, 0},
...
{"SSL_set_rfd", iFpi, 0},
{"SSL_set_session", iFpp, 0},




{"SSL_set_shutdown", iFp, 0},
# 507 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"

{"SSL_set_verify_depth", vFpi, 0},

{"SSL_set_wfd", iFpi, 0},
{"SSL_shutdown", iFp, 0},
# 522 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_use_certificate", iFpp, 0},
{"SSL_use_certificate_ASN1", iFppi, 0},
{"SSL_use_certificate_file", iFppi, 0},
{"SSL_use_PrivateKey", iFpp, 0},
{"SSL_use_PrivateKey_ASN1", iFppl, 0},
{"SSL_use_PrivateKey_file", iFppi, 0},

{"SSL_use_RSAPrivateKey", iFpp, 0},
{"SSL_use_RSAPrivateKey_ASN1", iFppl, 0},
{"SSL_use_RSAPrivateKey_file", iFppi, 0},
{"SSLv23_client_method", pFv, 0},
{"SSLv23_method", pFv, 0},
{"SSLv23_server_method", pFv, 0},
{"SSLv2_client_method", pFv, 0},
{"SSLv2_method", pFv, 0},
{"SSLv2_server_method", pFv, 0},
{"SSLv3_client_method", pFv, 0},
{"SSLv3_method", pFv, 0},
{"SSLv3_server_method", pFv, 0},


{"SSL_version", iFp, 0},

{"SSL_write", iFppi, 0},
# 582 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"TLSv1_1_client_method", pFv, 0},
{"TLSv1_1_method", pFv, 0},
{"TLSv1_1_server_method", pFv, 0},
{"TLSv1_2_client_method", pFv, 0},
{"TLSv1_2_method", pFv, 0},
{"TLSv1_2_server_method", pFv, 0},
{"TLSv1_client_method", pFv, 0},
{"TLSv1_method", pFv, 0},
{"verify_callback", iFip, 0},

{"TLSv1_server_method", pFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libsslmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
...
{"SSL_CTX_callback_ctrl", lFEpip, 0},
...
{"SSL_CTX_sess_set_new_cb", vFEpp, 0},
...
{"SSL_CTX_set_default_passwd_cb", vFEpp, 0},
...
{"SSL_CTX_set_next_proto_select_cb", vFEppp, 0},
# 334 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
{"SSL_CTX_set_verify", vFEpip, 0},
...
{"SSL_get_ex_new_index", iFElpppp, 0},
...
{"SSL_set_psk_client_callback", vFEpp, 0},
...
static const map_onesymbol_t libsslstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
...
static const map_onesymbol2_t libsslsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
...
static const map_onedata_t libssldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
...
static const map_onedata_t libsslmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibsslundefs.h" 1
...
int wrappedlibssl_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        lib->w.lib = dlopen("libssl.so.1.0.2", 
...
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        if(!lib->w.lib)
            ...
            {
            lib->w.lib = dlopen("libssl.so.1.1", 
...
# 156 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
            ...
            if(!lib->w.lib)
                ...
                else lib->path = box_strdup("libssl.so.1.1");
            } else lib->path = box_strdup("libssl.so.1.0.2");

        } else lib->path = box_strdup(libsslName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libsslsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsslsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libsslsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libsslsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libsslsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libsslsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libsslsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsslsymbolmap[i].name); }
 cnt = sizeof(libsslmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libsslmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libsslmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libsslmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libsslmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libsslmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libsslmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libsslmysymbolmap[i].name); }

    cnt = sizeof(libsslstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libsslstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libsslstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libsslstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libsslstsymbolmap[i].name);
    }
    cnt = sizeof(libsslsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libsslsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libsslsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libsslsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libsslsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libsslsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libsslsymbol2map[i].name);
    }
    cnt = sizeof(libssldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libssldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libssldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libssldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libssldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libssldatamap[i].sz;
        }
    }
    cnt = sizeof(libsslmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libsslmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libsslmydatamap[i].sz;
    }

    getMy(lib); setNeededLibs(lib, 2, "libcrypto.so.1.1", "libpthread.so.0");


    return 0;
}

void wrappedlibssl_fini(library_t* lib)
{
...
# 319 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibssl.c" 2
