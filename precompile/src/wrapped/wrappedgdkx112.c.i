# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2

const char* gdkx112Name = "libgdk-x11-2.0.so.0";


static char* libname = 
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 3 4
                      ((void *)0)
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
                          ;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgdkx112types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgdkx112types.h"
...
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
...
typedef struct gdkx112_my_s {
    ...
    vFp_t gdk_bitmap_unref; vFp_t gdk_pixmap_unref; pFp_t gdk_bitmap_ref; pFp_t gdk_pixmap_ref; vFpp_t gdk_init; iFpp_t gdk_init_check; vFppp_t gdk_event_handler_set; vFppp_t gdk_window_add_filter; vFppp_t gdk_window_remove_filter; iFiipp_t gdk_input_add; iFiippp_t gdk_input_add_full;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static gdkx112_my_t my_gdkx112 = {0};
static gdkx112_my_t * const my = &my_gdkx112;

static void getMy(library_t* lib)
{

    my->gdk_bitmap_unref = (vFp_t)dlsym(lib->w.lib, "gdk_bitmap_unref"); my->gdk_pixmap_unref = (vFp_t)dlsym(lib->w.lib, "gdk_pixmap_unref"); my->gdk_bitmap_ref = (pFp_t)dlsym(lib->w.lib, "gdk_bitmap_ref"); my->gdk_pixmap_ref = (pFp_t)dlsym(lib->w.lib, "gdk_pixmap_ref"); my->gdk_init = (vFpp_t)dlsym(lib->w.lib, "gdk_init"); my->gdk_init_check = (iFpp_t)dlsym(lib->w.lib, "gdk_init_check"); my->gdk_event_handler_set = (vFppp_t)dlsym(lib->w.lib, "gdk_event_handler_set"); my->gdk_window_add_filter = (vFppp_t)dlsym(lib->w.lib, "gdk_window_add_filter"); my->gdk_window_remove_filter = (vFppp_t)dlsym(lib->w.lib, "gdk_window_remove_filter"); my->gdk_input_add = (iFiipp_t)dlsym(lib->w.lib, "gdk_input_add"); my->gdk_input_add_full = (iFiippp_t)dlsym(lib->w.lib, "gdk_input_add_full");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
static uintptr_t my_filter_fct_0 = 0; static int my_filter_0(void* xevent, void* event, void* data) { return (int)RunFunctionFmt(my_filter_fct_0, "ppp", xevent, event, data); } static uintptr_t my_filter_fct_1 = 0; static int my_filter_1(void* xevent, void* event, void* data) { return (int)RunFunctionFmt(my_filter_fct_1, "ppp", xevent, event, data); } static uintptr_t my_filter_fct_2 = 0; static int my_filter_2(void* xevent, void* event, void* data) { return (int)RunFunctionFmt(my_filter_fct_2, "ppp", xevent, event, data); } static uintptr_t my_filter_fct_3 = 0; static int my_filter_3(void* xevent, void* event, void* data) { return (int)RunFunctionFmt(my_filter_fct_3, "ppp", xevent, event, data); }
...
static void* findFilterFct(void* fct)
{
    ...
    if(my_filter_fct_0 == (uintptr_t)fct) return my_filter_0; if(my_filter_fct_1 == (uintptr_t)fct) return my_filter_1; if(my_filter_fct_2 == (uintptr_t)fct) return my_filter_2; if(my_filter_fct_3 == (uintptr_t)fct) return my_filter_3;


    if(my_filter_fct_0 == 0) {my_filter_fct_0 = (uintptr_t)fct; return my_filter_0; } if(my_filter_fct_1 == 0) {my_filter_fct_1 = (uintptr_t)fct; return my_filter_1; } if(my_filter_fct_2 == 0) {my_filter_fct_2 = (uintptr_t)fct; return my_filter_2; } if(my_filter_fct_3 == 0) {my_filter_fct_3 = (uintptr_t)fct; return my_filter_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gtk-2 GdkFilterFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 3 4
          ((void *)0)
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
              ;
}
...
__attribute__((visibility("default"))) void my_gdk_event_handler_set(x86emu_t* emu, void* func, void* data, void* notify)
{
    (void)emu;
    if(!func)
...
__attribute__((visibility("default"))) int my_gdk_input_add(x86emu_t* emu, int source, int condition, void* f, void* data)
{
    (void)emu;
    if(!f)
        return my->gdk_input_add_full(source, condition, f, data, 
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 3 4
                                                                 ((void *)0)
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
                                                                     );

    my_signal_t* sig = new_mysignal(f, data, 
# 91 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 3 4
                                            ((void *)0)
# 91 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
                                                );
    return my->gdk_input_add_full(source, condition, my_input_function, sig, my_signal_delete);
}

__attribute__((visibility("default"))) int my_gdk_input_add_full(x86emu_t* emu, int source, int condition, void* f, void* data, void* notify)
{
    (void)emu;
    if(!f)
...
__attribute__((visibility("default"))) void my_gdk_init(x86emu_t* emu, void* argc, void* argv)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_gdk_init_check(x86emu_t* emu, void* argc, void* argv)
{
    (void)emu;
...
__attribute__((visibility("default"))) void my_gdk_window_add_filter(x86emu_t* emu, void* window, void* f, void* data)
{
    (void)emu;
    my->gdk_window_add_filter(window, findFilterFct(f), data);
}

__attribute__((visibility("default"))) void my_gdk_window_remove_filter(x86emu_t* emu, void* window, void* f, void* data)
{
    (void)emu;
    my->gdk_window_remove_filter(window, findFilterFct(f), data);
}
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgdkx112defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gdkx112symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
{"gdk_atom_intern", pFpi, 0},
{"gdk_atom_intern_static_string", pFp, 0},
{"gdk_atom_name", pFp, 0},
{"gdk_axis_use_get_type", iFv, 0},
{"gdk_beep", vFv, 0},
{"gdk_bitmap_create_from_data", pFppii, 0},
{"gdk_byte_order_get_type", iFv, 0},
{"gdk_cairo_create", pFp, 0},
{"gdk_cairo_rectangle", vFpp, 0},
{"gdk_cairo_region", vFpp, 0},
{"gdk_cairo_reset_clip", vFpp, 0},
{"gdk_cairo_set_source_color", vFpp, 0},
{"gdk_cairo_set_source_pixbuf", vFppdd, 0},
{"gdk_cairo_set_source_pixmap", vFppdd, 0},
{"gdk_cairo_set_source_window", vFppdd, 0},





{"gdk_color_alloc", iFpp, 0},
{"gdk_color_black", iFpp, 0},
{"gdk_color_change", iFpp, 0},
{"gdk_color_copy", pFp, 0},
{"gdk_color_equal", iFpp, 0},
{"gdk_color_free", vFp, 0},
{"gdk_color_get_type", iFv, 0},
{"gdk_color_hash", uFp, 0},
{"gdk_colormap_alloc_color", iFppii, 0},
{"gdk_colormap_alloc_colors", iFppiiip, 0},
{"gdk_colormap_change", vFpi, 0},
{"gdk_colormap_free_colors", vFppi, 0},
{"gdk_colormap_get_screen", pFp, 0},
{"gdk_colormap_get_system", pFv, 0},
{"gdk_colormap_get_system_size", iFv, 0},
{"gdk_colormap_get_type", iFv, 0},
{"gdk_colormap_get_visual", pFp, 0},
{"gdk_colormap_new", pFpi, 0},
{"gdk_colormap_query_color", vFpLp, 0},
{"gdk_colormap_ref", pFp, 0},
{"gdk_colormap_unref", vFp, 0},
{"gdk_color_parse", iFpp, 0},
{"gdk_colors_alloc", iFpipipi, 0},
{"gdk_colors_free", vFppiL, 0},
{"gdk_colors_store", vFppi, 0},
{"gdk_color_to_string", pFp, 0},
{"gdk_color_white", iFpp, 0},
{"gdk_crossing_mode_get_type", iFv, 0},
{"gdk_cursor_get_cursor_type", iFp, 0},
{"gdk_cursor_get_display", pFp, 0},
{"gdk_cursor_get_image", pFp, 0},
{"gdk_cursor_get_type", iFv, 0},
{"gdk_cursor_new", pFi, 0},
{"gdk_cursor_new_for_display", pFpi, 0},
{"gdk_cursor_new_from_name", pFpp, 0},
{"gdk_cursor_new_from_pixbuf", pFppii, 0},
{"gdk_cursor_new_from_pixmap", pFppppii, 0},
{"gdk_cursor_ref", pFp, 0},
{"gdk_cursor_type_get_type", iFv, 0},
{"gdk_cursor_unref", vFp, 0},
{"gdk_device_free_history", vFpi, 0},
{"gdk_device_get_axis", iFppip, 0},
{"gdk_device_get_axis_use", iFpu, 0},
{"gdk_device_get_core_pointer", pFv, 0},
{"gdk_device_get_has_cursor", iFp, 0},
{"gdk_device_get_history", iFppuupp, 0},
{"gdk_device_get_key", vFpupp, 0},
{"gdk_device_get_mode", iFp, 0},
{"gdk_device_get_name", pFp, 0},
{"gdk_device_get_n_axes", iFp, 0},
{"gdk_device_get_n_keys", iFp, 0},
{"gdk_device_get_source", iFp, 0},
{"gdk_device_get_state", vFpppp, 0},
{"gdk_device_get_type", iFv, 0},
{"gdk_device_set_axis_use", vFpui, 0},
{"gdk_device_set_key", vFpuui, 0},
{"gdk_device_set_mode", iFpi, 0},
{"gdk_device_set_source", vFpi, 0},
{"gdk_devices_list", pFv, 0},

{"gdk_display_beep", vFp, 0},
{"gdk_display_close", vFp, 0},
{"gdk_display_flush", vFp, 0},
{"gdk_display_get_core_pointer", pFp, 0},
{"gdk_display_get_default", pFv, 0},
{"gdk_display_get_default_cursor_size", uFp, 0},
{"gdk_display_get_default_group", pFp, 0},
{"gdk_display_get_default_screen", pFp, 0},
{"gdk_display_get_event", pFp, 0},
{"gdk_display_get_maximal_cursor_size", vFppp, 0},
{"gdk_display_get_name", pFp, 0},
{"gdk_display_get_n_screens", iFp, 0},
{"gdk_display_get_pointer", vFppppp, 0},
{"gdk_display_get_screen", pFpi, 0},
{"gdk_display_get_type", iFv, 0},
{"gdk_display_get_window_at_pointer", pFppp, 0},
{"gdk_display_is_closed", iFp, 0},
{"gdk_display_keyboard_ungrab", vFpu, 0},
{"gdk_display_list_devices", pFp, 0},
{"gdk_display_manager_get", pFv, 0},
{"gdk_display_manager_get_default_display", pFp, 0},
{"gdk_display_manager_get_type", iFv, 0},
{"gdk_display_manager_list_displays", pFp, 0},
{"gdk_display_manager_set_default_display", vFpp, 0},
{"gdk_display_open", pFp, 0},

{"gdk_display_peek_event", pFp, 0},
{"gdk_display_pointer_is_grabbed", iFp, 0},
{"gdk_display_pointer_ungrab", vFpu, 0},
{"gdk_display_put_event", vFpp, 0},
{"gdk_display_request_selection_notification", iFpp, 0},
{"gdk_display_set_double_click_distance", vFpu, 0},
{"gdk_display_set_double_click_time", vFpu, 0},

{"gdk_display_store_clipboard", vFppupi, 0},
{"gdk_display_supports_clipboard_persistence", iFp, 0},
{"gdk_display_supports_composite", iFp, 0},
{"gdk_display_supports_cursor_alpha", iFp, 0},
{"gdk_display_supports_cursor_color", iFp, 0},
{"gdk_display_supports_input_shapes", iFp, 0},
{"gdk_display_supports_selection_notification", iFp, 0},
{"gdk_display_supports_shapes", iFp, 0},
{"gdk_display_sync", vFp, 0},
{"gdk_display_warp_pointer", vFppii, 0},
{"gdk_drag_abort", vFpu, 0},
{"gdk_drag_action_get_type", iFv, 0},
{"gdk_drag_begin", pFpp, 0},
{"gdk_drag_context_get_actions", iFp, 0},
{"gdk_drag_context_get_dest_window", pFp, 0},
{"gdk_drag_context_get_protocol", iFp, 0},
{"gdk_drag_context_get_selected_action", iFp, 0},
{"gdk_drag_context_get_source_window", pFp, 0},
{"gdk_drag_context_get_suggested_action", iFp, 0},
{"gdk_drag_context_get_type", iFv, 0},
{"gdk_drag_context_list_targets", pFp, 0},
{"gdk_drag_context_new", pFv, 0},
{"gdk_drag_context_ref", vFp, 0},
{"gdk_drag_context_unref", vFp, 0},
{"gdk_drag_drop", vFpu, 0},
{"gdk_drag_drop_succeeded", iFp, 0},
{"gdk_drag_find_window", vFppiipp, 0},
{"gdk_drag_find_window_for_screen", vFpppiipp, 0},
{"gdk_drag_get_protocol", pFpp, 0},
{"gdk_drag_get_protocol_for_display", pFppp, 0},
{"gdk_drag_get_selection", pFp, 0},
{"gdk_drag_motion", iFppiiiiiu, 0},
{"gdk_drag_protocol_get_type", iFv, 0},
{"gdk_drag_status", vFpiu, 0},
{"gdk_drawable_copy_to_image", pFppiiiiii, 0},
{"gdk_drawable_get_clip_region", pFp, 0},
{"gdk_drawable_get_colormap", pFp, 0},
{"gdk_drawable_get_data", pFpp, 0},
{"gdk_drawable_get_depth", iFp, 0},
{"gdk_drawable_get_display", pFp, 0},
{"gdk_drawable_get_image", pFpiiii, 0},
{"gdk_drawable_get_screen", pFp, 0},
{"gdk_drawable_get_size", vFppp, 0},
{"gdk_drawable_get_type", iFv, 0},
{"gdk_drawable_get_visible_region", pFp, 0},
{"gdk_drawable_get_visual", pFp, 0},
{"gdk_drawable_ref", pFp, 0},
{"gdk_drawable_set_colormap", vFpp, 0},

{"gdk_drawable_unref", vFp, 0},
{"gdk_draw_arc", vFppiiiiiii, 0},
{"gdk_draw_drawable", vFpppiiiiii, 0},
{"gdk_draw_glyphs", vFpppiip, 0},
{"gdk_draw_glyphs_transformed", vFppppiip, 0},
{"gdk_draw_gray_image", vFppiiiiipi, 0},
{"gdk_draw_image", vFpppiiiiii, 0},
{"gdk_draw_indexed_image", vFppiiiiipip, 0},
{"gdk_draw_layout", vFppiip, 0},
{"gdk_draw_layout_line", vFppiip, 0},
{"gdk_draw_layout_line_with_colors", vFppiippp, 0},
{"gdk_draw_layout_with_colors", vFppiippp, 0},
{"gdk_draw_line", vFppiiii, 0},
{"gdk_draw_lines", vFpppi, 0},
{"gdk_draw_pixbuf", vFpppiiiiiiiii, 0},
{"gdk_draw_point", vFppii, 0},
{"gdk_draw_points", vFpppi, 0},
{"gdk_draw_polygon", vFppipi, 0},
{"gdk_draw_rectangle", vFppiiiii, 0},
{"gdk_draw_rgb_32_image", vFppiiiiipi, 0},
{"gdk_draw_rgb_32_image_dithalign", vFppiiiiipiii, 0},
{"gdk_draw_rgb_image", vFppiiiiipi, 0},
{"gdk_draw_rgb_image_dithalign", vFppiiiiipiii, 0},
{"gdk_draw_segments", vFpppi, 0},
{"gdk_draw_string", vFpppiip, 0},
{"gdk_draw_text", vFpppiipi, 0},
{"gdk_draw_text_wc", vFpppiipi, 0},
{"gdk_draw_trapezoids", vFpppi, 0},
{"gdk_drop_finish", vFpiu, 0},
{"gdk_drop_reply", vFpiu, 0},
{"gdk_error_trap_pop", iFv, 0},
{"gdk_error_trap_push", vFv, 0},
{"gdk_event_copy", pFp, 0},
{"gdk_event_free", vFp, 0},
{"gdk_event_get", pFv, 0},
{"gdk_event_get_axis", iFpip, 0},
{"gdk_event_get_coords", iFppp, 0},
{"gdk_event_get_graphics_expose", pFp, 0},
{"gdk_event_get_root_coords", iFppp, 0},
{"gdk_event_get_screen", pFp, 0},
{"gdk_event_get_state", iFpp, 0},
{"gdk_event_get_time", uFp, 0},
{"gdk_event_get_type", iFv, 0},

{"gdk_event_mask_get_type", iFv, 0},
{"gdk_event_new", pFi, 0},
{"gdk_event_peek", pFv, 0},
{"gdk_event_put", vFp, 0},
{"gdk_event_request_motions", vFp, 0},
{"gdk_event_send_client_message", iFpp, 0},
{"gdk_event_send_client_message_for_display", iFppp, 0},
{"gdk_event_send_clientmessage_toall", vFp, 0},
{"gdk_event_set_screen", vFpp, 0},
{"gdk_events_pending", iFv, 0},
...
{"gdk_font_get_type", iFv, 0},
# 252 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
{"gdk_free_compound_text", vFp, 0},
{"gdk_free_text_list", vFp, 0},
{"gdk_function_get_type", iFv, 0},
{"gdk_gc_copy", vFpp, 0},
{"gdk_gc_get_colormap", pFp, 0},
{"gdk_gc_get_screen", pFp, 0},
{"gdk_gc_get_type", iFv, 0},
{"gdk_gc_get_values", vFpp, 0},
{"gdk_gc_new", pFp, 0},
{"gdk_gc_new_with_values", pFppu, 0},
{"gdk_gc_offset", vFpii, 0},
{"gdk_gc_ref", pFp, 0},
{"gdk_gc_set_background", vFpp, 0},
{"gdk_gc_set_clip_mask", vFpp, 0},
{"gdk_gc_set_clip_origin", vFpii, 0},
{"gdk_gc_set_clip_rectangle", vFpp, 0},
{"gdk_gc_set_clip_region", vFpp, 0},
{"gdk_gc_set_colormap", vFpp, 0},
{"gdk_gc_set_dashes", vFpipi, 0},
{"gdk_gc_set_exposures", vFpi, 0},
{"gdk_gc_set_fill", vFpi, 0},
{"gdk_gc_set_font", vFpp, 0},
{"gdk_gc_set_foreground", vFpp, 0},
{"gdk_gc_set_function", vFpi, 0},
{"gdk_gc_set_line_attributes", vFpiiii, 0},
{"gdk_gc_set_rgb_bg_color", vFpp, 0},
{"gdk_gc_set_rgb_fg_color", vFpp, 0},
{"gdk_gc_set_stipple", vFpp, 0},
{"gdk_gc_set_subwindow", vFpi, 0},
{"gdk_gc_set_tile", vFpp, 0},
{"gdk_gc_set_ts_origin", vFpii, 0},
{"gdk_gc_set_values", vFppu, 0},
{"gdk_gc_unref", vFp, 0},
{"gdk_gc_values_mask_get_type", iFv, 0},
{"gdk_get_default_root_window", pFv, 0},
{"gdk_get_display", pFv, 0},
{"gdk_get_display_arg_name", pFv, 0},
{"gdk_get_program_class", pFv, 0},
{"gdk_get_show_events", iFv, 0},
{"gdk_get_use_xshm", iFv, 0},
{"gdk_grab_status_get_type", iFv, 0},
{"gdk_gravity_get_type", iFv, 0},
{"gdk_image_get", pFpiiii, 0},
{"gdk_image_get_bits_per_pixel", WFp, 0},
{"gdk_image_get_byte_order", iFp, 0},
{"gdk_image_get_bytes_per_line", WFp, 0},
{"gdk_image_get_bytes_per_pixel", WFp, 0},
{"gdk_image_get_colormap", pFp, 0},
{"gdk_image_get_depth", WFp, 0},
{"gdk_image_get_height", iFp, 0},
{"gdk_image_get_image_type", iFp, 0},
{"gdk_image_get_pixel", uFpii, 0},
{"gdk_image_get_pixels", pFp, 0},
{"gdk_image_get_type", iFv, 0},
{"gdk_image_get_visual", pFp, 0},
{"gdk_image_get_width", iFp, 0},
{"gdk_image_new", pFipii, 0},
{"gdk_image_new_bitmap", pFppii, 0},
{"gdk_image_put_pixel", vFpiiu, 0},
{"gdk_image_ref", pFp, 0},
{"gdk_image_set_colormap", vFpp, 0},
{"gdk_image_type_get_type", iFv, 0},
{"gdk_image_unref", vFp, 0},




{"gdk_input_condition_get_type", iFv, 0},
{"gdk_input_mode_get_type", iFv, 0},
{"gdk_input_remove", vFi, 0},
{"gdk_input_set_extension_events", vFpii, 0},
{"gdk_input_source_get_type", iFv, 0},
{"gdk_join_style_get_type", iFv, 0},
{"gdk_keyboard_grab", iFpiu, 0},

{"gdk_keyboard_ungrab", vFu, 0},
{"gdk_keymap_add_virtual_modifiers", vFpp, 0},
{"gdk_keymap_get_caps_lock_state", iFp, 0},
{"gdk_keymap_get_default", pFv, 0},
{"gdk_keymap_get_direction", iFp, 0},
{"gdk_keymap_get_entries_for_keycode", iFpuppp, 0},
{"gdk_keymap_get_entries_for_keyval", iFpupp, 0},
{"gdk_keymap_get_for_display", pFp, 0},
{"gdk_keymap_get_type", iFv, 0},
{"gdk_keymap_have_bidi_layouts", iFp, 0},
{"gdk_keymap_lookup_key", uFpp, 0},
{"gdk_keymap_map_virtual_modifiers", iFpp, 0},
{"gdk_keymap_translate_keyboard_state", iFpuiipppp, 0},
{"gdk_keyval_convert_case", vFupp, 0},
{"gdk_keyval_from_name", uFp, 0},
{"gdk_keyval_is_lower", iFu, 0},
{"gdk_keyval_is_upper", iFu, 0},
{"gdk_keyval_name", pFu, 0},
{"gdk_keyval_to_lower", uFu, 0},
{"gdk_keyval_to_unicode", uFu, 0},
{"gdk_keyval_to_upper", uFu, 0},
{"gdk_line_style_get_type", iFv, 0},
{"gdk_list_visuals", pFv, 0},

{"gdk_modifier_type_get_type", iFv, 0},
{"gdk_net_wm_supports", iFp, 0},
{"gdk_notify_startup_complete", vFv, 0},
{"gdk_notify_startup_complete_with_id", vFp, 0},
{"gdk_notify_type_get_type", iFv, 0},
{"gdk_offscreen_window_get_embedder", pFp, 0},
{"gdk_offscreen_window_get_pixmap", pFp, 0},
{"gdk_offscreen_window_get_type", iFv, 0},
{"gdk_offscreen_window_set_embedder", vFpp, 0},
{"gdk_overlap_type_get_type", iFv, 0},
{"gdk_owner_change_get_type", iFv, 0},
{"gdk_pango_attr_emboss_color_new", pFp, 0},
{"gdk_pango_attr_embossed_new", pFi, 0},
{"gdk_pango_attr_stipple_new", pFp, 0},
{"gdk_pango_context_get", pFv, 0},
{"gdk_pango_context_get_for_screen", pFp, 0},
{"gdk_pango_context_set_colormap", vFpp, 0},
{"gdk_pango_layout_get_clip_region", pFpiipi, 0},
{"gdk_pango_layout_line_get_clip_region", pFpiipi, 0},
{"gdk_pango_renderer_get_default", pFp, 0},
{"gdk_pango_renderer_get_type", iFv, 0},
{"gdk_pango_renderer_new", pFp, 0},
{"gdk_pango_renderer_set_drawable", vFpp, 0},
{"gdk_pango_renderer_set_gc", vFpp, 0},
{"gdk_pango_renderer_set_override_color", vFpip, 0},
{"gdk_pango_renderer_set_stipple", vFpip, 0},
{"gdk_parse_args", vFpp, 0},
{"gdk_pixbuf_get_from_drawable", pFpppiiiiii, 0},
{"gdk_pixbuf_get_from_image", pFpppiiiiii, 0},
{"gdk_pixbuf_render_pixmap_and_mask", vFpppi, 0},
{"gdk_pixbuf_render_pixmap_and_mask_for_colormap", vFppppi, 0},
{"gdk_pixbuf_render_threshold_alpha", vFppiiiiiii, 0},
{"gdk_pixbuf_render_to_drawable", vFpppiiiiiiiii, 0},
{"gdk_pixbuf_render_to_drawable_alpha", vFppiiiiiiiiiii, 0},
{"gdk_pixmap_colormap_create_from_xpm", pFppppp, 0},
{"gdk_pixmap_colormap_create_from_xpm_d", pFppppp, 0},
{"gdk_pixmap_create_from_data", pFppiiipp, 0},
{"gdk_pixmap_create_from_xpm", pFpppp, 0},
{"gdk_pixmap_create_from_xpm_d", pFpppp, 0},
{"gdk_pixmap_foreign_new", pFp, 0},
{"gdk_pixmap_foreign_new_for_display", pFpp, 0},
{"gdk_pixmap_foreign_new_for_screen", pFppiii, 0},
{"gdk_pixmap_get_size", vFppp, 0},
{"gdk_pixmap_get_type", iFv, 0},
{"gdk_pixmap_impl_x11_get_type", iFv, 0},
{"gdk_pixmap_lookup", pFp, 0},
{"gdk_pixmap_lookup_for_display", pFpp, 0},
{"gdk_pixmap_new", pFpiii, 0},
{"gdk_pointer_grab", iFpiippu, 0},

{"gdk_pointer_is_grabbed", iFv, 0},
{"gdk_pointer_ungrab", vFu, 0},

{"gdk_property_change", vFpppiipi, 0},
{"gdk_property_delete", vFpp, 0},
{"gdk_property_get", iFpppLLipppp, 0},
{"gdk_property_state_get_type", iFv, 0},
{"gdk_prop_mode_get_type", iFv, 0},
{"gdk_query_depths", vFpp, 0},
{"gdk_query_visual_types", vFpp, 0},
{"gdk_rectangle_get_type", iFv, 0},
{"gdk_rectangle_intersect", iFppp, 0},
{"gdk_rectangle_union", vFppp, 0},
{"gdk_region_copy", pFp, 0},
{"gdk_region_destroy", vFpp, 0},
{"gdk_region_empty", iFp, 0},
{"gdk_region_equal", iFpp, 0},
{"gdk_region_get_clipbox", vFpp, 0},
{"gdk_region_get_rectangles", vFppp, 0},
{"gdk_region_intersect", vFpp, 0},
{"gdk_region_new", pFv, 0},
{"gdk_region_offset", vFpii, 0},
{"gdk_region_point_in", iFpii, 0},
{"gdk_region_polygon", pFpii, 0},
{"gdk_region_rectangle", pFp, 0},
{"gdk_region_rect_equal", iFpp, 0},
{"gdk_region_rect_in", iFpp, 0},
{"gdk_region_shrink", vFpii, 0},

{"gdk_region_subtract", vFpp, 0},
{"gdk_region_union", vFpp, 0},
{"gdk_region_union_with_rect", vFpp, 0},
{"gdk_region_xor", vFpp, 0},
{"gdk_rgb_cmap_free", vFp, 0},
{"gdk_rgb_cmap_new", pFpi, 0},
{"gdk_rgb_colormap_ditherable", iFp, 0},
{"gdk_rgb_ditherable", iFv, 0},
{"gdk_rgb_dither_get_type", iFv, 0},
{"gdk_rgb_find_color", vFpp, 0},
{"gdk_rgb_gc_set_background", vFpu, 0},
{"gdk_rgb_gc_set_foreground", vFpu, 0},
{"gdk_rgb_get_colormap", pFv, 0},
{"gdk_rgb_get_visual", pFv, 0},
{"gdk_rgb_init", vFv, 0},
{"gdk_rgb_set_install", vFi, 0},
{"gdk_rgb_set_min_colors", vFi, 0},
{"gdk_rgb_set_verbose", vFi, 0},
{"gdk_rgb_xpixel_from_rgb", LFu, 0},
{"gdk_screen_broadcast_client_message", vFpp, 0},
{"gdk_screen_get_active_window", pFp, 0},
{"gdk_screen_get_default", pFv, 0},
{"gdk_screen_get_default_colormap", pFp, 0},
{"gdk_screen_get_display", pFp, 0},
{"gdk_screen_get_font_options", pFp, 0},
{"gdk_screen_get_height", iFp, 0},
{"gdk_screen_get_height_mm", iFp, 0},
{"gdk_screen_get_monitor_at_point", iFpii, 0},
{"gdk_screen_get_monitor_at_window", iFpp, 0},
{"gdk_screen_get_monitor_geometry", vFpip, 0},
{"gdk_screen_get_monitor_height_mm", iFpi, 0},
{"gdk_screen_get_monitor_plug_name", pFpi, 0},
{"gdk_screen_get_monitor_width_mm", iFpi, 0},
{"gdk_screen_get_n_monitors", iFp, 0},
{"gdk_screen_get_number", iFp, 0},
{"gdk_screen_get_primary_monitor", iFp, 0},
{"gdk_screen_get_resolution", dFp, 0},
{"gdk_screen_get_rgba_colormap", pFp, 0},
{"gdk_screen_get_rgba_visual", pFp, 0},
{"gdk_screen_get_rgb_colormap", pFp, 0},
{"gdk_screen_get_rgb_visual", pFp, 0},
{"gdk_screen_get_root_window", pFp, 0},
{"gdk_screen_get_setting", iFppp, 0},
{"gdk_screen_get_system_colormap", pFp, 0},
{"gdk_screen_get_system_visual", pFp, 0},
{"gdk_screen_get_toplevel_windows", pFp, 0},
{"gdk_screen_get_type", iFv, 0},
{"gdk_screen_get_width", iFp, 0},
{"gdk_screen_get_width_mm", iFp, 0},
{"gdk_screen_get_window_stack", pFp, 0},
{"gdk_screen_height", iFv, 0},
{"gdk_screen_height_mm", iFv, 0},
{"gdk_screen_is_composited", iFp, 0},
{"gdk_screen_list_visuals", pFp, 0},
{"gdk_screen_make_display_name", pFp, 0},
{"gdk_screen_set_default_colormap", vFpp, 0},
{"gdk_screen_set_font_options", vFpp, 0},
{"gdk_screen_set_resolution", vFpd, 0},
{"gdk_screen_width", iFv, 0},
{"gdk_screen_width_mm", iFv, 0},
{"gdk_scroll_direction_get_type", iFv, 0},
{"gdk_selection_convert", vFpppu, 0},
{"gdk_selection_owner_get", pFp, 0},
{"gdk_selection_owner_get_for_display", pFpp, 0},
{"gdk_selection_owner_set", iFppui, 0},
{"gdk_selection_owner_set_for_display", iFpppui, 0},
{"gdk_selection_property_get", iFpppp, 0},
{"gdk_selection_send_notify", vFppppu, 0},
{"gdk_selection_send_notify_for_display", vFpppppu, 0},
{"gdk_set_double_click_time", vFu, 0},
{"gdk_set_locale", pFv, 0},

{"gdk_set_program_class", vFp, 0},
{"gdk_set_show_events", vFi, 0},
{"gdk_set_sm_client_id", vFp, 0},
{"gdk_setting_action_get_type", iFv, 0},
{"gdk_setting_get", iFpp, 0},
{"gdk_set_use_xshm", vFi, 0},
{"gdk_spawn_command_line_on_screen", iFppp, 0},


{"gdk_status_get_type", iFv, 0},



{"gdk_string_to_compound_text", iFppppp, 0},
{"gdk_string_to_compound_text_for_display", iFpppppp, 0},
# 527 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
{"gdk_text_property_to_text_list", iFpipip, 0},
{"gdk_text_property_to_text_list_for_display", iFppipip, 0},
{"gdk_text_property_to_utf8_list", iFpipip, 0},
# 539 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
{"gdk_threads_enter", vFv, 0},
{"gdk_threads_init", vFv, 0},
{"gdk_threads_leave", vFv, 0},

{"gdk_unicode_to_keyval", uFu, 0},
{"gdk_utf8_to_compound_text", iFppppp, 0},
{"gdk_utf8_to_compound_text_for_display", iFpppppp, 0},
{"gdk_utf8_to_string_target", pFp, 0},
{"gdk_visibility_state_get_type", iFv, 0},
{"gdk_visual_get_best", pFv, 0},
{"gdk_visual_get_best_depth", iFv, 0},
{"gdk_visual_get_best_type", iFv, 0},
{"gdk_visual_get_best_with_both", pFii, 0},
{"gdk_visual_get_best_with_depth", pFi, 0},
{"gdk_visual_get_best_with_type", pFi, 0},
{"gdk_visual_get_bits_per_rgb", iFp, 0},
{"gdk_visual_get_blue_pixel_details", vFpppp, 0},
{"gdk_visual_get_byte_order", iFp, 0},
{"gdk_visual_get_colormap_size", iFp, 0},
{"gdk_visual_get_depth", iFp, 0},
{"gdk_visual_get_green_pixel_details", vFpppp, 0},
{"gdk_visual_get_red_pixel_details", vFpppp, 0},
{"gdk_visual_get_screen", pFp, 0},
{"gdk_visual_get_system", pFv, 0},
{"gdk_visual_get_type", iFv, 0},
{"gdk_visual_get_visual_type", iFp, 0},
{"gdk_visual_type_get_type", iFv, 0},


{"gdk_window_at_pointer", pFpp, 0},

{"gdk_window_beep", vFp, 0},
{"gdk_window_begin_move_drag", vFpiiiu, 0},
{"gdk_window_begin_paint_rect", vFpp, 0},
{"gdk_window_begin_paint_region", vFpp, 0},
{"gdk_window_begin_resize_drag", vFpuiiiu, 0},
{"gdk_window_class_get_type", iFv, 0},
{"gdk_window_clear", vFp, 0},
{"gdk_window_clear_area", vFpiiii, 0},
{"gdk_window_clear_area_e", vFpiiii, 0},
{"gdk_window_configure_finished", vFp, 0},
{"gdk_window_constrain_size", vFpuiipp, 0},
{"gdk_window_coords_from_parent", vFpddpp, 0},
{"gdk_window_coords_to_parent", vFpddpp, 0},
{"gdk_window_create_similar_surface", pFpiii, 0},
{"gdk_window_deiconify", vFp, 0},
{"gdk_window_destroy", vFp, 0},


{"gdk_window_enable_synchronized_configure", vFp, 0},
{"gdk_window_end_paint", vFp, 0},
{"gdk_window_ensure_native", iFp, 0},
{"gdk_window_flush", vFp, 0},
{"gdk_window_focus", vFpu, 0},
{"gdk_window_foreign_new", pFp, 0},
{"gdk_window_foreign_new_for_display", pFpp, 0},

{"gdk_window_freeze_updates", vFp, 0},
{"gdk_window_fullscreen", vFp, 0},
{"gdk_window_geometry_changed", vFp, 0},
{"gdk_window_get_accept_focus", iFp, 0},
{"gdk_window_get_background_pattern", pFp, 0},
{"gdk_window_get_children", pFp, 0},
{"gdk_window_get_composited", iFp, 0},
{"gdk_window_get_cursor", pFp, 0},
{"gdk_window_get_decorations", iFpp, 0},
{"gdk_window_get_deskrelative_origin", iFppp, 0},
{"gdk_window_get_display", pFp, 0},
{"gdk_window_get_effective_parent", pFp, 0},
{"gdk_window_get_effective_toplevel", pFp, 0},
{"gdk_window_get_events", vFpi, 0},
{"gdk_window_get_focus_on_map", iFp, 0},
{"gdk_window_get_frame_extents", vFpp, 0},
{"gdk_window_get_geometry", vFpppppp, 0},
{"gdk_window_get_group", pFp, 0},
{"gdk_window_get_height", iFp, 0},
{"gdk_window_get_internal_paint_info", vFpppp, 0},
{"gdk_window_get_modal_hint", iFp, 0},
{"gdk_window_get_origin", iFppp, 0},
{"gdk_window_get_parent", pFp, 0},
{"gdk_window_get_pointer", pFpppp, 0},
{"gdk_window_get_position", vFppp, 0},
{"gdk_window_get_root_coords", vFpiipp, 0},
{"gdk_window_get_root_origin", vFppp, 0},
{"gdk_window_get_screen", pFp, 0},
{"gdk_window_get_state", iFp, 0},
{"gdk_window_get_toplevel", pFp, 0},
{"gdk_window_get_toplevels", pFp, 0},
{"gdk_window_get_type_hint", iFp, 0},
{"gdk_window_get_update_area", pFp, 0},
{"gdk_window_get_user_data", vFpp, 0},
{"gdk_window_get_visual", pFp, 0},
{"gdk_window_get_width", iFp, 0},
{"gdk_window_get_window_type", iFp, 0},
{"gdk_window_has_native", iFp, 0},
{"gdk_window_hide", vFp, 0},
{"gdk_window_hints_get_type", iFv, 0},
{"gdk_window_iconify", vFp, 0},
{"gdk_window_impl_get_type", iFv, 0},
{"gdk_window_impl_x11_get_type", iFv, 0},
{"gdk_window_input_shape_combine_mask", vFppii, 0},
{"gdk_window_input_shape_combine_region", vFppii, 0},

{"gdk_window_invalidate_rect", vFppi, 0},
{"gdk_window_invalidate_region", vFppi, 0},
{"gdk_window_is_destroyed", iFp, 0},
{"gdk_window_is_input_only", iFp, 0},
{"gdk_window_is_shaped", iFp, 0},
{"gdk_window_is_viewable", iFp, 0},
{"gdk_window_is_visible", iFp, 0},
{"gdk_window_lookup", pFp, 0},
{"gdk_window_lookup_for_display", pFpp, 0},
{"gdk_window_lower", vFp, 0},
{"gdk_window_maximize", vFp, 0},
{"gdk_window_merge_child_input_shapes", vFp, 0},
{"gdk_window_merge_child_shapes", vFp, 0},
{"gdk_window_move", vFpii, 0},
{"gdk_window_move_region", vFppii, 0},
{"gdk_window_move_resize", vFpiiii, 0},
{"gdk_window_new", pFppi, 0},
{"gdk_window_object_get_type", iFv, 0},
{"gdk_window_peek_children", pFp, 0},
{"gdk_window_process_all_updates", vFv, 0},
{"gdk_window_process_updates", vFpi, 0},
{"gdk_window_raise", vFp, 0},
{"gdk_window_redirect_to_drawable", vFppiiiiii, 0},
{"gdk_window_register_dnd", vFp, 0},

{"gdk_window_remove_redirection", vFp, 0},
{"gdk_window_reparent", vFppii, 0},
{"gdk_window_resize", vFpii, 0},
{"gdk_window_restack", vFppi, 0},
{"gdk_window_scroll", vFpii, 0},
{"gdk_window_set_accept_focus", vFpi, 0},
{"gdk_window_set_background", vFpp, 0},
{"gdk_window_set_back_pixmap", vFppi, 0},
{"gdk_window_set_child_input_shapes", vFp, 0},
{"gdk_window_set_child_shapes", vFp, 0},
{"gdk_window_set_composited", vFpi, 0},
{"gdk_window_set_cursor", vFpp, 0},
{"gdk_window_set_debug_updates", vFi, 0},
{"gdk_window_set_decorations", vFpp, 0},
{"gdk_window_set_events", vFpp, 0},
{"gdk_window_set_focus_on_map", vFpi, 0},
{"gdk_window_set_functions", vFpu, 0},
{"gdk_window_set_geometry_hints", vFppi, 0},
{"gdk_window_set_group", vFpp, 0},
{"gdk_window_set_hints", vFpiiiiiii, 0},
{"gdk_window_set_icon", vFpppp, 0},
{"gdk_window_set_icon_list", vFpp, 0},
{"gdk_window_set_icon_name", vFpp, 0},
{"gdk_window_set_keep_above", vFpi, 0},
{"gdk_window_set_keep_below", vFpi, 0},
{"gdk_window_set_modal_hint", iFp, 0},
{"gdk_window_set_opacity", vFpi, 0},
{"gdk_window_set_override_redirect", vFpi, 0},
{"gdk_window_set_role", vFpp, 0},
{"gdk_window_set_skip_pager_hint", vFpi, 0},
{"gdk_window_set_skip_taskbar_hint", vFpi, 0},
{"gdk_window_set_startup_id", vFpp, 0},
{"gdk_window_set_static_gravities", iFpi, 0},
{"gdk_window_set_title", vFpp, 0},
{"gdk_window_set_transient_for", vFpp, 0},
{"gdk_window_set_type_hint", vFpi, 0},
{"gdk_window_set_urgency_hint", vFpi, 0},
{"gdk_window_set_user_data", vFpp, 0},
{"gdk_window_shape_combine_mask", vFppii, 0},
{"gdk_window_shape_combine_region", vFppii, 0},
{"gdk_window_show", vFp, 0},
{"gdk_window_show_unraised", vFp, 0},
{"gdk_window_state_get_type", iFv, 0},
{"gdk_window_stick", vFp, 0},

{"gdk_window_thaw_updates", vFp, 0},
{"gdk_window_type_get_type", iFv, 0},
{"gdk_window_type_hint_get_type", iFv, 0},
{"gdk_window_unfullscreen", vFp, 0},
{"gdk_window_unmaximize", vFp, 0},
{"gdk_window_unstick", vFp, 0},
{"gdk_window_withdraw", vFp, 0},
{"gdk_wm_decoration_get_type", iFv, 0},
{"gdk_wm_function_get_type", iFv, 0},
{"gdk_x11_atom_to_xatom", pFp, 0},
{"gdk_x11_atom_to_xatom_for_display", pFpp, 0},
{"gdk_x11_colormap_foreign_new", pFpp, 0},
{"gdk_x11_colormap_get_xcolormap", pFp, 0},
{"gdk_x11_colormap_get_xdisplay", pFp, 0},
{"gdk_x11_cursor_get_xcursor", pFp, 0},
{"gdk_x11_cursor_get_xdisplay", pFp, 0},
{"gdk_x11_display_broadcast_startup_message", vFppppppppppppp, 0},
{"gdk_x11_display_get_startup_notification_id", pFp, 0},
{"gdk_x11_display_get_user_time", uFp, 0},
{"gdk_x11_display_get_xdisplay", pFp, 0},
{"gdk_x11_display_grab", vFp, 0},
{"gdk_x11_display_set_cursor_theme", vFppi, 0},


{"gdk_x11_display_ungrab", vFp, 0},

{"gdk_x11_drawable_get_xdisplay", pFp, 0},
{"gdk_x11_drawable_get_xid", pFp, 0},
{"gdk_x11_font_get_name", pFp, 0},
{"gdk_x11_font_get_xdisplay", pFp, 0},
{"gdk_x11_font_get_xfont", pFp, 0},


{"gdk_x11_gc_get_xdisplay", pFp, 0},
{"gdk_x11_gc_get_xgc", pFp, 0},
{"gdk_x11_get_default_root_xwindow", pFv, 0},
{"gdk_x11_get_default_screen", iFv, 0},
{"gdk_x11_get_default_xdisplay", pFv, 0},
{"gdk_x11_get_server_time", uFp, 0},
{"gdk_x11_get_xatom_by_name", pFp, 0},
{"gdk_x11_get_xatom_by_name_for_display", pFpp, 0},
{"gdk_x11_get_xatom_name", pFp, 0},
{"gdk_x11_get_xatom_name_for_display", pFpp, 0},
{"gdk_x11_grab_server", vFv, 0},
{"gdk_x11_image_get_xdisplay", pFp, 0},
{"gdk_x11_image_get_ximage", pFp, 0},
{"gdk_x11_lookup_xdisplay", pFp, 0},
{"gdk_x11_pixmap_get_drawable_impl", pFp, 0},
{"gdk_x11_register_standard_event_type", vFpii, 0},
{"gdk_x11_screen_get_monitor_output", pFpi, 0},
{"gdk_x11_screen_get_screen_number", iFp, 0},
{"gdk_x11_screen_get_window_manager_name", pFp, 0},
{"gdk_x11_screen_get_xscreen", pFp, 0},
{"gdk_x11_screen_lookup_visual", pFpp, 0},
{"gdk_x11_screen_supports_net_wm_hint", iFpp, 0},
{"gdk_x11_set_sm_client_id", vFp, 0},
{"gdk_x11_ungrab_server", vFv, 0},
{"gdk_x11_visual_get_xvisual", pFp, 0},
{"gdk_x11_window_foreign_new_for_display", pFpp, 0},
{"gdk_x11_window_get_drawable_impl", pFp, 0},
{"gdk_x11_window_lookup_for_display", pFpp, 0},
{"gdk_x11_window_move_to_current_desktop", vFp, 0},
{"gdk_x11_window_set_user_time", vFpu, 0},
{"gdk_x11_xatom_to_atom", pFp, 0},
{"gdk_x11_xatom_to_atom_for_display", pFpp, 0},
{"gdkx_colormap_get", pFu, 0},
{"gdk_xid_table_lookup", pFp, 0},
{"gdk_xid_table_lookup_for_display", pFpp, 0},
{"gdkx_visual_get", pFp, 0},





{"dummy_set_child_property", vFppupp, 0},
...
static const map_onesymbol_t gdkx112mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
...
{"gdk_event_handler_set", vFEppp, 0},
...
{"gdk_init", vFEpp, 0},
{"gdk_init_check", iFEpp, 0},
{"gdk_input_add", iFEiipp, 0},
{"gdk_input_add_full", iFEiippp, 0},
...
{"gdk_window_add_filter", vFEppp, 0},
...
{"gdk_window_remove_filter", vFEppp, 0},
...
static const map_onesymbol_t gdkx112stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
...
static const map_onesymbol2_t gdkx112symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
...
{"gdk_pixmap_ref", pFp, 0, "g_object_ref"},
{"gdk_pixmap_unref", vFp, 0, "g_object_unref"},
{"gdk_bitmap_ref", pFp, 0, "g_object_ref"},
{"gdk_bitmap_unref", vFp, 0, "g_object_unref"},
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 101 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onedata_t gdkx112datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
...
{"gdk_threads_lock", 4, 0},
{"gdk_threads_unlock", 4, 0},
...
static const map_onedata_t gdkx112mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h" 1
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgdkx112undefs.h" 1
...
int wrappedgdkx112_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gdkx112Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gdkx112symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gdkx112symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gdkx112symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gdkx112symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gdkx112symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gdkx112symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gdkx112symbolmap[i].name, '@')) AddDictionnary(box86->versym, gdkx112symbolmap[i].name); }
 cnt = sizeof(gdkx112mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gdkx112mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gdkx112mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gdkx112mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gdkx112mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gdkx112mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gdkx112mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gdkx112mysymbolmap[i].name); }

    cnt = sizeof(gdkx112stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gdkx112stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gdkx112stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gdkx112stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gdkx112stsymbolmap[i].name);
    }
    cnt = sizeof(gdkx112symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gdkx112symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gdkx112symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gdkx112symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gdkx112symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gdkx112symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gdkx112symbol2map[i].name);
    }
    cnt = sizeof(gdkx112datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gdkx112datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gdkx112datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gdkx112datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gdkx112datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gdkx112datamap[i].sz;
        }
    }
    cnt = sizeof(gdkx112mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gdkx112mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gdkx112mydatamap[i].sz;
    }

    libname = lib->name; getMy(lib); setNeededLibs(lib, 3, "libgobject-2.0.so.0", "libgio-2.0.so.0", "libgdk_pixbuf-2.0.so.0");


    return 0;
}

void wrappedgdkx112_fini(library_t* lib)
{
...
# 146 "/home/ssd/pico/code/box86/src/wrapped/wrappedgdkx112.c" 2
