# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpaneldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libpanelsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
{"panel_userptr", pFp, 0},
{"panel_window", pFp, 0},
{"replace_panel", iFpp, 0},
{"set_panel_userptr", iFpp, 0},
{"show_panel", iFp, 0},
{"top_panel", iFp, 0},
{"update_panels", vFv, 0},
...
static const map_onesymbol_t libpanelmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
static const map_onesymbol_t libpanelstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
static const map_onesymbol2_t libpanelsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
static const map_onedata_t libpaneldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
static const map_onedata_t libpanelmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibpanelundefs.h" 1
...
int wrappedlibpanel_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libpanelName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libpanelsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpanelsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libpanelsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libpanelsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libpanelsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libpanelsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libpanelsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpanelsymbolmap[i].name); }
 cnt = sizeof(libpanelmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libpanelmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libpanelmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libpanelmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libpanelmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libpanelmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libpanelmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libpanelmysymbolmap[i].name); }

    cnt = sizeof(libpanelstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libpanelstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libpanelstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libpanelstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libpanelstsymbolmap[i].name);
    }
    cnt = sizeof(libpanelsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libpanelsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libpanelsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libpanelsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libpanelsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libpanelsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libpanelsymbol2map[i].name);
    }
    cnt = sizeof(libpaneldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libpaneldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libpaneldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libpaneldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libpaneldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libpaneldatamap[i].sz;
        }
    }
    cnt = sizeof(libpanelmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libpanelmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libpanelmydatamap[i].sz;
    }
...
void wrappedlibpanel_fini(library_t* lib)
{
...
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibpanel.c" 2
