# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 82 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
...
typedef struct vorbisfile_my_s {
    ...
    iFpi_t ov_bitrate; iFp_t ov_bitrate_instant; iFp_t ov_clear; iFpi_t ov_comment; iFpp_t ov_crosslap; iFpp_t ov_fopen; iFpi_t ov_halfrate; iFp_t ov_halfrate_p; pFpi_t ov_info; iFpppi_t ov_open; iFppplC_t ov_open_callbacks; iFpI_t ov_pcm_seek; iFpI_t ov_pcm_seek_lap; iFpI_t ov_pcm_seek_page; iFpI_t ov_pcm_seek_page_lap; IFp_t ov_pcm_tell; IFpi_t ov_pcm_total; iFpi_t ov_raw_seek; iFpi_t ov_raw_seek_lap; IFp_t ov_raw_tell; IFpi_t ov_raw_total; iFppiiiip_t ov_read; iFppip_t ov_read_float; iFp_t ov_seekable; iFpi_t ov_serialnumber; iFp_t ov_streams; iFpppi_t ov_test; iFp_t ov_test_open; iFpd_t ov_time_seek; iFpd_t ov_time_seek_lap; iFpd_t ov_time_seek_page; iFpd_t ov_time_seek_page_lap; dFp_t ov_time_tell; dFpi_t ov_time_total;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static vorbisfile_my_t my_vorbisfile = {0};
static vorbisfile_my_t * const my = &my_vorbisfile;

static void getMy(library_t* lib)
{

    my->ov_bitrate = (iFpi_t)dlsym(lib->w.lib, "ov_bitrate"); my->ov_bitrate_instant = (iFp_t)dlsym(lib->w.lib, "ov_bitrate_instant"); my->ov_clear = (iFp_t)dlsym(lib->w.lib, "ov_clear"); my->ov_comment = (iFpi_t)dlsym(lib->w.lib, "ov_comment"); my->ov_crosslap = (iFpp_t)dlsym(lib->w.lib, "ov_crosslap"); my->ov_fopen = (iFpp_t)dlsym(lib->w.lib, "ov_fopen"); my->ov_halfrate = (iFpi_t)dlsym(lib->w.lib, "ov_halfrate"); my->ov_halfrate_p = (iFp_t)dlsym(lib->w.lib, "ov_halfrate_p"); my->ov_info = (pFpi_t)dlsym(lib->w.lib, "ov_info"); my->ov_open = (iFpppi_t)dlsym(lib->w.lib, "ov_open"); my->ov_open_callbacks = (iFppplC_t)dlsym(lib->w.lib, "ov_open_callbacks"); my->ov_pcm_seek = (iFpI_t)dlsym(lib->w.lib, "ov_pcm_seek"); my->ov_pcm_seek_lap = (iFpI_t)dlsym(lib->w.lib, "ov_pcm_seek_lap"); my->ov_pcm_seek_page = (iFpI_t)dlsym(lib->w.lib, "ov_pcm_seek_page"); my->ov_pcm_seek_page_lap = (iFpI_t)dlsym(lib->w.lib, "ov_pcm_seek_page_lap"); my->ov_pcm_tell = (IFp_t)dlsym(lib->w.lib, "ov_pcm_tell"); my->ov_pcm_total = (IFpi_t)dlsym(lib->w.lib, "ov_pcm_total"); my->ov_raw_seek = (iFpi_t)dlsym(lib->w.lib, "ov_raw_seek"); my->ov_raw_seek_lap = (iFpi_t)dlsym(lib->w.lib, "ov_raw_seek_lap"); my->ov_raw_tell = (IFp_t)dlsym(lib->w.lib, "ov_raw_tell"); my->ov_raw_total = (IFpi_t)dlsym(lib->w.lib, "ov_raw_total"); my->ov_read = (iFppiiiip_t)dlsym(lib->w.lib, "ov_read"); my->ov_read_float = (iFppip_t)dlsym(lib->w.lib, "ov_read_float"); my->ov_seekable = (iFp_t)dlsym(lib->w.lib, "ov_seekable"); my->ov_serialnumber = (iFpi_t)dlsym(lib->w.lib, "ov_serialnumber"); my->ov_streams = (iFp_t)dlsym(lib->w.lib, "ov_streams"); my->ov_test = (iFpppi_t)dlsym(lib->w.lib, "ov_test"); my->ov_test_open = (iFp_t)dlsym(lib->w.lib, "ov_test_open"); my->ov_time_seek = (iFpd_t)dlsym(lib->w.lib, "ov_time_seek"); my->ov_time_seek_lap = (iFpd_t)dlsym(lib->w.lib, "ov_time_seek_lap"); my->ov_time_seek_page = (iFpd_t)dlsym(lib->w.lib, "ov_time_seek_page"); my->ov_time_seek_page_lap = (iFpd_t)dlsym(lib->w.lib, "ov_time_seek_page_lap"); my->ov_time_tell = (dFp_t)dlsym(lib->w.lib, "ov_time_tell"); my->ov_time_total = (dFpi_t)dlsym(lib->w.lib, "ov_time_total");
...
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
...
# 336 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
static uintptr_t my_read_fct_0 = 0; static unsigned long my_read_0(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_0, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_1 = 0; static unsigned long my_read_1(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_1, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_2 = 0; static unsigned long my_read_2(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_2, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_3 = 0; static unsigned long my_read_3(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_3, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_4 = 0; static unsigned long my_read_4(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_4, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_5 = 0; static unsigned long my_read_5(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_5, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_6 = 0; static unsigned long my_read_6(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_6, "pLLp", ptr, size, nmemb, datasource);} static uintptr_t my_read_fct_7 = 0; static unsigned long my_read_7(void* ptr, unsigned long size, unsigned long nmemb, void* datasource) { return (unsigned long)RunFunctionFmt(my_read_fct_7, "pLLp", ptr, size, nmemb, datasource);}

static void* findreadFct(void* fct)
{
    if(!fct) return 
# 340 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
                   ((void *)0)
# 340 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_read_fct_0 == (uintptr_t)fct) return my_read_0; if(my_read_fct_1 == (uintptr_t)fct) return my_read_1; if(my_read_fct_2 == (uintptr_t)fct) return my_read_2; if(my_read_fct_3 == (uintptr_t)fct) return my_read_3; if(my_read_fct_4 == (uintptr_t)fct) return my_read_4; if(my_read_fct_5 == (uintptr_t)fct) return my_read_5; if(my_read_fct_6 == (uintptr_t)fct) return my_read_6; if(my_read_fct_7 == (uintptr_t)fct) return my_read_7;


    if(my_read_fct_0 == 0) {my_read_fct_0 = (uintptr_t)fct; return my_read_0; } if(my_read_fct_1 == 0) {my_read_fct_1 = (uintptr_t)fct; return my_read_1; } if(my_read_fct_2 == 0) {my_read_fct_2 = (uintptr_t)fct; return my_read_2; } if(my_read_fct_3 == 0) {my_read_fct_3 = (uintptr_t)fct; return my_read_3; } if(my_read_fct_4 == 0) {my_read_fct_4 = (uintptr_t)fct; return my_read_4; } if(my_read_fct_5 == 0) {my_read_fct_5 = (uintptr_t)fct; return my_read_5; } if(my_read_fct_6 == 0) {my_read_fct_6 = (uintptr_t)fct; return my_read_6; } if(my_read_fct_7 == 0) {my_read_fct_7 = (uintptr_t)fct; return my_read_7; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for vorbisfile read callback\n"); fflush(ftrace);}} while(0);
    return 
# 349 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
          ((void *)0)
# 349 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
              ;
}
...
static uintptr_t my_seek_fct_0 = 0; static int my_seek_0(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_0, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_1 = 0; static int my_seek_1(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_1, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_2 = 0; static int my_seek_2(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_2, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_3 = 0; static int my_seek_3(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_3, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_4 = 0; static int my_seek_4(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_4, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_5 = 0; static int my_seek_5(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_5, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_6 = 0; static int my_seek_6(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_6, "pIi", ptr, offset, whence);} static uintptr_t my_seek_fct_7 = 0; static int my_seek_7(void* ptr, int64_t offset, int whence) { return (int)RunFunctionFmt(my_seek_fct_7, "pIi", ptr, offset, whence);}

static void* findseekFct(void* fct)
{
    if(!fct) return 
# 362 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
                   ((void *)0)
# 362 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_seek_fct_0 == (uintptr_t)fct) return my_seek_0; if(my_seek_fct_1 == (uintptr_t)fct) return my_seek_1; if(my_seek_fct_2 == (uintptr_t)fct) return my_seek_2; if(my_seek_fct_3 == (uintptr_t)fct) return my_seek_3; if(my_seek_fct_4 == (uintptr_t)fct) return my_seek_4; if(my_seek_fct_5 == (uintptr_t)fct) return my_seek_5; if(my_seek_fct_6 == (uintptr_t)fct) return my_seek_6; if(my_seek_fct_7 == (uintptr_t)fct) return my_seek_7;


    if(my_seek_fct_0 == 0) {my_seek_fct_0 = (uintptr_t)fct; return my_seek_0; } if(my_seek_fct_1 == 0) {my_seek_fct_1 = (uintptr_t)fct; return my_seek_1; } if(my_seek_fct_2 == 0) {my_seek_fct_2 = (uintptr_t)fct; return my_seek_2; } if(my_seek_fct_3 == 0) {my_seek_fct_3 = (uintptr_t)fct; return my_seek_3; } if(my_seek_fct_4 == 0) {my_seek_fct_4 = (uintptr_t)fct; return my_seek_4; } if(my_seek_fct_5 == 0) {my_seek_fct_5 = (uintptr_t)fct; return my_seek_5; } if(my_seek_fct_6 == 0) {my_seek_fct_6 = (uintptr_t)fct; return my_seek_6; } if(my_seek_fct_7 == 0) {my_seek_fct_7 = (uintptr_t)fct; return my_seek_7; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for vorbisfile seek callback\n"); fflush(ftrace);}} while(0);
    return 
# 371 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
          ((void *)0)
# 371 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
              ;
}
...
static uintptr_t my_close_fct_0 = 0; static int my_close_0(void* ptr) { return (int)RunFunctionFmt(my_close_fct_0, "p", ptr); } static uintptr_t my_close_fct_1 = 0; static int my_close_1(void* ptr) { return (int)RunFunctionFmt(my_close_fct_1, "p", ptr); } static uintptr_t my_close_fct_2 = 0; static int my_close_2(void* ptr) { return (int)RunFunctionFmt(my_close_fct_2, "p", ptr); } static uintptr_t my_close_fct_3 = 0; static int my_close_3(void* ptr) { return (int)RunFunctionFmt(my_close_fct_3, "p", ptr); } static uintptr_t my_close_fct_4 = 0; static int my_close_4(void* ptr) { return (int)RunFunctionFmt(my_close_fct_4, "p", ptr); } static uintptr_t my_close_fct_5 = 0; static int my_close_5(void* ptr) { return (int)RunFunctionFmt(my_close_fct_5, "p", ptr); } static uintptr_t my_close_fct_6 = 0; static int my_close_6(void* ptr) { return (int)RunFunctionFmt(my_close_fct_6, "p", ptr); } static uintptr_t my_close_fct_7 = 0; static int my_close_7(void* ptr) { return (int)RunFunctionFmt(my_close_fct_7, "p", ptr); }

static void* findcloseFct(void* fct)
{
    if(!fct) return 
# 384 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
                   ((void *)0)
# 384 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_close_fct_0 == (uintptr_t)fct) return my_close_0; if(my_close_fct_1 == (uintptr_t)fct) return my_close_1; if(my_close_fct_2 == (uintptr_t)fct) return my_close_2; if(my_close_fct_3 == (uintptr_t)fct) return my_close_3; if(my_close_fct_4 == (uintptr_t)fct) return my_close_4; if(my_close_fct_5 == (uintptr_t)fct) return my_close_5; if(my_close_fct_6 == (uintptr_t)fct) return my_close_6; if(my_close_fct_7 == (uintptr_t)fct) return my_close_7;


    if(my_close_fct_0 == 0) {my_close_fct_0 = (uintptr_t)fct; return my_close_0; } if(my_close_fct_1 == 0) {my_close_fct_1 = (uintptr_t)fct; return my_close_1; } if(my_close_fct_2 == 0) {my_close_fct_2 = (uintptr_t)fct; return my_close_2; } if(my_close_fct_3 == 0) {my_close_fct_3 = (uintptr_t)fct; return my_close_3; } if(my_close_fct_4 == 0) {my_close_fct_4 = (uintptr_t)fct; return my_close_4; } if(my_close_fct_5 == 0) {my_close_fct_5 = (uintptr_t)fct; return my_close_5; } if(my_close_fct_6 == 0) {my_close_fct_6 = (uintptr_t)fct; return my_close_6; } if(my_close_fct_7 == 0) {my_close_fct_7 = (uintptr_t)fct; return my_close_7; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for vorbisfile close callback\n"); fflush(ftrace);}} while(0);
    return 
# 393 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
          ((void *)0)
# 393 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
              ;
}
...
static uintptr_t my_tell_fct_0 = 0; static long my_tell_0(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_0, "p", ptr); } static uintptr_t my_tell_fct_1 = 0; static long my_tell_1(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_1, "p", ptr); } static uintptr_t my_tell_fct_2 = 0; static long my_tell_2(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_2, "p", ptr); } static uintptr_t my_tell_fct_3 = 0; static long my_tell_3(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_3, "p", ptr); } static uintptr_t my_tell_fct_4 = 0; static long my_tell_4(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_4, "p", ptr); } static uintptr_t my_tell_fct_5 = 0; static long my_tell_5(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_5, "p", ptr); } static uintptr_t my_tell_fct_6 = 0; static long my_tell_6(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_6, "p", ptr); } static uintptr_t my_tell_fct_7 = 0; static long my_tell_7(void* ptr) { return (long)RunFunctionFmt(my_tell_fct_7, "p", ptr); }

static void* findtellFct(void* fct)
{
    if(!fct) return 
# 406 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
                   ((void *)0)
# 406 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_tell_fct_0 == (uintptr_t)fct) return my_tell_0; if(my_tell_fct_1 == (uintptr_t)fct) return my_tell_1; if(my_tell_fct_2 == (uintptr_t)fct) return my_tell_2; if(my_tell_fct_3 == (uintptr_t)fct) return my_tell_3; if(my_tell_fct_4 == (uintptr_t)fct) return my_tell_4; if(my_tell_fct_5 == (uintptr_t)fct) return my_tell_5; if(my_tell_fct_6 == (uintptr_t)fct) return my_tell_6; if(my_tell_fct_7 == (uintptr_t)fct) return my_tell_7;


    if(my_tell_fct_0 == 0) {my_tell_fct_0 = (uintptr_t)fct; return my_tell_0; } if(my_tell_fct_1 == 0) {my_tell_fct_1 = (uintptr_t)fct; return my_tell_1; } if(my_tell_fct_2 == 0) {my_tell_fct_2 = (uintptr_t)fct; return my_tell_2; } if(my_tell_fct_3 == 0) {my_tell_fct_3 = (uintptr_t)fct; return my_tell_3; } if(my_tell_fct_4 == 0) {my_tell_fct_4 = (uintptr_t)fct; return my_tell_4; } if(my_tell_fct_5 == 0) {my_tell_fct_5 = (uintptr_t)fct; return my_tell_5; } if(my_tell_fct_6 == 0) {my_tell_fct_6 = (uintptr_t)fct; return my_tell_6; } if(my_tell_fct_7 == 0) {my_tell_fct_7 = (uintptr_t)fct; return my_tell_7; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for vorbisfile tell callback\n"); fflush(ftrace);}} while(0);
    return 
# 415 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 3 4
          ((void *)0)
# 415 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
              ;
}



__attribute__((visibility("default"))) int32_t my_ov_open_callbacks(x86emu_t* emu, void* datasource, void* vf, void* initial, long ibytes, void* read_fnc, void* seek_fnc, void* close_fnc, void* tell_fnc)
{
    (void)emu;
    ov_callbacks cbs = {0};
...
# 447 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedvorbisfiledefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t vorbisfilesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1



{"ov_bitrate", iFpi, 0},
{"ov_bitrate_instant", iFp, 0},
{"ov_clear", iFp, 0},
{"ov_comment", pFpi, 0},
{"ov_crosslap", iFpp, 0},
{"ov_fopen", iFpp, 0},
...
{"ov_pcm_seek", iFpI, 0},
{"ov_pcm_seek_lap", iFpi, 0},
{"ov_pcm_seek_page", iFpI, 0},
{"ov_pcm_seek_page_lap", iFpI, 0},
{"ov_pcm_tell", IFp, 0},
{"ov_pcm_total", IFpi, 0},
{"ov_raw_seek", iFpi, 0},
{"ov_raw_seek_lap", iFpi, 0},
{"ov_raw_tell", IFp, 0},
{"ov_raw_total", IFpi, 0},
{"ov_read", iFppiiiip, 0},

{"ov_read_float", iFppip, 0},
{"ov_seekable", iFp, 0},
{"ov_serialnumber", iFpi, 0},
{"ov_streams", iFp, 0},
{"ov_test", iFpppi, 0},

{"ov_test_open", iFp, 0},
{"ov_time_seek", iFpd, 0},
{"ov_time_seek_lap", iFpd, 0},
{"ov_time_seek_page", iFpd, 0},
{"ov_time_seek_page_lap", iFpd, 0},
{"ov_time_tell", dFp, 0},
{"ov_time_total", dFpi, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t vorbisfilemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1
...
{"ov_open_callbacks", iFEpppipppp, 0},
...
static const map_onesymbol_t vorbisfilestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1
...
static const map_onesymbol2_t vorbisfilesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1
...
static const map_onedata_t vorbisfiledatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1
...
static const map_onedata_t vorbisfilemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedvorbisfileundefs.h" 1
...
int wrappedvorbisfile_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(vorbisfileName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(vorbisfileName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(vorbisfilesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (vorbisfilesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, vorbisfilesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = vorbisfilesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, vorbisfilesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = vorbisfilesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(vorbisfilesymbolmap[i].name, '@')) AddDictionnary(box86->versym, vorbisfilesymbolmap[i].name); }
 cnt = sizeof(vorbisfilemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (vorbisfilemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, vorbisfilemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = vorbisfilemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, vorbisfilemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = vorbisfilemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(vorbisfilemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, vorbisfilemysymbolmap[i].name); }

    cnt = sizeof(vorbisfilestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, vorbisfilestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = vorbisfilestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(vorbisfilestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, vorbisfilestsymbolmap[i].name);
    }
    cnt = sizeof(vorbisfilesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, vorbisfilesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = vorbisfilesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = vorbisfilesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = vorbisfilesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(vorbisfilesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, vorbisfilesymbol2map[i].name);
    }
    cnt = sizeof(vorbisfiledatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(vorbisfiledatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, vorbisfiledatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = vorbisfiledatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, vorbisfiledatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = vorbisfiledatamap[i].sz;
        }
    }
    cnt = sizeof(vorbisfilemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, vorbisfilemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = vorbisfilemydatamap[i].sz;
    }
...
void wrappedvorbisfile_fini(library_t* lib)
{
...
# 448 "/home/ssd/pico/code/box86/src/wrapped/wrappedvorbisfile.c" 2
