# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2netdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t sdl2netsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
static const map_onesymbol_t sdl2netmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
static const map_onesymbol_t sdl2netstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
static const map_onesymbol2_t sdl2netsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
static const map_onedata_t sdl2netdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
static const map_onedata_t sdl2netmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2netundefs.h" 1
...
int wrappedsdl2net_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(sdl2netName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(sdl2netsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (sdl2netsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, sdl2netsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = sdl2netsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, sdl2netsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = sdl2netsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(sdl2netsymbolmap[i].name, '@')) AddDictionnary(box86->versym, sdl2netsymbolmap[i].name); }
 cnt = sizeof(sdl2netmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (sdl2netmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, sdl2netmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = sdl2netmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, sdl2netmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = sdl2netmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(sdl2netmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, sdl2netmysymbolmap[i].name); }

    cnt = sizeof(sdl2netstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, sdl2netstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = sdl2netstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(sdl2netstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, sdl2netstsymbolmap[i].name);
    }
    cnt = sizeof(sdl2netsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, sdl2netsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = sdl2netsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = sdl2netsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = sdl2netsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(sdl2netsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, sdl2netsymbol2map[i].name);
    }
    cnt = sizeof(sdl2netdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(sdl2netdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, sdl2netdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = sdl2netdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, sdl2netdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = sdl2netdatamap[i].sz;
        }
    }
    cnt = sizeof(sdl2netmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, sdl2netmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = sdl2netmydatamap[i].sz;
    }

    lib->w.altmy = box_strdup("my2_");


    return 0;
}

void wrappedsdl2net_fini(library_t* lib)
{
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2net.c" 2
