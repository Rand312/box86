# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
...
typedef struct libxcbimage_my_s {


    XFpuupwwC_t xcb_image_put;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libxcbimage_my_t my_libxcbimage = {0};
static libxcbimage_my_t * const my = &my_libxcbimage;

static void getMy(library_t* lib)
{

    my->xcb_image_put = (XFpuupwwC_t)dlsym(lib->w.lib, "xcb_image_put");
...
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c"
__attribute__((visibility("default"))) void* my_xcb_image_put (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t d, uint32_t gc, void* img, int16_t x, int16_t y, uint8_t pad) { (void)emu; *ret = my->xcb_image_put(c, d, gc, img, x, y, pad); return ret; }
# 58 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbimagedefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcbimagesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
{"xcb_create_pixmap_from_bitmap_data", pFpupuuuuup, 0},
{"xcb_image_annotate", vFp, 0},
{"xcb_image_convert", pFpp, 0},
{"xcb_image_create", pFWWiCCCCiipup, 0},
{"xcb_image_create_from_bitmap_data", pFpuu, 0},
{"xcb_image_create_native", pFpWWiCpup, 0},
{"xcb_image_destroy", vFp, 0},
{"xcb_image_get", pFpdwwWWui, 0},
{"xcb_image_get_pixel", uFpuu, 0},
{"xcb_image_native", pFppi, 0},

{"xcb_image_put_pixel", vFpuuu, 0},
{"xcb_image_shm_get", iFpupuupWWu, 0},
{"xcb_image_shm_put", pFpuupuupwwwwWWC, 0},
{"xcb_image_subimage", pFpuuuupup, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcbimagemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
static const map_onesymbol_t libxcbimagestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
static const map_onesymbol2_t libxcbimagesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
static const map_onedata_t libxcbimagedatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
static const map_onedata_t libxcbimagemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbimageundefs.h" 1
...
int wrappedlibxcbimage_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxcbimageName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxcbimageName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxcbimagesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbimagesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxcbimagesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxcbimagesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxcbimagesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxcbimagesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbimagesymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbimagesymbolmap[i].name); }
 cnt = sizeof(libxcbimagemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbimagemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxcbimagemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxcbimagemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxcbimagemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxcbimagemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbimagemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbimagemysymbolmap[i].name); }

    cnt = sizeof(libxcbimagestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxcbimagestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxcbimagestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxcbimagestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxcbimagestsymbolmap[i].name);
    }
    cnt = sizeof(libxcbimagesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxcbimagesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxcbimagesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxcbimagesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxcbimagesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxcbimagesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxcbimagesymbol2map[i].name);
    }
    cnt = sizeof(libxcbimagedatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxcbimagedatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxcbimagedatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxcbimagedatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxcbimagedatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxcbimagedatamap[i].sz;
        }
    }
    cnt = sizeof(libxcbimagemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxcbimagemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxcbimagemydatamap[i].sz;
    }
...
void wrappedlibxcbimage_fini(library_t* lib)
{
...
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbimage.c" 2
