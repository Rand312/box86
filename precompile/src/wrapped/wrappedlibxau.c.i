# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxaudefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxausymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1




{"XauDisposeAuth", iFp, 0},
{"XauFileName", pFv, 0},
{"XauGetAuthByAddr", pFuupupup, 0},
{"XauGetBestAuthByAddr", pFuupupipp, 0},
{"XauLockAuth", iFpiii, 0},
{"XauReadAuth", pFp, 0},
{"XauUnlockAuth", iFp, 0},
{"XauWriteAuth", iFpp, 0},
...
static const map_onesymbol_t libxaumysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1
...
static const map_onesymbol_t libxaustsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1
...
static const map_onesymbol2_t libxausymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1
...
static const map_onedata_t libxaudatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1
...
static const map_onedata_t libxaumydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxauundefs.h" 1
...
int wrappedlibxau_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxauName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxausymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxausymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxausymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxausymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxausymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxausymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxausymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxausymbolmap[i].name); }
 cnt = sizeof(libxaumysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxaumysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxaumysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxaumysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxaumysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxaumysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxaumysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxaumysymbolmap[i].name); }

    cnt = sizeof(libxaustsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxaustsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxaustsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxaustsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxaustsymbolmap[i].name);
    }
    cnt = sizeof(libxausymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxausymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxausymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxausymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxausymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxausymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxausymbol2map[i].name);
    }
    cnt = sizeof(libxaudatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxaudatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxaudatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxaudatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxaudatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxaudatamap[i].sz;
        }
    }
    cnt = sizeof(libxaumydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxaumydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxaumydatamap[i].sz;
    }
...
void wrappedlibxau_fini(library_t* lib)
{
...
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxau.c" 2
