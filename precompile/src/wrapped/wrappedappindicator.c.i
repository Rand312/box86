# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2

const char* appindicatorName = "libappindicator.so.1";
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedappindicatordefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t appindicatorsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1




{"app_indicator_build_menu_from_desktop", vFppp, 0},
{"app_indicator_category_get_type", iFv, 0},
...
static const map_onesymbol_t appindicatormysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1
...
static const map_onesymbol_t appindicatorstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1
...
static const map_onesymbol2_t appindicatorsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1
...
static const map_onedata_t appindicatordatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1
...
static const map_onedata_t appindicatormydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedappindicatorundefs.h" 1
...
int wrappedappindicator_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(appindicatorName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(appindicatorName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(appindicatorsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (appindicatorsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, appindicatorsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = appindicatorsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, appindicatorsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = appindicatorsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(appindicatorsymbolmap[i].name, '@')) AddDictionnary(box86->versym, appindicatorsymbolmap[i].name); }
 cnt = sizeof(appindicatormysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (appindicatormysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, appindicatormysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = appindicatormysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, appindicatormysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = appindicatormysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(appindicatormysymbolmap[i].name, '@')) AddDictionnary(box86->versym, appindicatormysymbolmap[i].name); }

    cnt = sizeof(appindicatorstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, appindicatorstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = appindicatorstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(appindicatorstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, appindicatorstsymbolmap[i].name);
    }
    cnt = sizeof(appindicatorsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, appindicatorsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = appindicatorsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = appindicatorsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = appindicatorsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(appindicatorsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, appindicatorsymbol2map[i].name);
    }
    cnt = sizeof(appindicatordatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(appindicatordatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, appindicatordatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = appindicatordatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, appindicatordatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = appindicatordatamap[i].sz;
        }
    }
    cnt = sizeof(appindicatormydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, appindicatormydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = appindicatormydatamap[i].sz;
    }
...
void wrappedappindicator_fini(library_t* lib)
{
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedappindicator.c" 2
