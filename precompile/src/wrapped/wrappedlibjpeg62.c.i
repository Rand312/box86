# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2

const char* libjpeg62Name = "libjpeg.so.62";



static bridge_t* my_bridge = 
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                            ((void *)0)
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                ;



# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpeg62types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpeg62types.h"
...
# 32 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
typedef struct libjpeg62_my_s {


    vFp_t jpeg_destroy_compress; vFp_t jpeg_destroy_decompress; vFp_t jpeg_finish_compress; vFp_t jpeg_set_defaults; iFv_t jpeg_simd_cpu_support; iFp_t jpeg_finish_decompress; iFp_t jpeg_start_decompress; pFp_t jpeg_std_error; vFpi_t jpeg_start_compress; vFpp_t jpeg_stdio_dest; vFpp_t jpeg_stdio_src; iFpi_t jpeg_read_header; iFpi_t jpeg_resync_to_restart; vFpii_t jpeg_set_quality; vFpiL_t jpeg_CreateCompress; vFpiL_t jpeg_CreateDecompress; vFpip_t jpeg_set_marker_processor; vFppp_t jpeg_mem_dest; uFppu_t jpeg_read_scanlines; uFppu_t jpeg_write_scanlines; vFpipu_t jpeg_write_marker;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libjpeg62_my_t my_libjpeg62 = {0};
static libjpeg62_my_t * const my = &my_libjpeg62;

static void getMy(library_t* lib)
{

    my->jpeg_destroy_compress = (vFp_t)dlsym(lib->w.lib, "jpeg_destroy_compress"); my->jpeg_destroy_decompress = (vFp_t)dlsym(lib->w.lib, "jpeg_destroy_decompress"); my->jpeg_finish_compress = (vFp_t)dlsym(lib->w.lib, "jpeg_finish_compress"); my->jpeg_set_defaults = (vFp_t)dlsym(lib->w.lib, "jpeg_set_defaults"); my->jpeg_simd_cpu_support = (iFv_t)dlsym(lib->w.lib, "jpeg_simd_cpu_support"); my->jpeg_finish_decompress = (iFp_t)dlsym(lib->w.lib, "jpeg_finish_decompress"); my->jpeg_start_decompress = (iFp_t)dlsym(lib->w.lib, "jpeg_start_decompress"); my->jpeg_std_error = (pFp_t)dlsym(lib->w.lib, "jpeg_std_error"); my->jpeg_start_compress = (vFpi_t)dlsym(lib->w.lib, "jpeg_start_compress"); my->jpeg_stdio_dest = (vFpp_t)dlsym(lib->w.lib, "jpeg_stdio_dest"); my->jpeg_stdio_src = (vFpp_t)dlsym(lib->w.lib, "jpeg_stdio_src"); my->jpeg_read_header = (iFpi_t)dlsym(lib->w.lib, "jpeg_read_header"); my->jpeg_resync_to_restart = (iFpi_t)dlsym(lib->w.lib, "jpeg_resync_to_restart"); my->jpeg_set_quality = (vFpii_t)dlsym(lib->w.lib, "jpeg_set_quality"); my->jpeg_CreateCompress = (vFpiL_t)dlsym(lib->w.lib, "jpeg_CreateCompress"); my->jpeg_CreateDecompress = (vFpiL_t)dlsym(lib->w.lib, "jpeg_CreateDecompress"); my->jpeg_set_marker_processor = (vFpip_t)dlsym(lib->w.lib, "jpeg_set_marker_processor"); my->jpeg_mem_dest = (vFppp_t)dlsym(lib->w.lib, "jpeg_mem_dest"); my->jpeg_read_scanlines = (uFppu_t)dlsym(lib->w.lib, "jpeg_read_scanlines"); my->jpeg_write_scanlines = (uFppu_t)dlsym(lib->w.lib, "jpeg_write_scanlines"); my->jpeg_write_marker = (vFpipu_t)dlsym(lib->w.lib, "jpeg_write_marker");
...
# 34 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
...
# 233 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
typedef struct j62_compress_ptr_s
{
    jpeg62_error_mgr_t* err; jpeg62_memory_mgr_t* mem; void* progress; void* client_data; int is_decompressor; int global_state; jpeg62_destination_mgr_t* dest; uint32_t image_width; uint32_t image_height; int input_components; int in_color_space; double input_gamma; int data_precision; int num_components; int jpeg_color_space; void* comp_info; void* quant_tbl_ptrs[4];; void* dc_huff_tbl_ptrs[4]; void* ac_huff_tbl_ptrs[4]; uint8_t arith_dc_L[16]; uint8_t arith_dc_U[16]; uint8_t arith_ac_K[16]; int num_scans; void* scan_info; int raw_data_in; int arith_code; int optimize_coding; int CCIR601_sampling; int smoothing_factor; int dct_method; uint32_t restart_interval; int restart_in_rows; int write_JFIF_header; uint8_t JFIF_major_version; uint8_t JFIF_minor_version; uint8_t density_unit; uint16_t X_density; uint16_t Y_density; int write_Adobe_marker; uint32_t next_scanline; int progressive_mode; int max_h_samp_factor; int max_v_samp_factor; uint32_t total_iMCU_rows; int comps_in_scan; void* cur_comp_info[4]; uint32_t MCUs_per_row; uint32_t MCU_rows_in_scan; int blocks_in_MCU; int MCU_membership[10]; int Ss; int Se; int Ah; int Al; void* master; void* main; void* prep; void* coef; void* marker; void* cconvert; void* downsample; void* fdct; void* entropy; void* script_space; int script_space_size;
} j62_compress_ptr_t;


typedef struct i386_compress_ptr_s
{
    jpeg62_error_mgr_t* err; jpeg62_memory_mgr_t* mem; void* progress; void* client_data; int is_decompressor; int global_state; jpeg62_destination_mgr_t* dest; uint32_t image_width; uint32_t image_height; int input_components; int in_color_space; uint32_t input_gamma[2]; int data_precision; int num_components; int jpeg_color_space; void* comp_info; void* quant_tbl_ptrs[4];; void* dc_huff_tbl_ptrs[4]; void* ac_huff_tbl_ptrs[4]; uint8_t arith_dc_L[16]; uint8_t arith_dc_U[16]; uint8_t arith_ac_K[16]; int num_scans; void* scan_info; int raw_data_in; int arith_code; int optimize_coding; int CCIR601_sampling; int smoothing_factor; int dct_method; uint32_t restart_interval; int restart_in_rows; int write_JFIF_header; uint8_t JFIF_major_version; uint8_t JFIF_minor_version; uint8_t density_unit; uint16_t X_density; uint16_t Y_density; int write_Adobe_marker; uint32_t next_scanline; int progressive_mode; int max_h_samp_factor; int max_v_samp_factor; uint32_t total_iMCU_rows; int comps_in_scan; void* cur_comp_info[4]; uint32_t MCUs_per_row; uint32_t MCU_rows_in_scan; int blocks_in_MCU; int MCU_membership[10]; int Ss; int Se; int Ah; int Al; void* master; void* main; void* prep; void* coef; void* marker; void* cconvert; void* downsample; void* fdct; void* entropy; void* script_space; int script_space_size;
} i386_compress_ptr_t;
...
typedef struct jpeg62_comp_master_s {
  ...
  int call_pass_startup;
  int is_last_pass;
}jpeg62_comp_master_t;

void j62compress_i386_to_arm(j62_compress_ptr_t* d, i386_compress_ptr_t* s) {
    memcpy(d, s, 
# 260 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                __builtin_offsetof (
# 260 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                struct i386_compress_ptr_s
# 260 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                , 
# 260 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                input_gamma
...
# 260 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
    ...
    memcpy(&d->input_gamma, &s->input_gamma, sizeof(struct i386_compress_ptr_s) - 
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                 __builtin_offsetof (
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                 struct i386_compress_ptr_s
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                 , 
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
void j62compress_arm_to_i386(i386_compress_ptr_t* d, j62_compress_ptr_t* s) {
    memcpy(d, s, 
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                __builtin_offsetof (
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                struct i386_compress_ptr_s
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                , 
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
# 265 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
    ...
    memcpy(&d->input_gamma, &s->input_gamma, sizeof(struct i386_compress_ptr_s) - 
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                 __builtin_offsetof (
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                 struct i386_compress_ptr_s
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                 , 
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
# 284 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static void native_error_exit(jpeg62_common_struct_t* cinfo) {
    jpeg62_common_struct_t temp_cinfo = *cinfo; jpeg62_error_mgr_t err = *cinfo->err; temp_cinfo.err = &err; temp_cinfo.err->error_exit = GetNativeFncOrFnc((uintptr_t)cinfo->err->error_exit); temp_cinfo.err->emit_message = GetNativeFncOrFnc((uintptr_t)cinfo->err->emit_message); temp_cinfo.err->output_message = GetNativeFncOrFnc((uintptr_t)cinfo->err->output_message); temp_cinfo.err->format_message = GetNativeFncOrFnc((uintptr_t)cinfo->err->format_message); temp_cinfo.err->reset_error_mgr = GetNativeFncOrFnc((uintptr_t)cinfo->err->reset_error_mgr);;
...
# 343 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_error_exit_fct_0 = 0; static void my_error_exit_0(jpeg62_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapCommonStruct(cinfo, 0); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_0, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapCommonStruct(cinfo, 0); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_1 = 0; static void my_error_exit_1(jpeg62_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapCommonStruct(cinfo, 0); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_1, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapCommonStruct(cinfo, 0); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_2 = 0; static void my_error_exit_2(jpeg62_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapCommonStruct(cinfo, 0); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_2, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapCommonStruct(cinfo, 0); else longjmp(cinfo->client_data, 1); } static uintptr_t my_error_exit_fct_3 = 0; static void my_error_exit_3(jpeg62_common_struct_t* cinfo) { uintptr_t oldip = thread_get_emu()->ip.dword[0]; wrapCommonStruct(cinfo, 0); jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_error_exit_fct_3, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; if(oldip==thread_get_emu()->ip.dword[0]) unwrapCommonStruct(cinfo, 0); else longjmp(cinfo->client_data, 1); }
...
static void* finderror_exitFct(void* fct)
{
    ...
    if(my_error_exit_fct_0 == (uintptr_t)fct) return my_error_exit_0; if(my_error_exit_fct_1 == (uintptr_t)fct) return my_error_exit_1; if(my_error_exit_fct_2 == (uintptr_t)fct) return my_error_exit_2; if(my_error_exit_fct_3 == (uintptr_t)fct) return my_error_exit_3;


    if(my_error_exit_fct_0 == 0) {my_error_exit_fct_0 = (uintptr_t)fct; return my_error_exit_0; } if(my_error_exit_fct_1 == 0) {my_error_exit_fct_1 = (uintptr_t)fct; return my_error_exit_1; } if(my_error_exit_fct_2 == 0) {my_error_exit_fct_2 = (uintptr_t)fct; return my_error_exit_2; } if(my_error_exit_fct_3 == 0) {my_error_exit_fct_3 = (uintptr_t)fct; return my_error_exit_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Jpeg error_exit callback\n"); fflush(ftrace);}} while(0);
    return 
# 356 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 356 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_error_exitFct(void* fct)
{
    ...
    if(my_error_exit_0 == fct) return (void*)my_error_exit_fct_0; if(my_error_exit_1 == fct) return (void*)my_error_exit_fct_1; if(my_error_exit_2 == fct) return (void*)my_error_exit_fct_2; if(my_error_exit_3 == fct) return (void*)my_error_exit_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 366 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 366 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_emit_message_fct_0 = 0; static void my_emit_message_0(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_0, 2, cinfo, msg_level); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_1 = 0; static void my_emit_message_1(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_1, 2, cinfo, msg_level); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_2 = 0; static void my_emit_message_2(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_2, 2, cinfo, msg_level); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_emit_message_fct_3 = 0; static void my_emit_message_3(void* cinfo, int msg_level) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_emit_message_fct_3, 2, cinfo, msg_level); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findemit_messageFct(void* fct)
{
    ...
    if(my_emit_message_fct_0 == (uintptr_t)fct) return my_emit_message_0; if(my_emit_message_fct_1 == (uintptr_t)fct) return my_emit_message_1; if(my_emit_message_fct_2 == (uintptr_t)fct) return my_emit_message_2; if(my_emit_message_fct_3 == (uintptr_t)fct) return my_emit_message_3;


    if(my_emit_message_fct_0 == 0) {my_emit_message_fct_0 = (uintptr_t)fct; return my_emit_message_0; } if(my_emit_message_fct_1 == 0) {my_emit_message_fct_1 = (uintptr_t)fct; return my_emit_message_1; } if(my_emit_message_fct_2 == 0) {my_emit_message_fct_2 = (uintptr_t)fct; return my_emit_message_2; } if(my_emit_message_fct_3 == 0) {my_emit_message_fct_3 = (uintptr_t)fct; return my_emit_message_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Jpeg emit_message callback\n"); fflush(ftrace);}} while(0);
    return 
# 389 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 389 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_emit_messageFct(void* fct)
{
    ...
    if(my_emit_message_0 == fct) return (void*)my_emit_message_fct_0; if(my_emit_message_1 == fct) return (void*)my_emit_message_fct_1; if(my_emit_message_2 == fct) return (void*)my_emit_message_fct_2; if(my_emit_message_3 == fct) return (void*)my_emit_message_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFpi, fct, 0, 
# 399 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                           ((void *)0)
# 399 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                               );
}
# 409 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_output_message_fct_0 = 0; static void my_output_message_0(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_0, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_1 = 0; static void my_output_message_1(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_1, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_2 = 0; static void my_output_message_2(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_2, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_output_message_fct_3 = 0; static void my_output_message_3(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_output_message_fct_3, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findoutput_messageFct(void* fct)
{
    ...
    if(my_output_message_fct_0 == (uintptr_t)fct) return my_output_message_0; if(my_output_message_fct_1 == (uintptr_t)fct) return my_output_message_1; if(my_output_message_fct_2 == (uintptr_t)fct) return my_output_message_2; if(my_output_message_fct_3 == (uintptr_t)fct) return my_output_message_3;


    if(my_output_message_fct_0 == 0) {my_output_message_fct_0 = (uintptr_t)fct; return my_output_message_0; } if(my_output_message_fct_1 == 0) {my_output_message_fct_1 = (uintptr_t)fct; return my_output_message_1; } if(my_output_message_fct_2 == 0) {my_output_message_fct_2 = (uintptr_t)fct; return my_output_message_2; } if(my_output_message_fct_3 == 0) {my_output_message_fct_3 = (uintptr_t)fct; return my_output_message_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Jpeg output_message callback\n"); fflush(ftrace);}} while(0);
    return 
# 422 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 422 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_output_messageFct(void* fct)
{
    ...
    if(my_output_message_0 == fct) return (void*)my_output_message_fct_0; if(my_output_message_1 == fct) return (void*)my_output_message_fct_1; if(my_output_message_2 == fct) return (void*)my_output_message_fct_2; if(my_output_message_3 == fct) return (void*)my_output_message_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 432 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 432 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 442 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_format_message_fct_0 = 0; static void my_format_message_0(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_0, 2, cinfo, buffer); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_1 = 0; static void my_format_message_1(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_1, 2, cinfo, buffer); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_2 = 0; static void my_format_message_2(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_2, 2, cinfo, buffer); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_format_message_fct_3 = 0; static void my_format_message_3(void* cinfo, char* buffer) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_format_message_fct_3, 2, cinfo, buffer); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findformat_messageFct(void* fct)
{
    ...
    if(my_format_message_fct_0 == (uintptr_t)fct) return my_format_message_0; if(my_format_message_fct_1 == (uintptr_t)fct) return my_format_message_1; if(my_format_message_fct_2 == (uintptr_t)fct) return my_format_message_2; if(my_format_message_fct_3 == (uintptr_t)fct) return my_format_message_3;


    if(my_format_message_fct_0 == 0) {my_format_message_fct_0 = (uintptr_t)fct; return my_format_message_0; } if(my_format_message_fct_1 == 0) {my_format_message_fct_1 = (uintptr_t)fct; return my_format_message_1; } if(my_format_message_fct_2 == 0) {my_format_message_fct_2 = (uintptr_t)fct; return my_format_message_2; } if(my_format_message_fct_3 == 0) {my_format_message_fct_3 = (uintptr_t)fct; return my_format_message_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Jpeg format_message callback\n"); fflush(ftrace);}} while(0);
    return 
# 455 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 455 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_format_messageFct(void* fct)
{
    ...
    if(my_format_message_0 == fct) return (void*)my_format_message_fct_0; if(my_format_message_1 == fct) return (void*)my_format_message_fct_1; if(my_format_message_2 == fct) return (void*)my_format_message_fct_2; if(my_format_message_3 == fct) return (void*)my_format_message_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFpp, fct, 0, 
# 465 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                           ((void *)0)
# 465 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                               );
}
# 475 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_reset_error_mgr_fct_0 = 0; static void my_reset_error_mgr_0(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_0, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_1 = 0; static void my_reset_error_mgr_1(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_1, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_2 = 0; static void my_reset_error_mgr_2(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_2, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_reset_error_mgr_fct_3 = 0; static void my_reset_error_mgr_3(void* cinfo) { jmpbuf_helper* helper = (jmpbuf_helper*)((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionWithEmu(thread_get_emu(), 1, my_reset_error_mgr_fct_3, 1, cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findreset_error_mgrFct(void* fct)
{
    ...
    if(my_reset_error_mgr_fct_0 == (uintptr_t)fct) return my_reset_error_mgr_0; if(my_reset_error_mgr_fct_1 == (uintptr_t)fct) return my_reset_error_mgr_1; if(my_reset_error_mgr_fct_2 == (uintptr_t)fct) return my_reset_error_mgr_2; if(my_reset_error_mgr_fct_3 == (uintptr_t)fct) return my_reset_error_mgr_3;


    if(my_reset_error_mgr_fct_0 == 0) {my_reset_error_mgr_fct_0 = (uintptr_t)fct; return my_reset_error_mgr_0; } if(my_reset_error_mgr_fct_1 == 0) {my_reset_error_mgr_fct_1 = (uintptr_t)fct; return my_reset_error_mgr_1; } if(my_reset_error_mgr_fct_2 == 0) {my_reset_error_mgr_fct_2 = (uintptr_t)fct; return my_reset_error_mgr_2; } if(my_reset_error_mgr_fct_3 == 0) {my_reset_error_mgr_fct_3 = (uintptr_t)fct; return my_reset_error_mgr_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for Jpeg reset_error_mgr callback\n"); fflush(ftrace);}} while(0);
    return 
# 488 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 488 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_reset_error_mgrFct(void* fct)
{
    ...
    if(my_reset_error_mgr_0 == fct) return (void*)my_reset_error_mgr_fct_0; if(my_reset_error_mgr_1 == fct) return (void*)my_reset_error_mgr_fct_1; if(my_reset_error_mgr_2 == fct) return (void*)my_reset_error_mgr_fct_2; if(my_reset_error_mgr_3 == fct) return (void*)my_reset_error_mgr_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 498 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 498 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 509 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_jpeg_marker_parser_method_fct_0 = 0; static int my_jpeg_marker_parser_method_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_1 = 0; static int my_jpeg_marker_parser_method_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_2 = 0; static int my_jpeg_marker_parser_method_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_jpeg_marker_parser_method_fct_3 = 0; static int my_jpeg_marker_parser_method_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_jpeg_marker_parser_method_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; }
...
static void* findjpeg_marker_parser_methodFct(void* fct)
{
    ...
    if(my_jpeg_marker_parser_method_fct_0 == (uintptr_t)fct) return my_jpeg_marker_parser_method_0; if(my_jpeg_marker_parser_method_fct_1 == (uintptr_t)fct) return my_jpeg_marker_parser_method_1; if(my_jpeg_marker_parser_method_fct_2 == (uintptr_t)fct) return my_jpeg_marker_parser_method_2; if(my_jpeg_marker_parser_method_fct_3 == (uintptr_t)fct) return my_jpeg_marker_parser_method_3;


    if(my_jpeg_marker_parser_method_fct_0 == 0) {my_jpeg_marker_parser_method_fct_0 = (uintptr_t)fct; return my_jpeg_marker_parser_method_0; } if(my_jpeg_marker_parser_method_fct_1 == 0) {my_jpeg_marker_parser_method_fct_1 = (uintptr_t)fct; return my_jpeg_marker_parser_method_1; } if(my_jpeg_marker_parser_method_fct_2 == 0) {my_jpeg_marker_parser_method_fct_2 = (uintptr_t)fct; return my_jpeg_marker_parser_method_2; } if(my_jpeg_marker_parser_method_fct_3 == 0) {my_jpeg_marker_parser_method_fct_3 = (uintptr_t)fct; return my_jpeg_marker_parser_method_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 jpeg_marker_parser_method callback\n"); fflush(ftrace);}} while(0);
    return 
# 522 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 522 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
# 543 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_alloc_small_fct_0 = 0; static void* my_alloc_small_0(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_small_fct_0, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_small_fct_1 = 0; static void* my_alloc_small_1(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_small_fct_1, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_small_fct_2 = 0; static void* my_alloc_small_2(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_small_fct_2, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_small_fct_3 = 0; static void* my_alloc_small_3(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_small_fct_3, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findalloc_smallFct(void* fct)
{
    ...
    if(my_alloc_small_fct_0 == (uintptr_t)fct) return my_alloc_small_0; if(my_alloc_small_fct_1 == (uintptr_t)fct) return my_alloc_small_1; if(my_alloc_small_fct_2 == (uintptr_t)fct) return my_alloc_small_2; if(my_alloc_small_fct_3 == (uintptr_t)fct) return my_alloc_small_3;


    if(my_alloc_small_fct_0 == 0) {my_alloc_small_fct_0 = (uintptr_t)fct; return my_alloc_small_0; } if(my_alloc_small_fct_1 == 0) {my_alloc_small_fct_1 = (uintptr_t)fct; return my_alloc_small_1; } if(my_alloc_small_fct_2 == 0) {my_alloc_small_fct_2 = (uintptr_t)fct; return my_alloc_small_2; } if(my_alloc_small_fct_3 == 0) {my_alloc_small_fct_3 = (uintptr_t)fct; return my_alloc_small_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 alloc_small callback\n"); fflush(ftrace);}} while(0);
    return 
# 556 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 556 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_alloc_smallFct(void* fct)
{
    ...
    if(my_alloc_small_0 == fct) return (void*)my_alloc_small_fct_0; if(my_alloc_small_1 == fct) return (void*)my_alloc_small_fct_1; if(my_alloc_small_2 == fct) return (void*)my_alloc_small_fct_2; if(my_alloc_small_3 == fct) return (void*)my_alloc_small_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiL, fct, 0, 
# 566 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                            ((void *)0)
# 566 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                );
}
# 577 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_alloc_large_fct_0 = 0; static void* my_alloc_large_0(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_large_fct_0, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_large_fct_1 = 0; static void* my_alloc_large_1(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_large_fct_1, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_large_fct_2 = 0; static void* my_alloc_large_2(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_large_fct_2, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_large_fct_3 = 0; static void* my_alloc_large_3(void* cinfo, int pool_id, size_t sizeofobject) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_large_fct_3, "piL", cinfo, pool_id, sizeofobject); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findalloc_largeFct(void* fct)
{
    ...
    if(my_alloc_large_fct_0 == (uintptr_t)fct) return my_alloc_large_0; if(my_alloc_large_fct_1 == (uintptr_t)fct) return my_alloc_large_1; if(my_alloc_large_fct_2 == (uintptr_t)fct) return my_alloc_large_2; if(my_alloc_large_fct_3 == (uintptr_t)fct) return my_alloc_large_3;


    if(my_alloc_large_fct_0 == 0) {my_alloc_large_fct_0 = (uintptr_t)fct; return my_alloc_large_0; } if(my_alloc_large_fct_1 == 0) {my_alloc_large_fct_1 = (uintptr_t)fct; return my_alloc_large_1; } if(my_alloc_large_fct_2 == 0) {my_alloc_large_fct_2 = (uintptr_t)fct; return my_alloc_large_2; } if(my_alloc_large_fct_3 == 0) {my_alloc_large_fct_3 = (uintptr_t)fct; return my_alloc_large_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 alloc_large callback\n"); fflush(ftrace);}} while(0);
    return 
# 590 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 590 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_alloc_largeFct(void* fct)
{
    ...
    if(my_alloc_large_0 == fct) return (void*)my_alloc_large_fct_0; if(my_alloc_large_1 == fct) return (void*)my_alloc_large_fct_1; if(my_alloc_large_2 == fct) return (void*)my_alloc_large_fct_2; if(my_alloc_large_3 == fct) return (void*)my_alloc_large_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiL, fct, 0, 
# 600 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                            ((void *)0)
# 600 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                );
}
# 611 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_alloc_sarray_fct_0 = 0; static void* my_alloc_sarray_0(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_sarray_fct_0, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_sarray_fct_1 = 0; static void* my_alloc_sarray_1(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_sarray_fct_1, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_sarray_fct_2 = 0; static void* my_alloc_sarray_2(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_sarray_fct_2, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_sarray_fct_3 = 0; static void* my_alloc_sarray_3(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_sarray_fct_3, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findalloc_sarrayFct(void* fct)
{
    ...
    if(my_alloc_sarray_fct_0 == (uintptr_t)fct) return my_alloc_sarray_0; if(my_alloc_sarray_fct_1 == (uintptr_t)fct) return my_alloc_sarray_1; if(my_alloc_sarray_fct_2 == (uintptr_t)fct) return my_alloc_sarray_2; if(my_alloc_sarray_fct_3 == (uintptr_t)fct) return my_alloc_sarray_3;


    if(my_alloc_sarray_fct_0 == 0) {my_alloc_sarray_fct_0 = (uintptr_t)fct; return my_alloc_sarray_0; } if(my_alloc_sarray_fct_1 == 0) {my_alloc_sarray_fct_1 = (uintptr_t)fct; return my_alloc_sarray_1; } if(my_alloc_sarray_fct_2 == 0) {my_alloc_sarray_fct_2 = (uintptr_t)fct; return my_alloc_sarray_2; } if(my_alloc_sarray_fct_3 == 0) {my_alloc_sarray_fct_3 = (uintptr_t)fct; return my_alloc_sarray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 alloc_sarray callback\n"); fflush(ftrace);}} while(0);
    return 
# 624 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 624 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_alloc_sarrayFct(void* fct)
{
    ...
    if(my_alloc_sarray_0 == fct) return (void*)my_alloc_sarray_fct_0; if(my_alloc_sarray_1 == fct) return (void*)my_alloc_sarray_fct_1; if(my_alloc_sarray_2 == fct) return (void*)my_alloc_sarray_fct_2; if(my_alloc_sarray_3 == fct) return (void*)my_alloc_sarray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiuu, fct, 0, 
# 634 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                             ((void *)0)
# 634 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                 );
}
# 645 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_alloc_barray_fct_0 = 0; static void* my_alloc_barray_0(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_barray_fct_0, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_barray_fct_1 = 0; static void* my_alloc_barray_1(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_barray_fct_1, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_barray_fct_2 = 0; static void* my_alloc_barray_2(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_barray_fct_2, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_alloc_barray_fct_3 = 0; static void* my_alloc_barray_3(void* cinfo, int pool_id, uint32_t samplesperrow, uint32_t numrows) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_alloc_barray_fct_3, "piuu", cinfo, pool_id, samplesperrow, numrows); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findalloc_barrayFct(void* fct)
{
    ...
    if(my_alloc_barray_fct_0 == (uintptr_t)fct) return my_alloc_barray_0; if(my_alloc_barray_fct_1 == (uintptr_t)fct) return my_alloc_barray_1; if(my_alloc_barray_fct_2 == (uintptr_t)fct) return my_alloc_barray_2; if(my_alloc_barray_fct_3 == (uintptr_t)fct) return my_alloc_barray_3;


    if(my_alloc_barray_fct_0 == 0) {my_alloc_barray_fct_0 = (uintptr_t)fct; return my_alloc_barray_0; } if(my_alloc_barray_fct_1 == 0) {my_alloc_barray_fct_1 = (uintptr_t)fct; return my_alloc_barray_1; } if(my_alloc_barray_fct_2 == 0) {my_alloc_barray_fct_2 = (uintptr_t)fct; return my_alloc_barray_2; } if(my_alloc_barray_fct_3 == 0) {my_alloc_barray_fct_3 = (uintptr_t)fct; return my_alloc_barray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 alloc_barray callback\n"); fflush(ftrace);}} while(0);
    return 
# 658 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 658 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_alloc_barrayFct(void* fct)
{
    ...
    if(my_alloc_barray_0 == fct) return (void*)my_alloc_barray_fct_0; if(my_alloc_barray_1 == fct) return (void*)my_alloc_barray_fct_1; if(my_alloc_barray_2 == fct) return (void*)my_alloc_barray_fct_2; if(my_alloc_barray_3 == fct) return (void*)my_alloc_barray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiuu, fct, 0, 
# 668 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                             ((void *)0)
# 668 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                 );
}
# 679 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_request_virt_sarray_fct_0 = 0; static void* my_request_virt_sarray_0(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_sarray_fct_0, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_sarray_fct_1 = 0; static void* my_request_virt_sarray_1(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_sarray_fct_1, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_sarray_fct_2 = 0; static void* my_request_virt_sarray_2(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_sarray_fct_2, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_sarray_fct_3 = 0; static void* my_request_virt_sarray_3(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_sarray_fct_3, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findrequest_virt_sarrayFct(void* fct)
{
    ...
    if(my_request_virt_sarray_fct_0 == (uintptr_t)fct) return my_request_virt_sarray_0; if(my_request_virt_sarray_fct_1 == (uintptr_t)fct) return my_request_virt_sarray_1; if(my_request_virt_sarray_fct_2 == (uintptr_t)fct) return my_request_virt_sarray_2; if(my_request_virt_sarray_fct_3 == (uintptr_t)fct) return my_request_virt_sarray_3;


    if(my_request_virt_sarray_fct_0 == 0) {my_request_virt_sarray_fct_0 = (uintptr_t)fct; return my_request_virt_sarray_0; } if(my_request_virt_sarray_fct_1 == 0) {my_request_virt_sarray_fct_1 = (uintptr_t)fct; return my_request_virt_sarray_1; } if(my_request_virt_sarray_fct_2 == 0) {my_request_virt_sarray_fct_2 = (uintptr_t)fct; return my_request_virt_sarray_2; } if(my_request_virt_sarray_fct_3 == 0) {my_request_virt_sarray_fct_3 = (uintptr_t)fct; return my_request_virt_sarray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 request_virt_sarray callback\n"); fflush(ftrace);}} while(0);
    return 
# 692 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 692 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_request_virt_sarrayFct(void* fct)
{
    ...
    if(my_request_virt_sarray_0 == fct) return (void*)my_request_virt_sarray_fct_0; if(my_request_virt_sarray_1 == fct) return (void*)my_request_virt_sarray_fct_1; if(my_request_virt_sarray_2 == fct) return (void*)my_request_virt_sarray_fct_2; if(my_request_virt_sarray_3 == fct) return (void*)my_request_virt_sarray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiiuuu, fct, 0, 
# 702 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                               ((void *)0)
# 702 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                   );
}
# 713 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_request_virt_barray_fct_0 = 0; static void* my_request_virt_barray_0(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_barray_fct_0, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_barray_fct_1 = 0; static void* my_request_virt_barray_1(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_barray_fct_1, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_barray_fct_2 = 0; static void* my_request_virt_barray_2(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_barray_fct_2, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_request_virt_barray_fct_3 = 0; static void* my_request_virt_barray_3(void* cinfo, int pool_id, int pre_zero, uint32_t samplesperrow,uint32_t numrows, uint32_t maxaccess) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_request_virt_barray_fct_3, "piiuuu", cinfo, pool_id, pre_zero, samplesperrow, numrows, maxaccess); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findrequest_virt_barrayFct(void* fct)
{
    ...
    if(my_request_virt_barray_fct_0 == (uintptr_t)fct) return my_request_virt_barray_0; if(my_request_virt_barray_fct_1 == (uintptr_t)fct) return my_request_virt_barray_1; if(my_request_virt_barray_fct_2 == (uintptr_t)fct) return my_request_virt_barray_2; if(my_request_virt_barray_fct_3 == (uintptr_t)fct) return my_request_virt_barray_3;


    if(my_request_virt_barray_fct_0 == 0) {my_request_virt_barray_fct_0 = (uintptr_t)fct; return my_request_virt_barray_0; } if(my_request_virt_barray_fct_1 == 0) {my_request_virt_barray_fct_1 = (uintptr_t)fct; return my_request_virt_barray_1; } if(my_request_virt_barray_fct_2 == 0) {my_request_virt_barray_fct_2 = (uintptr_t)fct; return my_request_virt_barray_2; } if(my_request_virt_barray_fct_3 == 0) {my_request_virt_barray_fct_3 = (uintptr_t)fct; return my_request_virt_barray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 request_virt_barray callback\n"); fflush(ftrace);}} while(0);
    return 
# 726 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 726 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_request_virt_barrayFct(void* fct)
{
    ...
    if(my_request_virt_barray_0 == fct) return (void*)my_request_virt_barray_fct_0; if(my_request_virt_barray_1 == fct) return (void*)my_request_virt_barray_fct_1; if(my_request_virt_barray_2 == fct) return (void*)my_request_virt_barray_fct_2; if(my_request_virt_barray_3 == fct) return (void*)my_request_virt_barray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFpiiuuu, fct, 0, 
# 736 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                               ((void *)0)
# 736 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                   );
}
# 746 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_realize_virt_arrays_fct_0 = 0; static void my_realize_virt_arrays_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_realize_virt_arrays_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_realize_virt_arrays_fct_1 = 0; static void my_realize_virt_arrays_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_realize_virt_arrays_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_realize_virt_arrays_fct_2 = 0; static void my_realize_virt_arrays_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_realize_virt_arrays_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_realize_virt_arrays_fct_3 = 0; static void my_realize_virt_arrays_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_realize_virt_arrays_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findrealize_virt_arraysFct(void* fct)
{
    ...
    if(my_realize_virt_arrays_fct_0 == (uintptr_t)fct) return my_realize_virt_arrays_0; if(my_realize_virt_arrays_fct_1 == (uintptr_t)fct) return my_realize_virt_arrays_1; if(my_realize_virt_arrays_fct_2 == (uintptr_t)fct) return my_realize_virt_arrays_2; if(my_realize_virt_arrays_fct_3 == (uintptr_t)fct) return my_realize_virt_arrays_3;


    if(my_realize_virt_arrays_fct_0 == 0) {my_realize_virt_arrays_fct_0 = (uintptr_t)fct; return my_realize_virt_arrays_0; } if(my_realize_virt_arrays_fct_1 == 0) {my_realize_virt_arrays_fct_1 = (uintptr_t)fct; return my_realize_virt_arrays_1; } if(my_realize_virt_arrays_fct_2 == 0) {my_realize_virt_arrays_fct_2 = (uintptr_t)fct; return my_realize_virt_arrays_2; } if(my_realize_virt_arrays_fct_3 == 0) {my_realize_virt_arrays_fct_3 = (uintptr_t)fct; return my_realize_virt_arrays_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 realize_virt_arrays callback\n"); fflush(ftrace);}} while(0);
    return 
# 759 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 759 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_realize_virt_arraysFct(void* fct)
{
    ...
    if(my_realize_virt_arrays_0 == fct) return (void*)my_realize_virt_arrays_fct_0; if(my_realize_virt_arrays_1 == fct) return (void*)my_realize_virt_arrays_fct_1; if(my_realize_virt_arrays_2 == fct) return (void*)my_realize_virt_arrays_fct_2; if(my_realize_virt_arrays_3 == fct) return (void*)my_realize_virt_arrays_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 769 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 769 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 780 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_access_virt_sarray_fct_0 = 0; static void* my_access_virt_sarray_0(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_sarray_fct_0, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_sarray_fct_1 = 0; static void* my_access_virt_sarray_1(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_sarray_fct_1, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_sarray_fct_2 = 0; static void* my_access_virt_sarray_2(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_sarray_fct_2, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_sarray_fct_3 = 0; static void* my_access_virt_sarray_3(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_sarray_fct_3, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findaccess_virt_sarrayFct(void* fct)
{
    ...
    if(my_access_virt_sarray_fct_0 == (uintptr_t)fct) return my_access_virt_sarray_0; if(my_access_virt_sarray_fct_1 == (uintptr_t)fct) return my_access_virt_sarray_1; if(my_access_virt_sarray_fct_2 == (uintptr_t)fct) return my_access_virt_sarray_2; if(my_access_virt_sarray_fct_3 == (uintptr_t)fct) return my_access_virt_sarray_3;


    if(my_access_virt_sarray_fct_0 == 0) {my_access_virt_sarray_fct_0 = (uintptr_t)fct; return my_access_virt_sarray_0; } if(my_access_virt_sarray_fct_1 == 0) {my_access_virt_sarray_fct_1 = (uintptr_t)fct; return my_access_virt_sarray_1; } if(my_access_virt_sarray_fct_2 == 0) {my_access_virt_sarray_fct_2 = (uintptr_t)fct; return my_access_virt_sarray_2; } if(my_access_virt_sarray_fct_3 == 0) {my_access_virt_sarray_fct_3 = (uintptr_t)fct; return my_access_virt_sarray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 access_virt_sarray callback\n"); fflush(ftrace);}} while(0);
    return 
# 793 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 793 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_access_virt_sarrayFct(void* fct)
{
    ...
    if(my_access_virt_sarray_0 == fct) return (void*)my_access_virt_sarray_fct_0; if(my_access_virt_sarray_1 == fct) return (void*)my_access_virt_sarray_fct_1; if(my_access_virt_sarray_2 == fct) return (void*)my_access_virt_sarray_fct_2; if(my_access_virt_sarray_3 == fct) return (void*)my_access_virt_sarray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFppuui, fct, 0, 
# 803 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                              ((void *)0)
# 803 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                  );
}
# 814 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_access_virt_barray_fct_0 = 0; static void* my_access_virt_barray_0(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_barray_fct_0, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_barray_fct_1 = 0; static void* my_access_virt_barray_1(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_barray_fct_1, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_barray_fct_2 = 0; static void* my_access_virt_barray_2(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_barray_fct_2, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; } static uintptr_t my_access_virt_barray_fct_3 = 0; static void* my_access_virt_barray_3(void* cinfo, void* ptr, uint32_t start_row, uint32_t num_rows, int writable) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_access_virt_barray_fct_3, "ppuui", cinfo, ptr, start_row, num_rows, writable); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (void*)ret; }
...
static void* findaccess_virt_barrayFct(void* fct)
{
    ...
    if(my_access_virt_barray_fct_0 == (uintptr_t)fct) return my_access_virt_barray_0; if(my_access_virt_barray_fct_1 == (uintptr_t)fct) return my_access_virt_barray_1; if(my_access_virt_barray_fct_2 == (uintptr_t)fct) return my_access_virt_barray_2; if(my_access_virt_barray_fct_3 == (uintptr_t)fct) return my_access_virt_barray_3;


    if(my_access_virt_barray_fct_0 == 0) {my_access_virt_barray_fct_0 = (uintptr_t)fct; return my_access_virt_barray_0; } if(my_access_virt_barray_fct_1 == 0) {my_access_virt_barray_fct_1 = (uintptr_t)fct; return my_access_virt_barray_1; } if(my_access_virt_barray_fct_2 == 0) {my_access_virt_barray_fct_2 = (uintptr_t)fct; return my_access_virt_barray_2; } if(my_access_virt_barray_fct_3 == 0) {my_access_virt_barray_fct_3 = (uintptr_t)fct; return my_access_virt_barray_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 access_virt_barray callback\n"); fflush(ftrace);}} while(0);
    return 
# 827 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 827 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_access_virt_barrayFct(void* fct)
{
    ...
    if(my_access_virt_barray_0 == fct) return (void*)my_access_virt_barray_fct_0; if(my_access_virt_barray_1 == fct) return (void*)my_access_virt_barray_fct_1; if(my_access_virt_barray_2 == fct) return (void*)my_access_virt_barray_fct_2; if(my_access_virt_barray_3 == fct) return (void*)my_access_virt_barray_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, pFppuui, fct, 0, 
# 837 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                              ((void *)0)
# 837 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                  );
}
# 847 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_free_pool_fct_0 = 0; static void my_free_pool_0(void* cinfo, int pool_id) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_free_pool_fct_0, "pi", cinfo, pool_id); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_free_pool_fct_1 = 0; static void my_free_pool_1(void* cinfo, int pool_id) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_free_pool_fct_1, "pi", cinfo, pool_id); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_free_pool_fct_2 = 0; static void my_free_pool_2(void* cinfo, int pool_id) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_free_pool_fct_2, "pi", cinfo, pool_id); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_free_pool_fct_3 = 0; static void my_free_pool_3(void* cinfo, int pool_id) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_free_pool_fct_3, "pi", cinfo, pool_id); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findfree_poolFct(void* fct)
{
    ...
    if(my_free_pool_fct_0 == (uintptr_t)fct) return my_free_pool_0; if(my_free_pool_fct_1 == (uintptr_t)fct) return my_free_pool_1; if(my_free_pool_fct_2 == (uintptr_t)fct) return my_free_pool_2; if(my_free_pool_fct_3 == (uintptr_t)fct) return my_free_pool_3;


    if(my_free_pool_fct_0 == 0) {my_free_pool_fct_0 = (uintptr_t)fct; return my_free_pool_0; } if(my_free_pool_fct_1 == 0) {my_free_pool_fct_1 = (uintptr_t)fct; return my_free_pool_1; } if(my_free_pool_fct_2 == 0) {my_free_pool_fct_2 = (uintptr_t)fct; return my_free_pool_2; } if(my_free_pool_fct_3 == 0) {my_free_pool_fct_3 = (uintptr_t)fct; return my_free_pool_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 free_pool callback\n"); fflush(ftrace);}} while(0);
    return 
# 860 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 860 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_free_poolFct(void* fct)
{
    ...
    if(my_free_pool_0 == fct) return (void*)my_free_pool_fct_0; if(my_free_pool_1 == fct) return (void*)my_free_pool_fct_1; if(my_free_pool_2 == fct) return (void*)my_free_pool_fct_2; if(my_free_pool_3 == fct) return (void*)my_free_pool_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFpi, fct, 0, 
# 870 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                           ((void *)0)
# 870 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                               );
}
# 880 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_self_destruct_fct_0 = 0; static void my_self_destruct_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_self_destruct_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_self_destruct_fct_1 = 0; static void my_self_destruct_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_self_destruct_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_self_destruct_fct_2 = 0; static void my_self_destruct_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_self_destruct_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_self_destruct_fct_3 = 0; static void my_self_destruct_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_self_destruct_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findself_destructFct(void* fct)
{
    ...
    if(my_self_destruct_fct_0 == (uintptr_t)fct) return my_self_destruct_0; if(my_self_destruct_fct_1 == (uintptr_t)fct) return my_self_destruct_1; if(my_self_destruct_fct_2 == (uintptr_t)fct) return my_self_destruct_2; if(my_self_destruct_fct_3 == (uintptr_t)fct) return my_self_destruct_3;


    if(my_self_destruct_fct_0 == 0) {my_self_destruct_fct_0 = (uintptr_t)fct; return my_self_destruct_0; } if(my_self_destruct_fct_1 == 0) {my_self_destruct_fct_1 = (uintptr_t)fct; return my_self_destruct_1; } if(my_self_destruct_fct_2 == 0) {my_self_destruct_fct_2 = (uintptr_t)fct; return my_self_destruct_2; } if(my_self_destruct_fct_3 == 0) {my_self_destruct_fct_3 = (uintptr_t)fct; return my_self_destruct_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 self_destruct callback\n"); fflush(ftrace);}} while(0);
    return 
# 893 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 893 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_self_destructFct(void* fct)
{
    ...
    if(my_self_destruct_0 == fct) return (void*)my_self_destruct_fct_0; if(my_self_destruct_1 == fct) return (void*)my_self_destruct_fct_1; if(my_self_destruct_2 == fct) return (void*)my_self_destruct_fct_2; if(my_self_destruct_3 == fct) return (void*)my_self_destruct_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 903 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 903 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 913 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_init_source_fct_0 = 0; static void my_init_source_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_source_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_init_source_fct_1 = 0; static void my_init_source_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_source_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_init_source_fct_2 = 0; static void my_init_source_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_source_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_init_source_fct_3 = 0; static void my_init_source_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_source_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findinit_sourceFct(void* fct)
{
    ...
    if(my_init_source_fct_0 == (uintptr_t)fct) return my_init_source_0; if(my_init_source_fct_1 == (uintptr_t)fct) return my_init_source_1; if(my_init_source_fct_2 == (uintptr_t)fct) return my_init_source_2; if(my_init_source_fct_3 == (uintptr_t)fct) return my_init_source_3;


    if(my_init_source_fct_0 == 0) {my_init_source_fct_0 = (uintptr_t)fct; return my_init_source_0; } if(my_init_source_fct_1 == 0) {my_init_source_fct_1 = (uintptr_t)fct; return my_init_source_1; } if(my_init_source_fct_2 == 0) {my_init_source_fct_2 = (uintptr_t)fct; return my_init_source_2; } if(my_init_source_fct_3 == 0) {my_init_source_fct_3 = (uintptr_t)fct; return my_init_source_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 init_source callback\n"); fflush(ftrace);}} while(0);
    return 
# 926 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 926 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_init_sourceFct(void* fct)
{
    ...
    if(my_init_source_0 == fct) return (void*)my_init_source_fct_0; if(my_init_source_1 == fct) return (void*)my_init_source_fct_1; if(my_init_source_2 == fct) return (void*)my_init_source_fct_2; if(my_init_source_3 == fct) return (void*)my_init_source_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 936 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 936 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 947 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_fill_input_buffer_fct_0 = 0; static int my_fill_input_buffer_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_fill_input_buffer_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_fill_input_buffer_fct_1 = 0; static int my_fill_input_buffer_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_fill_input_buffer_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_fill_input_buffer_fct_2 = 0; static int my_fill_input_buffer_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_fill_input_buffer_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_fill_input_buffer_fct_3 = 0; static int my_fill_input_buffer_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_fill_input_buffer_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; }
...
static void* findfill_input_bufferFct(void* fct)
{
    ...
    if(my_fill_input_buffer_fct_0 == (uintptr_t)fct) return my_fill_input_buffer_0; if(my_fill_input_buffer_fct_1 == (uintptr_t)fct) return my_fill_input_buffer_1; if(my_fill_input_buffer_fct_2 == (uintptr_t)fct) return my_fill_input_buffer_2; if(my_fill_input_buffer_fct_3 == (uintptr_t)fct) return my_fill_input_buffer_3;


    if(my_fill_input_buffer_fct_0 == 0) {my_fill_input_buffer_fct_0 = (uintptr_t)fct; return my_fill_input_buffer_0; } if(my_fill_input_buffer_fct_1 == 0) {my_fill_input_buffer_fct_1 = (uintptr_t)fct; return my_fill_input_buffer_1; } if(my_fill_input_buffer_fct_2 == 0) {my_fill_input_buffer_fct_2 = (uintptr_t)fct; return my_fill_input_buffer_2; } if(my_fill_input_buffer_fct_3 == 0) {my_fill_input_buffer_fct_3 = (uintptr_t)fct; return my_fill_input_buffer_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 fill_input_buffer callback\n"); fflush(ftrace);}} while(0);
    return 
# 960 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 960 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_fill_input_bufferFct(void* fct)
{
    ...
    if(my_fill_input_buffer_0 == fct) return (void*)my_fill_input_buffer_fct_0; if(my_fill_input_buffer_1 == fct) return (void*)my_fill_input_buffer_fct_1; if(my_fill_input_buffer_2 == fct) return (void*)my_fill_input_buffer_fct_2; if(my_fill_input_buffer_3 == fct) return (void*)my_fill_input_buffer_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, iFp, fct, 0, 
# 970 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 970 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 980 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_skip_input_data_fct_0 = 0; static void my_skip_input_data_0(void* cinfo, long num_bytes) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_skip_input_data_fct_0, "pl", cinfo, num_bytes); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_skip_input_data_fct_1 = 0; static void my_skip_input_data_1(void* cinfo, long num_bytes) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_skip_input_data_fct_1, "pl", cinfo, num_bytes); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_skip_input_data_fct_2 = 0; static void my_skip_input_data_2(void* cinfo, long num_bytes) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_skip_input_data_fct_2, "pl", cinfo, num_bytes); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_skip_input_data_fct_3 = 0; static void my_skip_input_data_3(void* cinfo, long num_bytes) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_skip_input_data_fct_3, "pl", cinfo, num_bytes); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findskip_input_dataFct(void* fct)
{
    ...
    if(my_skip_input_data_fct_0 == (uintptr_t)fct) return my_skip_input_data_0; if(my_skip_input_data_fct_1 == (uintptr_t)fct) return my_skip_input_data_1; if(my_skip_input_data_fct_2 == (uintptr_t)fct) return my_skip_input_data_2; if(my_skip_input_data_fct_3 == (uintptr_t)fct) return my_skip_input_data_3;


    if(my_skip_input_data_fct_0 == 0) {my_skip_input_data_fct_0 = (uintptr_t)fct; return my_skip_input_data_0; } if(my_skip_input_data_fct_1 == 0) {my_skip_input_data_fct_1 = (uintptr_t)fct; return my_skip_input_data_1; } if(my_skip_input_data_fct_2 == 0) {my_skip_input_data_fct_2 = (uintptr_t)fct; return my_skip_input_data_2; } if(my_skip_input_data_fct_3 == 0) {my_skip_input_data_fct_3 = (uintptr_t)fct; return my_skip_input_data_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 skip_input_data callback\n"); fflush(ftrace);}} while(0);
    return 
# 993 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 993 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_skip_input_dataFct(void* fct)
{
    ...
    if(my_skip_input_data_0 == fct) return (void*)my_skip_input_data_fct_0; if(my_skip_input_data_1 == fct) return (void*)my_skip_input_data_fct_1; if(my_skip_input_data_2 == fct) return (void*)my_skip_input_data_fct_2; if(my_skip_input_data_3 == fct) return (void*)my_skip_input_data_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFpl, fct, 0, 
# 1003 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                           ((void *)0)
# 1003 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                               );
}
# 1014 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_resync_to_restart_fct_0 = 0; static int my_resync_to_restart_0(void* cinfo, int desired) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_resync_to_restart_fct_0, "pi", cinfo, desired); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_resync_to_restart_fct_1 = 0; static int my_resync_to_restart_1(void* cinfo, int desired) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_resync_to_restart_fct_1, "pi", cinfo, desired); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_resync_to_restart_fct_2 = 0; static int my_resync_to_restart_2(void* cinfo, int desired) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_resync_to_restart_fct_2, "pi", cinfo, desired); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; } static uintptr_t my_resync_to_restart_fct_3 = 0; static int my_resync_to_restart_3(void* cinfo, int desired) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_resync_to_restart_fct_3, "pi", cinfo, desired); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;; return (int)ret; }
...
static void* findresync_to_restartFct(void* fct)
{
    ...
    if(my_resync_to_restart_fct_0 == (uintptr_t)fct) return my_resync_to_restart_0; if(my_resync_to_restart_fct_1 == (uintptr_t)fct) return my_resync_to_restart_1; if(my_resync_to_restart_fct_2 == (uintptr_t)fct) return my_resync_to_restart_2; if(my_resync_to_restart_fct_3 == (uintptr_t)fct) return my_resync_to_restart_3;


    if(my_resync_to_restart_fct_0 == 0) {my_resync_to_restart_fct_0 = (uintptr_t)fct; return my_resync_to_restart_0; } if(my_resync_to_restart_fct_1 == 0) {my_resync_to_restart_fct_1 = (uintptr_t)fct; return my_resync_to_restart_1; } if(my_resync_to_restart_fct_2 == 0) {my_resync_to_restart_fct_2 = (uintptr_t)fct; return my_resync_to_restart_2; } if(my_resync_to_restart_fct_3 == 0) {my_resync_to_restart_fct_3 = (uintptr_t)fct; return my_resync_to_restart_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 resync_to_restart callback\n"); fflush(ftrace);}} while(0);
    return 
# 1027 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1027 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_resync_to_restartFct(void* fct)
{
    ...
    if(my_resync_to_restart_0 == fct) return (void*)my_resync_to_restart_fct_0; if(my_resync_to_restart_1 == fct) return (void*)my_resync_to_restart_fct_1; if(my_resync_to_restart_2 == fct) return (void*)my_resync_to_restart_fct_2; if(my_resync_to_restart_3 == fct) return (void*)my_resync_to_restart_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, iFpi, fct, 0, 
# 1037 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                           ((void *)0)
# 1037 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                               );
}
# 1047 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_term_source_fct_0 = 0; static void my_term_source_0(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_source_fct_0, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_term_source_fct_1 = 0; static void my_term_source_1(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_source_fct_1, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_term_source_fct_2 = 0; static void my_term_source_2(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_source_fct_2, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;} static uintptr_t my_term_source_fct_3 = 0; static void my_term_source_3(void* cinfo) { jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; ((jpeg62_common_struct_t*)cinfo)->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_source_fct_3, "p", cinfo); ((jpeg62_common_struct_t*)cinfo)->client_data = helper;;}
...
static void* findterm_sourceFct(void* fct)
{
    ...
    if(my_term_source_fct_0 == (uintptr_t)fct) return my_term_source_0; if(my_term_source_fct_1 == (uintptr_t)fct) return my_term_source_1; if(my_term_source_fct_2 == (uintptr_t)fct) return my_term_source_2; if(my_term_source_fct_3 == (uintptr_t)fct) return my_term_source_3;


    if(my_term_source_fct_0 == 0) {my_term_source_fct_0 = (uintptr_t)fct; return my_term_source_0; } if(my_term_source_fct_1 == 0) {my_term_source_fct_1 = (uintptr_t)fct; return my_term_source_1; } if(my_term_source_fct_2 == 0) {my_term_source_fct_2 = (uintptr_t)fct; return my_term_source_2; } if(my_term_source_fct_3 == 0) {my_term_source_fct_3 = (uintptr_t)fct; return my_term_source_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 term_source callback\n"); fflush(ftrace);}} while(0);
    return 
# 1060 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1060 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_term_sourceFct(void* fct)
{
    ...
    if(my_term_source_0 == fct) return (void*)my_term_source_fct_0; if(my_term_source_1 == fct) return (void*)my_term_source_fct_1; if(my_term_source_2 == fct) return (void*)my_term_source_fct_2; if(my_term_source_3 == fct) return (void*)my_term_source_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1070 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1070 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1084 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_init_destination_fct_0 = 0; static void my_init_destination_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_destination_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_init_destination_fct_1 = 0; static void my_init_destination_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_destination_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_init_destination_fct_2 = 0; static void my_init_destination_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_destination_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_init_destination_fct_3 = 0; static void my_init_destination_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_init_destination_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findinit_destinationFct(void* fct)
{
    ...
    if(my_init_destination_fct_0 == (uintptr_t)fct) return my_init_destination_0; if(my_init_destination_fct_1 == (uintptr_t)fct) return my_init_destination_1; if(my_init_destination_fct_2 == (uintptr_t)fct) return my_init_destination_2; if(my_init_destination_fct_3 == (uintptr_t)fct) return my_init_destination_3;


    if(my_init_destination_fct_0 == 0) {my_init_destination_fct_0 = (uintptr_t)fct; return my_init_destination_0; } if(my_init_destination_fct_1 == 0) {my_init_destination_fct_1 = (uintptr_t)fct; return my_init_destination_1; } if(my_init_destination_fct_2 == 0) {my_init_destination_fct_2 = (uintptr_t)fct; return my_init_destination_2; } if(my_init_destination_fct_3 == 0) {my_init_destination_fct_3 = (uintptr_t)fct; return my_init_destination_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 init_destination callback\n"); fflush(ftrace);}} while(0);
    return 
# 1097 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1097 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_init_destinationFct(void* fct)
{
    ...
    if(my_init_destination_0 == fct) return (void*)my_init_destination_fct_0; if(my_init_destination_1 == fct) return (void*)my_init_destination_fct_1; if(my_init_destination_2 == fct) return (void*)my_init_destination_fct_2; if(my_init_destination_3 == fct) return (void*)my_init_destination_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1107 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1120 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_empty_output_buffer_fct_0 = 0; static void my_empty_output_buffer_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_empty_output_buffer_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_empty_output_buffer_fct_1 = 0; static void my_empty_output_buffer_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_empty_output_buffer_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_empty_output_buffer_fct_2 = 0; static void my_empty_output_buffer_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_empty_output_buffer_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_empty_output_buffer_fct_3 = 0; static void my_empty_output_buffer_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_empty_output_buffer_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findempty_output_bufferFct(void* fct)
{
    ...
    if(my_empty_output_buffer_fct_0 == (uintptr_t)fct) return my_empty_output_buffer_0; if(my_empty_output_buffer_fct_1 == (uintptr_t)fct) return my_empty_output_buffer_1; if(my_empty_output_buffer_fct_2 == (uintptr_t)fct) return my_empty_output_buffer_2; if(my_empty_output_buffer_fct_3 == (uintptr_t)fct) return my_empty_output_buffer_3;


    if(my_empty_output_buffer_fct_0 == 0) {my_empty_output_buffer_fct_0 = (uintptr_t)fct; return my_empty_output_buffer_0; } if(my_empty_output_buffer_fct_1 == 0) {my_empty_output_buffer_fct_1 = (uintptr_t)fct; return my_empty_output_buffer_1; } if(my_empty_output_buffer_fct_2 == 0) {my_empty_output_buffer_fct_2 = (uintptr_t)fct; return my_empty_output_buffer_2; } if(my_empty_output_buffer_fct_3 == 0) {my_empty_output_buffer_fct_3 = (uintptr_t)fct; return my_empty_output_buffer_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 empty_output_buffer callback\n"); fflush(ftrace);}} while(0);
    return 
# 1133 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1133 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_empty_output_bufferFct(void* fct)
{
    ...
    if(my_empty_output_buffer_0 == fct) return (void*)my_empty_output_buffer_fct_0; if(my_empty_output_buffer_1 == fct) return (void*)my_empty_output_buffer_fct_1; if(my_empty_output_buffer_2 == fct) return (void*)my_empty_output_buffer_fct_2; if(my_empty_output_buffer_3 == fct) return (void*)my_empty_output_buffer_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1156 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_term_destination_fct_0 = 0; static void my_term_destination_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_destination_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_term_destination_fct_1 = 0; static void my_term_destination_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_destination_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_term_destination_fct_2 = 0; static void my_term_destination_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_destination_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_term_destination_fct_3 = 0; static void my_term_destination_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_term_destination_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findterm_destinationFct(void* fct)
{
    ...
    if(my_term_destination_fct_0 == (uintptr_t)fct) return my_term_destination_0; if(my_term_destination_fct_1 == (uintptr_t)fct) return my_term_destination_1; if(my_term_destination_fct_2 == (uintptr_t)fct) return my_term_destination_2; if(my_term_destination_fct_3 == (uintptr_t)fct) return my_term_destination_3;


    if(my_term_destination_fct_0 == 0) {my_term_destination_fct_0 = (uintptr_t)fct; return my_term_destination_0; } if(my_term_destination_fct_1 == 0) {my_term_destination_fct_1 = (uintptr_t)fct; return my_term_destination_1; } if(my_term_destination_fct_2 == 0) {my_term_destination_fct_2 = (uintptr_t)fct; return my_term_destination_2; } if(my_term_destination_fct_3 == 0) {my_term_destination_fct_3 = (uintptr_t)fct; return my_term_destination_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 term_destination callback\n"); fflush(ftrace);}} while(0);
    return 
# 1169 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1169 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_term_destinationFct(void* fct)
{
    ...
    if(my_term_destination_0 == fct) return (void*)my_term_destination_fct_0; if(my_term_destination_1 == fct) return (void*)my_term_destination_fct_1; if(my_term_destination_2 == fct) return (void*)my_term_destination_fct_2; if(my_term_destination_3 == fct) return (void*)my_term_destination_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1179 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1179 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1193 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_prepare_for_pass_fct_0 = 0; static void my_prepare_for_pass_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_prepare_for_pass_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_prepare_for_pass_fct_1 = 0; static void my_prepare_for_pass_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_prepare_for_pass_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_prepare_for_pass_fct_2 = 0; static void my_prepare_for_pass_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_prepare_for_pass_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_prepare_for_pass_fct_3 = 0; static void my_prepare_for_pass_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_prepare_for_pass_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findprepare_for_passFct(void* fct)
{
    ...
    if(my_prepare_for_pass_fct_0 == (uintptr_t)fct) return my_prepare_for_pass_0; if(my_prepare_for_pass_fct_1 == (uintptr_t)fct) return my_prepare_for_pass_1; if(my_prepare_for_pass_fct_2 == (uintptr_t)fct) return my_prepare_for_pass_2; if(my_prepare_for_pass_fct_3 == (uintptr_t)fct) return my_prepare_for_pass_3;


    if(my_prepare_for_pass_fct_0 == 0) {my_prepare_for_pass_fct_0 = (uintptr_t)fct; return my_prepare_for_pass_0; } if(my_prepare_for_pass_fct_1 == 0) {my_prepare_for_pass_fct_1 = (uintptr_t)fct; return my_prepare_for_pass_1; } if(my_prepare_for_pass_fct_2 == 0) {my_prepare_for_pass_fct_2 = (uintptr_t)fct; return my_prepare_for_pass_2; } if(my_prepare_for_pass_fct_3 == 0) {my_prepare_for_pass_fct_3 = (uintptr_t)fct; return my_prepare_for_pass_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 prepare_for_pass callback\n"); fflush(ftrace);}} while(0);
    return 
# 1206 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1206 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_prepare_for_passFct(void* fct)
{
    ...
    if(my_prepare_for_pass_0 == fct) return (void*)my_prepare_for_pass_fct_0; if(my_prepare_for_pass_1 == fct) return (void*)my_prepare_for_pass_fct_1; if(my_prepare_for_pass_2 == fct) return (void*)my_prepare_for_pass_fct_2; if(my_prepare_for_pass_3 == fct) return (void*)my_prepare_for_pass_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1216 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1216 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1230 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_pass_startup_fct_0 = 0; static void my_pass_startup_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_pass_startup_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_pass_startup_fct_1 = 0; static void my_pass_startup_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_pass_startup_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_pass_startup_fct_2 = 0; static void my_pass_startup_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_pass_startup_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_pass_startup_fct_3 = 0; static void my_pass_startup_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_pass_startup_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findpass_startupFct(void* fct)
{
    ...
    if(my_pass_startup_fct_0 == (uintptr_t)fct) return my_pass_startup_0; if(my_pass_startup_fct_1 == (uintptr_t)fct) return my_pass_startup_1; if(my_pass_startup_fct_2 == (uintptr_t)fct) return my_pass_startup_2; if(my_pass_startup_fct_3 == (uintptr_t)fct) return my_pass_startup_3;


    if(my_pass_startup_fct_0 == 0) {my_pass_startup_fct_0 = (uintptr_t)fct; return my_pass_startup_0; } if(my_pass_startup_fct_1 == 0) {my_pass_startup_fct_1 = (uintptr_t)fct; return my_pass_startup_1; } if(my_pass_startup_fct_2 == 0) {my_pass_startup_fct_2 = (uintptr_t)fct; return my_pass_startup_2; } if(my_pass_startup_fct_3 == 0) {my_pass_startup_fct_3 = (uintptr_t)fct; return my_pass_startup_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 pass_startup callback\n"); fflush(ftrace);}} while(0);
    return 
# 1243 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1243 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_pass_startupFct(void* fct)
{
    ...
    if(my_pass_startup_0 == fct) return (void*)my_pass_startup_fct_0; if(my_pass_startup_1 == fct) return (void*)my_pass_startup_fct_1; if(my_pass_startup_2 == fct) return (void*)my_pass_startup_fct_2; if(my_pass_startup_3 == fct) return (void*)my_pass_startup_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1253 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1253 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1267 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static uintptr_t my_finish_pass_fct_0 = 0; static void my_finish_pass_0(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_finish_pass_fct_0, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_finish_pass_fct_1 = 0; static void my_finish_pass_1(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_finish_pass_fct_1, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_finish_pass_fct_2 = 0; static void my_finish_pass_2(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_finish_pass_fct_2, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; } static uintptr_t my_finish_pass_fct_3 = 0; static void my_finish_pass_3(j62_compress_ptr_t* cinfo) { i386_compress_ptr_t* tmp = ((jmpbuf_helper*)cinfo->client_data)->compress; wrapCompressStruct(tmp, cinfo); jmpbuf_helper* helper = ((jpeg62_common_struct_t*)cinfo)->client_data; tmp->client_data = helper->client_data; uint32_t ret = RunFunctionFmt(my_finish_pass_fct_3, "p", tmp); tmp->client_data = helper;; unwrapCompressStruct(cinfo, tmp); tmp->client_data = ((jmpbuf_helper*)cinfo->client_data)->client_data; }
...
static void* findfinish_passFct(void* fct)
{
    ...
    if(my_finish_pass_fct_0 == (uintptr_t)fct) return my_finish_pass_0; if(my_finish_pass_fct_1 == (uintptr_t)fct) return my_finish_pass_1; if(my_finish_pass_fct_2 == (uintptr_t)fct) return my_finish_pass_2; if(my_finish_pass_fct_3 == (uintptr_t)fct) return my_finish_pass_3;


    if(my_finish_pass_fct_0 == 0) {my_finish_pass_fct_0 = (uintptr_t)fct; return my_finish_pass_0; } if(my_finish_pass_fct_1 == 0) {my_finish_pass_fct_1 = (uintptr_t)fct; return my_finish_pass_1; } if(my_finish_pass_fct_2 == 0) {my_finish_pass_fct_2 = (uintptr_t)fct; return my_finish_pass_2; } if(my_finish_pass_fct_3 == 0) {my_finish_pass_fct_3 = (uintptr_t)fct; return my_finish_pass_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libjpeg.so.62 finish_pass callback\n"); fflush(ftrace);}} while(0);
    return 
# 1280 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
          ((void *)0)
# 1280 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
              ;
}
static void* reverse_finish_passFct(void* fct)
{
    ...
    if(my_finish_pass_0 == fct) return (void*)my_finish_pass_fct_0; if(my_finish_pass_1 == fct) return (void*)my_finish_pass_fct_1; if(my_finish_pass_2 == fct) return (void*)my_finish_pass_fct_2; if(my_finish_pass_3 == fct) return (void*)my_finish_pass_fct_3;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 1290 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                          ((void *)0)
# 1290 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                              );
}
# 1301 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static void wrapErrorMgr(jpeg62_error_mgr_t* mgr)
{
    if(!mgr)
        return;
    ...
    mgr->error_exit = reverse_error_exitFct(mgr->error_exit); mgr->emit_message = reverse_emit_messageFct(mgr->emit_message); mgr->output_message = reverse_output_messageFct(mgr->output_message); mgr->format_message = reverse_format_messageFct(mgr->format_message); mgr->reset_error_mgr = reverse_reset_error_mgrFct(mgr->reset_error_mgr);
...
static void unwrapErrorMgr(jpeg62_error_mgr_t* mgr)
{
    ...
    mgr->error_exit = finderror_exitFct(mgr->error_exit); mgr->emit_message = findemit_messageFct(mgr->emit_message); mgr->output_message = findoutput_messageFct(mgr->output_message); mgr->format_message = findformat_messageFct(mgr->format_message); mgr->reset_error_mgr = findreset_error_mgrFct(mgr->reset_error_mgr);

}
# 1337 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static void wrapMemoryMgr(jpeg62_memory_mgr_t* mgr)
{
    ...
    mgr->alloc_small = reverse_alloc_smallFct(mgr->alloc_small); mgr->alloc_large = reverse_alloc_largeFct(mgr->alloc_large); mgr->alloc_sarray = reverse_alloc_sarrayFct(mgr->alloc_sarray); mgr->alloc_barray = reverse_alloc_barrayFct(mgr->alloc_barray); mgr->request_virt_sarray = reverse_request_virt_sarrayFct(mgr->request_virt_sarray); mgr->request_virt_barray = reverse_request_virt_barrayFct(mgr->request_virt_barray); mgr->realize_virt_arrays = reverse_realize_virt_arraysFct(mgr->realize_virt_arrays); mgr->access_virt_sarray = reverse_access_virt_sarrayFct(mgr->access_virt_sarray); mgr->access_virt_barray = reverse_access_virt_barrayFct(mgr->access_virt_barray); mgr->free_pool = reverse_free_poolFct(mgr->free_pool); mgr->self_destruct = reverse_self_destructFct(mgr->self_destruct);
...
static void unwrapMemoryMgr(jpeg62_memory_mgr_t* mgr)
{
    ...
    mgr->alloc_small = findalloc_smallFct(mgr->alloc_small); mgr->alloc_large = findalloc_largeFct(mgr->alloc_large); mgr->alloc_sarray = findalloc_sarrayFct(mgr->alloc_sarray); mgr->alloc_barray = findalloc_barrayFct(mgr->alloc_barray); mgr->request_virt_sarray = findrequest_virt_sarrayFct(mgr->request_virt_sarray); mgr->request_virt_barray = findrequest_virt_barrayFct(mgr->request_virt_barray); mgr->realize_virt_arrays = findrealize_virt_arraysFct(mgr->realize_virt_arrays); mgr->access_virt_sarray = findaccess_virt_sarrayFct(mgr->access_virt_sarray); mgr->access_virt_barray = findaccess_virt_barrayFct(mgr->access_virt_barray); mgr->free_pool = findfree_poolFct(mgr->free_pool); mgr->self_destruct = findself_destructFct(mgr->self_destruct);

}
# 1367 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
static void wrapSourceMgr(jpeg62_source_mgr_t* mgr)
{
    ...
    mgr->init_source = reverse_init_sourceFct(mgr->init_source); mgr->fill_input_buffer = reverse_fill_input_bufferFct(mgr->fill_input_buffer); mgr->skip_input_data = reverse_skip_input_dataFct(mgr->skip_input_data); mgr->resync_to_restart = reverse_resync_to_restartFct(mgr->resync_to_restart); mgr->term_source = reverse_term_sourceFct(mgr->term_source);
...
static void unwrapSourceMgr(jpeg62_source_mgr_t* mgr)
{
    ...
    mgr->init_source = findinit_sourceFct(mgr->init_source); mgr->fill_input_buffer = findfill_input_bufferFct(mgr->fill_input_buffer); mgr->skip_input_data = findskip_input_dataFct(mgr->skip_input_data); mgr->resync_to_restart = findresync_to_restartFct(mgr->resync_to_restart); mgr->term_source = findterm_sourceFct(mgr->term_source);
...
static void wrapDestinationMgr(jpeg62_destination_mgr_t* mgr)
{
    ...
    mgr->init_destination = reverse_init_destinationFct(mgr->init_destination); mgr->empty_output_buffer = reverse_empty_output_bufferFct(mgr->empty_output_buffer); mgr->term_destination = reverse_term_destinationFct(mgr->term_destination);
...
static void unwrapDestinationMgr(jpeg62_destination_mgr_t* mgr)
{
    ...
    mgr->init_destination = findinit_destinationFct(mgr->init_destination); mgr->empty_output_buffer = findempty_output_bufferFct(mgr->empty_output_buffer); mgr->term_destination = findterm_destinationFct(mgr->term_destination);
...
static void wrapCompMaster(jpeg62_comp_master_t* master) {
    ...
    master->prepare_for_pass = reverse_prepare_for_passFct(master->prepare_for_pass); master->pass_startup = reverse_pass_startupFct(master->pass_startup); master->finish_pass = reverse_finish_passFct(master->finish_pass);
...
static void unwrapCompMaster(jpeg62_comp_master_t* master) {
    ...
    master->prepare_for_pass = findprepare_for_passFct(master->prepare_for_pass); master->pass_startup = findpass_startupFct(master->pass_startup); master->finish_pass = findfinish_passFct(master->finish_pass);
...
__attribute__((visibility("default"))) int my62_jpeg_simd_cpu_support()
{
    return 0x01|0x04|0x08;
}

__attribute__((visibility("default"))) void* my62_jpeg_std_error(x86emu_t* emu, void* errmgr)
{
    (void)emu;
    ...
    ret->error_exit = (void*)AddCheckBridge(my_lib->w.bridge, vFp, native_error_exit, 0, 
# 1481 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                        ((void *)0)
# 1481 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                            );
    ret->emit_message = (void*)AddCheckBridge(my_lib->w.bridge, vFpi, native_emit_message, 0, 
# 1482 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                             ((void *)0)
# 1482 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                                 );
    ret->output_message = (void*)AddCheckBridge(my_lib->w.bridge, vFp, native_output_message, 0, 
# 1483 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                                ((void *)0)
# 1483 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                                    );
    ret->format_message = (void*)AddCheckBridge(my_lib->w.bridge, vFpp, native_format_message, 0, 
# 1484 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                                 ((void *)0)
# 1484 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                                     );
    ret->reset_error_mgr = (void*)AddCheckBridge(my_lib->w.bridge, vFp, native_reset_error_mgr, 0, 
# 1485 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
                                                                                                  ((void *)0)
# 1485 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
                                                                                                      );

    return ret;
}
# 1520 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
__attribute__((visibility("default"))) void my62_jpeg_CreateDecompress(x86emu_t* emu, jpeg62_common_struct_t* cinfo, int version, unsigned long structsize)
{

    unwrapErrorMgr(cinfo->err);
    jmpbuf_helper helper;
    if(
# 1525 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      _setjmp (
# 1525 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
      &helper.jmpbuf
# 1525 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      )
# 1525 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
__attribute__((visibility("default"))) int my62_jpeg_read_header(x86emu_t* emu, jpeg62_common_struct_t* cinfo, int image)
{
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 1); if(
# 1539 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1539 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1539 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1539 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_read_header(cinfo, image); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1);
    return ret;
}

__attribute__((visibility("default"))) int my62_jpeg_start_decompress(x86emu_t* emu, jpeg62_common_struct_t* cinfo)
{
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 1); if(
# 1545 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1545 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1545 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1545 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_start_decompress(cinfo); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1);
    return ret;
}

__attribute__((visibility("default"))) uint32_t my62_jpeg_read_scanlines(x86emu_t* emu, jpeg62_common_struct_t* cinfo, void* scanlines, uint32_t maxlines)
{
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 1); if(
# 1551 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1551 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1551 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1551 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1); return (uint32_t)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; uint32_t ret = my->jpeg_read_scanlines(cinfo, scanlines, maxlines); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1);
    return ret;
}

__attribute__((visibility("default"))) int my62_jpeg_finish_decompress(x86emu_t* emu, jpeg62_common_struct_t* cinfo)
{
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 1); if(
# 1557 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1557 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1557 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1557 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; int ret = my->jpeg_finish_decompress(cinfo); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 1);
    return ret;
}

__attribute__((visibility("default"))) void my62_jpeg_set_marker_processor(x86emu_t* emu, jpeg62_common_struct_t* cinfo, int marker, void* routine)
{
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 0); if(
# 1563 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1563 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1563 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1563 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 0); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_set_marker_processor(cinfo, marker, findjpeg_marker_parser_methodFct(routine)); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 0);
}

__attribute__((visibility("default"))) void my62_jpeg_stdio_src(x86emu_t* emu, jpeg62_common_struct_t* cinfo, void* infile) {
    jmpbuf_helper helper; unwrapCommonStruct(cinfo, 0); if(
# 1567 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1567 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1567 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1567 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 0); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; cinfo->client_data = &helper; my->jpeg_stdio_src(cinfo, infile); cinfo->client_data = helper.client_data; wrapCommonStruct(cinfo, 0);
}

__attribute__((visibility("default"))) void my62_jpeg_stdio_dest(x86emu_t* emu, i386_compress_ptr_t* cinfo, void* outfile) {
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1571 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1571 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1571 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1571 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_stdio_dest(&tmp, outfile); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) void my62_jpeg_destroy_decompress(x86emu_t* emu, jpeg62_common_struct_t* cinfo)
{

    int unwrapped = 0;
    jmpbuf_helper helper;
    if(
# 1579 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      _setjmp (
# 1579 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
      &helper.jmpbuf
# 1579 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      )
# 1579 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
__attribute__((visibility("default"))) void my62_jpeg_CreateCompress(x86emu_t* emu, i386_compress_ptr_t* cinfo, int version, unsigned long structsize)
{
    jmpbuf_helper helper;
    ...
    if(
# 1599 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      _setjmp (
# 1599 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
      &helper.jmpbuf
# 1599 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      )
# 1599 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
    ...
    if(structsize!=sizeof(struct i386_compress_ptr_s)) {
        do {if((0)<=box86_log) {fprintf(ftrace, "Warning, invalid jpeg62 structuresize for compress (%lu/%u)", structsize, sizeof(struct i386_compress_ptr_s)); fflush(ftrace);}} while(0);
    }
    helper.client_data = cinfo->client_data;
...
__attribute__((visibility("default"))) void my62_jpeg_destroy_compress(x86emu_t* emu, i386_compress_ptr_t* cinfo)
{
    ...
    if(
# 1620 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      _setjmp (
# 1620 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
      &helper.jmpbuf
# 1620 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
      )
# 1620 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
__attribute__((visibility("default"))) void my62_jpeg_finish_compress(x86emu_t* emu, i386_compress_ptr_t* cinfo)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1635 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1635 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1635 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1635 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_finish_compress(&tmp); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) int my62_jpeg_resync_to_restart(x86emu_t* emu, i386_compress_ptr_t* cinfo, int desired)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1640 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1640 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1640 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1640 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (int)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; int ret = my->jpeg_resync_to_restart(&tmp, desired); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
    return ret;
}

__attribute__((visibility("default"))) void my62_jpeg_set_defaults(x86emu_t* emu, i386_compress_ptr_t* cinfo)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1646 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1646 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1646 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1646 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_set_defaults(&tmp); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) void my62_jpeg_start_compress(x86emu_t* emu, i386_compress_ptr_t* cinfo, int b)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1651 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1651 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1651 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1651 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_start_compress(&tmp, b); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) uint32_t my62_jpeg_write_scanlines(x86emu_t* emu, i386_compress_ptr_t* cinfo, void* scanlines, uint32_t maxlines)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1656 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1656 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1656 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1656 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (uint32_t)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; uint32_t ret = my->jpeg_write_scanlines(&tmp, scanlines, maxlines); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
    return ret;
}

__attribute__((visibility("default"))) void my62_jpeg_set_quality(x86emu_t* emu, i386_compress_ptr_t* cinfo, int quality, int force)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1662 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1662 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1662 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1662 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_set_quality(&tmp, quality, force); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) void my62_jpeg_mem_dest(x86emu_t* emu, i386_compress_ptr_t* cinfo, void* a, void* b)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1667 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1667 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1667 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1667 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_mem_dest(&tmp, a, b); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}

__attribute__((visibility("default"))) void my62_jpeg_write_marker(x86emu_t* emu, i386_compress_ptr_t* cinfo, int a, void* b, uint32_t c)
{
    jmpbuf_helper helper; struct j62_compress_ptr_s tmp; unwrapCompressStruct(&tmp, cinfo); if(
# 1672 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   _setjmp (
# 1672 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   &helper.jmpbuf
# 1672 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 3 4
   )
# 1672 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
   ) { tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp); return (void)emu->regs[_AX].dword[0]; } helper.client_data = cinfo->client_data; helper.compress = cinfo; tmp.client_data = &helper; my->jpeg_write_marker(&tmp, a, b, c); tmp.client_data = helper.client_data; wrapCompressStruct(cinfo, &tmp);;
}
# 1686 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpeg62defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libjpeg62symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1





{"jcopy_block_row", vFppu, 0},
{"jcopy_sample_rows", vFpipiiu, 0},
{"jdiv_round_up", iFii, 0},
{"jinit_1pass_quantizer", vFp, 0},
{"jinit_2pass_quantizer", vFp, 0},
{"jinit_arith_decoder", vFp, 0},
{"jinit_arith_encoder", vFp, 0},
{"jinit_c_coef_controller", vFpi, 0},
{"jinit_c_main_controller", vFpi, 0},
{"jinit_c_master_control", vFpi, 0},
{"jinit_color_converter", vFp, 0},
{"jinit_color_deconverter", vFp, 0},
{"jinit_compress_master", vFp, 0},
{"jinit_c_prep_controller", vFpi, 0},
{"jinit_d_coef_controller", vFpi, 0},
{"jinit_d_main_controller", vFpi, 0},
{"jinit_downsampler", vFp, 0},
{"jinit_d_post_controller", vFpi, 0},
{"jinit_forward_dct", vFp, 0},
{"jinit_huff_decoder", vFp, 0},
{"jinit_huff_encoder", vFp, 0},
{"jinit_input_controller", vFp, 0},
{"jinit_inverse_dct", vFp, 0},
{"jinit_marker_reader", vFp, 0},
{"jinit_marker_writer", vFp, 0},
{"jinit_master_decompress", vFp, 0},
{"jinit_memory_mgr", vFp, 0},
{"jinit_merged_upsampler", vFp, 0},
{"jinit_phuff_decoder", vFp, 0},
{"jinit_phuff_encoder", vFp, 0},
{"jinit_upsampler", vFp, 0},
{"jpeg_abort", vFp, 0},
{"jpeg_abort_compress", vFp, 0},
{"jpeg_abort_decompress", vFp, 0},
{"jpeg_add_quant_table", vFpipii, 0},
{"jpeg_alloc_huff_table", pFp, 0},
{"jpeg_alloc_quant_table", pFp, 0},

{"jpeg_calc_jpeg_dimensions", vFp, 0},
{"jpeg_calc_output_dimensions", vFp, 0},
{"jpeg_consume_input", iFp, 0},
{"jpeg_copy_critical_parameters", vFp, 0},
{"jpeg_core_output_dimensions", vFp, 0},


{"jpeg_crop_scanline", vFppp, 0},
{"jpeg_default_colorspace", vFp, 0},
{"jpeg_default_qtables", vFpi, 0},
{"jpeg_destroy", vFp, 0},
...
{"jpeg_finish_output", iFp, 0},





{"jpeg_has_multiple_scans", iFp, 0},
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h"
{"jpeg_input_complete", iFp, 0},





{"jpeg_mem_src", vFppu, 0},


{"jpeg_new_colormap", vFp, 0},

{"jpeg_quality_scaling", iFi, 0},
{"jpeg_read_coefficients", pFp, 0},

{"jpeg_read_raw_data", uFppu, 0},


{"jpeg_save_markers", vFpiu, 0},
{"jpeg_set_colorspace", vFpi, 0},

{"jpeg_set_linear_quality", vFpii, 0},



{"jpeg_simple_progression", vFp, 0},
{"jpeg_skip_scanlines", uFpu, 0},


{"jpeg_start_output", iFpi, 0},




{"jpeg_suppress_tables", vFpi, 0},
{"jpeg_write_coefficients", vFpp, 0},

{"jpeg_write_m_byte", vFpi, 0},
{"jpeg_write_m_header", vFpiu, 0},
{"jpeg_write_raw_data", uFppu, 0},

{"jpeg_write_tables", vFp, 0},
{"jround_up", iFii, 0},
{"jzero_far", vFpu, 0},


{"jppeg_dummy_virt_array", pFpiiuuu, 0},
{"jppeg_dummy_virt_access", pFppuui, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libjpeg62mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1
...
{"jpeg_CreateCompress", vFEpiL, 0},
{"jpeg_CreateDecompress", vFEpiL, 0},




{"jpeg_destroy_compress", vFEp, 0},
{"jpeg_destroy_decompress", vFEp, 0},




{"jpeg_finish_compress", vFEp, 0},
{"jpeg_finish_decompress", iFEp, 0},
...
{"jpeg_read_header", iFEpi, 0},

{"jpeg_read_scanlines", uFEppu, 0},
{"jpeg_resync_to_restart", iFEpi, 0},


{"jpeg_set_defaults", vFEp, 0},

{"jpeg_set_marker_processor", vFEpip, 0},
{"jpeg_set_quality", vFEpii, 0},
{"jpeg_simd_cpu_support", iFv, 0},


{"jpeg_start_compress", vFEpi, 0},
{"jpeg_start_decompress", iFEp, 0},

{"jpeg_std_error", pFEp, 0},
{"jpeg_stdio_dest", vFEpp, 0},
{"jpeg_stdio_src", vFEpp, 0},



{"jpeg_write_marker", vFEpipu, 0},



{"jpeg_write_scanlines", uFEppu, 0},
...
static const map_onesymbol_t libjpeg62stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1
...
static const map_onesymbol2_t libjpeg62symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1
...
static const map_onedata_t libjpeg62datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1
...
static const map_onedata_t libjpeg62mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibjpeg62undefs.h" 1
...
int wrappedlibjpeg62_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libjpeg62Name, 
...
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        lib->w.lib = dlopen("libjpeg.so.8", 
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 3 4
                                    0x00001 
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
                                              | 
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 3 4
                                                0x00100
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libjpeg62Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libjpeg62symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libjpeg62symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libjpeg62symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libjpeg62symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libjpeg62symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libjpeg62symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libjpeg62symbolmap[i].name, '@')) AddDictionnary(box86->versym, libjpeg62symbolmap[i].name); }
 cnt = sizeof(libjpeg62mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libjpeg62mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libjpeg62mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libjpeg62mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libjpeg62mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libjpeg62mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libjpeg62mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libjpeg62mysymbolmap[i].name); }

    cnt = sizeof(libjpeg62stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libjpeg62stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libjpeg62stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libjpeg62stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libjpeg62stsymbolmap[i].name);
    }
    cnt = sizeof(libjpeg62symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libjpeg62symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libjpeg62symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libjpeg62symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libjpeg62symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libjpeg62symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libjpeg62symbol2map[i].name);
    }
    cnt = sizeof(libjpeg62datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libjpeg62datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libjpeg62datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libjpeg62datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libjpeg62datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libjpeg62datamap[i].sz;
        }
    }
    cnt = sizeof(libjpeg62mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libjpeg62mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libjpeg62mydatamap[i].sz;
    }

    my_bridge = lib->w.bridge; lib->w.altmy = box_strdup("my62_"); getMy(lib);


    return 0;
}

void wrappedlibjpeg62_fini(library_t* lib)
{
...
# 1687 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibjpeg62.c" 2
