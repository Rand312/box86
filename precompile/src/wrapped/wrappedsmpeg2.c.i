# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpeg2types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpeg2types.h"
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
...
typedef struct smpeg2_my_s {
    ...
    vFpp_t SMPEG_getinfo; pFipi_t SMPEG_new_descr; pFppi_t SMPEG_new; vFpppp_t SMPEG_setdisplay; pFpipi_t SMPEG_new_data; pFppii_t SMPEG_new_rwops;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static smpeg2_my_t my_smpeg2 = {0};
static smpeg2_my_t * const my = &my_smpeg2;

static void getMy(library_t* lib)
{

    my->SMPEG_getinfo = (vFpp_t)dlsym(lib->w.lib, "SMPEG_getinfo"); my->SMPEG_new_descr = (pFipi_t)dlsym(lib->w.lib, "SMPEG_new_descr"); my->SMPEG_new = (pFppi_t)dlsym(lib->w.lib, "SMPEG_new"); my->SMPEG_setdisplay = (vFpppp_t)dlsym(lib->w.lib, "SMPEG_setdisplay"); my->SMPEG_new_data = (pFpipi_t)dlsym(lib->w.lib, "SMPEG_new_data"); my->SMPEG_new_rwops = (pFppii_t)dlsym(lib->w.lib, "SMPEG_new_rwops");
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c"
static uintptr_t my_dispcallback_fct_0 = 0; static void my_dispcallback_0(void* data, void* frame) { RunFunctionFmt(my_dispcallback_fct_0, "pp", data, frame); } static uintptr_t my_dispcallback_fct_1 = 0; static void my_dispcallback_1(void* data, void* frame) { RunFunctionFmt(my_dispcallback_fct_1, "pp", data, frame); } static uintptr_t my_dispcallback_fct_2 = 0; static void my_dispcallback_2(void* data, void* frame) { RunFunctionFmt(my_dispcallback_fct_2, "pp", data, frame); } static uintptr_t my_dispcallback_fct_3 = 0; static void my_dispcallback_3(void* data, void* frame) { RunFunctionFmt(my_dispcallback_fct_3, "pp", data, frame); } static uintptr_t my_dispcallback_fct_4 = 0; static void my_dispcallback_4(void* data, void* frame) { RunFunctionFmt(my_dispcallback_fct_4, "pp", data, frame); }
...
static void* find_dispcallback_Fct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libsmpeg2 dispcallback callback\n"); fflush(ftrace);}} while(0);
    return 
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 3 4
          ((void *)0)
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c"
              ;
}



__attribute__((visibility("default"))) void my2_SMPEG_setdisplay(x86emu_t* emu, void* mpeg, void* cb, void* data, void* lock)
{
    (void)emu;
    my->SMPEG_setdisplay(mpeg, find_dispcallback_Fct(cb), data, lock);
}

__attribute__((visibility("default"))) void my2_SMPEG_getinfo(x86emu_t* emu, void* mpeg, void* info)
{
    (void)emu;
...
__attribute__((visibility("default"))) void* my2_SMPEG_new(x86emu_t* emu, void* file, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
...
__attribute__((visibility("default"))) void* my2_SMPEG_new_descr(x86emu_t* emu, int file, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
    AlignSmpegInfo(&inf, info);
...
__attribute__((visibility("default"))) void* my2_SMPEG_new_data(x86emu_t* emu, void* data, int size, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
    AlignSmpegInfo(&inf, info);
...
__attribute__((visibility("default"))) void* my2_SMPEG_new_rwops(x86emu_t* emu, void* src, void* info, int32_t f, int32_t audio)
{
    my_SMPEG_Info_t inf;
    AlignSmpegInfo(&inf, info);
...
# 124 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpeg2defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t smpeg2symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
static const map_onesymbol_t smpeg2mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
static const map_onesymbol_t smpeg2stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
static const map_onesymbol2_t smpeg2symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
static const map_onedata_t smpeg2datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
static const map_onedata_t smpeg2mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpeg2undefs.h" 1
...
int wrappedsmpeg2_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(smpeg2Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(smpeg2symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (smpeg2symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, smpeg2symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = smpeg2symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, smpeg2symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = smpeg2symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(smpeg2symbolmap[i].name, '@')) AddDictionnary(box86->versym, smpeg2symbolmap[i].name); }
 cnt = sizeof(smpeg2mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (smpeg2mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, smpeg2mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = smpeg2mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, smpeg2mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = smpeg2mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(smpeg2mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, smpeg2mysymbolmap[i].name); }

    cnt = sizeof(smpeg2stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, smpeg2stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = smpeg2stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(smpeg2stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, smpeg2stsymbolmap[i].name);
    }
    cnt = sizeof(smpeg2symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, smpeg2symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = smpeg2symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = smpeg2symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = smpeg2symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(smpeg2symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, smpeg2symbol2map[i].name);
    }
    cnt = sizeof(smpeg2datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(smpeg2datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, smpeg2datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = smpeg2datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, smpeg2datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = smpeg2datamap[i].sz;
        }
    }
    cnt = sizeof(smpeg2mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, smpeg2mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = smpeg2mydatamap[i].sz;
    }

    getMy(lib); lib->w.altmy = box_strdup("my2_");


    return 0;
}

void wrappedsmpeg2_fini(library_t* lib)
{
...
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg2.c" 2
