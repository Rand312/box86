# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
const char* libv4l2Name = "libv4l2.so.0";




# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibv4l2types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibv4l2types.h"
typedef int32_t (*iFpL_t)(void*, uintptr_t);
typedef void* (*pFpLiiii_t)(void*, uintptr_t, int32_t, int32_t, int32_t, int32_t);
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
...
typedef struct libv4l2_my_s {
    ...
    iFpL_t v4l2_munmap; pFpLiiii_t v4l2_mmap;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libv4l2_my_t my_libv4l2 = {0};
static libv4l2_my_t * const my = &my_libv4l2;

static void getMy(library_t* lib)
{

    my->v4l2_munmap = (iFpL_t)dlsym(lib->w.lib, "v4l2_munmap"); my->v4l2_mmap = (pFpLiiii_t)dlsym(lib->w.lib, "v4l2_mmap");
...
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2


__attribute__((visibility("default"))) void* my_v4l2_mmap(x86emu_t* emu, void *addr, unsigned long length, int prot, int flags, int fd, int offset)
{
    (void)emu;
    if(prot&
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 3 4
           0x2
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
                     )
        prot|=
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 3 4
             0x1
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
                      ;
    if(box86_log<2) do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "%s: %p :v4l2_mmap(%p, %lu, 0x%x, 0x%x, %d, %d) =>", __FUNCTION__, my->v4l2_mmap, addr, length, prot, flags, fd, offset); fflush(ftrace);}} while(0);

    void* ret = my->v4l2_mmap(addr, length, prot, flags, fd, offset);
    if (ret == (void*)-1)
    {
        do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "v4l2_mmap failed:%s errno = %d, try mmap\n", strerror(
# 37 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 3 4
       (*__errno_location ())
# 37 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
       ), 
# 37 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 3 4
       (*__errno_location ())
# 37 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
        ...
        do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "mmap ret = %p\n", ret); fflush(ftrace);}} while(0);

    }
    if(box86_log<2) {do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "%p\n", ret); fflush(ftrace);}} while(0);}
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c"
    if(ret!=(void*)-1)
        setProtection((uintptr_t)ret, length, prot);
    return ret;
}

__attribute__((visibility("default"))) int my_v4l2_munmap(x86emu_t* emu, void* addr, unsigned long length)
{
    (void)emu;
    do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "v4l2_munmap(%p, %lu)\n", addr, length); fflush(ftrace);}} while(0);
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibv4l2defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libv4l2symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2_private.h" 1
...
static const map_onesymbol_t libv4l2mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2_private.h" 1
...
static const map_onesymbol2_t libv4l2symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2_private.h" 1
...
static const map_onedata_t libv4l2datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2_private.h" 1
...
static const map_onedata_t libv4l2mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibv4l2undefs.h" 1
...
int wrappedlibv4l2_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libv4l2Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libv4l2symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libv4l2symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libv4l2symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libv4l2symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libv4l2symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libv4l2symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libv4l2symbolmap[i].name, '@')) AddDictionnary(box86->versym, libv4l2symbolmap[i].name); }
 cnt = sizeof(libv4l2mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libv4l2mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libv4l2mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libv4l2mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libv4l2mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libv4l2mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libv4l2mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libv4l2mysymbolmap[i].name); }

    cnt = sizeof(libv4l2stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libv4l2stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libv4l2stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libv4l2stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libv4l2stsymbolmap[i].name);
    }
    cnt = sizeof(libv4l2symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libv4l2symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libv4l2symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libv4l2symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libv4l2symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libv4l2symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libv4l2symbol2map[i].name);
    }
    cnt = sizeof(libv4l2datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libv4l2datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libv4l2datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libv4l2datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libv4l2datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libv4l2datamap[i].sz;
        }
    }
    cnt = sizeof(libv4l2mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libv4l2mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libv4l2mydatamap[i].sz;
    }
...
void wrappedlibv4l2_fini(library_t* lib)
{
...
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibv4l2.c" 2
