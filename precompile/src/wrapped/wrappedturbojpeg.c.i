# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedturbojpegdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t turbojpegsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg_private.h" 1
...
{"TJBUFSIZEYUV", LFiii, 0},




{"tjCompressFromYUVPlanes", iFppipiippii, 0},





{"tjDecompressHeader2", iFppLppp, 0},

{"tjDecompressToYUV", iFppLpi, 0},
...
static const map_onesymbol_t turbojpegstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg_private.h" 1
...
static const map_onesymbol2_t turbojpegsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg_private.h" 1
...
static const map_onedata_t turbojpegdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg_private.h" 1
...
static const map_onedata_t turbojpegmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedturbojpegundefs.h" 1
...
int wrappedturbojpeg_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(turbojpegName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(turbojpegName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(turbojpegsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (turbojpegsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, turbojpegsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = turbojpegsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, turbojpegsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = turbojpegsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(turbojpegsymbolmap[i].name, '@')) AddDictionnary(box86->versym, turbojpegsymbolmap[i].name); }
 cnt = sizeof(turbojpegmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (turbojpegmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, turbojpegmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = turbojpegmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, turbojpegmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = turbojpegmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(turbojpegmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, turbojpegmysymbolmap[i].name); }

    cnt = sizeof(turbojpegstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, turbojpegstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = turbojpegstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(turbojpegstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, turbojpegstsymbolmap[i].name);
    }
    cnt = sizeof(turbojpegsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, turbojpegsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = turbojpegsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = turbojpegsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = turbojpegsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(turbojpegsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, turbojpegsymbol2map[i].name);
    }
    cnt = sizeof(turbojpegdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(turbojpegdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, turbojpegdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = turbojpegdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, turbojpegdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = turbojpegdatamap[i].sz;
        }
    }
    cnt = sizeof(turbojpegmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, turbojpegmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = turbojpegmydatamap[i].sz;
    }

    lib->w.altmy = box_strdup("myturbo_");


    return 0;
}

void wrappedturbojpeg_fini(library_t* lib)
{
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedturbojpeg.c" 2
