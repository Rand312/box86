# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2

const char* gmodule2Name = "libgmodule-2.0.so.0";
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmodule2defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gmodule2symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1





{"g_module_build_path", pFpp, 0},
{"g_module_close", iFp, 0},
{"g_module_error", pFv, 0},
{"g_module_make_resident", vFp, 0},
{"g_module_name", pFp, 0},
{"g_module_open", pFpi, 0},
{"g_module_supported", iFv, 0},
{"g_module_symbol", iFppp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gmodule2mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1
...
static const map_onesymbol_t gmodule2stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1
...
static const map_onesymbol2_t gmodule2symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1
...
static const map_onedata_t gmodule2datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1
...
static const map_onedata_t gmodule2mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmodule2undefs.h" 1
...
int wrappedgmodule2_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gmodule2Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gmodule2symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gmodule2symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gmodule2symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gmodule2symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gmodule2symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gmodule2symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gmodule2symbolmap[i].name, '@')) AddDictionnary(box86->versym, gmodule2symbolmap[i].name); }
 cnt = sizeof(gmodule2mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gmodule2mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gmodule2mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gmodule2mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gmodule2mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gmodule2mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gmodule2mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gmodule2mysymbolmap[i].name); }

    cnt = sizeof(gmodule2stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gmodule2stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gmodule2stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gmodule2stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gmodule2stsymbolmap[i].name);
    }
    cnt = sizeof(gmodule2symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gmodule2symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gmodule2symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gmodule2symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gmodule2symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gmodule2symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gmodule2symbol2map[i].name);
    }
    cnt = sizeof(gmodule2datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gmodule2datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gmodule2datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gmodule2datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gmodule2datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gmodule2datamap[i].sz;
        }
    }
    cnt = sizeof(gmodule2mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gmodule2mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gmodule2mydatamap[i].sz;
    }
...
void wrappedgmodule2_fini(library_t* lib)
{
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmodule2.c" 2
