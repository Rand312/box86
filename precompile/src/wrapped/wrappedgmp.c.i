# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmptypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmptypes.h"
typedef void (*vFppp_t)(void*, void*, void*);
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
...
typedef struct gmp_my_s {


    vFppp_t __gmp_get_memory_functions; vFppp_t __gmp_set_memory_functions;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static gmp_my_t my_gmp = {0};
static gmp_my_t * const my = &my_gmp;

static void getMy(library_t* lib)
{

    my->__gmp_get_memory_functions = (vFppp_t)dlsym(lib->w.lib, "__gmp_get_memory_functions"); my->__gmp_set_memory_functions = (vFppp_t)dlsym(lib->w.lib, "__gmp_set_memory_functions");
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
static uintptr_t my_alloc_func_fct_0 = 0; static void* my_alloc_func_0(size_t a) { return (void*)RunFunctionFmt(my_alloc_func_fct_0, "L", a); } static uintptr_t my_alloc_func_fct_1 = 0; static void* my_alloc_func_1(size_t a) { return (void*)RunFunctionFmt(my_alloc_func_fct_1, "L", a); } static uintptr_t my_alloc_func_fct_2 = 0; static void* my_alloc_func_2(size_t a) { return (void*)RunFunctionFmt(my_alloc_func_fct_2, "L", a); } static uintptr_t my_alloc_func_fct_3 = 0; static void* my_alloc_func_3(size_t a) { return (void*)RunFunctionFmt(my_alloc_func_fct_3, "L", a); } static uintptr_t my_alloc_func_fct_4 = 0; static void* my_alloc_func_4(size_t a) { return (void*)RunFunctionFmt(my_alloc_func_fct_4, "L", a); }

static void* find_alloc_func_Fct(void* fct)
{
    if(!fct) return 
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                   ((void *)0)
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_alloc_func_fct_0 == (uintptr_t)fct) return my_alloc_func_0; if(my_alloc_func_fct_1 == (uintptr_t)fct) return my_alloc_func_1; if(my_alloc_func_fct_2 == (uintptr_t)fct) return my_alloc_func_2; if(my_alloc_func_fct_3 == (uintptr_t)fct) return my_alloc_func_3; if(my_alloc_func_fct_4 == (uintptr_t)fct) return my_alloc_func_4;


    if(my_alloc_func_fct_0 == 0) {my_alloc_func_fct_0 = (uintptr_t)fct; return my_alloc_func_0; } if(my_alloc_func_fct_1 == 0) {my_alloc_func_fct_1 = (uintptr_t)fct; return my_alloc_func_1; } if(my_alloc_func_fct_2 == 0) {my_alloc_func_fct_2 = (uintptr_t)fct; return my_alloc_func_2; } if(my_alloc_func_fct_3 == 0) {my_alloc_func_fct_3 = (uintptr_t)fct; return my_alloc_func_3; } if(my_alloc_func_fct_4 == 0) {my_alloc_func_fct_4 = (uintptr_t)fct; return my_alloc_func_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgmp.so.10 alloc_func callback\n"); fflush(ftrace);}} while(0);
    return 
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
          ((void *)0)
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
              ;
}
static void* reverse_alloc_func_Fct(void* fct)
{
    ...
    if(my_alloc_func_0 == fct) return (void*)my_alloc_func_fct_0; if(my_alloc_func_1 == fct) return (void*)my_alloc_func_fct_1; if(my_alloc_func_2 == fct) return (void*)my_alloc_func_fct_2; if(my_alloc_func_3 == fct) return (void*)my_alloc_func_fct_3; if(my_alloc_func_4 == fct) return (void*)my_alloc_func_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, pFL, fct, 0, 
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                                                          ((void *)0)
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                                                              );
}
...
static uintptr_t my_realloc_func_fct_0 = 0; static void* my_realloc_func_0(void* a, size_t b) { return (void*)RunFunctionFmt(my_realloc_func_fct_0, "pL", a, b); } static uintptr_t my_realloc_func_fct_1 = 0; static void* my_realloc_func_1(void* a, size_t b) { return (void*)RunFunctionFmt(my_realloc_func_fct_1, "pL", a, b); } static uintptr_t my_realloc_func_fct_2 = 0; static void* my_realloc_func_2(void* a, size_t b) { return (void*)RunFunctionFmt(my_realloc_func_fct_2, "pL", a, b); } static uintptr_t my_realloc_func_fct_3 = 0; static void* my_realloc_func_3(void* a, size_t b) { return (void*)RunFunctionFmt(my_realloc_func_fct_3, "pL", a, b); } static uintptr_t my_realloc_func_fct_4 = 0; static void* my_realloc_func_4(void* a, size_t b) { return (void*)RunFunctionFmt(my_realloc_func_fct_4, "pL", a, b); }

static void* find_realloc_func_Fct(void* fct)
{
    if(!fct) return 
# 80 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                   ((void *)0)
# 80 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_realloc_func_fct_0 == (uintptr_t)fct) return my_realloc_func_0; if(my_realloc_func_fct_1 == (uintptr_t)fct) return my_realloc_func_1; if(my_realloc_func_fct_2 == (uintptr_t)fct) return my_realloc_func_2; if(my_realloc_func_fct_3 == (uintptr_t)fct) return my_realloc_func_3; if(my_realloc_func_fct_4 == (uintptr_t)fct) return my_realloc_func_4;


    if(my_realloc_func_fct_0 == 0) {my_realloc_func_fct_0 = (uintptr_t)fct; return my_realloc_func_0; } if(my_realloc_func_fct_1 == 0) {my_realloc_func_fct_1 = (uintptr_t)fct; return my_realloc_func_1; } if(my_realloc_func_fct_2 == 0) {my_realloc_func_fct_2 = (uintptr_t)fct; return my_realloc_func_2; } if(my_realloc_func_fct_3 == 0) {my_realloc_func_fct_3 = (uintptr_t)fct; return my_realloc_func_3; } if(my_realloc_func_fct_4 == 0) {my_realloc_func_fct_4 = (uintptr_t)fct; return my_realloc_func_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgmp.so.10 realloc_func callback\n"); fflush(ftrace);}} while(0);
    return 
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
          ((void *)0)
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
              ;
}
static void* reverse_realloc_func_Fct(void* fct)
{
    ...
    if(my_realloc_func_0 == fct) return (void*)my_realloc_func_fct_0; if(my_realloc_func_1 == fct) return (void*)my_realloc_func_fct_1; if(my_realloc_func_2 == fct) return (void*)my_realloc_func_fct_2; if(my_realloc_func_3 == fct) return (void*)my_realloc_func_fct_3; if(my_realloc_func_4 == fct) return (void*)my_realloc_func_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, pFpL, fct, 0, 
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                                                           ((void *)0)
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                                                               );
}
...
static uintptr_t my_free_func_fct_0 = 0; static void my_free_func_0(void* a) { RunFunctionFmt(my_free_func_fct_0, "p", a); } static uintptr_t my_free_func_fct_1 = 0; static void my_free_func_1(void* a) { RunFunctionFmt(my_free_func_fct_1, "p", a); } static uintptr_t my_free_func_fct_2 = 0; static void my_free_func_2(void* a) { RunFunctionFmt(my_free_func_fct_2, "p", a); } static uintptr_t my_free_func_fct_3 = 0; static void my_free_func_3(void* a) { RunFunctionFmt(my_free_func_fct_3, "p", a); } static uintptr_t my_free_func_fct_4 = 0; static void my_free_func_4(void* a) { RunFunctionFmt(my_free_func_fct_4, "p", a); }

static void* find_free_func_Fct(void* fct)
{
    if(!fct) return 
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                   ((void *)0)
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_free_func_fct_0 == (uintptr_t)fct) return my_free_func_0; if(my_free_func_fct_1 == (uintptr_t)fct) return my_free_func_1; if(my_free_func_fct_2 == (uintptr_t)fct) return my_free_func_2; if(my_free_func_fct_3 == (uintptr_t)fct) return my_free_func_3; if(my_free_func_fct_4 == (uintptr_t)fct) return my_free_func_4;


    if(my_free_func_fct_0 == 0) {my_free_func_fct_0 = (uintptr_t)fct; return my_free_func_0; } if(my_free_func_fct_1 == 0) {my_free_func_fct_1 = (uintptr_t)fct; return my_free_func_1; } if(my_free_func_fct_2 == 0) {my_free_func_fct_2 = (uintptr_t)fct; return my_free_func_2; } if(my_free_func_fct_3 == 0) {my_free_func_fct_3 = (uintptr_t)fct; return my_free_func_3; } if(my_free_func_fct_4 == 0) {my_free_func_fct_4 = (uintptr_t)fct; return my_free_func_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgmp.so.10 free_func callback\n"); fflush(ftrace);}} while(0);
    return 
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
          ((void *)0)
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
              ;
}
static void* reverse_free_func_Fct(void* fct)
{
    ...
    if(my_free_func_0 == fct) return (void*)my_free_func_fct_0; if(my_free_func_1 == fct) return (void*)my_free_func_fct_1; if(my_free_func_2 == fct) return (void*)my_free_func_fct_2; if(my_free_func_3 == fct) return (void*)my_free_func_fct_3; if(my_free_func_4 == fct) return (void*)my_free_func_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, vFp, fct, 0, 
# 133 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 3 4
                                                          ((void *)0)
# 133 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c"
                                                              );
}



__attribute__((visibility("default"))) void my___gmp_get_memory_functions(x86emu_t* emu, void** f_alloc, void** f_realloc, void** f_free)
{
...
__attribute__((visibility("default"))) void my___gmp_set_memory_functions(x86emu_t* emu, void* f_alloc, void* f_realloc, void* f_free)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmpdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gmpsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h" 1
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"

# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_addmul_1", LFppLL, 0},
{"__gmpn_add_n", LFpppL, 0},
# 134 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_cnd_add_n", LFLpppL, 0},
{"__gmpn_cnd_sub_n", LFLpppL, 0},



{"__gmpn_copyd", vFppL, 0},
{"__gmpn_copyi", vFppL, 0},
# 234 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_mul_1", LFppLL, 0},
# 245 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_mul_n", vFpppL, 0},
...
{"__gmpn_perfect_square_p", iFpL, 0},
# 273 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_rshift", LFppLu, 0},
# 303 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_sqr", vFppL, 0},
# 319 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_submul_1", LFppLL, 0},
{"__gmpn_sub_n", LFpppL, 0},
# 358 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpn_zero", vFpL, 0},
# 417 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"

# 440 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_add", vFppp, 0},


{"__gmpz_add_ui", vFppL, 0},





{"__gmpz_cdiv_q", vFppp, 0},
# 458 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_clear", vFp, 0},
...
{"__gmpz_cmp_ui", iFpu, 0},
{"__gmpz_com", vFpp, 0},


{"__gmpz_congruent_p", iFppp, 0},
# 480 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_export", vFppiLiLp, 0},

{"__gmpz_fdiv_q", vFppp, 0},
{"__gmpz_fdiv_q_2exp", vFppL, 0},



{"__gmpz_fdiv_r", vFppp, 0},
{"__gmpz_fdiv_r_2exp", vFppL, 0},
# 499 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_gcd", vFppp, 0},
# 509 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_import", vFpLiLiLp, 0},
{"__gmpz_init", vFp, 0},


{"__gmpz_init_set", vFpp, 0},



{"__gmpz_init_set_ui", vFpL, 0},



{"__gmpz_invert", iFppp, 0},
...
{"__gmpz_limbs_finish", vFpL, 0},
{"__gmpz_limbs_modify", pFpL, 0},
{"__gmpz_limbs_read", pFp, 0},
{"__gmpz_limbs_write", pFpL, 0},
...
{"__gmpz_mod", vFppp, 0},
{"__gmpz_mul", vFppp, 0},
{"__gmpz_mul_2exp", vFppL, 0},

{"__gmpz_mul_ui", vFppL, 0},
# 552 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmpz_powm", vFpppp, 0},
{"__gmpz_powm_sec", vFpppp, 0},
{"__gmpz_powm_ui", vFppLp, 0},


{"__gmpz_probab_prime_p", iFpi, 0},
...
{"__gmpz_scan1", LFpL, 0},
{"__gmpz_set", vFpp, 0},
{"__gmpz_setbit", vFpL, 0},





{"__gmpz_set_ui", vFpL, 0},


{"__gmpz_sizeinbase", LFpi, 0},



{"__gmpz_sub", vFppp, 0},

{"__gmpz_submul_ui", vFppL, 0},
{"__gmpz_sub_ui", vFppu, 0},


{"__gmpz_tdiv_q_2exp", vFppL, 0},
{"__gmpz_tdiv_qr", vFpppp, 0},
...
# 417 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
{"__gmp_set_memory_functions", vFEppp, 0},
# 440 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
...
static const map_onesymbol_t gmpstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h" 1
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
...
static const map_onesymbol2_t gmpsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h" 1
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
...
static const map_onedata_t gmpdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h" 1
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
...
static const map_onedata_t gmpmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h" 1
# 100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgmpundefs.h" 1
...
int wrappedgmp_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gmpName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gmpsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gmpsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gmpsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gmpsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gmpsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gmpsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gmpsymbolmap[i].name, '@')) AddDictionnary(box86->versym, gmpsymbolmap[i].name); }
 cnt = sizeof(gmpmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gmpmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gmpmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gmpmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gmpmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gmpmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gmpmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gmpmysymbolmap[i].name); }

    cnt = sizeof(gmpstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gmpstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gmpstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gmpstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gmpstsymbolmap[i].name);
    }
    cnt = sizeof(gmpsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gmpsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gmpsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gmpsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gmpsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gmpsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gmpsymbol2map[i].name);
    }
    cnt = sizeof(gmpdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gmpdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gmpdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gmpdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gmpdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gmpdatamap[i].sz;
        }
    }
    cnt = sizeof(gmpmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gmpmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gmpmydatamap[i].sz;
    }
...
void wrappedgmp_fini(library_t* lib)
{
...
# 157 "/home/ssd/pico/code/box86/src/wrapped/wrappedgmp.c" 2
