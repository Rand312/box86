# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgnutlstypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgnutlstypes.h"
typedef void (*vFp_t)(void*);
typedef void (*vFpp_t)(void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
typedef struct gnutls_my_s {
    ...
    vFp_t gnutls_global_set_log_function; vFpp_t gnutls_transport_set_pull_function; vFpp_t gnutls_transport_set_pull_timeout_function; vFpp_t gnutls_transport_set_push_function;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static gnutls_my_t my_gnutls = {0};
static gnutls_my_t * const my = &my_gnutls;

static void getMy(library_t* lib)
{

    my->gnutls_global_set_log_function = (vFp_t)dlsym(lib->w.lib, "gnutls_global_set_log_function"); my->gnutls_transport_set_pull_function = (vFpp_t)dlsym(lib->w.lib, "gnutls_transport_set_pull_function"); my->gnutls_transport_set_pull_timeout_function = (vFpp_t)dlsym(lib->w.lib, "gnutls_transport_set_pull_timeout_function"); my->gnutls_transport_set_push_function = (vFpp_t)dlsym(lib->w.lib, "gnutls_transport_set_push_function");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
...
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
static uintptr_t my_gnutls_log_fct_0 = 0; static void my_gnutls_log_0(int level, const char* p) { RunFunctionFmt(my_gnutls_log_fct_0, "ip", level, p); } static uintptr_t my_gnutls_log_fct_1 = 0; static void my_gnutls_log_1(int level, const char* p) { RunFunctionFmt(my_gnutls_log_fct_1, "ip", level, p); } static uintptr_t my_gnutls_log_fct_2 = 0; static void my_gnutls_log_2(int level, const char* p) { RunFunctionFmt(my_gnutls_log_fct_2, "ip", level, p); } static uintptr_t my_gnutls_log_fct_3 = 0; static void my_gnutls_log_3(int level, const char* p) { RunFunctionFmt(my_gnutls_log_fct_3, "ip", level, p); } static uintptr_t my_gnutls_log_fct_4 = 0; static void my_gnutls_log_4(int level, const char* p) { RunFunctionFmt(my_gnutls_log_fct_4, "ip", level, p); }

static void* find_gnutls_log_Fct(void* fct)
{
    if(!fct) return 
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
                   ((void *)0)
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_gnutls_log_fct_0 == (uintptr_t)fct) return my_gnutls_log_0; if(my_gnutls_log_fct_1 == (uintptr_t)fct) return my_gnutls_log_1; if(my_gnutls_log_fct_2 == (uintptr_t)fct) return my_gnutls_log_2; if(my_gnutls_log_fct_3 == (uintptr_t)fct) return my_gnutls_log_3; if(my_gnutls_log_fct_4 == (uintptr_t)fct) return my_gnutls_log_4;


    if(my_gnutls_log_fct_0 == 0) {my_gnutls_log_fct_0 = (uintptr_t)fct; return my_gnutls_log_0; } if(my_gnutls_log_fct_1 == 0) {my_gnutls_log_fct_1 = (uintptr_t)fct; return my_gnutls_log_1; } if(my_gnutls_log_fct_2 == 0) {my_gnutls_log_fct_2 = (uintptr_t)fct; return my_gnutls_log_2; } if(my_gnutls_log_fct_3 == 0) {my_gnutls_log_fct_3 = (uintptr_t)fct; return my_gnutls_log_3; } if(my_gnutls_log_fct_4 == 0) {my_gnutls_log_fct_4 = (uintptr_t)fct; return my_gnutls_log_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgnutls.so.30 gnutls_log callback\n"); fflush(ftrace);}} while(0);
    return 
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
          ((void *)0)
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
              ;
}
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
static uintptr_t my_pullpush_fct_0 = 0; static long my_pullpush_0(void* p, void* d, size_t l) { return (long)RunFunctionFmt(my_pullpush_fct_0, "ppL", p, d, l); } static uintptr_t my_pullpush_fct_1 = 0; static long my_pullpush_1(void* p, void* d, size_t l) { return (long)RunFunctionFmt(my_pullpush_fct_1, "ppL", p, d, l); } static uintptr_t my_pullpush_fct_2 = 0; static long my_pullpush_2(void* p, void* d, size_t l) { return (long)RunFunctionFmt(my_pullpush_fct_2, "ppL", p, d, l); } static uintptr_t my_pullpush_fct_3 = 0; static long my_pullpush_3(void* p, void* d, size_t l) { return (long)RunFunctionFmt(my_pullpush_fct_3, "ppL", p, d, l); } static uintptr_t my_pullpush_fct_4 = 0; static long my_pullpush_4(void* p, void* d, size_t l) { return (long)RunFunctionFmt(my_pullpush_fct_4, "ppL", p, d, l); }

static void* find_pullpush_Fct(void* fct)
{
    if(!fct) return 
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
                   ((void *)0)
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_pullpush_fct_0 == (uintptr_t)fct) return my_pullpush_0; if(my_pullpush_fct_1 == (uintptr_t)fct) return my_pullpush_1; if(my_pullpush_fct_2 == (uintptr_t)fct) return my_pullpush_2; if(my_pullpush_fct_3 == (uintptr_t)fct) return my_pullpush_3; if(my_pullpush_fct_4 == (uintptr_t)fct) return my_pullpush_4;


    if(my_pullpush_fct_0 == 0) {my_pullpush_fct_0 = (uintptr_t)fct; return my_pullpush_0; } if(my_pullpush_fct_1 == 0) {my_pullpush_fct_1 = (uintptr_t)fct; return my_pullpush_1; } if(my_pullpush_fct_2 == 0) {my_pullpush_fct_2 = (uintptr_t)fct; return my_pullpush_2; } if(my_pullpush_fct_3 == 0) {my_pullpush_fct_3 = (uintptr_t)fct; return my_pullpush_3; } if(my_pullpush_fct_4 == 0) {my_pullpush_fct_4 = (uintptr_t)fct; return my_pullpush_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgnutls.so.30 pullpush callback\n"); fflush(ftrace);}} while(0);
    return 
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
          ((void *)0)
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
              ;
}
# 104 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
static uintptr_t my_pulltimeout_fct_0 = 0; static int my_pulltimeout_0(void* p, uint32_t t) { return (int)RunFunctionFmt(my_pulltimeout_fct_0, "pu", p, t); } static uintptr_t my_pulltimeout_fct_1 = 0; static int my_pulltimeout_1(void* p, uint32_t t) { return (int)RunFunctionFmt(my_pulltimeout_fct_1, "pu", p, t); } static uintptr_t my_pulltimeout_fct_2 = 0; static int my_pulltimeout_2(void* p, uint32_t t) { return (int)RunFunctionFmt(my_pulltimeout_fct_2, "pu", p, t); } static uintptr_t my_pulltimeout_fct_3 = 0; static int my_pulltimeout_3(void* p, uint32_t t) { return (int)RunFunctionFmt(my_pulltimeout_fct_3, "pu", p, t); } static uintptr_t my_pulltimeout_fct_4 = 0; static int my_pulltimeout_4(void* p, uint32_t t) { return (int)RunFunctionFmt(my_pulltimeout_fct_4, "pu", p, t); }

static void* find_pulltimeout_Fct(void* fct)
{
    if(!fct) return 
# 108 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
                   ((void *)0)
# 108 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_pulltimeout_fct_0 == (uintptr_t)fct) return my_pulltimeout_0; if(my_pulltimeout_fct_1 == (uintptr_t)fct) return my_pulltimeout_1; if(my_pulltimeout_fct_2 == (uintptr_t)fct) return my_pulltimeout_2; if(my_pulltimeout_fct_3 == (uintptr_t)fct) return my_pulltimeout_3; if(my_pulltimeout_fct_4 == (uintptr_t)fct) return my_pulltimeout_4;


    if(my_pulltimeout_fct_0 == 0) {my_pulltimeout_fct_0 = (uintptr_t)fct; return my_pulltimeout_0; } if(my_pulltimeout_fct_1 == 0) {my_pulltimeout_fct_1 = (uintptr_t)fct; return my_pulltimeout_1; } if(my_pulltimeout_fct_2 == 0) {my_pulltimeout_fct_2 = (uintptr_t)fct; return my_pulltimeout_2; } if(my_pulltimeout_fct_3 == 0) {my_pulltimeout_fct_3 = (uintptr_t)fct; return my_pulltimeout_3; } if(my_pulltimeout_fct_4 == 0) {my_pulltimeout_fct_4 = (uintptr_t)fct; return my_pulltimeout_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libgnutls.so.30 pulltimeout callback\n"); fflush(ftrace);}} while(0);
    return 
# 118 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 3 4
          ((void *)0)
# 118 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c"
              ;
}



__attribute__((visibility("default"))) void my_gnutls_global_set_log_function(x86emu_t* emu, void* f)
{
    (void)emu;
    my->gnutls_global_set_log_function(find_gnutls_log_Fct(f));
}

__attribute__((visibility("default"))) void my_gnutls_transport_set_pull_function(x86emu_t* emu, void* session, void* f)
{
    (void)emu;
    my->gnutls_transport_set_pull_function(session, find_pullpush_Fct(f));
}
__attribute__((visibility("default"))) void my_gnutls_transport_set_push_function(x86emu_t* emu, void* session, void* f)
{
    (void)emu;
    my->gnutls_transport_set_push_function(session, find_pullpush_Fct(f));
}

__attribute__((visibility("default"))) void my_gnutls_transport_set_pull_timeout_function(x86emu_t* emu, void* session, void* f)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgnutlsdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gnutlssymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_alert_get", pFp, 0},
{"gnutls_alert_get_name", pFp, 0},

{"gnutls_alert_send", iFppp, 0},

{"gnutls_alpn_get_selected_protocol", iFpp, 0},
{"gnutls_alpn_set_protocols", iFppuu, 0},
# 39 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_certificate_allocate_credentials", iFp, 0},




{"gnutls_certificate_free_credentials", vFp, 0},
...
{"gnutls_certificate_get_peers", pFpp, 0},
# 85 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_certificate_set_x509_key", iFppip, 0},
# 105 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_check_version", pFp, 0},

{"gnutls_cipher_add_auth", iFppL, 0},
{"gnutls_cipher_decrypt", iFppL, 0},
{"gnutls_cipher_decrypt2", iFppLpL, 0},
{"gnutls_cipher_deinit", vFp, 0},
{"gnutls_cipher_encrypt", iFppL, 0},
{"gnutls_cipher_encrypt2", iFppLpL, 0},
{"gnutls_cipher_get", pFp, 0},
{"gnutls_cipher_get_block_size", uFp, 0},


{"gnutls_cipher_get_key_size", LFp, 0},


{"gnutls_cipher_init", iFpppp, 0},




{"gnutls_cipher_tag", iFppL, 0},
...
{"gnutls_credentials_set", iFppp, 0},
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_decode_rs_value", iFppp, 0},
...
{"gnutls_dh_params_deinit", vFp, 0},


{"gnutls_dh_params_export_raw", iFpppp, 0},
{"gnutls_dh_params_generate2", iFpu, 0},


{"gnutls_dh_params_import_raw", iFppp, 0},
{"gnutls_dh_params_import_raw2", iFpppu, 0},
{"gnutls_dh_params_init", iFp, 0},
# 180 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_dtls_set_mtu", vFpu, 0},
{"gnutls_dtls_set_timeouts", vFpuu, 0},
...
{"_gnutls_ecdh_compute_key", iFppp, 0},
{"gnutls_ecdh_compute_key", iFppp, 0},
# 202 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_global_deinit", vFv, 0},
{"gnutls_global_init", iFv, 0},


{"gnutls_global_set_log_level", vFi, 0},



{"gnutls_handshake", iFp, 0},
# 247 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_init", iFpu, 0},
...
{"gnutls_mac_get", pFp, 0},

{"gnutls_mac_get_key_size", LFp, 0},
# 394 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_perror", vFi, 0},
# 465 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_pkcs12_deinit", vFp, 0},





{"gnutls_pkcs12_import", iFpppu, 0},
{"gnutls_pkcs12_init", iFp, 0},


{"gnutls_pkcs12_simple_parse", iFppppppppu, 0},

{"gnutls_pkcs12_verify_mac", iFpp, 0},
# 514 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_pk_to_sign", pFpp, 0},
# 529 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_priority_set_direct", iFppp, 0},


{"gnutls_privkey_decrypt_data", iFpupp, 0},
{"gnutls_privkey_deinit", vFp, 0},
{"gnutls_privkey_export_dsa_raw", iFpppppp, 0},
{"gnutls_privkey_export_ecc_raw", iFppppp, 0},


{"gnutls_privkey_export_rsa_raw", iFppppppppp, 0},
{"gnutls_privkey_export_x509", iFpp, 0},
{"gnutls_privkey_generate", iFppuu, 0},




{"gnutls_privkey_import_dsa_raw", iFpppppp, 0},
{"gnutls_privkey_import_ecc_raw", iFppppp, 0},
...
{"gnutls_privkey_import_rsa_raw", iFppppppppp, 0},





{"gnutls_privkey_init", iFp, 0},


{"gnutls_privkey_set_spki", iFppu, 0},

{"gnutls_privkey_sign_hash", iFppupp, 0},





{"gnutls_protocol_get_version", iFp, 0},
# 587 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_pubkey_deinit", vFp, 0},
{"gnutls_pubkey_encrypt_data", iFpupp, 0},


{"gnutls_pubkey_export_dsa_raw", iFppppp, 0},
{"gnutls_pubkey_export_ecc_raw", iFpppp, 0},

{"gnutls_pubkey_export_rsa_raw", iFppp, 0},
...
{"gnutls_pubkey_import_dsa_raw", iFppppp, 0},
{"gnutls_pubkey_import_ecc_raw", iFpppp, 0},




{"gnutls_pubkey_import_privkey", iFppuu, 0},
{"gnutls_pubkey_import_rsa_raw", iFppp, 0},
...
{"gnutls_pubkey_init", iFp, 0},



{"gnutls_pubkey_set_spki", iFppu, 0},

{"gnutls_pubkey_verify_hash2", iFppupp, 0},
# 633 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_record_get_max_size", LFp, 0},


{"gnutls_record_recv", lFppL, 0},


{"gnutls_record_send", lFppL, 0},
# 657 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_server_name_set", iFpppL, 0},

{"gnutls_session_channel_binding", iFppp, 0},
# 688 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_set_default_priority", iFp, 0},
# 725 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_strerror", pFi, 0},
# 752 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_transport_get_ptr", pFp, 0},

{"gnutls_transport_set_errno", vFpi, 0},



{"gnutls_transport_set_ptr", vFpp, 0},




# 888 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_x509_crt_deinit", vFp, 0},


{"gnutls_x509_crt_export", iFpppp, 0},
# 950 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_x509_crt_import", iFppp, 0},


{"gnutls_x509_crt_init", iFp, 0},
# 1060 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_x509_privkey_deinit", vFp, 0},
...
{"gnutls_x509_privkey_export_rsa_raw2", iFppppppppp, 0},





{"gnutls_x509_privkey_get_pk_algorithm2", iFpp, 0},
...
{"gnutls_x509_privkey_import_pkcs8", iFppipu, 0},
{"gnutls_x509_privkey_import_rsa_raw", iFp, 0},

{"gnutls_x509_privkey_init", iFp, 0},
# 1096 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
{"gnutls_x509_spki_deinit", vFp, 0},
{"gnutls_x509_spki_init", vFp, 0},
{"gnutls_x509_spki_set_rsa_pss_params", vFppu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gnutlsmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
{"gnutls_global_set_log_function", vFEp, 0},
...
{"gnutls_transport_set_pull_function", vFEpp, 0},
{"gnutls_transport_set_pull_timeout_function", vFEpp, 0},
{"gnutls_transport_set_push_function", vFEpp, 0},
# 888 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
static const map_onesymbol_t gnutlsstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
static const map_onesymbol2_t gnutlssymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
static const map_onedata_t gnutlsdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
static const map_onedata_t gnutlsmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgnutlsundefs.h" 1
...
int wrappedgnutls_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gnutlsName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gnutlssymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gnutlssymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gnutlssymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gnutlssymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gnutlssymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gnutlssymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gnutlssymbolmap[i].name, '@')) AddDictionnary(box86->versym, gnutlssymbolmap[i].name); }
 cnt = sizeof(gnutlsmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gnutlsmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gnutlsmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gnutlsmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gnutlsmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gnutlsmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gnutlsmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gnutlsmysymbolmap[i].name); }

    cnt = sizeof(gnutlsstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gnutlsstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gnutlsstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gnutlsstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gnutlsstsymbolmap[i].name);
    }
    cnt = sizeof(gnutlssymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gnutlssymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gnutlssymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gnutlssymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gnutlssymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gnutlssymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gnutlssymbol2map[i].name);
    }
    cnt = sizeof(gnutlsdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gnutlsdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gnutlsdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gnutlsdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gnutlsdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gnutlsdatamap[i].sz;
        }
    }
    cnt = sizeof(gnutlsmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gnutlsmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gnutlsmydatamap[i].sz;
    }
...
void wrappedgnutls_fini(library_t* lib)
{
...
# 153 "/home/ssd/pico/code/box86/src/wrapped/wrappedgnutls.c" 2
