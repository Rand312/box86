# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedayatanaappindicator3defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ayatanaappindicator3symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1




{"app_indicator_build_menu_from_desktop", vFppp, 0},
{"app_indicator_category_get_type", pFv, 0},
{"app_indicator_get_attention_icon", pFp, 0},
{"app_indicator_get_attention_icon_desc", pFp, 0},
{"app_indicator_get_category", iFp, 0},
{"app_indicator_get_icon", pFp, 0},
{"app_indicator_get_icon_desc", pFp, 0},
{"app_indicator_get_icon_theme_path", pFp, 0},
{"app_indicator_get_id", pFp, 0},
{"app_indicator_get_label", pFp, 0},
{"app_indicator_get_label_guide", pFp, 0},
{"app_indicator_get_menu", pFp, 0},
{"app_indicator_get_ordering_index", uFp, 0},
{"app_indicator_get_secondary_activate_target", pFp, 0},
{"app_indicator_get_status", iFp, 0},
{"app_indicator_get_title", pFp, 0},
{"app_indicator_get_type", iFv, 0},
{"app_indicator_new", pFppi, 0},
{"app_indicator_new_with_path", pFppip, 0},
{"app_indicator_set_attention_icon", vFpp, 0},
{"app_indicator_set_attention_icon_full", vFppp, 0},
{"app_indicator_set_icon", vFpp, 0},
{"app_indicator_set_icon_full", vFppp, 0},
{"app_indicator_set_icon_theme_path", vFpp, 0},
{"app_indicator_set_label", vFppp, 0},
{"app_indicator_set_menu", vFpp, 0},
{"app_indicator_set_ordering_index", vFpu, 0},
{"app_indicator_set_secondary_activate_target", vFpp, 0},
{"app_indicator_set_status", vFpi, 0},
{"app_indicator_set_title", vFpp, 0},
{"app_indicator_status_get_type", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ayatanaappindicator3mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1
...
static const map_onesymbol_t ayatanaappindicator3stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1
...
static const map_onesymbol2_t ayatanaappindicator3symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1
...
static const map_onedata_t ayatanaappindicator3datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1
...
static const map_onedata_t ayatanaappindicator3mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedayatanaappindicator3undefs.h" 1
...
int wrappedayatanaappindicator3_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(ayatanaappindicator3Name, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(ayatanaappindicator3Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(ayatanaappindicator3symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ayatanaappindicator3symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, ayatanaappindicator3symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = ayatanaappindicator3symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, ayatanaappindicator3symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = ayatanaappindicator3symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(ayatanaappindicator3symbolmap[i].name, '@')) AddDictionnary(box86->versym, ayatanaappindicator3symbolmap[i].name); }
 cnt = sizeof(ayatanaappindicator3mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ayatanaappindicator3mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, ayatanaappindicator3mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = ayatanaappindicator3mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, ayatanaappindicator3mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = ayatanaappindicator3mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(ayatanaappindicator3mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, ayatanaappindicator3mysymbolmap[i].name); }

    cnt = sizeof(ayatanaappindicator3stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, ayatanaappindicator3stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = ayatanaappindicator3stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(ayatanaappindicator3stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, ayatanaappindicator3stsymbolmap[i].name);
    }
    cnt = sizeof(ayatanaappindicator3symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, ayatanaappindicator3symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = ayatanaappindicator3symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = ayatanaappindicator3symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = ayatanaappindicator3symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(ayatanaappindicator3symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, ayatanaappindicator3symbol2map[i].name);
    }
    cnt = sizeof(ayatanaappindicator3datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(ayatanaappindicator3datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, ayatanaappindicator3datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = ayatanaappindicator3datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, ayatanaappindicator3datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = ayatanaappindicator3datamap[i].sz;
        }
    }
    cnt = sizeof(ayatanaappindicator3mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, ayatanaappindicator3mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = ayatanaappindicator3mydatamap[i].sz;
    }
...
void wrappedayatanaappindicator3_fini(library_t* lib)
{
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedayatanaappindicator3.c" 2
