# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2

const char* udev1Name = "libudev.so.1";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev1types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev1types.h"
typedef void (*vFpp_t)(void*, void*);
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static udev1_my_t my_udev1 = {0};
static udev1_my_t * const my = &my_udev1;

static void getMy(library_t* lib)
{

    my->udev_set_log_fn = (vFpp_t)dlsym(lib->w.lib, "udev_set_log_fn");
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c"
static uintptr_t my_log_fn_fct_0 = 0; static void my_log_fn_0(void* a, int b, void* c, int d, void* e, void* f, void* va) { RunFunctionFmt(my_log_fn_fct_0, "pipippp", a, b, c, d, e, f, va); } static uintptr_t my_log_fn_fct_1 = 0; static void my_log_fn_1(void* a, int b, void* c, int d, void* e, void* f, void* va) { RunFunctionFmt(my_log_fn_fct_1, "pipippp", a, b, c, d, e, f, va); } static uintptr_t my_log_fn_fct_2 = 0; static void my_log_fn_2(void* a, int b, void* c, int d, void* e, void* f, void* va) { RunFunctionFmt(my_log_fn_fct_2, "pipippp", a, b, c, d, e, f, va); } static uintptr_t my_log_fn_fct_3 = 0; static void my_log_fn_3(void* a, int b, void* c, int d, void* e, void* f, void* va) { RunFunctionFmt(my_log_fn_fct_3, "pipippp", a, b, c, d, e, f, va); } static uintptr_t my_log_fn_fct_4 = 0; static void my_log_fn_4(void* a, int b, void* c, int d, void* e, void* f, void* va) { RunFunctionFmt(my_log_fn_fct_4, "pipippp", a, b, c, d, e, f, va); }
...
static void* find_log_fn_Fct(void* fct)
{
    ...
    if(my_log_fn_fct_0 == (uintptr_t)fct) return my_log_fn_0; if(my_log_fn_fct_1 == (uintptr_t)fct) return my_log_fn_1; if(my_log_fn_fct_2 == (uintptr_t)fct) return my_log_fn_2; if(my_log_fn_fct_3 == (uintptr_t)fct) return my_log_fn_3; if(my_log_fn_fct_4 == (uintptr_t)fct) return my_log_fn_4;


    if(my_log_fn_fct_0 == 0) {my_log_fn_fct_0 = (uintptr_t)fct; return my_log_fn_0; } if(my_log_fn_fct_1 == 0) {my_log_fn_fct_1 = (uintptr_t)fct; return my_log_fn_1; } if(my_log_fn_fct_2 == 0) {my_log_fn_fct_2 = (uintptr_t)fct; return my_log_fn_2; } if(my_log_fn_fct_3 == 0) {my_log_fn_fct_3 = (uintptr_t)fct; return my_log_fn_3; } if(my_log_fn_fct_4 == 0) {my_log_fn_fct_4 = (uintptr_t)fct; return my_log_fn_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for udev1 log_fn callback\n"); fflush(ftrace);}} while(0);
    return 
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 3 4
          ((void *)0)
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c"
              ;
}



__attribute__((visibility("default"))) void my_udev_set_log_fn(x86emu_t* emu, void* udev, void* f)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev1defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t udev1symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1_private.h" 1




{"udev_device_ref", pFp, 0},
{"udev_device_unref", pFp, 0},
{"udev_device_get_udev", pFp, 0},
{"udev_device_new_from_syspath", pFpp, 0},
{"udev_device_new_from_devnum", pFpCu, 0},
{"udev_device_new_from_subsystem_sysname", pFppp, 0},
{"udev_device_new_from_environment", pFp, 0},
{"udev_device_get_parent", pFp, 0},
{"udev_device_get_parent_with_subsystem_devtype", pFppp, 0},
{"udev_device_get_devpath", pFp, 0},
{"udev_device_get_subsystem", pFp, 0},
{"udev_device_get_devtype", pFp, 0},
{"udev_device_get_syspath", pFp, 0},
{"udev_device_get_sysname", pFp, 0},
{"udev_device_get_sysnum", pFp, 0},
{"udev_device_get_devnode", pFp, 0},
{"udev_device_get_is_initialized", iFp, 0},
{"udev_device_get_devlinks_list_entry", pFp, 0},
{"udev_device_get_properties_list_entry", pFp, 0},
{"udev_device_get_tags_list_entry", pFp, 0},
{"udev_device_get_property_value", pFpp, 0},
{"udev_device_get_driver", pFp, 0},
{"udev_device_get_devnum", uFp, 0},
{"udev_device_get_action", pFp, 0},
{"udev_device_get_sysattr_value", pFpp, 0},
{"udev_device_get_sysattr_list_entry", pFp, 0},
{"udev_device_get_seqnum", UFp, 0},
{"udev_device_get_usec_since_initialized", UFp, 0},
{"udev_device_has_tag", iFpp, 0},
{"udev_enumerate_ref", pFp, 0},
{"udev_enumerate_unref", pFp, 0},
{"udev_enumerate_get_udev", pFp, 0},
{"udev_enumerate_new", pFp, 0},
{"udev_enumerate_add_match_subsystem", iFpp, 0},
{"udev_enumerate_add_nomatch_subsystem", iFpp, 0},
{"udev_enumerate_add_match_sysattr", iFppp, 0},
{"udev_enumerate_add_nomatch_sysattr", iFppp, 0},
{"udev_enumerate_add_match_property", iFppp, 0},
{"udev_enumerate_add_match_tag", iFpp, 0},
{"udev_enumerate_add_match_parent", iFpp, 0},
{"udev_enumerate_add_match_is_initialized", iFp, 0},
{"udev_enumerate_add_match_sysname", iFpp, 0},
{"udev_enumerate_add_syspath", iFpp, 0},
{"udev_enumerate_scan_devices", iFp, 0},
{"udev_enumerate_scan_subsystems", iFp, 0},
{"udev_enumerate_get_list_entry", pFp, 0},
{"udev_get_log_priority", iFp, 0},
{"udev_get_sys_path", pFp, 0},
{"udev_get_dev_path", pFp, 0},
{"udev_get_run_path", pFp, 0},
{"udev_get_userdata", pFp, 0},
{"udev_list_entry_get_next", pFp, 0},
{"udev_list_entry_get_by_name", pFpp, 0},
{"udev_list_entry_get_name", pFp, 0},
{"udev_list_entry_get_value", pFp, 0},
{"udev_monitor_ref", pFp, 0},
{"udev_monitor_unref", pFp, 0},
{"udev_monitor_get_udev", pFp, 0},
{"udev_monitor_new_from_netlink", pFpp, 0},
{"udev_monitor_enable_receiving", iFp, 0},
{"udev_monitor_set_receive_buffer_size", iFpi, 0},
{"udev_monitor_get_fd", iFp, 0},
{"udev_monitor_receive_device", pFp, 0},
{"udev_monitor_filter_add_match_subsystem_devtype", iFppp, 0},
{"udev_monitor_filter_add_match_tag", iFpp, 0},
{"udev_monitor_filter_update", iFp, 0},
{"udev_monitor_filter_remove", iFp, 0},
{"udev_new", pFv, 0},
{"udev_ref", pFp, 0},
{"udev_unref", pFp, 0},
{"udev_queue_ref", pFp, 0},
{"udev_queue_unref", vFp, 0},
{"udev_queue_get_udev", pFp, 0},
{"udev_queue_new", pFp, 0},
{"udev_queue_get_kernel_seqnum", UFp, 0},
{"udev_queue_get_udev_seqnum", UFp, 0},
{"udev_queue_get_udev_is_active", iFp, 0},
{"udev_queue_get_queue_is_empty", iFp, 0},
{"udev_queue_get_seqnum_is_finished", iFpU, 0},
{"udev_queue_get_seqnum_sequence_is_finished", iFpUU, 0},
{"udev_queue_get_queued_list_entry", pFp, 0},

{"udev_set_log_priority", vFpi, 0},
{"udev_set_userdata", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t udev1mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1_private.h" 1
...
static const map_onesymbol2_t udev1symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1_private.h" 1
...
static const map_onedata_t udev1datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1_private.h" 1
...
static const map_onedata_t udev1mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev1undefs.h" 1
...
int wrappedudev1_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(udev1Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(udev1symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (udev1symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, udev1symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = udev1symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, udev1symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = udev1symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(udev1symbolmap[i].name, '@')) AddDictionnary(box86->versym, udev1symbolmap[i].name); }
 cnt = sizeof(udev1mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (udev1mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, udev1mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = udev1mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, udev1mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = udev1mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(udev1mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, udev1mysymbolmap[i].name); }

    cnt = sizeof(udev1stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, udev1stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = udev1stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(udev1stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, udev1stsymbolmap[i].name);
    }
    cnt = sizeof(udev1symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, udev1symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = udev1symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = udev1symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = udev1symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(udev1symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, udev1symbol2map[i].name);
    }
    cnt = sizeof(udev1datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(udev1datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, udev1datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = udev1datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, udev1datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = udev1datamap[i].sz;
        }
    }
    cnt = sizeof(udev1mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, udev1mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = udev1mydatamap[i].sz;
    }
...
void wrappedudev1_fini(library_t* lib)
{
...
# 75 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev1.c" 2
