# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
# 46 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstreamertypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstreamertypes.h"
...
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
...
typedef struct gstreamer_my_s {
    ...
    LFv_t gst_object_get_type; LFv_t gst_allocator_get_type; pFp_t gst_structure_new_empty; pFppp_t gst_structure_new_valist; pFv_t gst_caps_new_empty; iFpp_t gst_caps_replace; vFpp_t gst_caps_append_structure; vFppp_t gst_caps_set_simple_valist; vFppV_t gst_caps_set_simple; vFppV_t gst_structure_remove_fields; iFppp_t gst_caps_foreach; iFppp_t gst_structure_get_valist; iFppV_t gst_structure_get; pFppV_t gst_caps_new_simple; pFppV_t gst_structure_new; vFpppp_t gst_bus_set_sync_handler; vFpppp_t gst_mini_object_set_qdata; vFpppp_t gst_pad_set_activatemode_function_full; vFpppp_t gst_pad_set_chain_function_full; vFpppp_t gst_pad_set_event_function_full; vFpppp_t gst_pad_set_getrange_function_full; vFpppp_t gst_pad_set_query_function_full; pFppip_t gst_registry_feature_filter; pFiplllpp_t gst_buffer_new_wrapped_full; vFpippippV_t gst_debug_log;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static gstreamer_my_t my_gstreamer = {0};
static gstreamer_my_t * const my = &my_gstreamer;

static void getMy(library_t* lib)
{

    my->gst_object_get_type = (LFv_t)dlsym(lib->w.lib, "gst_object_get_type"); my->gst_allocator_get_type = (LFv_t)dlsym(lib->w.lib, "gst_allocator_get_type"); my->gst_structure_new_empty = (pFp_t)dlsym(lib->w.lib, "gst_structure_new_empty"); my->gst_structure_new_valist = (pFppp_t)dlsym(lib->w.lib, "gst_structure_new_valist"); my->gst_caps_new_empty = (pFv_t)dlsym(lib->w.lib, "gst_caps_new_empty"); my->gst_caps_replace = (iFpp_t)dlsym(lib->w.lib, "gst_caps_replace"); my->gst_caps_append_structure = (vFpp_t)dlsym(lib->w.lib, "gst_caps_append_structure"); my->gst_caps_set_simple_valist = (vFppp_t)dlsym(lib->w.lib, "gst_caps_set_simple_valist"); my->gst_caps_set_simple = (vFppV_t)dlsym(lib->w.lib, "gst_caps_set_simple"); my->gst_structure_remove_fields = (vFppV_t)dlsym(lib->w.lib, "gst_structure_remove_fields"); my->gst_caps_foreach = (iFppp_t)dlsym(lib->w.lib, "gst_caps_foreach"); my->gst_structure_get_valist = (iFppp_t)dlsym(lib->w.lib, "gst_structure_get_valist"); my->gst_structure_get = (iFppV_t)dlsym(lib->w.lib, "gst_structure_get"); my->gst_caps_new_simple = (pFppV_t)dlsym(lib->w.lib, "gst_caps_new_simple"); my->gst_structure_new = (pFppV_t)dlsym(lib->w.lib, "gst_structure_new"); my->gst_bus_set_sync_handler = (vFpppp_t)dlsym(lib->w.lib, "gst_bus_set_sync_handler"); my->gst_mini_object_set_qdata = (vFpppp_t)dlsym(lib->w.lib, "gst_mini_object_set_qdata"); my->gst_pad_set_activatemode_function_full = (vFpppp_t)dlsym(lib->w.lib, "gst_pad_set_activatemode_function_full"); my->gst_pad_set_chain_function_full = (vFpppp_t)dlsym(lib->w.lib, "gst_pad_set_chain_function_full"); my->gst_pad_set_event_function_full = (vFpppp_t)dlsym(lib->w.lib, "gst_pad_set_event_function_full"); my->gst_pad_set_getrange_function_full = (vFpppp_t)dlsym(lib->w.lib, "gst_pad_set_getrange_function_full"); my->gst_pad_set_query_function_full = (vFpppp_t)dlsym(lib->w.lib, "gst_pad_set_query_function_full"); my->gst_registry_feature_filter = (pFppip_t)dlsym(lib->w.lib, "gst_registry_feature_filter"); my->gst_buffer_new_wrapped_full = (pFiplllpp_t)dlsym(lib->w.lib, "gst_buffer_new_wrapped_full"); my->gst_debug_log = (vFpippippV_t)dlsym(lib->w.lib, "gst_debug_log");
...
static void* findDestroyFct(void* fct)
{
    ...
    if(my_destroyfunc_fct_0 == (uintptr_t)fct) return my_destroyfunc_0; if(my_destroyfunc_fct_1 == (uintptr_t)fct) return my_destroyfunc_1; if(my_destroyfunc_fct_2 == (uintptr_t)fct) return my_destroyfunc_2; if(my_destroyfunc_fct_3 == (uintptr_t)fct) return my_destroyfunc_3;


    if(my_destroyfunc_fct_0 == 0) {my_destroyfunc_fct_0 = (uintptr_t)fct; return my_destroyfunc_0; } if(my_destroyfunc_fct_1 == 0) {my_destroyfunc_fct_1 = (uintptr_t)fct; return my_destroyfunc_1; } if(my_destroyfunc_fct_2 == 0) {my_destroyfunc_fct_2 = (uintptr_t)fct; return my_destroyfunc_2; } if(my_destroyfunc_fct_3 == 0) {my_destroyfunc_fct_3 = (uintptr_t)fct; return my_destroyfunc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GDestroyNotify callback\n"); fflush(ftrace);}} while(0);
    return 
# 78 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 78 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstPadActivateModeFunction_fct_0 = 0; static int my_GstPadActivateModeFunction_0(void* a, void* b, int c, int d) { return (int)RunFunctionFmt(my_GstPadActivateModeFunction_fct_0, "ppii", a, b, c, d); } static uintptr_t my_GstPadActivateModeFunction_fct_1 = 0; static int my_GstPadActivateModeFunction_1(void* a, void* b, int c, int d) { return (int)RunFunctionFmt(my_GstPadActivateModeFunction_fct_1, "ppii", a, b, c, d); } static uintptr_t my_GstPadActivateModeFunction_fct_2 = 0; static int my_GstPadActivateModeFunction_2(void* a, void* b, int c, int d) { return (int)RunFunctionFmt(my_GstPadActivateModeFunction_fct_2, "ppii", a, b, c, d); } static uintptr_t my_GstPadActivateModeFunction_fct_3 = 0; static int my_GstPadActivateModeFunction_3(void* a, void* b, int c, int d) { return (int)RunFunctionFmt(my_GstPadActivateModeFunction_fct_3, "ppii", a, b, c, d); }
...
static void* findGstPadActivateModeFunctionFct(void* fct)
{
    ...
    if(my_GstPadActivateModeFunction_fct_0 == (uintptr_t)fct) return my_GstPadActivateModeFunction_0; if(my_GstPadActivateModeFunction_fct_1 == (uintptr_t)fct) return my_GstPadActivateModeFunction_1; if(my_GstPadActivateModeFunction_fct_2 == (uintptr_t)fct) return my_GstPadActivateModeFunction_2; if(my_GstPadActivateModeFunction_fct_3 == (uintptr_t)fct) return my_GstPadActivateModeFunction_3;


    if(my_GstPadActivateModeFunction_fct_0 == 0) {my_GstPadActivateModeFunction_fct_0 = (uintptr_t)fct; return my_GstPadActivateModeFunction_0; } if(my_GstPadActivateModeFunction_fct_1 == 0) {my_GstPadActivateModeFunction_fct_1 = (uintptr_t)fct; return my_GstPadActivateModeFunction_1; } if(my_GstPadActivateModeFunction_fct_2 == 0) {my_GstPadActivateModeFunction_fct_2 = (uintptr_t)fct; return my_GstPadActivateModeFunction_2; } if(my_GstPadActivateModeFunction_fct_3 == 0) {my_GstPadActivateModeFunction_fct_3 = (uintptr_t)fct; return my_GstPadActivateModeFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPadActivateModeFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 101 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 101 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstPadQueryFunction_fct_0 = 0; static int my_GstPadQueryFunction_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadQueryFunction_fct_0, "ppp", a, b, c); } static uintptr_t my_GstPadQueryFunction_fct_1 = 0; static int my_GstPadQueryFunction_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadQueryFunction_fct_1, "ppp", a, b, c); } static uintptr_t my_GstPadQueryFunction_fct_2 = 0; static int my_GstPadQueryFunction_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadQueryFunction_fct_2, "ppp", a, b, c); } static uintptr_t my_GstPadQueryFunction_fct_3 = 0; static int my_GstPadQueryFunction_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadQueryFunction_fct_3, "ppp", a, b, c); }
...
static void* findGstPadQueryFunctionFct(void* fct)
{
    ...
    if(my_GstPadQueryFunction_fct_0 == (uintptr_t)fct) return my_GstPadQueryFunction_0; if(my_GstPadQueryFunction_fct_1 == (uintptr_t)fct) return my_GstPadQueryFunction_1; if(my_GstPadQueryFunction_fct_2 == (uintptr_t)fct) return my_GstPadQueryFunction_2; if(my_GstPadQueryFunction_fct_3 == (uintptr_t)fct) return my_GstPadQueryFunction_3;


    if(my_GstPadQueryFunction_fct_0 == 0) {my_GstPadQueryFunction_fct_0 = (uintptr_t)fct; return my_GstPadQueryFunction_0; } if(my_GstPadQueryFunction_fct_1 == 0) {my_GstPadQueryFunction_fct_1 = (uintptr_t)fct; return my_GstPadQueryFunction_1; } if(my_GstPadQueryFunction_fct_2 == 0) {my_GstPadQueryFunction_fct_2 = (uintptr_t)fct; return my_GstPadQueryFunction_2; } if(my_GstPadQueryFunction_fct_3 == 0) {my_GstPadQueryFunction_fct_3 = (uintptr_t)fct; return my_GstPadQueryFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPadQueryFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 124 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 124 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstPadGetRangeFunction_fct_0 = 0; static int my_GstPadGetRangeFunction_0(void* a, void* b, uint64_t c, uint32_t d, void* e) { return (int)RunFunctionFmt(my_GstPadGetRangeFunction_fct_0, "ppUup", a, b, c, d, e); } static uintptr_t my_GstPadGetRangeFunction_fct_1 = 0; static int my_GstPadGetRangeFunction_1(void* a, void* b, uint64_t c, uint32_t d, void* e) { return (int)RunFunctionFmt(my_GstPadGetRangeFunction_fct_1, "ppUup", a, b, c, d, e); } static uintptr_t my_GstPadGetRangeFunction_fct_2 = 0; static int my_GstPadGetRangeFunction_2(void* a, void* b, uint64_t c, uint32_t d, void* e) { return (int)RunFunctionFmt(my_GstPadGetRangeFunction_fct_2, "ppUup", a, b, c, d, e); } static uintptr_t my_GstPadGetRangeFunction_fct_3 = 0; static int my_GstPadGetRangeFunction_3(void* a, void* b, uint64_t c, uint32_t d, void* e) { return (int)RunFunctionFmt(my_GstPadGetRangeFunction_fct_3, "ppUup", a, b, c, d, e); }
...
static void* findGstPadGetRangeFunctionFct(void* fct)
{
    ...
    if(my_GstPadGetRangeFunction_fct_0 == (uintptr_t)fct) return my_GstPadGetRangeFunction_0; if(my_GstPadGetRangeFunction_fct_1 == (uintptr_t)fct) return my_GstPadGetRangeFunction_1; if(my_GstPadGetRangeFunction_fct_2 == (uintptr_t)fct) return my_GstPadGetRangeFunction_2; if(my_GstPadGetRangeFunction_fct_3 == (uintptr_t)fct) return my_GstPadGetRangeFunction_3;


    if(my_GstPadGetRangeFunction_fct_0 == 0) {my_GstPadGetRangeFunction_fct_0 = (uintptr_t)fct; return my_GstPadGetRangeFunction_0; } if(my_GstPadGetRangeFunction_fct_1 == 0) {my_GstPadGetRangeFunction_fct_1 = (uintptr_t)fct; return my_GstPadGetRangeFunction_1; } if(my_GstPadGetRangeFunction_fct_2 == 0) {my_GstPadGetRangeFunction_fct_2 = (uintptr_t)fct; return my_GstPadGetRangeFunction_2; } if(my_GstPadGetRangeFunction_fct_3 == 0) {my_GstPadGetRangeFunction_fct_3 = (uintptr_t)fct; return my_GstPadGetRangeFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPadGetRangeFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstPadChainFunction_fct_0 = 0; static int my_GstPadChainFunction_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadChainFunction_fct_0, "ppp", a, b, c); } static uintptr_t my_GstPadChainFunction_fct_1 = 0; static int my_GstPadChainFunction_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadChainFunction_fct_1, "ppp", a, b, c); } static uintptr_t my_GstPadChainFunction_fct_2 = 0; static int my_GstPadChainFunction_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadChainFunction_fct_2, "ppp", a, b, c); } static uintptr_t my_GstPadChainFunction_fct_3 = 0; static int my_GstPadChainFunction_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadChainFunction_fct_3, "ppp", a, b, c); }
...
static void* findGstPadChainFunctionFct(void* fct)
{
    ...
    if(my_GstPadChainFunction_fct_0 == (uintptr_t)fct) return my_GstPadChainFunction_0; if(my_GstPadChainFunction_fct_1 == (uintptr_t)fct) return my_GstPadChainFunction_1; if(my_GstPadChainFunction_fct_2 == (uintptr_t)fct) return my_GstPadChainFunction_2; if(my_GstPadChainFunction_fct_3 == (uintptr_t)fct) return my_GstPadChainFunction_3;


    if(my_GstPadChainFunction_fct_0 == 0) {my_GstPadChainFunction_fct_0 = (uintptr_t)fct; return my_GstPadChainFunction_0; } if(my_GstPadChainFunction_fct_1 == 0) {my_GstPadChainFunction_fct_1 = (uintptr_t)fct; return my_GstPadChainFunction_1; } if(my_GstPadChainFunction_fct_2 == 0) {my_GstPadChainFunction_fct_2 = (uintptr_t)fct; return my_GstPadChainFunction_2; } if(my_GstPadChainFunction_fct_3 == 0) {my_GstPadChainFunction_fct_3 = (uintptr_t)fct; return my_GstPadChainFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPadChainFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 170 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 170 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstPadEventFunction_fct_0 = 0; static int my_GstPadEventFunction_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadEventFunction_fct_0, "ppp", a, b, c); } static uintptr_t my_GstPadEventFunction_fct_1 = 0; static int my_GstPadEventFunction_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadEventFunction_fct_1, "ppp", a, b, c); } static uintptr_t my_GstPadEventFunction_fct_2 = 0; static int my_GstPadEventFunction_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadEventFunction_fct_2, "ppp", a, b, c); } static uintptr_t my_GstPadEventFunction_fct_3 = 0; static int my_GstPadEventFunction_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstPadEventFunction_fct_3, "ppp", a, b, c); }

static void* findGstPadEventFunctionFct(void* fct)
{
    if(!fct) return fct;

    if(my_GstPadEventFunction_fct_0 == (uintptr_t)fct) return my_GstPadEventFunction_0; if(my_GstPadEventFunction_fct_1 == (uintptr_t)fct) return my_GstPadEventFunction_1; if(my_GstPadEventFunction_fct_2 == (uintptr_t)fct) return my_GstPadEventFunction_2; if(my_GstPadEventFunction_fct_3 == (uintptr_t)fct) return my_GstPadEventFunction_3;


    if(my_GstPadEventFunction_fct_0 == 0) {my_GstPadEventFunction_fct_0 = (uintptr_t)fct; return my_GstPadEventFunction_0; } if(my_GstPadEventFunction_fct_1 == 0) {my_GstPadEventFunction_fct_1 = (uintptr_t)fct; return my_GstPadEventFunction_1; } if(my_GstPadEventFunction_fct_2 == 0) {my_GstPadEventFunction_fct_2 = (uintptr_t)fct; return my_GstPadEventFunction_2; } if(my_GstPadEventFunction_fct_3 == 0) {my_GstPadEventFunction_fct_3 = (uintptr_t)fct; return my_GstPadEventFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPadEventFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 191 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 191 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
...
static uintptr_t my_GstBusSyncHandler_fct_0 = 0; static int my_GstBusSyncHandler_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstBusSyncHandler_fct_0, "ppp", a, b, c); } static uintptr_t my_GstBusSyncHandler_fct_1 = 0; static int my_GstBusSyncHandler_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstBusSyncHandler_fct_1, "ppp", a, b, c); } static uintptr_t my_GstBusSyncHandler_fct_2 = 0; static int my_GstBusSyncHandler_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstBusSyncHandler_fct_2, "ppp", a, b, c); } static uintptr_t my_GstBusSyncHandler_fct_3 = 0; static int my_GstBusSyncHandler_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstBusSyncHandler_fct_3, "ppp", a, b, c); }

static void* findGstBusSyncHandlerFct(void* fct)
{
    if(!fct) return fct;

    if(my_GstBusSyncHandler_fct_0 == (uintptr_t)fct) return my_GstBusSyncHandler_0; if(my_GstBusSyncHandler_fct_1 == (uintptr_t)fct) return my_GstBusSyncHandler_1; if(my_GstBusSyncHandler_fct_2 == (uintptr_t)fct) return my_GstBusSyncHandler_2; if(my_GstBusSyncHandler_fct_3 == (uintptr_t)fct) return my_GstBusSyncHandler_3;


    if(my_GstBusSyncHandler_fct_0 == 0) {my_GstBusSyncHandler_fct_0 = (uintptr_t)fct; return my_GstBusSyncHandler_0; } if(my_GstBusSyncHandler_fct_1 == 0) {my_GstBusSyncHandler_fct_1 = (uintptr_t)fct; return my_GstBusSyncHandler_1; } if(my_GstBusSyncHandler_fct_2 == 0) {my_GstBusSyncHandler_fct_2 = (uintptr_t)fct; return my_GstBusSyncHandler_2; } if(my_GstBusSyncHandler_fct_3 == 0) {my_GstBusSyncHandler_fct_3 = (uintptr_t)fct; return my_GstBusSyncHandler_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstBusSyncHandler callback\n"); fflush(ftrace);}} while(0);
    return 
# 212 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 212 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
# 222 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
static uintptr_t my_GstPluginFeatureFilter_fct_0 = 0; static int my_GstPluginFeatureFilter_0(void* a, void* b) { return (int)RunFunctionFmt(my_GstPluginFeatureFilter_fct_0, "pp", a, b); } static uintptr_t my_GstPluginFeatureFilter_fct_1 = 0; static int my_GstPluginFeatureFilter_1(void* a, void* b) { return (int)RunFunctionFmt(my_GstPluginFeatureFilter_fct_1, "pp", a, b); } static uintptr_t my_GstPluginFeatureFilter_fct_2 = 0; static int my_GstPluginFeatureFilter_2(void* a, void* b) { return (int)RunFunctionFmt(my_GstPluginFeatureFilter_fct_2, "pp", a, b); } static uintptr_t my_GstPluginFeatureFilter_fct_3 = 0; static int my_GstPluginFeatureFilter_3(void* a, void* b) { return (int)RunFunctionFmt(my_GstPluginFeatureFilter_fct_3, "pp", a, b); }

static void* findGstPluginFeatureFilterFct(void* fct)
{
    if(!fct) return fct;

    if(my_GstPluginFeatureFilter_fct_0 == (uintptr_t)fct) return my_GstPluginFeatureFilter_0; if(my_GstPluginFeatureFilter_fct_1 == (uintptr_t)fct) return my_GstPluginFeatureFilter_1; if(my_GstPluginFeatureFilter_fct_2 == (uintptr_t)fct) return my_GstPluginFeatureFilter_2; if(my_GstPluginFeatureFilter_fct_3 == (uintptr_t)fct) return my_GstPluginFeatureFilter_3;


    if(my_GstPluginFeatureFilter_fct_0 == 0) {my_GstPluginFeatureFilter_fct_0 = (uintptr_t)fct; return my_GstPluginFeatureFilter_0; } if(my_GstPluginFeatureFilter_fct_1 == 0) {my_GstPluginFeatureFilter_fct_1 = (uintptr_t)fct; return my_GstPluginFeatureFilter_1; } if(my_GstPluginFeatureFilter_fct_2 == 0) {my_GstPluginFeatureFilter_fct_2 = (uintptr_t)fct; return my_GstPluginFeatureFilter_2; } if(my_GstPluginFeatureFilter_fct_3 == 0) {my_GstPluginFeatureFilter_fct_3 = (uintptr_t)fct; return my_GstPluginFeatureFilter_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstPluginFeatureFilter callback\n"); fflush(ftrace);}} while(0);
    return 
# 234 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 234 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
static uintptr_t my_GstCapsFilterMapFunc_fct_0 = 0; static int my_GstCapsFilterMapFunc_0(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstCapsFilterMapFunc_fct_0, "ppp", a, b, c);} static uintptr_t my_GstCapsFilterMapFunc_fct_1 = 0; static int my_GstCapsFilterMapFunc_1(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstCapsFilterMapFunc_fct_1, "ppp", a, b, c);} static uintptr_t my_GstCapsFilterMapFunc_fct_2 = 0; static int my_GstCapsFilterMapFunc_2(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstCapsFilterMapFunc_fct_2, "ppp", a, b, c);} static uintptr_t my_GstCapsFilterMapFunc_fct_3 = 0; static int my_GstCapsFilterMapFunc_3(void* a, void* b, void* c) { return (int)RunFunctionFmt(my_GstCapsFilterMapFunc_fct_3, "ppp", a, b, c);}

static void* findGstCapsFilterMapFuncFct(void* fct)
{
    if(!fct) return fct;

    if(my_GstCapsFilterMapFunc_fct_0 == (uintptr_t)fct) return my_GstCapsFilterMapFunc_0; if(my_GstCapsFilterMapFunc_fct_1 == (uintptr_t)fct) return my_GstCapsFilterMapFunc_1; if(my_GstCapsFilterMapFunc_fct_2 == (uintptr_t)fct) return my_GstCapsFilterMapFunc_2; if(my_GstCapsFilterMapFunc_fct_3 == (uintptr_t)fct) return my_GstCapsFilterMapFunc_3;


    if(my_GstCapsFilterMapFunc_fct_0 == 0) {my_GstCapsFilterMapFunc_fct_0 = (uintptr_t)fct; return my_GstCapsFilterMapFunc_0; } if(my_GstCapsFilterMapFunc_fct_1 == 0) {my_GstCapsFilterMapFunc_fct_1 = (uintptr_t)fct; return my_GstCapsFilterMapFunc_1; } if(my_GstCapsFilterMapFunc_fct_2 == 0) {my_GstCapsFilterMapFunc_fct_2 = (uintptr_t)fct; return my_GstCapsFilterMapFunc_2; } if(my_GstCapsFilterMapFunc_fct_3 == 0) {my_GstCapsFilterMapFunc_fct_3 = (uintptr_t)fct; return my_GstCapsFilterMapFunc_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for gstreamer GstCapsFilterMapFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 256 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
          ((void *)0)
# 256 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
              ;
}



__attribute__((visibility("default"))) void my_gst_caps_set_simple(x86emu_t* emu, void* caps, void* field, void* b) {
    (void)emu;
    do {} while(0);
    my->gst_caps_set_simple_valist(caps, field, b);
}

__attribute__((visibility("default"))) void my_gst_caps_set_simple_valist(x86emu_t* emu, void* caps, void* field, void* V) {
    (void)emu;
    do {} while(0);
    my->gst_caps_set_simple_valist(caps, field, V);
}

__attribute__((visibility("default"))) int my_gst_structure_get(x86emu_t* emu, void* structure, void* field, void* b) {
    (void)emu;
    do {} while(0);
    return my->gst_structure_get_valist(structure, field, b);
}

__attribute__((visibility("default"))) int my_gst_structure_get_valist(x86emu_t* emu, void* structure, void* field, void* V) {
    (void)emu;
    do {} while(0);
    return my->gst_structure_get_valist(structure, field, V);
}


__attribute__((visibility("default"))) void my_gst_pad_set_activatemode_function_full(x86emu_t* emu, void* pad, void* f, void* data, void* d)
{
    my->gst_pad_set_activatemode_function_full(pad, findGstPadActivateModeFunctionFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_pad_set_query_function_full(x86emu_t* emu, void* pad, void* f, void* data, void* d)
{
    my->gst_pad_set_query_function_full(pad, findGstPadQueryFunctionFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_pad_set_getrange_function_full(x86emu_t* emu, void* pad, void* f, void* data, void* d)
{
    my->gst_pad_set_getrange_function_full(pad, findGstPadGetRangeFunctionFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_pad_set_chain_function_full(x86emu_t* emu, void* pad, void* f, void* data, void* d)
{
    my->gst_pad_set_chain_function_full(pad, findGstPadChainFunctionFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_pad_set_event_function_full(x86emu_t* emu, void* pad, void* f, void* data, void* d)
{
    my->gst_pad_set_event_function_full(pad, findGstPadEventFunctionFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_bus_set_sync_handler(x86emu_t* emu, void* bus, void* f, void* data, void* d)
{
    my->gst_bus_set_sync_handler(bus, findGstBusSyncHandlerFct(f), data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void* my_gst_buffer_new_wrapped_full(x86emu_t* emu, uint32_t f, void* data, size_t maxsize, size_t offset, size_t size, void* user, void* d)
{
    return my->gst_buffer_new_wrapped_full(f, data, maxsize, offset, size, user, findDestroyFct(d));
}

__attribute__((visibility("default"))) void my_gst_mini_object_set_qdata(x86emu_t* emu, void* object, void* quark, void* data, void* d)
{
    do {} while(0);
    my->gst_mini_object_set_qdata(object, quark, data, findDestroyFct(d));
}

__attribute__((visibility("default"))) void* my_gst_caps_new_simple(x86emu_t* emu, void* type, void* name, void* V)
{

    void* caps = my->gst_caps_new_empty();
    void* structure = my->gst_structure_new_valist(type, name, V);
    if (structure)
        my->gst_caps_append_structure(caps, structure);
    else
        my->gst_caps_replace(&caps, 
# 335 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 3 4
                                   ((void *)0)
# 335 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
                                       );

    return caps;
}

__attribute__((visibility("default"))) void* my_gst_registry_feature_filter(x86emu_t* emu, void* reg, void* filter, int first, void* data)
{
    return my->gst_registry_feature_filter(reg, findGstPluginFeatureFilterFct(filter), first, data);
}

__attribute__((visibility("default"))) int my_gst_caps_foreach(x86emu_t* emu, void* caps, void* f, void* data)
{
    return my->gst_caps_foreach(caps, findGstCapsFilterMapFuncFct(f), data);
}
# 371 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstreamerdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gstreamersymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_allocator_alloc", pFpLp, 0},



{"gst_allocator_get_type", pFv, 0},



{"gst_atomic_queue_length", uFp, 0},
{"gst_atomic_queue_new", pFu, 0},
{"gst_atomic_queue_peek", pFp, 0},
{"gst_atomic_queue_pop", pFp, 0},
{"gst_atomic_queue_push", vFpp, 0},
{"gst_atomic_queue_ref", vFp, 0},
{"gst_atomic_queue_unref", vFp, 0},
{"gst_bin_add", iFpp, 0},

{"gst_bin_find_unlinked_pad", pFpi, 0},
{"gst_bin_flags_get_type", pFv, 0},
{"gst_bin_get_by_interface", pFpp, 0},
{"gst_bin_get_by_name", pFpp, 0},
{"gst_bin_get_by_name_recurse_up", pFpp, 0},
{"gst_bin_get_suppressed_flags", iFp, 0},
{"gst_bin_get_type", pFv, 0},
{"gst_bin_iterate_all_by_element_factory_name", pFpp, 0},
{"gst_bin_iterate_all_by_interface", pFpp, 0},
{"gst_bin_iterate_elements", pFp, 0},
{"gst_bin_iterate_recurse", pFp, 0},
{"gst_bin_iterate_sinks", pFp, 0},
{"gst_bin_iterate_sorted", pFp, 0},
{"gst_bin_iterate_sources", pFp, 0},
{"gst_bin_new", pFp, 0},
{"gst_bin_recalculate_latency", iFp, 0},
{"gst_bin_remove", iFpp, 0},

{"gst_bin_set_suppressed_flags", vFpi, 0},
{"gst_bin_sync_children_states", iFp, 0},
{"gst_bitmask_get_type", pFv, 0},

{"gst_buffer_add_meta", pFppp, 0},
{"gst_buffer_add_parent_buffer_meta", pFpp, 0},
{"gst_buffer_add_protection_meta", pFpp, 0},
{"gst_buffer_add_reference_timestamp_meta", pFppUU, 0},
{"gst_buffer_append", pFpp, 0},
{"gst_buffer_append_memory", vFpp, 0},
{"gst_buffer_append_region", pFppll, 0},
{"gst_buffer_copy", pFp, 0},
{"gst_buffer_copy_deep", pFp, 0},
{"gst_buffer_copy_flags_get_type", pFv, 0},
{"gst_buffer_copy_into", iFppiLL, 0},
{"gst_buffer_copy_region", pFpiLL, 0},
{"gst_buffer_extract", LFpLpL, 0},
{"gst_buffer_extract_dup", vFpLLpp, 0},
{"gst_buffer_fill", LFpLpL, 0},
{"gst_buffer_find_memory", iFpLLppp, 0},
{"gst_buffer_flags_get_type", pFv, 0},

{"gst_buffer_get_all_memory", pFp, 0},
{"gst_buffer_get_flags", iFp, 0},
{"gst_buffer_get_max_memory", uFv, 0},
{"gst_buffer_get_memory", pFpu, 0},
{"gst_buffer_get_memory_range", pFpui, 0},
{"gst_buffer_get_meta", pFpp, 0},
{"gst_buffer_get_n_meta", uFpp, 0},
{"gst_buffer_get_reference_timestamp_meta", pFpp, 0},
{"gst_buffer_get_size", LFp, 0},
{"gst_buffer_get_sizes", LFppp, 0},
{"gst_buffer_get_sizes_range", LFpuipp, 0},
{"gst_buffer_get_type", pFv, 0},
{"gst_buffer_has_flags", iFpi, 0},
{"gst_buffering_mode_get_type", pFv, 0},
{"gst_buffer_insert_memory", vFpip, 0},
{"gst_buffer_is_all_memory_writable", iFp, 0},
{"gst_buffer_is_memory_range_writable", iFpui, 0},
{"gst_buffer_iterate_meta", pFpp, 0},
{"gst_buffer_iterate_meta_filtered", pFppp, 0},
# 102 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_buffer_map", iFppi, 0},
{"gst_buffer_map_range", iFpuipi, 0},
{"gst_buffer_memcmp", iFpLpL, 0},
{"gst_buffer_memset", LFpLCL, 0},
{"gst_buffer_new", pFv, 0},
{"gst_buffer_new_allocate", pFplp, 0},
{"gst_buffer_new_wrapped", pFpl, 0},
{"gst_buffer_new_wrapped_bytes", pFp, 0},

{"gst_buffer_n_memory", uFp, 0},
{"gst_buffer_peek_memory", pFpu, 0},


{"gst_buffer_pool_config_add_option", vFpp, 0},





{"gst_buffer_pool_config_set_allocator", vFppp, 0},
{"gst_buffer_pool_config_set_params", vFppuuu, 0},

{"gst_buffer_pool_get_config", pFp, 0},
...
{"gst_buffer_pool_set_active", iFpi, 0},
{"gst_buffer_pool_set_config", iFpp, 0},

{"gst_buffer_prepend_memory", vFpp, 0},
{"gst_buffer_ref", pFp, 0},
{"gst_buffer_remove_all_memory", vFp, 0},
{"gst_buffer_remove_memory", vFpu, 0},
{"gst_buffer_remove_memory_range", vFpui, 0},
{"gst_buffer_remove_meta", iFpp, 0},
{"gst_buffer_replace", iFpp, 0},
{"gst_buffer_replace_all_memory", vFpp, 0},
{"gst_buffer_replace_memory", vFpup, 0},
{"gst_buffer_replace_memory_range", vFpuip, 0},
{"gst_buffer_resize", vFpll, 0},
{"gst_buffer_resize_range", iFpuill, 0},
{"gst_buffer_set_flags", iFpi, 0},
{"gst_buffer_set_size", vFpl, 0},

{"gst_buffer_unmap", vFpp, 0},
{"gst_buffer_unref", vFp, 0},
{"gst_buffer_unset_flags", iFpi, 0},
{"gst_bus_add_signal_watch", vFp, 0},
{"gst_bus_add_signal_watch_full", vFpi, 0},


{"gst_bus_async_signal_func", iFppp, 0},
{"gst_bus_create_watch", pFp, 0},
{"gst_bus_disable_sync_message_emission", vFp, 0},
{"gst_bus_enable_sync_message_emission", vFp, 0},
{"gst_bus_flags_get_type", pFv, 0},
{"gst_bus_get_pollfd", vFpp, 0},
{"gst_bus_get_type", pFv, 0},
{"gst_bus_have_pending", iFp, 0},
{"gst_bus_new", pFv, 0},
{"gst_bus_peek", pFp, 0},
{"gst_bus_poll", pFppU, 0},
{"gst_bus_pop", pFp, 0},
{"gst_bus_pop_filtered", pFpi, 0},
{"gst_bus_post", iFpp, 0},
{"gst_bus_remove_signal_watch", vFp, 0},
{"gst_bus_remove_watch", iFp, 0},
{"gst_bus_set_flushing", vFpi, 0},

{"gst_bus_sync_reply_get_type", pFv, 0},
{"gst_bus_sync_signal_handler", iFppp, 0},
{"gst_bus_timed_pop", pFpU, 0},
{"gst_bus_timed_pop_filtered", pFpUi, 0},


{"gst_caps_append", vFpp, 0},
{"gst_caps_append_structure", vFpp, 0},
{"gst_caps_append_structure_full", vFppp, 0},
{"gst_caps_can_intersect", iFpp, 0},
{"gst_caps_copy", pFp, 0},
{"gst_caps_copy_nth", pFpu, 0},
# 213 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_caps_fixate", pFp, 0},
{"gst_caps_flags_get_type", pFv, 0},

{"gst_caps_from_string", pFp, 0},
{"gst_caps_get_features", pFpu, 0},
{"gst_caps_get_size", uFp, 0},
{"gst_caps_get_structure", pFpu, 0},
{"gst_caps_get_type", pFv, 0},
{"gst_caps_intersect", pFpp, 0},
{"gst_caps_intersect_full", pFppi, 0},
{"gst_caps_intersect_mode_get_type", pFv, 0},
{"gst_caps_is_always_compatible", iFpp, 0},
{"gst_caps_is_any", iFp, 0},
{"gst_caps_is_empty", iFp, 0},
{"gst_caps_is_equal", iFpp, 0},
{"gst_caps_is_equal_fixed", iFpp, 0},
{"gst_caps_is_fixed", iFp, 0},
{"gst_caps_is_strictly_equal", iFpp, 0},
{"gst_caps_is_subset", iFpp, 0},
{"gst_caps_is_subset_structure", iFpp, 0},
{"gst_caps_is_subset_structure_full", iFppp, 0},

{"gst_caps_merge", pFpp, 0},
{"gst_caps_merge_structure", pFpp, 0},
{"gst_caps_merge_structure_full", pFppp, 0},
{"gst_caps_new_any", pFv, 0},
{"gst_caps_new_empty", pFv, 0},
{"gst_caps_new_empty_simple", pFp, 0},

{"gst_caps_new_full_valist", pFpp, 0},


{"gst_caps_normalize", pFp, 0},
{"gst_caps_ref", pFp, 0},
{"gst_caps_remove_structure", vFpp, 0},
{"gst_caps_replace", iFpp, 0},
{"gst_caps_set_features", vFpup, 0},
{"gst_caps_set_features_simple", vFpp, 0},


{"gst_caps_set_value", vFppp, 0},
{"gst_caps_simplify", pFp, 0},
{"gst_caps_steal_structure", pFpu, 0},
{"gst_caps_subtract", pFpp, 0},
{"gst_caps_take", iFpp, 0},
{"gst_caps_to_string", pFp, 0},
{"gst_caps_truncate", pFp, 0},

{"gst_caps_unref", vFp, 0},
# 309 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_clear_caps", vFp, 0},
{"gst_clear_event", vFp, 0},
{"gst_clear_message", vFp, 0},


{"gst_clear_query", vFp, 0},
{"gst_clear_structure", vFp, 0},
# 361 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_context_new", pFpi, 0},
# 420 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_debug_category_get_threshold", iFp, 0},
{"_gst_debug_category_new", pFppp, 0},
# 440 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"



{"gst_debug_log_valist", vFpippippp, 0},


# 461 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_deinit", vFv, 0},
# 518 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_element_abort_state", vFp, 0},
{"gst_element_add_pad", iFpp, 0},
{"gst_element_add_property_deep_notify_watch", LFppi, 0},
{"gst_element_add_property_notify_watch", LFppi, 0},

{"gst_element_change_state", iFpi, 0},
{"gst_element_class_add_metadata", vFppp, 0},
{"gst_element_class_add_pad_template", vFpp, 0},
{"gst_element_class_add_static_metadata", vFppp, 0},
{"gst_element_class_add_static_pad_template", vFpp, 0},
{"gst_element_class_add_static_pad_template_with_gtype", vFppp, 0},
{"gst_element_class_get_metadata", pFpp, 0},
{"gst_element_class_get_pad_template", pFpp, 0},
{"gst_element_class_get_pad_template_list", pFp, 0},
{"gst_element_class_set_metadata", vFppppp, 0},
{"gst_element_class_set_static_metadata", vFppppp, 0},
{"gst_element_continue_state", iFpi, 0},


{"gst_element_factory_can_sink_all_caps", iFpp, 0},
{"gst_element_factory_can_sink_any_caps", iFpp, 0},
{"gst_element_factory_can_src_all_caps", iFpp, 0},
{"gst_element_factory_can_src_any_caps", iFpp, 0},
{"gst_element_factory_create", pFpp, 0},
{"gst_element_factory_find", pFp, 0},
{"gst_element_factory_get_element_type", pFp, 0},
{"gst_element_factory_get_metadata", pFpp, 0},
{"gst_element_factory_get_metadata_keys", pFp, 0},
{"gst_element_factory_get_num_pad_templates", uFp, 0},
{"gst_element_factory_get_static_pad_templates", pFp, 0},
{"gst_element_factory_get_type", pFv, 0},
{"gst_element_factory_get_uri_protocols", pFp, 0},
{"gst_element_factory_get_uri_type", iFp, 0},
{"gst_element_factory_has_interface", iFpp, 0},
{"gst_element_factory_list_filter", pFppii, 0},
{"gst_element_factory_list_get_elements", pFpi, 0},
{"gst_element_factory_list_is_type", iFpi, 0},
{"gst_element_factory_make", pFpp, 0},
{"gst_element_flags_get_type", pFv, 0},



{"gst_element_get_base_time", UFp, 0},
{"gst_element_get_bus", pFp, 0},
{"gst_element_get_clock", pFp, 0},
{"gst_element_get_compatible_pad", pFppp, 0},
{"gst_element_get_compatible_pad_template", pFpp, 0},
{"gst_element_get_context", pFpp, 0},
{"gst_element_get_contexts", pFp, 0},
{"gst_element_get_context_unlocked", pFpp, 0},
{"gst_element_get_current_clock_time", UFp, 0},
{"gst_element_get_current_running_time", UFp, 0},
{"gst_element_get_factory", pFp, 0},
{"gst_element_get_metadata", pFpp, 0},
{"gst_element_get_pad_template", pFpp, 0},
{"gst_element_get_pad_template_list", pFp, 0},

{"gst_element_get_start_time", UFp, 0},
{"gst_element_get_state", iFpppU, 0},
{"gst_element_get_static_pad", pFpp, 0},
{"gst_element_get_type", pFv, 0},
{"gst_element_is_locked_state", iFp, 0},
{"gst_element_iterate_pads", pFp, 0},
{"gst_element_iterate_sink_pads", pFp, 0},
{"gst_element_iterate_src_pads", pFp, 0},
{"gst_element_link", iFpp, 0},
{"gst_element_link_filtered", iFppp, 0},

{"gst_element_link_pads", iFpppp, 0},
{"gst_element_link_pads_filtered", iFppppp, 0},
{"gst_element_link_pads_full", iFppppi, 0},
{"gst_element_lost_state", vFp, 0},
{"gst_element_make_from_uri", pFpppp, 0},
{"gst_element_message_full", vFpipippppi, 0},
{"gst_element_message_full_with_details", vFpipippppip, 0},
{"gst_element_no_more_pads", vFp, 0},
{"gst_element_post_message", iFpp, 0},
{"gst_element_provide_clock", pFp, 0},
{"gst_element_query", iFpp, 0},
{"gst_element_query_convert", iFpiIip, 0},
{"gst_element_query_duration", iFpip, 0},
{"gst_element_query_position", iFpip, 0},
{"gst_element_register", iFppup, 0},
{"gst_element_release_request_pad", vFpp, 0},
{"gst_element_remove_pad", iFpp, 0},
{"gst_element_remove_property_notify_watch", vFpL, 0},
{"gst_element_request_pad", pFpppp, 0},
{"gst_element_seek", iFpdiiiIiI, 0},
{"gst_element_seek_simple", iFpiiI, 0},
{"gst_element_send_event", iFpp, 0},
{"gst_element_set_base_time", vFpU, 0},
{"gst_element_set_bus", vFpp, 0},
{"gst_element_set_clock", iFpp, 0},
{"gst_element_set_context", vFpp, 0},
{"gst_element_set_locked_state", iFpi, 0},
{"gst_element_set_start_time", vFpU, 0},
{"gst_element_set_state", iFpi, 0},
{"gst_element_state_change_return_get_name", pFi, 0},
{"gst_element_state_get_name", pFi, 0},
{"gst_element_sync_state_with_parent", iFp, 0},
{"gst_element_unlink", vFpp, 0},

{"gst_element_unlink_pads", vFpppp, 0},

{"gst_event_copy", pFp, 0},
{"gst_event_copy_segment", vFpp, 0},
{"gst_event_get_running_time_offset", IFp, 0},
{"gst_event_get_seqnum", uFp, 0},
{"gst_event_get_structure", pFp, 0},
{"gst_event_get_type", pFv, 0},
{"gst_event_has_name", iFpp, 0},
{"gst_event_has_name_id", iFpp, 0},
{"gst_event_new_buffer_size", pFiIIi, 0},
{"gst_event_new_caps", pFp, 0},
{"gst_event_new_custom", pFpp, 0},
{"gst_event_new_eos", pFv, 0},
{"gst_event_new_flush_start", pFv, 0},
{"gst_event_new_flush_stop", pFi, 0},
{"gst_event_new_gap", pFUU, 0},
{"gst_event_new_instant_rate_change", pFdi, 0},
{"gst_event_new_instant_rate_sync_time", pFdUU, 0},
{"gst_event_new_latency", pFU, 0},
{"gst_event_new_navigation", pFp, 0},
{"gst_event_new_protection", pFppp, 0},
{"gst_event_new_qos", pFpdIU, 0},
{"gst_event_new_reconfigure", pFv, 0},
{"gst_event_new_seek", pFdiiiIiI, 0},
{"gst_event_new_segment", pFp, 0},
{"gst_event_new_segment_done", pFiI, 0},
{"gst_event_new_select_streams", pFp, 0},
{"gst_event_new_sink_message", pFpp, 0},
{"gst_event_new_step", pFpUdii, 0},
{"gst_event_new_stream_collection", pFp, 0},
{"gst_event_new_stream_group_done", pFu, 0},
{"gst_event_new_stream_start", pFp, 0},
{"gst_event_new_tag", pFp, 0},
{"gst_event_new_toc", pFpi, 0},
{"gst_event_new_toc_select", pFp, 0},
{"gst_event_parse_buffer_size", vFppppp, 0},
{"gst_event_parse_caps", vFpp, 0},
{"gst_event_parse_flush_stop", vFpp, 0},
{"gst_event_parse_gap", vFppp, 0},
{"gst_event_parse_group_id", vFpp, 0},
{"gst_event_parse_instant_rate_change", vFppp, 0},
{"gst_event_parse_instant_rate_sync_time", vFpppp, 0},
{"gst_event_parse_latency", vFpp, 0},
{"gst_event_parse_protection", vFpppp, 0},
{"gst_event_parse_qos", vFppppp, 0},
{"gst_event_parse_seek", vFpppppppp, 0},
{"gst_event_parse_seek_trickmode_interval", vFpp, 0},
{"gst_event_parse_segment", vFpp, 0},
{"gst_event_parse_segment_done", vFppp, 0},
{"gst_event_parse_select_streams", vFpp, 0},
{"gst_event_parse_sink_message", vFpp, 0},
{"gst_event_parse_step", vFpppppp, 0},
{"gst_event_parse_stream", vFpp, 0},
{"gst_event_parse_stream_collection", vFpp, 0},
{"gst_event_parse_stream_flags", vFpp, 0},
{"gst_event_parse_stream_group_done", vFpp, 0},
{"gst_event_parse_stream_start", vFpp, 0},
{"gst_event_parse_tag", vFpp, 0},
{"gst_event_parse_toc", vFppp, 0},
{"gst_event_parse_toc_select", vFpp, 0},
{"gst_event_ref", pFp, 0},
{"gst_event_replace", iFpp, 0},
{"gst_event_set_group_id", vFpu, 0},
{"gst_event_set_running_time_offset", vFpI, 0},
{"gst_event_set_seek_trickmode_interval", vFpU, 0},
{"gst_event_set_seqnum", vFpu, 0},
{"gst_event_set_stream", vFpp, 0},
{"gst_event_set_stream_flags", vFpi, 0},
{"gst_event_steal", pFp, 0},
{"gst_event_take", iFpp, 0},

{"gst_event_type_flags_get_type", pFv, 0},
{"gst_event_type_get_flags", iFp, 0},
{"gst_event_type_get_name", pFi, 0},
{"gst_event_type_get_type", pFv, 0},
{"gst_event_type_to_quark", pFi, 0},
{"gst_event_unref", vFp, 0},
{"gst_event_writable_structure", pFp, 0},





{"gst_flow_get_name", pFi, 0},
{"gst_flow_return_get_type", pFv, 0},
{"gst_flow_to_quark", pFi, 0},
{"gst_format_get_by_nick", iFp, 0},
{"gst_format_get_details", pFi, 0},
{"gst_format_get_name", pFi, 0},
{"gst_format_get_type", pFv, 0},
{"gst_format_iterate_definitions", pFv, 0},
{"gst_format_register", iFpp, 0},
{"gst_formats_contains", iFpi, 0},
{"gst_format_to_quark", pFi, 0},
{"gst_fraction_get_type", pFv, 0},
{"gst_fraction_range_get_type", pFv, 0},


{"gst_get_main_executable_path", pFv, 0},
# 734 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_init", vFpp, 0},
{"gst_init_check", iFppp, 0},
{"gst_init_get_option_group", pFv, 0},





{"gst_is_initialized", iFv, 0},





{"gst_iterator_free", vFp, 0},





{"gst_iterator_next", iFpp, 0},


{"gst_iterator_resync", vFp, 0},
# 768 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_memory_init", vFpuppLLLL, 0},



{"gst_memory_map", iFppu, 0},





{"gst_memory_unmap", vFpp, 0},

{"gst_message_add_redirect_entry", vFpppp, 0},
{"gst_message_copy", pFp, 0},
{"gst_message_get_num_redirect_entries", lFp, 0},
{"gst_message_get_seqnum", uFp, 0},
{"gst_message_get_stream_status_object", pFp, 0},
{"gst_message_get_structure", pFp, 0},
{"gst_message_get_type", pFv, 0},
{"gst_message_has_name", iFpp, 0},
{"gst_message_new_application", pFpp, 0},
{"gst_message_new_async_done", pFpU, 0},
{"gst_message_new_async_start", pFp, 0},
{"gst_message_new_buffering", pFpi, 0},
{"gst_message_new_clock_lost", pFpp, 0},
{"gst_message_new_clock_provide", pFppi, 0},
{"gst_message_new_custom", pFppp, 0},
{"gst_message_new_device_added", pFpp, 0},
{"gst_message_new_device_changed", pFppp, 0},
{"gst_message_new_device_removed", pFpp, 0},
{"gst_message_new_duration_changed", pFp, 0},
{"gst_message_new_element", pFpp, 0},
{"gst_message_new_eos", pFp, 0},
{"gst_message_new_error", pFppp, 0},
{"gst_message_new_error_with_details", pFpppp, 0},
{"gst_message_new_have_context", pFpp, 0},
{"gst_message_new_info", pFppp, 0},
{"gst_message_new_info_with_details", pFpppp, 0},
{"gst_message_new_instant_rate_request", pFpp, 0},
{"gst_message_new_latency", pFp, 0},
{"gst_message_new_need_context", pFpp, 0},
{"gst_message_new_new_clock", pFpp, 0},
{"gst_message_new_progress", pFpppp, 0},
{"gst_message_new_property_notify", pFppp, 0},
{"gst_message_new_qos", pFpiUUUU, 0},
{"gst_message_new_redirect", pFpppp, 0},
{"gst_message_new_request_state", pFpp, 0},
{"gst_message_new_reset_time", pFpU, 0},
{"gst_message_new_segment_done", pFppI, 0},
{"gst_message_new_segment_start", pFppI, 0},
{"gst_message_new_state_changed", pFpiii, 0},
{"gst_message_new_state_dirty", pFp, 0},
{"gst_message_new_step_done", pFpiUdiiUi, 0},
{"gst_message_new_step_start", pFpiiUdii, 0},
{"gst_message_new_stream_collection", pFpp, 0},
{"gst_message_new_streams_selected", pFpp, 0},
{"gst_message_new_stream_start", pFp, 0},
{"gst_message_new_stream_status", pFpip, 0},
{"gst_message_new_structure_change", pFpppi, 0},
{"gst_message_new_tag", pFpp, 0},
{"gst_message_new_toc", pFppi, 0},
{"gst_message_new_warning", pFppp, 0},
{"gst_message_new_warning_with_details", pFpppp, 0},
{"gst_message_parse_async_done", vFpp, 0},
{"gst_message_parse_buffering", vFpp, 0},
{"gst_message_parse_buffering_stats", vFppppp, 0},
{"gst_message_parse_clock_lost", vFpp, 0},
{"gst_message_parse_clock_provide", vFppp, 0},
{"gst_message_parse_context_type", iFpp, 0},
{"gst_message_parse_device_added", vFpp, 0},
{"gst_message_parse_device_changed", vFppp, 0},
{"gst_message_parse_device_removed", vFpp, 0},
{"gst_message_parse_error", vFppp, 0},
{"gst_message_parse_error_details", vFpp, 0},
{"gst_message_parse_group_id", iFpp, 0},
{"gst_message_parse_have_context", vFpp, 0},
{"gst_message_parse_info", vFppp, 0},
{"gst_message_parse_info_details", vFpp, 0},
{"gst_message_parse_instant_rate_request", vFpp, 0},
{"gst_message_parse_new_clock", vFpp, 0},
{"gst_message_parse_progress", vFpppp, 0},
{"gst_message_parse_property_notify", vFpppp, 0},
{"gst_message_parse_qos", vFpppppp, 0},
{"gst_message_parse_qos_stats", vFpppp, 0},
{"gst_message_parse_qos_values", vFpppp, 0},
{"gst_message_parse_redirect_entry", vFplppp, 0},
{"gst_message_parse_request_state", vFpp, 0},
{"gst_message_parse_reset_time", vFpp, 0},
{"gst_message_parse_segment_done", vFppp, 0},
{"gst_message_parse_segment_start", vFppp, 0},
{"gst_message_parse_state_changed", vFpppp, 0},
{"gst_message_parse_step_done", vFpppppppp, 0},
{"gst_message_parse_step_start", vFppppppp, 0},
{"gst_message_parse_stream_collection", vFpp, 0},
{"gst_message_parse_streams_selected", vFpp, 0},
{"gst_message_parse_stream_status", vFppp, 0},
{"gst_message_parse_structure_change", vFpppp, 0},
{"gst_message_parse_tag", vFpp, 0},
{"gst_message_parse_toc", vFppp, 0},
{"gst_message_parse_warning", vFppp, 0},
{"gst_message_parse_warning_details", vFpp, 0},
{"gst_message_ref", pFp, 0},
{"gst_message_replace", iFpp, 0},
{"gst_message_set_buffering_stats", vFpiiiI, 0},
{"gst_message_set_group_id", vFpu, 0},
{"gst_message_set_qos_stats", vFpiUU, 0},
{"gst_message_set_qos_values", vFpIdi, 0},
{"gst_message_set_seqnum", vFpu, 0},
{"gst_message_set_stream_status_object", vFpp, 0},
{"gst_message_streams_selected_add", vFpp, 0},
{"gst_message_streams_selected_get_size", uFp, 0},
{"gst_message_streams_selected_get_stream", pFpu, 0},
{"gst_message_take", iFpp, 0},

{"gst_message_type_get_name", pFi, 0},
{"gst_message_type_get_type", pFv, 0},
{"gst_message_type_to_quark", pFi, 0},
{"gst_message_unref", vFp, 0},
{"gst_message_writable_structure", pFp, 0},
# 898 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_mini_object_copy", pFp, 0},

{"gst_mini_object_get_qdata", pFpp, 0},

{"gst_mini_object_is_writable", iFp, 0},

{"gst_mini_object_make_writable", pFp, 0},
{"gst_mini_object_ref", pFp, 0},
...
{"gst_mini_object_unref", vFp, 0},


{"gst_object_add_control_binding", iFpp, 0},
{"gst_object_check_uniqueness", iFpp, 0},
{"gst_object_default_deep_notify", vFpppp, 0},
{"gst_object_default_error", vFppp, 0},
{"gst_object_flags_get_type", pFv, 0},
{"gst_object_get_control_binding", pFpp, 0},
{"gst_object_get_control_rate", UFp, 0},
{"gst_object_get_g_value_array", iFppUUup, 0},
{"gst_object_get_name", pFp, 0},
{"gst_object_get_parent", pFp, 0},
{"gst_object_get_path_string", pFp, 0},
{"gst_object_get_type", pFv, 0},
{"gst_object_get_value", pFppU, 0},
{"gst_object_get_value_array", iFppUUup, 0},
{"gst_object_has_active_control_bindings", iFp, 0},
{"gst_object_has_ancestor", iFpp, 0},
{"gst_object_has_as_ancestor", iFpp, 0},
{"gst_object_has_as_parent", iFpp, 0},
{"gst_object_ref", pFp, 0},
{"gst_object_ref_sink", pFp, 0},
{"gst_object_remove_control_binding", iFpp, 0},
{"gst_object_replace", iFpp, 0},
{"gst_object_set_control_binding_disabled", vFppi, 0},
{"gst_object_set_control_bindings_disabled", vFpp, 0},
{"gst_object_set_control_rate", vFpU, 0},
{"gst_object_set_name", iFpp, 0},
{"gst_object_set_parent", iFpp, 0},
{"gst_object_suggest_next_sync", UFp, 0},
{"gst_object_sync_values", iFpU, 0},
{"gst_object_unparent", vFp, 0},
{"gst_object_unref", vFp, 0},
{"gst_pad_activate_mode", iFpii, 0},

{"gst_pad_can_link", iFpp, 0},
{"gst_pad_chain", iFpp, 0},
{"gst_pad_chain_list", iFpp, 0},
{"gst_pad_check_reconfigure", iFp, 0},
{"gst_pad_create_stream_id", pFppp, 0},


{"gst_pad_direction_get_type", pFv, 0},
{"gst_pad_event_default", iFppp, 0},
{"gst_pad_flags_get_type", pFv, 0},

{"gst_pad_get_allowed_caps", pFp, 0},
{"gst_pad_get_current_caps", pFp, 0},
{"gst_pad_get_direction", iFp, 0},
{"gst_pad_get_element_private", pFp, 0},
{"gst_pad_get_last_flow_return", iFp, 0},
{"gst_pad_get_offset", IFp, 0},
{"gst_pad_get_pad_template", pFp, 0},
{"gst_pad_get_pad_template_caps", pFp, 0},
{"gst_pad_get_parent_element", pFp, 0},
{"gst_pad_get_peer", pFp, 0},
{"gst_pad_get_range", iFpUup, 0},
{"gst_pad_get_single_internal_link", pFp, 0},
{"gst_pad_get_sticky_event", pFppu, 0},
{"gst_pad_get_stream", pFp, 0},
{"gst_pad_get_stream_id", pFp, 0},
{"gst_pad_get_task_state", iFp, 0},
{"gst_pad_get_type", pFv, 0},
{"gst_pad_has_current_caps", iFp, 0},
{"gst_pad_is_active", iFp, 0},
{"gst_pad_is_blocked", iFp, 0},
{"gst_pad_is_blocking", iFp, 0},
{"gst_pad_is_linked", iFp, 0},
{"gst_pad_iterate_internal_links", pFp, 0},
{"gst_pad_iterate_internal_links_default", pFpp, 0},
{"gst_pad_link", iFpp, 0},
{"gst_pad_link_check_get_type", pFv, 0},
{"gst_pad_link_full", iFppi, 0},
{"gst_pad_link_get_name", pFp, 0},
{"gst_pad_link_maybe_ghosting", iFpp, 0},
{"gst_pad_link_maybe_ghosting_full", iFppi, 0},
{"gst_pad_link_return_get_type", pFv, 0},
{"gst_pad_mark_reconfigure", vFp, 0},
{"gst_pad_mode_get_name", pFi, 0},
{"gst_pad_mode_get_type", pFv, 0},
{"gst_pad_needs_reconfigure", iFp, 0},
{"gst_pad_new", pFpi, 0},
{"gst_pad_new_from_static_template", pFpp, 0},
{"gst_pad_new_from_template", pFpp, 0},
{"gst_pad_pause_task", iFp, 0},
{"gst_pad_peer_query", iFpp, 0},
{"gst_pad_peer_query_accept_caps", iFpp, 0},
{"gst_pad_peer_query_caps", pFpp, 0},
{"gst_pad_peer_query_convert", iFpiIip, 0},
{"gst_pad_peer_query_duration", iFpip, 0},
{"gst_pad_peer_query_position", iFpip, 0},
{"gst_pad_presence_get_type", pFv, 0},
...
{"gst_pad_proxy_query_accept_caps", iFpp, 0},
{"gst_pad_proxy_query_caps", iFpp, 0},
{"gst_pad_pull_range", iFpUup, 0},
{"gst_pad_push", iFpp, 0},
{"gst_pad_push_event", iFpp, 0},
{"gst_pad_push_list", iFpp, 0},
{"gst_pad_query", iFpp, 0},
{"gst_pad_query_accept_caps", iFpp, 0},
{"gst_pad_query_caps", pFpp, 0},
{"gst_pad_query_convert", iFpiIip, 0},
{"gst_pad_query_default", iFppp, 0},
{"gst_pad_query_duration", iFppp, 0},
{"gst_pad_query_position", iFppp, 0},
{"gst_pad_remove_probe", vFpL, 0},
{"gst_pad_send_event", iFpp, 0},


{"gst_pad_set_active", iFpi, 0},


{"gst_pad_set_element_private", vFpp, 0},





{"gst_pad_set_offset", vFpI, 0},




{"gst_pad_stop_task", iFp, 0},
{"gst_pad_store_sticky_event", iFpp, 0},
{"gst_pad_template_flags_get_type", pFv, 0},



{"gst_pad_template_new", pFpiip, 0},




{"gst_pad_unlink", iFpp, 0},
{"gst_pad_use_fixed_caps", vFp, 0},
# 1100 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_plugin_feature_get_rank", uFp, 0},
{"gst_plugin_feature_get_type", LFv, 0},


{"gst_plugin_feature_list_free", vFp, 0},

{"gst_plugin_feature_rank_compare_func", iFpp, 0},
# 1190 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_query_add_allocation_meta", vFppp, 0},
{"gst_query_add_allocation_param", vFppp, 0},
{"gst_query_add_allocation_pool", vFppuuu, 0},
{"gst_query_add_buffering_range", iFpII, 0},
{"gst_query_add_scheduling_mode", vFpi, 0},
{"gst_query_copy", pFp, 0},
{"gst_query_find_allocation_meta", iFppp, 0},
{"gst_query_get_n_allocation_metas", uFp, 0},
{"gst_query_get_n_allocation_params", uFp, 0},
{"gst_query_get_n_allocation_pools", uFp, 0},
{"gst_query_get_n_buffering_ranges", uFp, 0},
{"gst_query_get_n_scheduling_modes", uFp, 0},
{"gst_query_get_structure", pFp, 0},
{"gst_query_get_type", pFv, 0},
{"gst_query_has_scheduling_mode", iFpi, 0},
{"gst_query_has_scheduling_mode_with_flags", iFpii, 0},
{"gst_query_new_accept_caps", pFp, 0},
{"gst_query_new_allocation", pFpi, 0},
{"gst_query_new_bitrate", pFv, 0},
{"gst_query_new_buffering", pFi, 0},
{"gst_query_new_caps", pFp, 0},
{"gst_query_new_context", pFp, 0},
{"gst_query_new_convert", pFiIi, 0},
{"gst_query_new_custom", pFip, 0},
{"gst_query_new_drain", pFv, 0},
{"gst_query_new_duration", pFi, 0},
{"gst_query_new_formats", pFv, 0},
{"gst_query_new_latency", pFv, 0},
{"gst_query_new_position", pFi, 0},
{"gst_query_new_scheduling", pFv, 0},
{"gst_query_new_seeking", pFi, 0},
{"gst_query_new_segment", pFi, 0},
{"gst_query_new_uri", pFv, 0},
{"gst_query_parse_accept_caps", vFpp, 0},
{"gst_query_parse_accept_caps_result", vFpp, 0},
{"gst_query_parse_allocation", vFppp, 0},
{"gst_query_parse_bitrate", vFpp, 0},
{"gst_query_parse_buffering_percent", vFppp, 0},
{"gst_query_parse_buffering_range", vFppppp, 0},
{"gst_query_parse_buffering_stats", vFppppp, 0},
{"gst_query_parse_caps", vFpp, 0},
{"gst_query_parse_caps_result", vFpp, 0},
{"gst_query_parse_context", vFpp, 0},
{"gst_query_parse_context_type", iFpp, 0},
{"gst_query_parse_convert", vFppppp, 0},
{"gst_query_parse_duration", vFppp, 0},
{"gst_query_parse_latency", vFpppp, 0},
{"gst_query_parse_n_formats", vFpp, 0},
{"gst_query_parse_nth_allocation_meta", pFpup, 0},
{"gst_query_parse_nth_allocation_param", vFpupp, 0},
{"gst_query_parse_nth_allocation_pool", vFpupppp, 0},
{"gst_query_parse_nth_buffering_range", iFpupp, 0},
{"gst_query_parse_nth_format", vFpup, 0},
{"gst_query_parse_nth_scheduling_mode", iFpu, 0},
{"gst_query_parse_position", vFppp, 0},
{"gst_query_parse_scheduling", vFppppp, 0},
{"gst_query_parse_seeking", vFppppp, 0},
{"gst_query_parse_segment", vFppppp, 0},
{"gst_query_parse_uri", vFpp, 0},
{"gst_query_parse_uri_redirection", vFpp, 0},
{"gst_query_parse_uri_redirection_permanent", vFpp, 0},
{"gst_query_ref", pFp, 0},
{"gst_query_remove_nth_allocation_meta", vFpu, 0},
{"gst_query_remove_nth_allocation_param", vFpu, 0},
{"gst_query_remove_nth_allocation_pool", vFpu, 0},
{"gst_query_replace", iFpp, 0},
{"gst_query_set_accept_caps_result", vFpi, 0},
{"gst_query_set_bitrate", vFpu, 0},
{"gst_query_set_buffering_percent", vFpii, 0},
{"gst_query_set_buffering_range", vFpiIII, 0},
{"gst_query_set_buffering_stats", vFpiiiI, 0},
{"gst_query_set_caps_result", vFpp, 0},
{"gst_query_set_context", vFpp, 0},
{"gst_query_set_convert", vFpiIiI, 0},
{"gst_query_set_duration", vFpiI, 0},

{"gst_query_set_formatsv", vFppp, 0},
{"gst_query_set_latency", vFpiUU, 0},
{"gst_query_set_nth_allocation_param", vFpupp, 0},
{"gst_query_set_nth_allocation_pool", vFpupuuu, 0},
{"gst_query_set_position", vFpiI, 0},
{"gst_query_set_scheduling", vFpiiii, 0},
{"gst_query_set_seeking", vFpiiII, 0},
{"gst_query_set_segment", vFpdiII, 0},
{"gst_query_set_uri", vFpp, 0},
{"gst_query_set_uri_redirection", vFpp, 0},
{"gst_query_set_uri_redirection_permanent", vFpi, 0},
{"gst_query_take", iFpp, 0},

{"gst_query_type_flags_get_type", pFv, 0},
{"gst_query_type_get_flags", iFi, 0},
{"gst_query_type_get_name", pFi, 0},
{"gst_query_type_get_type", pFv, 0},
{"gst_query_type_to_quark", pFi, 0},
{"gst_query_unref", vFp, 0},
{"gst_query_writable_structure", pFp, 0},
...
{"gst_registry_get", pFpL, 0},
# 1311 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_sample_copy", pFp, 0},
{"gst_sample_get_buffer", pFp, 0},
{"gst_sample_get_buffer_list", pFp, 0},
{"gst_sample_get_caps", pFp, 0},
{"gst_sample_get_info", pFp, 0},
{"gst_sample_get_segment", pFp, 0},
{"gst_sample_get_type", pFv, 0},
{"gst_sample_new", pFpppp, 0},
{"gst_sample_ref", pFp, 0},
...
{"gst_scheduling_flags_get_type", pFv, 0},
{"gst_search_mode_get_type", pFv, 0},
{"gst_seek_flags_get_type", pFv, 0},
{"gst_seek_type_get_type", pFv, 0},
{"gst_segment_clip", iFpiUUpp, 0},
{"gst_segment_copy", pFp, 0},
{"gst_segment_copy_into", vFpp, 0},
{"gst_segment_do_seek", iFpdiiiUiUp, 0},
{"gst_segment_flags_get_type", pFv, 0},
{"gst_segment_free", vFp, 0},
{"gst_segment_get_type", pFv, 0},
{"gst_segment_init", vFpi, 0},
{"gst_segment_is_equal", iFpp, 0},
{"gst_segment_new", pFv, 0},
{"gst_segment_offset_running_time", iFpiI, 0},
{"gst_segment_position_from_running_time", UFpiU, 0},
{"gst_segment_position_from_running_time_full", iFpiUp, 0},
{"gst_segment_position_from_stream_time", UFpiU, 0},
{"gst_segment_position_from_stream_time_full", iFpiUp, 0},
{"gst_segment_set_running_time", iFpiU, 0},

{"gst_segment_to_running_time", UFpiU, 0},
{"gst_segment_to_running_time_full", iFpiUp, 0},
{"gst_segment_to_stream_time", UFpiU, 0},
{"gst_segment_to_stream_time_full", iFpiUp, 0},
{"gst_segtrap_is_enabled", iFv, 0},
{"gst_segtrap_set_enabled", vFi, 0},
{"gst_stack_trace_flags_get_type", pFv, 0},

{"gst_state_change_get_type", pFv, 0},
{"gst_state_change_return_get_type", pFv, 0},
{"gst_state_get_type", pFv, 0},
{"gst_static_caps_cleanup", vFp, 0},
{"gst_static_caps_get", pFp, 0},
{"gst_static_caps_get_type", pFv, 0},
# 1374 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_stream_get_caps", pFp, 0},



{"gst_stream_get_tags", pFp, 0},

{"gst_stream_new", pFppuu, 0},
{"gst_stream_set_caps", vFpp, 0},

{"gst_stream_set_stream_type", vFpu, 0},
{"gst_stream_set_tags", vFpp, 0},



{"gst_structure_can_intersect", iFpp, 0},

{"gst_structure_copy", pFp, 0},

{"gst_structure_fixate", vFp, 0},
{"gst_structure_fixate_field", iFpp, 0},
{"gst_structure_fixate_field_boolean", iFppi, 0},
{"gst_structure_fixate_field_nearest_double", iFppd, 0},
{"gst_structure_fixate_field_nearest_fraction", iFppii, 0},
{"gst_structure_fixate_field_nearest_int", iFppi, 0},
{"gst_structure_fixate_field_string", iFppp, 0},

{"gst_structure_free", vFp, 0},
{"gst_structure_from_string", pFpp, 0},

{"gst_structure_get_array", iFppp, 0},
{"gst_structure_get_boolean", iFppp, 0},
{"gst_structure_get_clock_time", iFppp, 0},
{"gst_structure_get_date", iFppp, 0},
{"gst_structure_get_date_time", iFppp, 0},
{"gst_structure_get_double", iFppp, 0},
{"gst_structure_get_enum", iFpppp, 0},
{"gst_structure_get_field_type", pFpp, 0},
{"gst_structure_get_flagset", iFpppp, 0},
{"gst_structure_get_fraction", iFpppp, 0},
{"gst_structure_get_int", iFppp, 0},
{"gst_structure_get_int64", iFppp, 0},
{"gst_structure_get_list", iFppp, 0},
{"gst_structure_get_name", pFp, 0},
{"gst_structure_get_name_id", pFp, 0},
{"gst_structure_get_string", pFpp, 0},
{"gst_structure_get_type", pFv, 0},
{"gst_structure_get_uint", iFppp, 0},
{"gst_structure_get_uint64", iFppp, 0},

{"gst_structure_get_value", pFpp, 0},
{"gst_structure_has_field", iFpp, 0},
{"gst_structure_has_field_typed", iFppp, 0},
{"gst_structure_has_name", iFpp, 0},


{"gst_structure_id_get_value", pFpp, 0},
{"gst_structure_id_has_field", iFpp, 0},
{"gst_structure_id_has_field_typed", iFppp, 0},


{"gst_structure_id_set_value", vFppp, 0},
{"gst_structure_id_take_value", pFppp, 0},
{"gst_structure_intersect", pFpp, 0},
{"gst_structure_is_equal", iFpp, 0},
{"gst_structure_is_subset", iFpp, 0},


{"gst_structure_new_empty", pFp, 0},
{"gst_structure_new_from_string", pFp, 0},

{"gst_structure_new_id_empty", pFp, 0},
{"gst_structure_new_valist", pFppp, 0},
{"gst_structure_n_fields", iFp, 0},
{"gst_structure_nth_field_name", pFpu, 0},
{"gst_structure_remove_all_fields", vFp, 0},
{"gst_structure_remove_field", vFpp, 0},

{"gst_structure_remove_fields_valist", vFppp, 0},

{"gst_structure_set_array", vFppp, 0},
{"gst_structure_set_list", vFppp, 0},
{"gst_structure_set_name", vFpp, 0},
{"gst_structure_set_parent_refcount", iFpp, 0},

{"gst_structure_set_value", vFppp, 0},
{"gst_structure_take", iFpp, 0},
{"gst_structure_take_value", vFppp, 0},
{"gst_structure_to_string", pFp, 0},
# 1476 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_tag_list_add_value", vFpipp, 0},

{"gst_tag_list_copy", pFp, 0},
{"gst_tag_list_copy_value", iFppp, 0},

{"gst_tag_list_get_boolean", iFppp, 0},
{"gst_tag_list_get_boolean_index", iFppup, 0},
{"gst_tag_list_get_date", iFppp, 0},
{"gst_tag_list_get_date_index", iFppup, 0},
{"gst_tag_list_get_date_time", iFppp, 0},
{"gst_tag_list_get_date_time_index", iFppup, 0},
{"gst_tag_list_get_double", iFppp, 0},
{"gst_tag_list_get_double_index", iFppup, 0},
{"gst_tag_list_get_float", iFppp, 0},
{"gst_tag_list_get_float_index", iFppup, 0},
{"gst_tag_list_get_int", iFppp, 0},
{"gst_tag_list_get_int64", iFppp, 0},
{"gst_tag_list_get_int64_index", iFppup, 0},
{"gst_tag_list_get_int_index", iFppup, 0},
{"gst_tag_list_get_pointer", iFppp, 0},
{"gst_tag_list_get_pointer_index", iFppup, 0},
{"gst_tag_list_get_sample", iFppp, 0},
{"gst_tag_list_get_sample_index", iFppup, 0},
{"gst_tag_list_get_scope", iFp, 0},
{"gst_tag_list_get_string", iFppp, 0},
{"gst_tag_list_get_string_index", iFppup, 0},
{"gst_tag_list_get_tag_size", uFpp, 0},
{"gst_tag_list_get_type", pFv, 0},
{"gst_tag_list_get_uint", iFppp, 0},
{"gst_tag_list_get_uint64", iFppp, 0},
{"gst_tag_list_get_uint64_index", iFppup, 0},
{"gst_tag_list_get_uint_index", iFppup, 0},
{"gst_tag_list_get_value_index", pFppu, 0},
{"gst_tag_list_insert", vFppi, 0},
{"gst_tag_list_is_empty", iFp, 0},
{"gst_tag_list_is_equal", iFpp, 0},
{"gst_tag_list_merge", pFppi, 0},

{"gst_tag_list_new_empty", pFv, 0},
{"gst_tag_list_new_from_string", pFp, 0},

{"gst_tag_list_n_tags", iFp, 0},
{"gst_tag_list_nth_tag_name", pFpu, 0},
{"gst_tag_list_peek_string_index", iFppup, 0},
{"gst_tag_list_ref", pFp, 0},
{"gst_tag_list_remove_tag", vFpp, 0},
{"gst_tag_list_replace", iFpp, 0},
{"gst_tag_list_set_scope", vFpi, 0},
{"gst_tag_list_take", iFpp, 0},
{"gst_tag_list_to_string", pFp, 0},

{"gst_tag_list_unref", vFp, 0},
{"gst_tag_merge_mode_get_type", pFv, 0},
# 1709 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_util_set_object_arg", vFppp, 0},


{"gst_util_uint64_scale", UFUUU, 0},
# 1784 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_version", vFpppp, 0},
{"gst_version_string", pFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gstreamermysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
...
{"gst_buffer_new_wrapped_full", pFEiplllpp, 0},
...
{"gst_bus_set_sync_handler", vFEpppp, 0},
...
{"gst_caps_set_simple", vFEppV, 0},
{"gst_caps_set_simple_valist", vFEppp, 0},
...
{"gst_mini_object_set_qdata", vFEpppp, 0},
...
{"gst_pad_set_activatemode_function_full", vFEpppp, 0},

{"gst_pad_set_chain_function_full", vFEpppp, 0},



{"gst_pad_set_event_function_full", vFEpppp, 0},
{"gst_pad_set_getrange_function_full", vFEpppp, 0},



{"gst_pad_set_query_function_full", vFEpppp, 0},
...
{"gst_registry_feature_filter", pFEppip, 0},
...
{"gst_structure_get_valist", iFEppp, 0},
...
static const map_onesymbol_t gstreamerstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
...
static const map_onesymbol2_t gstreamersymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
...
# 440 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
{"gst_debug_log", vFpippippV, 0, "gst_debug_log_valist"},
...
{"gst_structure_new", pFppV, 0, "gst_structure_new_valist"},
...
{"gst_structure_remove_fields", vFppV, 0, "gst_structure_remove_fields_valist"},
...
static const map_onedata_t gstreamerdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
...
{"_gst_bitmask_type", sizeof(void*), 0},
...
{"_gst_buffer_type", sizeof(void*), 0},
...
{"_gst_fraction_type", sizeof(void*), 0},
...
{"_gst_sample_type", sizeof(long), 0},
...
static const map_onedata_t gstreamermydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstreamerundefs.h" 1
...
int wrappedgstreamer_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(gstreamerName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gstreamerName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gstreamersymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstreamersymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gstreamersymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gstreamersymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gstreamersymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gstreamersymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gstreamersymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstreamersymbolmap[i].name); }
 cnt = sizeof(gstreamermysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstreamermysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gstreamermysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gstreamermysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gstreamermysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gstreamermysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gstreamermysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstreamermysymbolmap[i].name); }

    cnt = sizeof(gstreamerstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gstreamerstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gstreamerstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gstreamerstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gstreamerstsymbolmap[i].name);
    }
    cnt = sizeof(gstreamersymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gstreamersymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gstreamersymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gstreamersymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gstreamersymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gstreamersymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gstreamersymbol2map[i].name);
    }
    cnt = sizeof(gstreamerdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gstreamerdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gstreamerdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gstreamerdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gstreamerdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gstreamerdatamap[i].sz;
        }
    }
    cnt = sizeof(gstreamermydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gstreamermydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gstreamermydatamap[i].sz;
    }

    getMy(lib); SetGstObjectID(my->gst_object_get_type()); SetGstAllocatorID(my->gst_allocator_get_type()); setNeededLibs(lib, 1, "libgtk-3.so.0");


    return 0;
}

void wrappedgstreamer_fini(library_t* lib)
{
...
# 372 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstreamer.c" 2
