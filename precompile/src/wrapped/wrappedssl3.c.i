# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2

const char* ssl3Name = "libssl3.so";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedssl3types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedssl3types.h"
typedef int32_t (*iFppp_t)(void*, void*, void*);
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
...
typedef struct ssl3_my_s {
    ...
    iFppp_t SSL_AuthCertificateHook; iFppp_t SSL_BadCertHook;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static ssl3_my_t my_ssl3 = {0};
static ssl3_my_t * const my = &my_ssl3;

static void getMy(library_t* lib)
{

    my->SSL_AuthCertificateHook = (iFppp_t)dlsym(lib->w.lib, "SSL_AuthCertificateHook"); my->SSL_BadCertHook = (iFppp_t)dlsym(lib->w.lib, "SSL_BadCertHook");
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
static uintptr_t my_SSLBadCertHandler_fct_0 = 0; static int my_SSLBadCertHandler_0(void* a, void* b) { return RunFunctionFmt(my_SSLBadCertHandler_fct_0, "pp", a, b);} static uintptr_t my_SSLBadCertHandler_fct_1 = 0; static int my_SSLBadCertHandler_1(void* a, void* b) { return RunFunctionFmt(my_SSLBadCertHandler_fct_1, "pp", a, b);} static uintptr_t my_SSLBadCertHandler_fct_2 = 0; static int my_SSLBadCertHandler_2(void* a, void* b) { return RunFunctionFmt(my_SSLBadCertHandler_fct_2, "pp", a, b);} static uintptr_t my_SSLBadCertHandler_fct_3 = 0; static int my_SSLBadCertHandler_3(void* a, void* b) { return RunFunctionFmt(my_SSLBadCertHandler_fct_3, "pp", a, b);} static uintptr_t my_SSLBadCertHandler_fct_4 = 0; static int my_SSLBadCertHandler_4(void* a, void* b) { return RunFunctionFmt(my_SSLBadCertHandler_fct_4, "pp", a, b);}
...
static void* find_SSLBadCertHandler_Fct(void* fct)
{
    ...
    if(my_SSLBadCertHandler_fct_0 == (uintptr_t)fct) return my_SSLBadCertHandler_0; if(my_SSLBadCertHandler_fct_1 == (uintptr_t)fct) return my_SSLBadCertHandler_1; if(my_SSLBadCertHandler_fct_2 == (uintptr_t)fct) return my_SSLBadCertHandler_2; if(my_SSLBadCertHandler_fct_3 == (uintptr_t)fct) return my_SSLBadCertHandler_3; if(my_SSLBadCertHandler_fct_4 == (uintptr_t)fct) return my_SSLBadCertHandler_4;


    if(my_SSLBadCertHandler_fct_0 == 0) {my_SSLBadCertHandler_fct_0 = (uintptr_t)fct; return my_SSLBadCertHandler_0; } if(my_SSLBadCertHandler_fct_1 == 0) {my_SSLBadCertHandler_fct_1 = (uintptr_t)fct; return my_SSLBadCertHandler_1; } if(my_SSLBadCertHandler_fct_2 == 0) {my_SSLBadCertHandler_fct_2 = (uintptr_t)fct; return my_SSLBadCertHandler_2; } if(my_SSLBadCertHandler_fct_3 == 0) {my_SSLBadCertHandler_fct_3 = (uintptr_t)fct; return my_SSLBadCertHandler_3; } if(my_SSLBadCertHandler_fct_4 == 0) {my_SSLBadCertHandler_fct_4 = (uintptr_t)fct; return my_SSLBadCertHandler_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for ssl3 SSLBadCertHandler callback\n"); fflush(ftrace);}} while(0);
    return 
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 3 4
          ((void *)0)
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
              ;
}
# 65 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
static uintptr_t my_SSLAuthCertificate_fct_0 = 0; static int my_SSLAuthCertificate_0(void* a, void* b, int c, int d) { return RunFunctionFmt(my_SSLAuthCertificate_fct_0, "ppii", a, b, c, d); } static uintptr_t my_SSLAuthCertificate_fct_1 = 0; static int my_SSLAuthCertificate_1(void* a, void* b, int c, int d) { return RunFunctionFmt(my_SSLAuthCertificate_fct_1, "ppii", a, b, c, d); } static uintptr_t my_SSLAuthCertificate_fct_2 = 0; static int my_SSLAuthCertificate_2(void* a, void* b, int c, int d) { return RunFunctionFmt(my_SSLAuthCertificate_fct_2, "ppii", a, b, c, d); } static uintptr_t my_SSLAuthCertificate_fct_3 = 0; static int my_SSLAuthCertificate_3(void* a, void* b, int c, int d) { return RunFunctionFmt(my_SSLAuthCertificate_fct_3, "ppii", a, b, c, d); } static uintptr_t my_SSLAuthCertificate_fct_4 = 0; static int my_SSLAuthCertificate_4(void* a, void* b, int c, int d) { return RunFunctionFmt(my_SSLAuthCertificate_fct_4, "ppii", a, b, c, d); }
...
static void* find_SSLAuthCertificate_Fct(void* fct)
{
    ...
    if(my_SSLAuthCertificate_fct_0 == (uintptr_t)fct) return my_SSLAuthCertificate_0; if(my_SSLAuthCertificate_fct_1 == (uintptr_t)fct) return my_SSLAuthCertificate_1; if(my_SSLAuthCertificate_fct_2 == (uintptr_t)fct) return my_SSLAuthCertificate_2; if(my_SSLAuthCertificate_fct_3 == (uintptr_t)fct) return my_SSLAuthCertificate_3; if(my_SSLAuthCertificate_fct_4 == (uintptr_t)fct) return my_SSLAuthCertificate_4;


    if(my_SSLAuthCertificate_fct_0 == 0) {my_SSLAuthCertificate_fct_0 = (uintptr_t)fct; return my_SSLAuthCertificate_0; } if(my_SSLAuthCertificate_fct_1 == 0) {my_SSLAuthCertificate_fct_1 = (uintptr_t)fct; return my_SSLAuthCertificate_1; } if(my_SSLAuthCertificate_fct_2 == 0) {my_SSLAuthCertificate_fct_2 = (uintptr_t)fct; return my_SSLAuthCertificate_2; } if(my_SSLAuthCertificate_fct_3 == 0) {my_SSLAuthCertificate_fct_3 = (uintptr_t)fct; return my_SSLAuthCertificate_3; } if(my_SSLAuthCertificate_fct_4 == 0) {my_SSLAuthCertificate_fct_4 = (uintptr_t)fct; return my_SSLAuthCertificate_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for ssl3 SSLAuthCertificate callback\n"); fflush(ftrace);}} while(0);
    return 
# 78 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 3 4
          ((void *)0)
# 78 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c"
              ;
}



__attribute__((visibility("default"))) int my_SSL_BadCertHook(x86emu_t* emu, void* fd, void* f, void* arg)
{
    (void)emu;
    return my->SSL_BadCertHook(fd, find_SSLBadCertHandler_Fct(f), arg);
}

__attribute__((visibility("default"))) int my_SSL_AuthCertificateHook(x86emu_t* emu, void* fd, void* f, void* arg)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedssl3defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ssl3symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
{"NSS_SetDomesticPolicy", iFv, 0},
...
{"SSL_AuthCertificate", iFppii, 0},



# 41 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
{"SSL_ForceHandshake", iFp, 0},
# 58 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
{"SSL_ImportFD", pFpp, 0},
...
{"SSL_OptionSet", iFpil, 0},
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
{"SSL_ResetHandshake", iFpi, 0},
# 97 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
{"SSL_SetURL", iFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ssl3mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
{"SSL_AuthCertificateHook", iFEppp, 0},
{"SSL_BadCertHook", iFEppp, 0},
# 41 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
static const map_onesymbol_t ssl3stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
static const map_onesymbol2_t ssl3symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
static const map_onedata_t ssl3datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
static const map_onedata_t ssl3mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h" 1
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedssl3undefs.h" 1
...
int wrappedssl3_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(ssl3Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(ssl3symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ssl3symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, ssl3symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = ssl3symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, ssl3symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = ssl3symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(ssl3symbolmap[i].name, '@')) AddDictionnary(box86->versym, ssl3symbolmap[i].name); }
 cnt = sizeof(ssl3mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ssl3mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, ssl3mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = ssl3mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, ssl3mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = ssl3mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(ssl3mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, ssl3mysymbolmap[i].name); }

    cnt = sizeof(ssl3stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, ssl3stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = ssl3stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(ssl3stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, ssl3stsymbolmap[i].name);
    }
    cnt = sizeof(ssl3symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, ssl3symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = ssl3symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = ssl3symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = ssl3symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(ssl3symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, ssl3symbol2map[i].name);
    }
    cnt = sizeof(ssl3datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(ssl3datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, ssl3datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = ssl3datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, ssl3datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = ssl3datamap[i].sz;
        }
    }
    cnt = sizeof(ssl3mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, ssl3mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = ssl3mydatamap[i].sz;
    }
...
void wrappedssl3_fini(library_t* lib)
{
...
# 102 "/home/ssd/pico/code/box86/src/wrapped/wrappedssl3.c" 2
