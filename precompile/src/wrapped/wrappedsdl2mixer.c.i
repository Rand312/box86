# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2mixertypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2mixertypes.h"
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
...
typedef struct sdl2mixer_my_s {
    ...
    iFiwC_t Mix_SetPosition; vFp_t Mix_ChannelFinished; vFp_t Mix_HookMusicFinished; vFpp_t Mix_HookMusic; vFpp_t Mix_SetPostMix; iFiw_t MinorityMix_SetPosition; iFip_t Mix_UnregisterEffect; pFpi_t Mix_LoadMUS_RW; pFpi_t Mix_LoadWAV_RW; pFpii_t Mix_LoadMUSType_RW; iFippp_t Mix_RegisterEffect;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static sdl2mixer_my_t my_sdl2mixer = {0};
static sdl2mixer_my_t * const my = &my_sdl2mixer;

static void getMy(library_t* lib)
{

    my->Mix_SetPosition = (iFiwC_t)dlsym(lib->w.lib, "Mix_SetPosition"); my->Mix_ChannelFinished = (vFp_t)dlsym(lib->w.lib, "Mix_ChannelFinished"); my->Mix_HookMusicFinished = (vFp_t)dlsym(lib->w.lib, "Mix_HookMusicFinished"); my->Mix_HookMusic = (vFpp_t)dlsym(lib->w.lib, "Mix_HookMusic"); my->Mix_SetPostMix = (vFpp_t)dlsym(lib->w.lib, "Mix_SetPostMix"); my->MinorityMix_SetPosition = (iFiw_t)dlsym(lib->w.lib, "MinorityMix_SetPosition"); my->Mix_UnregisterEffect = (iFip_t)dlsym(lib->w.lib, "Mix_UnregisterEffect"); my->Mix_LoadMUS_RW = (pFpi_t)dlsym(lib->w.lib, "Mix_LoadMUS_RW"); my->Mix_LoadWAV_RW = (pFpi_t)dlsym(lib->w.lib, "Mix_LoadWAV_RW"); my->Mix_LoadMUSType_RW = (pFpii_t)dlsym(lib->w.lib, "Mix_LoadMUSType_RW"); my->Mix_RegisterEffect = (iFippp_t)dlsym(lib->w.lib, "Mix_RegisterEffect");
...
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
# 45 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
static uintptr_t my_EffectFunc_fct_0 = 0; static void my_EffectFunc_0(int chan, void *stream, int len, void *udata) { RunFunctionFmt(my_EffectFunc_fct_0, "ipip", chan, stream, len, udata);} static uintptr_t my_EffectFunc_fct_1 = 0; static void my_EffectFunc_1(int chan, void *stream, int len, void *udata) { RunFunctionFmt(my_EffectFunc_fct_1, "ipip", chan, stream, len, udata);} static uintptr_t my_EffectFunc_fct_2 = 0; static void my_EffectFunc_2(int chan, void *stream, int len, void *udata) { RunFunctionFmt(my_EffectFunc_fct_2, "ipip", chan, stream, len, udata);} static uintptr_t my_EffectFunc_fct_3 = 0; static void my_EffectFunc_3(int chan, void *stream, int len, void *udata) { RunFunctionFmt(my_EffectFunc_fct_3, "ipip", chan, stream, len, udata);} static uintptr_t my_EffectFunc_fct_4 = 0; static void my_EffectFunc_4(int chan, void *stream, int len, void *udata) { RunFunctionFmt(my_EffectFunc_fct_4, "ipip", chan, stream, len, udata);}

static void* find_EffectFunc_Fct(void* fct)
{
    if(!fct) return 
# 49 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
                   ((void *)0)
# 49 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_EffectFunc_fct_0 == (uintptr_t)fct) return my_EffectFunc_0; if(my_EffectFunc_fct_1 == (uintptr_t)fct) return my_EffectFunc_1; if(my_EffectFunc_fct_2 == (uintptr_t)fct) return my_EffectFunc_2; if(my_EffectFunc_fct_3 == (uintptr_t)fct) return my_EffectFunc_3; if(my_EffectFunc_fct_4 == (uintptr_t)fct) return my_EffectFunc_4;


    if(my_EffectFunc_fct_0 == 0) {my_EffectFunc_fct_0 = (uintptr_t)fct; return my_EffectFunc_0; } if(my_EffectFunc_fct_1 == 0) {my_EffectFunc_fct_1 = (uintptr_t)fct; return my_EffectFunc_1; } if(my_EffectFunc_fct_2 == 0) {my_EffectFunc_fct_2 = (uintptr_t)fct; return my_EffectFunc_2; } if(my_EffectFunc_fct_3 == 0) {my_EffectFunc_fct_3 = (uintptr_t)fct; return my_EffectFunc_3; } if(my_EffectFunc_fct_4 == 0) {my_EffectFunc_fct_4 = (uintptr_t)fct; return my_EffectFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for SDL1Mixer EffectFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
          ((void *)0)
# 59 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
              ;
}
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
static uintptr_t my_EffectDone_fct_0 = 0; static void my_EffectDone_0(int chan, void *udata) { RunFunctionFmt(my_EffectDone_fct_0, "ip", chan, udata); } static uintptr_t my_EffectDone_fct_1 = 0; static void my_EffectDone_1(int chan, void *udata) { RunFunctionFmt(my_EffectDone_fct_1, "ip", chan, udata); } static uintptr_t my_EffectDone_fct_2 = 0; static void my_EffectDone_2(int chan, void *udata) { RunFunctionFmt(my_EffectDone_fct_2, "ip", chan, udata); } static uintptr_t my_EffectDone_fct_3 = 0; static void my_EffectDone_3(int chan, void *udata) { RunFunctionFmt(my_EffectDone_fct_3, "ip", chan, udata); } static uintptr_t my_EffectDone_fct_4 = 0; static void my_EffectDone_4(int chan, void *udata) { RunFunctionFmt(my_EffectDone_fct_4, "ip", chan, udata); }

static void* find_EffectDone_Fct(void* fct)
{
    if(!fct) return 
# 73 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
                   ((void *)0)
# 73 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_EffectDone_fct_0 == (uintptr_t)fct) return my_EffectDone_0; if(my_EffectDone_fct_1 == (uintptr_t)fct) return my_EffectDone_1; if(my_EffectDone_fct_2 == (uintptr_t)fct) return my_EffectDone_2; if(my_EffectDone_fct_3 == (uintptr_t)fct) return my_EffectDone_3; if(my_EffectDone_fct_4 == (uintptr_t)fct) return my_EffectDone_4;


    if(my_EffectDone_fct_0 == 0) {my_EffectDone_fct_0 = (uintptr_t)fct; return my_EffectDone_0; } if(my_EffectDone_fct_1 == 0) {my_EffectDone_fct_1 = (uintptr_t)fct; return my_EffectDone_1; } if(my_EffectDone_fct_2 == 0) {my_EffectDone_fct_2 = (uintptr_t)fct; return my_EffectDone_2; } if(my_EffectDone_fct_3 == 0) {my_EffectDone_fct_3 = (uintptr_t)fct; return my_EffectDone_3; } if(my_EffectDone_fct_4 == 0) {my_EffectDone_fct_4 = (uintptr_t)fct; return my_EffectDone_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for SDL1Mixer EffectDone callback\n"); fflush(ftrace);}} while(0);
    return 
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
          ((void *)0)
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
              ;
}
# 93 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
static uintptr_t my_MixFunc_fct_0 = 0; static void my_MixFunc_0(void *udata, uint8_t *stream, int len) { RunFunctionFmt(my_MixFunc_fct_0, "ppi", udata, stream, len); } static uintptr_t my_MixFunc_fct_1 = 0; static void my_MixFunc_1(void *udata, uint8_t *stream, int len) { RunFunctionFmt(my_MixFunc_fct_1, "ppi", udata, stream, len); } static uintptr_t my_MixFunc_fct_2 = 0; static void my_MixFunc_2(void *udata, uint8_t *stream, int len) { RunFunctionFmt(my_MixFunc_fct_2, "ppi", udata, stream, len); } static uintptr_t my_MixFunc_fct_3 = 0; static void my_MixFunc_3(void *udata, uint8_t *stream, int len) { RunFunctionFmt(my_MixFunc_fct_3, "ppi", udata, stream, len); } static uintptr_t my_MixFunc_fct_4 = 0; static void my_MixFunc_4(void *udata, uint8_t *stream, int len) { RunFunctionFmt(my_MixFunc_fct_4, "ppi", udata, stream, len); }

static void* find_MixFunc_Fct(void* fct)
{
    if(!fct) return 
# 97 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
                   ((void *)0)
# 97 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_MixFunc_fct_0 == (uintptr_t)fct) return my_MixFunc_0; if(my_MixFunc_fct_1 == (uintptr_t)fct) return my_MixFunc_1; if(my_MixFunc_fct_2 == (uintptr_t)fct) return my_MixFunc_2; if(my_MixFunc_fct_3 == (uintptr_t)fct) return my_MixFunc_3; if(my_MixFunc_fct_4 == (uintptr_t)fct) return my_MixFunc_4;


    if(my_MixFunc_fct_0 == 0) {my_MixFunc_fct_0 = (uintptr_t)fct; return my_MixFunc_0; } if(my_MixFunc_fct_1 == 0) {my_MixFunc_fct_1 = (uintptr_t)fct; return my_MixFunc_1; } if(my_MixFunc_fct_2 == 0) {my_MixFunc_fct_2 = (uintptr_t)fct; return my_MixFunc_2; } if(my_MixFunc_fct_3 == 0) {my_MixFunc_fct_3 = (uintptr_t)fct; return my_MixFunc_3; } if(my_MixFunc_fct_4 == 0) {my_MixFunc_fct_4 = (uintptr_t)fct; return my_MixFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for SDL1Mixer MixFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
          ((void *)0)
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
              ;
}
# 117 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
static uintptr_t my_ChannelFinished_fct_0 = 0; static void my_ChannelFinished_0(int channel) { RunFunctionFmt(my_ChannelFinished_fct_0, "i", channel); } static uintptr_t my_ChannelFinished_fct_1 = 0; static void my_ChannelFinished_1(int channel) { RunFunctionFmt(my_ChannelFinished_fct_1, "i", channel); } static uintptr_t my_ChannelFinished_fct_2 = 0; static void my_ChannelFinished_2(int channel) { RunFunctionFmt(my_ChannelFinished_fct_2, "i", channel); } static uintptr_t my_ChannelFinished_fct_3 = 0; static void my_ChannelFinished_3(int channel) { RunFunctionFmt(my_ChannelFinished_fct_3, "i", channel); } static uintptr_t my_ChannelFinished_fct_4 = 0; static void my_ChannelFinished_4(int channel) { RunFunctionFmt(my_ChannelFinished_fct_4, "i", channel); }

static void* find_ChannelFinished_Fct(void* fct)
{
    if(!fct) return 
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
                   ((void *)0)
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_ChannelFinished_fct_0 == (uintptr_t)fct) return my_ChannelFinished_0; if(my_ChannelFinished_fct_1 == (uintptr_t)fct) return my_ChannelFinished_1; if(my_ChannelFinished_fct_2 == (uintptr_t)fct) return my_ChannelFinished_2; if(my_ChannelFinished_fct_3 == (uintptr_t)fct) return my_ChannelFinished_3; if(my_ChannelFinished_fct_4 == (uintptr_t)fct) return my_ChannelFinished_4;


    if(my_ChannelFinished_fct_0 == 0) {my_ChannelFinished_fct_0 = (uintptr_t)fct; return my_ChannelFinished_0; } if(my_ChannelFinished_fct_1 == 0) {my_ChannelFinished_fct_1 = (uintptr_t)fct; return my_ChannelFinished_1; } if(my_ChannelFinished_fct_2 == 0) {my_ChannelFinished_fct_2 = (uintptr_t)fct; return my_ChannelFinished_2; } if(my_ChannelFinished_fct_3 == 0) {my_ChannelFinished_fct_3 = (uintptr_t)fct; return my_ChannelFinished_3; } if(my_ChannelFinished_fct_4 == 0) {my_ChannelFinished_fct_4 = (uintptr_t)fct; return my_ChannelFinished_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for SDL1Mixer ChannelFinished callback\n"); fflush(ftrace);}} while(0);
    return 
# 131 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
          ((void *)0)
# 131 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
              ;
}
# 141 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
static uintptr_t my_MusicFinished_fct_0 = 0; static void my_MusicFinished_0() { RunFunctionFmt(my_MusicFinished_fct_0, ""); } static uintptr_t my_MusicFinished_fct_1 = 0; static void my_MusicFinished_1() { RunFunctionFmt(my_MusicFinished_fct_1, ""); } static uintptr_t my_MusicFinished_fct_2 = 0; static void my_MusicFinished_2() { RunFunctionFmt(my_MusicFinished_fct_2, ""); } static uintptr_t my_MusicFinished_fct_3 = 0; static void my_MusicFinished_3() { RunFunctionFmt(my_MusicFinished_fct_3, ""); } static uintptr_t my_MusicFinished_fct_4 = 0; static void my_MusicFinished_4() { RunFunctionFmt(my_MusicFinished_fct_4, ""); }

static void* find_MusicFinished_Fct(void* fct)
{
    if(!fct) return 
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
                   ((void *)0)
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
                       ;
    void* p;
    if((p = GetNativeFnc((uintptr_t)fct))) return p;

    if(my_MusicFinished_fct_0 == (uintptr_t)fct) return my_MusicFinished_0; if(my_MusicFinished_fct_1 == (uintptr_t)fct) return my_MusicFinished_1; if(my_MusicFinished_fct_2 == (uintptr_t)fct) return my_MusicFinished_2; if(my_MusicFinished_fct_3 == (uintptr_t)fct) return my_MusicFinished_3; if(my_MusicFinished_fct_4 == (uintptr_t)fct) return my_MusicFinished_4;


    if(my_MusicFinished_fct_0 == 0) {my_MusicFinished_fct_0 = (uintptr_t)fct; return my_MusicFinished_0; } if(my_MusicFinished_fct_1 == 0) {my_MusicFinished_fct_1 = (uintptr_t)fct; return my_MusicFinished_1; } if(my_MusicFinished_fct_2 == 0) {my_MusicFinished_fct_2 = (uintptr_t)fct; return my_MusicFinished_2; } if(my_MusicFinished_fct_3 == 0) {my_MusicFinished_fct_3 = (uintptr_t)fct; return my_MusicFinished_3; } if(my_MusicFinished_fct_4 == 0) {my_MusicFinished_fct_4 = (uintptr_t)fct; return my_MusicFinished_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for SDL1Mixer MusicFinished callback\n"); fflush(ftrace);}} while(0);
    return 
# 155 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 3 4
          ((void *)0)
# 155 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
              ;
}



__attribute__((visibility("default"))) void* my2_Mix_LoadMUSType_RW(x86emu_t* emu, void* a, int32_t b, int32_t c)
{
...
__attribute__((visibility("default"))) void* my2_Mix_LoadMUS_RW(x86emu_t* emu, void* a, int32_t f)
{
    SDL2_RWops_t *rw = RWNativeStart2(emu, (SDL2_RWops_t*)a);
...
__attribute__((visibility("default"))) void* my2_Mix_LoadWAV_RW(x86emu_t* emu, void* a, int32_t f)
{
    SDL2_RWops_t *rw = RWNativeStart2(emu, (SDL2_RWops_t*)a);
...
__attribute__((visibility("default"))) void my2_Mix_SetPostMix(x86emu_t* emu, void* a, void* b)
{
    (void)emu;
    my->Mix_SetPostMix(find_MixFunc_Fct(a), b);
}

__attribute__((visibility("default"))) int32_t my2_Mix_RegisterEffect(x86emu_t*emu, int32_t channel, void* cb_effect, void* cb_done, void* arg)
{
    (void)emu;
    return my->Mix_RegisterEffect(channel, find_EffectFunc_Fct(cb_effect), find_EffectDone_Fct(cb_done), arg);
}

__attribute__((visibility("default"))) int32_t my2_Mix_UnregisterEffect(x86emu_t* emu, int channel, void* f)
{
    (void)emu;
    return my->Mix_UnregisterEffect(channel, find_EffectFunc_Fct(f));
}

__attribute__((visibility("default"))) void my2_Mix_ChannelFinished(x86emu_t* emu, void* cb)
{
    (void)emu;
    my->Mix_ChannelFinished(find_ChannelFinished_Fct(cb));
}

__attribute__((visibility("default"))) void my2_Mix_HookMusic(x86emu_t* emu, void* f, void* arg)
{
    (void)emu;
    my->Mix_HookMusic(find_MixFunc_Fct(f), arg);
}

__attribute__((visibility("default"))) void my2_Mix_HookMusicFinished(x86emu_t* emu, void* f)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my2_MinorityMix_SetPosition(x86emu_t* emu, int channel, int16_t angle)
{
    (void)emu;
    return my->Mix_SetPosition(channel, angle, 0);
}
# 237 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2mixerdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t sdl2mixersymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
{"Mix_AllocateChannels", iFi, 0},

{"Mix_CloseAudio", vFv, 0},

{"Mix_ExpireChannel", iFii, 0},
{"Mix_FadeInChannelTimed", iFipiii, 0},
{"Mix_FadeInMusic", iFpii, 0},
{"Mix_FadeInMusicPos", iFpiid, 0},
{"Mix_FadeOutChannel", iFii, 0},
{"Mix_FadeOutGroup", iFii, 0},
{"Mix_FadeOutMusic", iFi, 0},
{"Mix_FadingChannel", iFi, 0},
{"Mix_FadingMusic", iFv, 0},
{"Mix_FreeChunk", vFp, 0},
{"Mix_FreeMusic", vFp, 0},
{"Mix_GetChunk", pFi, 0},
{"Mix_GetChunkDecoder", pFi, 0},
{"Mix_GetMusicDecoder", pFi, 0},
{"Mix_GetMusicHookData", pFv, 0},
{"Mix_GetMusicType", iFp, 0},
{"Mix_GetNumChunkDecoders", iFv, 0},
{"Mix_GetNumMusicDecoders", iFv, 0},
{"Mix_GetSoundFonts", pFv, 0},
{"Mix_GetSynchroValue", iFv, 0},
{"Mix_GroupAvailable", iFi, 0},
{"Mix_GroupChannel", iFii, 0},
{"Mix_GroupChannels", iFiii, 0},
{"Mix_GroupCount", iFi, 0},
{"Mix_GroupNewer", iFi, 0},
{"Mix_GroupOldest", iFi, 0},
{"Mix_HaltChannel", iFi, 0},
{"Mix_HaltGroup", iFi, 0},
{"Mix_HaltMusic", iFv, 0},
...
{"Mix_Init", iFi, 0},
{"Mix_Linked_Version", pFv, 0},
{"Mix_LoadMUS", pFp, 0},



{"Mix_OpenAudio", iFiuii, 0},
{"Mix_OpenAudioDevice", iFiuiipi, 0},
{"Mix_Pause", vFi, 0},
{"Mix_PauseMusic", vFv, 0},
{"Mix_Paused", iFi, 0},
{"Mix_PausedMusic", iFv, 0},
{"Mix_PlayChannelTimed", iFipii, 0},
{"Mix_PlayMusic", iFpi, 0},
{"Mix_Playing", iFi, 0},
{"Mix_PlayingMusic", iFv, 0},
{"Mix_QuerySpec", iFppp, 0},
{"Mix_QuickLoad_RAW", pFpu, 0},
{"Mix_QuickLoad_WAV", pFp, 0},
{"Mix_Quit", vFv, 0},

{"Mix_ReserveChannels", iFi, 0},
{"Mix_Resume", vFi, 0},
{"Mix_ResumeMusic", vFv, 0},
{"Mix_RewindMusic", vFv, 0},
{"Mix_SetDistance", iFiu, 0},
{"Mix_SetMusicCMD", iFp, 0},
{"Mix_SetMusicPosition", iFd, 0},
{"Mix_SetPanning", iFiuu, 0},
{"Mix_SetPosition", iFiwC, 0},


{"Mix_SetReverseStereo", iFii, 0},
{"Mix_SetSoundFonts", iFp, 0},
{"Mix_SetSynchroValue", iFi, 0},
{"Mix_UnregisterAllEffects", iFi, 0},

{"Mix_Volume", iFii, 0},
{"Mix_VolumeChunk", iFpi, 0},
{"Mix_VolumeMusic", iFi, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t sdl2mixermysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
{"Mix_HookMusic", vFEpp, 0},
{"Mix_HookMusicFinished", vFEp, 0},



{"Mix_LoadMUSType_RW", pFEpii, 0},
{"Mix_LoadMUS_RW", pFEpi, 0},
{"Mix_LoadWAV_RW", pFEpi, 0},
...
{"MinorityMix_SetPosition", iFEiw, 0},
{"Mix_SetPostMix", vFEpp, 0},




{"Mix_UnregisterEffect", iFEip, 0},
...
static const map_onesymbol_t sdl2mixerstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
static const map_onesymbol2_t sdl2mixersymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
static const map_onedata_t sdl2mixerdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
static const map_onedata_t sdl2mixermydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsdl2mixerundefs.h" 1
...
int wrappedsdl2mixer_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(sdl2mixerName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(sdl2mixerName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(sdl2mixersymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (sdl2mixersymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, sdl2mixersymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = sdl2mixersymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, sdl2mixersymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = sdl2mixersymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(sdl2mixersymbolmap[i].name, '@')) AddDictionnary(box86->versym, sdl2mixersymbolmap[i].name); }
 cnt = sizeof(sdl2mixermysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (sdl2mixermysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, sdl2mixermysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = sdl2mixermysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, sdl2mixermysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = sdl2mixermysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(sdl2mixermysymbolmap[i].name, '@')) AddDictionnary(box86->versym, sdl2mixermysymbolmap[i].name); }

    cnt = sizeof(sdl2mixerstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, sdl2mixerstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = sdl2mixerstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(sdl2mixerstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, sdl2mixerstsymbolmap[i].name);
    }
    cnt = sizeof(sdl2mixersymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, sdl2mixersymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = sdl2mixersymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = sdl2mixersymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = sdl2mixersymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(sdl2mixersymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, sdl2mixersymbol2map[i].name);
    }
    cnt = sizeof(sdl2mixerdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(sdl2mixerdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, sdl2mixerdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = sdl2mixerdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, sdl2mixerdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = sdl2mixerdatamap[i].sz;
        }
    }
    cnt = sizeof(sdl2mixermydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, sdl2mixermydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = sdl2mixermydatamap[i].sz;
    }

    box86->sdl2mixerlib = lib; getMy(lib); lib->w.altmy = box_strdup("my2_");
...
void wrappedsdl2mixer_fini(library_t* lib)
{
    ...
    freeMy(); my_context->sdl2mixerlib = 
...
# 238 "/home/ssd/pico/code/box86/src/wrapped/wrappedsdl2mixer.c" 2
