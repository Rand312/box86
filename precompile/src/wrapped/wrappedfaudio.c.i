# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2

const char* faudioName = "libFAudio.so.0";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfaudiotypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfaudiotypes.h"
...
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
...
typedef struct faudio_my_s {
    ...
    vFpp_t FAudio_UnregisterForCallbacks; uFpp_t FAudio_RegisterForCallbacks; vFppp_t FAudio_SetEngineProcedureEXT; uFpCppp_t FAudioCOMConstructWithCustomAllocatorEXT; uFpuppp_t FAudioCreateReverb9WithCustomAllocatorEXT; uFpuppp_t FAudioCreateReverbWithCustomAllocatorEXT; uFpuppp_t FAudioCreateVolumeMeterWithCustomAllocatorEXT; uFpuuppp_t FAudioCreateWithCustomAllocatorEXT; uFpppuppp_t FAPOFX_CreateFXWithCustomAllocatorEXT; uFpppufppp_t FAudio_CreateSourceVoice;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static faudio_my_t my_faudio = {0};
static faudio_my_t * const my = &my_faudio;

static void getMy(library_t* lib)
{

    my->FAudio_UnregisterForCallbacks = (vFpp_t)dlsym(lib->w.lib, "FAudio_UnregisterForCallbacks"); my->FAudio_RegisterForCallbacks = (uFpp_t)dlsym(lib->w.lib, "FAudio_RegisterForCallbacks"); my->FAudio_SetEngineProcedureEXT = (vFppp_t)dlsym(lib->w.lib, "FAudio_SetEngineProcedureEXT"); my->FAudioCOMConstructWithCustomAllocatorEXT = (uFpCppp_t)dlsym(lib->w.lib, "FAudioCOMConstructWithCustomAllocatorEXT"); my->FAudioCreateReverb9WithCustomAllocatorEXT = (uFpuppp_t)dlsym(lib->w.lib, "FAudioCreateReverb9WithCustomAllocatorEXT"); my->FAudioCreateReverbWithCustomAllocatorEXT = (uFpuppp_t)dlsym(lib->w.lib, "FAudioCreateReverbWithCustomAllocatorEXT"); my->FAudioCreateVolumeMeterWithCustomAllocatorEXT = (uFpuppp_t)dlsym(lib->w.lib, "FAudioCreateVolumeMeterWithCustomAllocatorEXT"); my->FAudioCreateWithCustomAllocatorEXT = (uFpuuppp_t)dlsym(lib->w.lib, "FAudioCreateWithCustomAllocatorEXT"); my->FAPOFX_CreateFXWithCustomAllocatorEXT = (uFpppuppp_t)dlsym(lib->w.lib, "FAPOFX_CreateFXWithCustomAllocatorEXT"); my->FAudio_CreateSourceVoice = (uFpppufppp_t)dlsym(lib->w.lib, "FAudio_CreateSourceVoice");
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
static uintptr_t my_FAudioMalloc_fct_0 = 0; static void* my_FAudioMalloc_0(size_t a) { return (void*)RunFunctionFmt(my_FAudioMalloc_fct_0, "L", a); } static uintptr_t my_FAudioMalloc_fct_1 = 0; static void* my_FAudioMalloc_1(size_t a) { return (void*)RunFunctionFmt(my_FAudioMalloc_fct_1, "L", a); } static uintptr_t my_FAudioMalloc_fct_2 = 0; static void* my_FAudioMalloc_2(size_t a) { return (void*)RunFunctionFmt(my_FAudioMalloc_fct_2, "L", a); } static uintptr_t my_FAudioMalloc_fct_3 = 0; static void* my_FAudioMalloc_3(size_t a) { return (void*)RunFunctionFmt(my_FAudioMalloc_fct_3, "L", a); } static uintptr_t my_FAudioMalloc_fct_4 = 0; static void* my_FAudioMalloc_4(size_t a) { return (void*)RunFunctionFmt(my_FAudioMalloc_fct_4, "L", a); }
...
static void* find_FAudioMalloc_Fct(void* fct)
{
    ...
    if(my_FAudioMalloc_fct_0 == (uintptr_t)fct) return my_FAudioMalloc_0; if(my_FAudioMalloc_fct_1 == (uintptr_t)fct) return my_FAudioMalloc_1; if(my_FAudioMalloc_fct_2 == (uintptr_t)fct) return my_FAudioMalloc_2; if(my_FAudioMalloc_fct_3 == (uintptr_t)fct) return my_FAudioMalloc_3; if(my_FAudioMalloc_fct_4 == (uintptr_t)fct) return my_FAudioMalloc_4;


    if(my_FAudioMalloc_fct_0 == 0) {my_FAudioMalloc_fct_0 = (uintptr_t)fct; return my_FAudioMalloc_0; } if(my_FAudioMalloc_fct_1 == 0) {my_FAudioMalloc_fct_1 = (uintptr_t)fct; return my_FAudioMalloc_1; } if(my_FAudioMalloc_fct_2 == 0) {my_FAudioMalloc_fct_2 = (uintptr_t)fct; return my_FAudioMalloc_2; } if(my_FAudioMalloc_fct_3 == 0) {my_FAudioMalloc_fct_3 = (uintptr_t)fct; return my_FAudioMalloc_3; } if(my_FAudioMalloc_fct_4 == 0) {my_FAudioMalloc_fct_4 = (uintptr_t)fct; return my_FAudioMalloc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio FAudioMalloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_FAudioFree_fct_0 = 0; static void my_FAudioFree_0(void* a) { RunFunctionFmt(my_FAudioFree_fct_0, "p", a); } static uintptr_t my_FAudioFree_fct_1 = 0; static void my_FAudioFree_1(void* a) { RunFunctionFmt(my_FAudioFree_fct_1, "p", a); } static uintptr_t my_FAudioFree_fct_2 = 0; static void my_FAudioFree_2(void* a) { RunFunctionFmt(my_FAudioFree_fct_2, "p", a); } static uintptr_t my_FAudioFree_fct_3 = 0; static void my_FAudioFree_3(void* a) { RunFunctionFmt(my_FAudioFree_fct_3, "p", a); } static uintptr_t my_FAudioFree_fct_4 = 0; static void my_FAudioFree_4(void* a) { RunFunctionFmt(my_FAudioFree_fct_4, "p", a); }
...
static void* find_FAudioFree_Fct(void* fct)
{
    ...
    if(my_FAudioFree_fct_0 == (uintptr_t)fct) return my_FAudioFree_0; if(my_FAudioFree_fct_1 == (uintptr_t)fct) return my_FAudioFree_1; if(my_FAudioFree_fct_2 == (uintptr_t)fct) return my_FAudioFree_2; if(my_FAudioFree_fct_3 == (uintptr_t)fct) return my_FAudioFree_3; if(my_FAudioFree_fct_4 == (uintptr_t)fct) return my_FAudioFree_4;


    if(my_FAudioFree_fct_0 == 0) {my_FAudioFree_fct_0 = (uintptr_t)fct; return my_FAudioFree_0; } if(my_FAudioFree_fct_1 == 0) {my_FAudioFree_fct_1 = (uintptr_t)fct; return my_FAudioFree_1; } if(my_FAudioFree_fct_2 == 0) {my_FAudioFree_fct_2 = (uintptr_t)fct; return my_FAudioFree_2; } if(my_FAudioFree_fct_3 == 0) {my_FAudioFree_fct_3 = (uintptr_t)fct; return my_FAudioFree_3; } if(my_FAudioFree_fct_4 == 0) {my_FAudioFree_fct_4 = (uintptr_t)fct; return my_FAudioFree_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio FAudioFree callback\n"); fflush(ftrace);}} while(0);
    return 
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_FAudioRealloc_fct_0 = 0; static void* my_FAudioRealloc_0(void* a, size_t b) { return (void*)RunFunctionFmt(my_FAudioRealloc_fct_0, "pL", a, b); } static uintptr_t my_FAudioRealloc_fct_1 = 0; static void* my_FAudioRealloc_1(void* a, size_t b) { return (void*)RunFunctionFmt(my_FAudioRealloc_fct_1, "pL", a, b); } static uintptr_t my_FAudioRealloc_fct_2 = 0; static void* my_FAudioRealloc_2(void* a, size_t b) { return (void*)RunFunctionFmt(my_FAudioRealloc_fct_2, "pL", a, b); } static uintptr_t my_FAudioRealloc_fct_3 = 0; static void* my_FAudioRealloc_3(void* a, size_t b) { return (void*)RunFunctionFmt(my_FAudioRealloc_fct_3, "pL", a, b); } static uintptr_t my_FAudioRealloc_fct_4 = 0; static void* my_FAudioRealloc_4(void* a, size_t b) { return (void*)RunFunctionFmt(my_FAudioRealloc_fct_4, "pL", a, b); }
...
static void* find_FAudioRealloc_Fct(void* fct)
{
    ...
    if(my_FAudioRealloc_fct_0 == (uintptr_t)fct) return my_FAudioRealloc_0; if(my_FAudioRealloc_fct_1 == (uintptr_t)fct) return my_FAudioRealloc_1; if(my_FAudioRealloc_fct_2 == (uintptr_t)fct) return my_FAudioRealloc_2; if(my_FAudioRealloc_fct_3 == (uintptr_t)fct) return my_FAudioRealloc_3; if(my_FAudioRealloc_fct_4 == (uintptr_t)fct) return my_FAudioRealloc_4;


    if(my_FAudioRealloc_fct_0 == 0) {my_FAudioRealloc_fct_0 = (uintptr_t)fct; return my_FAudioRealloc_0; } if(my_FAudioRealloc_fct_1 == 0) {my_FAudioRealloc_fct_1 = (uintptr_t)fct; return my_FAudioRealloc_1; } if(my_FAudioRealloc_fct_2 == 0) {my_FAudioRealloc_fct_2 = (uintptr_t)fct; return my_FAudioRealloc_2; } if(my_FAudioRealloc_fct_3 == 0) {my_FAudioRealloc_fct_3 = (uintptr_t)fct; return my_FAudioRealloc_3; } if(my_FAudioRealloc_fct_4 == 0) {my_FAudioRealloc_fct_4 = (uintptr_t)fct; return my_FAudioRealloc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio FAudioRealloc callback\n"); fflush(ftrace);}} while(0);
    return 
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnCriticalErrorFunc_fct_0 = 0; static void my_OnCriticalErrorFunc_0(void* a, uint32_t b) { RunFunctionFmt(my_OnCriticalErrorFunc_fct_0, "pu", a, b); } static uintptr_t my_OnCriticalErrorFunc_fct_1 = 0; static void my_OnCriticalErrorFunc_1(void* a, uint32_t b) { RunFunctionFmt(my_OnCriticalErrorFunc_fct_1, "pu", a, b); } static uintptr_t my_OnCriticalErrorFunc_fct_2 = 0; static void my_OnCriticalErrorFunc_2(void* a, uint32_t b) { RunFunctionFmt(my_OnCriticalErrorFunc_fct_2, "pu", a, b); } static uintptr_t my_OnCriticalErrorFunc_fct_3 = 0; static void my_OnCriticalErrorFunc_3(void* a, uint32_t b) { RunFunctionFmt(my_OnCriticalErrorFunc_fct_3, "pu", a, b); } static uintptr_t my_OnCriticalErrorFunc_fct_4 = 0; static void my_OnCriticalErrorFunc_4(void* a, uint32_t b) { RunFunctionFmt(my_OnCriticalErrorFunc_fct_4, "pu", a, b); }
...
static void* find_OnCriticalErrorFunc_Fct(void* fct)
{
    ...
    if(my_OnCriticalErrorFunc_fct_0 == (uintptr_t)fct) return my_OnCriticalErrorFunc_0; if(my_OnCriticalErrorFunc_fct_1 == (uintptr_t)fct) return my_OnCriticalErrorFunc_1; if(my_OnCriticalErrorFunc_fct_2 == (uintptr_t)fct) return my_OnCriticalErrorFunc_2; if(my_OnCriticalErrorFunc_fct_3 == (uintptr_t)fct) return my_OnCriticalErrorFunc_3; if(my_OnCriticalErrorFunc_fct_4 == (uintptr_t)fct) return my_OnCriticalErrorFunc_4;


    if(my_OnCriticalErrorFunc_fct_0 == 0) {my_OnCriticalErrorFunc_fct_0 = (uintptr_t)fct; return my_OnCriticalErrorFunc_0; } if(my_OnCriticalErrorFunc_fct_1 == 0) {my_OnCriticalErrorFunc_fct_1 = (uintptr_t)fct; return my_OnCriticalErrorFunc_1; } if(my_OnCriticalErrorFunc_fct_2 == 0) {my_OnCriticalErrorFunc_fct_2 = (uintptr_t)fct; return my_OnCriticalErrorFunc_2; } if(my_OnCriticalErrorFunc_fct_3 == 0) {my_OnCriticalErrorFunc_fct_3 = (uintptr_t)fct; return my_OnCriticalErrorFunc_3; } if(my_OnCriticalErrorFunc_fct_4 == 0) {my_OnCriticalErrorFunc_fct_4 = (uintptr_t)fct; return my_OnCriticalErrorFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnCriticalErrorFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnProcessingPassEndFunc_fct_0 = 0; static void my_OnProcessingPassEndFunc_0(void* a) { RunFunctionFmt(my_OnProcessingPassEndFunc_fct_0, "p", a); } static uintptr_t my_OnProcessingPassEndFunc_fct_1 = 0; static void my_OnProcessingPassEndFunc_1(void* a) { RunFunctionFmt(my_OnProcessingPassEndFunc_fct_1, "p", a); } static uintptr_t my_OnProcessingPassEndFunc_fct_2 = 0; static void my_OnProcessingPassEndFunc_2(void* a) { RunFunctionFmt(my_OnProcessingPassEndFunc_fct_2, "p", a); } static uintptr_t my_OnProcessingPassEndFunc_fct_3 = 0; static void my_OnProcessingPassEndFunc_3(void* a) { RunFunctionFmt(my_OnProcessingPassEndFunc_fct_3, "p", a); } static uintptr_t my_OnProcessingPassEndFunc_fct_4 = 0; static void my_OnProcessingPassEndFunc_4(void* a) { RunFunctionFmt(my_OnProcessingPassEndFunc_fct_4, "p", a); }
...
static void* find_OnProcessingPassEndFunc_Fct(void* fct)
{
    ...
    if(my_OnProcessingPassEndFunc_fct_0 == (uintptr_t)fct) return my_OnProcessingPassEndFunc_0; if(my_OnProcessingPassEndFunc_fct_1 == (uintptr_t)fct) return my_OnProcessingPassEndFunc_1; if(my_OnProcessingPassEndFunc_fct_2 == (uintptr_t)fct) return my_OnProcessingPassEndFunc_2; if(my_OnProcessingPassEndFunc_fct_3 == (uintptr_t)fct) return my_OnProcessingPassEndFunc_3; if(my_OnProcessingPassEndFunc_fct_4 == (uintptr_t)fct) return my_OnProcessingPassEndFunc_4;


    if(my_OnProcessingPassEndFunc_fct_0 == 0) {my_OnProcessingPassEndFunc_fct_0 = (uintptr_t)fct; return my_OnProcessingPassEndFunc_0; } if(my_OnProcessingPassEndFunc_fct_1 == 0) {my_OnProcessingPassEndFunc_fct_1 = (uintptr_t)fct; return my_OnProcessingPassEndFunc_1; } if(my_OnProcessingPassEndFunc_fct_2 == 0) {my_OnProcessingPassEndFunc_fct_2 = (uintptr_t)fct; return my_OnProcessingPassEndFunc_2; } if(my_OnProcessingPassEndFunc_fct_3 == 0) {my_OnProcessingPassEndFunc_fct_3 = (uintptr_t)fct; return my_OnProcessingPassEndFunc_3; } if(my_OnProcessingPassEndFunc_fct_4 == 0) {my_OnProcessingPassEndFunc_fct_4 = (uintptr_t)fct; return my_OnProcessingPassEndFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnProcessingPassEndFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnProcessingPassStartFunc_fct_0 = 0; static void my_OnProcessingPassStartFunc_0(void* a) { RunFunctionFmt(my_OnProcessingPassStartFunc_fct_0, "p", a); } static uintptr_t my_OnProcessingPassStartFunc_fct_1 = 0; static void my_OnProcessingPassStartFunc_1(void* a) { RunFunctionFmt(my_OnProcessingPassStartFunc_fct_1, "p", a); } static uintptr_t my_OnProcessingPassStartFunc_fct_2 = 0; static void my_OnProcessingPassStartFunc_2(void* a) { RunFunctionFmt(my_OnProcessingPassStartFunc_fct_2, "p", a); } static uintptr_t my_OnProcessingPassStartFunc_fct_3 = 0; static void my_OnProcessingPassStartFunc_3(void* a) { RunFunctionFmt(my_OnProcessingPassStartFunc_fct_3, "p", a); } static uintptr_t my_OnProcessingPassStartFunc_fct_4 = 0; static void my_OnProcessingPassStartFunc_4(void* a) { RunFunctionFmt(my_OnProcessingPassStartFunc_fct_4, "p", a); }
...
static void* find_OnProcessingPassStartFunc_Fct(void* fct)
{
    ...
    if(my_OnProcessingPassStartFunc_fct_0 == (uintptr_t)fct) return my_OnProcessingPassStartFunc_0; if(my_OnProcessingPassStartFunc_fct_1 == (uintptr_t)fct) return my_OnProcessingPassStartFunc_1; if(my_OnProcessingPassStartFunc_fct_2 == (uintptr_t)fct) return my_OnProcessingPassStartFunc_2; if(my_OnProcessingPassStartFunc_fct_3 == (uintptr_t)fct) return my_OnProcessingPassStartFunc_3; if(my_OnProcessingPassStartFunc_fct_4 == (uintptr_t)fct) return my_OnProcessingPassStartFunc_4;


    if(my_OnProcessingPassStartFunc_fct_0 == 0) {my_OnProcessingPassStartFunc_fct_0 = (uintptr_t)fct; return my_OnProcessingPassStartFunc_0; } if(my_OnProcessingPassStartFunc_fct_1 == 0) {my_OnProcessingPassStartFunc_fct_1 = (uintptr_t)fct; return my_OnProcessingPassStartFunc_1; } if(my_OnProcessingPassStartFunc_fct_2 == 0) {my_OnProcessingPassStartFunc_fct_2 = (uintptr_t)fct; return my_OnProcessingPassStartFunc_2; } if(my_OnProcessingPassStartFunc_fct_3 == 0) {my_OnProcessingPassStartFunc_fct_3 = (uintptr_t)fct; return my_OnProcessingPassStartFunc_3; } if(my_OnProcessingPassStartFunc_fct_4 == 0) {my_OnProcessingPassStartFunc_fct_4 = (uintptr_t)fct; return my_OnProcessingPassStartFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnProcessingPassStartFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 165 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 165 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnBufferEndFunc_fct_0 = 0; static void my_OnBufferEndFunc_0(void* a, void* b) { RunFunctionFmt(my_OnBufferEndFunc_fct_0, "pp", a, b); } static uintptr_t my_OnBufferEndFunc_fct_1 = 0; static void my_OnBufferEndFunc_1(void* a, void* b) { RunFunctionFmt(my_OnBufferEndFunc_fct_1, "pp", a, b); } static uintptr_t my_OnBufferEndFunc_fct_2 = 0; static void my_OnBufferEndFunc_2(void* a, void* b) { RunFunctionFmt(my_OnBufferEndFunc_fct_2, "pp", a, b); } static uintptr_t my_OnBufferEndFunc_fct_3 = 0; static void my_OnBufferEndFunc_3(void* a, void* b) { RunFunctionFmt(my_OnBufferEndFunc_fct_3, "pp", a, b); } static uintptr_t my_OnBufferEndFunc_fct_4 = 0; static void my_OnBufferEndFunc_4(void* a, void* b) { RunFunctionFmt(my_OnBufferEndFunc_fct_4, "pp", a, b); }
...
static void* find_OnBufferEndFunc_Fct(void* fct)
{
    ...
    if(my_OnBufferEndFunc_fct_0 == (uintptr_t)fct) return my_OnBufferEndFunc_0; if(my_OnBufferEndFunc_fct_1 == (uintptr_t)fct) return my_OnBufferEndFunc_1; if(my_OnBufferEndFunc_fct_2 == (uintptr_t)fct) return my_OnBufferEndFunc_2; if(my_OnBufferEndFunc_fct_3 == (uintptr_t)fct) return my_OnBufferEndFunc_3; if(my_OnBufferEndFunc_fct_4 == (uintptr_t)fct) return my_OnBufferEndFunc_4;


    if(my_OnBufferEndFunc_fct_0 == 0) {my_OnBufferEndFunc_fct_0 = (uintptr_t)fct; return my_OnBufferEndFunc_0; } if(my_OnBufferEndFunc_fct_1 == 0) {my_OnBufferEndFunc_fct_1 = (uintptr_t)fct; return my_OnBufferEndFunc_1; } if(my_OnBufferEndFunc_fct_2 == 0) {my_OnBufferEndFunc_fct_2 = (uintptr_t)fct; return my_OnBufferEndFunc_2; } if(my_OnBufferEndFunc_fct_3 == 0) {my_OnBufferEndFunc_fct_3 = (uintptr_t)fct; return my_OnBufferEndFunc_3; } if(my_OnBufferEndFunc_fct_4 == 0) {my_OnBufferEndFunc_fct_4 = (uintptr_t)fct; return my_OnBufferEndFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnBufferEndFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnBufferStartFunc_fct_0 = 0; static void my_OnBufferStartFunc_0(void* a, void* b) { RunFunctionFmt(my_OnBufferStartFunc_fct_0, "pp", a, b); } static uintptr_t my_OnBufferStartFunc_fct_1 = 0; static void my_OnBufferStartFunc_1(void* a, void* b) { RunFunctionFmt(my_OnBufferStartFunc_fct_1, "pp", a, b); } static uintptr_t my_OnBufferStartFunc_fct_2 = 0; static void my_OnBufferStartFunc_2(void* a, void* b) { RunFunctionFmt(my_OnBufferStartFunc_fct_2, "pp", a, b); } static uintptr_t my_OnBufferStartFunc_fct_3 = 0; static void my_OnBufferStartFunc_3(void* a, void* b) { RunFunctionFmt(my_OnBufferStartFunc_fct_3, "pp", a, b); } static uintptr_t my_OnBufferStartFunc_fct_4 = 0; static void my_OnBufferStartFunc_4(void* a, void* b) { RunFunctionFmt(my_OnBufferStartFunc_fct_4, "pp", a, b); }
...
static void* find_OnBufferStartFunc_Fct(void* fct)
{
    ...
    if(my_OnBufferStartFunc_fct_0 == (uintptr_t)fct) return my_OnBufferStartFunc_0; if(my_OnBufferStartFunc_fct_1 == (uintptr_t)fct) return my_OnBufferStartFunc_1; if(my_OnBufferStartFunc_fct_2 == (uintptr_t)fct) return my_OnBufferStartFunc_2; if(my_OnBufferStartFunc_fct_3 == (uintptr_t)fct) return my_OnBufferStartFunc_3; if(my_OnBufferStartFunc_fct_4 == (uintptr_t)fct) return my_OnBufferStartFunc_4;


    if(my_OnBufferStartFunc_fct_0 == 0) {my_OnBufferStartFunc_fct_0 = (uintptr_t)fct; return my_OnBufferStartFunc_0; } if(my_OnBufferStartFunc_fct_1 == 0) {my_OnBufferStartFunc_fct_1 = (uintptr_t)fct; return my_OnBufferStartFunc_1; } if(my_OnBufferStartFunc_fct_2 == 0) {my_OnBufferStartFunc_fct_2 = (uintptr_t)fct; return my_OnBufferStartFunc_2; } if(my_OnBufferStartFunc_fct_3 == 0) {my_OnBufferStartFunc_fct_3 = (uintptr_t)fct; return my_OnBufferStartFunc_3; } if(my_OnBufferStartFunc_fct_4 == 0) {my_OnBufferStartFunc_fct_4 = (uintptr_t)fct; return my_OnBufferStartFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnBufferStartFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 215 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 215 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnLoopEndFunc_fct_0 = 0; static void my_OnLoopEndFunc_0(void* a, void* b) { RunFunctionFmt(my_OnLoopEndFunc_fct_0, "pp", a, b); } static uintptr_t my_OnLoopEndFunc_fct_1 = 0; static void my_OnLoopEndFunc_1(void* a, void* b) { RunFunctionFmt(my_OnLoopEndFunc_fct_1, "pp", a, b); } static uintptr_t my_OnLoopEndFunc_fct_2 = 0; static void my_OnLoopEndFunc_2(void* a, void* b) { RunFunctionFmt(my_OnLoopEndFunc_fct_2, "pp", a, b); } static uintptr_t my_OnLoopEndFunc_fct_3 = 0; static void my_OnLoopEndFunc_3(void* a, void* b) { RunFunctionFmt(my_OnLoopEndFunc_fct_3, "pp", a, b); } static uintptr_t my_OnLoopEndFunc_fct_4 = 0; static void my_OnLoopEndFunc_4(void* a, void* b) { RunFunctionFmt(my_OnLoopEndFunc_fct_4, "pp", a, b); }
...
static void* find_OnLoopEndFunc_Fct(void* fct)
{
    ...
    if(my_OnLoopEndFunc_fct_0 == (uintptr_t)fct) return my_OnLoopEndFunc_0; if(my_OnLoopEndFunc_fct_1 == (uintptr_t)fct) return my_OnLoopEndFunc_1; if(my_OnLoopEndFunc_fct_2 == (uintptr_t)fct) return my_OnLoopEndFunc_2; if(my_OnLoopEndFunc_fct_3 == (uintptr_t)fct) return my_OnLoopEndFunc_3; if(my_OnLoopEndFunc_fct_4 == (uintptr_t)fct) return my_OnLoopEndFunc_4;


    if(my_OnLoopEndFunc_fct_0 == 0) {my_OnLoopEndFunc_fct_0 = (uintptr_t)fct; return my_OnLoopEndFunc_0; } if(my_OnLoopEndFunc_fct_1 == 0) {my_OnLoopEndFunc_fct_1 = (uintptr_t)fct; return my_OnLoopEndFunc_1; } if(my_OnLoopEndFunc_fct_2 == 0) {my_OnLoopEndFunc_fct_2 = (uintptr_t)fct; return my_OnLoopEndFunc_2; } if(my_OnLoopEndFunc_fct_3 == 0) {my_OnLoopEndFunc_fct_3 = (uintptr_t)fct; return my_OnLoopEndFunc_3; } if(my_OnLoopEndFunc_fct_4 == 0) {my_OnLoopEndFunc_fct_4 = (uintptr_t)fct; return my_OnLoopEndFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnLoopEndFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 237 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 237 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnStreamEndFunc_fct_0 = 0; static void my_OnStreamEndFunc_0(void* a) { RunFunctionFmt(my_OnStreamEndFunc_fct_0, "p", a); } static uintptr_t my_OnStreamEndFunc_fct_1 = 0; static void my_OnStreamEndFunc_1(void* a) { RunFunctionFmt(my_OnStreamEndFunc_fct_1, "p", a); } static uintptr_t my_OnStreamEndFunc_fct_2 = 0; static void my_OnStreamEndFunc_2(void* a) { RunFunctionFmt(my_OnStreamEndFunc_fct_2, "p", a); } static uintptr_t my_OnStreamEndFunc_fct_3 = 0; static void my_OnStreamEndFunc_3(void* a) { RunFunctionFmt(my_OnStreamEndFunc_fct_3, "p", a); } static uintptr_t my_OnStreamEndFunc_fct_4 = 0; static void my_OnStreamEndFunc_4(void* a) { RunFunctionFmt(my_OnStreamEndFunc_fct_4, "p", a); }
...
static void* find_OnStreamEndFunc_Fct(void* fct)
{
    ...
    if(my_OnStreamEndFunc_fct_0 == (uintptr_t)fct) return my_OnStreamEndFunc_0; if(my_OnStreamEndFunc_fct_1 == (uintptr_t)fct) return my_OnStreamEndFunc_1; if(my_OnStreamEndFunc_fct_2 == (uintptr_t)fct) return my_OnStreamEndFunc_2; if(my_OnStreamEndFunc_fct_3 == (uintptr_t)fct) return my_OnStreamEndFunc_3; if(my_OnStreamEndFunc_fct_4 == (uintptr_t)fct) return my_OnStreamEndFunc_4;


    if(my_OnStreamEndFunc_fct_0 == 0) {my_OnStreamEndFunc_fct_0 = (uintptr_t)fct; return my_OnStreamEndFunc_0; } if(my_OnStreamEndFunc_fct_1 == 0) {my_OnStreamEndFunc_fct_1 = (uintptr_t)fct; return my_OnStreamEndFunc_1; } if(my_OnStreamEndFunc_fct_2 == 0) {my_OnStreamEndFunc_fct_2 = (uintptr_t)fct; return my_OnStreamEndFunc_2; } if(my_OnStreamEndFunc_fct_3 == 0) {my_OnStreamEndFunc_fct_3 = (uintptr_t)fct; return my_OnStreamEndFunc_3; } if(my_OnStreamEndFunc_fct_4 == 0) {my_OnStreamEndFunc_fct_4 = (uintptr_t)fct; return my_OnStreamEndFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnStreamEndFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 259 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 259 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnVoiceErrorFunc_fct_0 = 0; static void my_OnVoiceErrorFunc_0(void* a, void* b, uint32_t c) { RunFunctionFmt(my_OnVoiceErrorFunc_fct_0, "ppu", a, b, c); } static uintptr_t my_OnVoiceErrorFunc_fct_1 = 0; static void my_OnVoiceErrorFunc_1(void* a, void* b, uint32_t c) { RunFunctionFmt(my_OnVoiceErrorFunc_fct_1, "ppu", a, b, c); } static uintptr_t my_OnVoiceErrorFunc_fct_2 = 0; static void my_OnVoiceErrorFunc_2(void* a, void* b, uint32_t c) { RunFunctionFmt(my_OnVoiceErrorFunc_fct_2, "ppu", a, b, c); } static uintptr_t my_OnVoiceErrorFunc_fct_3 = 0; static void my_OnVoiceErrorFunc_3(void* a, void* b, uint32_t c) { RunFunctionFmt(my_OnVoiceErrorFunc_fct_3, "ppu", a, b, c); } static uintptr_t my_OnVoiceErrorFunc_fct_4 = 0; static void my_OnVoiceErrorFunc_4(void* a, void* b, uint32_t c) { RunFunctionFmt(my_OnVoiceErrorFunc_fct_4, "ppu", a, b, c); }
...
static void* find_OnVoiceErrorFunc_Fct(void* fct)
{
    ...
    if(my_OnVoiceErrorFunc_fct_0 == (uintptr_t)fct) return my_OnVoiceErrorFunc_0; if(my_OnVoiceErrorFunc_fct_1 == (uintptr_t)fct) return my_OnVoiceErrorFunc_1; if(my_OnVoiceErrorFunc_fct_2 == (uintptr_t)fct) return my_OnVoiceErrorFunc_2; if(my_OnVoiceErrorFunc_fct_3 == (uintptr_t)fct) return my_OnVoiceErrorFunc_3; if(my_OnVoiceErrorFunc_fct_4 == (uintptr_t)fct) return my_OnVoiceErrorFunc_4;


    if(my_OnVoiceErrorFunc_fct_0 == 0) {my_OnVoiceErrorFunc_fct_0 = (uintptr_t)fct; return my_OnVoiceErrorFunc_0; } if(my_OnVoiceErrorFunc_fct_1 == 0) {my_OnVoiceErrorFunc_fct_1 = (uintptr_t)fct; return my_OnVoiceErrorFunc_1; } if(my_OnVoiceErrorFunc_fct_2 == 0) {my_OnVoiceErrorFunc_fct_2 = (uintptr_t)fct; return my_OnVoiceErrorFunc_2; } if(my_OnVoiceErrorFunc_fct_3 == 0) {my_OnVoiceErrorFunc_fct_3 = (uintptr_t)fct; return my_OnVoiceErrorFunc_3; } if(my_OnVoiceErrorFunc_fct_4 == 0) {my_OnVoiceErrorFunc_fct_4 = (uintptr_t)fct; return my_OnVoiceErrorFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnVoiceErrorFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 281 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 281 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnVoiceProcessingPassEndFunc_fct_0 = 0; static void my_OnVoiceProcessingPassEndFunc_0(void* a) { RunFunctionFmt(my_OnVoiceProcessingPassEndFunc_fct_0, "p", a);} static uintptr_t my_OnVoiceProcessingPassEndFunc_fct_1 = 0; static void my_OnVoiceProcessingPassEndFunc_1(void* a) { RunFunctionFmt(my_OnVoiceProcessingPassEndFunc_fct_1, "p", a);} static uintptr_t my_OnVoiceProcessingPassEndFunc_fct_2 = 0; static void my_OnVoiceProcessingPassEndFunc_2(void* a) { RunFunctionFmt(my_OnVoiceProcessingPassEndFunc_fct_2, "p", a);} static uintptr_t my_OnVoiceProcessingPassEndFunc_fct_3 = 0; static void my_OnVoiceProcessingPassEndFunc_3(void* a) { RunFunctionFmt(my_OnVoiceProcessingPassEndFunc_fct_3, "p", a);} static uintptr_t my_OnVoiceProcessingPassEndFunc_fct_4 = 0; static void my_OnVoiceProcessingPassEndFunc_4(void* a) { RunFunctionFmt(my_OnVoiceProcessingPassEndFunc_fct_4, "p", a);}
...
static void* find_OnVoiceProcessingPassEndFunc_Fct(void* fct)
{
    ...
    if(my_OnVoiceProcessingPassEndFunc_fct_0 == (uintptr_t)fct) return my_OnVoiceProcessingPassEndFunc_0; if(my_OnVoiceProcessingPassEndFunc_fct_1 == (uintptr_t)fct) return my_OnVoiceProcessingPassEndFunc_1; if(my_OnVoiceProcessingPassEndFunc_fct_2 == (uintptr_t)fct) return my_OnVoiceProcessingPassEndFunc_2; if(my_OnVoiceProcessingPassEndFunc_fct_3 == (uintptr_t)fct) return my_OnVoiceProcessingPassEndFunc_3; if(my_OnVoiceProcessingPassEndFunc_fct_4 == (uintptr_t)fct) return my_OnVoiceProcessingPassEndFunc_4;


    if(my_OnVoiceProcessingPassEndFunc_fct_0 == 0) {my_OnVoiceProcessingPassEndFunc_fct_0 = (uintptr_t)fct; return my_OnVoiceProcessingPassEndFunc_0; } if(my_OnVoiceProcessingPassEndFunc_fct_1 == 0) {my_OnVoiceProcessingPassEndFunc_fct_1 = (uintptr_t)fct; return my_OnVoiceProcessingPassEndFunc_1; } if(my_OnVoiceProcessingPassEndFunc_fct_2 == 0) {my_OnVoiceProcessingPassEndFunc_fct_2 = (uintptr_t)fct; return my_OnVoiceProcessingPassEndFunc_2; } if(my_OnVoiceProcessingPassEndFunc_fct_3 == 0) {my_OnVoiceProcessingPassEndFunc_fct_3 = (uintptr_t)fct; return my_OnVoiceProcessingPassEndFunc_3; } if(my_OnVoiceProcessingPassEndFunc_fct_4 == 0) {my_OnVoiceProcessingPassEndFunc_fct_4 = (uintptr_t)fct; return my_OnVoiceProcessingPassEndFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnVoiceProcessingPassEndFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 303 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 303 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_OnVoiceProcessingPassStartFunc_fct_0 = 0; static void my_OnVoiceProcessingPassStartFunc_0(void* a, uint32_t b) { RunFunctionFmt(my_OnVoiceProcessingPassStartFunc_fct_0, "pu", a, b); } static uintptr_t my_OnVoiceProcessingPassStartFunc_fct_1 = 0; static void my_OnVoiceProcessingPassStartFunc_1(void* a, uint32_t b) { RunFunctionFmt(my_OnVoiceProcessingPassStartFunc_fct_1, "pu", a, b); } static uintptr_t my_OnVoiceProcessingPassStartFunc_fct_2 = 0; static void my_OnVoiceProcessingPassStartFunc_2(void* a, uint32_t b) { RunFunctionFmt(my_OnVoiceProcessingPassStartFunc_fct_2, "pu", a, b); } static uintptr_t my_OnVoiceProcessingPassStartFunc_fct_3 = 0; static void my_OnVoiceProcessingPassStartFunc_3(void* a, uint32_t b) { RunFunctionFmt(my_OnVoiceProcessingPassStartFunc_fct_3, "pu", a, b); } static uintptr_t my_OnVoiceProcessingPassStartFunc_fct_4 = 0; static void my_OnVoiceProcessingPassStartFunc_4(void* a, uint32_t b) { RunFunctionFmt(my_OnVoiceProcessingPassStartFunc_fct_4, "pu", a, b); }
...
static void* find_OnVoiceProcessingPassStartFunc_Fct(void* fct)
{
    ...
    if(my_OnVoiceProcessingPassStartFunc_fct_0 == (uintptr_t)fct) return my_OnVoiceProcessingPassStartFunc_0; if(my_OnVoiceProcessingPassStartFunc_fct_1 == (uintptr_t)fct) return my_OnVoiceProcessingPassStartFunc_1; if(my_OnVoiceProcessingPassStartFunc_fct_2 == (uintptr_t)fct) return my_OnVoiceProcessingPassStartFunc_2; if(my_OnVoiceProcessingPassStartFunc_fct_3 == (uintptr_t)fct) return my_OnVoiceProcessingPassStartFunc_3; if(my_OnVoiceProcessingPassStartFunc_fct_4 == (uintptr_t)fct) return my_OnVoiceProcessingPassStartFunc_4;


    if(my_OnVoiceProcessingPassStartFunc_fct_0 == 0) {my_OnVoiceProcessingPassStartFunc_fct_0 = (uintptr_t)fct; return my_OnVoiceProcessingPassStartFunc_0; } if(my_OnVoiceProcessingPassStartFunc_fct_1 == 0) {my_OnVoiceProcessingPassStartFunc_fct_1 = (uintptr_t)fct; return my_OnVoiceProcessingPassStartFunc_1; } if(my_OnVoiceProcessingPassStartFunc_fct_2 == 0) {my_OnVoiceProcessingPassStartFunc_fct_2 = (uintptr_t)fct; return my_OnVoiceProcessingPassStartFunc_2; } if(my_OnVoiceProcessingPassStartFunc_fct_3 == 0) {my_OnVoiceProcessingPassStartFunc_fct_3 = (uintptr_t)fct; return my_OnVoiceProcessingPassStartFunc_3; } if(my_OnVoiceProcessingPassStartFunc_fct_4 == 0) {my_OnVoiceProcessingPassStartFunc_fct_4 = (uintptr_t)fct; return my_OnVoiceProcessingPassStartFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio OnVoiceProcessingPassStartFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 325 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 325 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_FAudioEngineCallEXT_fct_0 = 0; static void my_FAudioEngineCallEXT_0(void* a, void* b) { RunFunctionFmt(my_FAudioEngineCallEXT_fct_0, "pp", a, b); } static uintptr_t my_FAudioEngineCallEXT_fct_1 = 0; static void my_FAudioEngineCallEXT_1(void* a, void* b) { RunFunctionFmt(my_FAudioEngineCallEXT_fct_1, "pp", a, b); } static uintptr_t my_FAudioEngineCallEXT_fct_2 = 0; static void my_FAudioEngineCallEXT_2(void* a, void* b) { RunFunctionFmt(my_FAudioEngineCallEXT_fct_2, "pp", a, b); } static uintptr_t my_FAudioEngineCallEXT_fct_3 = 0; static void my_FAudioEngineCallEXT_3(void* a, void* b) { RunFunctionFmt(my_FAudioEngineCallEXT_fct_3, "pp", a, b); } static uintptr_t my_FAudioEngineCallEXT_fct_4 = 0; static void my_FAudioEngineCallEXT_4(void* a, void* b) { RunFunctionFmt(my_FAudioEngineCallEXT_fct_4, "pp", a, b); }
...
static void* find_FAudioEngineCallEXT_Fct(void* fct)
{
    ...
    if(my_FAudioEngineCallEXT_fct_0 == (uintptr_t)fct) return my_FAudioEngineCallEXT_0; if(my_FAudioEngineCallEXT_fct_1 == (uintptr_t)fct) return my_FAudioEngineCallEXT_1; if(my_FAudioEngineCallEXT_fct_2 == (uintptr_t)fct) return my_FAudioEngineCallEXT_2; if(my_FAudioEngineCallEXT_fct_3 == (uintptr_t)fct) return my_FAudioEngineCallEXT_3; if(my_FAudioEngineCallEXT_fct_4 == (uintptr_t)fct) return my_FAudioEngineCallEXT_4;


    if(my_FAudioEngineCallEXT_fct_0 == 0) {my_FAudioEngineCallEXT_fct_0 = (uintptr_t)fct; return my_FAudioEngineCallEXT_0; } if(my_FAudioEngineCallEXT_fct_1 == 0) {my_FAudioEngineCallEXT_fct_1 = (uintptr_t)fct; return my_FAudioEngineCallEXT_1; } if(my_FAudioEngineCallEXT_fct_2 == 0) {my_FAudioEngineCallEXT_fct_2 = (uintptr_t)fct; return my_FAudioEngineCallEXT_2; } if(my_FAudioEngineCallEXT_fct_3 == 0) {my_FAudioEngineCallEXT_fct_3 = (uintptr_t)fct; return my_FAudioEngineCallEXT_3; } if(my_FAudioEngineCallEXT_fct_4 == 0) {my_FAudioEngineCallEXT_fct_4 = (uintptr_t)fct; return my_FAudioEngineCallEXT_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio FAudioEngineCallEXT callback\n"); fflush(ftrace);}} while(0);
    return 
# 357 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 357 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
static uintptr_t my_FAudioEngineProcedureEXT_fct_0 = 0; static void my_FAudioEngineProcedureEXT_0(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_FAudioEngineProcedureEXT_fct_0, "pppp", find_FAudioEngineCallEXT_Fct(a), b, c, d); } static uintptr_t my_FAudioEngineProcedureEXT_fct_1 = 0; static void my_FAudioEngineProcedureEXT_1(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_FAudioEngineProcedureEXT_fct_1, "pppp", find_FAudioEngineCallEXT_Fct(a), b, c, d); } static uintptr_t my_FAudioEngineProcedureEXT_fct_2 = 0; static void my_FAudioEngineProcedureEXT_2(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_FAudioEngineProcedureEXT_fct_2, "pppp", find_FAudioEngineCallEXT_Fct(a), b, c, d); } static uintptr_t my_FAudioEngineProcedureEXT_fct_3 = 0; static void my_FAudioEngineProcedureEXT_3(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_FAudioEngineProcedureEXT_fct_3, "pppp", find_FAudioEngineCallEXT_Fct(a), b, c, d); } static uintptr_t my_FAudioEngineProcedureEXT_fct_4 = 0; static void my_FAudioEngineProcedureEXT_4(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_FAudioEngineProcedureEXT_fct_4, "pppp", find_FAudioEngineCallEXT_Fct(a), b, c, d); }
...
static void* find_FAudioEngineProcedureEXT_Fct(void* fct)
{
    ...
    if(my_FAudioEngineProcedureEXT_fct_0 == (uintptr_t)fct) return my_FAudioEngineProcedureEXT_0; if(my_FAudioEngineProcedureEXT_fct_1 == (uintptr_t)fct) return my_FAudioEngineProcedureEXT_1; if(my_FAudioEngineProcedureEXT_fct_2 == (uintptr_t)fct) return my_FAudioEngineProcedureEXT_2; if(my_FAudioEngineProcedureEXT_fct_3 == (uintptr_t)fct) return my_FAudioEngineProcedureEXT_3; if(my_FAudioEngineProcedureEXT_fct_4 == (uintptr_t)fct) return my_FAudioEngineProcedureEXT_4;


    if(my_FAudioEngineProcedureEXT_fct_0 == 0) {my_FAudioEngineProcedureEXT_fct_0 = (uintptr_t)fct; return my_FAudioEngineProcedureEXT_0; } if(my_FAudioEngineProcedureEXT_fct_1 == 0) {my_FAudioEngineProcedureEXT_fct_1 = (uintptr_t)fct; return my_FAudioEngineProcedureEXT_1; } if(my_FAudioEngineProcedureEXT_fct_2 == 0) {my_FAudioEngineProcedureEXT_fct_2 = (uintptr_t)fct; return my_FAudioEngineProcedureEXT_2; } if(my_FAudioEngineProcedureEXT_fct_3 == 0) {my_FAudioEngineProcedureEXT_fct_3 = (uintptr_t)fct; return my_FAudioEngineProcedureEXT_3; } if(my_FAudioEngineProcedureEXT_fct_4 == 0) {my_FAudioEngineProcedureEXT_fct_4 = (uintptr_t)fct; return my_FAudioEngineProcedureEXT_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for FAudio FAudioEngineProcedureEXT callback\n"); fflush(ftrace);}} while(0);
    return 
# 379 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
          ((void *)0)
# 379 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
              ;
}
...
__attribute__((visibility("default"))) uint32_t my_FAudioCreateVolumeMeterWithCustomAllocatorEXT(x86emu_t* emu, void* ppApo, uint32_t flags, void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
__attribute__((visibility("default"))) uint32_t my_FAudioCreateReverbWithCustomAllocatorEXT(x86emu_t* emu, void* ppApo, uint32_t flags, void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
__attribute__((visibility("default"))) uint32_t my_FAudioCreateReverb9WithCustomAllocatorEXT(x86emu_t* emu, void* ppApo, uint32_t flags, void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
__attribute__((visibility("default"))) uint32_t my_FAudio_RegisterForCallbacks(x86emu_t* emu, void* audio, my_FAudioEngineCallback_t* p) {
    (void)emu;
    my_FAudioEngineCallback_t cb = {0};
    wrapFAudioEngineCallback(p, &cb);
    return my->FAudio_RegisterForCallbacks(audio, &cb);
}
__attribute__((visibility("default"))) void my_FAudio_UnregisterForCallbacks(x86emu_t* emu, void* audio, my_FAudioEngineCallback_t* p) {
    (void)emu;
    my_FAudioEngineCallback_t cb = {0};
    wrapFAudioEngineCallback(p, &cb);
...
__attribute__((visibility("default"))) uint32_t my_FAudio_CreateSourceVoice(x86emu_t* emu, void* audio, void* voices, void* format, uint32_t flags, float ratio, my_FAudioVoiceCallback_t* p, void* send, void* effect) {
    (void)emu;
    my_FAudioVoiceCallback_t cb = {0};
    if(p)
        wrapFAudioVoiceCallback(p, &cb);
    return my->FAudio_CreateSourceVoice(audio, voices, format, flags, ratio, p?(&cb):
# 434 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 3 4
                                                                                    ((void *)0)
# 434 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
                                                                                        , send, effect);
}

__attribute__((visibility("default"))) uint32_t my_FAudioCreateWithCustomAllocatorEXT(x86emu_t* emu, void* pp, uint32_t flags, uint32_t proc, void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
__attribute__((visibility("default"))) uint32_t my_FAudioCOMConstructWithCustomAllocatorEXT(x86emu_t* emu, void* pp, uint8_t ver,void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
__attribute__((visibility("default"))) void my_FAudio_SetEngineProcedureEXT(x86emu_t* emu, void* audio, void* p, void* user) {
    (void)emu;
    my->FAudio_SetEngineProcedureEXT(audio, find_FAudioEngineProcedureEXT_Fct(p), user);
}

__attribute__((visibility("default"))) uint32_t my_FAPOFX_CreateFXWithCustomAllocatorEXT(x86emu_t* emu, void* clsid, void* p, void* data, uint32_t size, void* customMalloc, void* customFree, void* customRealloc) {
    (void)emu;
...
# 464 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfaudiodefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t faudiosymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"F3DAudioCalculate", vFpppup, 0},


{"F3DAudioInitialize", vFufp, 0},
{"F3DAudioInitialize8", uFufp, 0},


{"FACT3DInitialize", uFpp, 0},
{"FACTAudioEngine_AddRef", uFp, 0},
{"FACTAudioEngine_CreateInMemoryWaveBank", uFppuuup, 0},
{"FACTAudioEngine_CreateSoundBank", uFppuuup, 0},
{"FACTAudioEngine_CreateStreamingWaveBank", uFppp, 0},
{"FACTAudioEngine_DoWork", uFp, 0},
{"FACTAudioEngine_GetCategory", WFpp, 0},
{"FACTAudioEngine_GetFinalMixFormat", uFpp, 0},
{"FACTAudioEngine_GetGlobalVariable", uFpWp, 0},
{"FACTAudioEngine_GetGlobalVariableIndex", WFpp, 0},
{"FACTAudioEngine_GetRendererCount", uFpp, 0},
{"FACTAudioEngine_GetRendererDetails", uFpWp, 0},
{"FACTAudioEngine_Initialize", uFpp, 0},
{"FACTAudioEngine_Pause", uFpWi, 0},


{"FACTAudioEngine_PrepareWave", uFpupuuuCp, 0},
{"FACTAudioEngine_RegisterNotification", uFpp, 0},
{"FACTAudioEngine_Release", uFp, 0},
{"FACTAudioEngine_SetGlobalVariable", uFpWf, 0},
{"FACTAudioEngine_SetVolume", uFpWf, 0},
{"FACTAudioEngine_ShutDown", uFp, 0},
{"FACTAudioEngine_Stop", uFpWu, 0},
{"FACTAudioEngine_UnRegisterNotification", uFpp, 0},
{"FACTCreateEngine", uFup, 0},

{"FACTCue_Destroy", uFp, 0},
{"FACTCue_GetProperties", uFpp, 0},
{"FACTCue_GetState", uFpp, 0},
{"FACTCue_GetVariable", uFpWp, 0},
{"FACTCue_GetVariableIndex", WFpp, 0},
{"FACTCue_Pause", uFpi, 0},
{"FACTCue_Play", uFp, 0},
{"FACTCue_SetMatrixCoefficients", uFpuup, 0},
{"FACTCue_SetOutputVoiceMatrix", uFppuup, 0},
{"FACTCue_SetOutputVoices", uFpp, 0},
{"FACTCue_SetVariable", uFpWf, 0},
{"FACTCue_Stop", uFpu, 0},
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FACTSoundBank_Destroy", uFp, 0},
{"FACTSoundBank_GetCueIndex", WFpp, 0},
{"FACTSoundBank_GetCueProperties", uFpWp, 0},
{"FACTSoundBank_GetNumCues", uFpp, 0},
{"FACTSoundBank_GetState", uFpp, 0},
{"FACTSoundBank_Play", uFpWuip, 0},
{"FACTSoundBank_Play3D", uFpWuipp, 0},
{"FACTSoundBank_Prepare", uFpWuip, 0},
{"FACTSoundBank_Stop", uFpWu, 0},
{"FACTWaveBank_Destroy", uFp, 0},
{"FACTWaveBank_GetNumWaves", uFpp, 0},
{"FACTWaveBank_GetState", uFpp, 0},
{"FACTWaveBank_GetWaveIndex", uFpp, 0},
{"FACTWaveBank_GetWaveProperties", uFpWp, 0},
{"FACTWaveBank_Play", uFpWuwCp, 0},
{"FACTWaveBank_Prepare", uFpWuuCp, 0},
{"FACTWaveBank_Stop", uFpWu, 0},
{"FACTWave_Destroy", uFp, 0},
{"FACTWave_GetProperties", uFpp, 0},
{"FACTWave_GetState", uFpp, 0},
{"FACTWave_Pause", uFpi, 0},
{"FACTWave_Play", uFp, 0},
{"FACTWave_SetMatrixCoefficients", uFpuup, 0},
{"FACTWave_SetPitch", uFpw, 0},
{"FACTWave_SetVolume", uFpf, 0},
{"FACTWave_Stop", uFpu, 0},
# 131 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FAPOFX_CreateFX", uFpppu, 0},

# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FAudio_AddRef", uFp, 0},

{"FAudioCOMConstructEXT", uFpuC, 0},

{"FAudio_CommitChanges", uFp, 0},
{"FAudio_CommitOperationSet", uFpu, 0},
{"FAudioCreate", uFpuu, 0},
{"FAudio_CreateMasteringVoice", uFppuuuup, 0},
{"FAudio_CreateMasteringVoice8", uFppuuuppi, 0},
{"FAudioCreateReverb", uFpu, 0},
{"FAudioCreateReverb9", uFpu, 0},



{"FAudio_CreateSubmixVoice", uFppuuuupp, 0},
{"FAudioCreateVolumeMeter", uFpu, 0},


{"FAudio_fopen", pFp, 0},
# 178 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FAudio_GetDeviceCount", uFpp, 0},
{"FAudio_GetDeviceDetails", uFpup, 0},
{"FAudio_GetPerformanceData", vFpp, 0},
{"FAudio_GetProcessingQuantum", vFppp, 0},



{"FAudio_Initialize", uFpuu, 0},
# 226 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FAudioLinkedVersion", uFv, 0},
{"FAudioMasteringVoice_GetChannelMask", uFpp, 0},
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"

{"FAudio_Release", uFp, 0},
{"FAudio_SetDebugConfiguration", vFppp, 0},


{"FAudioSourceVoice_Discontinuity", uFp, 0},
{"FAudioSourceVoice_ExitLoop", uFpu, 0},
{"FAudioSourceVoice_FlushSourceBuffers", uFp, 0},
{"FAudioSourceVoice_GetFrequencyRatio", vFpp, 0},
{"FAudioSourceVoice_GetState", vFppu, 0},
{"FAudioSourceVoice_SetFrequencyRatio", uFpfu, 0},
{"FAudioSourceVoice_SetSourceSampleRate", uFpu, 0},
{"FAudioSourceVoice_Start", uFpuu, 0},
{"FAudioSourceVoice_Stop", uFpuu, 0},
{"FAudioSourceVoice_SubmitSourceBuffer", uFppp, 0},
{"FAudio_StartEngine", uFp, 0},
{"FAudio_StopEngine", vFp, 0},



{"FAudioVoice_DestroyVoice", vFp, 0},
{"FAudioVoice_DisableEffect", uFpuu, 0},
{"FAudioVoice_EnableEffect", uFpuu, 0},
{"FAudioVoice_GetChannelVolumes", vFpup, 0},
{"FAudioVoice_GetEffectParameters", uFpupu, 0},
{"FAudioVoice_GetEffectState", vFpup, 0},
{"FAudioVoice_GetFilterParameters", vFpp, 0},
{"FAudioVoice_GetOutputFilterParameters", vFppp, 0},
{"FAudioVoice_GetOutputMatrix", vFppuup, 0},
{"FAudioVoice_GetVoiceDetails", vFpp, 0},
{"FAudioVoice_GetVolume", vFpp, 0},
{"FAudioVoice_SetChannelVolumes", uFpupu, 0},
{"FAudioVoice_SetEffectChain", uFpp, 0},
{"FAudioVoice_SetEffectParameters", uFpupuu, 0},
{"FAudioVoice_SetFilterParameters", uFppu, 0},
{"FAudioVoice_SetOutputFilterParameters", uFpppu, 0},
{"FAudioVoice_SetOutputMatrix", uFppuupu, 0},
{"FAudioVoice_SetOutputVoices", uFpp, 0},
{"FAudioVoice_SetVolume", uFpfu, 0},




{"ReverbConvertI3DL2ToNative", vFpp, 0},
{"ReverbConvertI3DL2ToNative9", vFpp, 0},
{"XNA_EnableVisualization", vFu, 0},
{"XNA_GetSongEnded", uFv, 0},
{"XNA_GetSongVisualizationData", vFppu, 0},
{"XNA_PauseSong", vFv, 0},
{"XNA_PlaySong", fFp, 0},
{"XNA_ResumeSong", vFv, 0},
{"XNA_SetSongVolume", vFf, 0},
{"XNA_SongInit", vFv, 0},
{"XNA_SongQuit", vFv, 0},
{"XNA_StopSong", vFv, 0},
{"XNA_VisualizationEnabled", uFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t faudiomysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
...
{"FAPOFX_CreateFXWithCustomAllocatorEXT", uFEpppuppp, 0},
# 147 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"



{"FAudioCOMConstructWithCustomAllocatorEXT", uFEpCppp, 0},
...
{"FAudioCreateReverb9WithCustomAllocatorEXT", uFEpuppp, 0},
{"FAudioCreateReverbWithCustomAllocatorEXT", uFEpuppp, 0},
{"FAudio_CreateSourceVoice", uFEpppufppp, 0},


{"FAudioCreateVolumeMeterWithCustomAllocatorEXT", uFEpuppp, 0},
{"FAudioCreateWithCustomAllocatorEXT", uFEpuuppp, 0},
...
# 261 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
{"FAudio_RegisterForCallbacks", uFEpp, 0},


{"FAudio_SetEngineProcedureEXT", vFEppp, 0},
...
{"FAudio_UnregisterForCallbacks", vFEpp, 0},
...
static const map_onesymbol_t faudiostsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
...
static const map_onesymbol2_t faudiosymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
...
static const map_onedata_t faudiodatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
...
static const map_onedata_t faudiomydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h" 1
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedfaudioundefs.h" 1
...
int wrappedfaudio_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(faudioName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(faudiosymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (faudiosymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, faudiosymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = faudiosymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, faudiosymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = faudiosymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(faudiosymbolmap[i].name, '@')) AddDictionnary(box86->versym, faudiosymbolmap[i].name); }
 cnt = sizeof(faudiomysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (faudiomysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, faudiomysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = faudiomysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, faudiomysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = faudiomysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(faudiomysymbolmap[i].name, '@')) AddDictionnary(box86->versym, faudiomysymbolmap[i].name); }

    cnt = sizeof(faudiostsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, faudiostsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = faudiostsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(faudiostsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, faudiostsymbolmap[i].name);
    }
    cnt = sizeof(faudiosymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, faudiosymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = faudiosymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = faudiosymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = faudiosymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(faudiosymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, faudiosymbol2map[i].name);
    }
    cnt = sizeof(faudiodatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(faudiodatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, faudiodatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = faudiodatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, faudiodatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = faudiodatamap[i].sz;
        }
    }
    cnt = sizeof(faudiomydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, faudiomydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = faudiomydatamap[i].sz;
    }
...
void wrappedfaudio_fini(library_t* lib)
{
...
# 465 "/home/ssd/pico/code/box86/src/wrapped/wrappedfaudio.c" 2
