# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbustypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbustypes.h"
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
...
typedef struct dbus_my_s {
    ...
    vFppp_t dbus_connection_remove_filter; vFppp_t dbus_timeout_set_data; vFppp_t dbus_watch_set_data; iFpiV_t dbus_message_append_args; vFpppp_t dbus_connection_set_dispatch_status_function; vFpppp_t dbus_connection_set_wakeup_main_function; iFpipp_t dbus_connection_set_data; iFpipp_t dbus_message_set_data; iFpipp_t dbus_pending_call_set_data; iFppip_t dbus_message_get_args_valist; iFppiV_t dbus_message_get_args; iFpppp_t dbus_connection_add_filter; iFpppp_t dbus_pending_call_set_notify; iFppppp_t dbus_connection_try_register_fallback; iFppppp_t dbus_connection_try_register_object_path; iFpppppp_t dbus_connection_set_timeout_functions; iFpppppp_t dbus_connection_set_watch_functions;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static dbus_my_t my_dbus = {0};
static dbus_my_t * const my = &my_dbus;

static void getMy(library_t* lib)
{

    my->dbus_connection_remove_filter = (vFppp_t)dlsym(lib->w.lib, "dbus_connection_remove_filter"); my->dbus_timeout_set_data = (vFppp_t)dlsym(lib->w.lib, "dbus_timeout_set_data"); my->dbus_watch_set_data = (vFppp_t)dlsym(lib->w.lib, "dbus_watch_set_data"); my->dbus_message_append_args = (iFpiV_t)dlsym(lib->w.lib, "dbus_message_append_args"); my->dbus_connection_set_dispatch_status_function = (vFpppp_t)dlsym(lib->w.lib, "dbus_connection_set_dispatch_status_function"); my->dbus_connection_set_wakeup_main_function = (vFpppp_t)dlsym(lib->w.lib, "dbus_connection_set_wakeup_main_function"); my->dbus_connection_set_data = (iFpipp_t)dlsym(lib->w.lib, "dbus_connection_set_data"); my->dbus_message_set_data = (iFpipp_t)dlsym(lib->w.lib, "dbus_message_set_data"); my->dbus_pending_call_set_data = (iFpipp_t)dlsym(lib->w.lib, "dbus_pending_call_set_data"); my->dbus_message_get_args_valist = (iFppip_t)dlsym(lib->w.lib, "dbus_message_get_args_valist"); my->dbus_message_get_args = (iFppiV_t)dlsym(lib->w.lib, "dbus_message_get_args"); my->dbus_connection_add_filter = (iFpppp_t)dlsym(lib->w.lib, "dbus_connection_add_filter"); my->dbus_pending_call_set_notify = (iFpppp_t)dlsym(lib->w.lib, "dbus_pending_call_set_notify"); my->dbus_connection_try_register_fallback = (iFppppp_t)dlsym(lib->w.lib, "dbus_connection_try_register_fallback"); my->dbus_connection_try_register_object_path = (iFppppp_t)dlsym(lib->w.lib, "dbus_connection_try_register_object_path"); my->dbus_connection_set_timeout_functions = (iFpppppp_t)dlsym(lib->w.lib, "dbus_connection_set_timeout_functions"); my->dbus_connection_set_watch_functions = (iFpppppp_t)dlsym(lib->w.lib, "dbus_connection_set_watch_functions");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusFreeFunction_fct_0 = 0; static void my_DBusFreeFunction_0(void* p) { RunFunctionFmt(my_DBusFreeFunction_fct_0, "p", p);} static uintptr_t my_DBusFreeFunction_fct_1 = 0; static void my_DBusFreeFunction_1(void* p) { RunFunctionFmt(my_DBusFreeFunction_fct_1, "p", p);} static uintptr_t my_DBusFreeFunction_fct_2 = 0; static void my_DBusFreeFunction_2(void* p) { RunFunctionFmt(my_DBusFreeFunction_fct_2, "p", p);} static uintptr_t my_DBusFreeFunction_fct_3 = 0; static void my_DBusFreeFunction_3(void* p) { RunFunctionFmt(my_DBusFreeFunction_fct_3, "p", p);}
...
static void* find_DBusFreeFunction_Fct(void* fct)
{
    ...
    if(my_DBusFreeFunction_fct_0 == (uintptr_t)fct) return my_DBusFreeFunction_0; if(my_DBusFreeFunction_fct_1 == (uintptr_t)fct) return my_DBusFreeFunction_1; if(my_DBusFreeFunction_fct_2 == (uintptr_t)fct) return my_DBusFreeFunction_2; if(my_DBusFreeFunction_fct_3 == (uintptr_t)fct) return my_DBusFreeFunction_3;


    if(my_DBusFreeFunction_fct_0 == 0) {my_DBusFreeFunction_fct_0 = (uintptr_t)fct; return my_DBusFreeFunction_0; } if(my_DBusFreeFunction_fct_1 == 0) {my_DBusFreeFunction_fct_1 = (uintptr_t)fct; return my_DBusFreeFunction_1; } if(my_DBusFreeFunction_fct_2 == 0) {my_DBusFreeFunction_fct_2 = (uintptr_t)fct; return my_DBusFreeFunction_2; } if(my_DBusFreeFunction_fct_3 == 0) {my_DBusFreeFunction_fct_3 = (uintptr_t)fct; return my_DBusFreeFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusFreeFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
...
static uintptr_t my_DBusHandleMessageFunction_fct_0 = 0; static int my_DBusHandleMessageFunction_0(void* a, void* b, void* c) { return RunFunctionFmt(my_DBusHandleMessageFunction_fct_0, "ppp", a, b, c);} static uintptr_t my_DBusHandleMessageFunction_fct_1 = 0; static int my_DBusHandleMessageFunction_1(void* a, void* b, void* c) { return RunFunctionFmt(my_DBusHandleMessageFunction_fct_1, "ppp", a, b, c);} static uintptr_t my_DBusHandleMessageFunction_fct_2 = 0; static int my_DBusHandleMessageFunction_2(void* a, void* b, void* c) { return RunFunctionFmt(my_DBusHandleMessageFunction_fct_2, "ppp", a, b, c);} static uintptr_t my_DBusHandleMessageFunction_fct_3 = 0; static int my_DBusHandleMessageFunction_3(void* a, void* b, void* c) { return RunFunctionFmt(my_DBusHandleMessageFunction_fct_3, "ppp", a, b, c);}
...
static void* find_DBusHandleMessageFunction_Fct(void* fct)
{
    ...
    if(my_DBusHandleMessageFunction_fct_0 == (uintptr_t)fct) return my_DBusHandleMessageFunction_0; if(my_DBusHandleMessageFunction_fct_1 == (uintptr_t)fct) return my_DBusHandleMessageFunction_1; if(my_DBusHandleMessageFunction_fct_2 == (uintptr_t)fct) return my_DBusHandleMessageFunction_2; if(my_DBusHandleMessageFunction_fct_3 == (uintptr_t)fct) return my_DBusHandleMessageFunction_3;


    if(my_DBusHandleMessageFunction_fct_0 == 0) {my_DBusHandleMessageFunction_fct_0 = (uintptr_t)fct; return my_DBusHandleMessageFunction_0; } if(my_DBusHandleMessageFunction_fct_1 == 0) {my_DBusHandleMessageFunction_fct_1 = (uintptr_t)fct; return my_DBusHandleMessageFunction_1; } if(my_DBusHandleMessageFunction_fct_2 == 0) {my_DBusHandleMessageFunction_fct_2 = (uintptr_t)fct; return my_DBusHandleMessageFunction_2; } if(my_DBusHandleMessageFunction_fct_3 == 0) {my_DBusHandleMessageFunction_fct_3 = (uintptr_t)fct; return my_DBusHandleMessageFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusHandleMessageFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
...
static uintptr_t my_DBusAddTimeoutFunction_fct_0 = 0; static int my_DBusAddTimeoutFunction_0(void* a, void* b) { return RunFunctionFmt(my_DBusAddTimeoutFunction_fct_0, "pp", a, b); } static uintptr_t my_DBusAddTimeoutFunction_fct_1 = 0; static int my_DBusAddTimeoutFunction_1(void* a, void* b) { return RunFunctionFmt(my_DBusAddTimeoutFunction_fct_1, "pp", a, b); } static uintptr_t my_DBusAddTimeoutFunction_fct_2 = 0; static int my_DBusAddTimeoutFunction_2(void* a, void* b) { return RunFunctionFmt(my_DBusAddTimeoutFunction_fct_2, "pp", a, b); } static uintptr_t my_DBusAddTimeoutFunction_fct_3 = 0; static int my_DBusAddTimeoutFunction_3(void* a, void* b) { return RunFunctionFmt(my_DBusAddTimeoutFunction_fct_3, "pp", a, b); }
...
static void* find_DBusAddTimeoutFunction_Fct(void* fct)
{
    ...
    if(my_DBusAddTimeoutFunction_fct_0 == (uintptr_t)fct) return my_DBusAddTimeoutFunction_0; if(my_DBusAddTimeoutFunction_fct_1 == (uintptr_t)fct) return my_DBusAddTimeoutFunction_1; if(my_DBusAddTimeoutFunction_fct_2 == (uintptr_t)fct) return my_DBusAddTimeoutFunction_2; if(my_DBusAddTimeoutFunction_fct_3 == (uintptr_t)fct) return my_DBusAddTimeoutFunction_3;


    if(my_DBusAddTimeoutFunction_fct_0 == 0) {my_DBusAddTimeoutFunction_fct_0 = (uintptr_t)fct; return my_DBusAddTimeoutFunction_0; } if(my_DBusAddTimeoutFunction_fct_1 == 0) {my_DBusAddTimeoutFunction_fct_1 = (uintptr_t)fct; return my_DBusAddTimeoutFunction_1; } if(my_DBusAddTimeoutFunction_fct_2 == 0) {my_DBusAddTimeoutFunction_fct_2 = (uintptr_t)fct; return my_DBusAddTimeoutFunction_2; } if(my_DBusAddTimeoutFunction_fct_3 == 0) {my_DBusAddTimeoutFunction_fct_3 = (uintptr_t)fct; return my_DBusAddTimeoutFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusAddTimeoutFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 101 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 101 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
...
static uintptr_t my_DBusRemoveTimeoutFunction_fct_0 = 0; static void my_DBusRemoveTimeoutFunction_0(void* a, void* b) { RunFunctionFmt(my_DBusRemoveTimeoutFunction_fct_0, "pp", a, b); } static uintptr_t my_DBusRemoveTimeoutFunction_fct_1 = 0; static void my_DBusRemoveTimeoutFunction_1(void* a, void* b) { RunFunctionFmt(my_DBusRemoveTimeoutFunction_fct_1, "pp", a, b); } static uintptr_t my_DBusRemoveTimeoutFunction_fct_2 = 0; static void my_DBusRemoveTimeoutFunction_2(void* a, void* b) { RunFunctionFmt(my_DBusRemoveTimeoutFunction_fct_2, "pp", a, b); } static uintptr_t my_DBusRemoveTimeoutFunction_fct_3 = 0; static void my_DBusRemoveTimeoutFunction_3(void* a, void* b) { RunFunctionFmt(my_DBusRemoveTimeoutFunction_fct_3, "pp", a, b); }
...
static void* find_DBusRemoveTimeoutFunction_Fct(void* fct)
{
    ...
    if(my_DBusRemoveTimeoutFunction_fct_0 == (uintptr_t)fct) return my_DBusRemoveTimeoutFunction_0; if(my_DBusRemoveTimeoutFunction_fct_1 == (uintptr_t)fct) return my_DBusRemoveTimeoutFunction_1; if(my_DBusRemoveTimeoutFunction_fct_2 == (uintptr_t)fct) return my_DBusRemoveTimeoutFunction_2; if(my_DBusRemoveTimeoutFunction_fct_3 == (uintptr_t)fct) return my_DBusRemoveTimeoutFunction_3;


    if(my_DBusRemoveTimeoutFunction_fct_0 == 0) {my_DBusRemoveTimeoutFunction_fct_0 = (uintptr_t)fct; return my_DBusRemoveTimeoutFunction_0; } if(my_DBusRemoveTimeoutFunction_fct_1 == 0) {my_DBusRemoveTimeoutFunction_fct_1 = (uintptr_t)fct; return my_DBusRemoveTimeoutFunction_1; } if(my_DBusRemoveTimeoutFunction_fct_2 == 0) {my_DBusRemoveTimeoutFunction_fct_2 = (uintptr_t)fct; return my_DBusRemoveTimeoutFunction_2; } if(my_DBusRemoveTimeoutFunction_fct_3 == 0) {my_DBusRemoveTimeoutFunction_fct_3 = (uintptr_t)fct; return my_DBusRemoveTimeoutFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusRemoveTimeoutFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
...
static uintptr_t my_DBusTimeoutToggledFunction_fct_0 = 0; static void my_DBusTimeoutToggledFunction_0(void* a, void* b) { RunFunctionFmt(my_DBusTimeoutToggledFunction_fct_0, "pp", a, b); } static uintptr_t my_DBusTimeoutToggledFunction_fct_1 = 0; static void my_DBusTimeoutToggledFunction_1(void* a, void* b) { RunFunctionFmt(my_DBusTimeoutToggledFunction_fct_1, "pp", a, b); } static uintptr_t my_DBusTimeoutToggledFunction_fct_2 = 0; static void my_DBusTimeoutToggledFunction_2(void* a, void* b) { RunFunctionFmt(my_DBusTimeoutToggledFunction_fct_2, "pp", a, b); } static uintptr_t my_DBusTimeoutToggledFunction_fct_3 = 0; static void my_DBusTimeoutToggledFunction_3(void* a, void* b) { RunFunctionFmt(my_DBusTimeoutToggledFunction_fct_3, "pp", a, b); }
...
static void* find_DBusTimeoutToggledFunction_Fct(void* fct)
{
    ...
    if(my_DBusTimeoutToggledFunction_fct_0 == (uintptr_t)fct) return my_DBusTimeoutToggledFunction_0; if(my_DBusTimeoutToggledFunction_fct_1 == (uintptr_t)fct) return my_DBusTimeoutToggledFunction_1; if(my_DBusTimeoutToggledFunction_fct_2 == (uintptr_t)fct) return my_DBusTimeoutToggledFunction_2; if(my_DBusTimeoutToggledFunction_fct_3 == (uintptr_t)fct) return my_DBusTimeoutToggledFunction_3;


    if(my_DBusTimeoutToggledFunction_fct_0 == 0) {my_DBusTimeoutToggledFunction_fct_0 = (uintptr_t)fct; return my_DBusTimeoutToggledFunction_0; } if(my_DBusTimeoutToggledFunction_fct_1 == 0) {my_DBusTimeoutToggledFunction_fct_1 = (uintptr_t)fct; return my_DBusTimeoutToggledFunction_1; } if(my_DBusTimeoutToggledFunction_fct_2 == 0) {my_DBusTimeoutToggledFunction_fct_2 = (uintptr_t)fct; return my_DBusTimeoutToggledFunction_2; } if(my_DBusTimeoutToggledFunction_fct_3 == 0) {my_DBusTimeoutToggledFunction_fct_3 = (uintptr_t)fct; return my_DBusTimeoutToggledFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusTimeoutToggledFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 145 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
...
static uintptr_t my_DBusWakeupMainFunction_fct_0 = 0; static void my_DBusWakeupMainFunction_0(void* a) { RunFunctionFmt(my_DBusWakeupMainFunction_fct_0, "p", a); } static uintptr_t my_DBusWakeupMainFunction_fct_1 = 0; static void my_DBusWakeupMainFunction_1(void* a) { RunFunctionFmt(my_DBusWakeupMainFunction_fct_1, "p", a); } static uintptr_t my_DBusWakeupMainFunction_fct_2 = 0; static void my_DBusWakeupMainFunction_2(void* a) { RunFunctionFmt(my_DBusWakeupMainFunction_fct_2, "p", a); } static uintptr_t my_DBusWakeupMainFunction_fct_3 = 0; static void my_DBusWakeupMainFunction_3(void* a) { RunFunctionFmt(my_DBusWakeupMainFunction_fct_3, "p", a); }
...
static void* find_DBusWakeupMainFunction_Fct(void* fct)
{
    ...
    if(my_DBusWakeupMainFunction_fct_0 == (uintptr_t)fct) return my_DBusWakeupMainFunction_0; if(my_DBusWakeupMainFunction_fct_1 == (uintptr_t)fct) return my_DBusWakeupMainFunction_1; if(my_DBusWakeupMainFunction_fct_2 == (uintptr_t)fct) return my_DBusWakeupMainFunction_2; if(my_DBusWakeupMainFunction_fct_3 == (uintptr_t)fct) return my_DBusWakeupMainFunction_3;


    if(my_DBusWakeupMainFunction_fct_0 == 0) {my_DBusWakeupMainFunction_fct_0 = (uintptr_t)fct; return my_DBusWakeupMainFunction_0; } if(my_DBusWakeupMainFunction_fct_1 == 0) {my_DBusWakeupMainFunction_fct_1 = (uintptr_t)fct; return my_DBusWakeupMainFunction_1; } if(my_DBusWakeupMainFunction_fct_2 == 0) {my_DBusWakeupMainFunction_fct_2 = (uintptr_t)fct; return my_DBusWakeupMainFunction_2; } if(my_DBusWakeupMainFunction_fct_3 == 0) {my_DBusWakeupMainFunction_fct_3 = (uintptr_t)fct; return my_DBusWakeupMainFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libdbus-1.so DBusWakeupMainFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 167 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 167 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 177 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusPendingCallNotifyFunction_fct_0 = 0; static void my_DBusPendingCallNotifyFunction_0(void* pending, void* data) { RunFunctionFmt(my_DBusPendingCallNotifyFunction_fct_0, "pp", pending, data); } static uintptr_t my_DBusPendingCallNotifyFunction_fct_1 = 0; static void my_DBusPendingCallNotifyFunction_1(void* pending, void* data) { RunFunctionFmt(my_DBusPendingCallNotifyFunction_fct_1, "pp", pending, data); } static uintptr_t my_DBusPendingCallNotifyFunction_fct_2 = 0; static void my_DBusPendingCallNotifyFunction_2(void* pending, void* data) { RunFunctionFmt(my_DBusPendingCallNotifyFunction_fct_2, "pp", pending, data); } static uintptr_t my_DBusPendingCallNotifyFunction_fct_3 = 0; static void my_DBusPendingCallNotifyFunction_3(void* pending, void* data) { RunFunctionFmt(my_DBusPendingCallNotifyFunction_fct_3, "pp", pending, data); }

static void* findDBusPendingCallNotifyFunctionFct(void* fct)
{
    if(!fct) return 
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 181 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusPendingCallNotifyFunction_fct_0 == (uintptr_t)fct) return my_DBusPendingCallNotifyFunction_0; if(my_DBusPendingCallNotifyFunction_fct_1 == (uintptr_t)fct) return my_DBusPendingCallNotifyFunction_1; if(my_DBusPendingCallNotifyFunction_fct_2 == (uintptr_t)fct) return my_DBusPendingCallNotifyFunction_2; if(my_DBusPendingCallNotifyFunction_fct_3 == (uintptr_t)fct) return my_DBusPendingCallNotifyFunction_3;


    if(my_DBusPendingCallNotifyFunction_fct_0 == 0) {my_DBusPendingCallNotifyFunction_fct_0 = (uintptr_t)fct; return my_DBusPendingCallNotifyFunction_0; } if(my_DBusPendingCallNotifyFunction_fct_1 == 0) {my_DBusPendingCallNotifyFunction_fct_1 = (uintptr_t)fct; return my_DBusPendingCallNotifyFunction_1; } if(my_DBusPendingCallNotifyFunction_fct_2 == 0) {my_DBusPendingCallNotifyFunction_fct_2 = (uintptr_t)fct; return my_DBusPendingCallNotifyFunction_2; } if(my_DBusPendingCallNotifyFunction_fct_3 == 0) {my_DBusPendingCallNotifyFunction_fct_3 = (uintptr_t)fct; return my_DBusPendingCallNotifyFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusPendingCallNotifyFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 190 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 190 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 200 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusDispatchStatusFunction_fct_0 = 0; static void my_DBusDispatchStatusFunction_0(void* connection, int new_status, void* data) { RunFunctionFmt(my_DBusDispatchStatusFunction_fct_0, "pip", connection, new_status, data); } static uintptr_t my_DBusDispatchStatusFunction_fct_1 = 0; static void my_DBusDispatchStatusFunction_1(void* connection, int new_status, void* data) { RunFunctionFmt(my_DBusDispatchStatusFunction_fct_1, "pip", connection, new_status, data); } static uintptr_t my_DBusDispatchStatusFunction_fct_2 = 0; static void my_DBusDispatchStatusFunction_2(void* connection, int new_status, void* data) { RunFunctionFmt(my_DBusDispatchStatusFunction_fct_2, "pip", connection, new_status, data); } static uintptr_t my_DBusDispatchStatusFunction_fct_3 = 0; static void my_DBusDispatchStatusFunction_3(void* connection, int new_status, void* data) { RunFunctionFmt(my_DBusDispatchStatusFunction_fct_3, "pip", connection, new_status, data); }

static void* findDBusDispatchStatusFunctionFct(void* fct)
{
    if(!fct) return 
# 204 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 204 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusDispatchStatusFunction_fct_0 == (uintptr_t)fct) return my_DBusDispatchStatusFunction_0; if(my_DBusDispatchStatusFunction_fct_1 == (uintptr_t)fct) return my_DBusDispatchStatusFunction_1; if(my_DBusDispatchStatusFunction_fct_2 == (uintptr_t)fct) return my_DBusDispatchStatusFunction_2; if(my_DBusDispatchStatusFunction_fct_3 == (uintptr_t)fct) return my_DBusDispatchStatusFunction_3;


    if(my_DBusDispatchStatusFunction_fct_0 == 0) {my_DBusDispatchStatusFunction_fct_0 = (uintptr_t)fct; return my_DBusDispatchStatusFunction_0; } if(my_DBusDispatchStatusFunction_fct_1 == 0) {my_DBusDispatchStatusFunction_fct_1 = (uintptr_t)fct; return my_DBusDispatchStatusFunction_1; } if(my_DBusDispatchStatusFunction_fct_2 == 0) {my_DBusDispatchStatusFunction_fct_2 = (uintptr_t)fct; return my_DBusDispatchStatusFunction_2; } if(my_DBusDispatchStatusFunction_fct_3 == 0) {my_DBusDispatchStatusFunction_fct_3 = (uintptr_t)fct; return my_DBusDispatchStatusFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusDispatchStatusFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 213 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 213 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 223 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusAddWatchFunction_fct_0 = 0; static int my_DBusAddWatchFunction_0(void* watch, void* data) { return (int)RunFunctionFmt(my_DBusAddWatchFunction_fct_0, "pp", watch, data); } static uintptr_t my_DBusAddWatchFunction_fct_1 = 0; static int my_DBusAddWatchFunction_1(void* watch, void* data) { return (int)RunFunctionFmt(my_DBusAddWatchFunction_fct_1, "pp", watch, data); } static uintptr_t my_DBusAddWatchFunction_fct_2 = 0; static int my_DBusAddWatchFunction_2(void* watch, void* data) { return (int)RunFunctionFmt(my_DBusAddWatchFunction_fct_2, "pp", watch, data); } static uintptr_t my_DBusAddWatchFunction_fct_3 = 0; static int my_DBusAddWatchFunction_3(void* watch, void* data) { return (int)RunFunctionFmt(my_DBusAddWatchFunction_fct_3, "pp", watch, data); }

static void* findDBusAddWatchFunctionFct(void* fct)
{
    if(!fct) return 
# 227 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 227 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusAddWatchFunction_fct_0 == (uintptr_t)fct) return my_DBusAddWatchFunction_0; if(my_DBusAddWatchFunction_fct_1 == (uintptr_t)fct) return my_DBusAddWatchFunction_1; if(my_DBusAddWatchFunction_fct_2 == (uintptr_t)fct) return my_DBusAddWatchFunction_2; if(my_DBusAddWatchFunction_fct_3 == (uintptr_t)fct) return my_DBusAddWatchFunction_3;


    if(my_DBusAddWatchFunction_fct_0 == 0) {my_DBusAddWatchFunction_fct_0 = (uintptr_t)fct; return my_DBusAddWatchFunction_0; } if(my_DBusAddWatchFunction_fct_1 == 0) {my_DBusAddWatchFunction_fct_1 = (uintptr_t)fct; return my_DBusAddWatchFunction_1; } if(my_DBusAddWatchFunction_fct_2 == 0) {my_DBusAddWatchFunction_fct_2 = (uintptr_t)fct; return my_DBusAddWatchFunction_2; } if(my_DBusAddWatchFunction_fct_3 == 0) {my_DBusAddWatchFunction_fct_3 = (uintptr_t)fct; return my_DBusAddWatchFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusAddWatchFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 236 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 236 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 246 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusRemoveWatchFunction_fct_0 = 0; static void my_DBusRemoveWatchFunction_0(void* watch, void* data) { RunFunctionFmt(my_DBusRemoveWatchFunction_fct_0, "pp", watch, data); } static uintptr_t my_DBusRemoveWatchFunction_fct_1 = 0; static void my_DBusRemoveWatchFunction_1(void* watch, void* data) { RunFunctionFmt(my_DBusRemoveWatchFunction_fct_1, "pp", watch, data); } static uintptr_t my_DBusRemoveWatchFunction_fct_2 = 0; static void my_DBusRemoveWatchFunction_2(void* watch, void* data) { RunFunctionFmt(my_DBusRemoveWatchFunction_fct_2, "pp", watch, data); } static uintptr_t my_DBusRemoveWatchFunction_fct_3 = 0; static void my_DBusRemoveWatchFunction_3(void* watch, void* data) { RunFunctionFmt(my_DBusRemoveWatchFunction_fct_3, "pp", watch, data); }

static void* findDBusRemoveWatchFunctionFct(void* fct)
{
    if(!fct) return 
# 250 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 250 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusRemoveWatchFunction_fct_0 == (uintptr_t)fct) return my_DBusRemoveWatchFunction_0; if(my_DBusRemoveWatchFunction_fct_1 == (uintptr_t)fct) return my_DBusRemoveWatchFunction_1; if(my_DBusRemoveWatchFunction_fct_2 == (uintptr_t)fct) return my_DBusRemoveWatchFunction_2; if(my_DBusRemoveWatchFunction_fct_3 == (uintptr_t)fct) return my_DBusRemoveWatchFunction_3;


    if(my_DBusRemoveWatchFunction_fct_0 == 0) {my_DBusRemoveWatchFunction_fct_0 = (uintptr_t)fct; return my_DBusRemoveWatchFunction_0; } if(my_DBusRemoveWatchFunction_fct_1 == 0) {my_DBusRemoveWatchFunction_fct_1 = (uintptr_t)fct; return my_DBusRemoveWatchFunction_1; } if(my_DBusRemoveWatchFunction_fct_2 == 0) {my_DBusRemoveWatchFunction_fct_2 = (uintptr_t)fct; return my_DBusRemoveWatchFunction_2; } if(my_DBusRemoveWatchFunction_fct_3 == 0) {my_DBusRemoveWatchFunction_fct_3 = (uintptr_t)fct; return my_DBusRemoveWatchFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusRemoveWatchFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 259 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 259 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 269 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusWatchToggledFunction_fct_0 = 0; static void my_DBusWatchToggledFunction_0(void* watch, void* data) { RunFunctionFmt(my_DBusWatchToggledFunction_fct_0, "pp", watch, data); } static uintptr_t my_DBusWatchToggledFunction_fct_1 = 0; static void my_DBusWatchToggledFunction_1(void* watch, void* data) { RunFunctionFmt(my_DBusWatchToggledFunction_fct_1, "pp", watch, data); } static uintptr_t my_DBusWatchToggledFunction_fct_2 = 0; static void my_DBusWatchToggledFunction_2(void* watch, void* data) { RunFunctionFmt(my_DBusWatchToggledFunction_fct_2, "pp", watch, data); } static uintptr_t my_DBusWatchToggledFunction_fct_3 = 0; static void my_DBusWatchToggledFunction_3(void* watch, void* data) { RunFunctionFmt(my_DBusWatchToggledFunction_fct_3, "pp", watch, data); }

static void* findDBusWatchToggledFunctionFct(void* fct)
{
    if(!fct) return 
# 273 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 273 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusWatchToggledFunction_fct_0 == (uintptr_t)fct) return my_DBusWatchToggledFunction_0; if(my_DBusWatchToggledFunction_fct_1 == (uintptr_t)fct) return my_DBusWatchToggledFunction_1; if(my_DBusWatchToggledFunction_fct_2 == (uintptr_t)fct) return my_DBusWatchToggledFunction_2; if(my_DBusWatchToggledFunction_fct_3 == (uintptr_t)fct) return my_DBusWatchToggledFunction_3;


    if(my_DBusWatchToggledFunction_fct_0 == 0) {my_DBusWatchToggledFunction_fct_0 = (uintptr_t)fct; return my_DBusWatchToggledFunction_0; } if(my_DBusWatchToggledFunction_fct_1 == 0) {my_DBusWatchToggledFunction_fct_1 = (uintptr_t)fct; return my_DBusWatchToggledFunction_1; } if(my_DBusWatchToggledFunction_fct_2 == 0) {my_DBusWatchToggledFunction_fct_2 = (uintptr_t)fct; return my_DBusWatchToggledFunction_2; } if(my_DBusWatchToggledFunction_fct_3 == 0) {my_DBusWatchToggledFunction_fct_3 = (uintptr_t)fct; return my_DBusWatchToggledFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusWatchToggledFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 282 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 282 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 292 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusObjectPathUnregisterFunction_fct_0 = 0; static void my_DBusObjectPathUnregisterFunction_0(void* connection, void* data) { RunFunctionFmt(my_DBusObjectPathUnregisterFunction_fct_0, "pp", connection, data); } static uintptr_t my_DBusObjectPathUnregisterFunction_fct_1 = 0; static void my_DBusObjectPathUnregisterFunction_1(void* connection, void* data) { RunFunctionFmt(my_DBusObjectPathUnregisterFunction_fct_1, "pp", connection, data); } static uintptr_t my_DBusObjectPathUnregisterFunction_fct_2 = 0; static void my_DBusObjectPathUnregisterFunction_2(void* connection, void* data) { RunFunctionFmt(my_DBusObjectPathUnregisterFunction_fct_2, "pp", connection, data); } static uintptr_t my_DBusObjectPathUnregisterFunction_fct_3 = 0; static void my_DBusObjectPathUnregisterFunction_3(void* connection, void* data) { RunFunctionFmt(my_DBusObjectPathUnregisterFunction_fct_3, "pp", connection, data); }

static void* findDBusObjectPathUnregisterFunctionFct(void* fct)
{
    if(!fct) return 
# 296 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 296 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusObjectPathUnregisterFunction_fct_0 == (uintptr_t)fct) return my_DBusObjectPathUnregisterFunction_0; if(my_DBusObjectPathUnregisterFunction_fct_1 == (uintptr_t)fct) return my_DBusObjectPathUnregisterFunction_1; if(my_DBusObjectPathUnregisterFunction_fct_2 == (uintptr_t)fct) return my_DBusObjectPathUnregisterFunction_2; if(my_DBusObjectPathUnregisterFunction_fct_3 == (uintptr_t)fct) return my_DBusObjectPathUnregisterFunction_3;


    if(my_DBusObjectPathUnregisterFunction_fct_0 == 0) {my_DBusObjectPathUnregisterFunction_fct_0 = (uintptr_t)fct; return my_DBusObjectPathUnregisterFunction_0; } if(my_DBusObjectPathUnregisterFunction_fct_1 == 0) {my_DBusObjectPathUnregisterFunction_fct_1 = (uintptr_t)fct; return my_DBusObjectPathUnregisterFunction_1; } if(my_DBusObjectPathUnregisterFunction_fct_2 == 0) {my_DBusObjectPathUnregisterFunction_fct_2 = (uintptr_t)fct; return my_DBusObjectPathUnregisterFunction_2; } if(my_DBusObjectPathUnregisterFunction_fct_3 == 0) {my_DBusObjectPathUnregisterFunction_fct_3 = (uintptr_t)fct; return my_DBusObjectPathUnregisterFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusObjectPathUnregisterFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 305 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 305 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 315 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_DBusObjectPathMessageFunction_fct_0 = 0; static void my_DBusObjectPathMessageFunction_0(void* connection, void* message, void* data) { RunFunctionFmt(my_DBusObjectPathMessageFunction_fct_0, "ppp", connection, message, data); } static uintptr_t my_DBusObjectPathMessageFunction_fct_1 = 0; static void my_DBusObjectPathMessageFunction_1(void* connection, void* message, void* data) { RunFunctionFmt(my_DBusObjectPathMessageFunction_fct_1, "ppp", connection, message, data); } static uintptr_t my_DBusObjectPathMessageFunction_fct_2 = 0; static void my_DBusObjectPathMessageFunction_2(void* connection, void* message, void* data) { RunFunctionFmt(my_DBusObjectPathMessageFunction_fct_2, "ppp", connection, message, data); } static uintptr_t my_DBusObjectPathMessageFunction_fct_3 = 0; static void my_DBusObjectPathMessageFunction_3(void* connection, void* message, void* data) { RunFunctionFmt(my_DBusObjectPathMessageFunction_fct_3, "ppp", connection, message, data); }

static void* findDBusObjectPathMessageFunctionFct(void* fct)
{
    if(!fct) return 
# 319 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 319 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_DBusObjectPathMessageFunction_fct_0 == (uintptr_t)fct) return my_DBusObjectPathMessageFunction_0; if(my_DBusObjectPathMessageFunction_fct_1 == (uintptr_t)fct) return my_DBusObjectPathMessageFunction_1; if(my_DBusObjectPathMessageFunction_fct_2 == (uintptr_t)fct) return my_DBusObjectPathMessageFunction_2; if(my_DBusObjectPathMessageFunction_fct_3 == (uintptr_t)fct) return my_DBusObjectPathMessageFunction_3;


    if(my_DBusObjectPathMessageFunction_fct_0 == 0) {my_DBusObjectPathMessageFunction_fct_0 = (uintptr_t)fct; return my_DBusObjectPathMessageFunction_0; } if(my_DBusObjectPathMessageFunction_fct_1 == 0) {my_DBusObjectPathMessageFunction_fct_1 = (uintptr_t)fct; return my_DBusObjectPathMessageFunction_1; } if(my_DBusObjectPathMessageFunction_fct_2 == 0) {my_DBusObjectPathMessageFunction_fct_2 = (uintptr_t)fct; return my_DBusObjectPathMessageFunction_2; } if(my_DBusObjectPathMessageFunction_fct_3 == 0) {my_DBusObjectPathMessageFunction_fct_3 = (uintptr_t)fct; return my_DBusObjectPathMessageFunction_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus DBusObjectPathMessageFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 328 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 328 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}
# 338 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
static uintptr_t my_dbus_internal_pad_fct_0 = 0; static void my_dbus_internal_pad_0(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_dbus_internal_pad_fct_0, "pppp", a, b, c, d); } static uintptr_t my_dbus_internal_pad_fct_1 = 0; static void my_dbus_internal_pad_1(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_dbus_internal_pad_fct_1, "pppp", a, b, c, d); } static uintptr_t my_dbus_internal_pad_fct_2 = 0; static void my_dbus_internal_pad_2(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_dbus_internal_pad_fct_2, "pppp", a, b, c, d); } static uintptr_t my_dbus_internal_pad_fct_3 = 0; static void my_dbus_internal_pad_3(void* a, void* b, void* c, void* d) { RunFunctionFmt(my_dbus_internal_pad_fct_3, "pppp", a, b, c, d); }

static void* finddbus_internal_padFct(void* fct)
{
    if(!fct) return 
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                   ((void *)0)
# 342 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_dbus_internal_pad_fct_0 == (uintptr_t)fct) return my_dbus_internal_pad_0; if(my_dbus_internal_pad_fct_1 == (uintptr_t)fct) return my_dbus_internal_pad_1; if(my_dbus_internal_pad_fct_2 == (uintptr_t)fct) return my_dbus_internal_pad_2; if(my_dbus_internal_pad_fct_3 == (uintptr_t)fct) return my_dbus_internal_pad_3;


    if(my_dbus_internal_pad_fct_0 == 0) {my_dbus_internal_pad_fct_0 = (uintptr_t)fct; return my_dbus_internal_pad_0; } if(my_dbus_internal_pad_fct_1 == 0) {my_dbus_internal_pad_fct_1 = (uintptr_t)fct; return my_dbus_internal_pad_1; } if(my_dbus_internal_pad_fct_2 == 0) {my_dbus_internal_pad_fct_2 = (uintptr_t)fct; return my_dbus_internal_pad_2; } if(my_dbus_internal_pad_fct_3 == 0) {my_dbus_internal_pad_fct_3 = (uintptr_t)fct; return my_dbus_internal_pad_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbus dbus_internal_pad callback\n"); fflush(ftrace);}} while(0);
    return 
# 351 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
          ((void *)0)
# 351 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
              ;
}


__attribute__((visibility("default"))) void my_dbus_timeout_set_data(x86emu_t* emu, void* e, void* p, void* f)
{
    (void)emu;
...
__attribute__((visibility("default"))) int32_t my_dbus_connection_set_timeout_functions(x86emu_t* emu, void* c, void* a, void* r, void* t, void* d, void* f)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_dbus_connection_add_filter(x86emu_t* emu, void* connection, void* fnc, void* data, void* fr)
{
    (void)emu;
    return my->dbus_connection_add_filter(connection, find_DBusHandleMessageFunction_Fct(fnc), data, find_DBusFreeFunction_Fct(fr));
}

__attribute__((visibility("default"))) void my_dbus_connection_remove_filter(x86emu_t* emu, void* connection, void* fnc, void* data)
{
    (void)emu;
    my->dbus_connection_remove_filter(connection, find_DBusHandleMessageFunction_Fct(fnc), data);
}

__attribute__((visibility("default"))) int my_dbus_message_get_args_valist(x86emu_t* emu, void* message, void* e, int arg, void* b)
{
...
__attribute__((visibility("default"))) int my_dbus_message_get_args(x86emu_t* emu, void* message, void* e, int arg, void* V)
{
...
__attribute__((visibility("default"))) int my_dbus_message_set_data(x86emu_t* emu, void* message, int32_t slot, void* data, void* free_func)
{
    (void)emu;
    return my->dbus_message_set_data(message, slot, data, find_DBusFreeFunction_Fct(free_func));
}

__attribute__((visibility("default"))) int my_dbus_pending_call_set_notify(x86emu_t* emu, void* pending, void* func, void* data, void* free_func)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_dbus_pending_call_set_data(x86emu_t* emu, void* pending, int32_t slot, void* data, void* free_func)
{
    (void)emu;
    return my->dbus_pending_call_set_data(pending, slot, data, find_DBusFreeFunction_Fct(free_func));
}

__attribute__((visibility("default"))) void my_dbus_watch_set_data(x86emu_t* emu, void* watch, void* data, void* free_func)
{
    (void)emu;
    my->dbus_watch_set_data(watch, data, find_DBusFreeFunction_Fct(free_func));
}

__attribute__((visibility("default"))) void my_dbus_connection_set_dispatch_status_function(x86emu_t* emu, void* connection, void* dispatch, void* data, void* free_func)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_dbus_connection_set_watch_functions(x86emu_t* emu, void* connection, void* add, void* remove, void* toggled, void* data, void* free_func)
{
    (void)emu;
...
__attribute__((visibility("default"))) int my_dbus_connection_try_register_object_path(x86emu_t* emu, void* connection, void* path, my_DBusObjectPathVTable_t* vtable, void* data, void* error)
{
    (void)emu;
    ...
    return my->dbus_connection_try_register_object_path(connection, path, vtable?&vt:
# 468 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                                                                                    ((void *)0)
# 468 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                                                                                        , data, error);
}

__attribute__((visibility("default"))) int my_dbus_connection_try_register_fallback(x86emu_t* emu, void* connection, void* path, my_DBusObjectPathVTable_t* vtable, void* data, void* error)
{
    (void)emu;
    my_DBusObjectPathVTable_t vt = {0};
    if(vtable) {
    ...
    return my->dbus_connection_try_register_fallback(connection, path, vtable?&vt:
# 484 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 3 4
                                                                                 ((void *)0)
# 484 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
                                                                                     , data, error);
}

__attribute__((visibility("default"))) int my_dbus_connection_set_data(x86emu_t* emu, void* connection, int slot, void* data, void* free_func)
{
    (void)emu;
    return my->dbus_connection_set_data(connection, slot, data, find_DBusFreeFunction_Fct(free_func));
}

__attribute__((visibility("default"))) void my_dbus_connection_set_wakeup_main_function(x86emu_t* emu, void* connection, void* wakeup, void* data, void* free_func)
{
    (void)emu;
...
# 506 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbussymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h" 1




{"dbus_address_entries_free", vFp, 0},
{"dbus_address_entry_get_method", pFp, 0},
{"dbus_address_entry_get_value", pFpp, 0},
{"dbus_address_escape_value", pFp, 0},
{"dbus_address_unescape_value", pFpp, 0},
{"dbus_bus_add_match", vFppp, 0},
{"dbus_bus_get", pFip, 0},
{"dbus_bus_get_id", pFpp, 0},
{"dbus_bus_get_private", pFip, 0},
{"dbus_bus_get_unique_name", pFp, 0},
{"dbus_bus_get_unix_user", uFppp, 0},
{"dbus_bus_name_has_owner", iFppp, 0},
{"dbus_bus_register", iFpp, 0},
{"dbus_bus_release_name", iFppp, 0},
{"dbus_bus_remove_match", vFppp, 0},
{"dbus_bus_request_name", iFppup, 0},
{"dbus_bus_set_unique_name", iFpp, 0},
{"dbus_bus_start_service_by_name", iFppupp, 0},

{"dbus_connection_allocate_data_slot", iFp, 0},
{"dbus_connection_borrow_message", pFp, 0},
{"dbus_connection_can_send_type", iFpi, 0},
{"dbus_connection_close", vFp, 0},
{"dbus_connection_dispatch", iFp, 0},
{"dbus_connection_flush", vFp, 0},
{"dbus_connection_free_data_slot", vFp, 0},
{"dbus_connection_free_preallocated_send", vFpp, 0},
{"dbus_connection_get_adt_audit_session_data", iFppp, 0},
{"dbus_connection_get_data", pFpi, 0},
{"dbus_connection_get_dispatch_status", iFp, 0},
{"dbus_connection_get_is_anonymous", iFp, 0},
{"dbus_connection_get_is_authenticated", iFp, 0},
{"dbus_connection_get_is_connected", iFp, 0},
{"dbus_connection_get_max_message_size", lFp, 0},
{"dbus_connection_get_max_received_size", lFp, 0},
{"dbus_connection_get_object_path_data", iFppp, 0},
{"dbus_connection_get_outgoing_size", lFp, 0},
{"dbus_connection_get_server_id", pFp, 0},
{"dbus_connection_get_socket", iFpp, 0},
{"dbus_connection_get_unix_fd", iFpp, 0},
{"dbus_connection_get_unix_process_id", iFpp, 0},
{"dbus_connection_get_unix_user", iFpp, 0},
{"dbus_connection_get_windows_user", iFpp, 0},
{"dbus_connection_has_messages_to_send", iFp, 0},
{"dbus_connection_list_registered", iFppp, 0},
{"dbus_connection_open", pFpp, 0},
{"dbus_connection_open_private", pFpp, 0},
{"dbus_connection_pop_message", pFp, 0},
{"dbus_connection_preallocate_send", pFp, 0},
{"dbus_connection_read_write", iFpi, 0},
{"dbus_connection_read_write_dispatch", iFpi, 0},
{"dbus_connection_ref", pFp, 0},



{"dbus_connection_return_message", vFpp, 0},
{"dbus_connection_send", iFppp, 0},
{"dbus_connection_send_preallocated", vFpppp, 0},
{"dbus_connection_send_with_reply", iFpppi, 0},
{"dbus_connection_send_with_reply_and_block", pFppip, 0},
{"dbus_connection_set_allow_anonymous", vFpi, 0},
{"dbus_connection_set_change_sigpipe", vFi, 0},


{"dbus_connection_set_exit_on_disconnect", vFpi, 0},
{"dbus_connection_set_max_message_size", vFpl, 0},
{"dbus_connection_set_max_received_size", vFpl, 0},
{"dbus_connection_set_route_peer_messages", vFpi, 0},





{"dbus_connection_steal_borrowed_message", vFpp, 0},


{"dbus_connection_unref", vFp, 0},
{"dbus_connection_unregister_object_path", iFpp, 0},
{"dbus_error_free", vFp, 0},
{"dbus_error_has_name", iFpp, 0},
{"dbus_error_init", vFp, 0},
{"dbus_error_is_set", iFp, 0},
{"dbus_free", vFp, 0},
{"dbus_free_string_array", vFp, 0},
{"dbus_get_local_machine_id", pFv, 0},
{"dbus_get_version", vFppp, 0},


{"dbus_malloc", pFL, 0},
{"dbus_malloc0", pFL, 0},
{"dbus_message_allocate_data_slot", iFp, 0},

{"dbus_message_append_args_valist", iFpip, 0},
{"dbus_message_copy", pFp, 0},
{"dbus_message_demarshal", pFpip, 0},
{"dbus_message_demarshal_bytes_needed", iFpi, 0},
{"dbus_message_free_data_slot", vFp, 0},


{"dbus_message_get_auto_start", iFp, 0},
{"dbus_message_get_data", pFpi, 0},
{"dbus_message_get_destination", pFp, 0},
{"dbus_message_get_error_name", pFp, 0},
{"dbus_message_get_interface", pFp, 0},
{"dbus_message_get_member", pFp, 0},
{"dbus_message_get_no_reply", iFp, 0},
{"dbus_message_get_path", pFp, 0},
{"dbus_message_get_path_decomposed", iFpp, 0},
{"dbus_message_get_reply_serial", uFp, 0},
{"dbus_message_get_sender", pFp, 0},
{"dbus_message_get_serial", iFp, 0},
{"dbus_message_get_signature", pFp, 0},
{"dbus_message_get_type", iFp, 0},
{"dbus_message_has_destination", iFpp, 0},
{"dbus_message_has_interface", iFpp, 0},
{"dbus_message_has_member", iFpp, 0},
{"dbus_message_has_path", iFpp, 0},
{"dbus_message_has_sender", iFpp, 0},
{"dbus_message_has_signature", iFpp, 0},
{"dbus_message_is_error", iFpp, 0},
{"dbus_message_is_method_call", iFppp, 0},
{"dbus_message_is_signal", iFppp, 0},
{"dbus_message_iter_abandon_container", vFpp, 0},
{"dbus_message_iter_append_basic", iFpip, 0},
{"dbus_message_iter_append_fixed_array", iFpipi, 0},
{"dbus_message_iter_close_container", iFpp, 0},
{"dbus_message_iter_get_arg_type", iFp, 0},
{"dbus_message_iter_get_array_len", iFp, 0},
{"dbus_message_iter_get_basic", vFpp, 0},
{"dbus_message_iter_get_element_type", iFp, 0},
{"dbus_message_iter_get_fixed_array", vFppp, 0},
{"dbus_message_iter_get_signature", pFp, 0},
{"dbus_message_iter_has_next", iFp, 0},
{"dbus_message_iter_init", iFpp, 0},
{"dbus_message_iter_init_append", vFpp, 0},
{"dbus_message_iter_next", iFp, 0},
{"dbus_message_iter_open_container", iFpipp, 0},
{"dbus_message_iter_recurse", vFpp, 0},
{"dbus_message_lock", vFp, 0},
{"dbus_message_marshal", iFppp, 0},
{"dbus_message_new", pFi, 0},
{"dbus_message_new_error", pFppp, 0},
{"dbus_message_new_error_printf", pFpppppppppppp, 0},
{"dbus_message_new_method_call", pFpppp, 0},
{"dbus_message_new_method_return", pFp, 0},
{"dbus_message_new_signal", pFppp, 0},
{"dbus_message_ref", pFp, 0},
{"dbus_message_set_auto_start", vFpi, 0},

{"dbus_message_set_destination", iFpp, 0},
{"dbus_message_set_error_name", iFpp, 0},
{"dbus_message_set_interface", iFpp, 0},
{"dbus_message_set_member", iFpp, 0},
{"dbus_message_set_no_reply", vFpi, 0},
{"dbus_message_set_path", iFpp, 0},
{"dbus_message_set_reply_serial", iFpu, 0},
{"dbus_message_set_sender", iFpp, 0},
{"dbus_message_set_serial", vFpu, 0},
{"dbus_message_type_from_string", iFp, 0},
{"dbus_message_type_to_string", pFi, 0},
{"dbus_message_unref", vFp, 0},
{"dbus_move_error", vFpp, 0},
{"dbus_parse_address", iFpppp, 0},
{"dbus_pending_call_allocate_data_slot", iFp, 0},
{"dbus_pending_call_block", vFp, 0},
{"dbus_pending_call_cancel", vFp, 0},
{"dbus_pending_call_free_data_slot", vFp, 0},
{"dbus_pending_call_get_completed", iFp, 0},
{"dbus_pending_call_get_data", pFpi, 0},
{"dbus_pending_call_ref", pFp, 0},


{"dbus_pending_call_steal_reply", pFp, 0},
{"dbus_pending_call_unref", vFp, 0},
{"dbus_realloc", pFpp, 0},
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h"
{"dbus_set_error", vFpppppppppp, 0},
{"dbus_set_error_const", vFppp, 0},
{"dbus_set_error_from_message", iFpp, 0},
{"dbus_shutdown", vFv, 0},
{"dbus_signature_iter_get_current_type", iFp, 0},
{"dbus_signature_iter_get_element_type", iFp, 0},
{"dbus_signature_iter_get_signature", pFp, 0},
{"dbus_signature_iter_init", vFpp, 0},
{"dbus_signature_iter_next", iFp, 0},
{"dbus_signature_iter_recurse", vFpp, 0},
{"dbus_signature_validate", iFpp, 0},
{"dbus_signature_validate_single", iFpp, 0},

{"dbus_threads_init_default", iFv, 0},
{"dbus_timeout_get_data", pFp, 0},
{"dbus_timeout_get_enabled", iFp, 0},
{"dbus_timeout_get_interval", iFp, 0},
{"dbus_timeout_handle", iFp, 0},

{"dbus_type_is_basic", iFi, 0},
{"dbus_type_is_container", iFi, 0},
{"dbus_type_is_fixed", iFi, 0},
{"dbus_type_is_valid", iFi, 0},
{"dbus_try_get_local_machine_id", pFp, 0},
{"dbus_validate_bus_name", iFpp, 0},
{"dbus_validate_error_name", iFpp, 0},
{"dbus_validate_interface", iFpp, 0},
{"dbus_validate_member", iFpp, 0},
{"dbus_validate_path", iFpp, 0},
{"dbus_validate_utf8", iFpp, 0},
{"dbus_watch_get_data", pFp, 0},
{"dbus_watch_get_enabled", iFp, 0},
{"dbus_watch_get_fd", iFp, 0},
{"dbus_watch_get_flags", uFp, 0},
{"dbus_watch_get_socket", iFp, 0},
{"dbus_watch_get_unix_fd", iFp, 0},
{"dbus_watch_handle", iFpu, 0},

# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h" 1
...
{"dbus_connection_add_filter", iFEpppp, 0},
...
{"dbus_connection_remove_filter", vFEppp, 0},
...
{"dbus_connection_set_data", iFEpipp, 0},
{"dbus_connection_set_dispatch_status_function", vFEpppp, 0},




{"dbus_connection_set_timeout_functions", iFEpppppp, 0},

{"dbus_connection_set_wakeup_main_function", vFEpppp, 0},
{"dbus_connection_set_watch_functions", iFEpppppp, 0},


{"dbus_connection_try_register_fallback", iFEppppp, 0},
{"dbus_connection_try_register_object_path", iFEppppp, 0},
...
{"dbus_message_get_args", iFEppiV, 0},
{"dbus_message_get_args_valist", iFEppip, 0},
...
{"dbus_message_set_data", iFEpipp, 0},
...
{"dbus_pending_call_set_data", iFEpipp, 0},
{"dbus_pending_call_set_notify", iFEpppp, 0},
...
{"dbus_timeout_set_data", vFEppp, 0},
...
static const map_onesymbol2_t dbussymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h" 1
...
{"dbus_message_append_args", iFpiV, 0, "dbus_message_append_args_valist"},
...
static const map_onedata_t dbusdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h" 1
...
static const map_onedata_t dbusmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusundefs.h" 1
...
int wrappeddbus_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(dbusName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(dbussymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbussymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, dbussymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = dbussymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, dbussymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = dbussymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(dbussymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbussymbolmap[i].name); }
 cnt = sizeof(dbusmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, dbusmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = dbusmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, dbusmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = dbusmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(dbusmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusmysymbolmap[i].name); }

    cnt = sizeof(dbusstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, dbusstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = dbusstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(dbusstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, dbusstsymbolmap[i].name);
    }
    cnt = sizeof(dbussymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, dbussymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = dbussymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = dbussymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = dbussymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(dbussymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, dbussymbol2map[i].name);
    }
    cnt = sizeof(dbusdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(dbusdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, dbusdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = dbusdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, dbusdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = dbusdatamap[i].sz;
        }
    }
    cnt = sizeof(dbusmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, dbusmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = dbusmydatamap[i].sz;
    }
...
void wrappeddbus_fini(library_t* lib)
{
...
# 507 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbus.c" 2
