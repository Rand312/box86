# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpegtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpegtypes.h"
typedef void (*vFpp_t)(void*, void*);
typedef void* (*pFipi_t)(int32_t, void*, int32_t);
typedef void* (*pFppi_t)(void*, void*, int32_t);
typedef void (*vFpppp_t)(void*, void*, void*, void*);
typedef void* (*pFpipi_t)(void*, int32_t, void*, int32_t);
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
...
typedef struct smpeg_my_s {
    ...
    vFpp_t SMPEG_getinfo; pFipi_t SMPEG_new_descr; pFppi_t SMPEG_new; pFppi_t SMPEG_new_rwops; vFpppp_t SMPEG_setdisplay; pFpipi_t SMPEG_new_data;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static smpeg_my_t my_smpeg = {0};
static smpeg_my_t * const my = &my_smpeg;

static void getMy(library_t* lib)
{

    my->SMPEG_getinfo = (vFpp_t)dlsym(lib->w.lib, "SMPEG_getinfo"); my->SMPEG_new_descr = (pFipi_t)dlsym(lib->w.lib, "SMPEG_new_descr"); my->SMPEG_new = (pFppi_t)dlsym(lib->w.lib, "SMPEG_new"); my->SMPEG_new_rwops = (pFppi_t)dlsym(lib->w.lib, "SMPEG_new_rwops"); my->SMPEG_setdisplay = (vFpppp_t)dlsym(lib->w.lib, "SMPEG_setdisplay"); my->SMPEG_new_data = (pFpipi_t)dlsym(lib->w.lib, "SMPEG_new_data");
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c"
static uintptr_t my_dispcallback_fct_0 = 0; static void my_dispcallback_0(void* dst, int32_t x, int32_t y, unsigned int w, unsigned int h){ RunFunctionFmt(my_dispcallback_fct_0, "piiuu", dst, x, y, w, h); } static uintptr_t my_dispcallback_fct_1 = 0; static void my_dispcallback_1(void* dst, int32_t x, int32_t y, unsigned int w, unsigned int h){ RunFunctionFmt(my_dispcallback_fct_1, "piiuu", dst, x, y, w, h); } static uintptr_t my_dispcallback_fct_2 = 0; static void my_dispcallback_2(void* dst, int32_t x, int32_t y, unsigned int w, unsigned int h){ RunFunctionFmt(my_dispcallback_fct_2, "piiuu", dst, x, y, w, h); } static uintptr_t my_dispcallback_fct_3 = 0; static void my_dispcallback_3(void* dst, int32_t x, int32_t y, unsigned int w, unsigned int h){ RunFunctionFmt(my_dispcallback_fct_3, "piiuu", dst, x, y, w, h); } static uintptr_t my_dispcallback_fct_4 = 0; static void my_dispcallback_4(void* dst, int32_t x, int32_t y, unsigned int w, unsigned int h){ RunFunctionFmt(my_dispcallback_fct_4, "piiuu", dst, x, y, w, h); }
...
static void* find_dispcallback_Fct(void* fct)
{
    ...
    if(my_dispcallback_fct_0 == (uintptr_t)fct) return my_dispcallback_0; if(my_dispcallback_fct_1 == (uintptr_t)fct) return my_dispcallback_1; if(my_dispcallback_fct_2 == (uintptr_t)fct) return my_dispcallback_2; if(my_dispcallback_fct_3 == (uintptr_t)fct) return my_dispcallback_3; if(my_dispcallback_fct_4 == (uintptr_t)fct) return my_dispcallback_4;


    if(my_dispcallback_fct_0 == 0) {my_dispcallback_fct_0 = (uintptr_t)fct; return my_dispcallback_0; } if(my_dispcallback_fct_1 == 0) {my_dispcallback_fct_1 = (uintptr_t)fct; return my_dispcallback_1; } if(my_dispcallback_fct_2 == 0) {my_dispcallback_fct_2 = (uintptr_t)fct; return my_dispcallback_2; } if(my_dispcallback_fct_3 == 0) {my_dispcallback_fct_3 = (uintptr_t)fct; return my_dispcallback_3; } if(my_dispcallback_fct_4 == 0) {my_dispcallback_fct_4 = (uintptr_t)fct; return my_dispcallback_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libsmpeg dispcallback callback\n"); fflush(ftrace);}} while(0);
    return 
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 3 4
          ((void *)0)
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c"
              ;
}


__attribute__((visibility("default"))) void my_SMPEG_setdisplay(x86emu_t* emu, void* mpeg, void* surf, void* lock, void* cb)
{
    (void)emu;
    my->SMPEG_setdisplay(mpeg, surf, lock, find_dispcallback_Fct(cb));
}

__attribute__((visibility("default"))) void my_SMPEG_getinfo(x86emu_t* emu, void* mpeg, void* info)
{
    (void)emu;
...
__attribute__((visibility("default"))) void* my_SMPEG_new(x86emu_t* emu, void* file, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
...
__attribute__((visibility("default"))) void* my_SMPEG_new_descr(x86emu_t* emu, int file, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
    AlignSmpegInfo(&inf, info);
...
__attribute__((visibility("default"))) void* my_SMPEG_new_data(x86emu_t* emu, void* data, int size, void* info, int sdl_audio)
{
    (void)emu;
    my_SMPEG_Info_t inf;
    AlignSmpegInfo(&inf, info);
...
__attribute__((visibility("default"))) void* my_SMPEG_new_rwops(x86emu_t* emu, void* src, void* info, int32_t sdl_audio)
{
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpegdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t smpegsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1


{"SMPEG_actualSpec", vFpp, 0},
{"SMPEG_delete", vFp, 0},
{"SMPEG_enableaudio", vFpi, 0},
{"SMPEG_enablevideo", vFpi, 0},
{"SMPEG_error", pFp, 0},
{"SMPEG_filter", pFpp, 0},
...
{"SMPEG_pause", vFp, 0},
{"SMPEG_play", vFp, 0},
{"SMPEG_playAudio", iFppi, 0},
{"SMPEG_playAudioSDL", vFppi, 0},
{"SMPEG_renderFinal", vFppii, 0},
{"SMPEG_renderFrame", vFpi, 0},
{"SMPEG_rewind", vFp, 0},
{"SMPEG_scale", vFpi, 0},
{"SMPEG_scaleXY", vFpii, 0},
{"SMPEG_seek", vFpi, 0},

{"SMPEG_setdisplayregion", vFpiiii, 0},
{"SMPEG_setvolume", vFpi, 0},
{"SMPEG_skip", vFpf, 0},
{"SMPEG_status", iFp, 0},
{"SMPEG_stop", vFp, 0},
{"SMPEG_wantedSpec", iFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t smpegmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1
...
{"SMPEG_getinfo", vFEpp, 0},


{"SMPEG_new", pFEppi, 0},
{"SMPEG_new_data", pFEpipi, 0},
{"SMPEG_new_descr", pFEipi, 0},
{"SMPEG_new_rwops", pFEppi, 0},
...
static const map_onesymbol_t smpegstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1
...
static const map_onesymbol2_t smpegsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1
...
static const map_onedata_t smpegdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1
...
static const map_onedata_t smpegmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedsmpegundefs.h" 1
...
int wrappedsmpeg_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(smpegName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(smpegsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (smpegsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, smpegsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = smpegsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, smpegsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = smpegsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(smpegsymbolmap[i].name, '@')) AddDictionnary(box86->versym, smpegsymbolmap[i].name); }
 cnt = sizeof(smpegmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (smpegmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, smpegmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = smpegmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, smpegmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = smpegmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(smpegmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, smpegmysymbolmap[i].name); }

    cnt = sizeof(smpegstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, smpegstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = smpegstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(smpegstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, smpegstsymbolmap[i].name);
    }
    cnt = sizeof(smpegsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, smpegsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = smpegsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = smpegsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = smpegsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(smpegsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, smpegsymbol2map[i].name);
    }
    cnt = sizeof(smpegdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(smpegdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, smpegdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = smpegdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, smpegdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = smpegdatamap[i].sz;
        }
    }
    cnt = sizeof(smpegmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, smpegmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = smpegmydatamap[i].sz;
    }
...
void wrappedsmpeg_fini(library_t* lib)
{
...
# 122 "/home/ssd/pico/code/box86/src/wrapped/wrappedsmpeg.c" 2
