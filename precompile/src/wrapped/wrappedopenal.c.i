# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2

const char* openalName = "libopenal.so.1";

static char* libname = 
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
                      ((void *)0)
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                          ;



# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopenaltypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopenaltypes.h"
typedef void (*vFv_t)(void);
typedef void* (*pFp_t)(void*);
typedef void* (*pFpp_t)(void*, void*);
typedef void (*vFiiipp_t)(int32_t, int32_t, int32_t, void*, void*);
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
typedef struct openal_my_s {
    ...
    vFv_t alRequestFoldbackStop; pFp_t alGetProcAddress; pFpp_t alcGetProcAddress; vFiiipp_t alRequestFoldbackStart;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static openal_my_t my_openal = {0};
static openal_my_t * const my = &my_openal;

static void getMy(library_t* lib)
{

    my->alRequestFoldbackStop = (vFv_t)dlsym(lib->w.lib, "alRequestFoldbackStop"); my->alGetProcAddress = (pFp_t)dlsym(lib->w.lib, "alGetProcAddress"); my->alcGetProcAddress = (pFpp_t)dlsym(lib->w.lib, "alcGetProcAddress"); my->alRequestFoldbackStart = (vFiiipp_t)dlsym(lib->w.lib, "alRequestFoldbackStart");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
static uintptr_t my_Request_fct_0 = 0; static void my_Request_0(int32_t a, int32_t b) { RunFunctionFmt(my_Request_fct_0, "ii", a, b); } static uintptr_t my_Request_fct_1 = 0; static void my_Request_1(int32_t a, int32_t b) { RunFunctionFmt(my_Request_fct_1, "ii", a, b); } static uintptr_t my_Request_fct_2 = 0; static void my_Request_2(int32_t a, int32_t b) { RunFunctionFmt(my_Request_fct_2, "ii", a, b); } static uintptr_t my_Request_fct_3 = 0; static void my_Request_3(int32_t a, int32_t b) { RunFunctionFmt(my_Request_fct_3, "ii", a, b); } static uintptr_t my_Request_fct_4 = 0; static void my_Request_4(int32_t a, int32_t b) { RunFunctionFmt(my_Request_fct_4, "ii", a, b); }
...
static void* find_Request_Fct(void* fct)
{
    ...
    if(my_Request_fct_0 == (uintptr_t)fct) return my_Request_0; if(my_Request_fct_1 == (uintptr_t)fct) return my_Request_1; if(my_Request_fct_2 == (uintptr_t)fct) return my_Request_2; if(my_Request_fct_3 == (uintptr_t)fct) return my_Request_3; if(my_Request_fct_4 == (uintptr_t)fct) return my_Request_4;


    if(my_Request_fct_0 == 0) {my_Request_fct_0 = (uintptr_t)fct; return my_Request_0; } if(my_Request_fct_1 == 0) {my_Request_fct_1 = (uintptr_t)fct; return my_Request_1; } if(my_Request_fct_2 == 0) {my_Request_fct_2 = (uintptr_t)fct; return my_Request_2; } if(my_Request_fct_3 == 0) {my_Request_fct_3 = (uintptr_t)fct; return my_Request_3; } if(my_Request_fct_4 == 0) {my_Request_fct_4 = (uintptr_t)fct; return my_Request_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for zlib Request callback\n"); fflush(ftrace);}} while(0);
    return 
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
          ((void *)0)
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
              ;
}
...
__attribute__((visibility("default"))) void* my_alGetProcAddress(x86emu_t* emu, void* name)
{
    khint_t k;
    const char* rname = (const char*)name;
    do {if((2)<=box86_log) {fprintf(ftrace, "Calling alGetProcAddress(%s)\n", rname); fflush(ftrace);}} while(0);
    if(!emu->context->alwrappers)
        fillALProcWrapper();

    k = kh_get_symbolmap(emu->context->almymap, rname);
    int is_my = (k==((emu->context->almymap)->n_buckets))?0:1;
    void* symbol;
    if(is_my) {
    ...
    if(!symbol)
        return 
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
              ((void *)0)
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                  ;

    k = kh_get_symbolmap(emu->context->alwrappers, rname);
    if(k==((emu->context->alwrappers)->n_buckets)) {
        do {if((1)<=box86_log) {fprintf(ftrace, "Warning, no wrapper for %s\n", rname); fflush(ftrace);}} while(0);
        return 
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
              ((void *)0)
# 89 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                  ;
    }
    symbol1_t *s = &((emu->context->alwrappers)->vals[k]);
    if(!s->resolved) {
        const char* constname = ((emu->context->alwrappers)->keys[k]);
...
__attribute__((visibility("default"))) void* my_alcGetProcAddress(x86emu_t* emu, void* device, void* name)
{
    khint_t k;
    const char* rname = (const char*)name;
    do {if((2)<=box86_log) {fprintf(ftrace, "Calling alcGetProcAddress(%p, %s)\n", device, rname); fflush(ftrace);}} while(0);
    if(!emu->context->alwrappers)
        fillALProcWrapper();
    ...
    if(!symbol)
        return 
# 120 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
              ((void *)0)
# 120 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                  ;
    ...
    if(k==((emu->context->alwrappers)->n_buckets)) {
        do {if((1)<=box86_log) {fprintf(ftrace, "Warning, no wrapper for %s\n", rname); fflush(ftrace);}} while(0);
        return 
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
              ((void *)0)
# 125 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                  ;
    }
    symbol1_t *s = &((emu->context->alwrappers)->vals[k]);
    if(!s->resolved) {
...
__attribute__((visibility("default"))) void my_alRequestFoldbackStart(x86emu_t *emu, int32_t mode, int32_t count, int32_t length, void* mem, void* cb)
{
    (void)emu;
    my->alRequestFoldbackStart(mode, count, length, mem, find_Request_Fct(cb));
}

__attribute__((visibility("default"))) void my_alRequestFoldbackStop(x86emu_t* emu)
{
    (void)emu;
    my->alRequestFoldbackStop();
}
# 155 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopenaldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t openalsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1




{"alDopplerFactor", vFf, 0},
{"alDopplerVelocity", vFf, 0},
{"alSpeedOfSound", vFf, 0},
{"alDistanceModel", vFi, 0},
{"alEnable", vFi, 0},
{"alDisable", vFi, 0},
{"alIsEnabled", cFi, 0},
{"alGetString", pFi, 0},
{"alGetBooleanv", vFip, 0},
{"alGetIntegerv", vFip, 0},
{"alGetFloatv", vFip, 0},
{"alGetDoublev", vFip, 0},
{"alGetBoolean", iFi, 0},
{"alGetInteger", iFi, 0},
...
{"alGetDouble", dFi, 0},
{"alGetError", iFv, 0},
{"alIsExtensionPresent", cFp, 0},

{"alGetEnumValue", iFp, 0},
{"alListenerf", vFif, 0},
{"alListener3f", vFifff, 0},
{"alListenerfv", vFip, 0},
{"alListeneri", vFii, 0},
{"alListener3i", vFiiii, 0},
{"alListeneriv", vFip, 0},
{"alGetListenerf", vFip, 0},
{"alGetListener3f", vFippp, 0},
{"alGetListenerfv", vFip, 0},
{"alGetListeneri", vFip, 0},
{"alGetListener3i", vFippp, 0},
{"alGetListeneriv", vFip, 0},
{"alGenSources", vFip, 0},
{"alDeleteSources", vFip, 0},
{"alIsSource", cFu, 0},
{"alSourcef", vFuif, 0},
{"alSource3f", vFuifff, 0},
{"alSourcefv", vFuip, 0},
{"alSourcei", vFuii, 0},
{"alSource3i", vFuiiii, 0},
{"alSourceiv", vFuip, 0},
{"alGetSourcef", vFuip, 0},
{"alGetSource3f", vFuippp, 0},
{"alGetSourcefv", vFuip, 0},
{"alGetSourcei", vFuip, 0},
{"alGetSource3i", vFuippp, 0},
{"alGetSourceiv", vFuip, 0},
{"alSourcePlayv", vFip, 0},
{"alSourceStopv", vFip, 0},
{"alSourceRewindv", vFip, 0},
{"alSourcePausev", vFip, 0},
{"alSourcePlay", vFu, 0},
{"alSourceStop", vFu, 0},
{"alSourceRewind", vFu, 0},
{"alSourcePause", vFu, 0},
{"alSourceQueueBuffers", vFuip, 0},
{"alSourceUnqueueBuffers", vFuip, 0},
{"alGenBuffers", vFip, 0},
{"alDeleteBuffers", vFip, 0},
{"alIsBuffer", cFu, 0},
{"alBufferData", vFuipii, 0},
{"alBufferf", vFuif, 0},
{"alBuffer3f", vFuifff, 0},
{"alBufferfv", vFuip, 0},
{"alBufferi", vFuii, 0},
{"alBuffer3i", vFuiiii, 0},
{"alBufferiv", vFuip, 0},
{"alGetBufferf", vFuip, 0},
{"alGetBuffer3f", vFuippp, 0},
{"alGetBufferfv", vFuip, 0},
{"alGetBufferi", vFuip, 0},
{"alGetBuffer3i", vFuippp, 0},
{"alGetBufferiv", vFuip, 0},

{"alcCreateContext", pFpp, 0},
{"alcMakeContextCurrent", iFp, 0},
{"alcProcessContext", vFp, 0},
{"alcSuspendContext", vFp, 0},
{"alcDestroyContext", vFp, 0},
{"alcGetCurrentContext", pFv, 0},
{"alcGetContextsDevice", pFp, 0},
{"alcOpenDevice", pFp, 0},
{"alcCloseDevice", iFp, 0},
{"alcGetError", iFp, 0},
{"alcIsExtensionPresent", cFpp, 0},

{"alcGetEnumValue", iFpp, 0},
{"alcGetString", pFpi, 0},
{"alcGetIntegerv", vFpiip, 0},
{"alcCaptureOpenDevice", pFpuii, 0},
{"alcCaptureCloseDevice", iFp, 0},
{"alcCaptureStart", vFp, 0},
{"alcCaptureStop", vFp, 0},
{"alcCaptureSamples", vFppi, 0},

{"alcGetThreadContext", pFv, 0},
{"alcSetThreadContext", iFp, 0},
{"alcLoopbackOpenDeviceSOFT", pFp, 0},
{"alcIsRenderFormatSupportedSOFT", cFpiii, 0},
{"alcRenderSamplesSOFT", vFppi, 0},
{"alcDevicePauseSOFT", vFp, 0},
{"alcDeviceResumeSOFT", vFp, 0},
{"alcGetStringiSOFT", pFpii, 0},
{"alcResetDeviceSOFT", iFpp, 0},
{"alcGetInteger64vSOFT", vFpiip, 0},

{"alBufferDataStatic", vFiipii, 0},
{"alBufferSubDataSOFT", vFuipii, 0},


{"alBufferSamplesSOFT", vFuuiiiip, 0},
{"alBufferSubSamplesSOFT", vFuiiiip, 0},
{"alGetBufferSamplesSOFT", vFuiiiip, 0},
{"alIsBufferFormatSupportedSOFT", cFi, 0},
{"alSourcedSOFT", vFuid, 0},
{"alSource3dSOFT", vFuiddd, 0},
{"alSourcedvSOFT", vFuip, 0},
{"alGetSourcedSOFT", vFuip, 0},
{"alGetSource3dSOFT", vFuippp, 0},
{"alGetSourcedvSOFT", vFuip, 0},
{"alSourcei64SOFT", vFuiI, 0},
{"alSource3i64SOFT", vFuiIII, 0},
{"alSourcei64vSOFT", vFuip, 0},
{"alGetSourcei64SOFT", vFuip, 0},
{"alGetSource3i64SOFT", vFuippp, 0},
{"alGetSourcei64vSOFT", vFuip, 0},
{"alDeferUpdatesSOFT", vFv, 0},
{"alProcessUpdatesSOFT", vFv, 0},
{"alGetStringiSOFT", pFii, 0},

{"alGenEffects", vFip, 0},
{"alDeleteEffects", vFip, 0},
{"alIsEffect", cFu, 0},
{"alEffecti", vFuii, 0},
{"alEffectiv", vFuip, 0},
{"alEffectf", vFuif, 0},
{"alEffectfv", vFuip, 0},
{"alGetEffecti", vFuip, 0},
{"alGetEffectiv", vFuip, 0},
{"alGetEffectf", vFuip, 0},
{"alGetEffectfv", vFuip, 0},
{"alGenFilters", vFip, 0},
{"alDeleteFilters", vFip, 0},
{"alIsFilter", cFu, 0},
{"alFilteri", vFuii, 0},
{"alFilteriv", vFuip, 0},
{"alFilterf", vFuif, 0},
{"alFilterfv", vFuip, 0},
{"alGetFilteri", vFuip, 0},
{"alGetFilteriv", vFuip, 0},
{"alGetFilterf", vFuip, 0},
{"alGetFilterfv", vFuip, 0},
{"alGenAuxiliaryEffectSlots", vFip, 0},
{"alDeleteAuxiliaryEffectSlots", vFip, 0},
{"alIsAuxiliaryEffectSlot", cFu, 0},
{"alAuxiliaryEffectSloti", vFuii, 0},
{"alAuxiliaryEffectSlotiv", vFuip, 0},
{"alAuxiliaryEffectSlotf", vFuif, 0},
{"alAuxiliaryEffectSlotfv", vFuip, 0},
{"alGetAuxiliaryEffectSloti", vFuip, 0},
{"alGetAuxiliaryEffectSlotiv", vFuip, 0},
{"alGetAuxiliaryEffectSlotf", vFuip, 0},
{"alGetAuxiliaryEffectSlotfv", vFuip, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t openalmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1
...
{"alRequestFoldbackStart", vFEiiipp, 0},
{"alRequestFoldbackStop", vFEv, 0},
...
static const map_onesymbol_t openalstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1
...
static const map_onesymbol2_t openalsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1
...
static const map_onedata_t openaldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1
...
static const map_onedata_t openalmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedopenalundefs.h" 1
...
int wrappedopenal_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(openalName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(openalsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (openalsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, openalsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = openalsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, openalsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = openalsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(openalsymbolmap[i].name, '@')) AddDictionnary(box86->versym, openalsymbolmap[i].name); }
 cnt = sizeof(openalmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (openalmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, openalmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = openalmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, openalmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = openalmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(openalmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, openalmysymbolmap[i].name); }

    cnt = sizeof(openalstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, openalstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = openalstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(openalstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, openalstsymbolmap[i].name);
    }
    cnt = sizeof(openalsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, openalsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = openalsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = openalsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = openalsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(openalsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, openalsymbol2map[i].name);
    }
    cnt = sizeof(openaldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(openaldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, openaldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = openaldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, openaldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = openaldatamap[i].sz;
        }
    }
    cnt = sizeof(openalmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, openalmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = openalmydatamap[i].sz;
    }

    libname = lib->name; getMy(lib);


    return 0;
}

void wrappedopenal_fini(library_t* lib)
{
...
# 156 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 2
...
void fillALProcWrapper()
{
    ...
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(symbolmap, openalsymbolmap[i].name, &ret);
        ((symbolmap)->vals[k]).w = openalsymbolmap[i].w;
        ((symbolmap)->vals[k]).resolved = 0;
    }

    cnt = sizeof(openalmysymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(symbolmap, openalmysymbolmap[i].name, &ret);
        ((symbolmap)->vals[k]).w = openalmysymbolmap[i].w;
        ((symbolmap)->vals[k]).resolved = 0;
    }
...
void freeALProcWrapper(box86context_t* context)
{
    ...
    if(context->alwrappers)
        kh_destroy_symbolmap(context->alwrappers);
    if(context->almymap)
        kh_destroy_symbolmap(context->almymap);
    context->alwrappers = 
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
                         ((void *)0)
# 195 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                             ;
    context->almymap = 
# 196 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c" 3 4
                      ((void *)0)
# 196 "/home/ssd/pico/code/box86/src/wrapped/wrappedopenal.c"
                          ;
}
