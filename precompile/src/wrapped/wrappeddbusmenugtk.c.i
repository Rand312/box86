# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2

const char* dbusmenugtkName = "libdbusmenu-gtk.so.4";
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenugtkdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusmenugtksymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1




{"dbusmenu_gtkclient_get_accel_group", pFp, 0},
{"dbusmenu_gtkclient_get_type", iFv, 0},
{"dbusmenu_gtkclient_menuitem_get", pFpp, 0},
{"dbusmenu_gtkclient_menuitem_get_submenu", pFpp, 0},
{"dbusmenu_gtkclient_new", pFpp, 0},
{"dbusmenu_gtkclient_newitem_base", vFpppp, 0},
{"dbusmenu_gtkclient_set_accel_group", vFpp, 0},
{"dbusmenu_gtkmenu_get_client", pFp, 0},
{"dbusmenu_gtkmenu_get_type", iFv, 0},
{"dbusmenu_gtkmenu_new", pFpp, 0},
{"dbusmenu_gtk_parse_get_cached_item", pFp, 0},
{"dbusmenu_gtk_parse_menu_structure", pFp, 0},
{"dbusmenu_menuitem_property_get_image", pFpp, 0},
{"dbusmenu_menuitem_property_get_shortcut", vFppp, 0},
{"dbusmenu_menuitem_property_set_image", iFppp, 0},
{"dbusmenu_menuitem_property_set_shortcut", iFpui, 0},
{"dbusmenu_menuitem_property_set_shortcut_menuitem", iFpp, 0},
{"dbusmenu_menuitem_property_set_shortcut_string", iFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusmenugtkmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1
...
static const map_onesymbol_t dbusmenugtkstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1
...
static const map_onesymbol2_t dbusmenugtksymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1
...
static const map_onedata_t dbusmenugtkdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1
...
static const map_onedata_t dbusmenugtkmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenugtkundefs.h" 1
...
int wrappeddbusmenugtk_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(dbusmenugtkName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(dbusmenugtkName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(dbusmenugtksymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusmenugtksymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, dbusmenugtksymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = dbusmenugtksymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, dbusmenugtksymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = dbusmenugtksymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(dbusmenugtksymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusmenugtksymbolmap[i].name); }
 cnt = sizeof(dbusmenugtkmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusmenugtkmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, dbusmenugtkmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = dbusmenugtkmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, dbusmenugtkmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = dbusmenugtkmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(dbusmenugtkmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusmenugtkmysymbolmap[i].name); }

    cnt = sizeof(dbusmenugtkstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, dbusmenugtkstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = dbusmenugtkstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(dbusmenugtkstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, dbusmenugtkstsymbolmap[i].name);
    }
    cnt = sizeof(dbusmenugtksymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, dbusmenugtksymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = dbusmenugtksymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = dbusmenugtksymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = dbusmenugtksymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(dbusmenugtksymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, dbusmenugtksymbol2map[i].name);
    }
    cnt = sizeof(dbusmenugtkdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(dbusmenugtkdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, dbusmenugtkdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = dbusmenugtkdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, dbusmenugtkdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = dbusmenugtkdatamap[i].sz;
        }
    }
    cnt = sizeof(dbusmenugtkmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, dbusmenugtkmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = dbusmenugtkmydatamap[i].sz;
    }
...
void wrappeddbusmenugtk_fini(library_t* lib)
{
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenugtk.c" 2
