# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedmpg123types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedmpg123types.h"
typedef int32_t (*iFpppp_t)(void*, void*, void*, void*);
# 32 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
...
typedef struct mpg123_my_s {
    ...
    iFpppp_t mpg123_replace_reader_handle; iFpppp_t mpg123_replace_reader_handle_32; iFpppp_t mpg123_replace_reader_handle_64;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static mpg123_my_t my_mpg123 = {0};
static mpg123_my_t * const my = &my_mpg123;

static void getMy(library_t* lib)
{

    my->mpg123_replace_reader_handle = (iFpppp_t)dlsym(lib->w.lib, "mpg123_replace_reader_handle"); my->mpg123_replace_reader_handle_32 = (iFpppp_t)dlsym(lib->w.lib, "mpg123_replace_reader_handle_32"); my->mpg123_replace_reader_handle_64 = (iFpppp_t)dlsym(lib->w.lib, "mpg123_replace_reader_handle_64");
...
# 34 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
# 49 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
static uintptr_t my_r_read_fct_0 = 0; static ssize_t my_r_read_0(void* a, void* b, size_t n) { return (ssize_t)RunFunctionFmt(my_r_read_fct_0, "ppL", a, b, n); } static uintptr_t my_r_read_fct_1 = 0; static ssize_t my_r_read_1(void* a, void* b, size_t n) { return (ssize_t)RunFunctionFmt(my_r_read_fct_1, "ppL", a, b, n); } static uintptr_t my_r_read_fct_2 = 0; static ssize_t my_r_read_2(void* a, void* b, size_t n) { return (ssize_t)RunFunctionFmt(my_r_read_fct_2, "ppL", a, b, n); } static uintptr_t my_r_read_fct_3 = 0; static ssize_t my_r_read_3(void* a, void* b, size_t n) { return (ssize_t)RunFunctionFmt(my_r_read_fct_3, "ppL", a, b, n); } static uintptr_t my_r_read_fct_4 = 0; static ssize_t my_r_read_4(void* a, void* b, size_t n) { return (ssize_t)RunFunctionFmt(my_r_read_fct_4, "ppL", a, b, n); }
...
static void* find_r_read_Fct(void* fct)
{
    ...
    if(my_r_read_fct_0 == (uintptr_t)fct) return my_r_read_0; if(my_r_read_fct_1 == (uintptr_t)fct) return my_r_read_1; if(my_r_read_fct_2 == (uintptr_t)fct) return my_r_read_2; if(my_r_read_fct_3 == (uintptr_t)fct) return my_r_read_3; if(my_r_read_fct_4 == (uintptr_t)fct) return my_r_read_4;


    if(my_r_read_fct_0 == 0) {my_r_read_fct_0 = (uintptr_t)fct; return my_r_read_0; } if(my_r_read_fct_1 == 0) {my_r_read_fct_1 = (uintptr_t)fct; return my_r_read_1; } if(my_r_read_fct_2 == 0) {my_r_read_fct_2 = (uintptr_t)fct; return my_r_read_2; } if(my_r_read_fct_3 == 0) {my_r_read_fct_3 = (uintptr_t)fct; return my_r_read_3; } if(my_r_read_fct_4 == 0) {my_r_read_fct_4 = (uintptr_t)fct; return my_r_read_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for mpg123 r_read callback\n"); fflush(ftrace);}} while(0);
    return 
# 62 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 3 4
          ((void *)0)
# 62 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
              ;
}
...
static uintptr_t my_r_lseek_fct_0 = 0; static int64_t my_r_lseek_0(void* a, int64_t b, int n) { return (int64_t)RunFunctionFmt64(my_r_lseek_fct_0, "pIi", a, b, n); } static uintptr_t my_r_lseek_fct_1 = 0; static int64_t my_r_lseek_1(void* a, int64_t b, int n) { return (int64_t)RunFunctionFmt64(my_r_lseek_fct_1, "pIi", a, b, n); } static uintptr_t my_r_lseek_fct_2 = 0; static int64_t my_r_lseek_2(void* a, int64_t b, int n) { return (int64_t)RunFunctionFmt64(my_r_lseek_fct_2, "pIi", a, b, n); } static uintptr_t my_r_lseek_fct_3 = 0; static int64_t my_r_lseek_3(void* a, int64_t b, int n) { return (int64_t)RunFunctionFmt64(my_r_lseek_fct_3, "pIi", a, b, n); } static uintptr_t my_r_lseek_fct_4 = 0; static int64_t my_r_lseek_4(void* a, int64_t b, int n) { return (int64_t)RunFunctionFmt64(my_r_lseek_fct_4, "pIi", a, b, n); }
...
static void* find_r_lseek_Fct(void* fct)
{
    ...
    if(my_r_lseek_fct_0 == (uintptr_t)fct) return my_r_lseek_0; if(my_r_lseek_fct_1 == (uintptr_t)fct) return my_r_lseek_1; if(my_r_lseek_fct_2 == (uintptr_t)fct) return my_r_lseek_2; if(my_r_lseek_fct_3 == (uintptr_t)fct) return my_r_lseek_3; if(my_r_lseek_fct_4 == (uintptr_t)fct) return my_r_lseek_4;


    if(my_r_lseek_fct_0 == 0) {my_r_lseek_fct_0 = (uintptr_t)fct; return my_r_lseek_0; } if(my_r_lseek_fct_1 == 0) {my_r_lseek_fct_1 = (uintptr_t)fct; return my_r_lseek_1; } if(my_r_lseek_fct_2 == 0) {my_r_lseek_fct_2 = (uintptr_t)fct; return my_r_lseek_2; } if(my_r_lseek_fct_3 == 0) {my_r_lseek_fct_3 = (uintptr_t)fct; return my_r_lseek_3; } if(my_r_lseek_fct_4 == 0) {my_r_lseek_fct_4 = (uintptr_t)fct; return my_r_lseek_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for mpg123 r_lseek callback\n"); fflush(ftrace);}} while(0);
    return 
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 3 4
          ((void *)0)
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
              ;
}
...
static uintptr_t my_cleanup_fct_0 = 0; static void my_cleanup_0(void* a) { RunFunctionFmt(my_cleanup_fct_0, "p", a); } static uintptr_t my_cleanup_fct_1 = 0; static void my_cleanup_1(void* a) { RunFunctionFmt(my_cleanup_fct_1, "p", a); } static uintptr_t my_cleanup_fct_2 = 0; static void my_cleanup_2(void* a) { RunFunctionFmt(my_cleanup_fct_2, "p", a); } static uintptr_t my_cleanup_fct_3 = 0; static void my_cleanup_3(void* a) { RunFunctionFmt(my_cleanup_fct_3, "p", a); } static uintptr_t my_cleanup_fct_4 = 0; static void my_cleanup_4(void* a) { RunFunctionFmt(my_cleanup_fct_4, "p", a); }
...
static void* find_cleanup_Fct(void* fct)
{
    ...
    if(my_cleanup_fct_0 == (uintptr_t)fct) return my_cleanup_0; if(my_cleanup_fct_1 == (uintptr_t)fct) return my_cleanup_1; if(my_cleanup_fct_2 == (uintptr_t)fct) return my_cleanup_2; if(my_cleanup_fct_3 == (uintptr_t)fct) return my_cleanup_3; if(my_cleanup_fct_4 == (uintptr_t)fct) return my_cleanup_4;


    if(my_cleanup_fct_0 == 0) {my_cleanup_fct_0 = (uintptr_t)fct; return my_cleanup_0; } if(my_cleanup_fct_1 == 0) {my_cleanup_fct_1 = (uintptr_t)fct; return my_cleanup_1; } if(my_cleanup_fct_2 == 0) {my_cleanup_fct_2 = (uintptr_t)fct; return my_cleanup_2; } if(my_cleanup_fct_3 == 0) {my_cleanup_fct_3 = (uintptr_t)fct; return my_cleanup_3; } if(my_cleanup_fct_4 == 0) {my_cleanup_fct_4 = (uintptr_t)fct; return my_cleanup_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for mpg123 cleanup callback\n"); fflush(ftrace);}} while(0);
    return 
# 106 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 3 4
          ((void *)0)
# 106 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c"
              ;
}



__attribute__((visibility("default"))) int my_mpg123_replace_reader_handle(x86emu_t* emu, void* mh, void* r_read, void* r_lseek, void* cleanup)
{
    (void)emu;
    return my->mpg123_replace_reader_handle(mh, find_r_read_Fct(r_read), find_r_lseek_Fct(r_lseek), find_cleanup_Fct(cleanup));
}

__attribute__((visibility("default"))) int my_mpg123_replace_reader_handle_32(x86emu_t* emu, void* mh, void* r_read, void* r_lseek, void* cleanup)
{
    (void)emu;
    return my->mpg123_replace_reader_handle_32(mh, find_r_read_Fct(r_read), find_r_lseek_Fct(r_lseek), find_cleanup_Fct(cleanup));
}

__attribute__((visibility("default"))) int my_mpg123_replace_reader_handle_64(x86emu_t* emu, void* mh, void* r_read, void* r_lseek, void* cleanup)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedmpg123defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t mpg123symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
{"mpg123_close", iFp, 0},



{"mpg123_decode_frame", iFpppp, 0},
{"mpg123_decode_frame_32", iFpppp, 0},
{"mpg123_decode_frame_64", iFpppp, 0},
{"mpg123_decoder", iFppLpLp, 0},

{"mpg123_delete", vFp, 0},


{"mpg123_encodings", vFpp, 0},
{"mpg123_encsize", iFi, 0},

{"mpg123_errcode", iFp, 0},
{"mpg123_exit", vFv, 0},
{"mpg123_feature", iFi, 0},
{"mpg123_feed", iFppL, 0},
{"mpg123_feedseek", IFpIip, 0},
{"mpg123_feedseek_32", IFpIip, 0},
{"mpg123_feedseek_64", IFpIip, 0},




{"mpg123_format", iFplii, 0},
{"mpg123_format_all", iFp, 0},
{"mpg123_format_none", iFp, 0},
{"mpg123_format_support", iFpli, 0},
{"mpg123_framebyframe_decode", iFpppp, 0},
{"mpg123_framebyframe_decode_32", iFpppp, 0},
{"mpg123_framebyframe_decode_64", iFpppp, 0},
{"mpg123_framebyframe_next", iFp, 0},
{"mpg123_framedata", iFpppp, 0},
{"mpg123_framelength", IFp, 0},
{"mpg123_framelength_32", IFp, 0},
{"mpg123_framelength_64", IFp, 0},
{"mpg123_framepos", IFp, 0},
{"mpg123_framepos_32", IFp, 0},
{"mpg123_framepos_64", IFp, 0},


{"mpg123_getformat", iFpppp, 0},
{"mpg123_getformat2", iFppppi, 0},

{"mpg123_getparam", iFpipp, 0},
...
{"mpg123_index", iFpppp, 0},
{"mpg123_index_32", iFpppp, 0},
{"mpg123_index_64", iFpppp, 0},

{"mpg123_init", iFv, 0},

{"mpg123_length", IFp, 0},
{"mpg123_length_32", IFp, 0},
{"mpg123_length_64", IFp, 0},


{"mpg123_new", pFpp, 0},

{"mpg123_open", iFpp, 0},
{"mpg123_open_32", iFpp, 0},
{"mpg123_open_64", iFpp, 0},
{"mpg123_open_fd", iFpi, 0},
{"mpg123_open_fd_32", iFpi, 0},
{"mpg123_open_fd_64", iFpi, 0},
{"mpg123_open_feed", iFp, 0},
{"mpg123_open_handle", iFpp, 0},
{"mpg123_open_handle_32", iFpp, 0},
{"mpg123_open_handle_64", iFpp, 0},


{"mpg123_param", iFpild, 0},


{"mpg123_position", iFpIIpppp, 0},
{"mpg123_position_32", iFpIIpppp, 0},
{"mpg123_position_64", iFpIIpppp, 0},
{"mpg123_rates", vFpp, 0},
{"mpg123_read", iFppp, 0},
...
{"mpg123_seek", IFpIi, 0},
{"mpg123_seek_32", IFpIi, 0},
{"mpg123_seek_64", IFpIi, 0},
{"mpg123_seek_frame", IFpIi, 0},
{"mpg123_seek_frame_32", IFpIi, 0},
{"mpg123_seek_frame_64", IFpIi, 0},
{"mpg123_set_filesize", iFpI, 0},
{"mpg123_set_filesize_32", iFpI, 0},
{"mpg123_set_filesize_64", iFpI, 0},
{"mpg123_set_index", iFppIL, 0},
{"mpg123_set_index_32", iFppIL, 0},
{"mpg123_set_index_64", iFppIL, 0},




{"mpg123_strerror", pFp, 0},


{"mpg123_tell", IFp, 0},
{"mpg123_tell_32", IFp, 0},
{"mpg123_tell_64", IFp, 0},
{"mpg123_tellframe", IFp, 0},
{"mpg123_tellframe_32", IFp, 0},
{"mpg123_tellframe_64", IFp, 0},
{"mpg123_tell_stream", IFp, 0},
{"mpg123_tell_stream_32", IFp, 0},
{"mpg123_tell_stream_64", IFp, 0},
{"mpg123_timeframe", IFpd, 0},
{"mpg123_timeframe_32", IFpd, 0},
{"mpg123_timeframe_64", IFpd, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t mpg123mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
...
{"mpg123_replace_reader_handle", iFEpppp, 0},
{"mpg123_replace_reader_handle_32", iFEpppp, 0},
{"mpg123_replace_reader_handle_64", iFEpppp, 0},
...
static const map_onesymbol_t mpg123stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
...
static const map_onesymbol2_t mpg123symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
...
static const map_onedata_t mpg123datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
...
static const map_onedata_t mpg123mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedmpg123undefs.h" 1
...
int wrappedmpg123_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(mpg123Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(mpg123symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (mpg123symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, mpg123symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = mpg123symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, mpg123symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = mpg123symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(mpg123symbolmap[i].name, '@')) AddDictionnary(box86->versym, mpg123symbolmap[i].name); }
 cnt = sizeof(mpg123mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (mpg123mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, mpg123mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = mpg123mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, mpg123mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = mpg123mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(mpg123mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, mpg123mysymbolmap[i].name); }

    cnt = sizeof(mpg123stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, mpg123stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = mpg123stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(mpg123stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, mpg123stsymbolmap[i].name);
    }
    cnt = sizeof(mpg123symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, mpg123symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = mpg123symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = mpg123symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = mpg123symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(mpg123symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, mpg123symbol2map[i].name);
    }
    cnt = sizeof(mpg123datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(mpg123datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, mpg123datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = mpg123datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, mpg123datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = mpg123datamap[i].sz;
        }
    }
    cnt = sizeof(mpg123mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, mpg123mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = mpg123mydatamap[i].sz;
    }
...
void wrappedmpg123_fini(library_t* lib)
{
...
# 136 "/home/ssd/pico/code/box86/src/wrapped/wrappedmpg123.c" 2
