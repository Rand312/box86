# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxexttypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxexttypes.h"
...
# 50 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
...
typedef struct libxext_my_s {


    pFp_t XSetExtensionErrorHandler; iFpppiiu_t XShmGetImage; pFppppip_t XextAddDisplay; pFppuippuu_t XShmCreateImage; iFppppiiiiuui_t XShmPutImage;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libxext_my_t my_libxext = {0};
static libxext_my_t * const my = &my_libxext;

static void getMy(library_t* lib)
{

    my->XSetExtensionErrorHandler = (pFp_t)dlsym(lib->w.lib, "XSetExtensionErrorHandler"); my->XShmGetImage = (iFpppiiu_t)dlsym(lib->w.lib, "XShmGetImage"); my->XextAddDisplay = (pFppppip_t)dlsym(lib->w.lib, "XextAddDisplay"); my->XShmCreateImage = (pFppuippuu_t)dlsym(lib->w.lib, "XShmCreateImage"); my->XShmPutImage = (iFppppiiiiuui_t)dlsym(lib->w.lib, "XShmPutImage");
...
# 52 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
static uintptr_t my_exterrorhandle_fct_0 = 0; static int my_exterrorhandle_0(void* display, void* ext_name, void* reason) { return RunFunctionFmt(my_exterrorhandle_fct_0, "ppp", display, ext_name, reason); } static uintptr_t my_exterrorhandle_fct_1 = 0; static int my_exterrorhandle_1(void* display, void* ext_name, void* reason) { return RunFunctionFmt(my_exterrorhandle_fct_1, "ppp", display, ext_name, reason); } static uintptr_t my_exterrorhandle_fct_2 = 0; static int my_exterrorhandle_2(void* display, void* ext_name, void* reason) { return RunFunctionFmt(my_exterrorhandle_fct_2, "ppp", display, ext_name, reason); } static uintptr_t my_exterrorhandle_fct_3 = 0; static int my_exterrorhandle_3(void* display, void* ext_name, void* reason) { return RunFunctionFmt(my_exterrorhandle_fct_3, "ppp", display, ext_name, reason); } static uintptr_t my_exterrorhandle_fct_4 = 0; static int my_exterrorhandle_4(void* display, void* ext_name, void* reason) { return RunFunctionFmt(my_exterrorhandle_fct_4, "ppp", display, ext_name, reason); }
...
static void* find_exterrorhandle_Fct(void* fct)
{
    ...
    if(my_exterrorhandle_fct_0 == (uintptr_t)fct) return my_exterrorhandle_0; if(my_exterrorhandle_fct_1 == (uintptr_t)fct) return my_exterrorhandle_1; if(my_exterrorhandle_fct_2 == (uintptr_t)fct) return my_exterrorhandle_2; if(my_exterrorhandle_fct_3 == (uintptr_t)fct) return my_exterrorhandle_3; if(my_exterrorhandle_fct_4 == (uintptr_t)fct) return my_exterrorhandle_4;


    if(my_exterrorhandle_fct_0 == 0) {my_exterrorhandle_fct_0 = (uintptr_t)fct; return my_exterrorhandle_0; } if(my_exterrorhandle_fct_1 == 0) {my_exterrorhandle_fct_1 = (uintptr_t)fct; return my_exterrorhandle_1; } if(my_exterrorhandle_fct_2 == 0) {my_exterrorhandle_fct_2 = (uintptr_t)fct; return my_exterrorhandle_2; } if(my_exterrorhandle_fct_3 == 0) {my_exterrorhandle_fct_3 = (uintptr_t)fct; return my_exterrorhandle_3; } if(my_exterrorhandle_fct_4 == 0) {my_exterrorhandle_fct_4 = (uintptr_t)fct; return my_exterrorhandle_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext exterrorhandle callback\n"); fflush(ftrace);}} while(0);
    return 
# 80 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 80 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
static void* reverse_exterrorhandleFct(void* fct)
{
    ...
    if(my_exterrorhandle_0 == fct) return (void*)my_exterrorhandle_fct_0; if(my_exterrorhandle_1 == fct) return (void*)my_exterrorhandle_fct_1; if(my_exterrorhandle_2 == fct) return (void*)my_exterrorhandle_fct_2; if(my_exterrorhandle_3 == fct) return (void*)my_exterrorhandle_fct_3; if(my_exterrorhandle_4 == fct) return (void*)my_exterrorhandle_fct_4;

    return (void*)AddBridge(my_lib->w.bridge, iFppp, fct, 0, 
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
                                                            ((void *)0)
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
                                                                );
}
...
static uintptr_t my_create_gc_fct_0 = 0; static int my_create_gc_0(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_create_gc_fct_0, "pup", a, b, c); } static uintptr_t my_create_gc_fct_1 = 0; static int my_create_gc_1(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_create_gc_fct_1, "pup", a, b, c); } static uintptr_t my_create_gc_fct_2 = 0; static int my_create_gc_2(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_create_gc_fct_2, "pup", a, b, c); } static uintptr_t my_create_gc_fct_3 = 0; static int my_create_gc_3(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_create_gc_fct_3, "pup", a, b, c); } static uintptr_t my_create_gc_fct_4 = 0; static int my_create_gc_4(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_create_gc_fct_4, "pup", a, b, c); }
...
static void* find_create_gc_Fct(void* fct)
{
    ...
    if(my_create_gc_fct_0 == (uintptr_t)fct) return my_create_gc_0; if(my_create_gc_fct_1 == (uintptr_t)fct) return my_create_gc_1; if(my_create_gc_fct_2 == (uintptr_t)fct) return my_create_gc_2; if(my_create_gc_fct_3 == (uintptr_t)fct) return my_create_gc_3; if(my_create_gc_fct_4 == (uintptr_t)fct) return my_create_gc_4;


    if(my_create_gc_fct_0 == 0) {my_create_gc_fct_0 = (uintptr_t)fct; return my_create_gc_0; } if(my_create_gc_fct_1 == 0) {my_create_gc_fct_1 = (uintptr_t)fct; return my_create_gc_1; } if(my_create_gc_fct_2 == 0) {my_create_gc_fct_2 = (uintptr_t)fct; return my_create_gc_2; } if(my_create_gc_fct_3 == 0) {my_create_gc_fct_3 = (uintptr_t)fct; return my_create_gc_3; } if(my_create_gc_fct_4 == 0) {my_create_gc_fct_4 = (uintptr_t)fct; return my_create_gc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext create_gc callback\n"); fflush(ftrace);}} while(0);
    return 
# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_copy_gc_fct_0 = 0; static int my_copy_gc_0(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_copy_gc_fct_0, "pup", a, b, c); } static uintptr_t my_copy_gc_fct_1 = 0; static int my_copy_gc_1(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_copy_gc_fct_1, "pup", a, b, c); } static uintptr_t my_copy_gc_fct_2 = 0; static int my_copy_gc_2(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_copy_gc_fct_2, "pup", a, b, c); } static uintptr_t my_copy_gc_fct_3 = 0; static int my_copy_gc_3(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_copy_gc_fct_3, "pup", a, b, c); } static uintptr_t my_copy_gc_fct_4 = 0; static int my_copy_gc_4(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_copy_gc_fct_4, "pup", a, b, c); }
...
static void* find_copy_gc_Fct(void* fct)
{
    ...
    if(my_copy_gc_fct_0 == (uintptr_t)fct) return my_copy_gc_0; if(my_copy_gc_fct_1 == (uintptr_t)fct) return my_copy_gc_1; if(my_copy_gc_fct_2 == (uintptr_t)fct) return my_copy_gc_2; if(my_copy_gc_fct_3 == (uintptr_t)fct) return my_copy_gc_3; if(my_copy_gc_fct_4 == (uintptr_t)fct) return my_copy_gc_4;


    if(my_copy_gc_fct_0 == 0) {my_copy_gc_fct_0 = (uintptr_t)fct; return my_copy_gc_0; } if(my_copy_gc_fct_1 == 0) {my_copy_gc_fct_1 = (uintptr_t)fct; return my_copy_gc_1; } if(my_copy_gc_fct_2 == 0) {my_copy_gc_fct_2 = (uintptr_t)fct; return my_copy_gc_2; } if(my_copy_gc_fct_3 == 0) {my_copy_gc_fct_3 = (uintptr_t)fct; return my_copy_gc_3; } if(my_copy_gc_fct_4 == 0) {my_copy_gc_fct_4 = (uintptr_t)fct; return my_copy_gc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext copy_gc callback\n"); fflush(ftrace);}} while(0);
    return 
# 134 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 134 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_flush_gc_fct_0 = 0; static int my_flush_gc_0(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_flush_gc_fct_0, "pup", a, b, c); } static uintptr_t my_flush_gc_fct_1 = 0; static int my_flush_gc_1(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_flush_gc_fct_1, "pup", a, b, c); } static uintptr_t my_flush_gc_fct_2 = 0; static int my_flush_gc_2(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_flush_gc_fct_2, "pup", a, b, c); } static uintptr_t my_flush_gc_fct_3 = 0; static int my_flush_gc_3(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_flush_gc_fct_3, "pup", a, b, c); } static uintptr_t my_flush_gc_fct_4 = 0; static int my_flush_gc_4(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_flush_gc_fct_4, "pup", a, b, c); }
...
static void* find_flush_gc_Fct(void* fct)
{
    ...
    if(my_flush_gc_fct_0 == (uintptr_t)fct) return my_flush_gc_0; if(my_flush_gc_fct_1 == (uintptr_t)fct) return my_flush_gc_1; if(my_flush_gc_fct_2 == (uintptr_t)fct) return my_flush_gc_2; if(my_flush_gc_fct_3 == (uintptr_t)fct) return my_flush_gc_3; if(my_flush_gc_fct_4 == (uintptr_t)fct) return my_flush_gc_4;


    if(my_flush_gc_fct_0 == 0) {my_flush_gc_fct_0 = (uintptr_t)fct; return my_flush_gc_0; } if(my_flush_gc_fct_1 == 0) {my_flush_gc_fct_1 = (uintptr_t)fct; return my_flush_gc_1; } if(my_flush_gc_fct_2 == 0) {my_flush_gc_fct_2 = (uintptr_t)fct; return my_flush_gc_2; } if(my_flush_gc_fct_3 == 0) {my_flush_gc_fct_3 = (uintptr_t)fct; return my_flush_gc_3; } if(my_flush_gc_fct_4 == 0) {my_flush_gc_fct_4 = (uintptr_t)fct; return my_flush_gc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext flush_gc callback\n"); fflush(ftrace);}} while(0);
    return 
# 156 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 156 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_free_gc_fct_0 = 0; static int my_free_gc_0(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_free_gc_fct_0, "pup", a, b, c); } static uintptr_t my_free_gc_fct_1 = 0; static int my_free_gc_1(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_free_gc_fct_1, "pup", a, b, c); } static uintptr_t my_free_gc_fct_2 = 0; static int my_free_gc_2(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_free_gc_fct_2, "pup", a, b, c); } static uintptr_t my_free_gc_fct_3 = 0; static int my_free_gc_3(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_free_gc_fct_3, "pup", a, b, c); } static uintptr_t my_free_gc_fct_4 = 0; static int my_free_gc_4(void* a, uint32_t b, void* c) { return RunFunctionFmt(my_free_gc_fct_4, "pup", a, b, c); }
...
static void* find_free_gc_Fct(void* fct)
{
    ...
    if(my_free_gc_fct_0 == (uintptr_t)fct) return my_free_gc_0; if(my_free_gc_fct_1 == (uintptr_t)fct) return my_free_gc_1; if(my_free_gc_fct_2 == (uintptr_t)fct) return my_free_gc_2; if(my_free_gc_fct_3 == (uintptr_t)fct) return my_free_gc_3; if(my_free_gc_fct_4 == (uintptr_t)fct) return my_free_gc_4;


    if(my_free_gc_fct_0 == 0) {my_free_gc_fct_0 = (uintptr_t)fct; return my_free_gc_0; } if(my_free_gc_fct_1 == 0) {my_free_gc_fct_1 = (uintptr_t)fct; return my_free_gc_1; } if(my_free_gc_fct_2 == 0) {my_free_gc_fct_2 = (uintptr_t)fct; return my_free_gc_2; } if(my_free_gc_fct_3 == 0) {my_free_gc_fct_3 = (uintptr_t)fct; return my_free_gc_3; } if(my_free_gc_fct_4 == 0) {my_free_gc_fct_4 = (uintptr_t)fct; return my_free_gc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext free_gc callback\n"); fflush(ftrace);}} while(0);
    return 
# 178 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 178 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_create_font_fct_0 = 0; static int my_create_font_0(void* a, void* b, void* c) { return RunFunctionFmt(my_create_font_fct_0, "ppp", a, b, c); } static uintptr_t my_create_font_fct_1 = 0; static int my_create_font_1(void* a, void* b, void* c) { return RunFunctionFmt(my_create_font_fct_1, "ppp", a, b, c); } static uintptr_t my_create_font_fct_2 = 0; static int my_create_font_2(void* a, void* b, void* c) { return RunFunctionFmt(my_create_font_fct_2, "ppp", a, b, c); } static uintptr_t my_create_font_fct_3 = 0; static int my_create_font_3(void* a, void* b, void* c) { return RunFunctionFmt(my_create_font_fct_3, "ppp", a, b, c); } static uintptr_t my_create_font_fct_4 = 0; static int my_create_font_4(void* a, void* b, void* c) { return RunFunctionFmt(my_create_font_fct_4, "ppp", a, b, c); }
...
static void* find_create_font_Fct(void* fct)
{
    ...
    if(my_create_font_fct_0 == (uintptr_t)fct) return my_create_font_0; if(my_create_font_fct_1 == (uintptr_t)fct) return my_create_font_1; if(my_create_font_fct_2 == (uintptr_t)fct) return my_create_font_2; if(my_create_font_fct_3 == (uintptr_t)fct) return my_create_font_3; if(my_create_font_fct_4 == (uintptr_t)fct) return my_create_font_4;


    if(my_create_font_fct_0 == 0) {my_create_font_fct_0 = (uintptr_t)fct; return my_create_font_0; } if(my_create_font_fct_1 == 0) {my_create_font_fct_1 = (uintptr_t)fct; return my_create_font_1; } if(my_create_font_fct_2 == 0) {my_create_font_fct_2 = (uintptr_t)fct; return my_create_font_2; } if(my_create_font_fct_3 == 0) {my_create_font_fct_3 = (uintptr_t)fct; return my_create_font_3; } if(my_create_font_fct_4 == 0) {my_create_font_fct_4 = (uintptr_t)fct; return my_create_font_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext create_font callback\n"); fflush(ftrace);}} while(0);
    return 
# 200 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 200 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_free_font_fct_0 = 0; static int my_free_font_0(void* a, void* b, void* c) { return RunFunctionFmt(my_free_font_fct_0, "ppp", a, b, c); } static uintptr_t my_free_font_fct_1 = 0; static int my_free_font_1(void* a, void* b, void* c) { return RunFunctionFmt(my_free_font_fct_1, "ppp", a, b, c); } static uintptr_t my_free_font_fct_2 = 0; static int my_free_font_2(void* a, void* b, void* c) { return RunFunctionFmt(my_free_font_fct_2, "ppp", a, b, c); } static uintptr_t my_free_font_fct_3 = 0; static int my_free_font_3(void* a, void* b, void* c) { return RunFunctionFmt(my_free_font_fct_3, "ppp", a, b, c); } static uintptr_t my_free_font_fct_4 = 0; static int my_free_font_4(void* a, void* b, void* c) { return RunFunctionFmt(my_free_font_fct_4, "ppp", a, b, c); }
...
static void* find_free_font_Fct(void* fct)
{
    ...
    if(my_free_font_fct_0 == (uintptr_t)fct) return my_free_font_0; if(my_free_font_fct_1 == (uintptr_t)fct) return my_free_font_1; if(my_free_font_fct_2 == (uintptr_t)fct) return my_free_font_2; if(my_free_font_fct_3 == (uintptr_t)fct) return my_free_font_3; if(my_free_font_fct_4 == (uintptr_t)fct) return my_free_font_4;


    if(my_free_font_fct_0 == 0) {my_free_font_fct_0 = (uintptr_t)fct; return my_free_font_0; } if(my_free_font_fct_1 == 0) {my_free_font_fct_1 = (uintptr_t)fct; return my_free_font_1; } if(my_free_font_fct_2 == 0) {my_free_font_fct_2 = (uintptr_t)fct; return my_free_font_2; } if(my_free_font_fct_3 == 0) {my_free_font_fct_3 = (uintptr_t)fct; return my_free_font_3; } if(my_free_font_fct_4 == 0) {my_free_font_fct_4 = (uintptr_t)fct; return my_free_font_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext free_font callback\n"); fflush(ftrace);}} while(0);
    return 
# 222 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 222 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_close_display_fct_0 = 0; static int my_close_display_0(void* a, void* b) { return RunFunctionFmt(my_close_display_fct_0, "pp", a, b);} static uintptr_t my_close_display_fct_1 = 0; static int my_close_display_1(void* a, void* b) { return RunFunctionFmt(my_close_display_fct_1, "pp", a, b);} static uintptr_t my_close_display_fct_2 = 0; static int my_close_display_2(void* a, void* b) { return RunFunctionFmt(my_close_display_fct_2, "pp", a, b);} static uintptr_t my_close_display_fct_3 = 0; static int my_close_display_3(void* a, void* b) { return RunFunctionFmt(my_close_display_fct_3, "pp", a, b);} static uintptr_t my_close_display_fct_4 = 0; static int my_close_display_4(void* a, void* b) { return RunFunctionFmt(my_close_display_fct_4, "pp", a, b);}
...
static void* find_close_display_Fct(void* fct)
{
    ...
    if(my_close_display_fct_0 == (uintptr_t)fct) return my_close_display_0; if(my_close_display_fct_1 == (uintptr_t)fct) return my_close_display_1; if(my_close_display_fct_2 == (uintptr_t)fct) return my_close_display_2; if(my_close_display_fct_3 == (uintptr_t)fct) return my_close_display_3; if(my_close_display_fct_4 == (uintptr_t)fct) return my_close_display_4;


    if(my_close_display_fct_0 == 0) {my_close_display_fct_0 = (uintptr_t)fct; return my_close_display_0; } if(my_close_display_fct_1 == 0) {my_close_display_fct_1 = (uintptr_t)fct; return my_close_display_1; } if(my_close_display_fct_2 == 0) {my_close_display_fct_2 = (uintptr_t)fct; return my_close_display_2; } if(my_close_display_fct_3 == 0) {my_close_display_fct_3 = (uintptr_t)fct; return my_close_display_3; } if(my_close_display_fct_4 == 0) {my_close_display_fct_4 = (uintptr_t)fct; return my_close_display_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext close_display callback\n"); fflush(ftrace);}} while(0);
    return 
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_wire_to_event_fct_0 = 0; static int my_wire_to_event_0(void* a, void* b, void* c) { return RunFunctionFmt(my_wire_to_event_fct_0, "ppp", a, b, c); } static uintptr_t my_wire_to_event_fct_1 = 0; static int my_wire_to_event_1(void* a, void* b, void* c) { return RunFunctionFmt(my_wire_to_event_fct_1, "ppp", a, b, c); } static uintptr_t my_wire_to_event_fct_2 = 0; static int my_wire_to_event_2(void* a, void* b, void* c) { return RunFunctionFmt(my_wire_to_event_fct_2, "ppp", a, b, c); } static uintptr_t my_wire_to_event_fct_3 = 0; static int my_wire_to_event_3(void* a, void* b, void* c) { return RunFunctionFmt(my_wire_to_event_fct_3, "ppp", a, b, c); } static uintptr_t my_wire_to_event_fct_4 = 0; static int my_wire_to_event_4(void* a, void* b, void* c) { return RunFunctionFmt(my_wire_to_event_fct_4, "ppp", a, b, c); }
...
static void* find_wire_to_event_Fct(void* fct)
{
    ...
    if(my_wire_to_event_fct_0 == (uintptr_t)fct) return my_wire_to_event_0; if(my_wire_to_event_fct_1 == (uintptr_t)fct) return my_wire_to_event_1; if(my_wire_to_event_fct_2 == (uintptr_t)fct) return my_wire_to_event_2; if(my_wire_to_event_fct_3 == (uintptr_t)fct) return my_wire_to_event_3; if(my_wire_to_event_fct_4 == (uintptr_t)fct) return my_wire_to_event_4;


    if(my_wire_to_event_fct_0 == 0) {my_wire_to_event_fct_0 = (uintptr_t)fct; return my_wire_to_event_0; } if(my_wire_to_event_fct_1 == 0) {my_wire_to_event_fct_1 = (uintptr_t)fct; return my_wire_to_event_1; } if(my_wire_to_event_fct_2 == 0) {my_wire_to_event_fct_2 = (uintptr_t)fct; return my_wire_to_event_2; } if(my_wire_to_event_fct_3 == 0) {my_wire_to_event_fct_3 = (uintptr_t)fct; return my_wire_to_event_3; } if(my_wire_to_event_fct_4 == 0) {my_wire_to_event_fct_4 = (uintptr_t)fct; return my_wire_to_event_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext wire_to_event callback\n"); fflush(ftrace);}} while(0);
    return 
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 266 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_event_to_wire_fct_0 = 0; static int my_event_to_wire_0(void* a, void* b, void* c) { return RunFunctionFmt(my_event_to_wire_fct_0, "ppp", a, b, c); } static uintptr_t my_event_to_wire_fct_1 = 0; static int my_event_to_wire_1(void* a, void* b, void* c) { return RunFunctionFmt(my_event_to_wire_fct_1, "ppp", a, b, c); } static uintptr_t my_event_to_wire_fct_2 = 0; static int my_event_to_wire_2(void* a, void* b, void* c) { return RunFunctionFmt(my_event_to_wire_fct_2, "ppp", a, b, c); } static uintptr_t my_event_to_wire_fct_3 = 0; static int my_event_to_wire_3(void* a, void* b, void* c) { return RunFunctionFmt(my_event_to_wire_fct_3, "ppp", a, b, c); } static uintptr_t my_event_to_wire_fct_4 = 0; static int my_event_to_wire_4(void* a, void* b, void* c) { return RunFunctionFmt(my_event_to_wire_fct_4, "ppp", a, b, c); }
...
static void* find_event_to_wire_Fct(void* fct)
{
    ...
    if(my_event_to_wire_fct_0 == (uintptr_t)fct) return my_event_to_wire_0; if(my_event_to_wire_fct_1 == (uintptr_t)fct) return my_event_to_wire_1; if(my_event_to_wire_fct_2 == (uintptr_t)fct) return my_event_to_wire_2; if(my_event_to_wire_fct_3 == (uintptr_t)fct) return my_event_to_wire_3; if(my_event_to_wire_fct_4 == (uintptr_t)fct) return my_event_to_wire_4;


    if(my_event_to_wire_fct_0 == 0) {my_event_to_wire_fct_0 = (uintptr_t)fct; return my_event_to_wire_0; } if(my_event_to_wire_fct_1 == 0) {my_event_to_wire_fct_1 = (uintptr_t)fct; return my_event_to_wire_1; } if(my_event_to_wire_fct_2 == 0) {my_event_to_wire_fct_2 = (uintptr_t)fct; return my_event_to_wire_2; } if(my_event_to_wire_fct_3 == 0) {my_event_to_wire_fct_3 = (uintptr_t)fct; return my_event_to_wire_3; } if(my_event_to_wire_fct_4 == 0) {my_event_to_wire_fct_4 = (uintptr_t)fct; return my_event_to_wire_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext event_to_wire callback\n"); fflush(ftrace);}} while(0);
    return 
# 288 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 288 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_error_fct_0 = 0; static int my_error_0(void* a, void* b, void* c, int* d) { return RunFunctionFmt(my_error_fct_0, "pppp", a, b, c, d); } static uintptr_t my_error_fct_1 = 0; static int my_error_1(void* a, void* b, void* c, int* d) { return RunFunctionFmt(my_error_fct_1, "pppp", a, b, c, d); } static uintptr_t my_error_fct_2 = 0; static int my_error_2(void* a, void* b, void* c, int* d) { return RunFunctionFmt(my_error_fct_2, "pppp", a, b, c, d); } static uintptr_t my_error_fct_3 = 0; static int my_error_3(void* a, void* b, void* c, int* d) { return RunFunctionFmt(my_error_fct_3, "pppp", a, b, c, d); } static uintptr_t my_error_fct_4 = 0; static int my_error_4(void* a, void* b, void* c, int* d) { return RunFunctionFmt(my_error_fct_4, "pppp", a, b, c, d); }
...
static void* find_error_Fct(void* fct)
{
    ...
    if(my_error_fct_0 == (uintptr_t)fct) return my_error_0; if(my_error_fct_1 == (uintptr_t)fct) return my_error_1; if(my_error_fct_2 == (uintptr_t)fct) return my_error_2; if(my_error_fct_3 == (uintptr_t)fct) return my_error_3; if(my_error_fct_4 == (uintptr_t)fct) return my_error_4;


    if(my_error_fct_0 == 0) {my_error_fct_0 = (uintptr_t)fct; return my_error_0; } if(my_error_fct_1 == 0) {my_error_fct_1 = (uintptr_t)fct; return my_error_1; } if(my_error_fct_2 == 0) {my_error_fct_2 = (uintptr_t)fct; return my_error_2; } if(my_error_fct_3 == 0) {my_error_fct_3 = (uintptr_t)fct; return my_error_3; } if(my_error_fct_4 == 0) {my_error_fct_4 = (uintptr_t)fct; return my_error_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext error callback\n"); fflush(ftrace);}} while(0);
    return 
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}
...
static uintptr_t my_error_string_fct_0 = 0; static int my_error_string_0(void* a, int b, void* c, void* d, int e) { return RunFunctionFmt(my_error_string_fct_0, "pippi", a, b, c, d, e); } static uintptr_t my_error_string_fct_1 = 0; static int my_error_string_1(void* a, int b, void* c, void* d, int e) { return RunFunctionFmt(my_error_string_fct_1, "pippi", a, b, c, d, e); } static uintptr_t my_error_string_fct_2 = 0; static int my_error_string_2(void* a, int b, void* c, void* d, int e) { return RunFunctionFmt(my_error_string_fct_2, "pippi", a, b, c, d, e); } static uintptr_t my_error_string_fct_3 = 0; static int my_error_string_3(void* a, int b, void* c, void* d, int e) { return RunFunctionFmt(my_error_string_fct_3, "pippi", a, b, c, d, e); } static uintptr_t my_error_string_fct_4 = 0; static int my_error_string_4(void* a, int b, void* c, void* d, int e) { return RunFunctionFmt(my_error_string_fct_4, "pippi", a, b, c, d, e); }
...
static void* find_error_string_Fct(void* fct)
{
    ...
    if(my_error_string_fct_0 == (uintptr_t)fct) return my_error_string_0; if(my_error_string_fct_1 == (uintptr_t)fct) return my_error_string_1; if(my_error_string_fct_2 == (uintptr_t)fct) return my_error_string_2; if(my_error_string_fct_3 == (uintptr_t)fct) return my_error_string_3; if(my_error_string_fct_4 == (uintptr_t)fct) return my_error_string_4;


    if(my_error_string_fct_0 == 0) {my_error_string_fct_0 = (uintptr_t)fct; return my_error_string_0; } if(my_error_string_fct_1 == 0) {my_error_string_fct_1 = (uintptr_t)fct; return my_error_string_1; } if(my_error_string_fct_2 == 0) {my_error_string_fct_2 = (uintptr_t)fct; return my_error_string_2; } if(my_error_string_fct_3 == 0) {my_error_string_fct_3 = (uintptr_t)fct; return my_error_string_3; } if(my_error_string_fct_4 == 0) {my_error_string_fct_4 = (uintptr_t)fct; return my_error_string_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libXext error_string callback\n"); fflush(ftrace);}} while(0);
    return 
# 332 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 3 4
          ((void *)0)
# 332 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
              ;
}



__attribute__((visibility("default"))) void* my_XShmCreateImage(x86emu_t* emu, void* disp, void* vis, uint32_t depth, int32_t fmt
...
__attribute__((visibility("default"))) int32_t my_XShmPutImage(x86emu_t* emu, void* disp, void* drawable, void* gc, void* image
...
__attribute__((visibility("default"))) int32_t my_XShmGetImage(x86emu_t* emu, void* disp, void* drawable, void* image, int32_t x, int32_t y, uint32_t plane)
{
    UnbridgeImageFunc(emu, (XImage*)image);
...
__attribute__((visibility("default"))) void* my_XSetExtensionErrorHandler(x86emu_t* emu, void* handler)
{
    (void)emu;
    return reverse_exterrorhandleFct(my->XSetExtensionErrorHandler(find_exterrorhandle_Fct(handler)));
}

__attribute__((visibility("default"))) void* my_XextAddDisplay(x86emu_t* emu, void* extinfo, void* dpy, void* extname, my_XExtensionHooks* hooks, int nevents, void* data)
{
    my_XExtensionHooks natives = {0};

    natives.create_gc = find_create_gc_Fct(hooks->create_gc);
    natives.copy_gc = find_copy_gc_Fct(hooks->copy_gc);
    natives.flush_gc = find_flush_gc_Fct(hooks->flush_gc);
    natives.free_gc = find_free_gc_Fct(hooks->free_gc);
    natives.create_font = find_create_font_Fct(hooks->create_font);
    natives.free_font = find_free_font_Fct(hooks->free_font);
    natives.close_display = find_close_display_Fct(hooks->close_display);
    natives.wire_to_event = find_wire_to_event_Fct(hooks->wire_to_event);
    natives.event_to_wire = find_event_to_wire_Fct(hooks->event_to_wire);
    natives.error = find_error_Fct(hooks->error);
    natives.error_string = find_error_string_Fct(hooks->error_string);

    void* ret = my->XextAddDisplay(extinfo, dpy, extname, &natives, nevents, data);
    return ret;
}
# 417 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxextdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxextsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h" 1
...
{"DPMSDisable", iFp, 0},
{"DPMSEnable", iFp, 0},
{"DPMSForceLevel", iFpu, 0},
{"DPMSGetTimeouts", iFpppp, 0},
{"DPMSGetVersion", iFppp, 0},
{"DPMSInfo", iFppp, 0},
{"DPMSQueryExtension", iFppp, 0},
{"DPMSSetTimeouts", iFpuuu, 0},
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h"
{"XdbeAllocateBackBufferName", pFppu, 0},
{"XdbeBeginIdiom", iFp, 0},
{"XdbeDeallocateBackBufferName", iFpp, 0},
{"XdbeEndIdiom", iFp, 0},
{"XdbeFreeVisualInfo", vFp, 0},
{"XdbeGetBackBufferAttributes", pFpp, 0},
{"XdbeGetVisualInfo", pFppp, 0},
{"XdbeQueryExtension", iFppp, 0},
{"XdbeSwapBuffers", iFppi, 0},




{"XextCreateExtension", pFv, 0},
{"XextDestroyExtension", vFp, 0},

{"XextFindDisplay", pFpp, 0},
{"XextRemoveDisplay", iFpp, 0},
# 60 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h"
{"XMissingExtension", iFpp, 0},
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h"

{"XShapeCombineMask", vFppiiipi, 0},
{"XShapeCombineRectangles", vFppiiipiii, 0},
{"XShapeCombineRegion", vFppiiipi, 0},
{"XShapeCombineShape", vFppiiipii, 0},
{"XShapeGetRectangles", pFppipp, 0},
{"XShapeInputSelected", uFpp, 0},
{"XShapeOffsetShape", vFppiii, 0},
{"XShapeQueryExtension", iFppp, 0},
{"XShapeQueryExtents", iFpppppppppppp, 0},
{"XShapeQueryVersion", iFppp, 0},
{"XShapeSelectInput", vFppu, 0},
{"XShmAttach", iFpp, 0},

{"XShmCreatePixmap", pFppppuuu, 0},
{"XShmDetach", iFpp, 0},
{"XShmGetEventBase", iFp, 0},

{"XShmPixmapFormat", iFp, 0},

{"XShmQueryExtension", iFp, 0},
{"XShmQueryVersion", iFpppp, 0},
{"XSyncAwait", iFppi, 0},

{"XSyncChangeAlarm", iFpuLp, 0},
{"XSyncChangeCounter", iFpu2, 0},
{"XSyncCreateAlarm", uFpLp, 0},
{"XSyncCreateCounter", uFp2, 0},

{"XSyncDestroyAlarm", iFpu, 0},
{"XSyncDestroyCounter", iFpu, 0},

{"XSyncFreeSystemCounterList", vFp, 0},
{"XSyncGetPriority", iFpup, 0},
{"XSyncInitialize", iFppp, 0},
{"XSyncIntsToValue", vFpui, 0},
{"XSyncIntToValue", vFpi, 0},
{"XSyncListSystemCounters", pFpp, 0},
{"XSyncMaxValue", vFp, 0},
{"XSyncMinValue", vFp, 0},
{"XSyncQueryAlarm", iFpup, 0},
{"XSyncQueryCounter", iFpup, 0},
{"XSyncQueryExtension", iFppp, 0},


{"XSyncSetCounter", iFpu2, 0},
{"XSyncSetPriority", iFpui, 0},

{"XSyncValueAdd", vFpppp, 0},
{"XSyncValueEqual", iFpp, 0},
{"XSyncValueGreaterOrEqual", iFpp, 0},
{"XSyncValueGreaterThan", iFpp, 0},
{"XSyncValueHigh32", iFp, 0},
{"XSyncValueIsNegative", iFp, 0},
{"XSyncValueIsPositive", iFp, 0},
{"XSyncValueIsZero", iFp, 0},
{"XSyncValueLessOrEqual", iFpp, 0},
{"XSyncValueLessThan", iFpp, 0},
{"XSyncValueLow32", uFp, 0},
{"XSyncValueSubtract", vFpppp, 0},
...
static const map_onesymbol_t libxextmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h" 1
...
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h"
{"XSetExtensionErrorHandler", pFEp, 0},
...
{"XShmCreateImage", pFEppuippuu, 0},



{"XShmGetImage", iFEpppiiu, 0},

{"XShmPutImage", iFEppppiiiiuui, 0},
...
static const map_onesymbol_t libxextstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h" 1
...
static const map_onesymbol2_t libxextsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h" 1
...
static const map_onedata_t libxextdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxextundefs.h" 1
...
int wrappedlibxext_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxextName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxextsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxextsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxextsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxextsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxextsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxextsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxextsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxextsymbolmap[i].name); }
 cnt = sizeof(libxextmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxextmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxextmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxextmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxextmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxextmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxextmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxextmysymbolmap[i].name); }

    cnt = sizeof(libxextstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxextstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxextstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxextstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxextstsymbolmap[i].name);
    }
    cnt = sizeof(libxextsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxextsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxextsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxextsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxextsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxextsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxextsymbol2map[i].name);
    }
    cnt = sizeof(libxextdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxextdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxextdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxextdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxextdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxextdatamap[i].sz;
        }
    }
    cnt = sizeof(libxextmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxextmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxextmydatamap[i].sz;
    }

    getMy(lib); setNeededLibs(lib, 5, "libX11.so.6", "libxcb.so.1", "libXau.so.6", "libdl.so.2", "libXdmcp.so.6");


    return 0;
}

void wrappedlibxext_fini(library_t* lib)
{
...
# 418 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxext.c" 2
