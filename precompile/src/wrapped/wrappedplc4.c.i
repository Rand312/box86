# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
...
int wrappedplc4_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(plc4Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(plc4symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (plc4symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, plc4symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = plc4symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, plc4symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = plc4symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(plc4symbolmap[i].name, '@')) AddDictionnary(box86->versym, plc4symbolmap[i].name); }
 cnt = sizeof(plc4mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (plc4mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, plc4mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = plc4mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, plc4mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = plc4mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(plc4mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, plc4mysymbolmap[i].name); }

    cnt = sizeof(plc4stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, plc4stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = plc4stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(plc4stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, plc4stsymbolmap[i].name);
    }
    cnt = sizeof(plc4symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, plc4symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = plc4symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = plc4symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = plc4symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(plc4symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, plc4symbol2map[i].name);
    }
    cnt = sizeof(plc4datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(plc4datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, plc4datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = plc4datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, plc4datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = plc4datamap[i].sz;
        }
    }
    cnt = sizeof(plc4mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, plc4mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = plc4mydatamap[i].sz;
    }
...
void wrappedplc4_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedplc4.c" 2
