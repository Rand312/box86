# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibibustypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibibustypes.h"
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
...
typedef struct libibus_my_s {


    vFpippp_t ibus_bus_current_input_context_async; vFpippp_t ibus_bus_get_global_engine_async; vFpippp_t ibus_bus_list_active_engines_async; vFpippp_t ibus_bus_list_engines_async; vFpippp_t ibus_input_context_get_engine_async; vFppippp_t ibus_bus_create_input_context_async; vFppippp_t ibus_bus_set_global_engine_async; vFppippp_t ibus_config_get_values_async; vFpppippp_t ibus_config_get_value_async; vFpuuuippp_t ibus_input_context_process_key_event_async; vFppppippp_t ibus_config_set_value_async;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libibus_my_t my_libibus = {0};
static libibus_my_t * const my = &my_libibus;

static void getMy(library_t* lib)
{

    my->ibus_bus_current_input_context_async = (vFpippp_t)dlsym(lib->w.lib, "ibus_bus_current_input_context_async"); my->ibus_bus_get_global_engine_async = (vFpippp_t)dlsym(lib->w.lib, "ibus_bus_get_global_engine_async"); my->ibus_bus_list_active_engines_async = (vFpippp_t)dlsym(lib->w.lib, "ibus_bus_list_active_engines_async"); my->ibus_bus_list_engines_async = (vFpippp_t)dlsym(lib->w.lib, "ibus_bus_list_engines_async"); my->ibus_input_context_get_engine_async = (vFpippp_t)dlsym(lib->w.lib, "ibus_input_context_get_engine_async"); my->ibus_bus_create_input_context_async = (vFppippp_t)dlsym(lib->w.lib, "ibus_bus_create_input_context_async"); my->ibus_bus_set_global_engine_async = (vFppippp_t)dlsym(lib->w.lib, "ibus_bus_set_global_engine_async"); my->ibus_config_get_values_async = (vFppippp_t)dlsym(lib->w.lib, "ibus_config_get_values_async"); my->ibus_config_get_value_async = (vFpppippp_t)dlsym(lib->w.lib, "ibus_config_get_value_async"); my->ibus_input_context_process_key_event_async = (vFpuuuippp_t)dlsym(lib->w.lib, "ibus_input_context_process_key_event_async"); my->ibus_config_set_value_async = (vFppppippp_t)dlsym(lib->w.lib, "ibus_config_set_value_async");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c"
...
static void* findGAsyncReadyCallbackFct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libibus GAsyncReadyCallback callback\n"); fflush(ftrace);}} while(0);
    return 
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 3 4
          ((void *)0)
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c"
              ;
}



__attribute__((visibility("default"))) void my_ibus_bus_create_input_context_async(x86emu_t* emu, void* bus, void* name, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_create_input_context_async(bus, name, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_bus_current_input_context_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_current_input_context_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_bus_get_global_engine_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_get_global_engine_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_bus_list_active_engines_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_list_active_engines_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_bus_list_engines_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_list_engines_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_bus_set_global_engine_async(x86emu_t* emu, void* bus, void* engine, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_bus_set_global_engine_async(bus, engine, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_config_get_value_async(x86emu_t* emu, void* bus, void* section, void* name, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_get_value_async(bus, section, name, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_config_get_values_async(x86emu_t* emu, void* bus, void* section, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_get_values_async(bus, section, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_config_set_value_async(x86emu_t* emu, void* bus, void* section, void* name, void* value, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_config_set_value_async(bus, section, name, value, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_input_context_get_engine_async(x86emu_t* emu, void* bus, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_input_context_get_engine_async(bus, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}

__attribute__((visibility("default"))) void my_ibus_input_context_process_key_event_async(x86emu_t* emu, void* bus, uint32_t keyval, uint32_t keycode, uint32_t state, int timeout, void* cancel, void* f, void* data)
{
    my->ibus_input_context_process_key_event_async(bus, keyval, keycode, state, timeout, cancel, findGAsyncReadyCallbackFct(f), data);
}
# 123 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibibusdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libibussymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_attr_type_get_type", LFv, 0},
{"ibus_attr_underline_get_type", LFv, 0},
...
{"ibus_bus_create_input_context_async_finish", pFppp, 0},


{"ibus_bus_current_input_context_async_finish", pFppp, 0},



{"ibus_bus_get_config", pFp, 0},

{"ibus_bus_get_engines_by_names", pFpp, 0},


{"ibus_bus_get_global_engine_async_finish", pFppp, 0},
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_bus_hello", pFp, 0},
{"ibus_bus_is_connected", iFp, 0},





{"ibus_bus_list_active_engines_async_finish", pFppp, 0},


{"ibus_bus_list_engines_async_finish", pFppp, 0},


{"ibus_bus_name_flag_get_type", LFv, 0},



{"ibus_bus_new", pFv, 0},
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_bus_request_name_reply_get_type", LFv, 0},


{"ibus_bus_set_global_engine_async_finish", pFppp, 0},



{"ibus_bus_set_watch_dbus_signal", vFpi, 0},
{"ibus_bus_set_watch_ibus_signal", vFpi, 0},
{"ibus_bus_start_service_by_name_reply_get_type", LFv, 0},
{"ibus_capabilite_get_type", LFv, 0},
# 134 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"

{"ibus_config_get_value_async_finish", pFppp, 0},


{"ibus_config_get_values_async_finish", pFppp, 0},
...
{"ibus_config_set_value_async_finish", pFppp, 0},
{"ibus_config_unset", iFppp, 0},
{"ibus_config_unwatch", iFppp, 0},
{"ibus_config_watch", iFppp, 0},
# 166 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_engine_desc_get_author", pFp, 0},
{"ibus_engine_desc_get_description", pFp, 0},
{"ibus_engine_desc_get_hotkeys", pFp, 0},
{"ibus_engine_desc_get_icon", pFp, 0},
{"ibus_engine_desc_get_icon_prop_key", pFp, 0},
{"ibus_engine_desc_get_language", pFp, 0},
{"ibus_engine_desc_get_layout", pFp, 0},
{"ibus_engine_desc_get_layout_option", pFp, 0},
{"ibus_engine_desc_get_layout_variant", pFp, 0},
{"ibus_engine_desc_get_license", pFp, 0},
{"ibus_engine_desc_get_longname", pFp, 0},
{"ibus_engine_desc_get_name", pFp, 0},
{"ibus_engine_desc_get_rank", iFp, 0},
{"ibus_engine_desc_get_setup", pFp, 0},
{"ibus_engine_desc_get_symbol", pFp, 0},
{"ibus_engine_desc_get_textdomain", pFp, 0},
{"ibus_engine_desc_get_type", pFp, 0},
{"ibus_engine_desc_get_version", pFp, 0},
# 212 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_error_get_type", LFv, 0},
# 244 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_init", vFv, 0},



{"ibus_input_context_focus_in", vFp, 0},
{"ibus_input_context_focus_out", vFp, 0},


{"ibus_input_context_get_engine_async_finish", pFppp, 0},




{"ibus_input_context_needs_surrounding_text", iFp, 0},
...
{"ibus_input_context_process_key_event_async_finish", pFppp, 0},
{"ibus_input_context_property_activate", vFppu, 0},


{"ibus_input_context_reset", vFp, 0},
{"ibus_input_context_set_capabilities", vFpu, 0},

{"ibus_input_context_set_content_type", vFpuu, 0},
{"ibus_input_context_set_cursor_location", vFpuuuu, 0},

{"ibus_input_context_set_engine", vFpp, 0},
{"ibus_input_context_set_surrounding_text", vFppuu, 0},
{"ibus_input_hints_get_type", LFv, 0},
{"ibus_input_purpose_get_type", LFv, 0},



{"ibus_keymap_get", pFp, 0},
{"ibus_keymap_get_type", LFv, 0},
{"ibus_keymap_lookup_keysym", uFpWu, 0},



{"ibus_keyval_from_name", uFp, 0},
{"ibus_keyval_name", pFu, 0},

{"ibus_keyval_to_unicode", uFu, 0},

{"ibus_lookup_table_append_candidate", vFpp, 0},
{"ibus_lookup_table_append_label", vFpp, 0},
{"ibus_lookup_table_clear", vFp, 0},


{"ibus_lookup_table_get_candidate", pFpu, 0},
{"ibus_lookup_table_get_cursor_in_page", uFp, 0},
{"ibus_lookup_table_get_cursor_pos", uFp, 0},
{"ibus_lookup_table_get_label", pFpu, 0},
{"ibus_lookup_table_get_number_of_candidates", uFp, 0},
{"ibus_lookup_table_get_orientation", iFp, 0},
{"ibus_lookup_table_get_page_size", uFp, 0},

{"ibus_lookup_table_is_cursor_visible", iFp, 0},
{"ibus_lookup_table_is_round", iFp, 0},
{"ibus_lookup_table_new", pFuuii, 0},


{"ibus_lookup_table_set_cursor_pos", vFpu, 0},
{"ibus_lookup_table_set_cursor_visible", vFpi, 0},
{"ibus_lookup_table_set_label", vFpup, 0},
{"ibus_lookup_table_set_orientation", vFpi, 0},
{"ibus_lookup_table_set_page_size", vFpu, 0},
{"ibus_lookup_table_set_round", vFpi, 0},

{"ibus_modifier_type_get_type", LFv, 0},

{"ibus_object_flags_get_type", LFv, 0},
{"ibus_object_get_type", LFv, 0},
...
{"ibus_orientation_get_type", LFv, 0},
# 347 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_preedit_focus_mode_get_type", LFv, 0},
{"ibus_property_get_icon", pFp, 0},
{"ibus_property_get_key", pFp, 0},
{"ibus_property_get_label", pFp, 0},
{"ibus_property_get_prop_type", iFp, 0},
{"ibus_property_get_sensitive", iFp, 0},
{"ibus_property_get_state", iFp, 0},
{"ibus_property_get_sub_props", pFp, 0},
{"ibus_property_get_symbol", pFp, 0},
{"ibus_property_get_tooltip", pFp, 0},
{"ibus_property_get_type", LFv, 0},
{"ibus_property_get_visible", iFp, 0},


{"ibus_property_set_icon", vFpp, 0},
{"ibus_property_set_label", vFpp, 0},
{"ibus_property_set_sensitive", vFpi, 0},
{"ibus_property_set_state", vFpi, 0},

{"ibus_property_set_symbol", vFpp, 0},
{"ibus_property_set_tooltip", vFpp, 0},
{"ibus_property_set_visible", vFpi, 0},


{"ibus_prop_list_get", pFpu, 0},
{"ibus_prop_list_get_type", LFv, 0},


{"ibus_prop_state_get_type", LFv, 0},
{"ibus_prop_type_get_type", LFv, 0},
# 415 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_text_get_text", pFp, 0},
{"ibus_text_get_type", LFv, 0},


{"ibus_text_new_from_string", pFp, 0},
# 440 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_unicode_to_keyval", uFu, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libibusmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
...
{"ibus_bus_create_input_context_async", vFEppippp, 0},


{"ibus_bus_current_input_context_async", vFEpippp, 0},
...
{"ibus_bus_get_global_engine_async", vFEpippp, 0},
...
{"ibus_bus_list_active_engines_async", vFEpippp, 0},


{"ibus_bus_list_engines_async", vFEpippp, 0},
...
{"ibus_bus_set_global_engine_async", vFEppippp, 0},
...
# 134 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
{"ibus_config_get_value_async", vFEpppippp, 0},


{"ibus_config_get_values_async", vFEppippp, 0},
...
{"ibus_config_set_value_async", vFEppppippp, 0},
...
{"ibus_input_context_get_engine_async", vFEpippp, 0},
...
{"ibus_input_context_process_key_event_async", vFEpuuuippp, 0},
...
static const map_onesymbol_t libibusstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
...
static const map_onesymbol2_t libibussymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
...
static const map_onedata_t libibusdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
...
static const map_onedata_t libibusmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h" 1
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibibusundefs.h" 1
...
int wrappedlibibus_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libibusName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libibussymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libibussymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libibussymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libibussymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libibussymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libibussymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libibussymbolmap[i].name, '@')) AddDictionnary(box86->versym, libibussymbolmap[i].name); }
 cnt = sizeof(libibusmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libibusmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libibusmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libibusmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libibusmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libibusmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libibusmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libibusmysymbolmap[i].name); }

    cnt = sizeof(libibusstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libibusstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libibusstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libibusstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libibusstsymbolmap[i].name);
    }
    cnt = sizeof(libibussymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libibussymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libibussymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libibussymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libibussymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libibussymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libibussymbol2map[i].name);
    }
    cnt = sizeof(libibusdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libibusdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libibusdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libibusdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libibusdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libibusdatamap[i].sz;
        }
    }
    cnt = sizeof(libibusmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libibusmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libibusmydatamap[i].sz;
    }
...
void wrappedlibibus_fini(library_t* lib)
{
...
# 124 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibibus.c" 2
