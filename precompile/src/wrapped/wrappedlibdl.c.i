# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 1 "/usr/include/bits/link_lavcurrent.h" 1 3 4
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/library.h" 1



# 1 "/home/ssd/pico/code/box86/src/include/symbols.h" 1




# 1 "/home/ssd/pico/code/box86/src/include/custommem.h" 1
# 6 "/home/ssd/pico/code/box86/src/include/symbols.h" 2
# 1 "/home/ssd/pico/code/box86/src/include/khash.h" 1
# 7 "/home/ssd/pico/code/box86/src/include/symbols.h" 2

typedef struct versymbols_s versymbols_t;

typedef struct kh_mapsymbols_s{ khint_t n_buckets, size, n_occupied, upper_bound; khint32_t *flags; kh_cstr_t *keys; versymbols_t *vals; } kh_mapsymbols_t; extern kh_mapsymbols_t *kh_init_mapsymbols(void); extern void kh_destroy_mapsymbols(kh_mapsymbols_t *h); extern void kh_clear_mapsymbols(kh_mapsymbols_t *h); extern khint_t kh_get_mapsymbols(const kh_mapsymbols_t *h, kh_cstr_t key); extern int kh_resize_mapsymbols(kh_mapsymbols_t *h, khint_t new_n_buckets); extern khint_t kh_put_mapsymbols(kh_mapsymbols_t *h, kh_cstr_t key, int *ret); extern void kh_del_mapsymbols(kh_mapsymbols_t *h, khint_t x);
...
typedef struct kh_defaultversion_s{ khint_t n_buckets, size, n_occupied, upper_bound; khint32_t *flags; kh_cstr_t *keys; const char* *vals; } kh_defaultversion_t; extern kh_defaultversion_t *kh_init_defaultversion(void); extern void kh_destroy_defaultversion(kh_defaultversion_t *h); extern void kh_clear_defaultversion(kh_defaultversion_t *h); extern khint_t kh_get_defaultversion(const kh_defaultversion_t *h, kh_cstr_t key); extern int kh_resize_defaultversion(kh_defaultversion_t *h, khint_t new_n_buckets); extern khint_t kh_put_defaultversion(kh_defaultversion_t *h, kh_cstr_t key, int *ret); extern void kh_del_defaultversion(kh_defaultversion_t *h, khint_t x);
...
# 5 "/home/ssd/pico/code/box86/src/include/library.h" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
# 1 "/home/ssd/pico/code/box86/src/elfs/elfloader_private.h" 1
...
typedef struct elfheader_s {
    ...
    kh_defaultversion_t *globaldefver;
    kh_defaultversion_t *weakdefver;
} elfheader_t;
# 137 "/home/ssd/pico/code/box86/src/elfs/elfloader_private.h"
elfheader_t* ParseElfHeader(FILE* f, const char* name, int exec);
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
...
dlprivate_t *NewDLPrivate() {
    dlprivate_t* dl = (dlprivate_t*)__libc_calloc(1, sizeof(dlprivate_t));
    return dl;
}
void FreeDLPrivate(dlprivate_t **lib) {
    __libc_free((*lib)->last_error);
    __libc_free(*lib);
}
...
void* my_dlopen(x86emu_t* emu, void *filename, int flag) __attribute__((visibility("default")));
void* my_dlmopen(x86emu_t* emu, void* mlid, void *filename, int flag) __attribute__((visibility("default")));
char* my_dlerror(x86emu_t* emu) __attribute__((visibility("default")));
void* my_dlsym(x86emu_t* emu, void *handle, void *symbol) __attribute__((visibility("default")));
int my_dlclose(x86emu_t* emu, void *handle) __attribute__((visibility("default")));
int my_dladdr(x86emu_t* emu, void *addr, void *info) __attribute__((visibility("default")));
int my_dladdr1(x86emu_t* emu, void *addr, void *info, void** extra_info, int flags) __attribute__((visibility("default")));
void* my_dlvsym(x86emu_t* emu, void *handle, void *symbol, const char *vername) __attribute__((visibility("default")));
int my_dlinfo(x86emu_t* emu, void* handle, int request, void* info) __attribute__((visibility("default")));
...
void RemoveDlopen(library_t** lib, int idx)
{
    ...
    if(dl && idx<dl->lib_sz) {
        if(lib!=&dl->dllibs[idx].lib)
            dl->dllibs[idx].lib = 
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                 ((void *)0)
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                     ;
...
void* my_dlopen(x86emu_t* emu, void *filename, int flag)
{
    ...
    library_t *lib = 
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                    ((void *)0)
# 90 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                        ;
    dlprivate_t *dl = my_context->dlprivate;
    size_t dlopened = 0;
    int is_local = (flag&0x100)?0:1;
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 94 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 94 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    if(filename) {
        char* rfilename = (char*)
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                __builtin_alloca (
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                4096
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                )
# 96 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
        ...
        do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "Call to dlopen(\"%s\"/%p, %X) from %p(%s)\n", rfilename, filename, flag, *(void**)(emu->regs[_SP].dword[0]), getAddrFunctionName(*(uintptr_t*)(emu->regs[_SP].dword[0]))); fflush(ftrace);}} while(0);

        while(strstr(rfilename, "${ORIGIN}")) {
            char* origin = box_strdup(my_context->fullpath);
            char* p = strrchr(origin, '/');
            if(p) *p = '\0';
            char* tmp = (char*)__libc_calloc(1, strlen(rfilename)-strlen("${ORIGIN}")+strlen(origin)+1);
        ...
        while(strstr(rfilename, "${PLATFORM}")) {
            ...
            if(p) *p = '\0';
            char* tmp = (char*)__libc_calloc(1, strlen(rfilename)-strlen("${PLATFORM}")+strlen(platform)+1);
            ...
            strcpy(rfilename, tmp);
            __libc_free(tmp);
            __libc_free(platform);
        }

        for (size_t i=3; i<dl->lib_sz; ++i) {
            if(dl->dllibs[i].full && IsSameLib(dl->dllibs[i].lib, rfilename)) {
                if(flag&0x4) {
                    if(dl->dllibs[i].count==0 && dl->dllibs[i].dlopened) {
                        do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, " => not present anymore\n"); fflush(ftrace);}} while(0);
                        return 
# 142 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                              ((void *)0)
# 142 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                  ;
                    }
                }
                ...
                do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "dlopen: Recycling %s/%p count=%zd (dlopened=%zd, elf_index=%d)\n", rfilename, (void*)(i+1), dl->dllibs[i].count, dl->dllibs[i].dlopened, GetElfIndex(dl->dllibs[i].lib)); fflush(ftrace);}} while(0);
                return (void*)(i+1);
            }
        }
        ...
        if(flag&0x4) {
            if(lib) {
                if(dl->lib_sz == dl->lib_cap) {
                    dl->lib_cap += 4;
                    dl->dllibs = (dllib_t*)__libc_realloc(dl->dllibs, sizeof(dllib_t)*dl->lib_cap);
                ...
                do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "dlopen: New handle %p (%s), dlopened=%zd\n", (void*)(idx+1), (char*)filename, dlopened); fflush(ftrace);}} while(0);
                return (void*)(idx+1);

            }
            do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, " => not present\n"); fflush(ftrace);}} while(0);
            return 
# 177 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                  ((void *)0)
# 177 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                      ;
        }
        dlopened = (lib==
# 179 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                        ((void *)0)
# 179 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                            );
        ...
        my_context->deferredInitList = 
# 184 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                      ((void *)0)
# 184 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                          ;
        ...
        if(AddNeededLib(
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                       ((void *)0)
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                           , is_local, bindnow, tmp, 
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                     ((void *)0)
# 193 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                         , my_context, emu)) {
            do {if(dlsym_error || ((strchr(rfilename,'/')?2:1)<=box86_log)) {fprintf(ftrace, "Warning: Cannot dlopen(\"%s\"/%p, %X)\n", rfilename, filename, flag); fflush(ftrace);}} while(0);
            if(!dl->last_error)
                dl->last_error = __libc_malloc(129);
            snprintf(dl->last_error, 129, "Cannot dlopen(\"%s\"/%p, %X)\n", rfilename, filename, flag);
            RemoveNeededLib(
# 198 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                           ((void *)0)
# 198 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                               , is_local, tmp, my_context, emu);
            if(my_context->deferredInitList)
                __libc_free(my_context->deferredInitList);
            ...
            return 
# 205 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                  ((void *)0)
# 205 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                      ;
        }
        free_neededlib(tmp);
        lib = GetLibInternal(rfilename);
        ...
        do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "Call to dlopen(NULL, %X)\n", flag); fflush(ftrace);}} while(0);
    }
...
{
    if(lmid) {
        do {if(dlsym_error || ((1)<=box86_log)) {fprintf(ftrace, "Warning, dlmopen(%p, %p(\"%s\"), 0x%x) called with lmid not LMID_ID_BASE (unsupported)\n", lmid, filename, filename?(char*)filename:"self", flag); fflush(ftrace);}} while(0);
    }
...
int recursive_dlsym_lib(kh_libs_t* collection, library_t* lib, const char* rsymbol, uintptr_t *start, uintptr_t *end, int version, const char* vername, const char* globdefver, const char* weakdefver)
{
    if(!lib)
        return 0;
    khint_t k = kh_get_libs(collection, (uintptr_t)lib);
    if(k != ((collection)->n_buckets))
        return 0;
    int ret;
    kh_put_libs(collection, (uintptr_t)lib, &ret);
...
# 299 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                  { { 0, 0, 0, PTHREAD_MUTEX_TIMED_NP, 0, { { 0, 0 } } } }
# 299 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                           ;
    ...
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 304 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 304 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "%04d|Call to dlsym(%p, \"%s\")%s", GetTID(), handle, rsymbol, dlsym_error?"":"\n"); fflush(ftrace);}} while(0);
    if(handle==
# 306 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 306 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ) {

        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 308 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 308 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 309 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 309 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        if(GetGlobalSymbolStartEnd(my_context->maplib, rsymbol, &start, &end, 
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                             ((void *)0)
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                 , -1, 
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                       ((void *)0)
# 310 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                           , globdefver, weakdefver)) {
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)start); fflush(ftrace);}} while(0);
        ...
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 318 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
       ((void *)0)
# 318 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
       ); fflush(ftrace);}} while(0);
        pthread_mutex_unlock(&mutex);
        return 
# 320 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 320 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(handle==(void*)~0LL) {

        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 324 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 324 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 325 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 325 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        elfheader_t *elf = FindElfAddress(my_context, *(uintptr_t*)emu->regs[_SP].dword[0]);
        if(GetNoSelfSymbolStartEnd(my_context->maplib, rsymbol, &start, &end, elf, 0, -1, 
# 327 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                         ((void *)0)
# 327 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                             , globdefver, weakdefver)) {
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)start); fflush(ftrace);}} while(0);
            pthread_mutex_unlock(&mutex);
            return (void*)start;
        ...
        snprintf(dl->last_error, 129, "Symbol \"%s\" not found in %p)\n", rsymbol, handle);
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 335 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
       ((void *)0)
# 335 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
       ); fflush(ftrace);}} while(0);
        pthread_mutex_unlock(&mutex);
        return 
# 337 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 337 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    ...
    if(nlib>=dl->lib_sz) {
        ...
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 346 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
       ((void *)0)
# 346 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
       ); fflush(ftrace);}} while(0);
        pthread_mutex_unlock(&mutex);
        return 
# 348 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 348 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(!dl->dllibs[nlib].count || !dl->dllibs[nlib].full) {
        ...
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)
# 354 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
       ((void *)0)
# 354 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
       ); fflush(ftrace);}} while(0);
        pthread_mutex_unlock(&mutex);
        return 
# 356 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 356 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(dl->dllibs[nlib].lib) {
        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, (my_context->maplib==dl->dllibs[nlib].lib->maplib)?
# 359 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                                                               ((void *)0)
# 359 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                                                                   :dl->dllibs[nlib].lib->maplib, 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, (my_context->maplib==dl->dllibs[nlib].lib->maplib)?
# 360 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                                                               ((void *)0)
# 360 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                                                                   :dl->dllibs[nlib].lib->maplib, 1, rsymbol);
        if(my_dlsym_lib(dl->dllibs[nlib].lib, rsymbol, &start, &end, -1, 
# 361 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                        ((void *)0)
# 361 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                            , globdefver, weakdefver)==0) {

            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\nCall to dlsym(%s, \"%s\") Symbol not found\n", 
# 363 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 363 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           , GetNameLib(dl->dllibs[nlib].lib), rsymbol); fflush(ftrace);}} while(0);
            do {if((2)<=box86_log) {fprintf(ftrace, " Symbol not found\n"); fflush(ftrace);}} while(0);
            if(!dl->last_error)
                dl->last_error = __libc_malloc(129);
            snprintf(dl->last_error, 129, "Symbol \"%s\" not found in %p(%s)", rsymbol, handle, GetNameLib(dl->dllibs[nlib].lib));
            pthread_mutex_unlock(&mutex);
            return 
# 369 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                  ((void *)0)
# 369 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                      ;
        }
    } else {
        ...
        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 374 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 374 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 375 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 375 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        if(GetGlobalSymbolStartEnd(my_context->maplib, rsymbol, &start, &end, 
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                             ((void *)0)
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                 , -1, 
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                       ((void *)0)
# 376 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
        ...
        snprintf(dl->last_error, 129, "Symbol \"%s\" not found in %p)\n", rsymbol, handle);
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 384 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
       ((void *)0)
# 384 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
       ); fflush(ftrace);}} while(0);
        pthread_mutex_unlock(&mutex);
        return 
# 386 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 386 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)start); fflush(ftrace);}} while(0);
    pthread_mutex_unlock(&mutex);
...
{
    (void)emu;
    do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "Call to dlclose(%p)\n", handle); fflush(ftrace);}} while(0);
    dlprivate_t *dl = my_context->dlprivate;
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 397 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 397 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    size_t nlib = (size_t)handle;
    --nlib;
    ...
    if(nlib>=dl->lib_sz) {
        if(!dl->last_error)
            dl->last_error = __libc_malloc(129);
        snprintf(dl->last_error, 129, "Bad handle %p)\n", handle);
        do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "dlclose: %s\n", dl->last_error); fflush(ftrace);}} while(0);
        return -1;
    }
    if(!dl->dllibs[nlib].count || !dl->dllibs[nlib].full) {
        if(!dl->last_error)
...
int my_dladdr1(x86emu_t* emu, void *addr, void *i, void** extra_info, int flags)
{
    ...
    dlprivate_t *dl = my_context->dlprivate;
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 429 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 429 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    Dl_info *info = (Dl_info*)i;
    do {if((2)<=box86_log) {fprintf(ftrace, "Warning: partially unimplement call to dladdr/dladdr1(%p, %p, %p, %d)\n", addr, info, extra_info, flags); fflush(ftrace);}} while(0);


    library_t* lib = 
# 434 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                    ((void *)0)
# 434 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                        ;
    info->dli_saddr = 
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                     ((void *)0)
# 435 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                         ;
    info->dli_fname = 
# 436 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                     ((void *)0)
# 436 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                         ;
    info->dli_sname = FindSymbolName(my_context->maplib, addr, &info->dli_saddr, 
# 437 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                ((void *)0)
# 437 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                    , &info->dli_fname, &info->dli_fbase, &lib);
    do {if((2)<=box86_log) {fprintf(ftrace, "     dladdr return saddr=%p, fname=\"%s\", sname=\"%s\"\n", info->dli_saddr, info->dli_sname?info->dli_sname:"", info->dli_fname?info->dli_fname:""); fflush(ftrace);}} while(0);
    if(flags==1) {
        do {if((1)<=box86_log) {fprintf(ftrace, "Warning, unimplement call to dladdr1 with RTLD_DL_SYMENT flags\n"); fflush(ftrace);}} while(0);
    } else if (flags==2) {
        do {if((1)<=box86_log) {fprintf(ftrace, "Warning, partially unimplemented call to dladdr1 with RTLD_DL_LINKMAP flags\n"); fflush(ftrace);}} while(0);
        *(linkmap_t**)extra_info = getLinkMapLib(lib);
    }
    return (info->dli_sname)?1:0;
}
int my_dladdr(x86emu_t* emu, void *addr, void *i)
{
    return my_dladdr1(emu, addr, i, 
# 449 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                   ((void *)0)
# 449 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                       , 0);
}
void* my_dlvsym(x86emu_t* emu, void *handle, void *symbol, const char *vername)
{
    ...
    char* rsymbol = (char*)symbol;
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 457 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 457 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "Call to dlvsym(%p, \"%s\", %s)%s", handle, rsymbol, vername?vername:"(nil)", dlsym_error?"":"\n"); fflush(ftrace);}} while(0);
    if(handle==
# 459 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 459 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ) {

        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 461 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 461 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 462 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 462 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        if(GetGlobalSymbolStartEnd(my_context->maplib, rsymbol, &start, &end, 
# 463 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                             ((void *)0)
# 463 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                 , version, vername, globdefver, weakdefver)) {
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)start); fflush(ftrace);}} while(0);
            return (void*)start;
        }
        if(!dl->last_error)
        ...
        snprintf(dl->last_error, 129, "Symbol \"%s\" version %s not found in %p)\n", rsymbol, vername?vername:"(nil)", handle);
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 470 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 470 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           ); fflush(ftrace);}} while(0);
        return 
# 471 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 471 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(handle==(void*)~0LL) {

        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 475 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 475 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 476 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 476 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        elfheader_t *elf = FindElfAddress(my_context, *(uintptr_t*)emu->regs[_SP].dword[0]);
        ...
        snprintf(dl->last_error, 129, "Symbol \"%s\" version %s not found in %p)\n", rsymbol, vername?vername:"(nil)", handle);
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 485 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 485 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           ); fflush(ftrace);}} while(0);
        return 
# 486 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 486 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    size_t nlib = (size_t)handle;
    --nlib;
    ...
    if(nlib>=dl->lib_sz) {
        ...
        snprintf(dl->last_error, 129, "Bad handle %p)\n", handle);
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", 
# 495 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 495 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           ); fflush(ftrace);}} while(0);
        return 
# 496 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 496 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(!dl->dllibs[nlib].count || !dl->dllibs[nlib].full) {
        if(!dl->last_error)
        ...
        snprintf(dl->last_error, 129, "Bad handle %p (already closed))\n", handle);
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)
# 502 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 502 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           ); fflush(ftrace);}} while(0);
        return 
# 503 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 503 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
    if(dl->dllibs[nlib].lib) {
        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, (my_context->maplib==dl->dllibs[nlib].lib->maplib)?
# 506 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                                                               ((void *)0)
# 506 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                                                                   :dl->dllibs[nlib].lib->maplib, 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, (my_context->maplib==dl->dllibs[nlib].lib->maplib)?
# 507 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                                                               ((void *)0)
# 507 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                                                                   :dl->dllibs[nlib].lib->maplib, 1, rsymbol);
...
# 510 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
               ((void *)0)
# 510 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
               , GetNameLib(dl->dllibs[nlib].lib), rsymbol, vername?vername:"(nil)"); fflush(ftrace);}} while(0);
            do {if((2)<=box86_log) {fprintf(ftrace, " Symbol not found\n"); fflush(ftrace);}} while(0);
            if(!dl->last_error)
                dl->last_error = __libc_malloc(129);
            snprintf(dl->last_error, 129, "Symbol \"%s\" not found in %p(%s)", rsymbol, handle, GetNameLib(dl->dllibs[nlib].lib));
            return 
# 515 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                  ((void *)0)
# 515 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                      ;
        }
    } else {

        const char* globdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 519 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 519 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 0, rsymbol);
        const char* weakdefver = GetMaplibDefaultVersion(my_context->maplib, 
# 520 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                            ((void *)0)
# 520 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                , 1, rsymbol);
        if(GetGlobalSymbolStartEnd(my_context->maplib, rsymbol, &start, &end, 
# 521 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                             ((void *)0)
# 521 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                                                                                 , -1, 
# 521 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
                                                                                       ((void *)0)
# 521 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
            ...
            do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\nCall to dlvsym(%s, \"%s\", %s) Symbol not found\n", 
# 526 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
           ((void *)0)
# 526 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
           , "Self", rsymbol, vername?vername:"(nil)"); fflush(ftrace);}} while(0);
        do {if((2)<=box86_log) {fprintf(ftrace, " Symbol not found\n"); fflush(ftrace);}} while(0);
        if(!dl->last_error)
            dl->last_error = __libc_malloc(129);
        snprintf(dl->last_error, 129, "Symbol \"%s\" version %s not found in %p)\n", rsymbol, vername?vername:"(nil)", handle);
        return 
# 531 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
              ((void *)0)
# 531 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
                  ;
    }
        do {if(dlsym_error || ((3)<=box86_log)) {fprintf(ftrace, "%p\n", (void*)start); fflush(ftrace);}} while(0);
    return (void*)start;
...
{
    (void)emu;
    do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "Call to dlinfo(%p, %d, %p)\n", handle, request, info); fflush(ftrace);}} while(0);
    dlprivate_t *dl = my_context->dlprivate;
    if(dl->last_error) __libc_free(dl->last_error); dl->last_error = 
# 542 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 3 4
   ((void *)0)
# 542 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
   ;
    size_t nlib = (size_t)handle;
    --nlib;
    ...
    if(nlib>=dl->lib_sz) {
        if(!dl->last_error)
            dl->last_error = __libc_malloc(129);
        snprintf(dl->last_error, 129, "Bad handle %p)\n", handle);
        do {if(dlsym_error || ((2)<=box86_log)) {fprintf(ftrace, "dlinfo: %s\n", dl->last_error); fflush(ftrace);}} while(0);
        return -1;
    }
    if(!dl->dllibs[nlib].count || !dl->dllibs[nlib].full) {
        if(!dl->last_error)
    ...
    switch(request) {
        case 2:
            ...
            return 0;
        default:
            do {if((0)<=box86_log) {fprintf(ftrace, "Warning, unsupported call to dlinfo(%p, %d, %p)\n", handle, request, info); fflush(ftrace);}} while(0);
        if(!dl->last_error)
            dl->last_error = __libc_malloc(129);
...
__attribute__((visibility("default"))) int my__dl_find_object(x86emu_t* emu, void* addr, my_dl_find_object_t* result)
{
...
# 612 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c"
    ...
    if(dl) {
        ...
        for(size_t i=0; i<dl->lib_sz; ++i)
            while(dl->dllibs[i].count) {
                do {if((2)<=box86_log) {fprintf(ftrace, "  closing %s\n", dl->dllibs[i].lib->name); fflush(ftrace);}} while(0);
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibdldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libdlsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl_private.h" 1
...
static const map_onesymbol_t libdlmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl_private.h" 1
...
static const map_onesymbol2_t libdlsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl_private.h" 1
...
static const map_onedata_t libdldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl_private.h" 1
...
static const map_onedata_t libdlmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibdlundefs.h" 1
...
int wrappedlibdl_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libdlName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libdlsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libdlsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libdlsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libdlsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libdlsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libdlsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libdlsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libdlsymbolmap[i].name); }
 cnt = sizeof(libdlmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libdlmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libdlmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libdlmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libdlmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libdlmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libdlmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libdlmysymbolmap[i].name); }

    cnt = sizeof(libdlstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libdlstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libdlstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libdlstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libdlstsymbolmap[i].name);
    }
    cnt = sizeof(libdlsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libdlsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libdlsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libdlsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libdlsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libdlsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libdlsymbol2map[i].name);
    }
    cnt = sizeof(libdldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libdldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libdldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libdldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libdldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libdldatamap[i].sz;
        }
    }
    cnt = sizeof(libdlmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libdlmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libdlmydatamap[i].sz;
    }
...
# 630 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibdl.c" 2
