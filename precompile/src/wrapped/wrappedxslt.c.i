# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxslttypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxslttypes.h"
typedef void (*vFp_t)(void*);
typedef int32_t (*iFppp_t)(void*, void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
...
typedef struct xslt_my_s {
    ...
    vFp_t xsltSetLoaderFunc; iFppp_t xsltRegisterExtModuleFunction;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static xslt_my_t my_xslt = {0};
static xslt_my_t * const my = &my_xslt;

static void getMy(library_t* lib)
{

    my->xsltSetLoaderFunc = (vFp_t)dlsym(lib->w.lib, "xsltSetLoaderFunc"); my->xsltRegisterExtModuleFunction = (iFppp_t)dlsym(lib->w.lib, "xsltRegisterExtModuleFunction");
...
static void* find_xmlXPathFunction_Fct(void* fct)
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libxslt xmlXPathFunction callback\n"); fflush(ftrace);}} while(0);
    return 
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 3 4
          ((void *)0)
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c"
              ;
}
...
static uintptr_t my_xsltDocLoaderFunc_fct_0 = 0; static void* my_xsltDocLoaderFunc_0(void* a, void* b, int c, void* d, int e) { return (void*)RunFunctionFmt(my_xsltDocLoaderFunc_fct_0, "ppipi", a, b, c, d, e); } static uintptr_t my_xsltDocLoaderFunc_fct_1 = 0; static void* my_xsltDocLoaderFunc_1(void* a, void* b, int c, void* d, int e) { return (void*)RunFunctionFmt(my_xsltDocLoaderFunc_fct_1, "ppipi", a, b, c, d, e); } static uintptr_t my_xsltDocLoaderFunc_fct_2 = 0; static void* my_xsltDocLoaderFunc_2(void* a, void* b, int c, void* d, int e) { return (void*)RunFunctionFmt(my_xsltDocLoaderFunc_fct_2, "ppipi", a, b, c, d, e); } static uintptr_t my_xsltDocLoaderFunc_fct_3 = 0; static void* my_xsltDocLoaderFunc_3(void* a, void* b, int c, void* d, int e) { return (void*)RunFunctionFmt(my_xsltDocLoaderFunc_fct_3, "ppipi", a, b, c, d, e); } static uintptr_t my_xsltDocLoaderFunc_fct_4 = 0; static void* my_xsltDocLoaderFunc_4(void* a, void* b, int c, void* d, int e) { return (void*)RunFunctionFmt(my_xsltDocLoaderFunc_fct_4, "ppipi", a, b, c, d, e); }
...
static void* find_xsltDocLoaderFunc_Fct(void* fct)
{
    ...
    if(my_xsltDocLoaderFunc_fct_0 == (uintptr_t)fct) return my_xsltDocLoaderFunc_0; if(my_xsltDocLoaderFunc_fct_1 == (uintptr_t)fct) return my_xsltDocLoaderFunc_1; if(my_xsltDocLoaderFunc_fct_2 == (uintptr_t)fct) return my_xsltDocLoaderFunc_2; if(my_xsltDocLoaderFunc_fct_3 == (uintptr_t)fct) return my_xsltDocLoaderFunc_3; if(my_xsltDocLoaderFunc_fct_4 == (uintptr_t)fct) return my_xsltDocLoaderFunc_4;


    if(my_xsltDocLoaderFunc_fct_0 == 0) {my_xsltDocLoaderFunc_fct_0 = (uintptr_t)fct; return my_xsltDocLoaderFunc_0; } if(my_xsltDocLoaderFunc_fct_1 == 0) {my_xsltDocLoaderFunc_fct_1 = (uintptr_t)fct; return my_xsltDocLoaderFunc_1; } if(my_xsltDocLoaderFunc_fct_2 == 0) {my_xsltDocLoaderFunc_fct_2 = (uintptr_t)fct; return my_xsltDocLoaderFunc_2; } if(my_xsltDocLoaderFunc_fct_3 == 0) {my_xsltDocLoaderFunc_fct_3 = (uintptr_t)fct; return my_xsltDocLoaderFunc_3; } if(my_xsltDocLoaderFunc_fct_4 == 0) {my_xsltDocLoaderFunc_fct_4 = (uintptr_t)fct; return my_xsltDocLoaderFunc_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libxslt xsltDocLoaderFunc callback\n"); fflush(ftrace);}} while(0);
    return 
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 3 4
          ((void *)0)
# 83 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c"
              ;
}



__attribute__((visibility("default"))) int my_xsltRegisterExtModuleFunction(x86emu_t* emu, void* name, void* URI, void* f)
{
    (void)emu;
    return my->xsltRegisterExtModuleFunction(name, URI, find_xmlXPathFunction_Fct(f));
}

__attribute__((visibility("default"))) void my_xsltSetLoaderFunc(x86emu_t* emu, void* f)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxsltdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t xsltsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
{"xslAddCall", iFpp, 0},
{"xslDropCall", vFv, 0},
{"xslHandleDebugger", vFpppp, 0},

{"xsltAddStackElemList", iFpp, 0},

{"xsltAllocateExtra", iFp, 0},
{"xsltAllocateExtraCtxt", iFp, 0},

{"xsltApplyImports", vFpppp, 0},
{"xsltApplyOneTemplate", vFppppp, 0},
{"xsltApplyStripSpaces", vFpp, 0},
{"xsltApplyStylesheet", pFppp, 0},
{"xsltApplyStylesheetUser", pFpppppp, 0},
{"xsltApplyTemplates", vFpppp, 0},
{"xsltAttribute", vFpppp, 0},




{"xsltCalibrateAdjust", vFl, 0},
{"xsltCallTemplate", vFpppp, 0},
{"xsltCheckExtPrefix", iFpp, 0},
{"xsltCheckExtURI", iFpp, 0},
{"xsltCheckRead", iFppp, 0},
{"xsltCheckWrite", iFppp, 0},
{"xsltChoose", vFpppp, 0},
{"xsltCleanupGlobals", vFv, 0},

{"xsltComment", vFpppp, 0},
{"xsltCompileAttr", vFpp, 0},

{"xsltComputeSortResult", pFpp, 0},
{"xsltCopy", vFpppp, 0},


{"xsltCopyOf", vFpppp, 0},
{"xsltCopyTextString", pFpppi, 0},

{"xsltCreateRVT", pFp, 0},
{"xsltDebug", vFpppp, 0},
{"xsltDebugDumpExtensions", vFp, 0},
{"xsltDebugGetDefaultTrace", iFv, 0},
{"xsltDebugSetDefaultTrace", vFi, 0},
{"xsltDecimalFormatGetByName", pFpp, 0},
{"xsltDecimalFormatGetByQName", pFppp, 0},
{"xsltDefaultSortFunction", vFppi, 0},

{"xsltDocumentElem", vFpppp, 0},

{"xsltDocumentSortFunction", vFp, 0},
{"xsltDoSortFunction", vFppi, 0},
{"xsltElement", vFpppp, 0},


{"xsltEvalAVT", pFppp, 0},
{"xsltEvalGlobalVariables", iFp, 0},
{"xsltEvalOneUserParam", iFppp, 0},


{"xsltEvalUserParams", iFpp, 0},




{"xsltExtensionInstructionResultFinalize", iFp, 0},
{"xsltExtensionInstructionResultRegister", iFpp, 0},




{"xsltFindDocument", pFpp, 0},
{"xsltFindElemSpaceHandling", iFpp, 0},
{"xsltFindTemplate", pFppp, 0},
{"xsltFlagRVTs", iFppp, 0},
{"xsltForEach", vFpppp, 0},
{"xsltFormatNumberConversion", iFppdp, 0},


{"xsltFreeAVTList", vFp, 0},

{"xsltFreeCtxtExts", vFp, 0},

{"xsltFreeDocuments", vFp, 0},
{"xsltFreeExts", vFp, 0},
{"xsltFreeGlobalVariables", vFp, 0},



{"xsltFreeRVTs", vFp, 0},
{"xsltFreeSecurityPrefs", vFp, 0},
{"xsltFreeStackElemList", vFp, 0},
{"xsltFreeStyleDocuments", vFp, 0},

{"xsltFreeStylesheet", vFp, 0},

{"xsltFreeTransformContext", vFp, 0},

{"xsltFunctionNodeSet", vFpi, 0},

{"xsltGetCNsProp", pFpppp, 0},
{"xsltGetDebuggerStatus", iFv, 0},

{"xsltGetExtData", pFpp, 0},
{"xsltGetExtInfo", pFpp, 0},


{"xsltGetNsProp", pFppp, 0},

{"xsltGetProfileInformation", pFp, 0},
{"xsltGetQNameURI", pFpp, 0},
{"xsltGetQNameURI2", pFppp, 0},
{"xsltGetSecurityPrefs", pFpi, 0},


{"xsltGetUTF8Char", iFpp, 0},
{"xsltGetXIncludeDefault", iFv, 0},
{"xsltIf", vFpppp, 0},
{"xsltInit", vFv, 0},
{"xsltInitAllDocKeys", iFp, 0},
{"xsltInitCtxtExts", iFp, 0},



{"xsltInitGlobals", vFv, 0},
{"xsltIsBlank", iFp, 0},

{"xsltLoadDocument", pFpp, 0},
{"xsltLoadStyleDocument", pFpp, 0},
{"xsltLoadStylesheetPI", pFp, 0},

{"xsltLocalVariablePop", vFpii, 0},
{"xsltLocalVariablePush", iFppi, 0},
{"xsltMessage", vFppp, 0},

{"xsltNeedElemSpaceHandling", iFp, 0},
{"xsltNewDocument", pFpp, 0},


{"xsltNewSecurityPrefs", pFv, 0},
{"xsltNewStyleDocument", pFpp, 0},
{"xsltNewStylesheet", pFv, 0},
{"xsltNewTransformContext", pFpp, 0},
{"xsltNextImport", pFp, 0},

{"xsltNumber", vFpppp, 0},
{"xsltNumberFormat", vFppp, 0},
{"xsltParseAnyXSLTElem", iFpp, 0},
{"xsltParseGlobalParam", vFpp, 0},
{"xsltParseGlobalVariable", vFpp, 0},
{"xsltParseSequenceConstructor", vFpp, 0},

{"xsltParseStylesheetCallerParam", pFpp, 0},
{"xsltParseStylesheetDoc", pFp, 0},
{"xsltParseStylesheetFile", pFp, 0},
{"xsltParseStylesheetImport", iFpp, 0},
{"xsltParseStylesheetImportedDoc", pFpp, 0},
{"xsltParseStylesheetInclude", iFpp, 0},
{"xsltParseStylesheetOutput", vFpp, 0},
{"xsltParseStylesheetParam", vFpp, 0},
{"xsltParseStylesheetProcess", pFpp, 0},
{"xsltParseStylesheetVariable", vFpp, 0},

{"xsltPointerListAddSize", iFppi, 0},
{"xsltPointerListClear", vFp, 0},
{"xsltPointerListCreate", pFi, 0},
{"xsltPointerListFree", vFp, 0},
{"xsltPreComputeExtModuleElement", pFpp, 0},
{"xsltPrintErrorContext", vFppp, 0},
{"xsltProcessingInstruction", vFpppp, 0},
{"xsltProcessOneNode", vFppp, 0},
{"xsltProfileStylesheet", pFpppp, 0},
{"xsltQuoteOneUserParam", iFppp, 0},
{"xsltQuoteUserParams", iFpp, 0},
{"xsltRegisterAllElement", vFp, 0},
{"xsltRegisterAllExtras", vFv, 0},
...
{"xsltRegisterExtPrefix", iFppp, 0},
{"xsltRegisterExtras", vFp, 0},
{"xsltRegisterLocalRVT", iFpp, 0},
{"xsltRegisterPersistRVT", iFpp, 0},
{"xsltRegisterTestModule", vFv, 0},
{"xsltRegisterTmpRVT", iFpp, 0},
{"xsltReleaseRVT", vFpp, 0},

{"xsltRestoreDocumentNamespaces", iFpp, 0},
{"xsltRunStylesheet", iFpppppp, 0},
{"xsltRunStylesheetUser", iFpppppppp, 0},
{"xsltSaveProfiling", vFpp, 0},
{"xsltSaveResultTo", iFppp, 0},
{"xsltSaveResultToFd", iFipp, 0},
{"xsltSaveResultToFile", iFppp, 0},
{"xsltSaveResultToFilename", iFpppi, 0},
{"xsltSaveResultToString", iFpppp, 0},
{"xsltSecurityAllow", iFppp, 0},
{"xsltSecurityForbid", iFppp, 0},
{"xsltSetCtxtParseOptions", iFpi, 0},
{"xsltSetCtxtSecurityPrefs", iFpp, 0},


{"xsltSetDebuggerStatus", vFi, 0},
{"xsltSetDefaultSecurityPrefs", vFp, 0},
...
{"xsltSetXIncludeDefault", vFi, 0},
{"xsltShutdownCtxtExts", vFp, 0},
{"xsltShutdownExts", vFp, 0},
{"xsltSort", vFpppp, 0},
{"xsltSplitQName", pFppp, 0},

{"xsltStyleGetExtData", pFpp, 0},

{"xsltStyleStylesheetLevelGetExtData", pFpp, 0},



{"xsltText", vFpppp, 0},
{"xsltTimestamp", lFv, 0},
{"xsltTransformError", vFpppppppppppppppp, 0},
{"xsltUninit", vFv, 0},

{"xsltUnregisterExtModule", iFp, 0},
{"xsltUnregisterExtModuleElement", iFpp, 0},
{"xsltUnregisterExtModuleFunction", iFpp, 0},
{"xsltUnregisterExtModuleTopLevel", iFpp, 0},
{"xsltValueOf", vFpppp, 0},
{"xsltVariableLookup", pFppp, 0},
{"xsltXPathCompile", pFpp, 0},
{"xsltXPathCompileFlags", pFppi, 0},
{"xsltXPathFunctionLookup", pFppp, 0},
{"xsltXPathGetTransformContext", pFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t xsltmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
{"xsltRegisterExtModuleFunction", iFEppp, 0},
...
static const map_onesymbol_t xsltstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
static const map_onesymbol2_t xsltsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
static const map_onedata_t xsltdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
static const map_onedata_t xsltmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedxsltundefs.h" 1
...
int wrappedxslt_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(xsltName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(xsltsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (xsltsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, xsltsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = xsltsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, xsltsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = xsltsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(xsltsymbolmap[i].name, '@')) AddDictionnary(box86->versym, xsltsymbolmap[i].name); }
 cnt = sizeof(xsltmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (xsltmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, xsltmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = xsltmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, xsltmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = xsltmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(xsltmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, xsltmysymbolmap[i].name); }

    cnt = sizeof(xsltstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, xsltstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = xsltstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(xsltstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, xsltstsymbolmap[i].name);
    }
    cnt = sizeof(xsltsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, xsltsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = xsltsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = xsltsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = xsltsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(xsltsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, xsltsymbol2map[i].name);
    }
    cnt = sizeof(xsltdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(xsltdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, xsltdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = xsltdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, xsltdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = xsltdatamap[i].sz;
        }
    }
    cnt = sizeof(xsltmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, xsltmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = xsltmydatamap[i].sz;
    }
...
void wrappedxslt_fini(library_t* lib)
{
...
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedxslt.c" 2
