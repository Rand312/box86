# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedldaprtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedldaprtypes.h"
typedef int32_t (*iFpppppupp_t)(void*, void*, void*, void*, void*, uint32_t, void*, void*);
# 31 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
...
typedef struct ldapr_my_s {
    ...
    iFpppppupp_t ldap_sasl_interactive_bind_s;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static ldapr_my_t my_ldapr = {0};
static ldapr_my_t * const my = &my_ldapr;

static void getMy(library_t* lib)
{

    my->ldap_sasl_interactive_bind_s = (iFpppppupp_t)dlsym(lib->w.lib, "ldap_sasl_interactive_bind_s");
...
# 33 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
# 48 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c"
static uintptr_t my_LDAP_SASL_INTERACT_PROC_fct_0 = 0; static int my_LDAP_SASL_INTERACT_PROC_0(void* a, unsigned b, void* c, void* d) { return RunFunctionFmt(my_LDAP_SASL_INTERACT_PROC_fct_0, "pupp", a, b, c, d); } static uintptr_t my_LDAP_SASL_INTERACT_PROC_fct_1 = 0; static int my_LDAP_SASL_INTERACT_PROC_1(void* a, unsigned b, void* c, void* d) { return RunFunctionFmt(my_LDAP_SASL_INTERACT_PROC_fct_1, "pupp", a, b, c, d); } static uintptr_t my_LDAP_SASL_INTERACT_PROC_fct_2 = 0; static int my_LDAP_SASL_INTERACT_PROC_2(void* a, unsigned b, void* c, void* d) { return RunFunctionFmt(my_LDAP_SASL_INTERACT_PROC_fct_2, "pupp", a, b, c, d); } static uintptr_t my_LDAP_SASL_INTERACT_PROC_fct_3 = 0; static int my_LDAP_SASL_INTERACT_PROC_3(void* a, unsigned b, void* c, void* d) { return RunFunctionFmt(my_LDAP_SASL_INTERACT_PROC_fct_3, "pupp", a, b, c, d); } static uintptr_t my_LDAP_SASL_INTERACT_PROC_fct_4 = 0; static int my_LDAP_SASL_INTERACT_PROC_4(void* a, unsigned b, void* c, void* d) { return RunFunctionFmt(my_LDAP_SASL_INTERACT_PROC_fct_4, "pupp", a, b, c, d); }
...
static void* find_LDAP_SASL_INTERACT_PROC_Fct(void* fct)
{
    ...
    if(my_LDAP_SASL_INTERACT_PROC_fct_0 == (uintptr_t)fct) return my_LDAP_SASL_INTERACT_PROC_0; if(my_LDAP_SASL_INTERACT_PROC_fct_1 == (uintptr_t)fct) return my_LDAP_SASL_INTERACT_PROC_1; if(my_LDAP_SASL_INTERACT_PROC_fct_2 == (uintptr_t)fct) return my_LDAP_SASL_INTERACT_PROC_2; if(my_LDAP_SASL_INTERACT_PROC_fct_3 == (uintptr_t)fct) return my_LDAP_SASL_INTERACT_PROC_3; if(my_LDAP_SASL_INTERACT_PROC_fct_4 == (uintptr_t)fct) return my_LDAP_SASL_INTERACT_PROC_4;


    if(my_LDAP_SASL_INTERACT_PROC_fct_0 == 0) {my_LDAP_SASL_INTERACT_PROC_fct_0 = (uintptr_t)fct; return my_LDAP_SASL_INTERACT_PROC_0; } if(my_LDAP_SASL_INTERACT_PROC_fct_1 == 0) {my_LDAP_SASL_INTERACT_PROC_fct_1 = (uintptr_t)fct; return my_LDAP_SASL_INTERACT_PROC_1; } if(my_LDAP_SASL_INTERACT_PROC_fct_2 == 0) {my_LDAP_SASL_INTERACT_PROC_fct_2 = (uintptr_t)fct; return my_LDAP_SASL_INTERACT_PROC_2; } if(my_LDAP_SASL_INTERACT_PROC_fct_3 == 0) {my_LDAP_SASL_INTERACT_PROC_fct_3 = (uintptr_t)fct; return my_LDAP_SASL_INTERACT_PROC_3; } if(my_LDAP_SASL_INTERACT_PROC_fct_4 == 0) {my_LDAP_SASL_INTERACT_PROC_fct_4 = (uintptr_t)fct; return my_LDAP_SASL_INTERACT_PROC_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for libldap_r LDAP_SASL_INTERACT_PROC callback\n"); fflush(ftrace);}} while(0);
    return 
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 3 4
          ((void *)0)
# 61 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c"
              ;
}


__attribute__((visibility("default"))) int my_ldap_sasl_interactive_bind_s(x86emu_t* emu, void* ld, void* dn, void* mechs, void* sctrls, void* cctrls, unsigned flags, void* f, void* defaults)
{
    (void)emu;
    return my->ldap_sasl_interactive_bind_s(ld, dn, mechs, sctrls, cctrls, flags, find_LDAP_SASL_INTERACT_PROC_Fct(f), defaults);
}
# 84 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedldaprdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ldaprsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1




{"ldap_abandon", iFpi, 0},
{"ldap_abandon_ext", iFpipp, 0},

{"ldap_add_ext", iFpppppp, 0},
{"ldap_add_ext_s", iFppppp, 0},
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_bind", iFpppi, 0},
{"ldap_bind_s", iFpppi, 0},
# 47 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_compare_ext", iFppppppp, 0},
{"ldap_compare_ext_s", iFpppppp, 0},
...
{"ldap_control_create", iFpipip, 0},
{"ldap_control_dup", pFp, 0},
{"ldap_control_find", pFppp, 0},
{"ldap_control_free", vFp, 0},
{"ldap_controls_dup", pFp, 0},
{"ldap_controls_free", vFp, 0},
{"ldap_count_entries", iFpp, 0},

{"ldap_count_references", iFpp, 0},
{"ldap_count_values", iFp, 0},
{"ldap_count_values_len", iFp, 0},
# 78 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_create_sort_control", iFppip, 0},


{"ldap_create_vlv_control", iFppp, 0},

{"ldap_dcedn2dn", pFp, 0},
{"ldap_delete", iFpp, 0},
{"ldap_delete_ext", iFppppp, 0},
{"ldap_delete_ext_s", iFpppp, 0},

{"ldap_delete_s", iFpp, 0},


{"ldap_dn2ad_canonical", pFp, 0},
...
{"ldap_dn2str", iFppu, 0},
{"ldap_dn2ufn", pFp, 0},
# 107 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_explode_dn", pFpi, 0},
{"ldap_explode_rdn", pFpi, 0},
{"ldap_extended_operation", iFpppppp, 0},
{"ldap_extended_operation_s", iFppppppp, 0},


{"ldap_first_attribute", pFppp, 0},
{"ldap_first_entry", pFpp, 0},

{"ldap_first_reference", pFpp, 0},
...
{"ldap_get_option", iFpip, 0},
{"ldap_get_values", pFppp, 0},
{"ldap_get_values_len", pFppp, 0},



{"ldap_init", pFpi, 0},
{"ldap_init_fd", iFuipp, 0},
{"ldap_initialize", iFpp, 0},
{"ldap_install_tls", iFp, 0},
# 197 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_memalloc", pFL, 0},
{"ldap_memcalloc", pFLL, 0},
{"ldap_memfree", vFp, 0},
{"ldap_memrealloc", pFpL, 0},
{"ldap_memvfree", vFp, 0},

{"ldap_modify_ext", iFpppppp, 0},
{"ldap_modify_ext_s", iFppppp, 0},





{"ldap_mods_free", vFpp, 0},
...
{"ldap_next_attribute", pFppp, 0},
{"ldap_next_entry", pFpp, 0},

{"ldap_next_reference", pFpp, 0},
...
{"ldap_parse_extended_result", iFppppi, 0},
...
{"ldap_parse_reference", iFppppi, 0},

{"ldap_parse_result", iFpppppppi, 0},
{"ldap_parse_sasl_bind_result", iFpppi, 0},

{"ldap_parse_sortresponse_control", iFpppp, 0},
{"ldap_parse_vlvresponse_control", iFpppppp, 0},
# 381 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_rename", iFppppippp, 0},


{"ldap_rename_s", iFppppipp, 0},
{"ldap_result", iFppipp, 0},


{"ldap_sasl_bind", iFppppppp, 0},
{"ldap_sasl_bind_s", iFppppppp, 0},




{"ldap_search_ext", iFppippipppip, 0},
{"ldap_search_ext_s", iFppippipppip, 0},
...
{"ldap_set_option", iFpip, 0},


{"ldap_simple_bind", iFppp, 0},
{"ldap_simple_bind_s", iFppp, 0},



{"ldap_start_tls", iFp, 0},
{"ldap_start_tls_s", iFppp, 0},
...
{"ldap_strdup", pFp, 0},
# 439 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_tls_inplace", iFp, 0},



{"ldap_unbind", iFp, 0},
{"ldap_unbind_ext", iFppp, 0},
{"ldap_unbind_ext_s", iFppp, 0},
{"ldap_unbind_s", iFp, 0},
# 479 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h"
{"ldap_value_free", vFp, 0},
{"ldap_value_free_len", vFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t ldaprmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1
...
{"ldap_sasl_interactive_bind_s", iFEpppppupp, 0},
...
static const map_onesymbol_t ldaprstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1
...
static const map_onesymbol2_t ldaprsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1
...
static const map_onedata_t ldaprdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1
...
static const map_onedata_t ldaprmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedldaprundefs.h" 1
...
int wrappedldapr_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(ldaprName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(ldaprsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ldaprsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, ldaprsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = ldaprsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, ldaprsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = ldaprsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(ldaprsymbolmap[i].name, '@')) AddDictionnary(box86->versym, ldaprsymbolmap[i].name); }
 cnt = sizeof(ldaprmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (ldaprmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, ldaprmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = ldaprmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, ldaprmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = ldaprmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(ldaprmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, ldaprmysymbolmap[i].name); }

    cnt = sizeof(ldaprstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, ldaprstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = ldaprstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(ldaprstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, ldaprstsymbolmap[i].name);
    }
    cnt = sizeof(ldaprsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, ldaprsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = ldaprsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = ldaprsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = ldaprsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(ldaprsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, ldaprsymbol2map[i].name);
    }
    cnt = sizeof(ldaprdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(ldaprdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, ldaprdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = ldaprdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, ldaprdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = ldaprdatamap[i].sz;
        }
    }
    cnt = sizeof(ldaprmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, ldaprmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = ldaprmydatamap[i].sz;
    }

    getMy(lib); setNeededLibs(lib, 1, "liblber-2.4.so.2");


    return 0;
}

void wrappedldapr_fini(library_t* lib)
{
...
# 85 "/home/ssd/pico/code/box86/src/wrapped/wrappedldapr.c" 2
