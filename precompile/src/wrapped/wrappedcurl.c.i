# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcurltypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcurltypes.h"
typedef uint32_t (*uFpup_t)(void*, uint32_t, void*);
# 32 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static curl_my_t my_curl = {0};
static curl_my_t * const my = &my_curl;

static void getMy(library_t* lib)
{

    my->curl_easy_setopt = (uFpup_t)dlsym(lib->w.lib, "curl_easy_setopt");
...
# 34 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
typedef enum {
...
# 336 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_write_fct_0 = 0; static size_t my_write_0(char* ptr, size_t size, size_t nmemb, void* userdata) { return (size_t)RunFunctionFmt(my_write_fct_0, "pLLp", ptr, size, nmemb, userdata);} static uintptr_t my_write_fct_1 = 0; static size_t my_write_1(char* ptr, size_t size, size_t nmemb, void* userdata) { return (size_t)RunFunctionFmt(my_write_fct_1, "pLLp", ptr, size, nmemb, userdata);} static uintptr_t my_write_fct_2 = 0; static size_t my_write_2(char* ptr, size_t size, size_t nmemb, void* userdata) { return (size_t)RunFunctionFmt(my_write_fct_2, "pLLp", ptr, size, nmemb, userdata);} static uintptr_t my_write_fct_3 = 0; static size_t my_write_3(char* ptr, size_t size, size_t nmemb, void* userdata) { return (size_t)RunFunctionFmt(my_write_fct_3, "pLLp", ptr, size, nmemb, userdata);}

static void* find_write_Fct(void* fct)
{
    if(!fct) return 
# 340 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 340 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl write callback\n"); fflush(ftrace);}} while(0);
    return 
# 349 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 349 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}
# 359 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_read_fct_0 = 0; static size_t my_read_0(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_read_fct_0, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_read_fct_1 = 0; static size_t my_read_1(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_read_fct_1, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_read_fct_2 = 0; static size_t my_read_2(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_read_fct_2, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_read_fct_3 = 0; static size_t my_read_3(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_read_fct_3, "pLLp", buffer, size, nitems, userdata); }

static void* find_read_Fct(void* fct)
{
    if(!fct) return 
# 363 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 363 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl read callback\n"); fflush(ftrace);}} while(0);
    return 
# 372 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 372 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}
# 382 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_ioctl_fct_0 = 0; static size_t my_ioctl_0(void* handle, int32_t fnc, void* userdata) { return (size_t)RunFunctionFmt(my_ioctl_fct_0, "pip", handle, fnc, userdata); } static uintptr_t my_ioctl_fct_1 = 0; static size_t my_ioctl_1(void* handle, int32_t fnc, void* userdata) { return (size_t)RunFunctionFmt(my_ioctl_fct_1, "pip", handle, fnc, userdata); } static uintptr_t my_ioctl_fct_2 = 0; static size_t my_ioctl_2(void* handle, int32_t fnc, void* userdata) { return (size_t)RunFunctionFmt(my_ioctl_fct_2, "pip", handle, fnc, userdata); } static uintptr_t my_ioctl_fct_3 = 0; static size_t my_ioctl_3(void* handle, int32_t fnc, void* userdata) { return (size_t)RunFunctionFmt(my_ioctl_fct_3, "pip", handle, fnc, userdata); }

static void* find_ioctl_Fct(void* fct)
{
    if(!fct) return 
# 386 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 386 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl ioctl callback\n"); fflush(ftrace);}} while(0);
    return 
# 395 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 395 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}
# 405 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_seek_fct_0 = 0; static int32_t my_seek_0(void* userdata, int64_t off, int32_t origin) { return (int32_t)RunFunctionFmt(my_seek_fct_0, "pIi", userdata, off, origin); } static uintptr_t my_seek_fct_1 = 0; static int32_t my_seek_1(void* userdata, int64_t off, int32_t origin) { return (int32_t)RunFunctionFmt(my_seek_fct_1, "pIi", userdata, off, origin); } static uintptr_t my_seek_fct_2 = 0; static int32_t my_seek_2(void* userdata, int64_t off, int32_t origin) { return (int32_t)RunFunctionFmt(my_seek_fct_2, "pIi", userdata, off, origin); } static uintptr_t my_seek_fct_3 = 0; static int32_t my_seek_3(void* userdata, int64_t off, int32_t origin) { return (int32_t)RunFunctionFmt(my_seek_fct_3, "pIi", userdata, off, origin); }

static void* find_seek_Fct(void* fct)
{
    if(!fct) return 
# 409 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 409 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_seek_fct_0 == (uintptr_t)fct) return my_seek_0; if(my_seek_fct_1 == (uintptr_t)fct) return my_seek_1; if(my_seek_fct_2 == (uintptr_t)fct) return my_seek_2; if(my_seek_fct_3 == (uintptr_t)fct) return my_seek_3;


    if(my_seek_fct_0 == 0) {my_seek_fct_0 = (uintptr_t)fct; return my_seek_0; } if(my_seek_fct_1 == 0) {my_seek_fct_1 = (uintptr_t)fct; return my_seek_1; } if(my_seek_fct_2 == 0) {my_seek_fct_2 = (uintptr_t)fct; return my_seek_2; } if(my_seek_fct_3 == 0) {my_seek_fct_3 = (uintptr_t)fct; return my_seek_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl seek callback\n"); fflush(ftrace);}} while(0);
    return 
# 418 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 418 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}
# 428 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_header_fct_0 = 0; static size_t my_header_0(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_header_fct_0, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_header_fct_1 = 0; static size_t my_header_1(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_header_fct_1, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_header_fct_2 = 0; static size_t my_header_2(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_header_fct_2, "pLLp", buffer, size, nitems, userdata); } static uintptr_t my_header_fct_3 = 0; static size_t my_header_3(char* buffer, size_t size, size_t nitems, void* userdata) { return (size_t)RunFunctionFmt(my_header_fct_3, "pLLp", buffer, size, nitems, userdata); }

static void* find_header_Fct(void* fct)
{
    if(!fct) return 
# 432 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 432 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_header_fct_0 == (uintptr_t)fct) return my_header_0; if(my_header_fct_1 == (uintptr_t)fct) return my_header_1; if(my_header_fct_2 == (uintptr_t)fct) return my_header_2; if(my_header_fct_3 == (uintptr_t)fct) return my_header_3;


    if(my_header_fct_0 == 0) {my_header_fct_0 = (uintptr_t)fct; return my_header_0; } if(my_header_fct_1 == 0) {my_header_fct_1 = (uintptr_t)fct; return my_header_1; } if(my_header_fct_2 == 0) {my_header_fct_2 = (uintptr_t)fct; return my_header_2; } if(my_header_fct_3 == 0) {my_header_fct_3 = (uintptr_t)fct; return my_header_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl header callback\n"); fflush(ftrace);}} while(0);
    return 
# 441 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 441 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}
# 451 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
static uintptr_t my_progress_fct_0 = 0; static int my_progress_0(void *clientp, double dltotal, double dlnow, double ultotal, double ulnow) { return (int)RunFunctionFmt(my_progress_fct_0, "pdddd", clientp, dltotal, dlnow, ultotal, ulnow); } static uintptr_t my_progress_fct_1 = 0; static int my_progress_1(void *clientp, double dltotal, double dlnow, double ultotal, double ulnow) { return (int)RunFunctionFmt(my_progress_fct_1, "pdddd", clientp, dltotal, dlnow, ultotal, ulnow); } static uintptr_t my_progress_fct_2 = 0; static int my_progress_2(void *clientp, double dltotal, double dlnow, double ultotal, double ulnow) { return (int)RunFunctionFmt(my_progress_fct_2, "pdddd", clientp, dltotal, dlnow, ultotal, ulnow); } static uintptr_t my_progress_fct_3 = 0; static int my_progress_3(void *clientp, double dltotal, double dlnow, double ultotal, double ulnow) { return (int)RunFunctionFmt(my_progress_fct_3, "pdddd", clientp, dltotal, dlnow, ultotal, ulnow); }

static void* find_progress_Fct(void* fct)
{
    if(!fct) return 
# 455 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
                   ((void *)0)
# 455 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
                       ;
    if(GetNativeFnc((uintptr_t)fct)) return GetNativeFnc((uintptr_t)fct);

    if(my_progress_fct_0 == (uintptr_t)fct) return my_progress_0; if(my_progress_fct_1 == (uintptr_t)fct) return my_progress_1; if(my_progress_fct_2 == (uintptr_t)fct) return my_progress_2; if(my_progress_fct_3 == (uintptr_t)fct) return my_progress_3;


    if(my_progress_fct_0 == 0) {my_progress_fct_0 = (uintptr_t)fct; return my_progress_0; } if(my_progress_fct_1 == 0) {my_progress_fct_1 = (uintptr_t)fct; return my_progress_1; } if(my_progress_fct_2 == 0) {my_progress_fct_2 = (uintptr_t)fct; return my_progress_2; } if(my_progress_fct_3 == 0) {my_progress_fct_3 = (uintptr_t)fct; return my_progress_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for curl progress callback\n"); fflush(ftrace);}} while(0);
    return 
# 464 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 3 4
          ((void *)0)
# 464 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
              ;
}



__attribute__((visibility("default"))) uint32_t my_curl_easy_setopt(x86emu_t* emu, void* handle, uint32_t option, void* param)
{
    (void)emu;
    switch(option) {
        ...
        case CURLOPT_RESOLVER_START_DATA:
            do {if((0)<=box86_log) {fprintf(ftrace, "Error: unimplemented option %u in curl_easy_setopt\n", option); fflush(ftrace);}} while(0);
            return 48;
        default:
            return my->curl_easy_setopt(handle, option, param);
    }
}
# 536 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcurldefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t curlsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1




{"curl_easy_cleanup", vFp, 0},
{"curl_easy_duphandle", pFp, 0},
{"curl_easy_escape", pFppi, 0},
{"curl_easy_getinfo", uFpppppp, 0},
{"curl_easy_init", pFv, 0},

{"curl_easy_perform", uFp, 0},

{"curl_easy_reset", vFp, 0},


{"curl_easy_strerror", pFu, 0},


{"curl_formadd", iFpppppppppppppppp, 0},
{"curl_formfree", vFp, 0},

{"curl_free", vFp, 0},


{"curl_global_cleanup", vFv, 0},
{"curl_global_init", uFu, 0},
# 46 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h"
{"curl_multi_add_handle", uFpp, 0},

{"curl_multi_cleanup", uFp, 0},
{"curl_multi_fdset", uFppppp, 0},
{"curl_multi_info_read", pFpp, 0},
{"curl_multi_init", pFv, 0},
{"curl_multi_perform", uFpp, 0},
{"curl_multi_remove_handle", uFpp, 0},




{"curl_multi_strerror", pFi, 0},
{"curl_multi_timeout", iFpp, 0},
{"curl_multi_wait", iFppuip, 0},
# 72 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h"
{"curl_slist_append", pFpp, 0},
{"curl_slist_free_all", vFp, 0},



{"curl_version", pFv, 0},
{"curl_version_info", pFi, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t curlmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1
...
static const map_onesymbol_t curlstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1
...
static const map_onesymbol2_t curlsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1
...
static const map_onedata_t curldatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1
...
static const map_onedata_t curlmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcurlundefs.h" 1
...
int wrappedcurl_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        lib->w.lib = dlopen("libcurl-gnutls.so.4", 
...
# 151 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(curlName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(curlsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (curlsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, curlsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = curlsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, curlsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = curlsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(curlsymbolmap[i].name, '@')) AddDictionnary(box86->versym, curlsymbolmap[i].name); }
 cnt = sizeof(curlmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (curlmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, curlmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = curlmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, curlmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = curlmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(curlmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, curlmysymbolmap[i].name); }

    cnt = sizeof(curlstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, curlstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = curlstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(curlstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, curlstsymbolmap[i].name);
    }
    cnt = sizeof(curlsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, curlsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = curlsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = curlsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = curlsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(curlsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, curlsymbol2map[i].name);
    }
    cnt = sizeof(curldatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(curldatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, curldatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = curldatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, curldatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = curldatamap[i].sz;
        }
    }
    cnt = sizeof(curlmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, curlmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = curlmydatamap[i].sz;
    }
...
void wrappedcurl_fini(library_t* lib)
{
...
# 537 "/home/ssd/pico/code/box86/src/wrapped/wrappedcurl.c" 2
