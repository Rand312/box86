# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcompositedefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcompositesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1




{"XCompositeCreateRegionFromBorderClip", LFpL, 0},
{"XCompositeFindDisplay", pFp, 0},
{"XCompositeGetOverlayWindow", LFpL, 0},
{"XCompositeNameWindowPixmap", LFpL, 0},
{"XCompositeQueryExtension", iFppp, 0},
{"XCompositeQueryVersion", iFppp, 0},
{"XCompositeRedirectSubwindows", vFpLi, 0},
{"XCompositeRedirectWindow", vFpLi, 0},
{"XCompositeReleaseOverlayWindow", vFpL, 0},
{"XCompositeUnredirectSubwindows", vFpLi, 0},
{"XCompositeUnredirectWindow", vFpLi, 0},
{"XCompositeVersion", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcompositemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1
...
static const map_onesymbol_t libxcompositestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1
...
static const map_onesymbol2_t libxcompositesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1
...
static const map_onedata_t libxcompositedatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1
...
static const map_onedata_t libxcompositemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcompositeundefs.h" 1
...
int wrappedlibxcomposite_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxcompositeName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxcompositeName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxcompositesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcompositesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxcompositesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxcompositesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxcompositesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxcompositesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxcompositesymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcompositesymbolmap[i].name); }
 cnt = sizeof(libxcompositemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcompositemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxcompositemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxcompositemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxcompositemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxcompositemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxcompositemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcompositemysymbolmap[i].name); }

    cnt = sizeof(libxcompositestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxcompositestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxcompositestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxcompositestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxcompositestsymbolmap[i].name);
    }
    cnt = sizeof(libxcompositesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxcompositesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxcompositesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxcompositesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxcompositesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxcompositesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxcompositesymbol2map[i].name);
    }
    cnt = sizeof(libxcompositedatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxcompositedatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxcompositedatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxcompositedatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxcompositedatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxcompositedatamap[i].sz;
        }
    }
    cnt = sizeof(libxcompositemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxcompositemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxcompositemydatamap[i].sz;
    }
...
void wrappedlibxcomposite_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcomposite.c" 2
