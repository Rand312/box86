# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibformwdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libformwsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1





{"link_fieldtype", pFpp, 0},
{"free_fieldtype", iFp, 0},


{"new_field", pFiiiiii, 0},
{"dup_field", pFpii, 0},
{"link_field", pFpii, 0},
{"free_field", iFp, 0},
{"field_info", iFppppppp, 0},
{"dynamic_field_info", iFpppp, 0},
{"set_max_field", iFpi, 0},
{"move_field", iFpii, 0},

{"set_new_page", iFpi, 0},
{"set_field_just", iFpi, 0},
{"field_just", iFp, 0},
{"set_field_fore", iFpL, 0},
{"set_field_back", iFpL, 0},
{"set_field_pad", iFpi, 0},
{"field_pad", iFp, 0},
{"set_field_buffer", iFpip, 0},
{"set_field_status", iFpi, 0},
{"set_field_userptr", iFpp, 0},
{"set_field_opts", iFpi, 0},
{"field_opts_on", iFpi, 0},
{"field_opts_off", iFpi, 0},
{"field_fore", LFp, 0},
{"field_back", LFp, 0},
{"new_page", iFp, 0},
{"field_status", iFp, 0},
...
{"free_form", iFp, 0},
{"set_form_fields", iFpp, 0},
{"field_count", iFp, 0},
{"set_form_win", iFpp, 0},
{"set_form_sub", iFpp, 0},
{"set_current_field", iFpp, 0},
{"unfocus_current_field", iFp, 0},
{"field_index", iFp, 0},
{"set_form_page", iFpi, 0},
{"form_page", iFp, 0},
{"scale_form", iFppp, 0},
...
{"post_form", iFp, 0},
{"unpost_form", iFp, 0},
{"pos_form_cursor", iFp, 0},
{"form_driver", iFpi, 0},
{"form_driver_w", iFpiu, 0},
{"set_form_userptr", iFpp, 0},
{"set_form_opts", iFpi, 0},
{"form_opts_on", iFpi, 0},
{"form_opts_off", iFpi, 0},
{"form_request_by_name", iFp, 0},
{"form_request_name", pFi, 0},
{"form_userptr", pFp, 0},
{"form_opts", iFp, 0},
{"data_ahead", iFp, 0},
{"data_behind", iFp, 0},
...
static const map_onesymbol_t libformwmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1
...
static const map_onesymbol_t libformwstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1
...
static const map_onesymbol2_t libformwsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1
...
static const map_onedata_t libformwdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1
...
static const map_onedata_t libformwmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibformwundefs.h" 1
...
int wrappedlibformw_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libformwName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libformwsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libformwsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libformwsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libformwsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libformwsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libformwsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libformwsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libformwsymbolmap[i].name); }
 cnt = sizeof(libformwmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libformwmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libformwmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libformwmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libformwmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libformwmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libformwmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libformwmysymbolmap[i].name); }

    cnt = sizeof(libformwstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libformwstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libformwstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libformwstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libformwstsymbolmap[i].name);
    }
    cnt = sizeof(libformwsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libformwsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libformwsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libformwsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libformwsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libformwsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libformwsymbol2map[i].name);
    }
    cnt = sizeof(libformwdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libformwdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libformwdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libformwdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libformwdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libformwdatamap[i].sz;
        }
    }
    cnt = sizeof(libformwmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libformwmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libformwmydatamap[i].sz;
    }
...
void wrappedlibformw_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibformw.c" 2
