# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgthread2types.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgthread2types.h"
typedef void (*vFp_t)(void*);
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
...
typedef struct gthread2_my_s {
    ...
    vFp_t g_thread_init; vFp_t g_thread_init_with_errorcheck_mutexes;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static gthread2_my_t my_gthread2 = {0};
static gthread2_my_t * const my = &my_gthread2;

static void getMy(library_t* lib)
{

    my->g_thread_init = (vFp_t)dlsym(lib->w.lib, "g_thread_init"); my->g_thread_init_with_errorcheck_mutexes = (vFp_t)dlsym(lib->w.lib, "g_thread_init_with_errorcheck_mutexes");
...
# 30 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2

__attribute__((visibility("default"))) int g_threads_got_initialized;
...
typedef struct my_GThreadFunctions_s
{
  ...
  void* (*private_new) (void* destructor);
  void* (*private_get) (void *private_key);
  void (*private_set) (void *private_key, void* data);
  void (*thread_create) (void* func, void* data, unsigned long stack_size, int joinable, int bound, int priority, void* thread, void **error);
...
__attribute__((visibility("default"))) void my_g_thread_init(x86emu_t* emu, my_GThreadFunctions_t* vtable)
{
    (void)emu;
    ...
    if(!vtable)
        return my->g_thread_init(
# 68 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 3 4
                                ((void *)0)
# 68 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c"
                                    );

    do {if((1)<=box86_log) {fprintf(ftrace, "Warning, vtable not NULL in g_thread_init not supported yet!\n"); fflush(ftrace);}} while(0);
...
__attribute__((visibility("default"))) void my_g_thread_init_with_errorcheck_mutexes(x86emu_t* emu, my_GThreadFunctions_t* vtable)
{
    (void)emu;
    if(g_threads_got_initialized) {
    ...
    if(vtable)
        do {if((0)<=box86_log) {fprintf(ftrace, "Warning, vtable is not NULL in g_thread_init_with_errorcheck_mutexes call!\n"); fflush(ftrace);}} while(0);

    my->g_thread_init_with_errorcheck_mutexes(vtable);
...
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgthread2defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gthread2symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1
...
static const map_onesymbol_t gthread2mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1




{"g_thread_init", vFEp, 0},
{"g_thread_init_with_errorcheck_mutexes", vFEp, 0},
# 68 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gthread2stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1
...
static const map_onesymbol2_t gthread2symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1
...
static const map_onedata_t gthread2datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1
...
static const map_onedata_t gthread2mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgthread2undefs.h" 1
...
int wrappedgthread2_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gthread2Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gthread2symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gthread2symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gthread2symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gthread2symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gthread2symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gthread2symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gthread2symbolmap[i].name, '@')) AddDictionnary(box86->versym, gthread2symbolmap[i].name); }
 cnt = sizeof(gthread2mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gthread2mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gthread2mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gthread2mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gthread2mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gthread2mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gthread2mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gthread2mysymbolmap[i].name); }

    cnt = sizeof(gthread2stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gthread2stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gthread2stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gthread2stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gthread2stsymbolmap[i].name);
    }
    cnt = sizeof(gthread2symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gthread2symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gthread2symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gthread2symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gthread2symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gthread2symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gthread2symbol2map[i].name);
    }
    cnt = sizeof(gthread2datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gthread2datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gthread2datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gthread2datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gthread2datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gthread2datamap[i].sz;
        }
    }
    cnt = sizeof(gthread2mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gthread2mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gthread2mydatamap[i].sz;
    }
...
void wrappedgthread2_fini(library_t* lib)
{
...
# 114 "/home/ssd/pico/code/box86/src/wrapped/wrappedgthread2.c" 2
