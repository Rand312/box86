# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
...
int wrappedlibcairogobject_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libcairogobjectName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libcairogobjectName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libcairogobjectsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libcairogobjectsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libcairogobjectsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libcairogobjectsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libcairogobjectsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libcairogobjectsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libcairogobjectsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libcairogobjectsymbolmap[i].name); }
 cnt = sizeof(libcairogobjectmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libcairogobjectmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libcairogobjectmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libcairogobjectmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libcairogobjectmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libcairogobjectmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libcairogobjectmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libcairogobjectmysymbolmap[i].name); }

    cnt = sizeof(libcairogobjectstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libcairogobjectstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libcairogobjectstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libcairogobjectstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libcairogobjectstsymbolmap[i].name);
    }
    cnt = sizeof(libcairogobjectsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libcairogobjectsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libcairogobjectsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libcairogobjectsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libcairogobjectsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libcairogobjectsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libcairogobjectsymbol2map[i].name);
    }
    cnt = sizeof(libcairogobjectdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libcairogobjectdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libcairogobjectdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libcairogobjectdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libcairogobjectdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libcairogobjectdatamap[i].sz;
        }
    }
    cnt = sizeof(libcairogobjectmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libcairogobjectmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libcairogobjectmydatamap[i].sz;
    }
...
void wrappedlibcairogobject_fini(library_t* lib)
{
...
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibcairogobject.c" 2
