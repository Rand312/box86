# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenuglibtypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenuglibtypes.h"
typedef void (*vFppp_t)(void*, void*, void*);
typedef int32_t (*iFppp_t)(void*, void*, void*);
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
...
typedef struct dbusmenuglib_my_s {


    vFppp_t dbusmenu_menuitem_foreach; vFppp_t dbusmenu_menuitem_send_about_to_show; iFppp_t dbusmenu_client_add_type_handler;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static dbusmenuglib_my_t my_dbusmenuglib = {0};
static dbusmenuglib_my_t * const my = &my_dbusmenuglib;

static void getMy(library_t* lib)
{

    my->dbusmenu_menuitem_foreach = (vFppp_t)dlsym(lib->w.lib, "dbusmenu_menuitem_foreach"); my->dbusmenu_menuitem_send_about_to_show = (vFppp_t)dlsym(lib->w.lib, "dbusmenu_menuitem_send_about_to_show"); my->dbusmenu_client_add_type_handler = (iFppp_t)dlsym(lib->w.lib, "dbusmenu_client_add_type_handler");
...
# 29 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
# 43 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
static uintptr_t my_DbusmenuClientTypeHandler_fct_0 = 0; static int my_DbusmenuClientTypeHandler_0(void* a, void* b, void* c, void* d) { return RunFunctionFmt(my_DbusmenuClientTypeHandler_fct_0, "pppp", a, b, c, d);} static uintptr_t my_DbusmenuClientTypeHandler_fct_1 = 0; static int my_DbusmenuClientTypeHandler_1(void* a, void* b, void* c, void* d) { return RunFunctionFmt(my_DbusmenuClientTypeHandler_fct_1, "pppp", a, b, c, d);} static uintptr_t my_DbusmenuClientTypeHandler_fct_2 = 0; static int my_DbusmenuClientTypeHandler_2(void* a, void* b, void* c, void* d) { return RunFunctionFmt(my_DbusmenuClientTypeHandler_fct_2, "pppp", a, b, c, d);} static uintptr_t my_DbusmenuClientTypeHandler_fct_3 = 0; static int my_DbusmenuClientTypeHandler_3(void* a, void* b, void* c, void* d) { return RunFunctionFmt(my_DbusmenuClientTypeHandler_fct_3, "pppp", a, b, c, d);}
...
static void* findDbusmenuClientTypeHandlerFct(void* fct)
{
    ...
    if(my_DbusmenuClientTypeHandler_fct_0 == (uintptr_t)fct) return my_DbusmenuClientTypeHandler_0; if(my_DbusmenuClientTypeHandler_fct_1 == (uintptr_t)fct) return my_DbusmenuClientTypeHandler_1; if(my_DbusmenuClientTypeHandler_fct_2 == (uintptr_t)fct) return my_DbusmenuClientTypeHandler_2; if(my_DbusmenuClientTypeHandler_fct_3 == (uintptr_t)fct) return my_DbusmenuClientTypeHandler_3;


    if(my_DbusmenuClientTypeHandler_fct_0 == 0) {my_DbusmenuClientTypeHandler_fct_0 = (uintptr_t)fct; return my_DbusmenuClientTypeHandler_0; } if(my_DbusmenuClientTypeHandler_fct_1 == 0) {my_DbusmenuClientTypeHandler_fct_1 = (uintptr_t)fct; return my_DbusmenuClientTypeHandler_1; } if(my_DbusmenuClientTypeHandler_fct_2 == 0) {my_DbusmenuClientTypeHandler_fct_2 = (uintptr_t)fct; return my_DbusmenuClientTypeHandler_2; } if(my_DbusmenuClientTypeHandler_fct_3 == 0) {my_DbusmenuClientTypeHandler_fct_3 = (uintptr_t)fct; return my_DbusmenuClientTypeHandler_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbusmenuglib DbusmenuClientTypeHandler callback\n"); fflush(ftrace);}} while(0);
    return 
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 3 4
          ((void *)0)
# 56 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
              ;
}
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
static uintptr_t my_DbusmenuMenuitem_fct_0 = 0; static void my_DbusmenuMenuitem_0(void* a, void* b) { RunFunctionFmt(my_DbusmenuMenuitem_fct_0, "pp", a, b);} static uintptr_t my_DbusmenuMenuitem_fct_1 = 0; static void my_DbusmenuMenuitem_1(void* a, void* b) { RunFunctionFmt(my_DbusmenuMenuitem_fct_1, "pp", a, b);} static uintptr_t my_DbusmenuMenuitem_fct_2 = 0; static void my_DbusmenuMenuitem_2(void* a, void* b) { RunFunctionFmt(my_DbusmenuMenuitem_fct_2, "pp", a, b);} static uintptr_t my_DbusmenuMenuitem_fct_3 = 0; static void my_DbusmenuMenuitem_3(void* a, void* b) { RunFunctionFmt(my_DbusmenuMenuitem_fct_3, "pp", a, b);}
...
static void* findDbusmenuMenuitemFct(void* fct)
{
    ...
    if(my_DbusmenuMenuitem_fct_0 == (uintptr_t)fct) return my_DbusmenuMenuitem_0; if(my_DbusmenuMenuitem_fct_1 == (uintptr_t)fct) return my_DbusmenuMenuitem_1; if(my_DbusmenuMenuitem_fct_2 == (uintptr_t)fct) return my_DbusmenuMenuitem_2; if(my_DbusmenuMenuitem_fct_3 == (uintptr_t)fct) return my_DbusmenuMenuitem_3;


    if(my_DbusmenuMenuitem_fct_0 == 0) {my_DbusmenuMenuitem_fct_0 = (uintptr_t)fct; return my_DbusmenuMenuitem_0; } if(my_DbusmenuMenuitem_fct_1 == 0) {my_DbusmenuMenuitem_fct_1 = (uintptr_t)fct; return my_DbusmenuMenuitem_1; } if(my_DbusmenuMenuitem_fct_2 == 0) {my_DbusmenuMenuitem_fct_2 = (uintptr_t)fct; return my_DbusmenuMenuitem_2; } if(my_DbusmenuMenuitem_fct_3 == 0) {my_DbusmenuMenuitem_fct_3 = (uintptr_t)fct; return my_DbusmenuMenuitem_3; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for dbusmenuglib DbusmenuMenuitem callback\n"); fflush(ftrace);}} while(0);
    return 
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 3 4
          ((void *)0)
# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
              ;
}



__attribute__((visibility("default"))) int my_dbusmenu_client_add_type_handler(x86emu_t* emu, void* client, void* type, void* f)
{
    (void)emu;
    return my->dbusmenu_client_add_type_handler(client, type, findDbusmenuClientTypeHandlerFct(f));
}

__attribute__((visibility("default"))) void my_dbusmenu_menuitem_foreach(x86emu_t* emu, void* mi, void* f, void* data)
{
    (void)emu;
    my->dbusmenu_menuitem_foreach(mi, findDbusmenuMenuitemFct(f), data);
}

__attribute__((visibility("default"))) void my_dbusmenu_menuitem_send_about_to_show(x86emu_t* emu, void* mi, void* f, void* data)
{
    (void)emu;
    my->dbusmenu_menuitem_send_about_to_show(mi, findDbusmenuMenuitemFct(f), data);
}
# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenuglibdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusmenuglibsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1
...
{"dbusmenu_client_get_icon_paths", pFp, 0},
{"dbusmenu_client_get_root", pFp, 0},


{"dbusmenu_client_get_type", pFv, 0},
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h"
{"dbusmenu_menuitem_child_add_position", iFppu, 0},
{"dbusmenu_menuitem_child_append", iFpp, 0},
{"dbusmenu_menuitem_child_delete", iFpp, 0},
{"dbusmenu_menuitem_child_find", pFpi, 0},
{"dbusmenu_menuitem_child_prepend", iFpp, 0},
{"dbusmenu_menuitem_child_reorder", iFppu, 0},

{"dbusmenu_menuitem_find_id", pFpi, 0},

{"dbusmenu_menuitem_get_children", pFp, 0},
{"dbusmenu_menuitem_get_id", iFp, 0},
{"dbusmenu_menuitem_get_parent", pFp, 0},
{"dbusmenu_menuitem_get_position", uFpp, 0},
{"dbusmenu_menuitem_get_position_realized", uFpp, 0},
{"dbusmenu_menuitem_get_root", iFp, 0},
{"dbusmenu_menuitem_get_type", iFv, 0},
{"dbusmenu_menuitem_handle_event", vFppGu, 0},
{"dbusmenu_menuitem_new", pFv, 0},
{"dbusmenu_menuitem_new_with_id", pFi, 0},
{"dbusmenu_menuitem_properties_copy", pFp, 0},
{"dbusmenu_menuitem_properties_list", pFp, 0},

{"dbusmenu_menuitem_property_exist", iFpp, 0},
{"dbusmenu_menuitem_property_get", pFpp, 0},
{"dbusmenu_menuitem_property_get_bool", iFpp, 0},
{"dbusmenu_menuitem_property_get_byte_array", pFppp, 0},
{"dbusmenu_menuitem_property_get_int", iFpp, 0},
{"dbusmenu_menuitem_property_get_variant", pFpp, 0},

{"dbusmenu_menuitem_property_remove", vFpp, 0},
{"dbusmenu_menuitem_property_set", iFppp, 0},
{"dbusmenu_menuitem_property_set_bool", iFppi, 0},
{"dbusmenu_menuitem_property_set_byte_array", iFpppL, 0},
{"dbusmenu_menuitem_property_set_int", iFppi, 0},
{"dbusmenu_menuitem_property_set_variant", iFppp, 0},
{"dbusmenu_menuitem_proxy_get_type", iFv, 0},
...
{"dbusmenu_menuitem_set_root", vFpi, 0},
{"dbusmenu_menuitem_show_to_user", vFpu, 0},
{"dbusmenu_menuitem_take_children", pFp, 0},

{"dbusmenu_server_get_icon_paths", pFp, 0},
{"dbusmenu_server_get_status", iFp, 0},
{"dbusmenu_server_get_text_direction", iFp, 0},
{"dbusmenu_server_get_type", iFv, 0},
{"dbusmenu_server_new", pFp, 0},
{"dbusmenu_server_set_icon_paths", vFpp, 0},
{"dbusmenu_server_set_root", vFpp, 0},
{"dbusmenu_server_set_status", vFpi, 0},
{"dbusmenu_server_set_text_direction", vFpi, 0},

{"dbusmenu_status_get_type", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t dbusmenuglibmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1




{"dbusmenu_client_add_type_handler", iFEppp, 0},
...
{"dbusmenu_menuitem_foreach", vFEppp, 0},
...
{"dbusmenu_menuitem_send_about_to_show", vFEppp, 0},
...
static const map_onesymbol_t dbusmenuglibstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1
...
static const map_onesymbol2_t dbusmenuglibsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1
...
static const map_onedata_t dbusmenuglibdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1
...
static const map_onedata_t dbusmenuglibmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappeddbusmenuglibundefs.h" 1
...
int wrappeddbusmenuglib_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(dbusmenuglibName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(dbusmenuglibName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(dbusmenuglibsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusmenuglibsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, dbusmenuglibsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = dbusmenuglibsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, dbusmenuglibsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = dbusmenuglibsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(dbusmenuglibsymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusmenuglibsymbolmap[i].name); }
 cnt = sizeof(dbusmenuglibmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (dbusmenuglibmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, dbusmenuglibmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = dbusmenuglibmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, dbusmenuglibmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = dbusmenuglibmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(dbusmenuglibmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, dbusmenuglibmysymbolmap[i].name); }

    cnt = sizeof(dbusmenuglibstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, dbusmenuglibstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = dbusmenuglibstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(dbusmenuglibstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, dbusmenuglibstsymbolmap[i].name);
    }
    cnt = sizeof(dbusmenuglibsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, dbusmenuglibsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = dbusmenuglibsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = dbusmenuglibsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = dbusmenuglibsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(dbusmenuglibsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, dbusmenuglibsymbol2map[i].name);
    }
    cnt = sizeof(dbusmenuglibdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(dbusmenuglibdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, dbusmenuglibdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = dbusmenuglibdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, dbusmenuglibdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = dbusmenuglibdatamap[i].sz;
        }
    }
    cnt = sizeof(dbusmenuglibmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, dbusmenuglibmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = dbusmenuglibmydatamap[i].sz;
    }
...
void wrappeddbusmenuglib_fini(library_t* lib)
{
...
# 113 "/home/ssd/pico/code/box86/src/wrapped/wrappeddbusmenuglib.c" 2
