# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpcapdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pcapsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
{"pcap_activate", iFp, 0},
{"pcap_breakloop", vFp, 0},

{"pcap_can_set_rfmon", iFp, 0},
{"pcap_close", vFp, 0},
{"pcap_compile", iFpppiu, 0},

{"pcap_create", pFpp, 0},
{"pcap_datalink", iFp, 0},

{"pcap_datalink_name_to_val", iFp, 0},
{"pcap_datalink_val_to_description", pFi, 0},

{"pcap_datalink_val_to_name", pFi, 0},
# 38 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h"
{"pcap_findalldevs", iFpp, 0},
{"pcap_fopen_offline", pFpp, 0},
{"pcap_fopen_offline_with_tstamp_precision", pFpup, 0},
{"pcap_freealldevs", vFp, 0},
{"pcap_freecode", vFp, 0},
{"pcap_free_datalinks", vFp, 0},
{"pcap_free_tstamp_types", vFp, 0},
{"pcap_geterr", pFp, 0},
{"pcap_getnonblock", iFpp, 0},

{"pcap_get_selectable_fd", iFp, 0},
{"pcap_get_tstamp_precision", iFp, 0},



{"pcap_lib_version", pFv, 0},
{"pcap_list_datalinks", iFpp, 0},
{"pcap_list_tstamp_types", iFpp, 0},

{"pcap_lookupnet", iFpppp, 0},
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h"
{"pcap_next", pFpp, 0},

{"pcap_next_ex", iFppp, 0},
{"pcap_offline_filter", iFppp, 0},
{"pcap_open_dead", pFii, 0},

{"pcap_open_live", pFpiiip, 0},
{"pcap_open_offline", pFpp, 0},
{"pcap_open_offline_with_tstamp_precision", pFpup, 0},

{"pcap_sendpacket", iFppi, 0},
{"pcap_set_buffer_size", iFpi, 0},
{"pcap_set_datalink", iFpi, 0},
{"pcap_setdirection", iFpi, 0},
{"pcap_setfilter", iFpp, 0},
{"pcap_set_immediate_mode", iFpi, 0},
{"pcap_setnonblock", pFpip, 0},
{"pcap_set_promisc", iFpi, 0},

{"pcap_set_rfmon", iFpi, 0},
{"pcap_set_snaplen", iFpi, 0},
{"pcap_set_timeout", iFpi, 0},
{"pcap_set_tstamp_precision", iFpi, 0},
{"pcap_set_tstamp_type", iFpi, 0},
{"pcap_snapshot", iFp, 0},
{"pcap_stats", iFpp, 0},
{"pcap_statustostr", pFi, 0},

{"pcap_tstamp_type_name_to_val", iFp, 0},
{"pcap_tstamp_type_val_to_description", pFi, 0},
{"pcap_tstamp_type_val_to_name", pFi, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t pcapmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
static const map_onesymbol_t pcapstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
static const map_onesymbol2_t pcapsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
static const map_onedata_t pcapdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
static const map_onedata_t pcapmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedpcapundefs.h" 1
...
int wrappedpcap_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(pcapName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(pcapsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pcapsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, pcapsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = pcapsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, pcapsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = pcapsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(pcapsymbolmap[i].name, '@')) AddDictionnary(box86->versym, pcapsymbolmap[i].name); }
 cnt = sizeof(pcapmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (pcapmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, pcapmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = pcapmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, pcapmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = pcapmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(pcapmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, pcapmysymbolmap[i].name); }

    cnt = sizeof(pcapstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, pcapstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = pcapstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(pcapstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, pcapstsymbolmap[i].name);
    }
    cnt = sizeof(pcapsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, pcapsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = pcapsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = pcapsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = pcapsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(pcapsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, pcapsymbol2map[i].name);
    }
    cnt = sizeof(pcapdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(pcapdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, pcapdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = pcapdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, pcapdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = pcapdatamap[i].sz;
        }
    }
    cnt = sizeof(pcapmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, pcapmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = pcapmydatamap[i].sz;
    }
...
void wrappedpcap_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedpcap.c" 2
