# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxpresentdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxpresentsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1
...
{"XPresentFindDisplay", pFp, 0},
{"XPresentFreeInput", vFppp, 0},
{"XPresentNotifyMSC", vFppuUUU, 0},
{"XPresentPixmap", vFpppuppiipppuUUUpi, 0},
{"XPresentQueryCapabilities", uFpp, 0},
{"XPresentQueryExtension", iFpppp, 0},
{"XPresentQueryVersion", iFppp, 0},
{"XPresentSelectInput", pFppu, 0},
{"XPresentVersion", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxpresentmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1
...
static const map_onesymbol_t libxpresentstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1
...
static const map_onesymbol2_t libxpresentsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1
...
static const map_onedata_t libxpresentdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1




{"XPresentExtensionInfo", 3*sizeof(void*), 0},
{"XPresentExtensionName", sizeof(void*), 0},
...
static const map_onedata_t libxpresentmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxpresentundefs.h" 1
...
int wrappedlibxpresent_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxpresentName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxpresentName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxpresentsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxpresentsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxpresentsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxpresentsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxpresentsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxpresentsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxpresentsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxpresentsymbolmap[i].name); }
 cnt = sizeof(libxpresentmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxpresentmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxpresentmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxpresentmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxpresentmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxpresentmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxpresentmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxpresentmysymbolmap[i].name); }

    cnt = sizeof(libxpresentstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxpresentstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxpresentstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxpresentstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxpresentstsymbolmap[i].name);
    }
    cnt = sizeof(libxpresentsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxpresentsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxpresentsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxpresentsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxpresentsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxpresentsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxpresentsymbol2map[i].name);
    }
    cnt = sizeof(libxpresentdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxpresentdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxpresentdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxpresentdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxpresentdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxpresentdatamap[i].sz;
        }
    }
    cnt = sizeof(libxpresentmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxpresentmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxpresentmydatamap[i].sz;
    }
...
void wrappedlibxpresent_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxpresent.c" 2
