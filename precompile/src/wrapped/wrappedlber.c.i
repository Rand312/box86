# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlberdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t lbersymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
{"ber_bvarray_add", vFpp, 0},


{"ber_bvarray_free", vFp, 0},
...
{"ber_get_bitstringa", LFppp, 0},
{"ber_get_boolean", LFpp, 0},
{"ber_get_enum", iFpp, 0},
{"ber_get_int", iFpp, 0},
{"ber_get_next", LFppp, 0},
{"ber_get_null", LFp, 0},

{"ber_get_stringa", LFpp, 0},
{"ber_get_stringal", LFpp, 0},

{"ber_get_stringb", LFppp, 0},
{"ber_get_stringbv", LFppi, 0},


{"ber_init", pFp, 0},
{"ber_init2", vFppi, 0},
# 81 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h"
{"ber_next_element", LFppp, 0},

{"ber_peek_tag", LFpp, 0},
{"ber_printf", iFpppppppppppppppppppppppppppppppppp, 0},


{"ber_put_bitstring", iFppLL, 0},
{"ber_put_boolean", iFpiL, 0},
{"ber_put_enum", iFpiL, 0},
{"ber_put_int", iFpiL, 0},
{"ber_put_null", iFpL, 0},
{"ber_put_ostring", iFppLL, 0},
{"ber_put_seq", iFp, 0},
{"ber_put_set", iFp, 0},
{"ber_put_string", iFppL, 0},
# 112 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h"
{"ber_scanf", LFpppppppppppppppppp, 0},



{"ber_skip_tag", LFpp, 0},
# 128 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h"
{"ber_start_seq", iFpL, 0},
{"ber_start_set", iFpL, 0},
{"ber_str2bv", pFpLip, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t lbermysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
static const map_onesymbol_t lberstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
static const map_onesymbol2_t lbersymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
static const map_onedata_t lberdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
static const map_onedata_t lbermydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlberundefs.h" 1
...
int wrappedlber_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(lberName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(lbersymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (lbersymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, lbersymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = lbersymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, lbersymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = lbersymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(lbersymbolmap[i].name, '@')) AddDictionnary(box86->versym, lbersymbolmap[i].name); }
 cnt = sizeof(lbermysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (lbermysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, lbermysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = lbermysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, lbermysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = lbermysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(lbermysymbolmap[i].name, '@')) AddDictionnary(box86->versym, lbermysymbolmap[i].name); }

    cnt = sizeof(lberstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, lberstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = lberstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(lberstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, lberstsymbolmap[i].name);
    }
    cnt = sizeof(lbersymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, lbersymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = lbersymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = lbersymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = lbersymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(lbersymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, lbersymbol2map[i].name);
    }
    cnt = sizeof(lberdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(lberdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, lberdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = lberdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, lberdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = lberdatamap[i].sz;
        }
    }
    cnt = sizeof(lbermydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, lbermydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = lbermydatamap[i].sz;
    }
...
void wrappedlber_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlber.c" 2
