# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2




    const char* gstaudioName = "libgstaudio-1.0.so.0";
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstaudiodefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gstaudiosymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
{"gst_audio_format_build_integer", iFiiii, 0},
...
{"gst_audio_format_to_string", pFi, 0},



{"gst_audio_info_convert", iFpiIip, 0},
{"gst_audio_info_copy", pFp, 0},
{"gst_audio_info_free", vFp, 0},
{"gst_audio_info_from_caps", iFpp, 0},
{"gst_audio_info_get_type", pFv, 0},
{"gst_audio_info_init", vFp, 0},
{"gst_audio_info_is_equal", iFpp, 0},
{"gst_audio_info_new", pFv, 0},
{"gst_audio_info_set_format", vFpiiip, 0},
{"gst_audio_info_to_caps", pFp, 0},
{"gst_audio_layout_get_type", pFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gstaudiomysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
...
static const map_onesymbol_t gstaudiostsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
...
static const map_onesymbol2_t gstaudiosymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
...
static const map_onedata_t gstaudiodatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
...
static const map_onedata_t gstaudiomydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h" 1
# 148 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgstaudioundefs.h" 1
...
int wrappedgstaudio_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gstaudioName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gstaudiosymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstaudiosymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gstaudiosymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gstaudiosymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gstaudiosymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gstaudiosymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gstaudiosymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstaudiosymbolmap[i].name); }
 cnt = sizeof(gstaudiomysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstaudiomysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gstaudiomysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gstaudiomysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gstaudiomysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gstaudiomysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gstaudiomysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstaudiomysymbolmap[i].name); }

    cnt = sizeof(gstaudiostsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gstaudiostsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gstaudiostsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gstaudiostsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gstaudiostsymbolmap[i].name);
    }
    cnt = sizeof(gstaudiosymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gstaudiosymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gstaudiosymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gstaudiosymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gstaudiosymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gstaudiosymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gstaudiosymbol2map[i].name);
    }
    cnt = sizeof(gstaudiodatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gstaudiodatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gstaudiodatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gstaudiodatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gstaudiodatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gstaudiodatamap[i].sz;
        }
    }
    cnt = sizeof(gstaudiomydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gstaudiomydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gstaudiomydatamap[i].sz;
    }
...
void wrappedgstaudio_fini(library_t* lib)
{
...
# 28 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstaudio.c" 2
