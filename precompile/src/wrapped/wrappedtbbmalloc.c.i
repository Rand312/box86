# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedtbbmallocdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t tbbmallocsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1




{"scalable_aligned_free", vFp, 0},
{"scalable_aligned_malloc", pFLL, 0},
{"scalable_aligned_realloc", pFpLL, 0},
{"scalable_allocation_command", iFip, 0},
{"scalable_allocation_mode", iFil, 0},
{"scalable_calloc", pFLL, 0},
{"scalable_free", vFp, 0},
{"scalable_malloc", pFL, 0},
{"scalable_msize", LFp, 0},
{"scalable_posix_memalign", iFpLL, 0},
{"scalable_realloc", pFpL, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t tbbmallocmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1
...
static const map_onesymbol_t tbbmallocstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1
...
static const map_onesymbol2_t tbbmallocsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1
...
static const map_onedata_t tbbmallocdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1
...
static const map_onedata_t tbbmallocmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedtbbmallocundefs.h" 1
...
int wrappedtbbmalloc_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(tbbmallocName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(tbbmallocName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(tbbmallocsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (tbbmallocsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, tbbmallocsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = tbbmallocsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, tbbmallocsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = tbbmallocsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(tbbmallocsymbolmap[i].name, '@')) AddDictionnary(box86->versym, tbbmallocsymbolmap[i].name); }
 cnt = sizeof(tbbmallocmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (tbbmallocmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, tbbmallocmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = tbbmallocmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, tbbmallocmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = tbbmallocmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(tbbmallocmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, tbbmallocmysymbolmap[i].name); }

    cnt = sizeof(tbbmallocstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, tbbmallocstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = tbbmallocstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(tbbmallocstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, tbbmallocstsymbolmap[i].name);
    }
    cnt = sizeof(tbbmallocsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, tbbmallocsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = tbbmallocsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = tbbmallocsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = tbbmallocsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(tbbmallocsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, tbbmallocsymbol2map[i].name);
    }
    cnt = sizeof(tbbmallocdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(tbbmallocdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, tbbmallocdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = tbbmallocdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, tbbmallocdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = tbbmallocdatamap[i].sz;
        }
    }
    cnt = sizeof(tbbmallocmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, tbbmallocmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = tbbmallocmydatamap[i].sz;
    }
...
void wrappedtbbmalloc_fini(library_t* lib)
{
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedtbbmalloc.c" 2
