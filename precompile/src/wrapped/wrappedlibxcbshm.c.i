# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
...
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c"
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h" 1




typedef struct libxcbshm_my_s {


    XFpuuC_t xcb_shm_attach; XFpuuC_t xcb_shm_attach_checked; XFpuuC_t xcb_shm_attach_fd; XFpuuC_t xcb_shm_attach_fd_checked; XFpuuWWCuu_t xcb_shm_create_pixmap; XFpuuWWCuu_t xcb_shm_create_pixmap_checked; XFpuuC_t xcb_shm_create_segment; XFpuuC_t xcb_shm_create_segment_unchecked; XFpu_t xcb_shm_detach; XFpu_t xcb_shm_detach_checked; XFpuwwWWuCuu_t xcb_shm_get_image; XFpuwwWWuCuu_t xcb_shm_get_image_unchecked; XFpuuWWWWWWwwCCCuu_t xcb_shm_put_image; XFpuuWWWWWWwwCCCuu_t xcb_shm_put_image_checked; XFp_t xcb_shm_query_version; XFp_t xcb_shm_query_version_unchecked; YFY_t xcb_shm_seg_end;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libxcbshm_my_t my_libxcbshm = {0};
static libxcbshm_my_t * const my = &my_libxcbshm;

static void getMy(library_t* lib)
{

    my->xcb_shm_attach = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_attach"); my->xcb_shm_attach_checked = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_attach_checked"); my->xcb_shm_attach_fd = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_attach_fd"); my->xcb_shm_attach_fd_checked = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_attach_fd_checked"); my->xcb_shm_create_pixmap = (XFpuuWWCuu_t)dlsym(lib->w.lib, "xcb_shm_create_pixmap"); my->xcb_shm_create_pixmap_checked = (XFpuuWWCuu_t)dlsym(lib->w.lib, "xcb_shm_create_pixmap_checked"); my->xcb_shm_create_segment = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_create_segment"); my->xcb_shm_create_segment_unchecked = (XFpuuC_t)dlsym(lib->w.lib, "xcb_shm_create_segment_unchecked"); my->xcb_shm_detach = (XFpu_t)dlsym(lib->w.lib, "xcb_shm_detach"); my->xcb_shm_detach_checked = (XFpu_t)dlsym(lib->w.lib, "xcb_shm_detach_checked"); my->xcb_shm_get_image = (XFpuwwWWuCuu_t)dlsym(lib->w.lib, "xcb_shm_get_image"); my->xcb_shm_get_image_unchecked = (XFpuwwWWuCuu_t)dlsym(lib->w.lib, "xcb_shm_get_image_unchecked"); my->xcb_shm_put_image = (XFpuuWWWWWWwwCCCuu_t)dlsym(lib->w.lib, "xcb_shm_put_image"); my->xcb_shm_put_image_checked = (XFpuuWWWWWWwwCCCuu_t)dlsym(lib->w.lib, "xcb_shm_put_image_checked"); my->xcb_shm_query_version = (XFp_t)dlsym(lib->w.lib, "xcb_shm_query_version"); my->xcb_shm_query_version_unchecked = (XFp_t)dlsym(lib->w.lib, "xcb_shm_query_version_unchecked"); my->xcb_shm_seg_end = (YFY_t)dlsym(lib->w.lib, "xcb_shm_seg_end");
...
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
# 76 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c"
__attribute__((visibility("default"))) void* my_xcb_shm_attach (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t shmid, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_attach(c, seg, shmid, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_attach_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t shmid, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_attach_checked(c, seg, shmid, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_attach_fd (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t shm_fd, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_attach_fd(c, seg, shm_fd, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_attach_fd_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t shm_fd, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_attach_fd_checked(c, seg, shm_fd, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_create_pixmap (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t pid, uint32_t draw, uint16_t w, uint16_t h, uint8_t d, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_create_pixmap(c, pid, draw, w, h, d, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_create_pixmap_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t pid, uint32_t draw, uint16_t w, uint16_t h, uint8_t d, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_create_pixmap_checked(c, pid, draw, w, h, d, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_create_segment (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t size, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_create_segment(c, seg, size, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_create_segment_unchecked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg, uint32_t size, uint8_t read_only) { (void)emu; *ret = my->xcb_shm_create_segment_unchecked(c, seg, size, read_only); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_detach (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg) { (void)emu; *ret = my->xcb_shm_detach(c, seg); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_detach_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t seg) { (void)emu; *ret = my->xcb_shm_detach_checked(c, seg); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_get_image (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t draw, int16_t x, int16_t y, uint16_t w, uint16_t h, uint32_t plane, uint8_t f, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_get_image(c, draw, x, y, w, h, plane, f, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_get_image_unchecked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t draw, int16_t x, int16_t y, uint16_t w, uint16_t h, uint32_t plane, uint8_t f, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_get_image_unchecked(c, draw, x, y, w, h, plane, f, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_put_image (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t draw, uint32_t gc, uint16_t tw, uint16_t th, uint16_t sx, uint16_t sy, uint16_t w, uint16_t h, int16_t x, int16_t y, uint8_t d, uint8_t f, uint8_t ev, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_put_image(c, draw, gc, tw, th, sx, sy, w, h, x, y, d, f, ev, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_put_image_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t draw, uint32_t gc, uint16_t tw, uint16_t th, uint16_t sx, uint16_t sy, uint16_t w, uint16_t h, int16_t x, int16_t y, uint8_t d, uint8_t f, uint8_t ev, uint32_t seg, uint32_t offs) { (void)emu; *ret = my->xcb_shm_put_image_checked(c, draw, gc, tw, th, sx, sy, w, h, x, y, d, f, ev, seg, offs); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_query_version (x86emu_t* emu, my_xcb_cookie_t* ret, void* c) { (void)emu; *ret = my->xcb_shm_query_version(c); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_query_version_unchecked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c) { (void)emu; *ret = my->xcb_shm_query_version_unchecked(c); return ret; }
__attribute__((visibility("default"))) void* my_xcb_shm_seg_end (x86emu_t* emu, my_xcb_iterator_t* ret, my_xcb_iterator_t i) { (void)emu; *ret = my->xcb_shm_seg_end(i); return ret; }
# 103 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbshmdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcbshmsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
{"xcb_shm_create_segment_reply", pFpup, 0},
{"xcb_shm_create_segment_reply_fds", pFpp, 0},




{"xcb_shm_get_image_reply", pFpup, 0},





{"xcb_shm_query_version_reply", pFpup, 0},


{"xcb_shm_seg_next", vFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcbshmmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
static const map_onesymbol_t libxcbshmstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
{"xcb_shm_attach", pFEppuuC, 0},
{"xcb_shm_attach_checked", pFEppuuC, 0},
{"xcb_shm_attach_fd", pFEppuuC, 0},
{"xcb_shm_attach_fd_checked", pFEppuuC, 0},
{"xcb_shm_create_pixmap", pFEppuuWWCuu, 0},
{"xcb_shm_create_pixmap_checked", pFEppuuWWCuu, 0},
{"xcb_shm_create_segment", pFEppuuC, 0},


{"xcb_shm_create_segment_unchecked", pFEppuuC, 0},
{"xcb_shm_detach", pFEppu, 0},
{"xcb_shm_detach_checked", pFEppu, 0},
{"xcb_shm_get_image", pFEppuwwWWuCuu, 0},

{"xcb_shm_get_image_unchecked", pFEppuwwWWuCuu, 0},

{"xcb_shm_put_image", pFEppuuWWWWWWwwCCCuu, 0},
{"xcb_shm_put_image_checked", pFEppuuWWWWWWwwCCCuu, 0},
{"xcb_shm_query_version", pFEpp, 0},

{"xcb_shm_query_version_unchecked", pFEpp, 0},
{"xcb_shm_seg_end", pFEppii, 0},

# 79 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 88 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol2_t libxcbshmsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
static const map_onedata_t libxcbshmdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
static const map_onedata_t libxcbshmmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbshmundefs.h" 1
...
int wrappedlibxcbshm_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxcbshmName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxcbshmName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxcbshmsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbshmsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxcbshmsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxcbshmsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxcbshmsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxcbshmsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbshmsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbshmsymbolmap[i].name); }
 cnt = sizeof(libxcbshmmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbshmmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxcbshmmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxcbshmmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxcbshmmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxcbshmmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbshmmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbshmmysymbolmap[i].name); }

    cnt = sizeof(libxcbshmstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxcbshmstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxcbshmstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxcbshmstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxcbshmstsymbolmap[i].name);
    }
    cnt = sizeof(libxcbshmsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxcbshmsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxcbshmsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxcbshmsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxcbshmsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxcbshmsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxcbshmsymbol2map[i].name);
    }
    cnt = sizeof(libxcbshmdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxcbshmdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxcbshmdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxcbshmdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxcbshmdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxcbshmdatamap[i].sz;
        }
    }
    cnt = sizeof(libxcbshmmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxcbshmmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxcbshmmydatamap[i].sz;
    }
...
void wrappedlibxcbshm_fini(library_t* lib)
{
...
# 104 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbshm.c" 2
