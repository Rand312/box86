# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev0defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t udev0symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
{"udev_monitor_new_from_socket", pFpp, 0},
{"udev_queue_get_failed_list_entry", pFp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t udev0mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
static const map_onesymbol_t udev0stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
static const map_onesymbol2_t udev0symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
static const map_onedata_t udev0datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
static const map_onedata_t udev0mydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedudev0undefs.h" 1
...
int wrappedudev0_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(udev0Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(udev0symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (udev0symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, udev0symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = udev0symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, udev0symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = udev0symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(udev0symbolmap[i].name, '@')) AddDictionnary(box86->versym, udev0symbolmap[i].name); }
 cnt = sizeof(udev0mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (udev0mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, udev0mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = udev0mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, udev0mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = udev0mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(udev0mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, udev0mysymbolmap[i].name); }

    cnt = sizeof(udev0stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, udev0stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = udev0stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(udev0stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, udev0stsymbolmap[i].name);
    }
    cnt = sizeof(udev0symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, udev0symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = udev0symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = udev0symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = udev0symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(udev0symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, udev0symbol2map[i].name);
    }
    cnt = sizeof(udev0datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(udev0datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, udev0datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = udev0datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, udev0datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = udev0datamap[i].sz;
        }
    }
    cnt = sizeof(udev0mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, udev0mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = udev0mydatamap[i].sz;
    }
...
void wrappedudev0_fini(library_t* lib)
{
...
# 21 "/home/ssd/pico/code/box86/src/wrapped/wrappedudev0.c" 2
