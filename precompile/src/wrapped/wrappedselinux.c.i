# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedselinuxdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t selinuxsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h" 1
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
{"fgetfilecon", iFip, 0},
{"fgetfilecon_raw", iFip, 0},

{"freecon", vFp, 0},
{"freeconary", vFp, 0},
{"fsetfilecon", iFip, 0},
{"fsetfilecon_raw", iFip, 0},
{"getcon", iFp, 0},
{"getcon_raw", iFp, 0},
...
{"getpeercon", iFip, 0},
{"getpeercon_raw", iFip, 0},
{"getpidcon", iFpp, 0},
{"getpidcon_raw", iFpp, 0},
{"getprevcon", iFp, 0},
{"getprevcon_raw", iFp, 0},





{"is_selinux_enabled", iFv, 0},

{"lgetfilecon", iFpp, 0},
{"lgetfilecon_raw", iFpp, 0},
{"lsetfilecon", iFpp, 0},
{"lsetfilecon_raw", iFpp, 0},
# 220 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
{"setcon", iFp, 0},
{"setcon_raw", iFp, 0},
...
static const map_onesymbol_t selinuxstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h" 1
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
...
static const map_onesymbol2_t selinuxsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h" 1
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
...
static const map_onedata_t selinuxdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h" 1
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
...
static const map_onedata_t selinuxmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h" 1
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedselinuxundefs.h" 1
...
int wrappedselinux_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(selinuxName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(selinuxsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (selinuxsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, selinuxsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = selinuxsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, selinuxsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = selinuxsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(selinuxsymbolmap[i].name, '@')) AddDictionnary(box86->versym, selinuxsymbolmap[i].name); }
 cnt = sizeof(selinuxmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (selinuxmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, selinuxmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = selinuxmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, selinuxmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = selinuxmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(selinuxmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, selinuxmysymbolmap[i].name); }

    cnt = sizeof(selinuxstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, selinuxstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = selinuxstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(selinuxstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, selinuxstsymbolmap[i].name);
    }
    cnt = sizeof(selinuxsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, selinuxsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = selinuxsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = selinuxsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = selinuxsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(selinuxsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, selinuxsymbol2map[i].name);
    }
    cnt = sizeof(selinuxdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(selinuxdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, selinuxdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = selinuxdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, selinuxdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = selinuxdatamap[i].sz;
        }
    }
    cnt = sizeof(selinuxmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, selinuxmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = selinuxmydatamap[i].sz;
    }
...
void wrappedselinux_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedselinux.c" 2
