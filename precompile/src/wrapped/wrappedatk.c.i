# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedatkdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t atksymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1




{"atk_action_do_action", iFpi, 0},
{"atk_action_get_description", iFpip, 0},
{"atk_action_get_keybinding", pFpi, 0},
{"atk_action_get_localized_name", pFpi, 0},
{"atk_action_get_n_actions", iFp, 0},
{"atk_action_get_name", pFpi, 0},
{"atk_action_get_type", iFv, 0},
{"atk_action_set_description", pFpi, 0},





{"atk_component_contains", iFpiii, 0},
{"atk_component_get_alpha", dFp, 0},
{"atk_component_get_extents", vFpppppi, 0},
{"atk_component_get_layer", iFp, 0},
{"atk_component_get_mdi_zorder", iFp, 0},
{"atk_component_get_position", vFpppi, 0},
{"atk_component_get_size", vFppp, 0},
{"atk_component_get_type", iFv, 0},
{"atk_component_grab_focus", iFp, 0},
{"atk_component_ref_accessible_at_point", pFpiii, 0},
{"atk_component_remove_focus_handler", vFpu, 0},
{"atk_component_set_extents", iFpiiiii, 0},
{"atk_component_set_position", iFpiii, 0},
{"atk_component_set_size", iFpii, 0},
{"atk_coord_type_get_type", iFv, 0},
# 49 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h"
{"atk_focus_tracker_notify", vFp, 0},

{"atk_get_default_registry", pFv, 0},
# 80 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h"
{"atk_image_get_image_description", pFp, 0},
{"atk_image_get_image_locale", pFp, 0},
{"atk_image_get_image_position", vFpppi, 0},
{"atk_image_get_image_size", vFppp, 0},
{"atk_image_get_type", pFv, 0},
{"atk_image_set_image_description", iFpp, 0},
{"atk_implementor_get_type", iFv, 0},
{"atk_implementor_ref_accessible", pFp, 0},
# 102 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h"
{"atk_object_add_relationship", iFpip, 0},

{"atk_object_factory_create_accessible", pFpp, 0},
{"atk_object_factory_get_accessible_type", pFp, 0},
{"atk_object_factory_get_type", pFv, 0},
{"atk_object_factory_invalidate", vFp, 0},
{"atk_object_get_attributes", pFp, 0},
{"atk_object_get_description", pFp, 0},
{"atk_object_get_index_in_parent", iFp, 0},
{"atk_object_get_layer", iFp, 0},
{"atk_object_get_mdi_zorder", iFp, 0},
{"atk_object_get_n_accessible_children", iFp, 0},
{"atk_object_get_name", pFp, 0},
{"atk_object_get_object_locale", pFp, 0},
{"atk_object_get_parent", pFp, 0},
{"atk_object_get_role", iFp, 0},
{"atk_object_get_type", iFv, 0},
{"atk_object_initialize", vFpp, 0},
{"atk_object_notify_state_change", vFpii, 0},
{"atk_object_ref_accessible_child", pFpi, 0},
{"atk_object_ref_relation_set", pFp, 0},
{"atk_object_ref_state_set", pFp, 0},
{"atk_object_remove_property_change_handler", vFpu, 0},
{"atk_object_remove_relationship", iFpip, 0},
{"atk_object_set_description", vFpp, 0},
{"atk_object_set_name", vFpp, 0},
{"atk_object_set_parent", vFpp, 0},
{"atk_object_set_role", vFpi, 0},



{"atk_rectangle_get_type", pFv, 0},
{"atk_registry_get_factory", pFpi, 0},
{"atk_registry_get_factory_type", iFpi, 0},
{"atk_registry_get_type", pFv, 0},
{"atk_registry_set_factory_type", vFpii, 0},
{"atk_relation_add_target", vFpp, 0},
{"atk_relation_get_relation_type", iFp, 0},
{"atk_relation_get_target", pFp, 0},
{"atk_relation_get_type", pFv, 0},
{"atk_relation_new", pFpii, 0},
{"atk_relation_remove_target", iFpp, 0},
{"atk_relation_set_add", vFpp, 0},
{"atk_relation_set_add_relation_by_type", vFpip, 0},
{"atk_relation_set_contains", iFpi, 0},
{"atk_relation_set_contains_target", iFpip, 0},
{"atk_relation_set_get_n_relations", iFp, 0},
{"atk_relation_set_get_relation", pFpi, 0},
{"atk_relation_set_get_relation_by_type", pFpi, 0},
{"atk_relation_set_get_type", pFv, 0},
{"atk_relation_set_new", pFv, 0},
{"atk_relation_set_remove", vFpp, 0},
{"atk_relation_type_for_name", iFp, 0},
{"atk_relation_type_get_name", pFi, 0},

{"atk_relation_type_register", iFp, 0},
{"atk_remove_focus_tracker", vFu, 0},


{"atk_role_for_name", iFp, 0},
{"atk_role_get_localized_name", pFp, 0},
{"atk_role_get_name", pFp, 0},
{"atk_role_get_type", iFv, 0},
{"atk_role_register", iFp, 0},



{"atk_selection_get_type", pFv, 0},





{"atk_socket_get_type", pFv, 0},


{"atk_state_set_add_state", iFpi, 0},
{"atk_state_set_add_states", vFppi, 0},
{"atk_state_set_and_sets", pFpp, 0},
{"atk_state_set_clear_states", vFp, 0},
{"atk_state_set_contains_state", iFpi, 0},
{"atk_state_set_contains_states", iFppi, 0},
{"atk_state_set_get_type", pFv, 0},
{"atk_state_set_is_empty", iFp, 0},
{"atk_state_set_new", pFv, 0},
{"atk_state_set_or_sets", pFpp, 0},
{"atk_state_set_remove_state", iFpi, 0},
{"atk_state_set_xor_sets", pFpp, 0},
{"atk_state_type_for_name", iFp, 0},
# 253 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h"
{"atk_text_get_type", pFv, 0},




{"atk_util_get_type", iFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t atkmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1
...
static const map_onesymbol_t atkstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1
...
static const map_onesymbol2_t atksymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1
...
static const map_onedata_t atkdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1
...
static const map_onedata_t atkmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedatkundefs.h" 1
...
int wrappedatk_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(atkName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(atksymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (atksymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, atksymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = atksymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, atksymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = atksymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(atksymbolmap[i].name, '@')) AddDictionnary(box86->versym, atksymbolmap[i].name); }
 cnt = sizeof(atkmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (atkmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, atkmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = atkmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, atkmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = atkmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(atkmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, atkmysymbolmap[i].name); }

    cnt = sizeof(atkstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, atkstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = atkstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(atkstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, atkstsymbolmap[i].name);
    }
    cnt = sizeof(atksymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, atksymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = atksymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = atksymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = atksymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(atksymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, atksymbol2map[i].name);
    }
    cnt = sizeof(atkdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(atkdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, atkdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = atkdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, atkdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = atkdatamap[i].sz;
        }
    }
    cnt = sizeof(atkmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, atkmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = atkmydatamap[i].sz;
    }
...
void wrappedatk_fini(library_t* lib)
{
...
# 23 "/home/ssd/pico/code/box86/src/wrapped/wrappedatk.c" 2
