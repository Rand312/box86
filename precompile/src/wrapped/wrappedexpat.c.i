# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2

const char* expatName = "libexpat.so.1";


# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedexpattypes.h" 1
# 14 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedexpattypes.h"
typedef void (*vFpp_t)(void*, void*);
typedef void (*vFppp_t)(void*, void*, void*);
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
...
typedef struct expat_my_s {
    ...
    vFpp_t XML_SetCharacterDataHandler; vFppp_t XML_SetDoctypeDeclHandler; vFppp_t XML_SetElementHandler;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static expat_my_t my_expat = {0};
static expat_my_t * const my = &my_expat;

static void getMy(library_t* lib)
{

    my->XML_SetCharacterDataHandler = (vFpp_t)dlsym(lib->w.lib, "XML_SetCharacterDataHandler"); my->XML_SetDoctypeDeclHandler = (vFppp_t)dlsym(lib->w.lib, "XML_SetDoctypeDeclHandler"); my->XML_SetElementHandler = (vFppp_t)dlsym(lib->w.lib, "XML_SetElementHandler");
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
# 42 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
static uintptr_t my_Start_fct_0 = 0; static void* my_Start_0(void* data, void* name, void* attr) { return (void*)RunFunctionFmt(my_Start_fct_0, "ppp", data, name, attr);} static uintptr_t my_Start_fct_1 = 0; static void* my_Start_1(void* data, void* name, void* attr) { return (void*)RunFunctionFmt(my_Start_fct_1, "ppp", data, name, attr);} static uintptr_t my_Start_fct_2 = 0; static void* my_Start_2(void* data, void* name, void* attr) { return (void*)RunFunctionFmt(my_Start_fct_2, "ppp", data, name, attr);} static uintptr_t my_Start_fct_3 = 0; static void* my_Start_3(void* data, void* name, void* attr) { return (void*)RunFunctionFmt(my_Start_fct_3, "ppp", data, name, attr);} static uintptr_t my_Start_fct_4 = 0; static void* my_Start_4(void* data, void* name, void* attr) { return (void*)RunFunctionFmt(my_Start_fct_4, "ppp", data, name, attr);}
...
static void* find_Start_Fct(void* fct)
{
    ...
    if(my_Start_fct_0 == (uintptr_t)fct) return my_Start_0; if(my_Start_fct_1 == (uintptr_t)fct) return my_Start_1; if(my_Start_fct_2 == (uintptr_t)fct) return my_Start_2; if(my_Start_fct_3 == (uintptr_t)fct) return my_Start_3; if(my_Start_fct_4 == (uintptr_t)fct) return my_Start_4;


    if(my_Start_fct_0 == 0) {my_Start_fct_0 = (uintptr_t)fct; return my_Start_0; } if(my_Start_fct_1 == 0) {my_Start_fct_1 = (uintptr_t)fct; return my_Start_1; } if(my_Start_fct_2 == 0) {my_Start_fct_2 = (uintptr_t)fct; return my_Start_2; } if(my_Start_fct_3 == 0) {my_Start_fct_3 = (uintptr_t)fct; return my_Start_3; } if(my_Start_fct_4 == 0) {my_Start_fct_4 = (uintptr_t)fct; return my_Start_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for expat Start callback\n"); fflush(ftrace);}} while(0);
    return 
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 3 4
          ((void *)0)
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
              ;
}
...
static uintptr_t my_End_fct_0 = 0; static void my_End_0(void* data, void* name) { RunFunctionFmt(my_End_fct_0, "pp", data, name); } static uintptr_t my_End_fct_1 = 0; static void my_End_1(void* data, void* name) { RunFunctionFmt(my_End_fct_1, "pp", data, name); } static uintptr_t my_End_fct_2 = 0; static void my_End_2(void* data, void* name) { RunFunctionFmt(my_End_fct_2, "pp", data, name); } static uintptr_t my_End_fct_3 = 0; static void my_End_3(void* data, void* name) { RunFunctionFmt(my_End_fct_3, "pp", data, name); } static uintptr_t my_End_fct_4 = 0; static void my_End_4(void* data, void* name) { RunFunctionFmt(my_End_fct_4, "pp", data, name); }
...
static void* find_End_Fct(void* fct)
{
    ...
    if(my_End_fct_0 == (uintptr_t)fct) return my_End_0; if(my_End_fct_1 == (uintptr_t)fct) return my_End_1; if(my_End_fct_2 == (uintptr_t)fct) return my_End_2; if(my_End_fct_3 == (uintptr_t)fct) return my_End_3; if(my_End_fct_4 == (uintptr_t)fct) return my_End_4;


    if(my_End_fct_0 == 0) {my_End_fct_0 = (uintptr_t)fct; return my_End_0; } if(my_End_fct_1 == 0) {my_End_fct_1 = (uintptr_t)fct; return my_End_1; } if(my_End_fct_2 == 0) {my_End_fct_2 = (uintptr_t)fct; return my_End_2; } if(my_End_fct_3 == 0) {my_End_fct_3 = (uintptr_t)fct; return my_End_3; } if(my_End_fct_4 == 0) {my_End_fct_4 = (uintptr_t)fct; return my_End_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for expat End callback\n"); fflush(ftrace);}} while(0);
    return 
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 3 4
          ((void *)0)
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
              ;
}
...
static uintptr_t my_CharData_fct_0 = 0; static void my_CharData_0(void* data, void* s, int l) { RunFunctionFmt(my_CharData_fct_0, "ppi", data, s, l); } static uintptr_t my_CharData_fct_1 = 0; static void my_CharData_1(void* data, void* s, int l) { RunFunctionFmt(my_CharData_fct_1, "ppi", data, s, l); } static uintptr_t my_CharData_fct_2 = 0; static void my_CharData_2(void* data, void* s, int l) { RunFunctionFmt(my_CharData_fct_2, "ppi", data, s, l); } static uintptr_t my_CharData_fct_3 = 0; static void my_CharData_3(void* data, void* s, int l) { RunFunctionFmt(my_CharData_fct_3, "ppi", data, s, l); } static uintptr_t my_CharData_fct_4 = 0; static void my_CharData_4(void* data, void* s, int l) { RunFunctionFmt(my_CharData_fct_4, "ppi", data, s, l); }
...
static void* find_CharData_Fct(void* fct)
{
    ...
    if(my_CharData_fct_0 == (uintptr_t)fct) return my_CharData_0; if(my_CharData_fct_1 == (uintptr_t)fct) return my_CharData_1; if(my_CharData_fct_2 == (uintptr_t)fct) return my_CharData_2; if(my_CharData_fct_3 == (uintptr_t)fct) return my_CharData_3; if(my_CharData_fct_4 == (uintptr_t)fct) return my_CharData_4;


    if(my_CharData_fct_0 == 0) {my_CharData_fct_0 = (uintptr_t)fct; return my_CharData_0; } if(my_CharData_fct_1 == 0) {my_CharData_fct_1 = (uintptr_t)fct; return my_CharData_1; } if(my_CharData_fct_2 == 0) {my_CharData_fct_2 = (uintptr_t)fct; return my_CharData_2; } if(my_CharData_fct_3 == 0) {my_CharData_fct_3 = (uintptr_t)fct; return my_CharData_3; } if(my_CharData_fct_4 == 0) {my_CharData_fct_4 = (uintptr_t)fct; return my_CharData_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for expat CharData callback\n"); fflush(ftrace);}} while(0);
    return 
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 3 4
          ((void *)0)
# 99 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
              ;
}
...
static uintptr_t my_StartDoctypeDeclHandler_fct_0 = 0; static void* my_StartDoctypeDeclHandler_0(void* data, void* name, void* sysid, void* pubid, int has_internal_subset) { return (void*)RunFunctionFmt(my_StartDoctypeDeclHandler_fct_0, "ppppi", data, name, sysid, pubid, has_internal_subset);} static uintptr_t my_StartDoctypeDeclHandler_fct_1 = 0; static void* my_StartDoctypeDeclHandler_1(void* data, void* name, void* sysid, void* pubid, int has_internal_subset) { return (void*)RunFunctionFmt(my_StartDoctypeDeclHandler_fct_1, "ppppi", data, name, sysid, pubid, has_internal_subset);} static uintptr_t my_StartDoctypeDeclHandler_fct_2 = 0; static void* my_StartDoctypeDeclHandler_2(void* data, void* name, void* sysid, void* pubid, int has_internal_subset) { return (void*)RunFunctionFmt(my_StartDoctypeDeclHandler_fct_2, "ppppi", data, name, sysid, pubid, has_internal_subset);} static uintptr_t my_StartDoctypeDeclHandler_fct_3 = 0; static void* my_StartDoctypeDeclHandler_3(void* data, void* name, void* sysid, void* pubid, int has_internal_subset) { return (void*)RunFunctionFmt(my_StartDoctypeDeclHandler_fct_3, "ppppi", data, name, sysid, pubid, has_internal_subset);} static uintptr_t my_StartDoctypeDeclHandler_fct_4 = 0; static void* my_StartDoctypeDeclHandler_4(void* data, void* name, void* sysid, void* pubid, int has_internal_subset) { return (void*)RunFunctionFmt(my_StartDoctypeDeclHandler_fct_4, "ppppi", data, name, sysid, pubid, has_internal_subset);}
...
static void* find_StartDoctypeDeclHandler_Fct(void* fct)
{
    ...
    if(my_StartDoctypeDeclHandler_fct_0 == (uintptr_t)fct) return my_StartDoctypeDeclHandler_0; if(my_StartDoctypeDeclHandler_fct_1 == (uintptr_t)fct) return my_StartDoctypeDeclHandler_1; if(my_StartDoctypeDeclHandler_fct_2 == (uintptr_t)fct) return my_StartDoctypeDeclHandler_2; if(my_StartDoctypeDeclHandler_fct_3 == (uintptr_t)fct) return my_StartDoctypeDeclHandler_3; if(my_StartDoctypeDeclHandler_fct_4 == (uintptr_t)fct) return my_StartDoctypeDeclHandler_4;


    if(my_StartDoctypeDeclHandler_fct_0 == 0) {my_StartDoctypeDeclHandler_fct_0 = (uintptr_t)fct; return my_StartDoctypeDeclHandler_0; } if(my_StartDoctypeDeclHandler_fct_1 == 0) {my_StartDoctypeDeclHandler_fct_1 = (uintptr_t)fct; return my_StartDoctypeDeclHandler_1; } if(my_StartDoctypeDeclHandler_fct_2 == 0) {my_StartDoctypeDeclHandler_fct_2 = (uintptr_t)fct; return my_StartDoctypeDeclHandler_2; } if(my_StartDoctypeDeclHandler_fct_3 == 0) {my_StartDoctypeDeclHandler_fct_3 = (uintptr_t)fct; return my_StartDoctypeDeclHandler_3; } if(my_StartDoctypeDeclHandler_fct_4 == 0) {my_StartDoctypeDeclHandler_fct_4 = (uintptr_t)fct; return my_StartDoctypeDeclHandler_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for expat StartDoctypeDeclHandler callback\n"); fflush(ftrace);}} while(0);
    return 
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 3 4
          ((void *)0)
# 121 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
              ;
}
...
static uintptr_t my_EndDoctypeDeclHandler_fct_0 = 0; static void* my_EndDoctypeDeclHandler_0(void* data) { return (void*)RunFunctionFmt(my_EndDoctypeDeclHandler_fct_0, "p", data);} static uintptr_t my_EndDoctypeDeclHandler_fct_1 = 0; static void* my_EndDoctypeDeclHandler_1(void* data) { return (void*)RunFunctionFmt(my_EndDoctypeDeclHandler_fct_1, "p", data);} static uintptr_t my_EndDoctypeDeclHandler_fct_2 = 0; static void* my_EndDoctypeDeclHandler_2(void* data) { return (void*)RunFunctionFmt(my_EndDoctypeDeclHandler_fct_2, "p", data);} static uintptr_t my_EndDoctypeDeclHandler_fct_3 = 0; static void* my_EndDoctypeDeclHandler_3(void* data) { return (void*)RunFunctionFmt(my_EndDoctypeDeclHandler_fct_3, "p", data);} static uintptr_t my_EndDoctypeDeclHandler_fct_4 = 0; static void* my_EndDoctypeDeclHandler_4(void* data) { return (void*)RunFunctionFmt(my_EndDoctypeDeclHandler_fct_4, "p", data);}
...
static void* find_EndDoctypeDeclHandler_Fct(void* fct)
{
    ...
    if(my_EndDoctypeDeclHandler_fct_0 == (uintptr_t)fct) return my_EndDoctypeDeclHandler_0; if(my_EndDoctypeDeclHandler_fct_1 == (uintptr_t)fct) return my_EndDoctypeDeclHandler_1; if(my_EndDoctypeDeclHandler_fct_2 == (uintptr_t)fct) return my_EndDoctypeDeclHandler_2; if(my_EndDoctypeDeclHandler_fct_3 == (uintptr_t)fct) return my_EndDoctypeDeclHandler_3; if(my_EndDoctypeDeclHandler_fct_4 == (uintptr_t)fct) return my_EndDoctypeDeclHandler_4;


    if(my_EndDoctypeDeclHandler_fct_0 == 0) {my_EndDoctypeDeclHandler_fct_0 = (uintptr_t)fct; return my_EndDoctypeDeclHandler_0; } if(my_EndDoctypeDeclHandler_fct_1 == 0) {my_EndDoctypeDeclHandler_fct_1 = (uintptr_t)fct; return my_EndDoctypeDeclHandler_1; } if(my_EndDoctypeDeclHandler_fct_2 == 0) {my_EndDoctypeDeclHandler_fct_2 = (uintptr_t)fct; return my_EndDoctypeDeclHandler_2; } if(my_EndDoctypeDeclHandler_fct_3 == 0) {my_EndDoctypeDeclHandler_fct_3 = (uintptr_t)fct; return my_EndDoctypeDeclHandler_3; } if(my_EndDoctypeDeclHandler_fct_4 == 0) {my_EndDoctypeDeclHandler_fct_4 = (uintptr_t)fct; return my_EndDoctypeDeclHandler_4; }

    do {if((0)<=box86_log) {fprintf(ftrace, "Warning, no more slot for expat EndDoctypeDeclHandler callback\n"); fflush(ftrace);}} while(0);
    return 
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 3 4
          ((void *)0)
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c"
              ;
}


__attribute__((visibility("default"))) void my_XML_SetElementHandler(x86emu_t* emu, void* p, void* start, void* end)
{
    (void)emu;
    my->XML_SetElementHandler(p, find_Start_Fct(start), find_End_Fct(end));
}

__attribute__((visibility("default"))) void my_XML_SetDoctypeDeclHandler(x86emu_t* emu, void* p, void* start, void* end)
{
    (void)emu;
    my->XML_SetDoctypeDeclHandler(p, find_StartDoctypeDeclHandler_Fct(start), find_EndDoctypeDeclHandler_Fct(end));
}

__attribute__((visibility("default"))) void my_XML_SetCharacterDataHandler(x86emu_t* emu, void* p, void* h)
{
    (void)emu;
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedexpatdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t expatsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
{"XML_ErrorString", pFi, 0},





{"XML_GetBuffer", pFpi, 0},



{"XML_GetCurrentLineNumber", iFp, 0},
{"XML_GetErrorCode", iFp, 0},
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h"
{"XML_Parse", iFppii, 0},
{"XML_ParseBuffer", iFpii, 0},
{"XML_ParserCreate", pFp, 0},


{"XML_ParserFree", vFp, 0},
...
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h"
{"XML_SetUserData", vFpp, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t expatmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
{"XML_SetCharacterDataHandler", vFEpp, 0},



{"XML_SetDoctypeDeclHandler", vFEppp, 0},

{"XML_SetElementHandler", vFEppp, 0},
# 67 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h"

# 68 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 77 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t expatstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
static const map_onesymbol2_t expatsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
static const map_onedata_t expatdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
static const map_onedata_t expatmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedexpatundefs.h" 1
...
int wrappedexpat_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(expatName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(expatsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (expatsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, expatsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = expatsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, expatsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = expatsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(expatsymbolmap[i].name, '@')) AddDictionnary(box86->versym, expatsymbolmap[i].name); }
 cnt = sizeof(expatmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (expatmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, expatmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = expatmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, expatmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = expatmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(expatmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, expatmysymbolmap[i].name); }

    cnt = sizeof(expatstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, expatstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = expatstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(expatstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, expatstsymbolmap[i].name);
    }
    cnt = sizeof(expatsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, expatsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = expatsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = expatsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = expatsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(expatsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, expatsymbol2map[i].name);
    }
    cnt = sizeof(expatdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(expatdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, expatdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = expatdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, expatdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = expatdatamap[i].sz;
        }
    }
    cnt = sizeof(expatmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, expatmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = expatmydatamap[i].sz;
    }
...
void wrappedexpat_fini(library_t* lib)
{
...
# 172 "/home/ssd/pico/code/box86/src/wrapped/wrappedexpat.c" 2
