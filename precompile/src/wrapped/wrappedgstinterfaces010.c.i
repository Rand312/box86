# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2

const char* gstinterfaces010Name = "libgstinterfaces-0.10.so.0";
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c"
...
int wrappedgstinterfaces010_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(gstinterfaces010Name, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gstinterfaces010Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gstinterfaces010symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstinterfaces010symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gstinterfaces010symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gstinterfaces010symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gstinterfaces010symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gstinterfaces010symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gstinterfaces010symbolmap[i].name, '@')) AddDictionnary(box86->versym, gstinterfaces010symbolmap[i].name); }
 cnt = sizeof(gstinterfaces010mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gstinterfaces010mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gstinterfaces010mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gstinterfaces010mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gstinterfaces010mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gstinterfaces010mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gstinterfaces010mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gstinterfaces010mysymbolmap[i].name); }

    cnt = sizeof(gstinterfaces010stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gstinterfaces010stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gstinterfaces010stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gstinterfaces010stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gstinterfaces010stsymbolmap[i].name);
    }
    cnt = sizeof(gstinterfaces010symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gstinterfaces010symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gstinterfaces010symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gstinterfaces010symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gstinterfaces010symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gstinterfaces010symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gstinterfaces010symbol2map[i].name);
    }
    cnt = sizeof(gstinterfaces010datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gstinterfaces010datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gstinterfaces010datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gstinterfaces010datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gstinterfaces010datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gstinterfaces010datamap[i].sz;
        }
    }
    cnt = sizeof(gstinterfaces010mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gstinterfaces010mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gstinterfaces010mydatamap[i].sz;
    }

    lib->w.altmy = box_strdup("my010_"); setNeededLibs(lib, 1, "libgstreamer-0.10.so.0");


    return 0;
}

void wrappedgstinterfaces010_fini(library_t* lib)
{
...
# 27 "/home/ssd/pico/code/box86/src/wrapped/wrappedgstinterfaces010.c" 2
