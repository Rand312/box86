# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappediconvdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t iconvsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1




{"libiconv", uFppppp, 0},
{"libiconv_close", iFp, 0},
{"libiconv_open", pFpp, 0},
{"libiconv_open_into", iFppp, 0},
{"libiconv_set_relocation_prefix", vFpp, 0},
{"libiconvctl", iFpip, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t iconvmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1
...
static const map_onesymbol_t iconvstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1
...
static const map_onesymbol2_t iconvsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1
...
static const map_onedata_t iconvdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1
...
static const map_onedata_t iconvmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappediconvundefs.h" 1
...
int wrappediconv_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(iconvName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(iconvsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (iconvsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, iconvsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = iconvsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, iconvsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = iconvsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(iconvsymbolmap[i].name, '@')) AddDictionnary(box86->versym, iconvsymbolmap[i].name); }
 cnt = sizeof(iconvmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (iconvmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, iconvmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = iconvmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, iconvmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = iconvmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(iconvmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, iconvmysymbolmap[i].name); }

    cnt = sizeof(iconvstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, iconvstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = iconvstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(iconvstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, iconvstsymbolmap[i].name);
    }
    cnt = sizeof(iconvsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, iconvsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = iconvsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = iconvsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = iconvsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(iconvsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, iconvsymbol2map[i].name);
    }
    cnt = sizeof(iconvdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(iconvdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, iconvdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = iconvdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, iconvdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = iconvdatamap[i].sz;
        }
    }
    cnt = sizeof(iconvmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, iconvmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = iconvmydatamap[i].sz;
    }
...
void wrappediconv_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappediconv.c" 2
