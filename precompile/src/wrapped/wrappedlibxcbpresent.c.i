# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
...
# 44 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c"
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h" 1




typedef struct libxcbpresent_my_s {


    XFpuuUUU_t xcb_present_notify_msc; XFpuuuuuwwuuuuUUUup_t xcb_present_pixmap_checked; XFpuuuuuwwuuuuUUUup_t xcb_present_pixmap; XFpuu_t xcb_present_query_version; XFpuuu_t xcb_present_select_input_checked;
...
# 15 "/home/ssd/pico/code/box86/src/wrapped/wrappercallback.h"
                              ;
static libxcbpresent_my_t my_libxcbpresent = {0};
static libxcbpresent_my_t * const my = &my_libxcbpresent;

static void getMy(library_t* lib)
{

    my->xcb_present_notify_msc = (XFpuuUUU_t)dlsym(lib->w.lib, "xcb_present_notify_msc"); my->xcb_present_pixmap_checked = (XFpuuuuuwwuuuuUUUup_t)dlsym(lib->w.lib, "xcb_present_pixmap_checked"); my->xcb_present_pixmap = (XFpuuuuuwwuuuuUUUup_t)dlsym(lib->w.lib, "xcb_present_pixmap"); my->xcb_present_query_version = (XFpuu_t)dlsym(lib->w.lib, "xcb_present_query_version"); my->xcb_present_select_input_checked = (XFpuuu_t)dlsym(lib->w.lib, "xcb_present_select_input_checked");
...
# 45 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
# 54 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c"
__attribute__((visibility("default"))) void* my_xcb_present_notify_msc (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t win, uint32_t serial, uint64_t target, uint64_t divisor, uint64_t rem) { (void)emu; *ret = my->xcb_present_notify_msc(c, win, serial, target, divisor, rem); return ret; }
__attribute__((visibility("default"))) void* my_xcb_present_pixmap_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t win, uint32_t pix, uint32_t serial, uint32_t valid, uint32_t update, int16_t x_off, int16_t y_off, uint32_t target_crtc, uint32_t wait_fence, uint32_t idle_fence, uint32_t options, uint64_t target, uint64_t dividor, uint64_t rem, uint32_t len, void* notifies) { (void)emu; *ret = my->xcb_present_pixmap_checked(c, win, pix, serial, valid, update, x_off, y_off, target_crtc, wait_fence, idle_fence, options, target, dividor, rem, len, notifies); return ret; }
__attribute__((visibility("default"))) void* my_xcb_present_pixmap (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t win, uint32_t pix, uint32_t serial, uint32_t valid, uint32_t update, int16_t x_off, int16_t y_off, uint32_t target_crtc, uint32_t wait_fence, uint32_t idle_fence, uint32_t options, uint64_t target, uint64_t dividor, uint64_t rem, uint32_t len, void* notifies) { (void)emu; *ret = my->xcb_present_pixmap(c, win, pix, serial, valid, update, x_off, y_off, target_crtc, wait_fence, idle_fence, options, target, dividor, rem, len, notifies); return ret; }
__attribute__((visibility("default"))) void* my_xcb_present_query_version (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t major, uint32_t minor) { (void)emu; *ret = my->xcb_present_query_version(c, major, minor); return ret; }
__attribute__((visibility("default"))) void* my_xcb_present_select_input_checked (x86emu_t* emu, my_xcb_cookie_t* ret, void* c, uint32_t eid, uint32_t w, uint32_t mask) { (void)emu; *ret = my->xcb_present_select_input_checked(c, eid, w, mask); return ret; }
# 69 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbpresentdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxcbpresentsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h"
...
{"xcb_present_query_version_reply", pFpup, 0},
...
static const map_onesymbol_t libxcbpresentmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h"
...
static const map_onesymbol_t libxcbpresentstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h"


{"xcb_present_notify_msc", pFEppuuUUU, 0},


{"xcb_present_pixmap", pFEppuuuuuwwuuuuUUUup, 0},
{"xcb_present_pixmap_checked", pFEppuuuuuwwuuuuUUUup, 0},
...
{"xcb_present_query_version", pFEppuu, 0},
...
static const map_onedata_t libxcbpresentdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h"
{"xcb_present_id", 8, 0},
...
static const map_onedata_t libxcbpresentmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h" 1
# 9 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent_private.h"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxcbpresentundefs.h" 1
...
int wrappedlibxcbpresent_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxcbpresentName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxcbpresentName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxcbpresentsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbpresentsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxcbpresentsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxcbpresentsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxcbpresentsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxcbpresentsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbpresentsymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbpresentsymbolmap[i].name); }
 cnt = sizeof(libxcbpresentmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxcbpresentmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxcbpresentmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxcbpresentmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxcbpresentmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxcbpresentmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxcbpresentmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxcbpresentmysymbolmap[i].name); }

    cnt = sizeof(libxcbpresentstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxcbpresentstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxcbpresentstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxcbpresentstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxcbpresentstsymbolmap[i].name);
    }
    cnt = sizeof(libxcbpresentsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxcbpresentsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxcbpresentsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxcbpresentsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxcbpresentsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxcbpresentsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxcbpresentsymbol2map[i].name);
    }
    cnt = sizeof(libxcbpresentdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxcbpresentdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxcbpresentdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxcbpresentdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxcbpresentdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxcbpresentdatamap[i].sz;
        }
    }
    cnt = sizeof(libxcbpresentmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxcbpresentmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxcbpresentmydatamap[i].sz;
    }
...
void wrappedlibxcbpresent_fini(library_t* lib)
{
...
# 70 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxcbpresent.c" 2
