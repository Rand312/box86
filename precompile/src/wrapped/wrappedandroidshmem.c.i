# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedandroidshmemdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t androidshmemsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
static const map_onesymbol_t androidshmemmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
static const map_onesymbol_t androidshmemstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
static const map_onesymbol2_t androidshmemsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
static const map_onedata_t androidshmemdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
static const map_onedata_t androidshmemmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedandroidshmemundefs.h" 1
...
int wrappedandroidshmem_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(androidshmemName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(androidshmemName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(androidshmemsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (androidshmemsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, androidshmemsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = androidshmemsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, androidshmemsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = androidshmemsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(androidshmemsymbolmap[i].name, '@')) AddDictionnary(box86->versym, androidshmemsymbolmap[i].name); }
 cnt = sizeof(androidshmemmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (androidshmemmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, androidshmemmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = androidshmemmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, androidshmemmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = androidshmemmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(androidshmemmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, androidshmemmysymbolmap[i].name); }

    cnt = sizeof(androidshmemstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, androidshmemstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = androidshmemstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(androidshmemstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, androidshmemstsymbolmap[i].name);
    }
    cnt = sizeof(androidshmemsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, androidshmemsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = androidshmemsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = androidshmemsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = androidshmemsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(androidshmemsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, androidshmemsymbol2map[i].name);
    }
    cnt = sizeof(androidshmemdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(androidshmemdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, androidshmemdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = androidshmemdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, androidshmemdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = androidshmemdatamap[i].sz;
        }
    }
    cnt = sizeof(androidshmemmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, androidshmemmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = androidshmemmydatamap[i].sz;
    }
...
void wrappedandroidshmem_fini(library_t* lib)
{
...
# 18 "/home/ssd/pico/code/box86/src/wrapped/wrappedandroidshmem.c" 2
