# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c"
...
# 2 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairogobjectdefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t cairogobjectsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1




{"cairo_gobject_antialias_get_type", lFv, 0},
{"cairo_gobject_content_get_type", lFv, 0},
{"cairo_gobject_context_get_type", lFv, 0},
{"cairo_gobject_device_get_type", lFv, 0},
{"cairo_gobject_device_type_get_type", lFv, 0},
{"cairo_gobject_extend_get_type", lFv, 0},
{"cairo_gobject_fill_rule_get_type", lFv, 0},
{"cairo_gobject_filter_get_type", lFv, 0},
{"cairo_gobject_font_face_get_type", lFv, 0},
{"cairo_gobject_font_options_get_type", lFv, 0},
{"cairo_gobject_font_slant_get_type", lFv, 0},
{"cairo_gobject_font_type_get_type", lFv, 0},
{"cairo_gobject_font_weight_get_type", lFv, 0},
{"cairo_gobject_format_get_type", lFv, 0},
{"cairo_gobject_hint_metrics_get_type", lFv, 0},
{"cairo_gobject_hint_style_get_type", lFv, 0},
{"cairo_gobject_line_cap_get_type", lFv, 0},
{"cairo_gobject_line_join_get_type", lFv, 0},
{"cairo_gobject_matrix_get_type", lFv, 0},
{"cairo_gobject_operator_get_type", lFv, 0},
{"cairo_gobject_path_data_type_get_type", lFv, 0},
{"cairo_gobject_pattern_get_type", lFv, 0},
{"cairo_gobject_pattern_type_get_type", lFv, 0},
{"cairo_gobject_rectangle_get_type", lFv, 0},
{"cairo_gobject_rectangle_int_get_type", lFv, 0},
{"cairo_gobject_region_get_type", lFv, 0},
{"cairo_gobject_region_overlap_get_type", lFv, 0},
{"cairo_gobject_scaled_font_get_type", lFv, 0},
{"cairo_gobject_status_get_type", lFv, 0},
{"cairo_gobject_subpixel_order_get_type", lFv, 0},
{"cairo_gobject_surface_get_type", lFv, 0},
{"cairo_gobject_surface_type_get_type", lFv, 0},
{"cairo_gobject_text_cluster_flags_get_type", lFv, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t cairogobjectmysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1
...
static const map_onesymbol_t cairogobjectstsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1
...
static const map_onesymbol2_t cairogobjectsymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1
...
static const map_onedata_t cairogobjectdatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1
...
static const map_onedata_t cairogobjectmydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedcairogobjectundefs.h" 1
...
int wrappedcairogobject_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(cairogobjectName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(cairogobjectName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(cairogobjectsymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (cairogobjectsymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, cairogobjectsymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = cairogobjectsymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, cairogobjectsymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = cairogobjectsymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(cairogobjectsymbolmap[i].name, '@')) AddDictionnary(box86->versym, cairogobjectsymbolmap[i].name); }
 cnt = sizeof(cairogobjectmysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (cairogobjectmysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, cairogobjectmysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = cairogobjectmysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, cairogobjectmysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = cairogobjectmysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(cairogobjectmysymbolmap[i].name, '@')) AddDictionnary(box86->versym, cairogobjectmysymbolmap[i].name); }

    cnt = sizeof(cairogobjectstsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, cairogobjectstsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = cairogobjectstsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(cairogobjectstsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, cairogobjectstsymbolmap[i].name);
    }
    cnt = sizeof(cairogobjectsymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, cairogobjectsymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = cairogobjectsymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = cairogobjectsymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = cairogobjectsymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(cairogobjectsymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, cairogobjectsymbol2map[i].name);
    }
    cnt = sizeof(cairogobjectdatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(cairogobjectdatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, cairogobjectdatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = cairogobjectdatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, cairogobjectdatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = cairogobjectdatamap[i].sz;
        }
    }
    cnt = sizeof(cairogobjectmydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, cairogobjectmydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = cairogobjectmydatamap[i].sz;
    }
...
void wrappedcairogobject_fini(library_t* lib)
{
...
# 19 "/home/ssd/pico/code/box86/src/wrapped/wrappedcairogobject.c" 2
