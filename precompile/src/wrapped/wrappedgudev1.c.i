# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2

const char* gudev1Name = "libgudev-1.0.so.0";
# 25 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c"
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgudev1defs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gudev1symbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1_private.h" 1




{"g_udev_client_get_type", iFv, 0},
{"g_udev_client_new", pFp, 0},
{"g_udev_client_query_by_device_file", pFpp, 0},
{"g_udev_client_query_by_device_number", pFpiU, 0},
{"g_udev_client_query_by_subsystem", pFpp, 0},
{"g_udev_client_query_by_subsystem_and_name", pFppp, 0},
{"g_udev_client_query_by_sysfs_path", pFpp, 0},
{"g_udev_device_get_action", pFp, 0},
{"g_udev_device_get_device_file", pFp, 0},
{"g_udev_device_get_device_file_symlinks", pFp, 0},
{"g_udev_device_get_device_number", UFp, 0},
{"g_udev_device_get_device_type", iFp, 0},
{"g_udev_device_get_devtype", pFp, 0},
{"g_udev_device_get_driver", pFp, 0},
{"g_udev_device_get_name", pFp, 0},
{"g_udev_device_get_number", pFp, 0},
{"g_udev_device_get_parent", pFp, 0},
{"g_udev_device_get_parent_with_subsystem", pFp, 0},
{"g_udev_device_get_property", pFpp, 0},
{"g_udev_device_get_property_as_boolean", iFpp, 0},
{"g_udev_device_get_property_as_double", dFpp, 0},
{"g_udev_device_get_property_as_int", iFpp, 0},
{"g_udev_device_get_property_as_strv", pFpp, 0},
{"g_udev_device_get_property_as_uint64", UFpp, 0},
{"g_udev_device_get_property_keys", pFp, 0},
{"g_udev_device_get_seqnum", UFp, 0},
{"g_udev_device_get_subsystem", pFp, 0},
{"g_udev_device_get_sysfs_attr", pFpp, 0},
{"g_udev_device_get_sysfs_attr_as_boolean", iFpp, 0},
{"g_udev_device_get_sysfs_attr_as_double", dFpp, 0},
{"g_udev_device_get_sysfs_attr_as_int", iFpp, 0},
{"g_udev_device_get_sysfs_attr_as_strv", pFpp, 0},
{"g_udev_device_get_sysfs_attr_as_uint64", UFpp, 0},
{"g_udev_device_get_sysfs_path", pFp, 0},
{"g_udev_device_get_type", iFv, 0},
{"g_udev_device_has_property", iFpp, 0},
{"g_udev_device_type_get_type", iFv, 0},

# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t gudev1mysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1_private.h" 1
...
static const map_onesymbol_t gudev1stsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1_private.h" 1
...
static const map_onesymbol2_t gudev1symbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1_private.h" 1
...
static const map_onedata_t gudev1datamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedgudev1undefs.h" 1
...
int wrappedgudev1_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(gudev1Name);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(gudev1symbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gudev1symbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, gudev1symbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = gudev1symbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, gudev1symbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = gudev1symbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(gudev1symbolmap[i].name, '@')) AddDictionnary(box86->versym, gudev1symbolmap[i].name); }
 cnt = sizeof(gudev1mysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (gudev1mysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, gudev1mysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = gudev1mysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, gudev1mysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = gudev1mysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(gudev1mysymbolmap[i].name, '@')) AddDictionnary(box86->versym, gudev1mysymbolmap[i].name); }

    cnt = sizeof(gudev1stsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, gudev1stsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = gudev1stsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(gudev1stsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, gudev1stsymbolmap[i].name);
    }
    cnt = sizeof(gudev1symbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, gudev1symbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = gudev1symbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = gudev1symbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = gudev1symbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(gudev1symbol2map[i].name, '@'))
            AddDictionnary(box86->versym, gudev1symbol2map[i].name);
    }
    cnt = sizeof(gudev1datamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(gudev1datamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, gudev1datamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = gudev1datamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, gudev1datamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = gudev1datamap[i].sz;
        }
    }
    cnt = sizeof(gudev1mydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, gudev1mydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = gudev1mydatamap[i].sz;
    }
...
void wrappedgudev1_fini(library_t* lib)
{
...
# 26 "/home/ssd/pico/code/box86/src/wrapped/wrappedgudev1.c" 2
