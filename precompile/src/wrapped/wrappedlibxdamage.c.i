# 0 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c"
...
# 3 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxdamagedefs.h" 1
# 22 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
# 55 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxdamagesymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
{"XDamageAdd", vFpLL, 0},
{"XDamageCreate", LFpLi, 0},
{"XDamageDestroy", vFpL, 0},
{"XDamageFindDisplay", pFp, 0},
{"XDamageQueryExtension", iFppp, 0},
{"XDamageQueryVersion", iFppp, 0},
{"XDamageSubtract", vFpLLL, 0},
# 57 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h" 2
};
# 66 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
static const map_onesymbol_t libxdamagemysymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
static const map_onesymbol_t libxdamagestsymbolmap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
static const map_onesymbol2_t libxdamagesymbol2map[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
static const map_onedata_t libxdamagedatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
static const map_onedata_t libxdamagemydatamap[] = {
# 1 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage_private.h" 1
...
# 1 "/home/ssd/pico/code/box86/src/wrapped/generated/wrappedlibxdamageundefs.h" 1
...
int wrappedlibxdamage_init(library_t* lib, box86context_t* box86)
{
    (void)box86;
...
# 143 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
    ...
    {
        lib->w.lib = dlopen(libxdamageName, 
...
# 159 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
        ...
        } else lib->path = box_strdup(libxdamageName);
    }
...
# 188 "/home/ssd/pico/code/box86/src/wrapped/wrappedlib_init.h"
 cnt = sizeof(libxdamagesymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxdamagesymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wsymbolmap, libxdamagesymbolmap[i].name, &ret); ((lib->w.wsymbolmap)->vals[k]).w = libxdamagesymbolmap[i].w; ((lib->w.wsymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.symbolmap, libxdamagesymbolmap[i].name, &ret); ((lib->w.symbolmap)->vals[k]).w = libxdamagesymbolmap[i].w; ((lib->w.symbolmap)->vals[k]).resolved = 0; } if (strchr(libxdamagesymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxdamagesymbolmap[i].name); }
 cnt = sizeof(libxdamagemysymbolmap)/sizeof(map_onesymbol_t); for (int i = 0; i < cnt; ++i) { if (libxdamagemysymbolmap[i].weak) { k = kh_put_symbolmap(lib->w.wmysymbolmap, libxdamagemysymbolmap[i].name, &ret); ((lib->w.wmysymbolmap)->vals[k]).w = libxdamagemysymbolmap[i].w; ((lib->w.wmysymbolmap)->vals[k]).resolved = 0; } else { k = kh_put_symbolmap(lib->w.mysymbolmap, libxdamagemysymbolmap[i].name, &ret); ((lib->w.mysymbolmap)->vals[k]).w = libxdamagemysymbolmap[i].w; ((lib->w.mysymbolmap)->vals[k]).resolved = 0; } if (strchr(libxdamagemysymbolmap[i].name, '@')) AddDictionnary(box86->versym, libxdamagemysymbolmap[i].name); }

    cnt = sizeof(libxdamagestsymbolmap)/sizeof(map_onesymbol_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbolmap(lib->w.stsymbolmap, libxdamagestsymbolmap[i].name, &ret);
        ((lib->w.stsymbolmap)->vals[k]).w = libxdamagestsymbolmap[i].w;
        ((lib->w.stsymbolmap)->vals[k]).resolved = 0;
        if(strchr(libxdamagestsymbolmap[i].name, '@'))
            AddDictionnary(box86->versym, libxdamagestsymbolmap[i].name);
    }
    cnt = sizeof(libxdamagesymbol2map)/sizeof(map_onesymbol2_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_symbol2map(lib->w.symbol2map, libxdamagesymbol2map[i].name, &ret);
        ((lib->w.symbol2map)->vals[k]).name = libxdamagesymbol2map[i].name2;
        ((lib->w.symbol2map)->vals[k]).w = libxdamagesymbol2map[i].w;
        ((lib->w.symbol2map)->vals[k]).weak = libxdamagesymbol2map[i].weak;
        ((lib->w.symbol2map)->vals[k]).resolved = 0;
        if(strchr(libxdamagesymbol2map[i].name, '@'))
            AddDictionnary(box86->versym, libxdamagesymbol2map[i].name);
    }
    cnt = sizeof(libxdamagedatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        if(libxdamagedatamap[i].weak) {
            k = kh_put_datamap(lib->w.wdatamap, libxdamagedatamap[i].name, &ret);
            ((lib->w.wdatamap)->vals[k]) = libxdamagedatamap[i].sz;
        } else {
            k = kh_put_datamap(lib->w.datamap, libxdamagedatamap[i].name, &ret);
            ((lib->w.datamap)->vals[k]) = libxdamagedatamap[i].sz;
        }
    }
    cnt = sizeof(libxdamagemydatamap)/sizeof(map_onedata_t);
    for (int i=0; i<cnt; ++i) {
        k = kh_put_datamap(lib->w.mydatamap, libxdamagemydatamap[i].name, &ret);
        ((lib->w.mydatamap)->vals[k]) = libxdamagemydatamap[i].sz;
    }
...
void wrappedlibxdamage_fini(library_t* lib)
{
...
# 24 "/home/ssd/pico/code/box86/src/wrapped/wrappedlibxdamage.c" 2
