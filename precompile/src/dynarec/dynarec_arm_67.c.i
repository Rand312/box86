# 0 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c"
...
# 2 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
...
# 4 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
int GetTID();
# 13 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
# 1 "/home/ssd/pico/code/box86/src/dynarec/arm_printer.h" 1



const char* arm_print(uint32_t opcode);
# 21 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 23 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
...
# 24 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c" 2
                ...
                case 0xFF:
                    ...
                    switch((nextop>>3)&7) {
                        case 6:
                            ;
                            if(((nextop&0xC0)==0xC0)) {
                                --dyn->size; *ok = -1; if(box86_dynarec_log>=1 || box86_dynarec_dump || box86_dynarec_missing) { do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "%p: Dynarec stopped @ %s (%s:%u) because of Opcode %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", (void*)ip, __FUNCTION__, "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c", 127, *(uint8_t*)(ip+0), *(uint8_t*)(ip+1), *(uint8_t*)(ip+2), *(uint8_t*)(ip+3), *(uint8_t*)(ip+4), *(uint8_t*)(ip+5), *(uint8_t*)(ip+6), *(uint8_t*)(ip+7), *(uint8_t*)(ip+8), *(uint8_t*)(ip+9), *(uint8_t*)(ip+10),*(uint8_t*)(ip+11),*(uint8_t*)(ip+12), *(uint8_t*)(ip+13),*(uint8_t*)(ip+14)); fflush(ftrace);}} while(0); printFunctionAddr(ip, " => "); do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "\n"); fflush(ftrace);}} while(0); };
                            } else {
                                if((dyn->smread==0) && (box86_dynarec_strongmem>2)) {if(box86_dynarec_strongmem){;}else{;} dyn->smwrite=0; dyn->smread=1;} else dyn->smread=1;
                                addr = geted16_STEP(dyn, addr, ninst, nextop, &ed, 2, &fixedaddress, 0, 0);
                                ;
                            ...
                            break;
                        default:
                            --dyn->size; *ok = -1; if(box86_dynarec_log>=1 || box86_dynarec_dump || box86_dynarec_missing) { do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "%p: Dynarec stopped @ %s (%s:%u) because of Opcode %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", (void*)ip, __FUNCTION__, "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c", 136, *(uint8_t*)(ip+0), *(uint8_t*)(ip+1), *(uint8_t*)(ip+2), *(uint8_t*)(ip+3), *(uint8_t*)(ip+4), *(uint8_t*)(ip+5), *(uint8_t*)(ip+6), *(uint8_t*)(ip+7), *(uint8_t*)(ip+8), *(uint8_t*)(ip+9), *(uint8_t*)(ip+10),*(uint8_t*)(ip+11),*(uint8_t*)(ip+12), *(uint8_t*)(ip+13),*(uint8_t*)(ip+14)); fflush(ftrace);}} while(0); printFunctionAddr(ip, " => "); do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "\n"); fflush(ftrace);}} while(0); };
                    }
                    break;
                default:
                    --dyn->size; *ok = -1; if(box86_dynarec_log>=1 || box86_dynarec_dump || box86_dynarec_missing) { do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "%p: Dynarec stopped @ %s (%s:%u) because of Opcode %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", (void*)ip, __FUNCTION__, "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c", 140, *(uint8_t*)(ip+0), *(uint8_t*)(ip+1), *(uint8_t*)(ip+2), *(uint8_t*)(ip+3), *(uint8_t*)(ip+4), *(uint8_t*)(ip+5), *(uint8_t*)(ip+6), *(uint8_t*)(ip+7), *(uint8_t*)(ip+8), *(uint8_t*)(ip+9), *(uint8_t*)(ip+10),*(uint8_t*)(ip+11),*(uint8_t*)(ip+12), *(uint8_t*)(ip+13),*(uint8_t*)(ip+14)); fflush(ftrace);}} while(0); printFunctionAddr(ip, " => "); do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "\n"); fflush(ftrace);}} while(0); };
            }
            break;
# 166 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c"
        case 0xE0:
            ;
            dyn->insts[ninst].x86.use_flags = (1<<3); dyn->f.dfnone = 1; dyn->f.pending=1;
            i8 = *(int8_t*)(addr++);
            ;
            ;
            ;
            ...
            ;
            if(8!=8) {fpu_purgecacheSTEP(dyn, ninst, 0, 1, 2, 3); dyn->insts[ninst].x86.barrier = 8;} else dyn->insts[ninst].barrier_maybe = 1; add_jump(dyn, ninst); add_next(dyn, (uintptr_t)addr+i8); if(dyn->smwrite && box86_dynarec_strongmem) {if(box86_dynarec_strongmem){;}else{;}} dyn->smwrite=0; dyn->smread=0;; dyn->insts[ninst].x86.jmp = addr+i8; dyn->insts[ninst].x86.jmp_cond = 1; dyn->insts[ninst].x86.jmp_insts = 0; if(dyn->insts[ninst].x86.jmp_insts==-1 || 0) { i32 = dyn->insts[ninst].epilog-(dyn->arm_size+8); ; if(dyn->insts[ninst].x86.jmp_insts==-1) { if(!(dyn->insts[ninst].x86.barrier&2)) fpu_purgecacheSTEP(dyn, ninst, 1, 1, 2, 3); jump_to_next_STEP(dyn, addr+i8, 0, ninst); } else { CacheTransformSTEP(dyn, ninst, cacheupd, 1, 2, 3); i32 = dyn->insts[dyn->insts[ninst].x86.jmp_insts].address-(dyn->arm_size+8); ; } } else { i32 = dyn->insts[dyn->insts[ninst].x86.jmp_insts].address-(dyn->arm_size+8); ; };
            break;
        case 0xE1:
            ;
            dyn->insts[ninst].x86.use_flags = (1<<3); dyn->f.dfnone = 1; dyn->f.pending=1;
        ...
        default:
            --dyn->size; *ok = -1; if(box86_dynarec_log>=1 || box86_dynarec_dump || box86_dynarec_missing) { do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "%p: Dynarec stopped @ %s (%s:%u) because of Opcode %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", (void*)ip, __FUNCTION__, "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_67.c", 206, *(uint8_t*)(ip+0), *(uint8_t*)(ip+1), *(uint8_t*)(ip+2), *(uint8_t*)(ip+3), *(uint8_t*)(ip+4), *(uint8_t*)(ip+5), *(uint8_t*)(ip+6), *(uint8_t*)(ip+7), *(uint8_t*)(ip+8), *(uint8_t*)(ip+9), *(uint8_t*)(ip+10),*(uint8_t*)(ip+11),*(uint8_t*)(ip+12), *(uint8_t*)(ip+13),*(uint8_t*)(ip+14)); fflush(ftrace);}} while(0); printFunctionAddr(ip, " => "); do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "\n"); fflush(ftrace);}} while(0); };
    }
    return addr;
}
