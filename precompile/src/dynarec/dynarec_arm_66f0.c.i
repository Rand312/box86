# 0 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c"
...
# 2 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 3 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
# 1 "/usr/lib/gcc/x86_64-linux-gnu/11/include/stddef.h" 1 3 4
...
# 4 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
int GetTID();
# 13 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
# 1 "/home/ssd/pico/code/box86/src/dynarec/arm_printer.h" 1



const char* arm_print(uint32_t opcode);
# 21 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 23 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2
...
# 24 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 2


uintptr_t dynarec66F0STEP(dynarec_arm_t* dyn, uintptr_t addr, uintptr_t ip, int ninst, int* ok, int* need_epilog)
{
    uint8_t nextop, opcode = *(uint8_t*)(addr++);
            ...
            switch((nextop>>3)&7) {
                case 0:
                    ...
                    if(((nextop&0xC0)==0xC0)) {
                        ...
                        ed = 4 +(nextop&7);
                        emit_add16cSTEP(dyn, ninst, ed, i16, 3, 14);
                    } else {
                        addr = geted_STEP(dyn, addr, ninst, nextop, &wback, 2, &fixedaddress, 0, 0, 1, (int*)1);
                        if(opcode==0x81) i16 = *(int16_t*)(addr+=2, addr-2); else i16 = *(int8_t*)(addr++);
                        if(!fixedaddress) {
                            ;
                        ...
                        if(!fixedaddress || (fixedaddress && !(fixedaddress&1))) {
                            if(dyn->insts) {dyn->insts[ninst].marklock = (uintptr_t)dyn->arm_size;};
                            ;
                            emit_add16cSTEP(dyn, ninst, 1, i16, 3, 14);
                            ;
                            ;
                            j32 = ((dyn->insts)?dyn->insts[ninst].marklock:(dyn->arm_size+4))-(dyn->arm_size+8); ;
...
# 103 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 3 4
                       ((void *)0)
# 103 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c"
                       ); ; ed = 1; wb1 = 1; };
                        emit_inc16STEP(dyn, ninst, ed, 3, 14);
                        if(wb1) {; dyn->smwrite=1;} else {;}(1);
                    } else {
                        addr = geted_STEP(dyn, addr, ninst, nextop, &wback, 2, &fixedaddress, 0, 0, 1, (int*)1);
                        if(!fixedaddress) {
                            ;
                ...
                case 1:
                    ...
                    if(((nextop&0xC0)==0xC0)) {
                        if((nextop&0xC0)==0xC0) { wback = 4 +(nextop&7); ; ed = 1; wb1 = 0; } else { if((dyn->smread==0) && (box86_dynarec_strongmem>2)) {if(box86_dynarec_strongmem){;}else{;} dyn->smwrite=0; dyn->smread=1;} else dyn->smread=1; addr = geted_STEP(dyn, addr, ninst, nextop, &wback, 3, &fixedaddress, 255, 0, 0, 
# 142 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c" 3 4
                       ((void *)0)
# 142 "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c"
                       ); ; ed = 1; wb1 = 1; };
                        emit_dec32STEP(dyn, ninst, ed, 3, 14);
                        if(wb1) {; dyn->smwrite=1;} else {;}(1);
                    } else {
                        addr = geted_STEP(dyn, addr, ninst, nextop, &wback, 2, &fixedaddress, 0, 0, 1, (int*)1);
                        if(!fixedaddress) {
            ...
            break;
        default:
            --dyn->size; *ok = -1; if(box86_dynarec_log>=1 || box86_dynarec_dump || box86_dynarec_missing) { do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "%p: Dynarec stopped @ %s (%s:%u) because of Opcode %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X", (void*)ip, __FUNCTION__, "/home/ssd/pico/code/box86/src/dynarec/dynarec_arm_66f0.c", 184, *(uint8_t*)(ip+0), *(uint8_t*)(ip+1), *(uint8_t*)(ip+2), *(uint8_t*)(ip+3), *(uint8_t*)(ip+4), *(uint8_t*)(ip+5), *(uint8_t*)(ip+6), *(uint8_t*)(ip+7), *(uint8_t*)(ip+8), *(uint8_t*)(ip+9), *(uint8_t*)(ip+10),*(uint8_t*)(ip+11),*(uint8_t*)(ip+12), *(uint8_t*)(ip+13),*(uint8_t*)(ip+14)); fflush(ftrace);}} while(0); printFunctionAddr(ip, " => "); do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "\n"); fflush(ftrace);}} while(0); };
    }
