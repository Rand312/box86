# 0 "/home/ssd/pico/code/box86/src/custommem.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/custommem.c"
...
# 3 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 8 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/include/box86context.h" 2
...
# 10 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/custommem.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/myfts.h" 1
...
# 20 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 21 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 23 "/home/ssd/pico/code/box86/src/custommem.c" 2
...
# 24 "/home/ssd/pico/code/box86/src/custommem.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/custommem.h" 1
# 25 "/home/ssd/pico/code/box86/src/custommem.c" 2

# 1 "/home/ssd/pico/code/box86/src/include/rbtree.h" 1
...
# 6 "/home/ssd/pico/code/box86/src/include/rbtree.h"
...
# 27 "/home/ssd/pico/code/box86/src/custommem.c" 2
# 52 "/home/ssd/pico/code/box86/src/custommem.c"
...
rbtree* memprot = 
# 58 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                 ((void *)0)
# 58 "/home/ssd/pico/code/box86/src/custommem.c"
                     ;
static int inited = 0;

static rbtree* mapallmem = 
# 61 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                           ((void *)0)
# 61 "/home/ssd/pico/code/box86/src/custommem.c"
                               ;
static rbtree* mmapmem = 
# 62 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                         ((void *)0)
# 62 "/home/ssd/pico/code/box86/src/custommem.c"
                             ;
...
static blocklist_t* p_blocks = 
# 76 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                     ((void *)0)
# 76 "/home/ssd/pico/code/box86/src/custommem.c"
                                         ;
...
{
    do {if((0)<=box86_log) {fprintf(ftrace, "========== Block is:\n"); fflush(ftrace);}} while(0);
    do {
        do {if((0)<=box86_log) {fprintf(ftrace, "%c%p, fill=%d, size=0x%x (prev=%d/0x%x)\n", b==start?'*':' ', b, b->next.fill, b->next.size, b->prev.fill, b->prev.size); fflush(ftrace);}} while(0);
        b = (blockmark_t*)((uintptr_t)(b) + (b)->next.size + sizeof(blockmark_t));
    } while(b->next.x32);
    do {if((0)<=box86_log) {fprintf(ftrace, "===================\n"); fflush(ftrace);}} while(0);
}
...
static void* getFirstBlock(void* block, size_t maxsize, size_t* size, void* start)
{
    ...
    while(m->next.x32) {
        ...
        m = (blockmark_t*)((uintptr_t)(m) + (m)->next.size + sizeof(blockmark_t));
    }

    return 
# 117 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
          ((void *)0)
# 117 "/home/ssd/pico/code/box86/src/custommem.c"
              ;
}
...
static void* getPrevFreeBlock(void* block)
{
    blockmark_t *m = (blockmark_t*)block;
    do {
         m = (blockmark_t*)(((uintptr_t)(m) - (m)->prev.size) - sizeof(blockmark_t));
    } while (m->next.fill);
    return m;
}
...
static size_t getMaxFreeBlock(void* block, size_t block_size, void* start)
{
    ...
    if(start) {
        ...
        blockmark_t *m = (blockmark_t*)(((uintptr_t)(block)+(block_size))-sizeof(blockmark_t));
        int maxsize = 0;
        while(m->prev.x32) {
...
static void* allocBlock(void* block, void *sub, size_t size, void** pstart)
{
    ...
    blockmark_t *n = (blockmark_t*)((uintptr_t)(s) + (s)->next.size + sizeof(blockmark_t));

    s->next.fill = 1;

    if(s->next.size>size+2*sizeof(blockmark_t)+(128-2*sizeof(blockmark_t))) {
        size_t old_size = s->next.size;
        s->next.size = size;
        blockmark_t *m = (blockmark_t*)((uintptr_t)(s) + (s)->next.size + sizeof(blockmark_t));
        m->prev.fill = 1;
    ...
    if(pstart && sub==*pstart) {
        ...
        while(n->next.fill)
            n = (blockmark_t*)((uintptr_t)(n) + (n)->next.size + sizeof(blockmark_t));
        *pstart = (void*)n;
    }
...
static size_t freeBlock(void *block, void* sub, void** pstart)
{
    ...
    blockmark_t *n = (blockmark_t*)((uintptr_t)(s) + (s)->next.size + sizeof(blockmark_t));
    if(block!=sub)
        m = (blockmark_t*)(((uintptr_t)(s) - (s)->prev.size) - sizeof(blockmark_t));
    s->next.fill = 0;
    n->prev.fill = 0;
    ...
    if(n->next.x32 && !n->next.fill) {
        blockmark_t *n2 = (blockmark_t*)((uintptr_t)(n) + (n)->next.size + sizeof(blockmark_t));
...
static int expandBlock(void* block, void* sub, size_t newsize)
{
    ...
    if((s->next.size+n->next.size+sizeof(blockmark_t))-newsize<(128-2*sizeof(blockmark_t))+2*sizeof(blockmark_t))
        s->next.size += n->next.size+sizeof(blockmark_t);
    else
...
{
    if(i<0 || i>=n_blocks) {
        do {if((0)<=box86_log) {fprintf(ftrace, "Error, %d should be between 0 and %d\n", i, n_blocks); fflush(ftrace);}} while(0);
        return 0;
    }
    int ret = 1;
    ...
    if(p_blocks[i].first && p_blocks[i].first!=first) {do {if((0)<=box86_log) {fprintf(ftrace, "First %p and stored first %p differs for block %d\n", first, p_blocks[i].first, i); fflush(ftrace);}} while(0); ret = 0;}

    size_t maxfree = getMaxFreeBlock(m, p_blocks[i].size, 
# 283 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                                         ((void *)0)
# 283 "/home/ssd/pico/code/box86/src/custommem.c"
                                                             );
    if(maxfree != p_blocks[i].maxfree) {do {if((0)<=box86_log) {fprintf(ftrace, "Maxfree without hint %zd and stored maxfree %zd differs for block %d\n", maxfree, p_blocks[i].maxfree, i); fflush(ftrace);}} while(0); ret = 0;}

    maxfree = getMaxFreeBlock(m, p_blocks[i].size, p_blocks[i].first);
    if(maxfree != p_blocks[i].maxfree) {do {if((0)<=box86_log) {fprintf(ftrace, "Maxfree with hint %zd and stored maxfree %zd differs for block %d\n", maxfree, p_blocks[i].maxfree, i); fflush(ftrace);}} while(0); ret = 0;}

    blockmark_t* last = (blockmark_t*)(((uintptr_t)m)+p_blocks[i].size-sizeof(blockmark_t));
    while(m<last) {
        blockmark_t* n = (blockmark_t*)((uintptr_t)(m) + (m)->next.size + sizeof(blockmark_t));
        if(!m->next.fill && !n->next.fill && n!=last) {
            do {if((0)<=box86_log) {fprintf(ftrace, "Chain contains 2 subsequent free blocks %p (%d) and %p (%d) for block %d\n", m, m->next.size, n, n->next.size, i); fflush(ftrace);}} while(0);
            ret = 0;
        }
        m = n;
    }
    if(m!=last) {
        do {if((0)<=box86_log) {fprintf(ftrace, "Last block %p is behond expexted block %p for block %d\n", m, last, i); fflush(ftrace);}} while(0);
        ret = 0;
    }
...
void testAllBlocks()
{
    ...
    do {if((0)<=box86_log) {fprintf(ftrace, "Total %d blocks, for %zd allocated memory, max_free %zd, toatal fragmented free %zd\n", n_blocks, total, max_free, fragmented_free); fflush(ftrace);}} while(0);
}
...
static size_t roundSize(size_t size)
{
    ...
    if(size<(128-2*sizeof(blockmark_t)))
        size = (128-2*sizeof(blockmark_t));
...
void* customMalloc(size_t size)
{
    ...
    void* sub = 
# 345 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
               ((void *)0)
# 345 "/home/ssd/pico/code/box86/src/custommem.c"
                   ;
    ...
    for(int i=0; i<n_blocks; ++i) {
        if(p_blocks[i].maxfree>=size) {
            ...
            if(sub) {
                if(rsize-size<(128-2*sizeof(blockmark_t)))
                    size = rsize;
    ...
    if(n_blocks>c_blocks) {
        c_blocks += 4;
        p_blocks = (blocklist_t*)__libc_realloc(p_blocks, c_blocks*sizeof(blocklist_t));
    }
    size_t allocsize = (fullsize>(64*1024))?fullsize:(64*1024);




    void* p = __libc_calloc(1, allocsize);
    ...
    pthread_mutex_unlock(&mutex_blocks);
    if(mapallmem)
        setProtection((uintptr_t)p, allocsize, 
# 396 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                              0x1 
# 396 "/home/ssd/pico/code/box86/src/custommem.c"
                                                        | 
# 396 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                                          0x2
# 396 "/home/ssd/pico/code/box86/src/custommem.c"
...
void* customRealloc(void* p, size_t size)
{
    ...
    pthread_mutex_unlock(&mutex_blocks);
    if(n_blocks)
        do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "Warning, block %p not found in p_blocks for realloc, malloc'ing again without free\n", (void*)addr); fflush(ftrace);}} while(0);
    return customMalloc(size);
}
void customFree(void* p)
{
    ...
    pthread_mutex_unlock(&mutex_blocks);
    if(n_blocks)
        do {if((0)<=box86_dynarec_log) {fprintf(ftrace, "Warning, block %p not found in p_blocks for Free\n", (void*)addr); fflush(ftrace);}} while(0);
}
# 906 "/home/ssd/pico/code/box86/src/custommem.c"
void updateProtection(uintptr_t addr, uintptr_t size, uint32_t prot)
{
    ...
    uintptr_t end = (((cur+size)+box86_pagesize-1)&~(box86_pagesize-1));
    ...
    while (cur < end) {
        ...
        uint32_t dyn=(oprot&(0x80 | 0x40 | 0x20 | 0x100));
        if(!(dyn&(0x20 | 0x100))) {
            if(dyn && (prot&
# 920 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                           0x2
# 920 "/home/ssd/pico/code/box86/src/custommem.c"
                                     )) {
                dyn = 0x80;
                mprotect((void*)cur, bend-cur, prot&~
# 922 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                                    0x2
# 922 "/home/ssd/pico/code/box86/src/custommem.c"
                                                              );
            } else if(dyn && !(prot&
# 923 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                   0x2
# 923 "/home/ssd/pico/code/box86/src/custommem.c"
                                             )) {
                dyn = 0x40;
            }
        }
...
void setProtection(uintptr_t addr, uintptr_t size, uint32_t prot)
{
    ...
    size = (((size)+box86_pagesize-1)&~(box86_pagesize-1));
    pthread_mutex_lock(&mutex_prot);
    uintptr_t cur = addr & ~(box86_pagesize-1);
    uintptr_t end = (((cur+size)+box86_pagesize-1)&~(box86_pagesize-1));
...
void refreshProtection(uintptr_t addr)
{
    ...
    if (rb_get_end(memprot, addr, &prot, &bend)) {
        int ret = mprotect((void*)(addr&~(box86_pagesize-1)), box86_pagesize, prot&~(0x80 | 0x40 | 0x20 | 0x100));
        do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "refreshProtection(%p): %p/0x%x (ret=%d/%s)\n", (void*)addr, (void*)(addr&~(box86_pagesize-1)), prot, ret, ret?strerror(
# 986 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
       (*__errno_location ())
# 986 "/home/ssd/pico/code/box86/src/custommem.c"
       ):"ok"); fflush(ftrace);}} while(0);
    }
    pthread_mutex_unlock(&mutex_prot);
}
...
{
    do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "allocProtection %p:%p 0x%x\n", (void*)addr, (void*)(addr+size-1), prot); fflush(ftrace);}} while(0);
    size = (((size)+box86_pagesize-1)&~(box86_pagesize-1));
    addr &= ~(box86_pagesize-1);
    pthread_mutex_lock(&mutex_prot);
    rb_set(mapallmem, addr, addr+size, 1);
...
uintptr_t old_brk = 0;
uintptr_t* cur_brk = 
# 1004 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                    ((void *)0)
# 1004 "/home/ssd/pico/code/box86/src/custommem.c"
                        ;
void loadProtectionFromMap()
{
    if(box86_mapclean)
    ...
    while(!feof(f)) {
        ...
        if(sscanf(buf, "%x-%x %c%c%c", &s, &e, &r, &w, &x)==5) {
            int prot = ((r=='r')?
# 1019 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                0x1
# 1019 "/home/ssd/pico/code/box86/src/custommem.c"
                                         :0)|((w=='w')?
# 1019 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                                       0x2
# 1019 "/home/ssd/pico/code/box86/src/custommem.c"
...
# 1019 "/home/ssd/pico/code/box86/src/custommem.c"
    ...
    if(!pbrk) {
        do {if((1)<=box86_log) {fprintf(ftrace, "BOX86: Warning, program break not found\n"); fflush(ftrace);}} while(0);
        if(cur_brk) pbrk = *cur_brk;
    }
    fclose(f);
    box86_mapclean = 1;
}
...
void freeProtection(uintptr_t addr, uintptr_t size)
{
    size = (((size)+box86_pagesize-1)&~(box86_pagesize-1));
    addr &= ~(box86_pagesize-1);
    do {if((2)<=box86_dynarec_log) {fprintf(ftrace, "freeProtection %p:%p\n", (void*)addr, (void*)(addr+size-1)); fflush(ftrace);}} while(0);
    pthread_mutex_lock(&mutex_prot);
...
static void* findBlockHinted(void* hint, size_t size, uintptr_t mask)
{
    ...
    if(pbrk && cur_brk && *cur_brk!=old_brk) {
        old_brk = *cur_brk;
        setProtection(pbrk, old_brk-pbrk, 
# 1066 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                         0x1
# 1066 "/home/ssd/pico/code/box86/src/custommem.c"
                                                  |
# 1066 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                                                   0x2
# 1066 "/home/ssd/pico/code/box86/src/custommem.c"
    ...
    int prot;
    if(hint<(void*)0x10000) hint = (void*)0x10000;
    uintptr_t bend = 0;
    ...
    while(bend<end_mem) {
        if(!rb_get_end(mapallmem, cur, &prot, &bend)) {
            ...
            if(bend>=0xc0000000 && (uintptr_t)hint<0xc0000000)
                return 
# 1079 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                      ((void *)0)
# 1079 "/home/ssd/pico/code/box86/src/custommem.c"
                          ;
        }
    ...
    return 
# 1084 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
          ((void *)0)
# 1084 "/home/ssd/pico/code/box86/src/custommem.c"
              ;
}
void* findBlockNearHint(void* hint, size_t size, uintptr_t mask)
...
void* find32bitBlock(size_t size)
{
    void* ret = findBlockHinted((void*)0x40000000, size, 0);
    if(!ret) ret = findBlockHinted((void*)0x10000, size, 0);
    return ret;
}
...
void* find32bitBlockElf(size_t size, int mainbin, uintptr_t mask)
{
    ...
    if(!ret) ret = findBlockHinted((void*)0x10000, size, mask);
    if(!mainbin)
...
int unlockCustommemMutex()
{
    int ret = 0;
    int i = 0;
# 1138 "/home/ssd/pico/code/box86/src/custommem.c"
    i = checkUnlockMutex(&mutex_blocks); if(i) { ret|=(1<<0); }
    i = checkUnlockMutex(&mutex_prot); if(i) { ret|=(1<<1); }
...
void relockCustommemMutex(int locks)
{
    ...
    if(locks&(1<<0)) pthread_mutex_lock(&mutex_blocks);
    if(locks&(1<<1)) pthread_mutex_lock(&mutex_prot);
...
void init_custommem_helper(box86context_t* ctx)
{
    ...
    inited = 1;
    cur_brk = dlsym(
# 1183 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                   ((void *) -1l)
# 1183 "/home/ssd/pico/code/box86/src/custommem.c"
                            , "__curbrk");
    memprot = init_rbtree();
    init_mutexes();
# 1197 "/home/ssd/pico/code/box86/src/custommem.c"
    pthread_atfork(
# 1197 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
                  ((void *)0)
# 1197 "/home/ssd/pico/code/box86/src/custommem.c"
                      , 
# 1197 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
...
{
    (void)ctx;
# 1222 "/home/ssd/pico/code/box86/src/custommem.c"
    if(!inited)
        return;
    inited = 0;
# 1255 "/home/ssd/pico/code/box86/src/custommem.c"
    delete_rbtree(memprot);
    memprot = 
# 1256 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
             ((void *)0)
# 1256 "/home/ssd/pico/code/box86/src/custommem.c"
                 ;
    delete_rbtree(mmapmem);
    mmapmem = 
# 1258 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
             ((void *)0)
# 1258 "/home/ssd/pico/code/box86/src/custommem.c"
                 ;
    delete_rbtree(mapallmem);
    mapallmem = 
# 1260 "/home/ssd/pico/code/box86/src/custommem.c" 3 4
               ((void *)0)
# 1260 "/home/ssd/pico/code/box86/src/custommem.c"
                   ;
    ...
    for(int i=0; i<n_blocks; ++i)
        ...
        __libc_free(p_blocks[i].block);

    __libc_free(p_blocks);
