# 0 "/home/ssd/pico/code/box86/src/box86context.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/ssd/pico/code/box86/src/box86context.c"
...
# 3 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 4 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 5 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 6 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 7 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 9 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 10 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 11 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 12 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 13 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 14 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 15 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 16 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 17 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 18 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 19 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 20 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 22 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 23 "/home/ssd/pico/code/box86/src/box86context.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/custommem.h" 1
# 24 "/home/ssd/pico/code/box86/src/box86context.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/dictionnary.h" 1
# 25 "/home/ssd/pico/code/box86/src/box86context.c" 2
# 1 "/home/ssd/pico/code/box86/src/include/rcfile.h" 1




# 4 "/home/ssd/pico/code/box86/src/include/rcfile.h"
...
# 26 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
# 27 "/home/ssd/pico/code/box86/src/box86context.c" 2
...
int getrand(int maxval)
{
    if(maxval<1024) {
        ...
        uint64_t r = random();
        r = (r*maxval) / 
# 70 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                        2147483647
# 70 "/home/ssd/pico/code/box86/src/box86context.c"
                                ;
        return r;
...
void free_tlsdatasize(void* p)
{
    ...
    __libc_free(data->ptr);
    __libc_free(p);
    if(my_context)
        pthread_setspecific(my_context->tlskey, 
# 83 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                               ((void *)0)
# 83 "/home/ssd/pico/code/box86/src/box86context.c"
                                                   );
}
...
int unlockMutex()
{
    ...
    int i;
# 105 "/home/ssd/pico/code/box86/src/box86context.c"
    i = checkUnlockMutex(&my_context->mutex_once); if(i) { ret|=(1<<5); }
    i = checkUnlockMutex(&my_context->mutex_once2); if(i) { ret|=(1<<6); }
    i = checkUnlockMutex(&my_context->mutex_trace); if(i) { ret|=(1<<7); }



    i = checkUnlockMutex(&my_context->mutex_lock); if(i) { ret|=(1<<8); }

    i = checkUnlockMutex(&my_context->mutex_tls); if(i) { ret|=(1<<9); }
    i = checkUnlockMutex(&my_context->mutex_thread); if(i) { ret|=(1<<10); }
    i = checkUnlockMutex(&my_context->mutex_bridge); if(i) { ret|=(1<<11); }
...
void relockMutex(int locks)
{
    ...
    if(locks&(1<<5)) pthread_mutex_lock(&my_context->mutex_once);
    if(locks&(1<<6)) pthread_mutex_lock(&my_context->mutex_once2);
    if(locks&(1<<7)) pthread_mutex_lock(&my_context->mutex_trace);



    if(locks&(1<<8)) pthread_mutex_lock(&my_context->mutex_lock);

    if(locks&(1<<9)) pthread_mutex_lock(&my_context->mutex_tls);
    if(locks&(1<<10)) pthread_mutex_lock(&my_context->mutex_thread);
    if(locks&(1<<11)) pthread_mutex_lock(&my_context->mutex_bridge);
...
{
# 169 "/home/ssd/pico/code/box86/src/box86context.c"
...
void freeCycleLog(box86context_t* ctx)
{
    if(cycle_log) {
        for(int i=0; i<cycle_log; ++i) {
            __libc_free(ctx->log_call[i]);
            __libc_free(ctx->log_ret[i]);
        }
        __libc_free(ctx->log_call);
        __libc_free(ctx->log_ret);
        ctx->log_call = 
# 199 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                       ((void *)0)
# 199 "/home/ssd/pico/code/box86/src/box86context.c"
                           ;
        ctx->log_ret = 
# 200 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                      ((void *)0)
# 200 "/home/ssd/pico/code/box86/src/box86context.c"
                          ;
    }
}
void initCycleLog(box86context_t* context)
{
    if(cycle_log) {
        context->log_call = (char**)__libc_calloc(cycle_log, sizeof(char*));
        context->log_ret = (char**)__libc_calloc(cycle_log, sizeof(char*));
        for(int i=0; i<cycle_log; ++i) {
            context->log_call[i] = (char*)__libc_calloc(256, 1);
            context->log_ret[i] = (char*)__libc_calloc(128, 1);
        }
    }
}
...
box86context_t *NewBox86Context(int argc)
{
    ...
    box86context_t *context = my_context = (box86context_t*)__libc_calloc(1, sizeof(box86context_t));
...
# 244 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                                                       ((void *)0)
# 244 "/home/ssd/pico/code/box86/src/box86context.c"
                                                                           );
    addAlternate((void*)0xffffe400, (void*)context->vsyscall);

    context->exit_bridge = AddBridge(context->system, 
# 247 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                                     ((void *)0)
# 247 "/home/ssd/pico/code/box86/src/box86context.c"
                                                         , 
# 247 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                                           ((void *)0)
# 247 "/home/ssd/pico/code/box86/src/box86context.c"
...
# 247 "/home/ssd/pico/code/box86/src/box86context.c"
    ...
    context->box86lib = dlopen(
# 251 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                              ((void *)0)
# 251 "/home/ssd/pico/code/box86/src/box86context.c"
                                  , 
# 251 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                    0x00002
# 251 "/home/ssd/pico/code/box86/src/box86context.c"
...
# 251 "/home/ssd/pico/code/box86/src/box86context.c"
    ...
    context->argc = argc;
    context->argv = (char**)__libc_calloc(context->argc+1, sizeof(char*));

    init_mutexes(context);
    pthread_atfork(
# 259 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                  ((void *)0)
# 259 "/home/ssd/pico/code/box86/src/box86context.c"
                      , 
# 259 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                        ((void *)0)
# 259 "/home/ssd/pico/code/box86/src/box86context.c"
    ...
    pthread_key_create(&context->tlskey, 
# 261 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                        ((void *)0) 
# 261 "/home/ssd/pico/code/box86/src/box86context.c"
                                                                );
    ...
    context->canary[ 0] = 0;
    do {if((2)<=box86_log) {fprintf(ftrace, "Setting up canary (for Stack protector) at GS:0x14, value:%08X\n", *(uint32_t*)context->canary); fflush(ftrace);}} while(0);
...
void FreeBox86Context(box86context_t** context)
{
    ...
    box86context_t* ctx = *context;


    if(ctx->local_maplib)
        FreeLibrarian(&ctx->local_maplib, 
# 293 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                         ((void *)0)
# 293 "/home/ssd/pico/code/box86/src/box86context.c"
                                             );
    if(ctx->maplib)
        FreeLibrarian(&ctx->maplib, 
# 295 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                   ((void *)0)
# 295 "/home/ssd/pico/code/box86/src/box86context.c"
                                       );
    ...
    if(ctx->deferredInitList)
        __libc_free(ctx->deferredInitList);
    ...
    if(ctx->atfork_sz) {
        __libc_free(ctx->atforks);
        ctx->atforks = 
# 325 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                      ((void *)0)
# 325 "/home/ssd/pico/code/box86/src/box86context.c"
                          ;
    ...
    for(int i=0; i<64; ++i)
        if(ctx->signals[i]!=0 && ctx->signals[i]!=1) {
            signal(i, 
# 331 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                     ((__sighandler_t) 0)
# 331 "/home/ssd/pico/code/box86/src/box86context.c"
                            );
        }

    *context = 
# 334 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
              ((void *)0)
# 334 "/home/ssd/pico/code/box86/src/box86context.c"
                  ;
    ...
    __libc_free(ctx->fullpath);
    __libc_free(ctx->box86path);
    __libc_free(ctx->bashpath);
    ...
    if(ctx->stack_clone)
        __libc_free(ctx->stack_clone);

    void* ptr;
    if ((ptr = pthread_getspecific(ctx->tlskey)) != 
# 360 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                                                   ((void *)0)
# 360 "/home/ssd/pico/code/box86/src/box86context.c"
                                                       ) {
    ...
    ctx->neededlibs = 
# 376 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                     ((void *)0)
# 376 "/home/ssd/pico/code/box86/src/box86context.c"
                         ;
...
int AddElfHeader(box86context_t* ctx, elfheader_t* head) {
    ...
    if(idx == ctx->elfsize) {
        if(idx==ctx->elfcap) {
            ...
            ctx->elfcap += 16;
            ctx->elfs = (elfheader_t**)__libc_realloc(ctx->elfs, sizeof(elfheader_t*) * ctx->elfcap);
        }
        ctx->elfs[idx] = head;
        ctx->elfsize++;
    } else {
    ...
    do {if((2)<=box86_log) {fprintf(ftrace, "Adding \"%s\" as #%d in elf collection\n", ElfName(head), idx); fflush(ftrace);}} while(0);
    return idx;
}
...
void RemoveElfHeader(box86context_t* ctx, elfheader_t* head) {
    ...
    for(int i=0; i<ctx->elfsize; ++i)
        if(ctx->elfs[i] == head) {
            ctx->elfs[i] = 
# 431 "/home/ssd/pico/code/box86/src/box86context.c" 3 4
                          ((void *)0)
# 431 "/home/ssd/pico/code/box86/src/box86context.c"
                              ;
            return;
        }
}
...
int AddTLSPartition(box86context_t* context, int tlssize) {
    ...
    context->tlsdata = __libc_realloc(context->tlsdata, context->tlssize);
